...
LOG_FILE = os.path.join(LOG_DIR, 'codefmt.log')
...
def generate_cmake_defs(args):
    ...
    if args.target == "windows-x86_64":
        return [
            ...
            "-DCODEFMT_CODE_COVERAGE=" + bool_to_opt(args.code_coverage),
...
def main():
    """build entry"""
    parser = argparse.ArgumentParser(description='build codefmt project')
    subparsers = parser.add_subparsers(help='sub command help')
    parser_build = subparsers.add_parser('build', help='build codefmt')
