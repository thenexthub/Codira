...
#ifndef CODEFMT_FUNCPARAMFORMATTER_H
#define CODEFMT_FUNCPARAMFORMATTER_H
...
private:
    void AddFuncParam(Doc& doc, const Codira::AST::FuncParam& funcParam, int level, FuncOptions funcOptions);
};
} // namespace Codira::Format
#endif // CODEFMT_FUNCPARAMFORMATTER_H
