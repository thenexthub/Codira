...
#ifndef CODEFMT_FUNCBODYFORMATTER_H
#define CODEFMT_FUNCBODYFORMATTER_H
...
private:
    void AddFuncBody(Doc& doc, const Codira::AST::FuncBody& funcBody, int level, FuncOptions funcOptions);
    void AddFuncBodyIsLambda(Doc& doc, const Codira::AST::FuncBody& funcBody, int level, FuncOptions funcOptions);
};
} // namespace Codira::Format
#endif // CODEFMT_FUNCBODYFORMATTER_H
