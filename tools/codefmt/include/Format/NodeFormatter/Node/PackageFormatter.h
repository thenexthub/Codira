...
#ifndef CODEFMT_PACKAGEFORMATTER_H
#define CODEFMT_PACKAGEFORMATTER_H
...
private:
    void AddPackage(Doc& doc, const Codira::AST::Package& package, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_PACKAGEFORMATTER_H
