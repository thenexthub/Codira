...
#ifndef CODEFMT_IMPORTSPECFORMATTER_H
#define CODEFMT_IMPORTSPECFORMATTER_H
...
private:
    void AddImportSpec(Doc& doc, const Codira::AST::ImportSpec& importSpec, int level);
    void AddImportContent(Doc& doc, const Codira::AST::ImportContent& content, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_IMPORTSPECFORMATTER_H
