...
#ifndef CODEFMT_FUNCARGFORMATTER_H
#define CODEFMT_FUNCARGFORMATTER_H
...
private:
    void AddFuncArg(Doc& doc, const Codira::AST::FuncArg& funcArg, int level, FuncOptions& funcOptions);
};
} // namespace Codira::Format
#endif // CODEFMT_FUNCARGFORMATTER_H
