...
#ifndef CODEFMT_GENERICCONSTRAINTFORMATTER_H
#define CODEFMT_GENERICCONSTRAINTFORMATTER_H
...
private:
    void AddGenericConstraint(Doc& doc, const Codira::AST::GenericConstraint& genericConstraint, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_GENERICCONSTRAINTFORMATTER_H
