...
#ifndef CODEFMT_MATCHCASEFORMATTER_H
#define CODEFMT_MATCHCASEFORMATTER_H
...
private:
    void AddMatchCase(Doc& doc, const Codira::AST::MatchCase& matchCase, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_MATCHCASEFORMATTER_H
