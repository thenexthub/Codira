...
#ifndef CODEFMT_MATCHCASEOTHERFORMATTER_H
#define CODEFMT_MATCHCASEOTHERFORMATTER_H
...
private:
    void AddMatchCaseOther(Doc& doc, const Codira::AST::MatchCaseOther& matchCaseOther, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_MATCHCASEOTHERFORMATTER_H
