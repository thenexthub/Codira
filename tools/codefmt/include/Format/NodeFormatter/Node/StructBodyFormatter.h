...
#ifndef CODEFMT_STRUCTBODYFORMATTER_H
#define CODEFMT_STRUCTBODYFORMATTER_H
...
private:
    void AddStructBody(Doc& doc, const Codira::AST::StructBody& structBody, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_STRUCTBODYFORMATTER_H
