...
#ifndef CODEFMT_CLASSBODYFORMATTER_H
#define CODEFMT_CLASSBODYFORMATTER_H
...
private:
    void AddClassBody(Doc& doc, const Codira::AST::ClassBody& classBody, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_CLASSBODYFORMATTER_H
