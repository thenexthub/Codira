...
#ifndef CODEFMT_PACKAGESPECFORMATTER_H
#define CODEFMT_PACKAGESPECFORMATTER_H
...
private:
    void AddPackageSpec(Doc& doc, const Codira::AST::PackageSpec& packageSpec, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_PACKAGESPECFORMATTER_H
