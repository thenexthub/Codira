...
#ifndef CODEFMT_DECLFORMATTER_H
#define CODEFMT_DECLFORMATTER_H
...
public:
    ...
    void ASTToDoc(
        Doc& doc, Ptr<Codira::AST::Node> node, int level, FuncOptions& funcOptions) override = 0;
};
} // namespace Codira::Format
#endif // CODEFMT_DECLFORMATTER_H
