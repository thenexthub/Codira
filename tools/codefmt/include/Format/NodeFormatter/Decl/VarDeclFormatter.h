...
#ifndef CODEFMT_VARDECLFORMATTER_H
#define CODEFMT_VARDECLFORMATTER_H
...
private:
    void AddVarDecl(Doc& doc, const Codira::AST::VarDecl& varDecl, int level, FuncOptions funcOptions);
};
} // namespace Codira::Format
#endif // CODEFMT_VARDECLFORMATTER_H
