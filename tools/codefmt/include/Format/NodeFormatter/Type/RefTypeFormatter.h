...
#ifndef CODEFMT_REFTYPEFORMATTER_H
#define CODEFMT_REFTYPEFORMATTER_H
...
private:
    void AddRefType(Doc& doc, const Codira::AST::RefType& refType, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_REFTYPEFORMATTER_H
