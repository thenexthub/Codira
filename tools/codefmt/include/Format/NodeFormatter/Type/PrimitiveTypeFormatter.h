...
#ifndef CODEFMT_PRIMITIVETYPEFORMATTER_H
#define CODEFMT_PRIMITIVETYPEFORMATTER_H
...
private:
    void AddPrimitiveType(Doc& doc, const Codira::AST::PrimitiveType& primitiveType, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_PRIMITIVETYPEFORMATTER_H
