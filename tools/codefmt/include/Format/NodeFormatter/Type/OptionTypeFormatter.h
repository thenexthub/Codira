...
#ifndef CODEFMT_OPTIONTYPEFORMATTER_H
#define CODEFMT_OPTIONTYPEFORMATTER_H
...
private:
    void AddOptionType(Doc& doc, const Codira::AST::OptionType& optionType, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_OPTIONTYPEFORMATTER_H
