...
#ifndef CODEFMT_CONSTANTTYPEFORMATTER_H
#define CODEFMT_CONSTANTTYPEFORMATTER_H
...
private:
    void AddConstantType(Doc& doc, const Codira::AST::ConstantType& constantType, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_CONSTANTTYPEFORMATTER_H
