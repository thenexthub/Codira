...
#ifndef CODEFMT_TUPLETYPEFORMATTER_H
#define CODEFMT_TUPLETYPEFORMATTER_H
...
private:
    void AddTupleType(Doc& doc, const Codira::AST::TupleType& tupleType, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_TUPLETYPEFORMATTER_H
