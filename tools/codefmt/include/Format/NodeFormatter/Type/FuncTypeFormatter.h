...
#ifndef CODEFMT_FUNCTYPEFORMATTER_H
#define CODEFMT_FUNCTYPEFORMATTER_H
...
private:
    void AddFuncType(Doc& doc, const Codira::AST::FuncType& funcType, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_FUNCTYPEFORMATTER_H
