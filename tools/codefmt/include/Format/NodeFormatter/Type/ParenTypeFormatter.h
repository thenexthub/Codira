...
#ifndef CODEFMT_PARENTYPEFORMATTER_H
#define CODEFMT_PARENTYPEFORMATTER_H
...
private:
    void AddParenType(Doc& doc, const Codira::AST::ParenType& parenType, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_PARENTYPEFORMATTER_H
