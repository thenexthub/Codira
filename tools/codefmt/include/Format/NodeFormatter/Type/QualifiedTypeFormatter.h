...
#ifndef CODEFMT_QUALIFIEDTYPEFORMATTER_H
#define CODEFMT_QUALIFIEDTYPEFORMATTER_H
...
private:
    void AddQualifiedType(Doc& doc, const Codira::AST::QualifiedType& qualifiedType, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_QUALIFIEDTYPEFORMATTER_H
