...
#ifndef CODEFMT_VARRAYTYPEFORMATTER_H
#define CODEFMT_VARRAYTYPEFORMATTER_H
...
private:
    void AddVArrayType(Doc& doc, const Codira::AST::VArrayType& vArrayType, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_VARRAYTYPEFORMATTER_H
