...
#ifndef CODEFMT_TRAILINGCLOSUREEXPRFORMATTER_H
#define CODEFMT_TRAILINGCLOSUREEXPRFORMATTER_H
...
private:
    void AddTrailingClosureExpr(Doc& doc, const Codira::AST::TrailingClosureExpr& trailingClosureExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_TRAILINGCLOSUREEXPRFORMATTER_H
