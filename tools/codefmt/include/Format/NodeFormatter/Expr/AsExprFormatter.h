...
#ifndef CODEFMT_ASEXPRFORMATTER_H
#define CODEFMT_ASEXPRFORMATTER_H
...
private:
    void AddAsExpr(Doc& doc, const Codira::AST::AsExpr& asExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_ASEXPRFORMATTER_H
