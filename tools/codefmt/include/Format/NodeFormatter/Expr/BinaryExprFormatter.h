...
#ifndef CODEFMT_BINARYEXPRFORMATTER_H
#define CODEFMT_BINARYEXPRFORMATTER_H
...
private:
    void AddBinaryExpr(Doc& doc, const Codira::AST::BinaryExpr& binaryExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_BINARYEXPRFORMATTER_H
