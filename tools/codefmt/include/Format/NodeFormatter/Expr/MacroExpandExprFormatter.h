...
#ifndef CODEFMT_MACROEXPANDEXPRFORMATTER_H
#define CODEFMT_MACROEXPANDEXPRFORMATTER_H
...
private:
    void AddMacroExpandExpr(Doc& doc, const Codira::AST::MacroExpandExpr& macroExpandExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_MACROEXPANDEXPRFORMATTER_H
