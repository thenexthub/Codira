...
#ifndef CODEFMT_MATCHEXPRFORMATTER_H
#define CODEFMT_MATCHEXPRFORMATTER_H
...
private:
    void AddMatchExpr(Doc& doc, const Codira::AST::MatchExpr& matchExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_MATCHEXPRFORMATTER_H
