...
#ifndef CODEFMT_SYNCHRONIZEDEXPRFORMATTER_H
#define CODEFMT_SYNCHRONIZEDEXPRFORMATTER_H
...
private:
    void AddSynchronizedExpr(Doc& doc, const Codira::AST::SynchronizedExpr& synchronizedExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_SYNCHRONIZEDEXPRFORMATTER_H
