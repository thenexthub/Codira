...
#ifndef CODEFMT_CALLEXPRFORMATTER_H
#define CODEFMT_CALLEXPRFORMATTER_H
...
private:
    void AddCallExpr(Doc& doc, const Codira::AST::CallExpr& callExpr, int level, FuncOptions funcOptions);
    void AddBreakLineCallArgs(Doc& doc, const Codira::AST::CallExpr& callExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_CALLEXPRFORMATTER_H
