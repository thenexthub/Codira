...
#ifndef CODEFMT_WHILEEXPRFORMATTER_H
#define CODEFMT_WHILEEXPRFORMATTER_H
...
private:
    void AddWhileExpr(Doc& doc, const Codira::AST::WhileExpr& whileExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_WHILEEXPRFORMATTER_H
