...
#ifndef CODEFMT_ASSIGNEXPRFORMATTER_H
#define CODEFMT_ASSIGNEXPRFORMATTER_H
...
private:
    void AddAssignExpr(Doc& doc, const Codira::AST::AssignExpr& assignExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_ASSIGNEXPRFORMATTER_H
