...
#ifndef CODEFMT_PARENEXPRFORMATTER_H
#define CODEFMT_PARENEXPRFORMATTER_H
...
private:
    void AddParenExpr(Doc& doc, const Codira::AST::ParenExpr& parenExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_PARENEXPRFORMATTER_H
