...
#ifndef CODEFMT_LAMBDAEXPRFORMATTER_H
#define CODEFMT_LAMBDAEXPRFORMATTER_H
...
private:
    void AddLambdaExpr(Doc& doc, const Codira::AST::LambdaExpr& lambdaExpr, int level);
    void AddLambdaExprOverFlowStrategy(Doc& doc, const Codira::AST::LambdaExpr& lambdaExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_LAMBDAEXPRFORMATTER_H
