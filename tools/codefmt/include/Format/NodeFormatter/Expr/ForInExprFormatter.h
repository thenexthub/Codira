...
#ifndef CODEFMT_FORINEXPRFORMATTER_H
#define CODEFMT_FORINEXPRFORMATTER_H
...
private:
    void AddForInExpr(Doc& doc, const Codira::AST::ForInExpr& forInExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_FORINEXPRFORMATTER_H
