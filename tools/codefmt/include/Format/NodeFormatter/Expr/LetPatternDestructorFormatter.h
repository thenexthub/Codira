...
#ifndef CODEFMT_LETPATTERNDESTRUCTORFORMATTER_H
#define CODEFMT_LETPATTERNDESTRUCTORFORMATTER_H
...
private:
    void AddLetPatternDestructor(Doc& doc, const Codira::AST::LetPatternDestructor& letPatternDestructor, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_LETPATTERNDESTRUCTORFORMATTER_H
