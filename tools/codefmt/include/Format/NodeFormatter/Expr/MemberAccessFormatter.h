...
#ifndef CODEFMT_MEMBERACCESSFORMATTER_H
#define CODEFMT_MEMBERACCESSFORMATTER_H
...
private:
    void AddMemberAccess(Doc& doc, const Codira::AST::MemberAccess& memberAccess, int level, FuncOptions funcOptions);
    static bool IsHexadecimal(const Codira::AST::MemberAccess& memberAccess);
};
} // namespace Codira::Format
#endif // CODEFMT_MEMBERACCESSFORMATTER_H
