...
#ifndef CODEFMT_TRYEXPRFORMATTER_H
#define CODEFMT_TRYEXPRFORMATTER_H
...
private:
    void AddTryExpr(Doc& doc, const Codira::AST::TryExpr& tryExpr, int level);
    void AddIsTryWithResource(Doc& doc, const Codira::AST::TryExpr& tryExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_TRYEXPRFORMATTER_H
