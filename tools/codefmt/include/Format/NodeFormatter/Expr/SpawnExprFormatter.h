...
#ifndef CODEFMT_SPAWNEXPRFORMATTER_H
#define CODEFMT_SPAWNEXPRFORMATTER_H
...
private:
    void AddSpawnExpr(Doc& doc, const Codira::AST::SpawnExpr& spawnExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_SPAWNEXPRFORMATTER_H
