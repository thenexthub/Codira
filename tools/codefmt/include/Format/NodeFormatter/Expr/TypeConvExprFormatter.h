...
#ifndef CODEFMT_TYPECONVEXPRFORMATTER_H
#define CODEFMT_TYPECONVEXPRFORMATTER_H
...
private:
    void AddTypeConvExpr(Doc& doc, const Codira::AST::TypeConvExpr& typeConvExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_TYPECONVEXPRFORMATTER_H
