...
#ifndef CODEFMT_ISEXPRFORMATTER_H
#define CODEFMT_ISEXPRFORMATTER_H
...
private:
    void AddIsExpr(Doc& doc, const Codira::AST::IsExpr& isExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_ISEXPRFORMATTER_H
