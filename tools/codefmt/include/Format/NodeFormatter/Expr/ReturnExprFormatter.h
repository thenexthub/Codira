...
#ifndef CODEFMT_RETURNEXPRFORMATTER_H
#define CODEFMT_RETURNEXPRFORMATTER_H
...
private:
    void AddReturnExpr(Doc& doc, const Codira::AST::ReturnExpr& returnExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_RETURNEXPRFORMATTER_H
