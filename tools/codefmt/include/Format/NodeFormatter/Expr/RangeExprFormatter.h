...
#ifndef CODEFMT_RANGEEXPRFORMATTER_H
#define CODEFMT_RANGEEXPRFORMATTER_H
...
private:
    void AddRangeExpr(Doc& doc, const Codira::AST::RangeExpr& rangeExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_RANGEEXPRFORMATTER_H
