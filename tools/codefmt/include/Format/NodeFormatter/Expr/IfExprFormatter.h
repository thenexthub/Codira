...
#ifndef CODEFMT_IFEXPRFORMATTER_H
#define CODEFMT_IFEXPRFORMATTER_H
...
private:
    void AddIfExpr(Doc& doc, const Codira::AST::IfExpr& ifExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_IFEXPRFORMATTER_H
