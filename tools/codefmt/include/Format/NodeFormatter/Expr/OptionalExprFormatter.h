...
#ifndef CODEFMT_OPTIONALEXPRFORMATTER_H
#define CODEFMT_OPTIONALEXPRFORMATTER_H
...
private:
    void AddOptionalExpr(Doc& doc, const Codira::AST::OptionalExpr& optionalExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_OPTIONALEXPRFORMATTER_H
