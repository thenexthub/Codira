...
#ifndef CODEFMT_QUOTEEXPRFORMATTER_H
#define CODEFMT_QUOTEEXPRFORMATTER_H
...
private:
    void AddQuoteExpr(Doc& doc, const Codira::AST::QuoteExpr& quoteExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_QUOTEEXPRFORMATTER_H
