...
#ifndef CODEFMT_JUMPEXPRFORMATTER_H
#define CODEFMT_JUMPEXPRFORMATTER_H
...
private:
    void AddJumpExpr(Doc& doc, const Codira::AST::JumpExpr& jumpExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_JUMPEXPRFORMATTER_H
