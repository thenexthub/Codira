...
#ifndef CODEFMT_OPTIONALCHAINEXPRFORMATTER_H
#define CODEFMT_OPTIONALCHAINEXPRFORMATTER_H
...
private:
    void AddOptionalChainExpr(Doc& doc, const Codira::AST::OptionalChainExpr& optionalChainExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_OPTIONALCHAINEXPRFORMATTER_H
