...
#ifndef CODEFMT_ARRAYEXPRFORMATTER_H
#define CODEFMT_ARRAYEXPRFORMATTER_H
...
private:
    void AddArrayExpr(Doc& doc, const Codira::AST::ArrayExpr& arrayExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_ARRAYEXPRFORMATTER_H
