...
#ifndef CODEFMT_PRIMITIVETYPEEXPRFORMATTER_H
#define CODEFMT_PRIMITIVETYPEEXPRFORMATTER_H
...
private:
    static void AddPrimitiveTypeExpr(Doc& doc, const Codira::AST::PrimitiveTypeExpr& primitiveTypeExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_PRIMITIVETYPEEXPRFORMATTER_H
