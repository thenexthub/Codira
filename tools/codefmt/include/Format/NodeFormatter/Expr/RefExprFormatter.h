...
#ifndef CODEFMT_REFEXPRFORMATTER_H
#define CODEFMT_REFEXPRFORMATTER_H
...
private:
    void AddRefExpr(Doc& doc, const Codira::AST::RefExpr& refExpr, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_REFEXPRFORMATTER_H
