...
#ifndef CODEFMT_TYPEPATTERNFORMATTER_H
#define CODEFMT_TYPEPATTERNFORMATTER_H
...
private:
    void AddTypePattern(Doc& doc, const Codira::AST::TypePattern& typePattern, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_TYPEPATTERNFORMATTER_H
