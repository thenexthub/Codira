...
#ifndef CODEFMT_VARORENUMPATTERNFORMATTER_H
#define CODEFMT_VARORENUMPATTERNFORMATTER_H
...
private:
    void AddVarOrEnumPattern(Doc& doc, const Codira::AST::VarOrEnumPattern& varOrEnumPattern, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_VARORENUMPATTERNFORMATTER_H
