...
#ifndef CODEFMT_EXCEPTTYPEPATTERNFORMATTER_H
#define CODEFMT_EXCEPTTYPEPATTERNFORMATTER_H
...
private:
    void AddExceptTypePattern(Doc& doc, const Codira::AST::ExceptTypePattern& exceptTypePattern, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_EXCEPTTYPEPATTERNFORMATTER_H
