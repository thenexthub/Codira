...
#ifndef CODEFMT_VARPATTERNFORMATTER_H
#define CODEFMT_VARPATTERNFORMATTER_H
...
private:
    void AddVarPattern(Doc& doc, const Codira::AST::VarPattern& varPattern, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_VARPATTERNFORMATTER_H
