...
#ifndef CODEFMT_PATTERNFORMATTER_H
#define CODEFMT_PATTERNFORMATTER_H
...
public:
    ...
    void ASTToDoc(Doc& doc, Ptr<Codira::AST::Node> node, int level, FuncOptions& funcOptions) override = 0;
};
} // namespace Codira::Format
#endif // CODEFMT_PATTERNFORMATTER_H
