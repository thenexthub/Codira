...
#ifndef CODEFMT_CONSTPATTERNFORMATTER_H
#define CODEFMT_CONSTPATTERNFORMATTER_H
...
private:
    void AddConstPattern(Doc& doc, const Codira::AST::ConstPattern& constPattern, int level);
};
} // namespace Codira::Format
#endif // CODEFMT_CONSTPATTERNFORMATTER_H
