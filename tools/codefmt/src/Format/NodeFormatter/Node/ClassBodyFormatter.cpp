...
void ClassBodyFormatter::ASTToDoc(Doc& doc, Ptr<Codira::AST::Node> node, int level, FuncOptions&)
{
    auto classBody = As<ASTKind::CLASS_BODY>(node);
    AddClassBody(doc, *classBody, level);
}
void ClassBodyFormatter::AddClassBody(Doc& doc, const Codira::AST::ClassBody& classBody, int level)
{
