...
void Codira::Format::MatchCaseOtherFormatter::ASTToDoc(Doc& doc, Ptr<Codira::AST::Node> node, int level, FuncOptions&)
{
    auto matchCaseOther = As<ASTKind::MATCH_CASE_OTHER>(node);
    AddMatchCaseOther(doc, *matchCaseOther, level);
}
void MatchCaseOtherFormatter::AddMatchCaseOther(Doc& doc, const Codira::AST::MatchCaseOther& matchCaseOther, int level)
{
