...
void FuncArgFormatter::ASTToDoc(Doc& doc, Ptr<Codira::AST::Node> node, int level, FuncOptions& funcOptions)
{
    auto funcArg = As<ASTKind::FUNC_ARG>(node);
    AddFuncArg(doc, *funcArg, level, funcOptions);
}
void FuncArgFormatter::AddFuncArg(Doc& doc, const Codira::AST::FuncArg& funcArg, int level, FuncOptions& funcOptions)
{
