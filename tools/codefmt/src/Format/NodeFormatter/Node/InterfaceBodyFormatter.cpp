...
void InterfaceBodyFormatter::ASTToDoc(Doc& doc, Ptr<Codira::AST::Node> node, int level, FuncOptions&)
{
    auto interfaceBody = As<ASTKind::INTERFACE_BODY>(node);
    AddInterfaceBody(doc, *interfaceBody, level);
}
void InterfaceBodyFormatter::AddInterfaceBody(Doc& doc, const Codira::AST::InterfaceBody& interfaceBody, int level)
{
