...
void ReturnExprFormatter::ASTToDoc(Doc& doc, Ptr<Codira::AST::Node> node, int level, FuncOptions&)
{
    auto returnExpr = As<ASTKind::RETURN_EXPR>(node);
    AddReturnExpr(doc, *returnExpr, level);
}

void ReturnExprFormatter::AddReturnExpr(Doc& doc, const Codira::AST::ReturnExpr& returnExpr, int level)
{
