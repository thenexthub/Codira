...
void LetPatternDestructorFormatter::ASTToDoc(Doc& doc, Ptr<Codira::AST::Node> node, int level, FuncOptions&)
{
...
void LetPatternDestructorFormatter::AddLetPatternDestructor(
    Doc& doc, const Codira::AST::LetPatternDestructor& letPatternDestructor, int level)
{
