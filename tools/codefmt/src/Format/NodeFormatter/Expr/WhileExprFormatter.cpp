...
void WhileExprFormatter::ASTToDoc(Doc& doc, Ptr<Codira::AST::Node> node, int level, FuncOptions&)
{
    auto whileExpr = As<ASTKind::WHILE_EXPR>(node);
    AddWhileExpr(doc, *whileExpr, level);
}

void WhileExprFormatter::AddWhileExpr(Doc& doc, const Codira::AST::WhileExpr& whileExpr, int level)
{
