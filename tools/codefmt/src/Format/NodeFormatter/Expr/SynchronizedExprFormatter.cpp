...
void SynchronizedExprFormatter::ASTToDoc(Doc& doc, Ptr<Codira::AST::Node> node, int level, FuncOptions&)
{
...
void SynchronizedExprFormatter::AddSynchronizedExpr(
    Doc& doc, const Codira::AST::SynchronizedExpr& synchronizedExpr, int level)
{
