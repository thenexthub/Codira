...
void ParenExprFormatter::ASTToDoc(Doc& doc, Ptr<Codira::AST::Node> node, int level, FuncOptions&)
{
    auto parenExpr = As<ASTKind::PAREN_EXPR>(node);
    AddParenExpr(doc, *parenExpr, level);
}

void ParenExprFormatter::AddParenExpr(Doc& doc, const Codira::AST::ParenExpr& parenExpr, int level)
{
