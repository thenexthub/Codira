...
void SpawnExprFormatter::AddSpawnExpr(Doc& doc, const Codira::AST::SpawnExpr& spawnExpr, int level)
{
...
void SpawnExprFormatter::ASTToDoc(Doc& doc, Ptr<Codira::AST::Node> node, int level, FuncOptions&)
{
