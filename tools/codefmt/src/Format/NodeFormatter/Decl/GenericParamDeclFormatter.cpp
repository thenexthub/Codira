...
void GenericParamDeclFormatter::ASTToDoc(Doc& doc, Ptr<Codira::AST::Node> node, int level, FuncOptions&)
{
...
void GenericParamDeclFormatter::AddGenericParamDecl(
    Doc& doc, const Codira::AST::GenericParamDecl& genericParamDecl, int level)
{
