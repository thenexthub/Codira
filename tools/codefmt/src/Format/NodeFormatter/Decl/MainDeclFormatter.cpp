...
void MainDeclFormatter::AddMainDecl(Doc &doc, const Codira::AST::MainDecl &mainDecl, int level)
{
...
void MainDeclFormatter::ASTToDoc(Doc &doc, Ptr<Codira::AST::Node> node, int level, FuncOptions&)
{
