...
#ifndef CODIRA_LSP_EXTRACTVARIABLE_H
#define CODIRA_LSP_EXTRACTVARIABLE_H
...
public:
    ...
    static void MatchModifier(Codira::AST::Node &node, std::string &modifier);
...
#endif // CODIRA_LSP_EXTRACTVARIABLE_H
