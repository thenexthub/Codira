...
public:
    ...
    static std::map<Codira::AST::Attribute, std::string> GetSupportAttribute();

private:
    static std::map<Codira::AST::Attribute, std::string> supportAttribute;

    static std::unordered_set<Codira::AST::ASTKind> supportSymbolKind;
};
}
