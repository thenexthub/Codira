...
#ifndef CODIRACODECHECK_STRUCTURALRULEGNAM05_H
#define CODIRACODECHECK_STRUCTURALRULEGNAM05_H
...
private:
    void FindGlobalOrStaticVarWithLetName(Ptr<Codira::AST::Node> node);
    void CheckGlobalOrStaticVarWithLetName(const Codira::AST::VarDecl& varDecl);
};
} // namespace Codira::CodeCheck
#endif // CODIRACODECHECK_STRUCTURALRULEGNAM05_H
