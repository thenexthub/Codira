...
#ifndef CODIRACODECHECK_STRUCTURALRULEGERR03_H
#define CODIRACODECHECK_STRUCTURALRULEGERR03_H
...
protected:
    ...
    void FindMemberAccess(Ptr<Codira::AST::Node> node);
    void CheckMemberAccessAttribute(const Codira::AST::MemberAccess &memberAccess);
};
}
#endif // CODIRACODECHECK_STRUCTURALRULEGERR03_H
