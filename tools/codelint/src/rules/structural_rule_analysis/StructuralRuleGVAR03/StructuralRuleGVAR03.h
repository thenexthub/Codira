...
#ifndef CODIRACODECHECK_STRUCTURALRULEGVAR03_H
#define CODIRACODECHECK_STRUCTURALRULEGVAR03_H
...
private:
    void CheckVarDecl(const Codira::AST::VarDecl &varDecl);
    void FindGlobalVar(Ptr<Codira::AST::Node> node);
};
}
#endif // CODIRACODECHECK_STRUCTURALRULEGVAR03_H
