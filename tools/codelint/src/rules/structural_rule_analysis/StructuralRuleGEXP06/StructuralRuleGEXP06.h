...
#ifndef CODIRACODECHECK_STRUCTURALRULEGEXP06_H
#define CODIRACODECHECK_STRUCTURALRULEGEXP06_H
...
protected:
    ...
    void FindBinaryExpr(Ptr<Codira::AST::Node> node);
    void CheckBinaryExpr(const Codira::AST::BinaryExpr &binaryExpr);
};
}
#endif // CODIRACODECHECK_STRUCTURALRULEGEXP06_H
