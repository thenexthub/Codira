...
#ifndef CODIRACODECHECK_STRUCTURALRULEGNAM02_H
#define CODIRACODECHECK_STRUCTURALRULEGNAM02_H
...
private:
    void FindFileName(Ptr<Codira::AST::Node> node);
    void CheckNameRule(Codira::AST::File &file);
};
}
#endif // CODIRACODECHECK_STRUCTURALRULEGNAM02_H
