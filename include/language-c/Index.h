...
#ifndef LANGUAGE_CORE_C_INDEX_H
#define LANGUAGE_CORE_C_INDEX_H

#include "language/Core-c/BuildSystem.h"
#include "language/Core-c/CXDiagnostic.h"
#include "language/Core-c/CXErrorCode.h"
#include "language/Core-c/CXFile.h"
#include "language/Core-c/CXSourceLocation.h"
 ...
 *
 * See the definition of toolchain::language::Core::TemplateArgument::ArgKind for full
 ...
 *
 * See \c language::Core::PrintingPolicy for more information.
 */
 ...
 *
 * Internal: this currently mirrors low 9 bits of language::Core::index::SymbolRole with
