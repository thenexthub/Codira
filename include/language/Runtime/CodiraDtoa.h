...
/// ===============
///
/// CodiraDtoa is the C implementation that supports the `.description`
/// and `.debugDescription` properties for the standard Codira
...
/// ------------------
///
/// The first version of CodiraDtoa was committed to the Codira runtime
/// in 2018.  It supported Codira's Float, Double, and Float80 formats.
///
/// About CodiraDtoa v1a
/// -------------------
///
/// Version 1a of CodiraDtoa added support for Float16.
///
/// About CodiraDtoa v2
/// ------------------
///
/// Version 2 of CodiraDtoa is a major overhaul with a number of
...
/// binary128 format, which is not currently supported by Codira.
//
//===---------------------------------------------------------------------===//

#ifndef LANGUAGE_DTOA_H
#define LANGUAGE_DTOA_H
...
// Force disable: -DLANGUAGE_DTOA_BINARY16_SUPPORT=0
#ifndef LANGUAGE_DTOA_BINARY16_SUPPORT
 #define LANGUAGE_DTOA_BINARY16_SUPPORT 1
#endif

/// Does this platform support needs to pass _Float16 as a float in
/// C function?
#ifndef LANGUAGE_DTOA_PASS_FLOAT16_AS_FLOAT
...
#  define LANGUAGE_DTOA_PASS_FLOAT16_AS_FLOAT 1
# else
#  define LANGUAGE_DTOA_PASS_FLOAT16_AS_FLOAT 0
# endif
#endif
...
// Force disable: -DLANGUAGE_DTOA_BINARY32_SUPPORT=0
#ifndef LANGUAGE_DTOA_BINARY32_SUPPORT
 #define LANGUAGE_DTOA_BINARY32_SUPPORT 1
#endif
...
// so we enable it by default.
// Force disable: -DLANGUAGE_DTOA_BINARY64_SUPPORT=0
#ifndef LANGUAGE_DTOA_BINARY64_SUPPORT
 #define LANGUAGE_DTOA_BINARY64_SUPPORT 1
#endif
...
// Force enable: -DLANGUAGE_DTOA_FLOAT80_SUPPORT=1
// Force disable: -DLANGUAGE_DTOA_FLOAT80_SUPPORT=0
#ifndef LANGUAGE_DTOA_FLOAT80_SUPPORT
 #if LONG_DOUBLE_IS_FLOAT80
  #define LANGUAGE_DTOA_FLOAT80_SUPPORT 1
 #endif
#endif
...
// Force enable: -DLANGUAGE_DTOA_BINARY128_SUPPORT=1
// Force disable: -DLANGUAGE_DTOA_BINARY128_SUPPORT=0
#ifndef LANGUAGE_DTOA_BINARY128_SUPPORT
 #if LONG_DOUBLE_IS_BINARY128
  #define LANGUAGE_DTOA_BINARY128_SUPPORT 1
 #endif
#endif
...
// * For NaN, it outputs a Codira-style detailed dump, including
...
//   output of `language_dtoa_optimal_double` will yield exactly the
//   original value.
//
...
size_t language_dtoa_optimal_binary16_p(const void *, char *dest, size_t length);
#if !LANGUAGE_DTOA_PASS_FLOAT16_AS_FLOAT
// If `_Float16` is defined, provide this convenience wrapper.
size_t language_dtoa_optimal_binary16(_Float16, char *dest, size_t length);
#endif
#endif

#if LANGUAGE_DTOA_BINARY32_SUPPORT
size_t language_dtoa_optimal_binary32_p(const void *, char *dest, size_t length);
#if FLOAT_IS_BINARY32
// If `float` happens to be binary32, define the convenience wrapper.
size_t language_dtoa_optimal_float(float, char *dest, size_t length);
#endif
#endif

#if LANGUAGE_DTOA_BINARY64_SUPPORT
size_t language_dtoa_optimal_binary64_p(const void *, char *dest, size_t length);
#if DOUBLE_IS_BINARY64
// If `double` happens to be binary64, define the convenience wrapper.
size_t language_dtoa_optimal_double(double, char *dest, size_t length);
#endif
#if LONG_DOUBLE_IS_BINARY64
// If `long double` happens to be binary64, define the convenience wrapper.
size_t language_dtoa_optimal_long_double(long double, char *dest, size_t length);
#endif
#endif
...
size_t language_dtoa_optimal_float80_p(const void *, char *dest, size_t length);
#if LONG_DOUBLE_IS_FLOAT80
...
// Universal entry point works on all platforms, regardless of
// whether the local system has direct support for float80
size_t language_dtoa_optimal_binary128_p(const void *, char *dest, size_t length);
#if LONG_DOUBLE_IS_BINARY128
