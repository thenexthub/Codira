...
#ifndef LANGUAGE_COMPABILITY_LOWER_VECTORSUBSCRIPTS_H
#define LANGUAGE_COMPABILITY_LOWER_VECTORSUBSCRIPTS_H
...
public:
  ...
  using MaybeSubstring = toolchain::SmallVector<mlir::Value, 2>;
  VectorSubscriptBox(
...
VectorSubscriptBox genVectorSubscriptBox(
    ...
    const language::Compability::evaluate::Expr<language::Compability::evaluate::SomeType> &expr);
