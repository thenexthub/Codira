...
//===----------------------------------------------------------------------===//
///
/// Implements the conversion from language::Compability::evaluate::Expr trees to FIR.
///
//===----------------------------------------------------------------------===//

#ifndef LANGUAGE_COMPABILITY_LOWER_CONVERTEXPR_H
#define LANGUAGE_COMPABILITY_LOWER_CONVERTEXPR_H
...
void createArrayOfPointerAssignment(
    ...
    std::optional<toolchain::SmallVector<mlir::Value>> ubounds, SymMap &symMap,
    StatementContext &stmtCtx);
