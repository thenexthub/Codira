...
#ifndef LANGUAGE_COMPABILITY_OPTIMIZER_CODEGEN_TBAABUILDER_H
#define LANGUAGE_COMPABILITY_OPTIMIZER_CODEGEN_TBAABUILDER_H
...
// type conversion and to attach toolchain.tbaa attributes to memory access
// instructions.
//
...
//   toolchain.metadata @__flang_tbaa {
//     toolchain.tbaa_root @root_0 {id = "Flang Type TBAA Function Root funcName"}
//     toolchain.tbaa_type_desc @type_desc_1 {id = "any access",
//                                       members = {<@root_0, 0>}}
//     toolchain.tbaa_type_desc @type_desc_2 {id = "any data access",
//                                       members = {<@type_desc_1, 0>}}
//     toolchain.tbaa_type_desc @type_desc_3 {id = "descriptor member",
//                                       members = {<@type_desc_1, 0>}}
//   }
//
...
//   toolchain.tbaa_type_desc @type_desc_4 {
//       id = "CFI_cdesc_t_dim0",
...
//   }
//   toolchain.tbaa_type_desc @type_desc_5 {
//       id = "CFI_cdesc_t_dim1",
//       members = {<@type_desc_3, 0>, // base_addr
//                  <@type_desc_3, 8>, // elem_len
//                  <@type_desc_3, 16>, // version
...
//   }
//   toolchain.tbaa_type_desc @type_desc_6 {
//       id = "CFI_cdesc_t_dim2",
//       members = {<@type_desc_3, 0>, // base_addr
//                  <@type_desc_3, 8>, // elem_len
//                  <@type_desc_3, 16>, // version
...
//   * offset:
//       toolchain.getelementptr %arg0[0, 0] :
//           (!toolchain.ptr<struct<(ptr<f32>, i64, i32, i8, i8, i8, i8,
//                              array<1 x array<3 x i64>>)>>) ->
//           !toolchain.ptr<ptr<f32>>
...
public:
  ...
  // Attach the toolchain.tbaa attribute to the given memory accessing operation
...
private:
  ...
  toolchain::DenseMap<mlir::Type, mlir::LLVM::TBAATypeDescriptorAttr> typeDescMap;
