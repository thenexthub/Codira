...
#ifndef LANGUAGE_COMPABILITY_OPTIMIZER_DIALECT_FORTRANVARIABLEINTERFACE_H
#define LANGUAGE_COMPABILITY_OPTIMIZER_DIALECT_FORTRANVARIABLEINTERFACE_H
...
#include "language/Compability/Optimizer/Dialect/FortranVariableInterface.h.inc"
