...
#ifndef LANGUAGE_COMPABILITY_OPTIMIZER_DIALECT_FIRTYPE_H
#define LANGUAGE_COMPABILITY_OPTIMIZER_DIALECT_FIRTYPE_H
...
#include "language/Compability/Optimizer/Dialect/FIROpsTypes.h.inc"
...
// These isa_ routines follow the precedent of toolchain::isa_or_null<>
...
/// Convert toolchain::Type::TypeID to mlir::Type
mlir::Type fromRealTypeID(mlir::MLIRContext *context, toolchain::Type::TypeID typeID,
                          fir::KindTy kind);
