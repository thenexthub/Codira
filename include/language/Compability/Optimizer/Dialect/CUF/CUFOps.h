...
#ifndef LANGUAGE_COMPABILITY_OPTIMIZER_DIALECT_CUF_CUFOPS_H
#define LANGUAGE_COMPABILITY_OPTIMIZER_DIALECT_CUF_CUFOPS_H
...
#include "language/Compability/Optimizer/Dialect/CUF/CUFOps.h.inc"
