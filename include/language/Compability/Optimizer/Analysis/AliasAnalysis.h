...
#ifndef LANGUAGE_COMPABILITY_OPTIMIZER_ANALYSIS_ALIASANALYSIS_H
#define LANGUAGE_COMPABILITY_OPTIMIZER_ANALYSIS_ALIASANALYSIS_H
...
struct AliasAnalysis {
  ...
  // See
  // https://discourse.toolchain.org/t/rfc-distinguish-between-data-and-non-data-in-fir-alias-analysis/78759/1
  //
  ...
  struct Source {
    using SourceUnion = toolchain::PointerUnion<mlir::SymbolRefAttr, mlir::Value>;
    using Attributes = language::Compability::common::EnumSet<Attribute, Attribute_enumSize>;
