...
#ifndef LANGUAGE_COMPABILITY_OPTIMIZER_HLFIR_HLFIRDIALECT_H
#define LANGUAGE_COMPABILITY_OPTIMIZER_HLFIR_HLFIRDIALECT_H
...
#include "language/Compability/Optimizer/HLFIR/HLFIRDialect.h.inc"

#include "language/Compability/Optimizer/HLFIR/HLFIREnums.h.inc"

#define GET_TYPEDEF_CLASSES
#include "language/Compability/Optimizer/HLFIR/HLFIRTypes.h.inc"

#define GET_ATTRDEF_CLASSES
#include "language/Compability/Optimizer/HLFIR/HLFIRAttributes.h.inc"
...
inline bool isFortranPointerObjectType(mlir::Type type) {
  auto boxTy =
      toolchain::dyn_cast_or_null<fir::BaseBoxType>(fir::dyn_cast_ptrEleTy(type));
