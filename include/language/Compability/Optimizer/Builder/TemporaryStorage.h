...
#ifndef LANGUAGE_COMPABILITY_OPTIMIZER_BUILDER_TEMPORARYSTORAGE_H
#define LANGUAGE_COMPABILITY_OPTIMIZER_BUILDER_TEMPORARYSTORAGE_H
...
public:
  SimpleCopy(mlir::Location loc, fir::FirOpBuilder &builder,
             hlfir::Entity source, toolchain::StringRef tempName);
