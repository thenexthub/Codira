...
#ifndef LANGUAGE_COMPABILITY_OPTIMIZER_BUILDER_HLFIRTOOLS_H
#define LANGUAGE_COMPABILITY_OPTIMIZER_BUILDER_HLFIRTOOLS_H
...
toolchain::SmallVector<mlir::Value> genLowerbounds(mlir::Location loc,
                                              fir::FirOpBuilder &builder,
...
toolchain::SmallVector<mlir::Value> getIndexExtents(mlir::Location loc,
                                               fir::FirOpBuilder &builder,
                                               mlir::Value shape);
...
using ReductionLoopBodyGenerator = std::function<toolchain::SmallVector<mlir::Value>(
...
toolchain::SmallVector<mlir::Value> genLoopNestWithReductions(
