...
#ifndef LANGUAGE_COMPABILITY_OPTIMIZER_BUILDER_FIRBUILDER_H
#define LANGUAGE_COMPABILITY_OPTIMIZER_BUILDER_FIRBUILDER_H
...
inline mlir::Type getIntPtrType(mlir::OpBuilder &builder) {
  ...
  // toolchain::DataLayout::getPointerSizeInBits here.
...
public:
  ...
  mlir::SymbolRefAttr getSymbolRefAttr(toolchain::StringRef str) {
  ...
  mlir::Value allocateLocal(mlir::Location loc, mlir::Type ty,
                            toolchain::StringRef uniqName, toolchain::StringRef name,
                            bool pinned, toolchain::ArrayRef<mlir::Value> shape,
  ...
  mlir::Value createTemporaryAlloc(
      ...
      std::optional<language::Compability::common::CUDADataAttr> cudaAttr = std::nullopt);
  ...
  mlir::Value createTemporary(mlir::Location loc, mlir::Type type,
    ...
    return createTemporary(loc, type, toolchain::StringRef{}, shape);
  }

  mlir::Value createTemporary(mlir::Location loc, mlir::Type type,
                              toolchain::ArrayRef<mlir::NamedAttribute> attrs) {
    return createTemporary(loc, type, toolchain::StringRef{}, {}, {}, attrs);
  }
  ...
  createHeapTemporary(mlir::Location loc, mlir::Type type,
                      toolchain::StringRef name = {}, mlir::ValueRange shape = {},
  ...
  createArrayTemp(mlir::Location loc, fir::SequenceType arrayType,
                  mlir::Value shape, toolchain::ArrayRef<mlir::Value> extents,
                  toolchain::ArrayRef<mlir::Value> typeParams,
                  const std::function<decltype(genTempDeclareOp)> &genDeclare,
                  mlir::Value polymorphicMold, bool useStack = false,
                  toolchain::StringRef tmpName = ".tmp.array") {
  ...
  fir::GlobalOp createGlobal(mlir::Location loc, mlir::Type type,
                             toolchain::StringRef name, bool isConst, bool isTarget,
  ...
  mlir::func::FuncOp getNamedFunction(toolchain::StringRef name) {
  ...
  fir::GlobalOp getNamedGlobal(toolchain::StringRef name) {
  ...
  mlir::func::FuncOp createFunction(mlir::Location loc, toolchain::StringRef name,
  ...
  mlir::Value genShape(mlir::Location loc, toolchain::ArrayRef<mlir::Value> shift,
                       toolchain::ArrayRef<mlir::Value> exts);
  mlir::Value genShape(mlir::Location loc, toolchain::ArrayRef<mlir::Value> exts);
  mlir::Value genShift(mlir::Location loc, toolchain::ArrayRef<mlir::Value> shift);
  ...
  mlir::Value createBox(mlir::Location loc, mlir::Type boxType,
                        ...
                        toolchain::ArrayRef<mlir::Value> lengths, mlir::Value tdesc);
  ...
  /// config.
  void setFastMathFlags(language::Compability::common::MathOptionsBase options);
...
toolchain::SmallVector<mlir::Value> readExtents(fir::FirOpBuilder &builder,
                                           mlir::Location loc,
...
std::string uniqueCGIdent(toolchain::StringRef prefix, toolchain::StringRef name);

/// Lowers the extents from the sequence type to Values.
/// Any unknown extents are lowered to undefined values.
toolchain::SmallVector<mlir::Value> createExtents(fir::FirOpBuilder &builder,
                                             mlir::Location loc,
...
mlir::Value genLenOfCharacter(fir::FirOpBuilder &builder, mlir::Location loc,
                              ...
                              toolchain::ArrayRef<mlir::Value> path,
                              toolchain::ArrayRef<mlir::Value> substring);
mlir::Value genLenOfCharacter(fir::FirOpBuilder &builder, mlir::Location loc,
...
toolchain::SmallVector<mlir::Value> deduceOptimalExtents(mlir::ValueRange extents1,
...
toolchain::SmallVector<mlir::Value> updateRuntimeExtentsForEmptyArrays(
