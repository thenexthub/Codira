...
#ifndef LANGUAGE_COMPABILITY_OPTIMIZER_BUILDER_RUNTIME_RTBUILDER_H
#define LANGUAGE_COMPABILITY_OPTIMIZER_BUILDER_RUNTIME_RTBUILDER_H
...
#include "language/Compability/Runtime/reduce.h"
...
#define REDUCTION_REF_OPERATION_MODEL(T)                                       \
  ...
  getModel<language::Compability::runtime::ReferenceReductionOperation<T>>() {               \
...
#define REDUCTION_VALUE_OPERATION_MODEL(T)                                     \
  template <>                                                                  \
  constexpr TypeBuilderFunc                                                    \
  getModel<language::Compability::runtime::ValueReductionOperation<T>>() {                   \
    return [](mlir::MLIRContext *context) -> mlir::Type {                      \
      TypeBuilderFunc f{getModel<T>()};                                        \
      auto refTy = fir::ReferenceType::get(f(context));                        \
...
#define REDUCTION_CHAR_OPERATION_MODEL(T)                                      \
  template <>                                                                  \
  constexpr TypeBuilderFunc                                                    \
  getModel<language::Compability::runtime::ReductionCharOperation<T>>() {                    \
    return [](mlir::MLIRContext *context) -> mlir::Type {                      \
      TypeBuilderFunc f{getModel<T>()};                                        \
...
template <>
constexpr TypeBuilderFunc getModel<language::Compability::common::int128_t>() {
  return [](mlir::MLIRContext *context) -> mlir::Type {
    return mlir::IntegerType::get(context,
                                  8 * sizeof(language::Compability::common::int128_t));
  };
}
template <>
constexpr TypeBuilderFunc getModel<long long &>() {
...
constexpr TypeBuilderFunc getModel<long double>() {
  return [](mlir::MLIRContext *context) -> mlir::Type {
    ...
    if constexpr (size == 8)
      return mlir::Float64Type::get(context);
    toolchain_unreachable("failed static assert");
  };
}
template <>
constexpr TypeBuilderFunc getModel<long double *>() {
...
template <>
constexpr TypeBuilderFunc getModel<language::Compability::common::uint128_t>() {
  return getModel<language::Compability::common::int128_t>();
}
template <>
constexpr TypeBuilderFunc getModel<language::Compability::common::int128_t *>() {
  return [](mlir::MLIRContext *context) -> mlir::Type {
    TypeBuilderFunc f{getModel<language::Compability::common::int128_t>()};
    return fir::ReferenceType::get(f(context));
  };
}
template <>
...
template <>
constexpr TypeBuilderFunc getModel<const language::Compability::common::uint128_t *>() {
  return getModel<language::Compability::common::uint128_t *>();
}
...
template <>
constexpr TypeBuilderFunc getModel<const language::Compability::runtime::Descriptor &>() {
  return [](mlir::MLIRContext *context) -> mlir::Type {
    return fir::BoxType::get(mlir::NoneType::get(context));
  };
}
template <>
constexpr TypeBuilderFunc getModel<language::Compability::runtime::Descriptor &>() {
  return [](mlir::MLIRContext *context) -> mlir::Type {
    return fir::ReferenceType::get(
...
template <>
constexpr TypeBuilderFunc getModel<const language::Compability::runtime::Descriptor *>() {
  return getModel<const language::Compability::runtime::Descriptor &>();
}
template <>
constexpr TypeBuilderFunc getModel<language::Compability::runtime::Descriptor *>() {
  return getModel<language::Compability::runtime::Descriptor &>();
}
template <>
constexpr TypeBuilderFunc getModel<language::Compability::common::TypeCategory>() {
  return [](mlir::MLIRContext *context) -> mlir::Type {
    return mlir::IntegerType::get(context,
                                  sizeof(language::Compability::common::TypeCategory) * 8);
  };
}
template <>
constexpr TypeBuilderFunc
getModel<const language::Compability::runtime::typeInfo::DerivedType &>() {
  return [](mlir::MLIRContext *context) -> mlir::Type {
...
template <>
constexpr TypeBuilderFunc getModel<language::Compability::runtime::io::IoStatementState *>() {
  return getModel<char *>();
}
template <>
constexpr TypeBuilderFunc getModel<language::Compability::runtime::io::Iostat>() {
  return [](mlir::MLIRContext *context) -> mlir::Type {
    return mlir::IntegerType::get(context,
                                  8 * sizeof(language::Compability::runtime::io::Iostat));
  };
}
template <>
constexpr TypeBuilderFunc
getModel<const language::Compability::runtime::io::NamelistGroup &>() {
  return [](mlir::MLIRContext *context) -> mlir::Type {
...
template <>
constexpr TypeBuilderFunc
getModel<const language::Compability::runtime::io::NonTbpDefinedIoTable *>() {
  return [](mlir::MLIRContext *context) -> mlir::Type {
    return fir::ReferenceType::get(mlir::TupleType::get(context));
  };
}
...
REDUCTION_REF_OPERATION_MODEL(language::Compability::common::int128_t)
REDUCTION_VALUE_OPERATION_MODEL(language::Compability::common::int128_t)
...
REDUCTION_REF_OPERATION_MODEL(language::Compability::common::uint128_t)
REDUCTION_VALUE_OPERATION_MODEL(language::Compability::common::uint128_t)
...
// implementation for it. https://github.com/toolchain/toolchain-project/issues/110674
template <>
constexpr TypeBuilderFunc
getModel<language::Compability::runtime::ValueReductionOperation<std::complex<float>>>() {
  return [](mlir::MLIRContext *context) -> mlir::Type {
...
template <>
constexpr TypeBuilderFunc
getModel<language::Compability::runtime::ValueReductionOperation<std::complex<double>>>() {
  return [](mlir::MLIRContext *context) -> mlir::Type {
...
template <>
constexpr TypeBuilderFunc
getModel<language::Compability::runtime::ReferenceReductionOperation<std::complex<float>>>() {
  return [](mlir::MLIRContext *context) -> mlir::Type {
    mlir::Type cplx = mlir::ComplexType::get(getModel<float>()(context));
    auto refTy = fir::ReferenceType::get(cplx);
    return mlir::FunctionType::get(context, {refTy, refTy}, refTy);
...
constexpr TypeBuilderFunc getModel<
    language::Compability::runtime::ReferenceReductionOperation<std::complex<double>>>() {
  return [](mlir::MLIRContext *context) -> mlir::Type {
    mlir::Type cplx = mlir::ComplexType::get(getModel<double>()(context));
    auto refTy = fir::ReferenceType::get(cplx);
    return mlir::FunctionType::get(context, {refTy, refTy}, refTy);
...
template <>
constexpr TypeBuilderFunc
getModel<language::Compability::runtime::ReductionDerivedTypeOperation>() {
  return [](mlir::MLIRContext *context) -> mlir::Type {
    auto voidTy =
        fir::LLVMPointerType::get(context, mlir::IntegerType::get(context, 8));
...
struct RuntimeTableKey<RT(ATs...)> {
  static constexpr FuncTypeBuilderFunc getTypeModel() {
    return [](mlir::MLIRContext *ctxt) {
      ...
      toolchain::SmallVector<mlir::Type, sizeof...(ATs)> argTys;
      for (auto f : args)
...
createArguments(fir::FirOpBuilder &builder, mlir::Location loc,
                mlir::FunctionType fTy, toolchain::ArrayRef<mlir::Value> args) {
  return toolchain::map_to_vector(toolchain::zip_equal(fTy.getInputs(), args),
