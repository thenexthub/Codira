...
#ifndef LANGUAGE_COMPABILITY_OPTIMIZER_BUILDER_MUTABLEBOX_H
#define LANGUAGE_COMPABILITY_OPTIMIZER_BUILDER_MUTABLEBOX_H
...
void genInlinedAllocation(fir::FirOpBuilder &builder, mlir::Location loc,
                          ...
                          mlir::ValueRange lenParams, toolchain::StringRef allocName,
