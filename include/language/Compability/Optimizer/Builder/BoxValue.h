...
#ifndef LANGUAGE_COMPABILITY_OPTIMIZER_BUILDER_BOXVALUE_H
#define LANGUAGE_COMPABILITY_OPTIMIZER_BUILDER_BOXVALUE_H
...
toolchain::raw_ostream &operator<<(toolchain::raw_ostream &, const CharBoxValue &);
toolchain::raw_ostream &operator<<(toolchain::raw_ostream &, const ArrayBoxValue &);
toolchain::raw_ostream &operator<<(toolchain::raw_ostream &, const CharArrayBoxValue &);
toolchain::raw_ostream &operator<<(toolchain::raw_ostream &, const ProcBoxValue &);
toolchain::raw_ostream &operator<<(toolchain::raw_ostream &, const MutableBoxValue &);
toolchain::raw_ostream &operator<<(toolchain::raw_ostream &, const BoxValue &);
toolchain::raw_ostream &operator<<(toolchain::raw_ostream &, const PolymorphicValue &);
...
public:
  ...
  friend toolchain::raw_ostream &operator<<(toolchain::raw_ostream &,
                                       const CharBoxValue &);
  LLVM_DUMP_METHOD void dump() const { toolchain::errs() << *this; }
...
protected:
  toolchain::SmallVector<mlir::Value, 4> extents;
  toolchain::SmallVector<mlir::Value, 4> lbounds;
};
...
public:
  ArrayBoxValue(mlir::Value addr, toolchain::ArrayRef<mlir::Value> extents,
                toolchain::ArrayRef<mlir::Value> lbounds = {},
                mlir::Value sourceBox = {})
...
public:
  ...
  AbstractIrBox(mlir::Value addr, toolchain::ArrayRef<mlir::Value> lbounds,
                toolchain::ArrayRef<mlir::Value> extents)
...
public:
  ...
  BoxValue(mlir::Value addr, toolchain::ArrayRef<mlir::Value> lbounds,
  ...
  friend toolchain::raw_ostream &operator<<(toolchain::raw_ostream &, const BoxValue &);
  LLVM_DUMP_METHOD void dump() const { toolchain::errs() << *this; }

  toolchain::ArrayRef<mlir::Value> getLBounds() const { return lbounds; }
  ...
  toolchain::ArrayRef<mlir::Value> getExplicitExtents() const { return extents; }

  toolchain::ArrayRef<mlir::Value> getExplicitParameters() const {
...
protected:
  ...
  toolchain::SmallVector<mlir::Value, 2> explicitParams;
};
...
public:
  ...
  mlir::Value addr;
  toolchain::SmallVector<mlir::Value, 2> extents;
  toolchain::SmallVector<mlir::Value, 2> lbounds;
  ...
  toolchain::SmallVector<mlir::Value, 2> deferredParams;
};
...
public:
  ...
  toolchain::ArrayRef<mlir::Value> nonDeferredLenParams() const { return lenParams; }
  friend toolchain::raw_ostream &operator<<(toolchain::raw_ostream &,
...
toolchain::raw_ostream &operator<<(toolchain::raw_ostream &, const ExtendedValue &);
...
toolchain::SmallVector<mlir::Value> getTypeParams(const ExtendedValue &exv);
...
toolchain::SmallVector<mlir::Value> getTypeParams(mlir::Location loc,
