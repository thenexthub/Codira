...
#ifndef LANGUAGE_COMPABILITY_OPTIMIZER_BUILDER_CHARACTER_H
#define LANGUAGE_COMPABILITY_OPTIMIZER_BUILDER_CHARACTER_H
...
public:
  ...
  fir::CharBoxValue
  createCharExtremum(bool predIsMin, toolchain::ArrayRef<fir::CharBoxValue> opCBVs);
