...
#ifndef LANGUAGE_COMPABILITY_LOWER_INTRINSICCALL_H
#define LANGUAGE_COMPABILITY_LOWER_INTRINSICCALL_H
...
#include "language/Compability/Optimizer/Builder/Runtime/Numeric.h"
...
genIntrinsicCall(fir::FirOpBuilder &, mlir::Location, toolchain::StringRef name,
...
enum class ExtremumBehavior {
  ...
  // Compilers: xlf (only for MAX), ifort, pgfortran -notoolchain, and nagfor.
  PgfortranLlvm,
  // "Opposite of" x86 minss/maxss behavior:
  // If the first argument is a number and the other is NaN, return the
  // number.
  // In all other cases where at least one operand is NaN, return NaN.
  // Compilers: xlf (only for MIN), and pgfortran (with toolchain).
  IeeeMinMaxNum
...
struct IntrinsicLibrary {
  ...
  std::pair<fir::ExtendedValue, bool>
  genIntrinsicCall(toolchain::StringRef name, std::optional<mlir::Type> resultType,
                   toolchain::ArrayRef<fir::ExtendedValue> arg);
  ...
  mlir::Value genRuntimeCall(toolchain::StringRef name, mlir::Type,
                             toolchain::ArrayRef<mlir::Value>);

  using RuntimeCallGenerator = std::function<mlir::Value(
      fir::FirOpBuilder &, mlir::Location, toolchain::ArrayRef<mlir::Value>)>;
  RuntimeCallGenerator
  getRuntimeCallGenerator(toolchain::StringRef name,
                          mlir::FunctionType soughtFuncType);

  void genAbort(toolchain::ArrayRef<fir::ExtendedValue>);
  /// Lowering for the ABS intrinsic. The ABS intrinsic expects one argument in
  /// the toolchain::ArrayRef. The ABS intrinsic is lowered into MLIR/FIR operation
  /// if the argument is an integer, into toolchain intrinsics if the argument is
  /// real and to the `hypot` math routine if the argument is of complex type.
  mlir::Value genAbs(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genAcosd(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genAcospi(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  ...
  mlir::Value genAimag(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genAint(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genAll(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genAllocated(mlir::Type,
                                  toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genAnint(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genAny(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genAtanpi(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genAtomicAdd(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genAtomicAnd(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genAtomicCas(mlir::Type,
                                  toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genAtomicDec(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genAtomicExch(mlir::Type,
                                   toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genAtomicInc(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genAtomicMax(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genAtomicMin(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genAtomicOr(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genAtomicSub(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genAtomicXor(mlir::Type,
                                  toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue
      genCommandArgumentCount(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genAsind(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genAsinpi(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genAssociated(mlir::Type,
                                   toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genAtand(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  ...
  mlir::Value genBitwiseCompare(mlir::Type resultType,
                                toolchain::ArrayRef<mlir::Value> args);

  mlir::Value genBtest(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genCeiling(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genChar(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genChdir(std::optional<mlir::Type> resultType,
                              toolchain::ArrayRef<fir::ExtendedValue>);
  template <mlir::arith::CmpIPredicate pred>
  fir::ExtendedValue genCharacterCompare(mlir::Type,
                                         toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genCmplx(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genConjg(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genCount(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  void genCpuTime(toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genCshift(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  ...
  fir::ExtendedValue genCAssociatedCPtr(mlir::Type,
                                        toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genCDevLoc(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genErfcScaled(mlir::Type resultType,
                            toolchain::ArrayRef<mlir::Value> args);
  void genCFPointer(toolchain::ArrayRef<fir::ExtendedValue>);
  void genCFProcPointer(toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genCFunLoc(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genCLoc(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  template <mlir::arith::CmpIPredicate pred>
  fir::ExtendedValue genCPtrCompare(mlir::Type,
                                    toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genCosd(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genCospi(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  void genDateAndTime(toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genDim(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genDotProduct(mlir::Type,
                                   toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genDprod(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genDshiftl(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genDshiftr(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genEoshift(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  void genExit(toolchain::ArrayRef<fir::ExtendedValue>);
  void genExecuteCommandLine(mlir::ArrayRef<fir::ExtendedValue> args);
  fir::ExtendedValue genEtime(std::optional<mlir::Type>,
                              mlir::ArrayRef<fir::ExtendedValue> args);
  mlir::Value genExponent(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genExtendsTypeOf(mlir::Type,
                                      toolchain::ArrayRef<fir::ExtendedValue>);
  template <Extremum, ExtremumBehavior>
  mlir::Value genExtremum(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genFloor(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  ...
  void genGetEnvironmentVariable(toolchain::ArrayRef<fir::ExtendedValue>);
  ...
  fir::ExtendedValue genHostnm(std::optional<mlir::Type> resultType,
                               toolchain::ArrayRef<fir::ExtendedValue> args);
  fir::ExtendedValue genIall(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genIand(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genIany(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genIbclr(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genIbits(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genIbset(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genIchar(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genFindloc(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genIeeeClass(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genIeeeCopySign(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  void genIeeeGetFlag(toolchain::ArrayRef<fir::ExtendedValue>);
  void genIeeeGetHaltingMode(toolchain::ArrayRef<fir::ExtendedValue>);
  template <bool isGet, bool isModes>
  void genIeeeGetOrSetModesOrStatus(toolchain::ArrayRef<fir::ExtendedValue>);
  void genIeeeGetRoundingMode(toolchain::ArrayRef<fir::ExtendedValue>);
  void genIeeeGetUnderflowMode(toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genIeeeInt(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genIeeeIsFinite(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genIeeeIsNan(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genIeeeIsNegative(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genIeeeIsNormal(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genIeeeLogb(mlir::Type, mlir::ArrayRef<mlir::Value>);
  template <bool isMax, bool isNum, bool isMag>
  mlir::Value genIeeeMaxMin(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  template <mlir::arith::CmpFPredicate pred>
  mlir::Value genIeeeQuietCompare(mlir::Type resultType,
                                  toolchain::ArrayRef<mlir::Value>);
  mlir::Value genIeeeReal(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genIeeeRem(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genIeeeRint(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  template <bool isFlag>
  void genIeeeSetFlagOrHaltingMode(toolchain::ArrayRef<fir::ExtendedValue>);
  void genIeeeSetRoundingMode(toolchain::ArrayRef<fir::ExtendedValue>);
  void genIeeeSetUnderflowMode(toolchain::ArrayRef<fir::ExtendedValue>);
  template <mlir::arith::CmpFPredicate pred>
  mlir::Value genIeeeSignalingCompare(mlir::Type resultType,
                                      toolchain::ArrayRef<mlir::Value>);
  mlir::Value genIeeeSignbit(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  ...
  fir::ExtendedValue genIeeeSupportStandard(mlir::Type,
                                            toolchain::ArrayRef<fir::ExtendedValue>);
  template <mlir::arith::CmpIPredicate pred>
  mlir::Value genIeeeTypeCompare(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genIeeeUnordered(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genIeeeValue(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genIeor(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genIndex(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genIor(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genIparity(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genIsContiguous(mlir::Type,
                                     toolchain::ArrayRef<fir::ExtendedValue>);
  template <language::Compability::runtime::io::Iostat value>
  mlir::Value genIsIostatValue(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genIsFPClass(mlir::Type, toolchain::ArrayRef<mlir::Value>,
                           int fpclass);
  mlir::Value genIshft(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genIshftc(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genLbound(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genLeadz(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genLen(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genLenTrim(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genLoc(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genMalloc(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  template <typename Shift>
  mlir::Value genMask(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genMatchAllSync(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genMatchAnySync(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genMatmul(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genMatmulTranspose(mlir::Type,
                                        toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genMaxloc(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genMaxval(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genMerge(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genMergeBits(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genMinloc(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genMinval(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genMod(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genModulo(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  void genMoveAlloc(toolchain::ArrayRef<fir::ExtendedValue>);
  void genMvbits(toolchain::ArrayRef<fir::ExtendedValue>);
  enum class NearestProc { Nearest, NextAfter, NextDown, NextUp };
  template <NearestProc>
  mlir::Value genNearest(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genNint(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genNorm2(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genNot(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genNull(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  template <typename OpTy>
  mlir::Value genNVVMTime(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genPack(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genParity(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  void genPerror(toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genPopcnt(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genPoppar(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genPresent(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genProduct(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genPutenv(std::optional<mlir::Type>,
                               toolchain::ArrayRef<fir::ExtendedValue>);
  void genRandomInit(toolchain::ArrayRef<fir::ExtendedValue>);
  void genRandomNumber(toolchain::ArrayRef<fir::ExtendedValue>);
  void genRandomSeed(toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genReduce(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  ...
  fir::ExtendedValue genRepeat(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genReshape(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genRRSpacing(mlir::Type resultType,
                           toolchain::ArrayRef<mlir::Value> args);
  fir::ExtendedValue genSameTypeAs(mlir::Type,
                                   toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genScale(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genScan(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genSecond(std::optional<mlir::Type>,
                               mlir::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genSelectedCharKind(mlir::Type,
                                         toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genSelectedIntKind(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genSelectedLogicalKind(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genSelectedRealKind(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genSetExponent(mlir::Type resultType,
                             toolchain::ArrayRef<mlir::Value> args);
  fir::ExtendedValue genShape(mlir::Type resultType,
                              toolchain::ArrayRef<fir::ExtendedValue>);
  template <typename Shift>
  mlir::Value genShift(mlir::Type resultType, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genShiftA(mlir::Type resultType, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genSign(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genSind(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genSinpi(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genSize(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genSizeOf(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genSpacing(mlir::Type resultType,
                         toolchain::ArrayRef<mlir::Value> args);
  fir::ExtendedValue genSpread(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genStorageSize(mlir::Type,
                                    toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genSum(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  void genSignalSubroutine(toolchain::ArrayRef<fir::ExtendedValue>);
  void genSleep(toolchain::ArrayRef<fir::ExtendedValue>);
  void genSyncThreads(toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genSyncThreadsAnd(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genSyncThreadsCount(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genSyncThreadsOr(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  void genSyncWarp(toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genSystem(std::optional<mlir::Type>,
                               mlir::ArrayRef<fir::ExtendedValue> args);
  void genSystemClock(toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genTand(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genTanpi(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genTime(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genTrailz(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  fir::ExtendedValue genTransfer(mlir::Type,
                                 toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genTranspose(mlir::Type,
                                  toolchain::ArrayRef<fir::ExtendedValue>);
  mlir::Value genThisGrid(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genThisThreadBlock(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  mlir::Value genThisWarp(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  void genThreadFence(toolchain::ArrayRef<fir::ExtendedValue>);
  void genThreadFenceBlock(toolchain::ArrayRef<fir::ExtendedValue>);
  void genThreadFenceSystem(toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genTrim(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genUbound(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genUnlink(std::optional<mlir::Type> resultType,
                               toolchain::ArrayRef<fir::ExtendedValue> args);
  fir::ExtendedValue genUnpack(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  fir::ExtendedValue genVerify(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue>);
  template <mlir::NVVM::VoteSyncKind kind>
  mlir::Value genVoteSync(mlir::Type, toolchain::ArrayRef<mlir::Value>);

  /// Implement all conversion functions like DBLE, the first argument is
  /// the value to convert. There may be an additional KIND arguments that
  /// is ignored because this is already reflected in the result type.
  mlir::Value genConversion(mlir::Type, toolchain::ArrayRef<mlir::Value>);
  ...
  fir::ExtendedValue genExtremumloc(FN func, FD funcDim, toolchain::StringRef errMsg,
                                    mlir::Type,
                                    toolchain::ArrayRef<fir::ExtendedValue>);
  ...
  fir::ExtendedValue genExtremumVal(FN func, FD funcDim, FC funcChar,
                                    toolchain::StringRef errMsg,
                                    mlir::Type resultType,
                                    toolchain::ArrayRef<fir::ExtendedValue> args);
  /// Process calls to Product, Sum, IAll, IAny, IParity intrinsic functions
  template <typename FN, typename FD>
  fir::ExtendedValue genReduction(FN func, FD funcDim, toolchain::StringRef errMsg,
                                  mlir::Type resultType,
                                  toolchain::ArrayRef<fir::ExtendedValue> args);
  ...
  mlir::Value outlineInWrapper(GeneratorType, toolchain::StringRef name,
                               mlir::Type resultType,
                               toolchain::ArrayRef<mlir::Value> args);
  template <typename GeneratorType>
  fir::ExtendedValue
  outlineInExtendedWrapper(GeneratorType, toolchain::StringRef name,
                           std::optional<mlir::Type> resultType,
                           toolchain::ArrayRef<fir::ExtendedValue> args);

  template <typename GeneratorType>
  mlir::func::FuncOp getWrapper(GeneratorType, toolchain::StringRef name,
                                mlir::FunctionType,
  ...
  template <typename GeneratorType>
  fir::ExtendedValue
  genElementalCall(GeneratorType, toolchain::StringRef name, mlir::Type resultType,
                   toolchain::ArrayRef<fir::ExtendedValue> args, bool outline);
  ...
  mlir::SymbolRefAttr
  getUnrestrictedIntrinsicSymbolRefAttr(toolchain::StringRef name,
...
struct RuntimeFunction {
  // toolchain::StringRef comparison operator are not constexpr, so use string_view.
...
struct MathOperation {
  ...
  // Name of a runtime function that implements the operation.
  toolchain::StringRef runtimeFunc;
...
static inline mlir::Type getTypeHelper(mlir::MLIRContext *context,
  ...
  case ParamTypeId::Void:
    toolchain::report_fatal_error("can not get type of void");
    break;
...
static inline mlir::FunctionType genFuncType(mlir::MLIRContext *context,
                                             fir::FirOpBuilder &builder) {
  toolchain::SmallVector<ParamTypeId> argTys = {ArgTys::ty...};
  toolchain::SmallVector<int> argKinds = {ArgTys::kind...};
  toolchain::SmallVector<mlir::Type> argTypes;
...
getBasesForArgs(toolchain::ArrayRef<fir::ExtendedValue> args) {
  toolchain::SmallVector<mlir::Value, 4> baseVec;
  for (auto arg : args)
    baseVec.push_back(getBase(arg));
  return baseVec;
}

static inline toolchain::SmallVector<mlir::Type, 4>
getTypesForArgs(toolchain::ArrayRef<mlir::Value> args) {
  toolchain::SmallVector<mlir::Type, 4> typeVec;
  for (auto arg : args)
...
lookupIntrinsicHandler(fir::FirOpBuilder &, toolchain::StringRef intrinsicName,
                       std::optional<mlir::Type> resultType);

/// Generate a TODO error message for an as yet unimplemented intrinsic.
void crashOnMissingIntrinsic(mlir::Location loc, toolchain::StringRef name);
...
getIntrinsicArgumentLowering(toolchain::StringRef intrinsicName);
