//===-- language/Compability/Semantics/scope.h -------------------------*- C++ -*-===//
//
...
#ifndef LANGUAGE_COMPABILITY_SEMANTICS_SCOPE_H_
#define LANGUAGE_COMPABILITY_SEMANTICS_SCOPE_H_
...
private:
  ...
  friend toolchain::raw_ostream &operator<<(toolchain::raw_ostream &, const Scope &);
};
