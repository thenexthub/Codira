//===-- language/Compability/Semantics/semantics.h ---------------------*- C++ -*-===//
//
...
#ifndef LANGUAGE_COMPABILITY_SEMANTICS_SEMANTICS_H_
#define LANGUAGE_COMPABILITY_SEMANTICS_SEMANTICS_H_
...
public:
  ...
  void EmitMessages(toolchain::raw_ostream &);
  ...
  void DumpSymbols(toolchain::raw_ostream &);
...
public:
  ...
  void EmitMessages(toolchain::raw_ostream &);
  void DumpSymbols(toolchain::raw_ostream &);
  void DumpSymbolsSources(toolchain::raw_ostream &) const;
