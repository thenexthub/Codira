//===-- language/Compability/Semantics/expression.h --------------------*- C++ -*-===//
//
...
#ifndef LANGUAGE_COMPABILITY_SEMANTICS_EXPRESSION_H_
#define LANGUAGE_COMPABILITY_SEMANTICS_EXPRESSION_H_
...
// namespace language::Compability::evaluate, but the exposed API to it is in the
// namespace language::Compability::semantics (below).
//
