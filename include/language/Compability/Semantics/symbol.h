//===-- language/Compability/Semantics/symbol.h ------------------------*- C++ -*-===//
//
...
#ifndef LANGUAGE_COMPABILITY_SEMANTICS_SYMBOL_H_
#define LANGUAGE_COMPABILITY_SEMANTICS_SYMBOL_H_
...
#include "language/Compability/Semantics/module-dependences.h"
...
public:
  explicit OpenACCRoutineDeviceTypeInfo(
      language::Compability::common::OpenACCDeviceType dType)
      : deviceType_{dType} {}
  ...
  language::Compability::common::OpenACCDeviceType dType() const { return deviceType_; }

  friend toolchain::raw_ostream &operator<<(
      toolchain::raw_ostream &, const OpenACCRoutineDeviceTypeInfo &);
...
private:
  ...
  language::Compability::common::OpenACCDeviceType deviceType_{
      language::Compability::common::OpenACCDeviceType::None};
};
...
public:
  OpenACCRoutineInfo()
      : OpenACCRoutineDeviceTypeInfo(language::Compability::common::OpenACCDeviceType::None) {
  }
  ...
  OpenACCRoutineDeviceTypeInfo &add_deviceTypeInfo(
      language::Compability::common::OpenACCDeviceType type) {
  ...
  friend toolchain::raw_ostream &operator<<(
      toolchain::raw_ostream &, const OpenACCRoutineInfo &);
...
private:
  ...
  friend toolchain::raw_ostream &operator<<(
      toolchain::raw_ostream &, const SubprogramDetails &);
};
...
private:
  ...
  friend toolchain::raw_ostream &operator<<(
      toolchain::raw_ostream &, const EntityDetails &);
};
...
toolchain::raw_ostream &operator<<(toolchain::raw_ostream &, const AssocEntityDetails &);
...
private:
  ...
  friend toolchain::raw_ostream &operator<<(
      toolchain::raw_ostream &, const ObjectEntityDetails &);
};
...
private:
  ...
  friend toolchain::raw_ostream &operator<<(
      toolchain::raw_ostream &, const ProcEntityDetails &);
};
...
private:
  ...
  friend toolchain::raw_ostream &operator<<(
      toolchain::raw_ostream &, const DerivedTypeDetails &);
};
...
toolchain::raw_ostream &operator<<(toolchain::raw_ostream &, const GenericDetails &);
...
toolchain::raw_ostream &operator<<(toolchain::raw_ostream &, const Details &);
...
private:
  ...
  friend toolchain::raw_ostream &operator<<(toolchain::raw_ostream &, const Symbol &);
  friend toolchain::raw_ostream &DumpForUnparse(
      toolchain::raw_ostream &, const Symbol &, bool);
...
toolchain::raw_ostream &operator<<(toolchain::raw_ostream &, Symbol::Flag);
...
// Define required  info so that SymbolRef can be used inside toolchain::DenseMap.
namespace toolchain {
template <> struct DenseMapInfo<language::Compability::semantics::SymbolRef> {
  static inline language::Compability::semantics::SymbolRef getEmptyKey() {
    auto ptr = DenseMapInfo<const language::Compability::semantics::Symbol *>::getEmptyKey();
    return *reinterpret_cast<language::Compability::semantics::SymbolRef *>(&ptr);
  }

  static inline language::Compability::semantics::SymbolRef getTombstoneKey() {
    auto ptr =
        DenseMapInfo<const language::Compability::semantics::Symbol *>::getTombstoneKey();
    return *reinterpret_cast<language::Compability::semantics::SymbolRef *>(&ptr);
  }

  static unsigned getHashValue(const language::Compability::semantics::SymbolRef &sym) {
    return DenseMapInfo<const language::Compability::semantics::Symbol *>::getHashValue(
        &sym.get());
  }

  static bool isEqual(const language::Compability::semantics::SymbolRef &LHS,
      const language::Compability::semantics::SymbolRef &RHS) {
    return LHS == RHS;
  }
};
} // namespace toolchain
