//===-- language/Compability/Runtime/array-constructor-consts.h --------*- C++ -*-===//
//
...
#ifndef LANGUAGE_COMPABILITY_RUNTIME_ARRAY_CONSTRUCTOR_CONSTS_H_
#define LANGUAGE_COMPABILITY_RUNTIME_ARRAY_CONSTRUCTOR_CONSTS_H_
