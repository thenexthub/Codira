//===-- language/Compability/Runtime/misc-intrinsic.h ------------------*- C++ -*-===//
//
...
#ifndef LANGUAGE_COMPABILITY_RUNTIME_MISC_INTRINSIC_H_
#define LANGUAGE_COMPABILITY_RUNTIME_MISC_INTRINSIC_H_
