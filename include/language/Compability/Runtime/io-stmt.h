//===-- language/Compability-rt/runtime/io-stmt.h ----------------------*- C++ -*-===//
//
...
public:
  ...
  RT_API_ATTRS language::Compability::common::optional<DataEdit> GetNextDataEdit(
      int maxRepeat = 1);
  ...
  RT_API_ATTRS language::Compability::common::optional<char32_t> GetCurrentCharSlow(
  ...
  public:
    ...
    RT_API_ATTRS language::Compability::common::optional<char32_t> Next() const {
      if (at_ && at_ < limit_) {
        return *at_;
      } else {
        return language::Compability::common::nullopt;
      }
    }
  ...
  RT_API_ATTRS language::Compability::common::optional<char32_t> GetCurrentChar(
  ...
  RT_API_ATTRS language::Compability::common::optional<int> CueUpInput(
      const DataEdit &edit, FastAsciiField *fastField = nullptr) {
    language::Compability::common::optional<int> remaining;
  ...
  RT_API_ATTRS language::Compability::common::optional<char32_t> SkipSpaces(
      language::Compability::common::optional<int> &remaining,
  ...
  RT_API_ATTRS language::Compability::common::optional<char32_t> NextInField(
      language::Compability::common::optional<int> &remaining, const DataEdit &,
  ...
  RT_API_ATTRS language::Compability::common::optional<char32_t> GetNextNonBlank(
...
private:
  std::variant<language::Compability::common::reference_wrapper<OpenStatementState>,
      language::Compability::common::reference_wrapper<CloseStatementState>,
      language::Compability::common::reference_wrapper<NoopStatementState>,
      language::Compability::common::reference_wrapper<
      ...
      language::Compability::common::reference_wrapper<InquireUnitState>,
      language::Compability::common::reference_wrapper<InquireNoUnitState>,
      language::Compability::common::reference_wrapper<InquireUnconnectedFileState>,
      language::Compability::common::reference_wrapper<InquireIOLengthState>,
      language::Compability::common::reference_wrapper<ExternalMiscIoStatementState>,
      language::Compability::common::reference_wrapper<ErroneousIoStatementState>>
      u_;
};
...
private:
  ...
  language::Compability::common::optional<SavedPosition> repeatPosition_;
...
private:
  bool wasExtant_;
  bool isNewUnit_;
  language::Compability::common::optional<OpenStatus> status_;
  language::Compability::common::optional<Position> position_;
  language::Compability::common::optional<Action> action_;
  Convert convert_{Convert::Unknown};
  OwningPtr<char> path_;
  std::size_t pathLength_{};
  language::Compability::common::optional<bool> isUnformatted_;
  language::Compability::common::optional<Access> access_;
};
