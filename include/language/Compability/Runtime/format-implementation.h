//===-- language/Compability-rt/runtime/format-implementation.h --------*- C++ -*-===//
//
...
RT_API_ATTRS int FormatControl<CONTEXT>::CueUpNextDataEdit(
  ...
  while (true) {
    language::Compability::common::optional<int> repeat;
...
template <typename CONTEXT>
RT_API_ATTRS language::Compability::common::optional<DataEdit>
