//===-- language/Compability/Runtime/CUDA/memmove-function.h -----------*- C++ -*-===//
//
...
#ifndef LANGUAGE_COMPABILITY_RUNTIME_CUDA_MEMMOVE_FUNCTION_H_
#define LANGUAGE_COMPABILITY_RUNTIME_CUDA_MEMMOVE_FUNCTION_H_
