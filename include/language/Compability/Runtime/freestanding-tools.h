//===-- language/Compability/Runtime/freestanding-tools.h --------------*- C++ -*-===//
//
...
#ifndef LANGUAGE_COMPABILITY_RUNTIME_FREESTANDING_TOOLS_H_
#define LANGUAGE_COMPABILITY_RUNTIME_FREESTANDING_TOOLS_H_
...
static RT_API_ATTRS void *MemmoveWrapper(
    void *dest, const void *src, std::size_t count) {
  return language::Compability::runtime::memmove(dest, src, count);
}
#endif
