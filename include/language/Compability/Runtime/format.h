//===-- language/Compability-rt/runtime/format.h -----------------------*- C++ -*-===//
//
...
struct DataEdit {
  ...
  language::Compability::common::optional<int> width; // the 'w' field; optional for A
  language::Compability::common::optional<int> digits; // the 'm' or 'd' field
  language::Compability::common::optional<int> expoDigits; // 'Ee' field
  MutableModes modes;
  int repeat{1};
