...
#ifndef LANGUAGE_COMPABILITY_FRONTEND_CODEGENOPTIONS_H
#define LANGUAGE_COMPABILITY_FRONTEND_CODEGENOPTIONS_H
...
public:
  ...
  struct OptRemark {
    ...
    bool patternMatches(toolchain::StringRef string) const {
  ...
  bool hasProfileClangInstr() const {
    return getProfileInstr() == toolchain::driver::ProfileClangInstr;
  }

  /// Check if IR level profile instrumentation is on.
  bool hasProfileIRInstr() const {
    return getProfileInstr() == toolchain::driver::ProfileIRInstr;
  }

  /// Check if CS IR level profile instrumentation is on.
  bool hasProfileCSIRInstr() const {
    return getProfileInstr() == toolchain::driver::ProfileCSIRInstr;
  }
  /// Check if IR level profile use is on.
  bool hasProfileIRUse() const {
    return getProfileUse() == toolchain::driver::ProfileIRInstr ||
           getProfileUse() == toolchain::driver::ProfileCSIRInstr;
  }
  /// Check if CSIR profile use is on.
  bool hasProfileCSIRUse() const {
    return getProfileUse() == toolchain::driver::ProfileCSIRInstr;
  }
