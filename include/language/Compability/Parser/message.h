//===-- language/Compability/Parser/message.h --------------------------*- C++ -*-===//
//
...
#ifndef LANGUAGE_COMPABILITY_PARSER_MESSAGE_H_
#define LANGUAGE_COMPABILITY_PARSER_MESSAGE_H_
...
#include "language/Compability/Common/reference-counted.h"
...
public:
  ...
  void Emit(toolchain::raw_ostream &, const AllCookedSources &,
