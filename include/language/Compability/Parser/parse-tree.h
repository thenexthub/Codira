//===-- language/Compability/Parser/parse-tree.h -----------------------*- C++ -*-===//
//
...
#ifndef LANGUAGE_COMPABILITY_PARSER_PARSE_TREE_H_
#define LANGUAGE_COMPABILITY_PARSER_PARSE_TREE_H_
...
struct OmpDirectiveName {
  ...
  constexpr OmpDirectiveName(toolchain::omp::Directive x) : v(x) {}
  ...
  CharBlock source;
  toolchain::omp::Directive v{toolchain::omp::Directive::OMPD_unknown};
};
...
struct OmpTraitSelectorName {
  ...
  std::variant<Value, toolchain::omp::Directive, std::string> u;
};
...
// Extension:
// https://openmp.toolchain.org//openacc/OpenMPExtensions.html#ompx-hold
//
// ompx-hold-modifier ->
//    OMPX_HOLD                                     // since 4.5
//
...
using OmpDirectiveList = std::list<toolchain::omp::Directive>;
...
struct OmpDirectiveSpecification {
  ...
  toolchain::omp::Directive DirId() const { //
    return DirName().v;
  }
...
struct OmpSectionsDirective {
  WRAPPER_CLASS_BOILERPLATE(OmpSectionsDirective, toolchain::omp::Directive);
  CharBlock source;
};
...
struct OpenMPAtomicConstruct : public OmpBlockConstruct {
  toolchain::omp::Clause GetKind() const;
...
struct OmpLoopDirective {
  WRAPPER_CLASS_BOILERPLATE(OmpLoopDirective, toolchain::omp::Directive);
  CharBlock source;
};
...
struct AccBlockDirective {
  WRAPPER_CLASS_BOILERPLATE(AccBlockDirective, toolchain::acc::Directive);
  CharBlock source;
};

struct AccLoopDirective {
  WRAPPER_CLASS_BOILERPLATE(AccLoopDirective, toolchain::acc::Directive);
  CharBlock source;
};

struct AccStandaloneDirective {
  WRAPPER_CLASS_BOILERPLATE(AccStandaloneDirective, toolchain::acc::Directive);
  CharBlock source;
};

// 2.11 Combined constructs
struct AccCombinedDirective {
  WRAPPER_CLASS_BOILERPLATE(AccCombinedDirective, toolchain::acc::Directive);
  CharBlock source;
};

struct AccDeclarativeDirective {
  WRAPPER_CLASS_BOILERPLATE(AccDeclarativeDirective, toolchain::acc::Directive);
  CharBlock source;
};
...
struct AccDefaultClause {
  WRAPPER_CLASS_BOILERPLATE(AccDefaultClause, toolchain::acc::DefaultValue);
  CharBlock source;
};
...
struct AccDeviceTypeExpr {
  WRAPPER_CLASS_BOILERPLATE(
      AccDeviceTypeExpr, language::Compability::common::OpenACCDeviceType);
  CharBlock source;
};
...
struct OpenACCEndConstruct {
  WRAPPER_CLASS_BOILERPLATE(OpenACCEndConstruct, toolchain::acc::Directive);
  CharBlock source;
};
