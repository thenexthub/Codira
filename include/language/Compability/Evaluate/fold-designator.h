//===-- language/Compability/Evaluate/fold-designator.h ----------------*- C++ -*-===//
//
...
#ifndef LANGUAGE_COMPABILITY_EVALUATE_FOLD_DESIGNATOR_H_
#define LANGUAGE_COMPABILITY_EVALUATE_FOLD_DESIGNATOR_H_
