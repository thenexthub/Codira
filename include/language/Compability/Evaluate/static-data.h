//===-- language/Compability/Evaluate/static-data.h --------------------*- C++ -*-===//
//
...
#ifndef LANGUAGE_COMPABILITY_EVALUATE_STATIC_DATA_H_
#define LANGUAGE_COMPABILITY_EVALUATE_STATIC_DATA_H_
...
public:
  ...
  toolchain::raw_ostream &AsFortran(
      toolchain::raw_ostream &, bool bigEndian = false) const;
