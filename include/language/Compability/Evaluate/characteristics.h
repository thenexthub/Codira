//===-- language/Compability/Evaluate/characteristics.h ----------------*- C++ -*-===//
//
...
#ifndef LANGUAGE_COMPABILITY_EVALUATE_CHARACTERISTICS_H_
#define LANGUAGE_COMPABILITY_EVALUATE_CHARACTERISTICS_H_
