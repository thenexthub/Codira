//===-- language/Compability/Evaluate/real.h ---------------------------*- C++ -*-===//
//
...
#ifndef LANGUAGE_COMPABILITY_EVALUATE_REAL_H_
#define LANGUAGE_COMPABILITY_EVALUATE_REAL_H_
...
public:
  ...
  toolchain::raw_ostream &AsFortran(
      toolchain::raw_ostream &, int kind, bool minimal = false) const;
