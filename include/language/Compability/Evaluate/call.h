//===-- language/Compability/Evaluate/call.h ---------------------------*- C++ -*-===//
//
...
#ifndef LANGUAGE_COMPABILITY_EVALUATE_CALL_H_
#define LANGUAGE_COMPABILITY_EVALUATE_CALL_H_
...
extern template class language::Compability::common::Indirection<language::Compability::evaluate::Component,
    true>;
