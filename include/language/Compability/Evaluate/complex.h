//===-- language/Compability/Evaluate/complex.h ------------------------*- C++ -*-===//
//
...
#ifndef LANGUAGE_COMPABILITY_EVALUATE_COMPLEX_H_
#define LANGUAGE_COMPABILITY_EVALUATE_COMPLEX_H_
...
public:
  ...
  toolchain::raw_ostream &AsFortran(toolchain::raw_ostream &, int kind) const;
