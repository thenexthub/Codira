//===-- language/Compability/Evaluate/expression.h ---------------------*- C++ -*-===//
//
...
#ifndef LANGUAGE_COMPABILITY_EVALUATE_EXPRESSION_H_
#define LANGUAGE_COMPABILITY_EVALUATE_EXPRESSION_H_
...
public:
  ...
  static constexpr int Corank() { return 0; }
  toolchain::raw_ostream &AsFortran(toolchain::raw_ostream &o) const;
