//===-- language/Compability/Common/enum-set.h -------------------------*- C++ -*-===//
//
...
#ifndef LANGUAGE_COMPABILITY_COMMON_ENUM_SET_H_
#define LANGUAGE_COMPABILITY_COMMON_ENUM_SET_H_
...
struct std::hash<language::Compability::common::EnumSet<ENUM, values>> {
  std::size_t operator()(
      const language::Compability::common::EnumSet<ENUM, values> &x) const {
