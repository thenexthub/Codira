//===-- language/Compability/Common/format.h ---------------------------*- C++ -*-===//
//
...
#ifndef LANGUAGE_COMPABILITY_COMMON_FORMAT_H_
#define LANGUAGE_COMPABILITY_COMMON_FORMAT_H_
...
// toolchain/include/toolchain/Support/MathExtras.h and specialised to int64_t.
