//===-- language/Compability/Common/reference-wrapper.h ----------------*- C++ -*-===//
//
...
#ifndef LANGUAGE_COMPABILITY_COMMON_REFERENCE_WRAPPER_H
#define LANGUAGE_COMPABILITY_COMMON_REFERENCE_WRAPPER_H
