//===--- CodiraNameTranslation.h - Codira Name Translation --------*- C++ -*-===//
//
...
#ifndef LANGUAGE_NAME_TRANSLATION_H
#define LANGUAGE_NAME_TRANSLATION_H
...
namespace objc_translation {
  ...
  bool printCodiraEnumElemNameInObjC(const EnumElementDecl *EL,
  ...
  getObjCNameForCodiraDecl(const ValueDecl *VD, DeclName PreferredName = DeclName());
