...
#ifndef LANGUAGE_INLINE_BITFIELD_H
#define LANGUAGE_INLINE_BITFIELD_H
...
/// LANGUAGE_INLINE_BITFIELD(Foo, Bar, 1+3+7+2, w:1, x:3, y:7, z:2);
...
#define LANGUAGE_INLINE_BITFIELD_BASE(T, C, ...) \
...
#define LANGUAGE_INLINE_BITFIELD_TEMPLATE(T, U, C, HC, ...) \
  TOOLCHAIN_PACKED_START \
  class T##Bitfield { \
    friend class T; \
...
#define LANGUAGE_INLINE_BITFIELD(T, U, C, ...) \
  LANGUAGE_INLINE_BITFIELD_TEMPLATE(T, U, C, 0, __VA_ARGS__)
...
///
/// LANGUAGE_INLINE_BITFIELD_FULL(Foo, Bar, 1+8+16,
///   flag : 1,
///   : NumPadBits, // pad the center, not the end
///   x : 8,
///   y : 16
/// );
#define LANGUAGE_INLINE_BITFIELD_FULL(T, U, C, ...) \
  TOOLCHAIN_PACKED_START \
  class T##Bitfield { \
    friend class T; \
...
#define LANGUAGE_INLINE_BITFIELD_FULL_TEMPLATE(T, U, C, ...)                      \
  TOOLCHAIN_PACKED_START                                                            \
  class T##Bitfield {                                                          \
...
#define LANGUAGE_INLINE_BITFIELD_EMPTY(T, U) \
...
#endif // LANGUAGE_INLINE_BITFIELD_H
