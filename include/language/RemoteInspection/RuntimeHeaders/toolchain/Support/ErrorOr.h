//===- toolchain/Support/ErrorOr.h - Error Smart Pointer -------------*- C++ -*-===//
//
...
#ifndef TOOLCHAIN_SUPPORT_ERROROR_H
#define TOOLCHAIN_SUPPORT_ERROROR_H
...
#endif // TOOLCHAIN_SUPPORT_ERROROR_H
