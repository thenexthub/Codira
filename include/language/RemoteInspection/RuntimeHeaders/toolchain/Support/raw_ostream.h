...
#ifndef TOOLCHAIN_SUPPORT_RAW_OSTREAM_H
#define TOOLCHAIN_SUPPORT_RAW_OSTREAM_H
...
public:
  ...
  /// satisfy toolchain::isPrint into an escape sequence.
...
/// toolchain::outs for "-", raw_null_ostream for "/dev/null", and raw_fd_ostream
...
#endif // TOOLCHAIN_SUPPORT_RAW_OSTREAM_H
