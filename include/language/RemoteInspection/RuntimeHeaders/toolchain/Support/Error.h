...
#ifndef TOOLCHAIN_SUPPORT_ERROR_H
#define TOOLCHAIN_SUPPORT_ERROR_H

#include "toolchain-c/Error.h"
...
#if TOOLCHAIN_ENABLE_ABI_BREAKING_CHECKS
    if (TOOLCHAIN_UNLIKELY(!getChecked() || getPtr()))
      fatalUncheckedError();
#endif
  }
...
///  'EXPECT_THAT_EXPECTED' macros in toolchain/Testing/Support/Error.h
...
#if TOOLCHAIN_ENABLE_ABI_BREAKING_CHECKS
  [[noreturn]] TOOLCHAIN_ATTRIBUTE_NOINLINE void fatalUncheckedExpected() const {
...
#if TOOLCHAIN_ENABLE_ABI_BREAKING_CHECKS
    if (TOOLCHAIN_UNLIKELY(Unchecked))
...
#endif // TOOLCHAIN_SUPPORT_ERROR_H
