...
#ifndef TOOLCHAIN_OBJECT_OBJECTFILE_H
#define TOOLCHAIN_OBJECT_OBJECTFILE_H
...
#include "toolchain/BinaryFormat/Codira.h"
#include "toolchain/Object/Binary.h"
#include "toolchain/Object/Error.h"
#include "toolchain/Object/SymbolicFile.h"
...
protected:
  ...
  virtual toolchain::binaryformat::Codira5ReflectionSectionKind
  mapReflectionSectionNameToEnumValue(StringRef SectionName) const {
    return toolchain::binaryformat::Codira5ReflectionSectionKind::unknown;
  };
...
public:
  ...
  bool isReflectionSectionStrippable(
      toolchain::binaryformat::Codira5ReflectionSectionKind ReflectionSectionKind)
      const;
  ...
  createObjectFile(MemoryBufferRef Object, toolchain::file_magic Type,
                   bool InitContent = true);
  static Expected<std::unique_ptr<ObjectFile>>
  createObjectFile(MemoryBufferRef Object) {
    return createObjectFile(Object, toolchain::file_magic::unknown);
  }
...
#endif // TOOLCHAIN_OBJECT_OBJECTFILE_H
