//===- toolchain/BinaryFormat/ELF.h - ELF constants and structures ---*- C++ -*-===//
//
...
#ifndef TOOLCHAIN_BINARYFORMAT_ELF_H
#define TOOLCHAIN_BINARYFORMAT_ELF_H
...
enum {
  ...
  STO_MIPS_PIC = 0x20,       // PIC fn in an object mixes PIC/non-PIC
...
enum : unsigned {
  ...
  SHT_TOOLCHAIN_ODRTAB = 0x6fff4c00,         // LLVM ODR table.
  SHT_TOOLCHAIN_LINKER_OPTIONS = 0x6fff4c01, // LLVM Linker Options.
  SHT_TOOLCHAIN_ADDRSIG = 0x6fff4c03,        // List of address-significant symbols
                                        // for safe ICF.
  SHT_TOOLCHAIN_DEPENDENT_LIBRARIES =
      0x6fff4c04,                  // LLVM Dependent Library Specifiers.
  SHT_TOOLCHAIN_SYMPART = 0x6fff4c05,   // Symbol partition specification.
  SHT_TOOLCHAIN_PART_EHDR = 0x6fff4c06, // ELF header for loadable partition.
  SHT_TOOLCHAIN_PART_PHDR = 0x6fff4c07, // Phdrs for loadable partition.
  SHT_TOOLCHAIN_BB_ADDR_MAP_V0 =
      0x6fff4c08, // LLVM Basic Block Address Map (old version kept for
                  // backward-compatibility).
  SHT_TOOLCHAIN_CALL_GRAPH_PROFILE = 0x6fff4c09, // LLVM Call Graph Profile.
  SHT_TOOLCHAIN_BB_ADDR_MAP = 0x6fff4c0a,        // LLVM Basic Block Address Map.
  SHT_TOOLCHAIN_OFFLOADING = 0x6fff4c0b,         // LLVM device offloading data.
  SHT_TOOLCHAIN_LTO = 0x6fff4c0c,                // .toolchain.lto for fat LTO.
...
enum : unsigned {
  NT_TOOLCHAIN_OPENMP_OFFLOAD_VERSION = 1,
  NT_TOOLCHAIN_OPENMP_OFFLOAD_PRODUCER = 2,
  NT_TOOLCHAIN_OPENMP_OFFLOAD_PRODUCER_VERSION = 3
};
...
#endif // TOOLCHAIN_BINARYFORMAT_ELF_H
