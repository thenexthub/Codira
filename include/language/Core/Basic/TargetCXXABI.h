...
#ifndef LANGUAGE_CORE_BASIC_TARGETCXXABI_H
#define LANGUAGE_CORE_BASIC_TARGETCXXABI_H
...
private:
  ...
  static const auto &getABIMap() {
    static toolchain::StringMap<Kind> ABIMap = {
...
public:
  ...
  // default.
  static bool usesRelativeVTables(const toolchain::Triple &T) {
  ...
  static bool isSupportedCXXABI(const toolchain::Triple &T, Kind Kind) {
    switch (Kind) {
    case GenericARM:
    ...
    toolchain_unreachable("invalid CXXABI kind");
  }
