...
#ifndef LANGUAGE_CORE_BASIC_ATTRIBUTECOMMONINFO_H
#define LANGUAGE_CORE_BASIC_ATTRIBUTECOMMONINFO_H

#include "language/Core/Basic/AttributeScopeInfo.h"
...
#include "language/Core/Basic/AttrParsedAttrList.inc"
#undef PARSED_ATTR
...
private:
  ...
  friend class language::Core::ASTRecordWriter;
...
#endif // LANGUAGE_CORE_BASIC_ATTRIBUTECOMMONINFO_H
