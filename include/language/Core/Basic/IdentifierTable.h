...
//
/// \file
/// Defines the language::Core::IdentifierInfo, language::Core::IdentifierTable, and
/// language::Core::Selector interfaces.
//
//===----------------------------------------------------------------------===//

#ifndef LANGUAGE_CORE_BASIC_IDENTIFIERTABLE_H
#define LANGUAGE_CORE_BASIC_IDENTIFIERTABLE_H
...
class alignas(IdentifierInfoAlignment) IdentifierInfo {
  ...
  toolchain::StringMapEntry<IdentifierInfo *> *Entry = nullptr;

  IdentifierInfo()
      : TokenID(tok::identifier),
        InterestingIdentifierID(toolchain::to_underlying(
...
public:
  ...
  bool isStr(toolchain::StringRef Str) const {
    toolchain::StringRef ThisStr(getNameStart(), getLength());
    return ThisStr == Str;
  }
  ...
  tok::ObjCKeywordKind getObjCKeywordID() const {
    assert(0 == toolchain::to_underlying(InterestingIdentifier::objc_not_keyword));
  ...
  unsigned getBuiltinID() const {
    ...
    if (Value >
      ...
      auto FirstBuiltin =
          toolchain::to_underlying(InterestingIdentifier::NotBuiltin);
  ...
  void setBuiltinID(unsigned ID) {
    ...
    auto FirstBuiltin = toolchain::to_underlying(InterestingIdentifier::NotBuiltin);
    InterestingIdentifierID = ID + FirstBuiltin;
    assert(getBuiltinID() == ID && "ID too large for field!");
  }
  void clearBuiltinID() {
    InterestingIdentifierID =
        toolchain::to_underlying(InterestingIdentifier::NotInterestingIdentifier);
  }
  ...
  tok::NotableIdentifierKind getNotableIdentifierID() const {
    ...
    if (Value > InterestingIdentifier::NUM_OBJC_KEYWORDS &&
      ...
      auto FirstNotableIdentifier =
          1 + toolchain::to_underlying(InterestingIdentifier::NUM_OBJC_KEYWORDS);
...
class IdentifierTable {
  ...
  // BumpPtrAllocator!
  using HashTableTy = toolchain::StringMap<IdentifierInfo *, toolchain::BumpPtrAllocator>;
...
class alignas(IdentifierInfoAlignment) DeclarationNameExtra {
  friend class language::Core::DeclarationName;
  friend class language::Core::DeclarationNameTable;
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, keyword_iterator ArgTys,
                      unsigned NumArgs) {
...
class Selector {
  ...
  toolchain::PointerIntPair<
      toolchain::PointerUnion<const IdentifierInfo *, MultiKeywordSelector *>, 2>
      InfoPtr;
...
/// DenseSets.
template <>
struct DenseMapInfo<language::Core::Selector> {
  static language::Core::Selector getEmptyKey() {
    return language::Core::Selector::getEmptyMarker();
  }

  static language::Core::Selector getTombstoneKey() {
    return language::Core::Selector::getTombstoneMarker();
  }

  static unsigned getHashValue(language::Core::Selector S);

  static bool isEqual(language::Core::Selector LHS, language::Core::Selector RHS) {
    return LHS == RHS;
  }
};

template<>
struct PointerLikeTypeTraits<language::Core::Selector> {
  static const void *getAsVoidPointer(language::Core::Selector P) {
    return P.getAsOpaquePtr();
  }

  static language::Core::Selector getFromVoidPointer(const void *P) {
    return language::Core::Selector(reinterpret_cast<uintptr_t>(P));
  }
...
#endif // LANGUAGE_CORE_BASIC_IDENTIFIERTABLE_H
