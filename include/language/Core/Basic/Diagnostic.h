...
#ifndef LANGUAGE_CORE_BASIC_DIAGNOSTIC_H
#define LANGUAGE_CORE_BASIC_DIAGNOSTIC_H
...
private:
  ...
  /// source location.
  class DiagState {
    toolchain::DenseMap<unsigned, DiagnosticMapping> DiagMap;
  ...
  public:
    ...
    using iterator = toolchain::DenseMap<unsigned, DiagnosticMapping>::iterator;
    using const_iterator =
        toolchain::DenseMap<unsigned, DiagnosticMapping>::const_iterator;
  ...
  private:
    ...
    struct File {
      ...
      toolchain::SmallVector<DiagStatePoint, 4> StateTransitions;
  ...
  toolchain::unique_function<bool(diag::kind, SourceLocation /*DiagLoc*/,
...
public:
  ...
  using diag_mapping_range = toolchain::iterator_range<DiagState::const_iterator>;
  ...
  unsigned getNumOverloadCandidatesToShow() const {
    ...
    toolchain_unreachable("invalid OverloadsShown kind");
  }
  ...
  void setDiagSuppressionMapping(toolchain::MemoryBuffer &Input);
...
public:
  using DiagStorageAllocator = language::Core::DiagStorageAllocator;
...
// clutter the emitting code with `toolchain::to_underlying()`.
...
public:
  ...
  ArrayRef<CharSourceRange> getRanges() const { return toolchain::ArrayRef(Ranges); }
  ...
  ArrayRef<FixItHint> getFixIts() const { return toolchain::ArrayRef(FixIts); }
};

// Simple debug printing of StoredDiagnostic.
toolchain::raw_ostream &operator<<(toolchain::raw_ostream &OS, const StoredDiagnostic &);
...
void ProcessWarningOptions(DiagnosticsEngine &Diags,
                           ...
                           toolchain::vfs::FileSystem &VFS, bool ReportDiags = true);
void EscapeStringForDiagnostic(StringRef Str, SmallVectorImpl<char> &OutStr);
} // namespace language::Core

#endif // LANGUAGE_CORE_BASIC_DIAGNOSTIC_H
