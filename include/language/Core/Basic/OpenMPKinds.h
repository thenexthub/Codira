...
#ifndef LANGUAGE_CORE_BASIC_OPENMPKINDS_H
#define LANGUAGE_CORE_BASIC_OPENMPKINDS_H
...
/// OpenMP directives.
using OpenMPDirectiveKind = toolchain::omp::Directive;

/// OpenMP clauses.
using OpenMPClauseKind = toolchain::omp::Clause;
...
struct OMPInteropInfo final {
  ...
  bool IsTarget;
  bool IsTargetSync;
  toolchain::SmallVector<Expr *, 4> PreferTypes;
};

unsigned getOpenMPSimpleClauseType(OpenMPClauseKind Kind, toolchain::StringRef Str,
...
void getOpenMPCaptureRegions(
    toolchain::SmallVectorImpl<OpenMPDirectiveKind> &CaptureRegions,
...
template <>
struct toolchain::enum_iteration_traits<language::Core::OpenMPDefaultmapClauseKind> {
