...
#ifndef LANGUAGE_CORE_BASIC_DIAGNOSTICIDS_H
#define LANGUAGE_CORE_BASIC_DIAGNOSTICIDS_H
...
#include "language/Core/Basic/DiagnosticCommonInterface.inc"
...
public:
  ...
  static toolchain::IntrusiveRefCntPtr<DiagnosticIDs> create() {
    return toolchain::makeIntrusiveRefCnt<DiagnosticIDs>();
  }
