...
#ifndef LANGUAGE_CORE_BASIC_SPECIFIERS_H
#define LANGUAGE_CORE_BASIC_SPECIFIERS_H
...
#include "language/Core/Basic/HLSLIntangibleTypes.def"
  ...
  inline bool isTemplateExplicitInstantiationOrSpecialization(
    ...
    toolchain_unreachable("bad template specialization kind");
  }
  ...
  toolchain::raw_ostream &operator<<(toolchain::raw_ostream&, NullabilityKind);
  ...
  toolchain::StringRef getNullabilitySpelling(NullabilityKind kind,
  ...
  toolchain::StringRef getParameterABISpelling(ParameterABI kind);

  inline toolchain::StringRef getAccessSpelling(AccessSpecifier AS) {
    switch (AS) {
    ...
    toolchain_unreachable("Unknown AccessSpecifier");
  }
} // end namespace language::Core

#endif // LANGUAGE_CORE_BASIC_SPECIFIERS_H
