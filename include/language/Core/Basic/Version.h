...
#ifndef LANGUAGE_CORE_BASIC_VERSION_H
#define LANGUAGE_CORE_BASIC_VERSION_H

#include "language/Core/Basic/Version.inc"
...
namespace language::Core {
  ...
  std::string getClangToolFullVersion(toolchain::StringRef ToolName);
...
#endif // LANGUAGE_CORE_BASIC_VERSION_H
