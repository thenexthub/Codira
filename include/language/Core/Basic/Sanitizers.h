...
//
/// \file
/// Defines the language::Core::SanitizerKind enum.
//
//===----------------------------------------------------------------------===//

#ifndef LANGUAGE_CORE_BASIC_SANITIZERS_H
#define LANGUAGE_CORE_BASIC_SANITIZERS_H
...
public:
  ...
  toolchain::hash_code hash_value() const;
...
toolchain::AsanDtorKind AsanDtorKindFromString(StringRef kind);
...
#endif // LANGUAGE_CORE_BASIC_SANITIZERS_H
