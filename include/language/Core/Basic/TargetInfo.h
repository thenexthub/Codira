...
///
/// \file
/// Defines the language::Core::TargetInfo interface.
///
//===----------------------------------------------------------------------===//

#ifndef LANGUAGE_CORE_BASIC_TARGETINFO_H
#define LANGUAGE_CORE_BASIC_TARGETINFO_H

#include "language/Core/Basic/AddressSpaces.h"
#include "language/Core/Basic/BitmaskEnum.h"
#include "language/Core/Basic/Builtins.h"
#include "language/Core/Basic/CFProtectionOptions.h"
...
#include "toolchain/ADT/StringTable.h"
...
struct TransferrableTargetInfo {
  ...
  const toolchain::fltSemantics *HalfFormat, *BFloat16Format, *FloatFormat,
...
protected:
  ...
  unsigned RealTypeUsesObjCFPRetMask : toolchain::BitWidth<FloatModeKind>;
  LLVM_PREFERRED_TYPE(bool)
  ...
  std::optional<toolchain::Triple> DarwinTargetVariantTriple;

  bool HasMicrosoftRecordLayout = false;

  // TargetInfo Constructor.  Default initializes all fields.
  TargetInfo(const toolchain::Triple &T);
  ...
  toolchain::StringSet<> ReadOnlyFeatures;
...
public:
  ...
  IntType getSignedSizeType() const {
    ...
    default:
      toolchain_unreachable("Invalid SizeType");
    }
  }
  ...
  static IntType getCorrespondingUnsignedType(IntType T) {
    ...
    default:
      toolchain_unreachable("Unexpected signed integer type");
    }
  }
  ...
  unsigned getBitIntWidth(unsigned NumBits) const {
    return toolchain::alignTo(NumBits, getBitIntAlign(NumBits));
  }
  unsigned getBitIntAlign(unsigned NumBits) const {
    return std::clamp<unsigned>(toolchain::PowerOf2Ceil(NumBits), getCharWidth(),
                                getBitIntMaxAlign());
  }
  ...
  virtual size_t getMaxBitIntWidth() const {
    ...
    if (MaxBitIntWidth)
      return std::min<size_t>(*MaxBitIntWidth, toolchain::IntegerType::MAX_INT_BITS);

    // FIXME: this value should be toolchain::IntegerType::MAX_INT_BITS, which is
  ...
  const toolchain::fltSemantics &getHalfFormat() const { return *HalfFormat; }

  /// getFloatWidth/Align/Format - Return the size/align/format of 'float'.
  unsigned getFloatWidth() const { return FloatWidth; }
  unsigned getFloatAlign() const { return FloatAlign; }
  const toolchain::fltSemantics &getFloatFormat() const { return *FloatFormat; }

  /// getBFloat16Width/Align/Format - Return the size/align/format of '__bf16'.
  unsigned getBFloat16Width() const { return BFloat16Width; }
  unsigned getBFloat16Align() const { return BFloat16Align; }
  const toolchain::fltSemantics &getBFloat16Format() const { return *BFloat16Format; }

  /// getDoubleWidth/Align/Format - Return the size/align/format of 'double'.
  unsigned getDoubleWidth() const { return DoubleWidth; }
  unsigned getDoubleAlign() const { return DoubleAlign; }
  const toolchain::fltSemantics &getDoubleFormat() const { return *DoubleFormat; }

  /// getLongDoubleWidth/Align/Format - Return the size/align/format of 'long
  /// double'.
  unsigned getLongDoubleWidth() const { return LongDoubleWidth; }
  unsigned getLongDoubleAlign() const { return LongDoubleAlign; }
  const toolchain::fltSemantics &getLongDoubleFormat() const {
  ...
  const toolchain::fltSemantics &getFloat128Format() const {
  ...
  const toolchain::fltSemantics &getIbm128Format() const { return *Ibm128Format; }
  ...
  virtual const char *getIbm128Mangling() const {
    toolchain_unreachable("ibm128 not implemented on this target");
  }
  ...
  virtual bool hasBuiltinAtomic(uint64_t AtomicSizeInBits,
    ...
    return AtomicSizeInBits <= AlignmentInBits &&
           ...
           (AtomicSizeInBits <= getCharWidth() ||
            toolchain::isPowerOf2_64(AtomicSizeInBits / getCharWidth()));
  }
  ...
  /// Check whether toolchain intrinsics such as toolchain.convert.to.fp16 should be used
  ...
  virtual toolchain::SmallVector<Builtin::InfosShard> getTargetBuiltins() const = 0;
  ...
  getVScaleRange(const LangOptions &LangOpts, ArmStreamingKind Mode,
                 toolchain::StringMap<bool> *FeatureMap = nullptr) const {
    return std::nullopt;
  }
  ...
  struct ConstraintInfo {
    ...
    toolchain::SmallSet<int, 4> ImmSet;
  ...
  public:
    ...
    bool isValidAsmImmediate(const toolchain::APInt &Value) const {
      if (!ImmSet.empty())
    ...
    void setRequiresImmediate(toolchain::ArrayRef<int> Exacts) {
      Flags |= CI_ImmediateConstant;
  ...
  virtual bool validateOutputSize(const toolchain::StringMap<bool> &FeatureMap,
                                  StringRef /*Constraint*/,
                                  unsigned /*Size*/) const {
    return true;
  }

  virtual bool validateInputSize(const toolchain::StringMap<bool> &FeatureMap,
                                 StringRef /*Constraint*/,
                                 unsigned /*Size*/) const {
    return true;
  }
  ...
  const toolchain::Triple &getTriple() const {
    return Triple;
  }
  ...
  virtual bool hasPS4DLLImportExport() const {
    return getTriple().isPS() ||
           ...
           (getTriple().isWindowsItaniumEnvironment() &&
            getTriple().getVendor() == toolchain::Triple::SCEI);
  }
  ...
  virtual bool initFeatureMap(toolchain::StringMap<bool> &Features,
  ...
  virtual bool hasFeatureEnabled(const toolchain::StringMap<bool> &Features,
  ...
  virtual void setFeatureEnabled(toolchain::StringMap<bool> &Features,
                                 StringRef Name,
                                 bool Enabled) const {
  ...
  public:
    ...
    const char *getSignReturnAddrStr() const {
      ...
      toolchain_unreachable("Unexpected SignReturnAddressScopeKind");
    }
    ...
    const char *getSignKeyStr() const {
      ...
      toolchain_unreachable("Unexpected SignReturnAddressKeyKind");
    }
  ...
  bool supportsIFunc() const {
    ...
    if (getTriple().isOSWindows() && getTriple().isAArch64())
      return true;
    if (getTriple().getArch() == toolchain::Triple::ArchType::avr)
      return true;
  ...
  virtual toolchain::APInt getFMVPriority(ArrayRef<StringRef> Features) const {
    return toolchain::APInt::getZero(32);
  }
  ...
  // cpu_specific/cpu_dispatch so that it can be passed to toolchain as optimization
  // options.
  virtual void getCPUSpecificCPUDispatchFeatures(
      StringRef Name, toolchain::SmallVectorImpl<StringRef> &Features) const {
    toolchain_unreachable(
        "cpu_specific Multiversioning not implemented on this target");
  }
  ...
  bool isSEHTrySupported() const {
    return getTriple().isOSWindows() &&
           (getTriple().isX86() ||
            getTriple().getArch() == toolchain::Triple::aarch64);
  }
  ...
  virtual bool validatePointerAuthKey(const toolchain::APSInt &value) const;
  ...
  virtual const toolchain::omp::GV &getGridValue() const {
    toolchain_unreachable("getGridValue not implemented on this target");
  }
  ...
  /// toolchain.eh.sjlj.longjmp / toolchain.eh.sjlj.setjmp.
...
#include "language/Core/Basic/OpenCLExtensions.def"
  ...
  toolchain::StringMap<bool> &getSupportedOpenCLOpts() {
    return getTargetOpts().OpenCLFeaturesMap;
  }

  /// Get const supported OpenCL extensions and optional core features.
  const toolchain::StringMap<bool> &getSupportedOpenCLOpts() const {
    return getTargetOpts().OpenCLFeaturesMap;
  }
  ...
  const toolchain::VersionTuple &getSDKVersion() const {
  ...
  const toolchain::Triple *getDarwinTargetVariantTriple() const {
...
namespace targets {
std::unique_ptr<language::Core::TargetInfo>
AllocateTarget(const toolchain::Triple &Triple, const language::Core::TargetOptions &Opts);
} // namespace targets
