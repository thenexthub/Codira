...
#ifndef LANGUAGE_CORE_BASIC_DIAGNOSTICOPTIONS_H
#define LANGUAGE_CORE_BASIC_DIAGNOSTICOPTIONS_H
...
class DiagnosticOptions {
  friend bool ParseDiagnosticArgs(DiagnosticOptions &, toolchain::opt::ArgList &,
                                  language::Core::DiagnosticsEngine *, bool);
...
#endif // LANGUAGE_CORE_BASIC_DIAGNOSTICOPTIONS_H
