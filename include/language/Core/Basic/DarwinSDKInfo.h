...
#ifndef LANGUAGE_CORE_BASIC_DARWINSDKINFO_H
#define LANGUAGE_CORE_BASIC_DARWINSDKINFO_H
...
public:
  ...
  public:
    ...
    constexpr OSEnvPair(toolchain::Triple::OSType FromOS,
                        toolchain::Triple::EnvironmentType FromEnv,
                        toolchain::Triple::OSType ToOS,
                        toolchain::Triple::EnvironmentType ToEnv)
        : Value(((StorageType(FromOS) * StorageType(toolchain::Triple::LastOSType) +
                  StorageType(FromEnv))
                 << 32ull) |
                (StorageType(ToOS) * StorageType(toolchain::Triple::LastOSType) +
                 StorageType(ToEnv))) {}
    ...
    static inline constexpr OSEnvPair macOStoMacCatalystPair() {
      return OSEnvPair(toolchain::Triple::MacOSX, toolchain::Triple::UnknownEnvironment,
                       toolchain::Triple::IOS, toolchain::Triple::MacABI);
    }

    /// Returns the os-environment mapping pair that's used to represent the
    /// Mac Catalyst -> macOS version mapping.
    static inline constexpr OSEnvPair macCatalystToMacOSPair() {
      return OSEnvPair(toolchain::Triple::IOS, toolchain::Triple::MacABI,
                       toolchain::Triple::MacOSX, toolchain::Triple::UnknownEnvironment);
    }

    /// Returns the os-environment mapping pair that's used to represent the
    /// iOS -> watchOS version mapping.
    static inline constexpr OSEnvPair iOStoWatchOSPair() {
      return OSEnvPair(toolchain::Triple::IOS, toolchain::Triple::UnknownEnvironment,
                       toolchain::Triple::WatchOS, toolchain::Triple::UnknownEnvironment);
    }
    ...
    static inline constexpr OSEnvPair iOStoTvOSPair() {
      return OSEnvPair(toolchain::Triple::IOS, toolchain::Triple::UnknownEnvironment,
                       toolchain::Triple::TvOS, toolchain::Triple::UnknownEnvironment);
    }
  ...
  public:
    ...
    parseJSON(const toolchain::json::Object &Obj,
  ...
  const toolchain::VersionTuple &getVersion() const { return Version; }

  const toolchain::Triple::OSType &getOS() const { return OS; }
  ...
  parseDarwinSDKSettingsJSON(const toolchain::json::Object *Obj);
...
parseDarwinSDKInfo(toolchain::vfs::FileSystem &VFS, StringRef SDKRootPath);

} // end namespace language::Core

#endif // LANGUAGE_CORE_BASIC_DARWINSDKINFO_H
