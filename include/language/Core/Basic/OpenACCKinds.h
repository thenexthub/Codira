...
#ifndef LANGUAGE_CORE_BASIC_OPENACCKINDS_H
#define LANGUAGE_CORE_BASIC_OPENACCKINDS_H
...
inline StreamTy &printOpenACCDirectiveKind(StreamTy &Out,
  ...
  toolchain_unreachable("Uncovered directive kind");
}
...
inline StreamTy &printOpenACCAtomicKind(StreamTy &Out, OpenACCAtomicKind AK) {
  ...
  toolchain_unreachable("unknown atomic kind");
}
inline const StreamingDiagnostic &operator<<(const StreamingDiagnostic &Out,
...
inline StreamTy &printOpenACCClauseKind(StreamTy &Out, OpenACCClauseKind K) {
  ...
  toolchain_unreachable("Uncovered clause kind");
}
...
inline StreamTy &printOpenACCDefaultClauseKind(StreamTy &Out,
  ...
  toolchain_unreachable("Unknown OpenACCDefaultClauseKind enum");
}
...
inline StreamTy &printOpenACCReductionOperator(StreamTy &Out,
  ...
  toolchain_unreachable("Unknown reduction operator kind");
}
inline const StreamingDiagnostic &operator<<(const StreamingDiagnostic &Out,
                                             OpenACCReductionOperator Op) {
...
#endif // LANGUAGE_CORE_BASIC_OPENACCKINDS_H
