...
#ifndef LANGUAGE_CORE_STATICANALYZER_FRONTEND_CHECKERREGISTRY_H
#define LANGUAGE_CORE_STATICANALYZER_FRONTEND_CHECKERREGISTRY_H
...
#endif // LANGUAGE_CORE_STATICANALYZER_FRONTEND_CHECKERREGISTRY_H
