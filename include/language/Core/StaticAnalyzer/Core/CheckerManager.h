...
#ifndef LANGUAGE_CORE_STATICANALYZER_CORE_CHECKERMANAGER_H
#define LANGUAGE_CORE_STATICANALYZER_CORE_CHECKERMANAGER_H
...
class CheckerNameRef {
  friend class ::language::Core::ento::CheckerRegistry;
...
private:
  ...
  toolchain::DenseMap<CheckerTag, std::unique_ptr<CheckerBackend>> CheckerTags;
  ...
  using CachedDeclCheckersMapTy = toolchain::DenseMap<unsigned, CachedDeclCheckers>;
  ...
  using CachedStmtCheckersMapTy = toolchain::DenseMap<unsigned, CachedStmtCheckers>;
  ...
  using EventsTy = toolchain::DenseMap<EventTag, EventInfo>;
  EventsTy Events;
};
...
#endif // LANGUAGE_CORE_STATICANALYZER_CORE_CHECKERMANAGER_H
