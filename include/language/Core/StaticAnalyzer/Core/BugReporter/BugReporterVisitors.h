...
#ifndef LANGUAGE_CORE_STATICANALYZER_CORE_BUGREPORTER_BUGREPORTERVISITORS_H
#define LANGUAGE_CORE_STATICANALYZER_CORE_BUGREPORTER_BUGREPORTERVISITORS_H
...
class BugReporterVisitor : public toolchain::FoldingSetNode {
public:
...
class Tracker;
using TrackerRef = toolchain::IntrusiveRefCntPtr<Tracker>;
...
class Tracker : public toolchain::RefCountedBase<Tracker> {
private:
...
class ConditionBRVisitor final : public BugReporterVisitor {
  ...
  constexpr static toolchain::StringLiteral GenericTrueMessage =
      "Assuming the condition is true";
  constexpr static toolchain::StringLiteral GenericFalseMessage =
...
private:
  ...
  toolchain::SmallPtrSet<const StackFrameContext *, 32> FramesModifying;
  toolchain::SmallPtrSet<const StackFrameContext *, 32> FramesModifyingCalculated;
...
#endif // LANGUAGE_CORE_STATICANALYZER_CORE_BUGREPORTER_BUGREPORTERVISITORS_H
