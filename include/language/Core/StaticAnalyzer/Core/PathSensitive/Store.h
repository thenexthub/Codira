...
#ifndef LANGUAGE_CORE_STATICANALYZER_CORE_PATHSENSITIVE_STORE_H
#define LANGUAGE_CORE_STATICANALYZER_CORE_PATHSENSITIVE_STORE_H
...
using InvalidatedSymbols = toolchain::DenseSet<SymbolRef>;
...
struct BindResult {
  ...
  toolchain::SmallVector<SVal, 0> FailedToBindValues;
};
...
#endif // LANGUAGE_CORE_STATICANALYZER_CORE_PATHSENSITIVE_STORE_H
