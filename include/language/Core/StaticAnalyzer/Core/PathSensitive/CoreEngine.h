...
#ifndef LANGUAGE_CORE_STATICANALYZER_CORE_PATHSENSITIVE_COREENGINE_H
#define LANGUAGE_CORE_STATICANALYZER_CORE_PATHSENSITIVE_COREENGINE_H
...
public:
  ...
  auto exhausted_blocks() const {
    return toolchain::iterator_range(blocksExhausted);
  }

  auto aborted_blocks() const { return toolchain::iterator_range(blocksAborted); }
...
#endif // LANGUAGE_CORE_STATICANALYZER_CORE_PATHSENSITIVE_COREENGINE_H
