...
#ifndef LANGUAGE_CORE_STATICANALYZER_CORE_PATHSENSITIVE_STOREREF_H
#define LANGUAGE_CORE_STATICANALYZER_CORE_PATHSENSITIVE_STOREREF_H
...
#endif // LANGUAGE_CORE_STATICANALYZER_CORE_PATHSENSITIVE_STOREREF_H
