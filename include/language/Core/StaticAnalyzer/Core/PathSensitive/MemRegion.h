...
#ifndef LANGUAGE_CORE_STATICANALYZER_CORE_PATHSENSITIVE_MEMREGION_H
#define LANGUAGE_CORE_STATICANALYZER_CORE_PATHSENSITIVE_MEMREGION_H
...
class MemRegion : public toolchain::FoldingSetNode {
public:
  enum Kind {
...
public:
  ...
  virtual void Profile(toolchain::FoldingSetNodeID& ID) const = 0;
...
class AllocaRegion : public SubRegion {
  ...
  static void ProfileRegion(toolchain::FoldingSetNodeID& ID, const Expr *Ex,
...
class FunctionCodeRegion : public CodeTextRegion {
  ...
  static void ProfileRegion(toolchain::FoldingSetNodeID& ID, const NamedDecl *FD,
                            const MemRegion*);
...
class BlockCodeRegion : public CodeTextRegion {
  ...
  static void ProfileRegion(toolchain::FoldingSetNodeID& ID, const BlockDecl *BD,
...
class BlockDataRegion : public TypedRegion {
  ...
  static void ProfileRegion(toolchain::FoldingSetNodeID&, const BlockCodeRegion *,
...
public:
  ...
  toolchain::iterator_range<referenced_vars_iterator> referenced_vars() const;
...
public:
  ...
  static void ProfileRegion(toolchain::FoldingSetNodeID& ID,
                            SymbolRef sym,
                            const MemRegion* superRegion);
...
class NonParamVarRegion : public VarRegion {
  ...
  static void ProfileRegion(toolchain::FoldingSetNodeID &ID, const VarDecl *VD,
                            const MemRegion *superRegion);
...
class ParamVarRegion : public VarRegion {
  ...
  static void ProfileRegion(toolchain::FoldingSetNodeID &ID, const Expr *OE,
...
class FieldRegion : public DeclRegion {
  ...
  static void ProfileRegion(toolchain::FoldingSetNodeID &ID, const FieldDecl *FD,
                            const MemRegion* superRegion) {
...
class ObjCIvarRegion : public DeclRegion {
  ...
  static void ProfileRegion(toolchain::FoldingSetNodeID& ID, const ObjCIvarDecl *ivd,
                            const MemRegion* superRegion);
...
class ElementRegion : public TypedValueRegion {
  ...
  static void ProfileRegion(toolchain::FoldingSetNodeID& ID, QualType elementType,
...
class CXXLifetimeExtendedObjectRegion : public TypedValueRegion {
  ...
  static void ProfileRegion(toolchain::FoldingSetNodeID &ID, Expr const *E,
...
class CXXBaseObjectRegion : public TypedValueRegion {
  ...
  toolchain::PointerIntPair<const CXXRecordDecl *, 1, bool> Data;
  ...
  static void ProfileRegion(toolchain::FoldingSetNodeID &ID, const CXXRecordDecl *RD,
...
class MemRegionManager {
  ...
  toolchain::FoldingSet<MemRegion> Regions;
  ...
  toolchain::DenseMap<const StackFrameContext *, StackLocalsSpaceRegion *>
    StackLocalsSpaceRegions;
  toolchain::DenseMap<const StackFrameContext *, StackArgumentsSpaceRegion *>
    StackArgumentsSpaceRegions;
  toolchain::DenseMap<const CodeTextRegion *, StaticGlobalSpaceRegion *>
...
public:
  MemRegionManager(ASTContext &c, toolchain::BumpPtrAllocator &a) : Ctx(c), A(a) {}
  ~MemRegionManager();

  ASTContext &getContext() { return Ctx; }
  const ASTContext &getContext() const { return Ctx; }

  toolchain::BumpPtrAllocator &getAllocator() { return A; }
...
class RegionAndSymbolInvalidationTraits {
  ...
  toolchain::DenseMap<const MemRegion *, StorageTypeForKinds> MRTraitsMap;
  toolchain::DenseMap<SymbolRef, StorageTypeForKinds> SymTraitsMap;

  using const_region_iterator =
      toolchain::DenseMap<const MemRegion *, StorageTypeForKinds>::const_iterator;
  using const_symbol_iterator =
      toolchain::DenseMap<SymbolRef, StorageTypeForKinds>::const_iterator;
...
#endif // LANGUAGE_CORE_STATICANALYZER_CORE_PATHSENSITIVE_MEMREGION_H
