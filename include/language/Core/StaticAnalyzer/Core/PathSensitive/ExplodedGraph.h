...
#ifndef LANGUAGE_CORE_STATICANALYZER_CORE_PATHSENSITIVE_EXPLODEDGRAPH_H
#define LANGUAGE_CORE_STATICANALYZER_CORE_PATHSENSITIVE_EXPLODEDGRAPH_H
...
class ExplodedNode : public toolchain::FoldingSetNode {
...
public:
  ...
  using const_succ_range = toolchain::iterator_range<const_succ_iterator>;
  ...
  using const_pred_range = toolchain::iterator_range<const_pred_iterator>;
...
using InterExplodedGraphMap =
    toolchain::DenseMap<const ExplodedNode *, const ExplodedNode *>;
...
protected:
  ...
  toolchain::FoldingSet<ExplodedNode> Nodes;
...
public:
  ...
  using AllNodesTy = toolchain::FoldingSet<ExplodedNode>;
  ...
  toolchain::iterator_range<node_iterator> nodes() { return Nodes; }

  toolchain::iterator_range<const_node_iterator> nodes() const { return Nodes; }
  ...
  toolchain::BumpPtrAllocator & getAllocator() { return BVC.getAllocator(); }
  BumpVectorContext &getNodeAllocator() { return BVC; }

  using NodeMap = toolchain::DenseMap<const ExplodedNode *, ExplodedNode *>;
...
class ExplodedNodeSet {
  using ImplTy = toolchain::SmallSetVector<ExplodedNode *, 4>;
  ImplTy Impl;
...
namespace toolchain {
  template <> struct GraphTraits<language::Core::ento::ExplodedGraph *> {
    using GraphTy = language::Core::ento::ExplodedGraph *;
    using NodeRef = language::Core::ento::ExplodedNode *;
    using ChildIteratorType = language::Core::ento::ExplodedNode::succ_iterator;
    using nodes_iterator = toolchain::df_iterator<GraphTy>;
...
#endif // LANGUAGE_CORE_STATICANALYZER_CORE_PATHSENSITIVE_EXPLODEDGRAPH_H
