...
#ifndef LANGUAGE_CORE_STATICANALYZER_CORE_CHECKER_H
#define LANGUAGE_CORE_STATICANALYZER_CORE_CHECKER_H
...
class BlockEntrance {
  ...
  static void _checkBlockEntrance(void *Checker,
                                  const language::Core::BlockEntrance &Entrance,
                                  CheckerContext &C) {
...
public:
  using BlockEntrance = language::Core::BlockEntrance;
