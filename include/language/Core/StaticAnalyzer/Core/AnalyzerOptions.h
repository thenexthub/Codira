...
#ifndef LANGUAGE_CORE_STATICANALYZER_CORE_ANALYZEROPTIONS_H
#define LANGUAGE_CORE_STATICANALYZER_CORE_ANALYZEROPTIONS_H
...
public:
  using ConfigTable = toolchain::StringMap<std::string>;
  ...
  ///            ^~~~~~~~~~~~~~~~~~EntryWidth
  ///   ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~MinLineWidth
  static void printFormattedEntry(toolchain::raw_ostream &Out,
...
#undef ANALYZER_OPTION_DEPENDS_ON_USER_MODE
  ...
  bool isUnknownAnalyzerConfig(toolchain::StringRef Name) {
    static std::vector<toolchain::StringLiteral> AnalyzerConfigCmdFlags = []() {
      // Create an array of all -analyzer-config command line options.
      std::vector<toolchain::StringLiteral> AnalyzerConfigCmdFlags = {
#define ANALYZER_OPTION_DEPENDS_ON_USER_MODE(TYPE, NAME, CMDFLAG, DESC,        \
                                             SHALLOW_VAL, DEEP_VAL)            \
  ANALYZER_OPTION(TYPE, NAME, CMDFLAG, DESC, SHALLOW_VAL)

#define ANALYZER_OPTION(TYPE, NAME, CMDFLAG, DESC, DEFAULT_VAL)                \
  toolchain::StringLiteral(CMDFLAG),
...
#undef ANALYZER_OPTION_DEPENDS_ON_USER_MODE
      ...
      toolchain::sort(AnalyzerConfigCmdFlags);
      return AnalyzerConfigCmdFlags;
    }();

    return !toolchain::binary_search(AnalyzerConfigCmdFlags, Name);
  }
...
AnalyzerOptions::getRegisteredCheckers(bool IncludeExperimental) {
  static constexpr toolchain::StringLiteral StaticAnalyzerCheckerNames[] = {
#define GET_CHECKERS
#define CHECKER(FULLNAME, CLASS, HELPTEXT, DOC_URI, IS_HIDDEN)                 \
  toolchain::StringLiteral(FULLNAME),
...
AnalyzerOptions::getRegisteredPackages(bool IncludeExperimental) {
  static constexpr toolchain::StringLiteral StaticAnalyzerPackageNames[] = {
#define GET_PACKAGES
#define PACKAGE(FULLNAME) toolchain::StringLiteral(FULLNAME),
#include "language/Core/StaticAnalyzer/Checkers/Checkers.inc"
#undef PACKAGE
#undef GET_PACKAGES
  };
...
#endif // LANGUAGE_CORE_STATICANALYZER_CORE_ANALYZEROPTIONS_H
