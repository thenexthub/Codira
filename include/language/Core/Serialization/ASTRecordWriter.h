...
#ifndef LANGUAGE_CORE_SERIALIZATION_ASTRECORDWRITER_H
#define LANGUAGE_CORE_SERIALIZATION_ASTRECORDWRITER_H
...
public:
  ...
  void AddAPInt(const toolchain::APInt &Value) {
    writeAPInt(Value);
  }

  /// Emit a signed integral value.
  void AddAPSInt(const toolchain::APSInt &Value) {
    writeAPSInt(Value);
  }

  /// Emit a floating-point value.
  void AddAPFloat(const toolchain::APFloat &Value);
