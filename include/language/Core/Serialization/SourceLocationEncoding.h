...
#ifndef LANGUAGE_CORE_SERIALIZATION_SOURCELOCATIONENCODING_H
#define LANGUAGE_CORE_SERIALIZATION_SOURCELOCATIONENCODING_H
...
SourceLocationEncoding::decode(RawLocEncoding Encoded) {
  ...
  Encoded &= toolchain::maskTrailingOnes<RawLocEncoding>(32);
