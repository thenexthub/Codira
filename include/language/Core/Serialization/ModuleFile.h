...
#ifndef LANGUAGE_CORE_SERIALIZATION_MODULEFILE_H
#define LANGUAGE_CORE_SERIALIZATION_MODULEFILE_H
...
class InputFile {
  ...
  toolchain::PointerIntPair<const FileEntryRef::MapEntry *, 2, unsigned> Val;
...
public:
  ...
  toolchain::BitVector SearchPathUsage;

  /// The bit vector denoting usage of each VFS entry (true = used).
  toolchain::BitVector VFSUsage;
  ...
  toolchain::BitstreamCursor InputFilesCursor;

  /// Absolute offset of the start of the input-files block.
  uint64_t InputFilesOffsetBase = 0;

  /// Relative offsets for all of the input file entries in the AST file.
  const toolchain::support::unaligned_uint64_t *InputFileOffsets = nullptr;
  ...
  toolchain::BitstreamCursor SLocEntryCursor;
  ...
  toolchain::BitstreamCursor MacroCursor;
  ...
  /// record block.
  toolchain::BitstreamCursor PreprocessorDetailCursor;
  ...
  toolchain::SetVector<ModuleFile *> ImportedBy;

  /// List of modules which this module directly imported
  toolchain::SetVector<ModuleFile *> Imports;
  ...
  toolchain::SmallVector<ModuleFile *, 16> TransitiveImports;
...
#endif // LANGUAGE_CORE_SERIALIZATION_MODULEFILE_H
