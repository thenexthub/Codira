...
#ifndef LANGUAGE_CORE_SERIALIZATION_OBJECTFILEPCHCONTAINERREADER_H
#define LANGUAGE_CORE_SERIALIZATION_OBJECTFILEPCHCONTAINERREADER_H
...
class ObjectFilePCHContainerReader : public PCHContainerReader {
  ...
  StringRef ExtractPCH(toolchain::MemoryBufferRef Buffer) const override;
};
} // namespace language::Core
