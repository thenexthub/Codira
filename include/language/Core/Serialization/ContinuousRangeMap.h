...
#ifndef LANGUAGE_CORE_SERIALIZATION_CONTINUOUSRANGEMAP_H
#define LANGUAGE_CORE_SERIALIZATION_CONTINUOUSRANGEMAP_H
...
public:
  ...
  void insertOrReplace(const value_type &Val) {
    iterator I = toolchain::lower_bound(Rep, Val, Compare());
  ...
  iterator find(Int K) {
    iterator I = toolchain::upper_bound(Rep, K, Compare());
  ...
  public:
    ...
    ~Builder() {
      toolchain::sort(Self.Rep, Compare());
      Self.Rep.erase(
          toolchain::unique(
              Self.Rep,
...
#endif // LANGUAGE_CORE_SERIALIZATION_CONTINUOUSRANGEMAP_H
