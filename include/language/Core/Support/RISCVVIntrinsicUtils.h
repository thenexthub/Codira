...
struct PrototypeDescriptor {
  ...
  parsePrototypeDescriptor(toolchain::StringRef PrototypeStr);
};

toolchain::SmallVector<PrototypeDescriptor>
parsePrototypes(toolchain::StringRef Prototypes);
...
public:
  ...
  computeTypes(BasicType BT, int Log2LMUL, unsigned NF,
               toolchain::ArrayRef<PrototypeDescriptor> Prototype);
...
public:
  RVVIntrinsic(toolchain::StringRef Name, toolchain::StringRef Suffix,
               toolchain::StringRef OverloadedName, toolchain::StringRef OverloadedSuffix,
               toolchain::StringRef IRName, bool IsMasked, bool HasMaskedOffOperand,
               bool HasVL, PolicyScheme Scheme, bool SupportOverloading,
               bool HasBuiltinAlias, toolchain::StringRef ManualCodegen,
  ...
  toolchain::StringRef getBuiltinName() const { return BuiltinName; }
  ...
  toolchain::StringRef getOverloadedName() const { return OverloadedName; }
  toolchain::StringRef getIRName() const { return IRName; }
  toolchain::StringRef getManualCodegen() const { return ManualCodegen; }
  ...
  unsigned getPolicyAttrsBits() const {
    ...
    toolchain_unreachable("unsupport policy");
    return 0;
  }
  ...
  static toolchain::SmallVector<PrototypeDescriptor>
  computeBuiltinTypes(toolchain::ArrayRef<PrototypeDescriptor> Prototype,
                      bool IsMasked, bool HasMaskedOffOperand, bool HasVL,
                      unsigned NF, PolicyScheme DefaultScheme,
                      Policy PolicyAttrs, bool IsTuple);

  static toolchain::SmallVector<Policy> getSupportedUnMaskedPolicies();
  static toolchain::SmallVector<Policy>
