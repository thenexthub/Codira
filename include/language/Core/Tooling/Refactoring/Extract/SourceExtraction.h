...
#ifndef LANGUAGE_CORE_TOOLING_REFACTORING_EXTRACT_SOURCEEXTRACTION_H
#define LANGUAGE_CORE_TOOLING_REFACTORING_EXTRACT_SOURCEEXTRACTION_H
...
#endif // LANGUAGE_CORE_TOOLING_REFACTORING_EXTRACT_SOURCEEXTRACTION_H
