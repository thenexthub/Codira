...
#ifndef LANGUAGE_CORE_TOOLING_COMPILATIONDATABASE_H
#define LANGUAGE_CORE_TOOLING_COMPILATIONDATABASE_H
...
public:
  ...
  ///
  /// The argument list is meant to be compatible with normal toolchain command line
...
#endif // LANGUAGE_CORE_TOOLING_COMPILATIONDATABASE_H
