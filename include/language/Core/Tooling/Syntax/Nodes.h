...
//===----------------------------------------------------------------------===//
#ifndef LANGUAGE_CORE_TOOLING_SYNTAX_NODES_H
#define LANGUAGE_CORE_TOOLING_SYNTAX_NODES_H
...
#include "language/Core/Tooling/Syntax/NodeClasses.inc"
...
/// correspond 1-to-1 to language::Core::Decl. Syntax trees distinguish between top-level
