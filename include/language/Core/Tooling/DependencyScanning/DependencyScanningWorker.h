...
#ifndef LANGUAGE_CORE_TOOLING_DEPENDENCYSCANNING_DEPENDENCYSCANNINGWORKER_H
#define LANGUAGE_CORE_TOOLING_DEPENDENCYSCANNING_DEPENDENCYSCANNINGWORKER_H
...
public:
  ...
  toolchain::Error computeDependencies(
      StringRef WorkingDirectory, const std::vector<std::string> &CommandLine,
  ...
  /// \returns A \c StringError with the diagnostic output if clang errors
  /// occurred, success otherwise.
  toolchain::Error computeDependencies(StringRef WorkingDirectory,
                                  const std::vector<std::string> &CommandLine,
                                  DependencyConsumer &Consumer,
                                  DependencyActionController &Controller,
                                  StringRef ModuleName);

  toolchain::vfs::FileSystem &getVFS() const { return *BaseFS; }
...
private:
  ...
  toolchain::IntrusiveRefCntPtr<toolchain::vfs::FileSystem> BaseFS;
...
#endif // LANGUAGE_CORE_TOOLING_DEPENDENCYSCANNING_DEPENDENCYSCANNINGWORKER_H
