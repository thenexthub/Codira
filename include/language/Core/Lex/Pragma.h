...
#ifndef LANGUAGE_CORE_LEX_PRAGMA_H
#define LANGUAGE_CORE_LEX_PRAGMA_H
...
class PragmaNamespace : public PragmaHandler {
  ...
  /// as key.
  toolchain::StringMap<std::unique_ptr<PragmaHandler>> Handlers;
...
#endif // LANGUAGE_CORE_LEX_PRAGMA_H
