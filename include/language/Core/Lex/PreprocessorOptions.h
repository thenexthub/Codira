...
#ifndef LANGUAGE_CORE_LEX_PREPROCESSOROPTIONS_H_
#define LANGUAGE_CORE_LEX_PREPROCESSOROPTIONS_H_
...
public:
  ...
  std::vector<std::pair<std::string, toolchain::MemoryBuffer *>> RemappedFileBuffers;
...
public:
  ...
  void addRemappedFile(StringRef From, toolchain::MemoryBuffer *To) {
...
#endif // LANGUAGE_CORE_LEX_PREPROCESSOROPTIONS_H_
