...
#ifndef LANGUAGE_CORE_LEX_LEXER_H
#define LANGUAGE_CORE_LEX_LEXER_H
...
public:
  ...
  Lexer(FileID FID, const toolchain::MemoryBufferRef &InputFile, Preprocessor &PP,
  ...
  /// suitable for calls to 'LexFromRawLexer'.  This lexer assumes that the
  /// text range will outlive it, so it doesn't take ownership of it.
  Lexer(FileID FID, const toolchain::MemoryBufferRef &FromFile,
...
#endif // LANGUAGE_CORE_LEX_LEXER_H
