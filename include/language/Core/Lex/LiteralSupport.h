...
#ifndef LANGUAGE_CORE_LEX_LITERALSUPPORT_H
#define LANGUAGE_CORE_LEX_LITERALSUPPORT_H
...
public:
  ...
  bool GetIntegerValue(toolchain::APInt &Val);
  ...
  toolchain::APFloat::opStatus GetFloatValue(toolchain::APFloat &Result,
  ...
  bool GetFixedPointValue(toolchain::APInt &StoreVal, unsigned Scale);
