...
#ifndef LANGUAGE_CORE_LEX_DEPENDENCYDIRECTIVESSCANNER_H
#define LANGUAGE_CORE_LEX_DEPENDENCYDIRECTIVESSCANNER_H
...
#endif // LANGUAGE_CORE_LEX_DEPENDENCYDIRECTIVESSCANNER_H
