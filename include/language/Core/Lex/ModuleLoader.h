...
#ifndef LANGUAGE_CORE_LEX_MODULELOADER_H
#define LANGUAGE_CORE_LEX_MODULELOADER_H
...
public:
  ...
  toolchain::PointerIntPair<Module *, 2, LoadResultKind> Storage;
...
#endif // LANGUAGE_CORE_LEX_MODULELOADER_H
