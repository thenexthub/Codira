...
#ifndef LANGUAGE_CORE_LEX_HEADERSEARCHOPTIONS_H
#define LANGUAGE_CORE_LEX_HEADERSEARCHOPTIONS_H
...
public:
  ...
  toolchain::SmallSetVector<toolchain::CachedHashString, 16> ModulesIgnoreMacros;
...
inline void addHash(toolchain::HashBuilder<HasherT, Endianness> &HBuilder,
...
#endif // LANGUAGE_CORE_LEX_HEADERSEARCHOPTIONS_H
