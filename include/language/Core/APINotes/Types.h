...
#ifndef LANGUAGE_CORE_APINOTES_TYPES_H
#define LANGUAGE_CORE_APINOTES_TYPES_H
...
public:
  ...
  LLVM_DUMP_METHOD void dump(toolchain::raw_ostream &OS) const;
};
...
public:
  ...
  void setNSErrorDomain(const std::optional<toolchain::StringRef> &Domain) {
...
public:
  ...
  LLVM_DUMP_METHOD void dump(toolchain::raw_ostream &OS);
};
...
struct ObjCSelectorRef {
  unsigned NumArgs;
  toolchain::ArrayRef<toolchain::StringRef> Identifiers;
};
} // namespace api_notes
} // namespace language::Core
