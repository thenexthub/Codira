...
#ifndef LANGUAGE_CORE_REWRITE_CORE_HTMLREWRITE_H
#define LANGUAGE_CORE_REWRITE_CORE_HTMLREWRITE_H
...
namespace html {
  ...
  void HighlightRange(toolchain::RewriteBuffer &RB, unsigned B, unsigned E,
