...
#ifndef LANGUAGE_CORE_REWRITE_CORE_REWRITER_H
#define LANGUAGE_CORE_REWRITE_CORE_REWRITER_H
...
class Rewriter {
  ...
  std::map<FileID, toolchain::RewriteBuffer> RewriteBuffers;
...
public:
  struct RewriteOptions {
    ...
    /// toolchain::RewriteBuffer::RemoveText).  Moreover, it's inefficient because
  ...
  using buffer_iterator = std::map<FileID, toolchain::RewriteBuffer>::iterator;
  using const_buffer_iterator =
      std::map<FileID, toolchain::RewriteBuffer>::const_iterator;
  ...
  /// FileID's buffer.
  toolchain::RewriteBuffer &getEditBuffer(FileID FID);

  /// getRewriteBufferFor - Return the rewrite buffer for the specified FileID.
  /// If no modification has been made to it, return null.
  const toolchain::RewriteBuffer *getRewriteBufferFor(FileID FID) const {
    std::map<FileID, toolchain::RewriteBuffer>::const_iterator I =
...
#endif // LANGUAGE_CORE_REWRITE_CORE_REWRITER_H
