...
#ifndef LANGUAGE_CORE_EXTRACTAPI_EXTRACT_API_VISITOR_H
#define LANGUAGE_CORE_EXTRACTAPI_EXTRACT_API_VISITOR_H
...
protected:
  ...
  void maybeMergeWithAnonymousTag(const DeclaratorDecl &D,
    ...
    language::Core::index::generateUSRForDecl(Tag, TagUSR);
    if (auto *Record = toolchain::dyn_cast_if_present<TagRecord>(
...
#endif // LANGUAGE_CORE_EXTRACTAPI_EXTRACT_API_VISITOR_H
