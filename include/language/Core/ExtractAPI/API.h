...
#ifndef LANGUAGE_CORE_EXTRACTAPI_API_H
#define LANGUAGE_CORE_EXTRACTAPI_API_H
...
#include "language/Core/ExtractAPI/DeclarationFragments.h"
...
class Template {
  ...
  toolchain::SmallVector<TemplateParameter> Parameters;
  toolchain::SmallVector<TemplateConstraint> Constraints;
...
public:
  ...
  const toolchain::SmallVector<TemplateParameter> &getParameters() const {
    return Parameters;
  }

  const toolchain::SmallVector<TemplateConstraint> &getConstraints() const {
    return Constraints;
  }
...
public:
  ...
  using record_range = toolchain::iterator_range<record_iterator>;
...
public:
  ...
  APISet(const toolchain::Triple &Target, Language Lang,
...
private:
  ...
  toolchain::DenseMap<StringRef, APIRecordStoredPtr> USRBasedLookupTable;
  toolchain::SmallVector<const APIRecord *, 32> TopLevelRecords;
...
template <typename FromTy>
struct CastInfo<::language::Core::extractapi::RecordContext, FromTy *>
    : public NullableValueCastFailed<::language::Core::extractapi::RecordContext *>,
      public DefaultDoCastIfPossible<
          ::language::Core::extractapi::RecordContext *, FromTy *,
          CastInfo<::language::Core::extractapi::RecordContext, FromTy *>> {
  static inline bool isPossible(FromTy *From) {
    return ::language::Core::extractapi::ToRecordContextCastInfoWrapper<
        FromTy>::isPossible(From);
  }

  static inline ::language::Core::extractapi::RecordContext *doCast(FromTy *From) {
    return ::language::Core::extractapi::ToRecordContextCastInfoWrapper<FromTy>::doCast(
        From);
  }
};

template <typename FromTy>
struct CastInfo<::language::Core::extractapi::RecordContext, const FromTy *>
    : public ConstStrippingForwardingCast<
          ::language::Core::extractapi::RecordContext, const FromTy *,
          CastInfo<::language::Core::extractapi::RecordContext, FromTy *>> {};

template <typename ToTy>
struct CastInfo<ToTy, ::language::Core::extractapi::RecordContext *>
    : public NullableValueCastFailed<ToTy *>,
      public DefaultDoCastIfPossible<
          ToTy *, ::language::Core::extractapi::RecordContext *,
          CastInfo<ToTy, ::language::Core::extractapi::RecordContext *>> {
  static inline bool isPossible(::language::Core::extractapi::RecordContext *Ctx) {
    return ::language::Core::extractapi::FromRecordContextCastInfoWrapper<
        ToTy>::isPossible(Ctx);
  }

  static inline ToTy *doCast(::language::Core::extractapi::RecordContext *Ctx) {
    return ::language::Core::extractapi::FromRecordContextCastInfoWrapper<ToTy>::doCast(
        Ctx);
  }
};

template <typename ToTy>
struct CastInfo<ToTy, const ::language::Core::extractapi::RecordContext *>
    : public ConstStrippingForwardingCast<
          ToTy, const ::language::Core::extractapi::RecordContext *,
          CastInfo<ToTy, ::language::Core::extractapi::RecordContext *>> {};

} // namespace toolchain

#endif // LANGUAGE_CORE_EXTRACTAPI_API_H
