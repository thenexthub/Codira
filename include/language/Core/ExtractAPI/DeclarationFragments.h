...
#ifndef LANGUAGE_CORE_EXTRACTAPI_DECLARATION_FRAGMENTS_H
#define LANGUAGE_CORE_EXTRACTAPI_DECLARATION_FRAGMENTS_H
...
public:
  ...
  static AccessControl getAccessControl(const Decl *Decl) {
    ...
    toolchain_unreachable("Unhandled access control");
  }
...
#endif // LANGUAGE_CORE_EXTRACTAPI_DECLARATION_FRAGMENTS_H
