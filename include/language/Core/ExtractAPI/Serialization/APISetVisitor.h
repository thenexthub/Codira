...
#ifndef LANGUAGE_CORE_EXTRACTAPI_SERIALIZATION_SERIALIZERBASE_H
#define LANGUAGE_CORE_EXTRACTAPI_SERIALIZATION_SERIALIZERBASE_H
...
#endif // LANGUAGE_CORE_EXTRACTAPI_SERIALIZATION_SERIALIZERBASE_H
