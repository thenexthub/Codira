...
#ifndef LANGUAGE_CORE_EXTRACTAPI_SERIALIZATION_SYMBOLGRAPHSERIALIZER_H
#define LANGUAGE_CORE_EXTRACTAPI_SERIALIZATION_SYMBOLGRAPHSERIALIZER_H

#include "language/Core/ExtractAPI/API.h"
#include "language/Core/ExtractAPI/APIIgnoresList.h"
#include "language/Core/ExtractAPI/Serialization/APISetVisitor.h"
...
private:
  ...
  toolchain::StringMap<ExtendedModule> ExtendedModules;
  ...
  toolchain::SmallVector<SymbolReference, 8> Hierarchy;
...
public:
  ...
  static void serializeWithExtensionGraphs(
      ...
      toolchain::function_ref<
          std::unique_ptr<toolchain::raw_pwrite_stream>(toolchain::Twine BaseFileName)>
          CreateOutputStream,
      SymbolGraphSerializerOption Options = {});
...
#endif // LANGUAGE_CORE_EXTRACTAPI_SERIALIZATION_SYMBOLGRAPHSERIALIZER_H
