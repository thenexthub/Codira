...
#ifndef LANGUAGE_CORE_PARSE_PARSER_H
#define LANGUAGE_CORE_PARSE_PARSER_H
...
public:
  ...
  bool SkipUntil(tok::TokenKind T,
    ...
    return SkipUntil(toolchain::ArrayRef(T), Flags);
  }
...
private:
  ...
  void CodeCompleteIncludedFile(toolchain::StringRef Dir, bool IsAngled) override;
...
private:
  ...
  static bool isTypeSpecifier(DeclSpecContext DSC) {
    ...
    toolchain_unreachable("Missing DeclSpecContext case");
  }
  ...
  void ParseStructDeclaration(
      ParsingDeclSpec &DS,
      toolchain::function_ref<Decl *(ParsingFieldDeclarator &)> FieldsCallback,
  ...
  bool
  ParseAttributeArgumentList(const language::Core::IdentifierInfo &AttrName,
  ...
  void ParseTypeQualifierListOpt(
      ...
      toolchain::function_ref<void()> CodeCompletionHandler = {});
...
private:
  ...
  using InnerNamespaceInfoList = toolchain::SmallVector<InnerNamespaceInfo, 4>;
...
private:
  ...
  // used as type traits.
  toolchain::SmallDenseMap<IdentifierInfo *, tok::TokenKind> RevertibleTypeTraits;
  ...
  bool isRevertibleTypeTrait(const IdentifierInfo *Id,
                             language::Core::tok::TokenKind *Kind = nullptr);
  ...
  bool ParseExpressionList(SmallVectorImpl<Expr *> &Exprs,
                           toolchain::function_ref<void()> ExpressionStarts =
                               toolchain::function_ref<void()>(),
...
private:
  ...
  IdentifierInfo *ObjCTypeQuals[toolchain::to_underlying(ObjCTypeQual::NumQuals)];
...
private:
  ...
  struct OpenACCWaitParseInfo {
    ...
    SmallVector<Expr *> getAllExprs() {
      ...
      toolchain::append_range(Out, QueueIdExprs);
      return Out;
    }
  };
  ...
  using OpenACCClauseParseResult =
      toolchain::PointerIntPair<OpenACCClause *, 1, OpenACCParseCanContinue>;
  ...
  toolchain::SmallVector<Expr *> ParseOpenACCVarList(OpenACCDirectiveKind DK,
                                                OpenACCClauseKind CK);
  ...
  bool ParseOpenACCIntExprList(OpenACCDirectiveKind DK, OpenACCClauseKind CK,
                               SourceLocation Loc,
                               toolchain::SmallVectorImpl<Expr *> &IntExprs);
  ...
  bool ParseOpenACCDeviceTypeList(toolchain::SmallVector<IdentifierLoc> &Archs);
  ...
  bool ParseOpenACCSizeExprList(OpenACCClauseKind CK,
                                toolchain::SmallVectorImpl<Expr *> &SizeExprs);
  ...
  bool ParseOpenACCGangArgList(SourceLocation GangLoc,
                               toolchain::SmallVectorImpl<OpenACCGangKind> &GKs,
                               toolchain::SmallVectorImpl<Expr *> &IntExprs);
...
private:
  ...
  OpenMPClauseKind OMPClauseKind = toolchain::omp::OMPC_unknown;
  ...
  void ParseOpenMPClauses(OpenMPDirectiveKind DKind,
                          SmallVectorImpl<language::Core::OMPClause *> &Clauses,
                          SourceLocation Loc);
...
public:
  ...
  ExprResult ParseMSAsmIdentifier(toolchain::SmallVectorImpl<Token> &LineToks,
...
private:
  ...
  language::Core::Parser::DeclGroupPtrTy ParseTemplateDeclarationOrSpecialization(
