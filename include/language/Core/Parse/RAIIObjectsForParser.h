...
#ifndef LANGUAGE_CORE_PARSE_RAIIOBJECTSFORPARSER_H
#define LANGUAGE_CORE_PARSE_RAIIOBJECTSFORPARSER_H
...
namespace language::Core {
  ...
  class BalancedDelimiterTracker : public GreaterThanIsOperatorScope {
    ...
    unsigned short &getDepth() {
      switch (Kind) {
        ...
        default: toolchain_unreachable("Wrong token kind");
      }
    }
  ...
  public:
    ...
    {
      switch (Kind) {
        default: toolchain_unreachable("Unexpected balanced token");
        case tok::l_brace:
          Close = tok::r_brace;
