...
#ifndef LANGUAGE_CORE_FRONTEND_FRONTENDACTIONS_H
#define LANGUAGE_CORE_FRONTEND_FRONTENDACTIONS_H
...
class DumpModuleInfoAction : public ASTFrontendAction {
  ...
  std::shared_ptr<toolchain::raw_ostream> OutputStream;
...
public:
  ...
  explicit DumpModuleInfoAction(std::shared_ptr<toolchain::raw_ostream> Out)
      : OutputStream(Out) {}
