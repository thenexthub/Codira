...
#ifndef LANGUAGE_CORE_FRONTEND_DIAGNOSTICRENDERER_H
#define LANGUAGE_CORE_FRONTEND_DIAGNOSTICRENDERER_H
...
using DiagOrStoredDiag =
    toolchain::PointerUnion<const Diagnostic *, const StoredDiagnostic *>;
...
#endif // LANGUAGE_CORE_FRONTEND_DIAGNOSTICRENDERER_H
