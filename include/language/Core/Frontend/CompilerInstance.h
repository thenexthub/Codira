...
#ifndef LANGUAGE_CORE_FRONTEND_COMPILERINSTANCE_H_
#define LANGUAGE_CORE_FRONTEND_COMPILERINSTANCE_H_
...
class CompilerInstance : public ModuleLoader {
  ...
  std::unique_ptr<toolchain::TimerGroup> timerGroup;

  /// The frontend timer.
  std::unique_ptr<toolchain::Timer> FrontendTimer;
  ...
  /// build it again.
  toolchain::StringSet<> FailedModules;
  ...
  raw_ostream *VerboseOutputStream = &toolchain::errs();
  ...
  struct OutputFile {
    std::string Filename;
    std::optional<toolchain::sys::fs::TempFile> File;
...
public:
  ...
  ///    required.
  ///
  ///  - Clients should eventually call toolchain_shutdown() upon the completion of
  ...
  //
  // FIXME: Eliminate the toolchain_shutdown requirement, that should either be part
  ...
  void setDiagnostics(toolchain::IntrusiveRefCntPtr<DiagnosticsEngine> Value);
  ...
  toolchain::vfs::FileSystem &getVirtualFileSystem() const;
  ...
  void resetAndLeakFileManager() {
    toolchain::BuryPointer(FileMgr.get());
  ...
  void resetAndLeakSourceManager() {
    toolchain::BuryPointer(SourceMgr.get());
    SourceMgr.resetWithoutRelease();
  }

  /// setSourceManager - Replace the current source manager.
  void setSourceManager(toolchain::IntrusiveRefCntPtr<SourceManager> Value);
  ...
  void resetAndLeakPreprocessor() {
    toolchain::BuryPointer(new std::shared_ptr<Preprocessor>(PP));
  }
  ...
  void resetAndLeakASTContext() {
    toolchain::BuryPointer(Context.get());
    Context.resetWithoutRelease();
  }

  /// setASTContext - Replace the current AST context.
  void setASTContext(toolchain::IntrusiveRefCntPtr<ASTContext> Value);
  ...
  const PCHContainerWriter &getPCHContainerWriter() const {
    ...
    if (!Writer) {
      ...
      toolchain::report_fatal_error("unknown module format");
    }
    return *Writer;
  }
  ...
  toolchain::TimerGroup &getTimerGroup() const { return *timerGroup; }

  toolchain::Timer &getFrontendTimer() const {
  ...
  void createDiagnostics(toolchain::vfs::FileSystem &VFS,
  ...
  createDiagnostics(toolchain::vfs::FileSystem &VFS, DiagnosticOptions &Opts,
                    DiagnosticConsumer *Client = nullptr,
                    bool ShouldOwnClient = true,
  ...
  FileManager *
  createFileManager(IntrusiveRefCntPtr<toolchain::vfs::FileSystem> VFS = nullptr);
...
private:
  ...
  /// toolchain::sys::RemoveFileOnSignal. Note that this is not safe for
...
public:
  ...
  std::unique_ptr<toolchain::raw_pwrite_stream> takeOutputStream() {
  ...
  public:
    ...
    IntrusiveRefCntPtr<toolchain::vfs::FileSystem> getVFS() const { return VFS; }
