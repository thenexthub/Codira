...
///
/// \file
/// Defines the language::Core::FrontendAction interface and various convenience
/// abstract classes (language::Core::ASTFrontendAction, language::Core::PluginASTAction,
/// language::Core::PreprocessorFrontendAction, and language::Core::WrapperFrontendAction)
/// derived from it.
///
//===----------------------------------------------------------------------===//

#ifndef LANGUAGE_CORE_FRONTEND_FRONTENDACTION_H
#define LANGUAGE_CORE_FRONTEND_FRONTENDACTION_H
