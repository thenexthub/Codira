...
#ifndef LANGUAGE_CORE_FRONTEND_PRECOMPILEDPREAMBLE_H
#define LANGUAGE_CORE_FRONTEND_PRECOMPILEDPREAMBLE_H
...
public:
  ...
  /// the preamble.
  static toolchain::ErrorOr<PrecompiledPreamble>
  ...
  toolchain::StringRef getContents() const {
  ...
  bool CanReuse(const CompilerInvocation &Invocation,
                ...
                PreambleBounds Bounds, toolchain::vfs::FileSystem &VFS) const;
...
private:
  ...
  struct PreambleFileHash {
    ...
    toolchain::MD5::MD5Result MD5 = {};

    static PreambleFileHash createForFile(off_t Size, time_t ModTime);
    static PreambleFileHash
    createForMemoryBuffer(const toolchain::MemoryBufferRef &Buffer);
...
template <>
struct std::is_error_code_enum<language::Core::BuildPreambleError> : std::true_type {};
