...
#ifndef LANGUAGE_CORE_FRONTEND_FRONTENDOPTIONS_H
#define LANGUAGE_CORE_FRONTEND_FRONTENDOPTIONS_H
...
public:
  ...
  FrontendInputFile(toolchain::MemoryBufferRef Buffer, InputKind Kind,
                    bool IsSystem = false)
  ...
  toolchain::MemoryBufferRef getBuffer() const {
    assert(isBuffer());
    return *Buffer;
  }
};
...
#endif // LANGUAGE_CORE_FRONTEND_FRONTENDOPTIONS_H
