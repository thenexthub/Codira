...
//  AST_MATCHER_P(language::Core::MemberExpr, Member,
//                language::Core::ast_matchers::internal::Matcher<language::Core::ValueDecl>,
//                InnerMatcher) {
...
#ifndef LANGUAGE_CORE_ASTMATCHERS_ASTMATCHERSMACROS_H
#define LANGUAGE_CORE_ASTMATCHERS_ASTMATCHERSMACROS_H
...
#define AST_MATCHER_FUNCTION(ReturnType, DefineMatcher)                        \
  ...
  inline ReturnType DefineMatcher() {                                          \
    return ::language::Core::ast_matchers::internal::MemoizedMatcher<                   \
...
#define AST_MATCHER(Type, DefineMatcher)                                       \
  ...
  class matcher_##DefineMatcher##Matcher                                       \
      : public ::language::Core::ast_matchers::internal::MatcherInterface<Type> {       \
  public:                                                                      \
    explicit matcher_##DefineMatcher##Matcher() = default;                     \
    bool matches(const Type &Node,                                             \
                 ::language::Core::ast_matchers::internal::ASTMatchFinder *Finder,      \
                 ::language::Core::ast_matchers::internal::BoundNodesTreeBuilder        \
                     *Builder) const override;                                 \
  };                                                                           \
  }                                                                            \
  inline ::language::Core::ast_matchers::internal::Matcher<Type> DefineMatcher() {      \
    return ::language::Core::ast_matchers::internal::Matcher(                           \
        new internal::matcher_##DefineMatcher##Matcher());                     \
  }                                                                            \
  inline bool internal::matcher_##DefineMatcher##Matcher::matches(             \
      const Type &Node,                                                        \
      ::language::Core::ast_matchers::internal::ASTMatchFinder *Finder,                 \
      ::language::Core::ast_matchers::internal::BoundNodesTreeBuilder *Builder) const
...
#define AST_MATCHER_P_OVERLOAD(Type, DefineMatcher, ParamType, Param,          \
  ...
  typedef ::language::Core::ast_matchers::internal::Matcher<Type> (                     \
...
#define AST_POLYMORPHIC_SUPPORTED_TYPES(...)                                   \
  void(::language::Core::ast_matchers::internal::TypeList<__VA_ARGS__>)
...
#define AST_POLYMORPHIC_MATCHER(DefineMatcher, ReturnTypesF)                   \
  ...
  class matcher_##DefineMatcher##Matcher                                       \
      : public ::language::Core::ast_matchers::internal::MatcherInterface<NodeType> {   \
  public:                                                                      \
  ...
  inline ::language::Core::ast_matchers::internal::PolymorphicMatcher<                  \
      internal::matcher_##DefineMatcher##Matcher, ReturnTypesF>                \
  DefineMatcher() {                                                            \
    return ::language::Core::ast_matchers::internal::PolymorphicMatcher<                \
        internal::matcher_##DefineMatcher##Matcher, ReturnTypesF>();           \
  }                                                                            \
  template <typename NodeType>                                                 \
...
#define AST_POLYMORPHIC_MATCHER_P_OVERLOAD(DefineMatcher, ReturnTypesF,        \
  ...
  typedef ::language::Core::ast_matchers::internal::PolymorphicMatcher<                 \
      internal::matcher_##DefineMatcher##OverloadId##Matcher, ReturnTypesF,    \
  ...
  bool internal::                                                              \
      matcher_##DefineMatcher##OverloadId##Matcher<NodeType, ParamT>::matches( \
          const NodeType &Node,                                                \
          ::language::Core::ast_matchers::internal::ASTMatchFinder *Finder,             \
          ::language::Core::ast_matchers::internal::BoundNodesTreeBuilder *Builder)     \
          const
...
#define AST_TYPE_TRAVERSE_MATCHER_DECL(MatcherName, FunctionName,              \
  ...
  CLANG_ABI extern const ::language::Core::ast_matchers::internal::                     \
      TypeTraversePolymorphicMatcher<                                          \
          QualType,                                                            \
          ::language::Core::ast_matchers::internal::TypeMatcher##MatcherName##Getter,   \
          ::language::Core::ast_matchers::internal::TypeTraverseMatcher,                \
          ReturnTypesF>::Func MatcherName

#define AST_TYPE_TRAVERSE_MATCHER_DEF(MatcherName, ReturnTypesF)               \
  const ::language::Core::ast_matchers::internal::TypeTraversePolymorphicMatcher<       \
      QualType,                                                                \
      ::language::Core::ast_matchers::internal::TypeMatcher##MatcherName##Getter,       \
      ::language::Core::ast_matchers::internal::TypeTraverseMatcher,                    \
      ReturnTypesF>::Func MatcherName
...
#define AST_TYPELOC_TRAVERSE_MATCHER_DECL(MatcherName, FunctionName,           \
  ...
  CLANG_ABI extern const ::language::Core::ast_matchers::internal::                     \
      TypeTraversePolymorphicMatcher<                                          \
          TypeLoc,                                                             \
          ::language::Core::ast_matchers::internal::                                    \
              TypeLocMatcher##MatcherName##Getter,                             \
          ::language::Core::ast_matchers::internal::TypeLocTraverseMatcher,             \
...
#define AST_TYPELOC_TRAVERSE_MATCHER_DEF(MatcherName, ReturnTypesF)            \
  const ::language::Core::ast_matchers::internal::TypeTraversePolymorphicMatcher<       \
      TypeLoc,                                                                 \
      ::language::Core::ast_matchers::internal::TypeLocMatcher##MatcherName##Getter,    \
      ::language::Core::ast_matchers::internal::TypeLocTraverseMatcher,                 \
      ReturnTypesF>::Func MatcherName##Loc;                                    \
...
///
///   Node:                  the AST node being matched; its type is Type.
///   Param:                 a pointer to an \ref toolchain::Regex object
///   Finder:                an ASTMatchFinder*.
///   Builder:               a BoundNodesTreeBuilder*.
///
/// The code should return true if 'Node' matches.
...
#define AST_MATCHER_REGEX_OVERLOAD(Type, DefineMatcher, Param, OverloadId)     \
  ...
  public:                                                                      \
    explicit matcher_##DefineMatcher##OverloadId##Matcher(                     \
        std::shared_ptr<toolchain::Regex> RE)                                       \
        : Param(std::move(RE)) {}                                              \
    bool matches(const Type &Node,                                             \
                 ::language::Core::ast_matchers::internal::ASTMatchFinder *Finder,      \
                 ::language::Core::ast_matchers::internal::BoundNodesTreeBuilder        \
                     *Builder) const override;                                 \
                                                                               \
  private:                                                                     \
    std::shared_ptr<toolchain::Regex> Param;                                        \
  };                                                                           \
  }                                                                            \
  inline ::language::Core::ast_matchers::internal::Matcher<Type> DefineMatcher(         \
      toolchain::StringRef Param, toolchain::Regex::RegexFlags RegexFlags) {             \
    return ::language::Core::ast_matchers::internal::Matcher(                           \
        new internal::matcher_##DefineMatcher##OverloadId##Matcher(            \
            ::language::Core::ast_matchers::internal::createAndVerifyRegex(             \
                Param, RegexFlags, #DefineMatcher)));                          \
  }                                                                            \
  inline ::language::Core::ast_matchers::internal::Matcher<Type> DefineMatcher(         \
      toolchain::StringRef Param) {                                                 \
    return DefineMatcher(Param, toolchain::Regex::NoFlags);                         \
  }                                                                            \
                                                                               \
  typedef ::language::Core::ast_matchers::internal::Matcher<Type> (                     \
      &DefineMatcher##_Type##OverloadId##Flags)(toolchain::StringRef,               \
                                                toolchain::Regex::RegexFlags);      \
  typedef ::language::Core::ast_matchers::internal::Matcher<Type> (                     \
      &DefineMatcher##_Type##OverloadId)(toolchain::StringRef);                     \
  inline bool internal::matcher_##DefineMatcher##OverloadId##Matcher::matches( \
      const Type &Node,                                                        \
      ::language::Core::ast_matchers::internal::ASTMatchFinder *Finder,                 \
      ::language::Core::ast_matchers::internal::BoundNodesTreeBuilder *Builder) const
...
#define AST_POLYMORPHIC_MATCHER_REGEX_OVERLOAD(DefineMatcher, ReturnTypesF,    \
  ...
  inline ::language::Core::ast_matchers::internal::PolymorphicMatcher<                  \
      internal::matcher_##DefineMatcher##OverloadId##Matcher, ReturnTypesF,    \
      std::shared_ptr<toolchain::Regex>>                                            \
  DefineMatcher(toolchain::StringRef Param, toolchain::Regex::RegexFlags RegexFlags) {   \
    return ::language::Core::ast_matchers::internal::PolymorphicMatcher<                \
        internal::matcher_##DefineMatcher##OverloadId##Matcher, ReturnTypesF,  \
        std::shared_ptr<toolchain::Regex>>(                                         \
        ::language::Core::ast_matchers::internal::createAndVerifyRegex(                 \
  ...
  inline ::language::Core::ast_matchers::internal::PolymorphicMatcher<                  \
      internal::matcher_##DefineMatcher##OverloadId##Matcher, ReturnTypesF,    \
      std::shared_ptr<toolchain::Regex>>                                            \
  DefineMatcher(toolchain::StringRef Param) {                                       \
    return DefineMatcher(Param, toolchain::Regex::NoFlags);                         \
  }                                                                            \
  typedef ::language::Core::ast_matchers::internal::PolymorphicMatcher<                 \
      internal::matcher_##DefineMatcher##OverloadId##Matcher, ReturnTypesF,    \
  ...
  typedef ::language::Core::ast_matchers::internal::PolymorphicMatcher<                 \
      internal::matcher_##DefineMatcher##OverloadId##Matcher, ReturnTypesF,    \
      std::shared_ptr<toolchain::Regex>> (&DefineMatcher##_Type##OverloadId)(       \
      toolchain::StringRef Param);                                                  \
  template <typename NodeType, typename ParamT>                                \
  bool internal::                                                              \
      matcher_##DefineMatcher##OverloadId##Matcher<NodeType, ParamT>::matches( \
...
#endif // LANGUAGE_CORE_ASTMATCHERS_ASTMATCHERSMACROS_H
