...
#ifndef LANGUAGE_CORE_ASTMATCHERS_DYNAMIC_VARIANTVALUE_H
#define LANGUAGE_CORE_ASTMATCHERS_DYNAMIC_VARIANTVALUE_H
...
#endif // LANGUAGE_CORE_ASTMATCHERS_DYNAMIC_VARIANTVALUE_H
