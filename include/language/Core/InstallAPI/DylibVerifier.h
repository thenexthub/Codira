...
#ifndef LANGUAGE_CORE_INSTALLAPI_DYLIBVERIFIER_H
#define LANGUAGE_CORE_INSTALLAPI_DYLIBVERIFIER_H
...
using ReexportedInterfaces = toolchain::SmallVector<toolchain::MachO::InterfaceFile, 8>;
...
public:
  ...
  using AttrsToArchs = toolchain::SmallVector<Entry, 10>;
...
struct ZipperedDeclSource {
  ...
  language::Core::SourceManager *SrcMgr;
  Target T;
};
...
class DylibVerifier : toolchain::MachO::RecordVisitor {
private:
...
public:
  ...
  struct VerifierContext {
    ...
    void emitDiag(toolchain::function_ref<void()> Report, RecordLoc *Loc = nullptr);
  ...
  DylibVerifier(toolchain::MachO::Records &&Dylib, ReexportedInterfaces &&Reexports,
...
private:
  ...
  toolchain::StringMap<ZipperedDeclSources> DeferredZipperedSymbols;
  ...
  toolchain::SmallVector<IntrusiveRefCntPtr<SourceManager>, 12> SourceManagers;
};

} // namespace installapi
} // namespace language::Core
#endif // LANGUAGE_CORE_INSTALLAPI_DYLIBVERIFIER_H
