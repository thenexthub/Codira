...
#ifndef LANGUAGE_CORE_CIR_DIALECT_BUILDER_CIRBASEBUILDER_H
#define LANGUAGE_CORE_CIR_DIALECT_BUILDER_CIRBASEBUILDER_H
...
constexpr OverflowBehavior operator|(OverflowBehavior a, OverflowBehavior b) {
  return static_cast<OverflowBehavior>(toolchain::to_underlying(a) |
                                       toolchain::to_underlying(b));
}
...
public:
  ...
  mlir::TypedAttr getZeroInitAttr(mlir::Type ty) {
    ...
    toolchain_unreachable("Zero initializer for given type is NYI");
  }
  ...
  cir::DoWhileOp createDoWhile(
      mlir::Location loc,
      toolchain::function_ref<void(mlir::OpBuilder &, mlir::Location)> condBuilder,
      toolchain::function_ref<void(mlir::OpBuilder &, mlir::Location)> bodyBuilder) {
  ...
  cir::ForOp createFor(
      ...
      toolchain::function_ref<void(mlir::OpBuilder &, mlir::Location)> condBuilder,
      toolchain::function_ref<void(mlir::OpBuilder &, mlir::Location)> bodyBuilder,
      toolchain::function_ref<void(mlir::OpBuilder &, mlir::Location)> stepBuilder) {
  ...
  mlir::Value createAlloca(mlir::Location loc, cir::PointerType addrType,
                           mlir::Type type, toolchain::StringRef name,
  ...
  cir::GetMemberOp createGetMember(mlir::Location loc, mlir::Type resultTy,
                                   mlir::Value base, toolchain::StringRef name,
                                   unsigned index) {
  ...
  createIndirectCallOp(mlir::Location loc, mlir::Value indirectTarget,
                       ...
                       toolchain::ArrayRef<mlir::NamedAttribute> attrs = {}) {
    toolchain::SmallVector<mlir::Value> resOperands{indirectTarget};
  ...
  mlir::Value createLowBitsSet(mlir::Location loc, unsigned size,
                               unsigned bits) {
    toolchain::APInt val = toolchain::APInt::getLowBitsSet(size, bits);
  ...
  mlir::Value createMul(mlir::Location loc, mlir::Value lhs, mlir::Value rhs,
    ...
    op.setNoUnsignedWrap(
        toolchain::to_underlying(ob & OverflowBehavior::NoUnsignedWrap));
    op.setNoSignedWrap(
        toolchain::to_underlying(ob & OverflowBehavior::NoSignedWrap));
    return op;
  }
  ...
  mlir::Value createSub(mlir::Location loc, mlir::Value lhs, mlir::Value rhs,
    ...
    op.setNoSignedWrap(
        toolchain::to_underlying(ob & OverflowBehavior::NoSignedWrap));
    op.setSaturated(toolchain::to_underlying(ob & OverflowBehavior::Saturated));
    return op;
  }
  ...
  mlir::Value createShift(mlir::Location loc, mlir::Value lhs,
                          const toolchain::APInt &rhs, bool isShiftLeft) {
  ...
  mlir::Value createShift(mlir::Location loc, mlir::Value lhs, unsigned bits,
    ...
    auto shift = toolchain::APInt(width, bits);
  ...
  // attribute.
  mlir::IntegerAttr getAlignmentAttr(language::Core::CharUnits alignment) {
    return getAlignmentAttr(alignment.getQuantity());
  }

  mlir::IntegerAttr getAlignmentAttr(toolchain::Align alignment) {
  ...
  mlir::IntegerAttr getSizeFromCharUnits(language::Core::CharUnits size) {
