...
#ifndef LANGUAGE_CORE_FORMAT_FORMAT_H
#define LANGUAGE_CORE_FORMAT_FORMAT_H
...
private:
  ...
  parseConfiguration(toolchain::MemoryBufferRef Config, FormatStyle *Style,
...
/// http://toolchain.org/docs/CodingStandards.html.
FormatStyle
...
inline std::error_code parseConfiguration(StringRef Config, FormatStyle *Style,
  ...
  return parseConfiguration(toolchain::MemoryBufferRef(Config, "YAML"), Style,
...
/// \p Replaces on success; otheriwse, return an toolchain::Error carrying
/// toolchain::StringError.
Expected<tooling::Replacements>
formatReplacements(StringRef Code, const tooling::Replacements &Replaces,
                   const FormatStyle &Style);

/// Returns the replacements corresponding to applying \p Replaces and
/// cleaning up the code after that on success; otherwise, return an toolchain::Error
/// carrying toolchain::StringError.
...
/// Description to be used for help text for a ``toolchain::cl`` option for
...
getStyle(StringRef StyleName, StringRef FileName, StringRef FallbackStyle,
         StringRef Code = "", toolchain::vfs::FileSystem *FS = nullptr,
         bool AllowUnknownOptions = false,
         toolchain::SourceMgr::DiagHandlerTy DiagHandler = nullptr);
...
template <>
struct std::is_error_code_enum<language::Core::format::ParseError> : std::true_type {};

#endif // LANGUAGE_CORE_FORMAT_FORMAT_H
