...
#ifndef LANGUAGE_CORE_AST_EXPROBJC_H
#define LANGUAGE_CORE_AST_EXPROBJC_H
...
class ObjCArrayLiteral final
    : public Expr,
      private toolchain::TrailingObjects<ObjCArrayLiteral, Expr *> {
...
class ObjCDictionaryLiteral final
    : public Expr,
      private toolchain::TrailingObjects<ObjCDictionaryLiteral,
...
private:
  ...
  toolchain::PointerIntPair<NamedDecl *, 1, bool> PropertyOrGetter;
  ...
  toolchain::PointerIntPair<ObjCMethodDecl *, 2, unsigned> SetterAndMethodRefFlags;
  ...
  toolchain::PointerUnion<Stmt *, const Type *, ObjCInterfaceDecl *> Receiver;
...
class ObjCMessageExpr final
    : public Expr,
      private toolchain::TrailingObjects<ObjCMessageExpr, void *, SourceLocation> {
public:
...
public:
  ...
  toolchain::iterator_range<arg_iterator> arguments() {
    return toolchain::make_range(arg_begin(), arg_end());
  }

  toolchain::iterator_range<const_arg_iterator> arguments() const {
    return toolchain::make_range(arg_begin(), arg_end());
  }
...
class ObjCBridgedCastExpr final
    : public ExplicitCastExpr,
      private toolchain::TrailingObjects<ObjCBridgedCastExpr, CXXBaseSpecifier *> {
  friend class ASTStmtReader;
  friend class ASTStmtWriter;
...
#endif // LANGUAGE_CORE_AST_EXPROBJC_H
