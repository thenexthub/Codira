...
#ifndef LANGUAGE_CORE_AST_EXPRCONCEPTS_H
#define LANGUAGE_CORE_AST_EXPRCONCEPTS_H
...
private:
  toolchain::PointerUnion<SubstitutionDiagnostic *, TypeSourceInfo *> Value;
...
public:
  ...
  class ReturnTypeRequirement {
      toolchain::PointerIntPair<
          toolchain::PointerUnion<TemplateParameterList *, SubstitutionDiagnostic *>,
          1, bool>
          TypeConstraintInfo;
  public:
      friend ASTStmtReader;
...
private:
  toolchain::PointerUnion<Expr *, SubstitutionDiagnostic *> Value;
...
class RequiresExpr final : public Expr,
    toolchain::TrailingObjects<RequiresExpr, ParmVarDecl *,
...
#endif // LANGUAGE_CORE_AST_EXPRCONCEPTS_H
