...
#ifndef LANGUAGE_CORE_AST_TEMPLATENAME_H
#define LANGUAGE_CORE_AST_TEMPLATENAME_H
...
public:
  ...
  toolchain::ArrayRef<NamedDecl*> decls() const {
    return toolchain::ArrayRef(begin(), end());
  }
};
...
public:
  ...
  void Profile(toolchain::FoldingSetNodeID &ID, ASTContext &Context);

  static void Profile(toolchain::FoldingSetNodeID &ID, ASTContext &Context,
...
class TemplateName {
  ...
  using StorageType =
      toolchain::PointerUnion<Decl *, UncommonTemplateNameStorage *,
...
class SubstTemplateTemplateParmStorage
  : public UncommonTemplateNameStorage, public toolchain::FoldingSetNode {
  friend class ASTContext;
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, TemplateName Replacement,
                      Decl *AssociatedDecl, unsigned Index,
                      UnsignedOrNone PackIndex, bool Final);
};
...
public:
  ...
  void Profile(toolchain::FoldingSetNodeID &ID, const ASTContext &Context) const;
...
class QualifiedTemplateName : public toolchain::FoldingSetNode {
  friend class ASTContext;
  ...
  toolchain::PointerIntPair<NestedNameSpecifier, 1, bool> Qualifier;
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, NestedNameSpecifier NNS,
...
/// The language::Core::TemplateName class is effectively a pointer.
template<>
struct PointerLikeTypeTraits<language::Core::TemplateName> {
  static inline void *getAsVoidPointer(language::Core::TemplateName TN) {
    return TN.getAsVoidPointer();
  }

  static inline language::Core::TemplateName getFromVoidPointer(void *Ptr) {
    return language::Core::TemplateName::getFromVoidPointer(Ptr);
  }
...
#endif // LANGUAGE_CORE_AST_TEMPLATENAME_H
