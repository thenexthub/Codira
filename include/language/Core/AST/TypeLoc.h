...
//
/// \file
/// Defines the language::Core::TypeLoc interface and its subclasses.
//
//===----------------------------------------------------------------------===//

#ifndef LANGUAGE_CORE_AST_TYPELOC_H
#define LANGUAGE_CORE_AST_TYPELOC_H
...
#include "language/Core/AST/TypeNodes.inc"
  ...
  void dump() const;
  void dump(toolchain::raw_ostream &, const ASTContext &) const;
...
public:
  ...
  UnqualTypeLoc getUnqualifiedLoc() const {
    ...
    dataInt = toolchain::alignTo(dataInt, align);
...
public:
  ...
  unsigned getLocalDataSize() const {
    ...
    size = toolchain::alignTo(size, extraAlign);
    size += asDerived()->getExtraLocalDataSize();
    size = toolchain::alignTo(size, asDerived()->getLocalDataAlignment());
    return size;
  }
...
protected:
  ...
  void *getNonLocalData() const {
    ...
    data = toolchain::alignTo(data, getNextTypeAlign());
...
#endif // LANGUAGE_CORE_AST_TYPELOC_H
