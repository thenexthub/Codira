...
#ifndef LANGUAGE_CORE_AST_ASTTYPETRAITS_H
#define LANGUAGE_CORE_AST_ASTTYPETRAITS_H
...
public:
  ...
  void print(toolchain::raw_ostream &OS, const PrintingPolicy &PP) const;
  ...
  struct DenseMapInfo {
    ...
    static unsigned getHashValue(const DynTypedNode &Val) {
      ...
      if (ASTNodeKind::getFromNodeKind<TypeLoc>().isBaseOf(Val.NodeKind)) {
        ...
        return toolchain::hash_combine(TL.getType().getAsOpaquePtr(),
                                  TL.getOpaqueData());
      }
      ...
      return toolchain::hash_value(Val.getMemoizationData());
    }
...
private:
  ...
  toolchain::AlignedCharArrayUnion<const void *, TemplateArgument,
...
template <>
struct DenseMapInfo<language::Core::ASTNodeKind> : language::Core::ASTNodeKind::DenseMapInfo {};

template <>
struct DenseMapInfo<language::Core::DynTypedNode> : language::Core::DynTypedNode::DenseMapInfo {};
