...
#ifndef LANGUAGE_CORE_AST_VTABLEBUILDER_H
#define LANGUAGE_CORE_AST_VTABLEBUILDER_H
...
public:
  ...
  GlobalDecl getGlobalDecl() const {
    ...
    case CK_UnusedFunctionPointer:
      toolchain_unreachable("Only function pointers kinds");
    }
    toolchain_unreachable("Should already return");
  }
...
public:
  ...
  typedef toolchain::DenseMap<BaseSubobject, AddressPointLocation>
      AddressPointsMapTy;
  ...
  typedef toolchain::SmallVector<unsigned, 4> AddressPointsIndexMapTy;
...
public:
  typedef toolchain::DenseMap<const CXXMethodDecl *, const CXXMethodDecl *>
      OriginalMethodMapTy;
...
private:
  ...
  typedef toolchain::DenseMap<const CXXRecordDecl *,
  ...
  typedef toolchain::DenseMap<ClassPairTy, CharUnits>
...
struct VirtualBaseInfo {
  ...
  toolchain::DenseMap<const CXXRecordDecl *, unsigned> VBTableIndices;
...
private:
  ...
  typedef toolchain::DenseMap<const CXXRecordDecl *, std::unique_ptr<VPtrInfoVector>>
      VFPtrLocationsMapTy;
  VFPtrLocationsMapTy VFPtrLocations;

  typedef std::pair<const CXXRecordDecl *, CharUnits> VFTableIdTy;
  typedef toolchain::DenseMap<VFTableIdTy, std::unique_ptr<const VTableLayout>>
      VFTableLayoutMapTy;
  VFTableLayoutMapTy VFTableLayouts;

  toolchain::DenseMap<const CXXRecordDecl *, std::unique_ptr<VirtualBaseInfo>>
      VBaseInfo;
