...
#ifndef LANGUAGE_CORE_AST_OSLOG_H
#define LANGUAGE_CORE_AST_OSLOG_H
...
public:
  ...
  bool hasNonScalarOrMask() const {
    return toolchain::any_of(Items, [](const OSLogBufferItem &Item) {
...
bool computeOSLogBufferLayout(language::Core::ASTContext &Ctx, const language::Core::CallExpr *E,
