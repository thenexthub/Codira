...
#ifndef LANGUAGE_CORE_AST_DECLTEMPLATE_H
#define LANGUAGE_CORE_AST_DECLTEMPLATE_H
...
using TemplateParameter =
    toolchain::PointerUnion<TemplateTypeParmDecl *, NonTypeTemplateParmDecl *,
...
class TemplateParameterList final
    : private toolchain::TrailingObjects<TemplateParameterList, NamedDecl *,
                                    Expr *> {
...
public:
  ...
  void Profile(toolchain::FoldingSetNodeID &ID, const ASTContext &C) const;
  ...
  void getAssociatedConstraints(
      toolchain::SmallVectorImpl<AssociatedConstraint> &AC) const;
...
class TemplateArgumentList final
    : private toolchain::TrailingObjects<TemplateArgumentList, TemplateArgument> {
...
class DefaultArgStorage {
  ...
  toolchain::PointerUnion<ArgType, ParmDecl*, Chain*> ValueOrInherited;
...
class FunctionTemplateSpecializationInfo final
    : public toolchain::FoldingSetNode,
      private toolchain::TrailingObjects<FunctionTemplateSpecializationInfo,
  ...
  toolchain::PointerIntPair<FunctionDecl *, 1, bool> Function;

  /// The function template from which this function template
  /// specialization was generated.
  ///
  /// The two bits contain the top 4 values of TemplateSpecializationKind.
  toolchain::PointerIntPair<FunctionTemplateDecl *, 2> Template;
...
public:
  ...
  static void
  Profile(toolchain::FoldingSetNodeID &ID, ArrayRef<TemplateArgument> TemplateArgs,
...
class MemberSpecializationInfo {
  ...
  toolchain::PointerIntPair<NamedDecl *, 2> MemberAndTSK;
...
class DependentFunctionTemplateSpecializationInfo final
    : private toolchain::TrailingObjects<DependentFunctionTemplateSpecializationInfo,
...
protected:
  ...
  struct SpecIterator
      : toolchain::iterator_adaptor_base<
            ...
            typename toolchain::FoldingSetVector<EntryType>::iterator,
            typename std::iterator_traits<typename toolchain::FoldingSetVector<
                EntryType>::iterator>::iterator_category,
            DeclType *, ptrdiff_t, DeclType *, DeclType *> {
    SpecIterator() = default;
    explicit SpecIterator(
        typename toolchain::FoldingSetVector<EntryType>::iterator SetIter)
  ...
  makeSpecIterator(toolchain::FoldingSetVector<EntryType> &Specs, bool isEnd) {
  ...
  findSpecializationImpl(toolchain::FoldingSetVector<EntryType> &Specs,
                         void *&InsertPos, ProfileArguments... ProfileArgs);

  template <class EntryType, typename... ProfileArguments>
  typename SpecEntryTraits<EntryType>::DeclType *
  findSpecializationLocally(toolchain::FoldingSetVector<EntryType> &Specs,
                            void *&InsertPos, ProfileArguments... ProfileArgs);

  template <class Derived, class EntryType>
  void addSpecializationImpl(toolchain::FoldingSetVector<EntryType> &Specs,
  ...
  struct CommonBase {
    ...
    toolchain::PointerIntPair<RedeclarableTemplateDecl *, 1, bool>
...
protected:
  ...
  struct Common : CommonBase {
    ...
    toolchain::FoldingSetVector<FunctionTemplateSpecializationInfo> Specializations;
  ...
  /// function template.
  toolchain::FoldingSetVector<FunctionTemplateSpecializationInfo> &
...
public:
  ...
  using spec_range = toolchain::iterator_range<spec_iterator>;
...
class TemplateTypeParmDecl final : public TypeDecl,
    private toolchain::TrailingObjects<TemplateTypeParmDecl, TypeConstraint> {
...
class NonTypeTemplateParmDecl final
    : public DeclaratorDecl,
      ...
      private toolchain::TrailingObjects<NonTypeTemplateParmDecl,
...
class TemplateTemplateParmDecl final
    : public TemplateDecl,
      protected TemplateParmPosition,
      private toolchain::TrailingObjects<TemplateTemplateParmDecl,
...
using SpecializationOrInstantiationInfo =
    toolchain::PointerUnion<const ASTTemplateArgumentListInfo *,
...
class ClassTemplateSpecializationDecl : public CXXRecordDecl,
  ...
  toolchain::PointerUnion<ClassTemplateDecl *, SpecializedPartialSpecialization *>
    SpecializedTemplate;
...
public:
  ...
  getInstantiatedFrom() const {
    if (!isTemplateInstantiation(getSpecializationKind()))
      return toolchain::PointerUnion<ClassTemplateDecl *,
                                ClassTemplatePartialSpecializationDecl *>();
...
class ClassTemplatePartialSpecializationDecl
  ...
  toolchain::PointerIntPair<ClassTemplatePartialSpecializationDecl *, 1, bool>
      InstantiatedFromMember;
...
protected:
  ...
  struct Common : CommonBase {
    ...
    /// template, including explicit specializations and instantiations.
    toolchain::FoldingSetVector<ClassTemplateSpecializationDecl> Specializations;

    /// The class template partial specializations for this class
    /// template.
    toolchain::FoldingSetVector<ClassTemplatePartialSpecializationDecl>
  ...
  toolchain::FoldingSetVector<ClassTemplateSpecializationDecl> &
  getSpecializations() const;
...
class VarTemplateSpecializationDecl : public VarDecl,
  ...
  /// The template that this specialization specializes.
  toolchain::PointerUnion<VarTemplateDecl *, SpecializedPartialSpecialization *>
  SpecializedTemplate;
...
public:
  ...
  /// it was instantiated.
  toolchain::PointerUnion<VarTemplateDecl *, VarTemplatePartialSpecializationDecl *>
  getInstantiatedFrom() const {
    if (!isTemplateInstantiation(getSpecializationKind()))
      return toolchain::PointerUnion<VarTemplateDecl *,
...
class VarTemplatePartialSpecializationDecl
  ...
  /// partial specialization was specialized at this level.
  toolchain::PointerIntPair<VarTemplatePartialSpecializationDecl *, 1, bool>
  InstantiatedFromMember;
...
protected:
  ...
  struct Common : CommonBase {
    ...
    /// template, including explicit specializations and instantiations.
    toolchain::FoldingSetVector<VarTemplateSpecializationDecl> Specializations;

    /// The variable template partial specializations for this variable
    /// template.
    toolchain::FoldingSetVector<VarTemplatePartialSpecializationDecl>
    PartialSpecializations;
  ...
  toolchain::FoldingSetVector<VarTemplateSpecializationDecl> &
  getSpecializations() const;
...
class ImplicitConceptSpecializationDecl final
    : public Decl,
      private toolchain::TrailingObjects<ImplicitConceptSpecializationDecl,
                                    TemplateArgument> {
...
public:
  ...
  void printName(toolchain::raw_ostream &OS,
                 const PrintingPolicy &Policy) const override;

  /// Print this object as an equivalent expression.
  void printAsExpr(toolchain::raw_ostream &OS) const;
  void printAsExpr(toolchain::raw_ostream &OS, const PrintingPolicy &Policy) const;

  /// Print this object as an initializer suitable for a variable of the
  /// object's type.
  void printAsInit(toolchain::raw_ostream &OS) const;
  void printAsInit(toolchain::raw_ostream &OS, const PrintingPolicy &Policy) const;
...
#endif // LANGUAGE_CORE_AST_DECLTEMPLATE_H
