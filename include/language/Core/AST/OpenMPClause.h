...
#ifndef LANGUAGE_CORE_AST_OPENMPCLAUSE_H
#define LANGUAGE_CORE_AST_OPENMPCLAUSE_H
...
#include "toolchain/Frontend/OpenMP/OMPAssume.h"
#include "toolchain/Frontend/OpenMP/OMPConstants.h"
#include "toolchain/Frontend/OpenMP/OMPContext.h"
...
class OMPClauseWithPreInit {
  ...
  OpenMPDirectiveKind CaptureRegion = toolchain::omp::OMPD_unknown;
...
protected:
  ...
  setPreInitStmt(Stmt *S,
                 OpenMPDirectiveKind ThisRegion = toolchain::omp::OMPD_unknown) {
    PreInit = S;
...
protected:
  ...
  void setVarRefs(ArrayRef<Expr *> VL) {
    ...
    toolchain::copy(VL, getVarRefs().begin());
  }

public:
  using varlist_iterator = MutableArrayRef<Expr *>::iterator;
  using varlist_const_iterator = ArrayRef<const Expr *>::iterator;
  using varlist_range = toolchain::iterator_range<varlist_iterator>;
  using varlist_const_range = toolchain::iterator_range<varlist_const_iterator>;
...
public:
  ...
  void setDirectiveKinds(ArrayRef<OpenMPDirectiveKind> DK) {
    ...
    toolchain::copy(DK, getDirectiveKinds().begin());
  }
...
class OMPAllocatorClause final
    : public OMPOneStmtClause<toolchain::omp::OMPC_allocator, OMPClause> {
  friend class OMPClauseReader;
...
class OMPAlignClause final
    : public OMPOneStmtClause<toolchain::omp::OMPC_align, OMPClause> {
  friend class OMPClauseReader;
...
class OMPAllocateClause final
    : public OMPVarListClause<OMPAllocateClause>,
      private toolchain::TrailingObjects<OMPAllocateClause, Expr *> {
  friend class OMPClauseReader;
  ...
  OMPAllocateClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                    ...
                    unsigned N)
      : OMPVarListClause<OMPAllocateClause>(toolchain::omp::OMPC_allocate, StartLoc,
                                            LParenLoc, EndLoc, N),
  ...
  explicit OMPAllocateClause(unsigned N)
      : OMPVarListClause<OMPAllocateClause>(toolchain::omp::OMPC_allocate,
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_allocate;
  }
};
...
class OMPIfClause : public OMPClause, public OMPClauseWithPreInit {
  ...
  OpenMPDirectiveKind NameModifier = toolchain::omp::OMPD_unknown;
...
public:
  ...
  OMPIfClause(OpenMPDirectiveKind NameModifier, Expr *Cond, Stmt *HelperCond,
      ...
      : OMPClause(toolchain::omp::OMPC_if, StartLoc, EndLoc),
  ...
  /// Build an empty clause.
  OMPIfClause()
      : OMPClause(toolchain::omp::OMPC_if, SourceLocation(), SourceLocation()),
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_if;
  }
};
...
class OMPFinalClause final
    : public OMPOneStmtClause<toolchain::omp::OMPC_final, OMPClause>,
...
class OMPNumThreadsClause final
    : public OMPOneStmtClause<toolchain::omp::OMPC_num_threads, OMPClause>,
      public OMPClauseWithPreInit {
  friend class OMPClauseReader;
...
class OMPSafelenClause final
    : public OMPOneStmtClause<toolchain::omp::OMPC_safelen, OMPClause> {
  friend class OMPClauseReader;
...
class OMPSimdlenClause final
    : public OMPOneStmtClause<toolchain::omp::OMPC_simdlen, OMPClause> {
  friend class OMPClauseReader;
...
class OMPSizesClause final
    : public OMPClause,
      private toolchain::TrailingObjects<OMPSizesClause, Expr *> {
  friend class OMPClauseReader;
  friend class toolchain::TrailingObjects<OMPSizesClause, Expr *>;
  ...
  explicit OMPSizesClause(int NumSizes)
      : OMPClause(toolchain::omp::OMPC_sizes, SourceLocation(), SourceLocation()),
        NumSizes(NumSizes) {}
...
public:
  ...
  void setSizesRefs(ArrayRef<Expr *> VL) {
    ...
    toolchain::copy(VL, getSizesRefs().begin());
  }
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_sizes;
  }
};
...
class OMPPermutationClause final
  ...
  void setArgRefs(ArrayRef<Expr *> VL) {
    ...
    toolchain::copy(VL, getTrailingObjects());
  }

  /// Build an empty clause.
  explicit OMPPermutationClause(int NumLoops)
      : OMPClause(toolchain::omp::OMPC_permutation, SourceLocation(),
                  SourceLocation()),
        NumLoops(NumLoops) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_permutation;
  }
};
...
/// for (int i = 0; i < 64; ++i)
/// \endcode
class OMPFullClause final : public OMPNoChildClause<toolchain::omp::OMPC_full> {
  friend class OMPClauseReader;
...
class OMPPartialClause final : public OMPClause {
  ...
  /// Build an empty clause.
  explicit OMPPartialClause() : OMPClause(toolchain::omp::OMPC_partial, {}, {}) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_partial;
  }
};
...
class OMPCollapseClause final
    : public OMPOneStmtClause<toolchain::omp::OMPC_collapse, OMPClause> {
  friend class OMPClauseReader;
...
class OMPDefaultClause : public OMPClause {
  ...
  toolchain::omp::DefaultKind Kind = toolchain::omp::OMP_DEFAULT_unknown;
  ...
  void setDefaultKind(toolchain::omp::DefaultKind K) { Kind = K; }
...
public:
  ...
  /// \param LParenLoc Location of '('.
  /// \param EndLoc Ending location of the clause.
  OMPDefaultClause(toolchain::omp::DefaultKind A, SourceLocation ALoc,
                   SourceLocation StartLoc, SourceLocation LParenLoc,
                   SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_default, StartLoc, EndLoc),
        LParenLoc(LParenLoc), Kind(A), KindKwLoc(ALoc) {}

  /// Build an empty clause.
  OMPDefaultClause()
      : OMPClause(toolchain::omp::OMPC_default, SourceLocation(), SourceLocation()) {
  }
  ...
  toolchain::omp::DefaultKind getDefaultKind() const { return Kind; }
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_default;
  }
};
...
class OMPProcBindClause : public OMPClause {
  ...
  toolchain::omp::ProcBindKind Kind = toolchain::omp::OMP_PROC_BIND_unknown;
  ...
  void setProcBindKind(toolchain::omp::ProcBindKind K) { Kind = K; }
...
public:
  ...
  /// \param LParenLoc Location of '('.
  /// \param EndLoc Ending location of the clause.
  OMPProcBindClause(toolchain::omp::ProcBindKind A, SourceLocation ALoc,
                    SourceLocation StartLoc, SourceLocation LParenLoc,
                    SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_proc_bind, StartLoc, EndLoc),
        LParenLoc(LParenLoc), Kind(A), KindKwLoc(ALoc) {}

  /// Build an empty clause.
  OMPProcBindClause()
      : OMPClause(toolchain::omp::OMPC_proc_bind, SourceLocation(),
                  SourceLocation()) {}
  ...
  /// Returns kind of the clause.
  toolchain::omp::ProcBindKind getProcBindKind() const { return Kind; }
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_proc_bind;
  }
};
...
class OMPUnifiedAddressClause final
    : public OMPNoChildClause<toolchain::omp::OMPC_unified_address> {
public:
  friend class OMPClauseReader;
...
public:
  ...
  OMPUnifiedSharedMemoryClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_unified_shared_memory, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OMPUnifiedSharedMemoryClause()
      : OMPClause(toolchain::omp::OMPC_unified_shared_memory, SourceLocation(),
                  SourceLocation()) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_unified_shared_memory;
  }
};
...
public:
  ...
  OMPReverseOffloadClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_reverse_offload, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OMPReverseOffloadClause()
      : OMPClause(toolchain::omp::OMPC_reverse_offload, SourceLocation(),
                  SourceLocation()) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_reverse_offload;
  }
};
...
public:
  ...
  OMPDynamicAllocatorsClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_dynamic_allocators, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OMPDynamicAllocatorsClause()
      : OMPClause(toolchain::omp::OMPC_dynamic_allocators, SourceLocation(),
                  SourceLocation()) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_dynamic_allocators;
  }
};
...
public:
  ...
  OMPAtomicDefaultMemOrderClause(OpenMPAtomicDefaultMemOrderClauseKind A,
                                 ...
                                 SourceLocation LParenLoc,
                                 SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_atomic_default_mem_order, StartLoc, EndLoc),
        LParenLoc(LParenLoc), Kind(A), KindKwLoc(ALoc) {}

  /// Build an empty clause.
  OMPAtomicDefaultMemOrderClause()
      : OMPClause(toolchain::omp::OMPC_atomic_default_mem_order, SourceLocation(),
                  SourceLocation()) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_atomic_default_mem_order;
  }
};
...
public:
  ...
  OMPSelfMapsClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_self_maps, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OMPSelfMapsClause()
      : OMPClause(toolchain::omp::OMPC_self_maps, SourceLocation(),
                  SourceLocation()) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_self_maps;
  }
};
...
public:
  ...
  OMPAtClause(OpenMPAtClauseKind A, SourceLocation ALoc,
              SourceLocation StartLoc, SourceLocation LParenLoc,
              SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_at, StartLoc, EndLoc), LParenLoc(LParenLoc),
        Kind(A), KindKwLoc(ALoc) {}

  /// Build an empty clause.
  OMPAtClause()
      : OMPClause(toolchain::omp::OMPC_at, SourceLocation(), SourceLocation()) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_at;
  }
};
...
public:
  ...
  OMPSeverityClause(OpenMPSeverityClauseKind A, SourceLocation ALoc,
                    SourceLocation StartLoc, SourceLocation LParenLoc,
                    SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_severity, StartLoc, EndLoc),
        LParenLoc(LParenLoc), Kind(A), KindKwLoc(ALoc) {}

  /// Build an empty clause.
  OMPSeverityClause()
      : OMPClause(toolchain::omp::OMPC_severity, SourceLocation(),
                  SourceLocation()) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_severity;
  }
};
...
public:
  ...
  OMPMessageClause(Expr *MS, SourceLocation StartLoc, SourceLocation LParenLoc,
                   SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_message, StartLoc, EndLoc),
        LParenLoc(LParenLoc), MessageString(MS) {}

  /// Build an empty clause.
  OMPMessageClause()
      : OMPClause(toolchain::omp::OMPC_message, SourceLocation(), SourceLocation()) {
  }
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_message;
  }
};
...
public:
  ...
  OMPScheduleClause(SourceLocation StartLoc, SourceLocation LParenLoc,
      ...
      : OMPClause(toolchain::omp::OMPC_schedule, StartLoc, EndLoc),
  ...
  explicit OMPScheduleClause()
      : OMPClause(toolchain::omp::OMPC_schedule, SourceLocation(), SourceLocation()),
        OMPClauseWithPreInit(this) {
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_schedule;
  }
};
...
class OMPOrderedClause final
    : public OMPClause,
      private toolchain::TrailingObjects<OMPOrderedClause, Expr *> {
  friend class OMPClauseReader;
  friend TrailingObjects;
  ...
  OMPOrderedClause(Expr *Num, unsigned NumLoops, SourceLocation StartLoc,
                   SourceLocation LParenLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_ordered, StartLoc, EndLoc),
        LParenLoc(LParenLoc), NumForLoops(Num), NumberOfLoops(NumLoops) {}

  /// Build an empty clause.
  explicit OMPOrderedClause(unsigned NumLoops)
      : OMPClause(toolchain::omp::OMPC_ordered, SourceLocation(), SourceLocation()),
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_ordered;
  }
};
...
class OMPNowaitClause final : public OMPNoChildClause<toolchain::omp::OMPC_nowait> {
public:
  /// Build 'nowait' clause.
  ///
  /// \param StartLoc Starting location of the clause.
...
public:
  ...
  OMPUntiedClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_untied, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OMPUntiedClause()
      : OMPClause(toolchain::omp::OMPC_untied, SourceLocation(), SourceLocation()) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_untied;
  }
};
...
public:
  ...
  OMPMergeableClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_mergeable, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OMPMergeableClause()
      : OMPClause(toolchain::omp::OMPC_mergeable, SourceLocation(),
                  SourceLocation()) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_mergeable;
  }
};
...
class OMPAbsentClause final
    : public OMPDirectiveListClause<OMPAbsentClause>,
      private toolchain::TrailingObjects<OMPAbsentClause, OpenMPDirectiveKind> {
  ...
  OMPAbsentClause(SourceLocation StartLoc, SourceLocation LParenLoc,
      ...
      : OMPDirectiveListClause<OMPAbsentClause>(
            toolchain::omp::OMPC_absent, StartLoc, LParenLoc, EndLoc, NumKinds) {}

  /// Build an empty clause.
  OMPAbsentClause(unsigned NumKinds)
      : OMPDirectiveListClause<OMPAbsentClause>(
            toolchain::omp::OMPC_absent, SourceLocation(), SourceLocation(),
...
public:
  ...
  static bool classof(const OMPClause *C) {
    return C->getClauseKind() == toolchain::omp::OMPC_absent;
  }
};
...
class OMPContainsClause final
    : public OMPDirectiveListClause<OMPContainsClause>,
      private toolchain::TrailingObjects<OMPContainsClause, OpenMPDirectiveKind> {
  friend OMPDirectiveListClause;
  friend TrailingObjects;
  ...
  OMPContainsClause(SourceLocation StartLoc, SourceLocation LParenLoc,
      ...
      : OMPDirectiveListClause<OMPContainsClause>(
            toolchain::omp::OMPC_contains, StartLoc, LParenLoc, EndLoc, NumKinds) {}

  /// Build an empty clause.
  OMPContainsClause(unsigned NumKinds)
      : OMPDirectiveListClause<OMPContainsClause>(
            toolchain::omp::OMPC_contains, SourceLocation(), SourceLocation(),
            SourceLocation(), NumKinds) {}
...
public:
  ...
  static bool classof(const OMPClause *C) {
    return C->getClauseKind() == toolchain::omp::OMPC_contains;
  }
};
...
class OMPHoldsClause final
    : public OMPOneStmtClause<toolchain::omp::OMPC_holds, OMPClause> {
  friend class OMPClauseReader;
...
class OMPNoOpenMPClause final
    : public OMPNoChildClause<toolchain::omp::OMPC_no_openmp> {
public:
...
class OMPNoOpenMPRoutinesClause final
    : public OMPNoChildClause<toolchain::omp::OMPC_no_openmp_routines> {
public:
...
class OMPNoOpenMPConstructsClause final
    : public OMPNoChildClause<toolchain::omp::OMPC_no_openmp_constructs> {
public:
...
class OMPNoParallelismClause final
    : public OMPNoChildClause<toolchain::omp::OMPC_no_parallelism> {
public:
...
public:
  ...
  OMPReadClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_read, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OMPReadClause()
      : OMPClause(toolchain::omp::OMPC_read, SourceLocation(), SourceLocation()) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_read;
  }
};
...
public:
  ...
  OMPWriteClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_write, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OMPWriteClause()
      : OMPClause(toolchain::omp::OMPC_write, SourceLocation(), SourceLocation()) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_write;
  }
};
...
class OMPUpdateClause final
    : public OMPClause,
      private toolchain::TrailingObjects<OMPUpdateClause, SourceLocation,
  ...
  OMPUpdateClause(SourceLocation StartLoc, SourceLocation EndLoc,
                  bool IsExtended)
      : OMPClause(toolchain::omp::OMPC_update, StartLoc, EndLoc),
        IsExtended(IsExtended) {}

  /// Build an empty clause.
  OMPUpdateClause(bool IsExtended)
      : OMPClause(toolchain::omp::OMPC_update, SourceLocation(), SourceLocation()),
        IsExtended(IsExtended) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_update;
  }
};
...
public:
  ...
  OMPCaptureClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_capture, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OMPCaptureClause()
      : OMPClause(toolchain::omp::OMPC_capture, SourceLocation(), SourceLocation()) {
  }
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_capture;
  }
};
...
public:
  ...
  OMPCompareClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_compare, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OMPCompareClause()
      : OMPClause(toolchain::omp::OMPC_compare, SourceLocation(), SourceLocation()) {
  }
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_compare;
  }
};
...
public:
  ...
  OMPSeqCstClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_seq_cst, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OMPSeqCstClause()
      : OMPClause(toolchain::omp::OMPC_seq_cst, SourceLocation(), SourceLocation()) {
  }
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_seq_cst;
  }
};
...
public:
  ...
  OMPAcqRelClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_acq_rel, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OMPAcqRelClause()
      : OMPClause(toolchain::omp::OMPC_acq_rel, SourceLocation(), SourceLocation()) {
  }
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_acq_rel;
  }
};
...
public:
  ...
  OMPAcquireClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_acquire, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OMPAcquireClause()
      : OMPClause(toolchain::omp::OMPC_acquire, SourceLocation(), SourceLocation()) {
  }
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_acquire;
  }
};
...
public:
  ...
  OMPReleaseClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_release, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OMPReleaseClause()
      : OMPClause(toolchain::omp::OMPC_release, SourceLocation(), SourceLocation()) {
  }
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_release;
  }
};
...
public:
  ...
  OMPRelaxedClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_relaxed, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OMPRelaxedClause()
      : OMPClause(toolchain::omp::OMPC_relaxed, SourceLocation(), SourceLocation()) {
  }
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_relaxed;
  }
};
...
public:
  ...
  OMPWeakClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_weak, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OMPWeakClause()
      : OMPClause(toolchain::omp::OMPC_weak, SourceLocation(), SourceLocation()) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_weak;
  }
};
...
class OMPFailClause final : public OMPClause {
  ...
  OpenMPClauseKind FailParameter = toolchain::omp::Clause::OMPC_unknown;
...
public:
  ...
  OMPFailClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_fail, StartLoc, EndLoc) {}
  ...
  /// Build an empty clause.
  OMPFailClause()
      : OMPClause(toolchain::omp::OMPC_fail, SourceLocation(), SourceLocation()) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_fail;
  }
...
class OMPPrivateClause final
    : public OMPVarListClause<OMPPrivateClause>,
      private toolchain::TrailingObjects<OMPPrivateClause, Expr *> {
  friend class OMPClauseReader;
  friend OMPVarListClause;
  friend TrailingObjects;
  ...
  OMPPrivateClause(SourceLocation StartLoc, SourceLocation LParenLoc,
      ...
      : OMPVarListClause<OMPPrivateClause>(toolchain::omp::OMPC_private, StartLoc,
                                           LParenLoc, EndLoc, N) {}
  ...
  explicit OMPPrivateClause(unsigned N)
      : OMPVarListClause<OMPPrivateClause>(toolchain::omp::OMPC_private,
                                           SourceLocation(), SourceLocation(),
                                           SourceLocation(), N) {}
...
public:
  ...
  using private_copies_range = toolchain::iterator_range<private_copies_iterator>;
  using private_copies_const_range =
      toolchain::iterator_range<private_copies_const_iterator>;
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_private;
  }
};
...
class OMPFirstprivateClause final
    : public OMPVarListClause<OMPFirstprivateClause>,
      public OMPClauseWithPreInit,
      private toolchain::TrailingObjects<OMPFirstprivateClause, Expr *> {
  friend class OMPClauseReader;
  friend OMPVarListClause;
  friend TrailingObjects;
  ...
  OMPFirstprivateClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                        SourceLocation EndLoc, unsigned N)
      : OMPVarListClause<OMPFirstprivateClause>(toolchain::omp::OMPC_firstprivate,
  ...
  explicit OMPFirstprivateClause(unsigned N)
      : OMPVarListClause<OMPFirstprivateClause>(
            toolchain::omp::OMPC_firstprivate, SourceLocation(), SourceLocation(),
            SourceLocation(), N),
        OMPClauseWithPreInit(this) {}
...
public:
  ...
  using inits_range = toolchain::iterator_range<inits_iterator>;
  using inits_const_range = toolchain::iterator_range<inits_const_iterator>;
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_firstprivate;
  }
};
...
class OMPLastprivateClause final
    : public OMPVarListClause<OMPLastprivateClause>,
      ...
      private toolchain::TrailingObjects<OMPLastprivateClause, Expr *> {
  ...
  OMPLastprivateClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                       ...
                       unsigned N)
      : OMPVarListClause<OMPLastprivateClause>(toolchain::omp::OMPC_lastprivate,
                                               StartLoc, LParenLoc, EndLoc, N),
  ...
  explicit OMPLastprivateClause(unsigned N)
      : OMPVarListClause<OMPLastprivateClause>(
            toolchain::omp::OMPC_lastprivate, SourceLocation(), SourceLocation(),
            SourceLocation(), N),
...
public:
  ...
  using helper_expr_range = toolchain::iterator_range<helper_expr_iterator>;
  using helper_expr_const_range =
      toolchain::iterator_range<helper_expr_const_iterator>;
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_lastprivate;
  }
};
...
class OMPSharedClause final
    : public OMPVarListClause<OMPSharedClause>,
      private toolchain::TrailingObjects<OMPSharedClause, Expr *> {
  friend OMPVarListClause;
  friend TrailingObjects;
  ...
  OMPSharedClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                  SourceLocation EndLoc, unsigned N)
      : OMPVarListClause<OMPSharedClause>(toolchain::omp::OMPC_shared, StartLoc,
                                          LParenLoc, EndLoc, N) {}
  ...
  explicit OMPSharedClause(unsigned N)
      : OMPVarListClause<OMPSharedClause>(toolchain::omp::OMPC_shared,
                                          SourceLocation(), SourceLocation(),
                                          SourceLocation(), N) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_shared;
  }
};
...
class OMPReductionClause final
    : public OMPVarListClause<OMPReductionClause>,
      public OMPClauseWithPostUpdate,
      private toolchain::TrailingObjects<OMPReductionClause, Expr *, bool> {
  friend class OMPClauseReader;
  friend OMPVarListClause;
  friend TrailingObjects;
  ...
  OMPReductionClause(SourceLocation StartLoc, SourceLocation LParenLoc,
      ...
      : OMPVarListClause<OMPReductionClause>(toolchain::omp::OMPC_reduction,
                                             StartLoc, LParenLoc, EndLoc, N),
  ...
  void setPrivateVariableReductionFlags(ArrayRef<bool> Flags) {
    ...
    toolchain::copy(Flags, getTrailingObjects<bool>());
  }
...
public:
  ...
  using helper_flag_range = toolchain::iterator_range<helper_flag_iterator>;
  using helper_flag_const_range =
      toolchain::iterator_range<helper_flag_const_iterator>;
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_reduction;
  }
};
...
class OMPTaskReductionClause final
    : public OMPVarListClause<OMPTaskReductionClause>,
      public OMPClauseWithPostUpdate,
      private toolchain::TrailingObjects<OMPTaskReductionClause, Expr *> {
  friend class OMPClauseReader;
  friend OMPVarListClause;
  friend TrailingObjects;
  ...
  OMPTaskReductionClause(SourceLocation StartLoc, SourceLocation LParenLoc,
      ...
      : OMPVarListClause<OMPTaskReductionClause>(
            toolchain::omp::OMPC_task_reduction, StartLoc, LParenLoc, EndLoc, N),
  ...
  explicit OMPTaskReductionClause(unsigned N)
      : OMPVarListClause<OMPTaskReductionClause>(
            toolchain::omp::OMPC_task_reduction, SourceLocation(), SourceLocation(),
            SourceLocation(), N),
        OMPClauseWithPostUpdate(this) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_task_reduction;
  }
};
...
class OMPInReductionClause final
    : public OMPVarListClause<OMPInReductionClause>,
      public OMPClauseWithPostUpdate,
      private toolchain::TrailingObjects<OMPInReductionClause, Expr *> {
  friend class OMPClauseReader;
  friend OMPVarListClause;
  friend TrailingObjects;
  ...
  OMPInReductionClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                       ...
                       unsigned N, NestedNameSpecifierLoc QualifierLoc,
                       const DeclarationNameInfo &NameInfo)
      : OMPVarListClause<OMPInReductionClause>(toolchain::omp::OMPC_in_reduction,
                                               StartLoc, LParenLoc, EndLoc, N),
        OMPClauseWithPostUpdate(this), ColonLoc(ColonLoc),
        QualifierLoc(QualifierLoc), NameInfo(NameInfo) {}
  ...
  explicit OMPInReductionClause(unsigned N)
      : OMPVarListClause<OMPInReductionClause>(
            toolchain::omp::OMPC_in_reduction, SourceLocation(), SourceLocation(),
            SourceLocation(), N),
        OMPClauseWithPostUpdate(this) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_in_reduction;
  }
};
...
class OMPLinearClause final
    : public OMPVarListClause<OMPLinearClause>,
      public OMPClauseWithPostUpdate,
      private toolchain::TrailingObjects<OMPLinearClause, Expr *> {
  friend class OMPClauseReader;
  friend OMPVarListClause;
  friend TrailingObjects;
  ...
  OMPLinearClause(SourceLocation StartLoc, SourceLocation LParenLoc,
      ...
      : OMPVarListClause<OMPLinearClause>(toolchain::omp::OMPC_linear, StartLoc,
  ...
  explicit OMPLinearClause(unsigned NumVars)
      : OMPVarListClause<OMPLinearClause>(toolchain::omp::OMPC_linear,
                                          SourceLocation(), SourceLocation(),
...
public:
  ...
  using privates_range = toolchain::iterator_range<privates_iterator>;
  using privates_const_range = toolchain::iterator_range<privates_const_iterator>;
  ...
  using updates_range = toolchain::iterator_range<updates_iterator>;
  using updates_const_range = toolchain::iterator_range<updates_const_iterator>;
  ...
  using finals_range = toolchain::iterator_range<finals_iterator>;
  using finals_const_range = toolchain::iterator_range<finals_const_iterator>;
  ...
  using used_expressions_range =
      toolchain::iterator_range<used_expressions_iterator>;
  using used_expressions_const_range =
      toolchain::iterator_range<used_expressions_const_iterator>;
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_linear;
  }
};
...
class OMPAlignedClause final
    : public OMPVarListClause<OMPAlignedClause>,
      private toolchain::TrailingObjects<OMPAlignedClause, Expr *> {
  friend class OMPClauseReader;
  friend OMPVarListClause;
  friend TrailingObjects;
  ...
  OMPAlignedClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                   SourceLocation ColonLoc, SourceLocation EndLoc,
                   unsigned NumVars)
      : OMPVarListClause<OMPAlignedClause>(toolchain::omp::OMPC_aligned, StartLoc,
                                           LParenLoc, EndLoc, NumVars),
        ColonLoc(ColonLoc) {}
  ...
  explicit OMPAlignedClause(unsigned NumVars)
      : OMPVarListClause<OMPAlignedClause>(toolchain::omp::OMPC_aligned,
                                           SourceLocation(), SourceLocation(),
                                           SourceLocation(), NumVars) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_aligned;
  }
};
...
class OMPCopyinClause final
    : public OMPVarListClause<OMPCopyinClause>,
      private toolchain::TrailingObjects<OMPCopyinClause, Expr *> {
  ...
  OMPCopyinClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                  SourceLocation EndLoc, unsigned N)
      : OMPVarListClause<OMPCopyinClause>(toolchain::omp::OMPC_copyin, StartLoc,
                                          LParenLoc, EndLoc, N) {}
  ...
  explicit OMPCopyinClause(unsigned N)
      : OMPVarListClause<OMPCopyinClause>(toolchain::omp::OMPC_copyin,
                                          SourceLocation(), SourceLocation(),
                                          SourceLocation(), N) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_copyin;
  }
};
...
class OMPCopyprivateClause final
    : public OMPVarListClause<OMPCopyprivateClause>,
      private toolchain::TrailingObjects<OMPCopyprivateClause, Expr *> {
  friend class OMPClauseReader;
  friend OMPVarListClause;
  friend TrailingObjects;
  ...
  OMPCopyprivateClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                       SourceLocation EndLoc, unsigned N)
      : OMPVarListClause<OMPCopyprivateClause>(toolchain::omp::OMPC_copyprivate,
                                               StartLoc, LParenLoc, EndLoc, N) {
  }
  ...
  explicit OMPCopyprivateClause(unsigned N)
      : OMPVarListClause<OMPCopyprivateClause>(
            toolchain::omp::OMPC_copyprivate, SourceLocation(), SourceLocation(),
            SourceLocation(), N) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_copyprivate;
  }
};
...
class OMPFlushClause final
    : public OMPVarListClause<OMPFlushClause>,
      private toolchain::TrailingObjects<OMPFlushClause, Expr *> {
  friend OMPVarListClause;
  friend TrailingObjects;
  ...
  OMPFlushClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                 SourceLocation EndLoc, unsigned N)
      : OMPVarListClause<OMPFlushClause>(toolchain::omp::OMPC_flush, StartLoc,
                                         LParenLoc, EndLoc, N) {}
  ...
  explicit OMPFlushClause(unsigned N)
      : OMPVarListClause<OMPFlushClause>(toolchain::omp::OMPC_flush,
                                         SourceLocation(), SourceLocation(),
                                         SourceLocation(), N) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_flush;
  }
};
...
class OMPDepobjClause final : public OMPClause {
  ...
  OMPDepobjClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                  SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_depobj, StartLoc, EndLoc),
        LParenLoc(LParenLoc) {}

  /// Build an empty clause.
  ///
  explicit OMPDepobjClause()
      : OMPClause(toolchain::omp::OMPC_depobj, SourceLocation(), SourceLocation()) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_depobj;
  }
};
...
class OMPDependClause final
    : public OMPVarListClause<OMPDependClause>,
      private toolchain::TrailingObjects<OMPDependClause, Expr *> {
  friend class OMPClauseReader;
  friend OMPVarListClause;
  friend TrailingObjects;
...
private:
  ...
  OMPDependClause(SourceLocation StartLoc, SourceLocation LParenLoc,
      ...
      : OMPVarListClause<OMPDependClause>(toolchain::omp::OMPC_depend, StartLoc,
                                          LParenLoc, EndLoc, N),
        NumLoops(NumLoops) {}
  ...
  explicit OMPDependClause(unsigned N, unsigned NumLoops)
      : OMPVarListClause<OMPDependClause>(toolchain::omp::OMPC_depend,
                                          SourceLocation(), SourceLocation(),
                                          SourceLocation(), N),
        NumLoops(NumLoops) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_depend;
  }
};
...
public:
  ...
  OMPDeviceClause(OpenMPDeviceClauseModifier Modifier, Expr *E, Stmt *HelperE,
                  ...
                  SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_device, StartLoc, EndLoc),
  ...
  /// Build an empty clause.
  OMPDeviceClause()
      : OMPClause(toolchain::omp::OMPC_device, SourceLocation(), SourceLocation()),
        OMPClauseWithPreInit(this) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_device;
  }
};
...
class OMPThreadsClause final
    : public OMPNoChildClause<toolchain::omp::OMPC_threads> {
public:
...
public:
  ...
  OMPSIMDClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_simd, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OMPSIMDClause()
      : OMPClause(toolchain::omp::OMPC_simd, SourceLocation(), SourceLocation()) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_simd;
  }
};
...
public:
  ...
  class MappableComponent {
    ...
    /// component.
    toolchain::PointerIntPair<Expr *, 1, bool> AssociatedExpressionNonContiguousPr;
...
protected:
  ...
  void setUniqueDecls(ArrayRef<ValueDecl *> UDs) {
    ...
    toolchain::copy(UDs, getUniqueDeclsRef().begin());
  }
  ...
  void setDeclNumLists(ArrayRef<unsigned> DNLs) {
    ...
    toolchain::copy(DNLs, getDeclNumListsRef().begin());
  }
  ...
  void setComponentListSizes(ArrayRef<unsigned> CLSs) {
    ...
    toolchain::copy(CLSs, getComponentListSizesRef().begin());
  }
  ...
  void setComponents(ArrayRef<MappableComponent> Components,
    ...
    toolchain::copy(Components, getComponentsRef().begin());
  }
  ...
  void setClauseInfo(ArrayRef<ValueDecl *> Declarations,
    ...
    toolchain::MapVector<ValueDecl *, SmallVector<MappableExprComponentListRef, 8>>
        ComponentListMap;
    {
  ...
  void setUDMapperRefs(ArrayRef<Expr *> DMDs) {
    ...
    assert(SupportsMapper &&
           "Must be a clause that is possible to have user-defined mappers");
    toolchain::copy(DMDs, getUDMapperRefs().begin());
  }
...
public:
  ...
  class const_component_lists_iterator
      : public toolchain::iterator_adaptor_base<
  ...
  using const_component_lists_range =
      toolchain::iterator_range<const_component_lists_iterator>;
  ...
  using const_all_decls_range = toolchain::iterator_range<const_all_decls_iterator>;
  ...
  using const_all_num_lists_range =
      toolchain::iterator_range<const_all_num_lists_iterator>;
  ...
  using const_all_lists_sizes_range =
      toolchain::iterator_range<const_all_lists_sizes_iterator>;
  ...
  using const_all_components_range =
      toolchain::iterator_range<const_all_components_iterator>;
  ...
  using mapperlist_range = toolchain::iterator_range<mapperlist_iterator>;
  using mapperlist_const_range =
      toolchain::iterator_range<mapperlist_const_iterator>;
...
private:
  ...
  explicit OMPMapClause(ArrayRef<OpenMPMapModifierKind> MapModifiers,
      ...
      : OMPMappableExprListClause(toolchain::omp::OMPC_map, Locs, Sizes,
    ...
    toolchain::copy(MapModifiers, std::begin(MapTypeModifiers));

    assert(std::size(MapTypeModifiersLoc) == MapModifiersLoc.size() &&
           "Unexpected number of map type modifier locations.");
    toolchain::copy(MapModifiersLoc, std::begin(MapTypeModifiersLoc));
  }
  ...
  explicit OMPMapClause(const OMPMappableExprListSizeTy &Sizes)
      : OMPMappableExprListClause(toolchain::omp::OMPC_map, OMPVarListLocTy(), Sizes,
                                  /*SupportsMapper=*/true) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_map;
  }
};
...
class OMPNumTeamsClause final
    : public OMPVarListClause<OMPNumTeamsClause>,
      public OMPClauseWithPreInit,
      private toolchain::TrailingObjects<OMPNumTeamsClause, Expr *> {
  friend OMPVarListClause;
  friend TrailingObjects;
  ...
  OMPNumTeamsClause(const ASTContext &C, SourceLocation StartLoc,
                    SourceLocation LParenLoc, SourceLocation EndLoc, unsigned N)
      : OMPVarListClause(toolchain::omp::OMPC_num_teams, StartLoc, LParenLoc, EndLoc,
                         N),
        OMPClauseWithPreInit(this) {}

  /// Build an empty clause.
  OMPNumTeamsClause(unsigned N)
      : OMPVarListClause(toolchain::omp::OMPC_num_teams, SourceLocation(),
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_num_teams;
  }
};
...
class OMPThreadLimitClause final
    : public OMPVarListClause<OMPThreadLimitClause>,
      public OMPClauseWithPreInit,
      private toolchain::TrailingObjects<OMPThreadLimitClause, Expr *> {
  friend OMPVarListClause;
  friend TrailingObjects;
  ...
  OMPThreadLimitClause(const ASTContext &C, SourceLocation StartLoc,
                       SourceLocation LParenLoc, SourceLocation EndLoc,
                       unsigned N)
      : OMPVarListClause(toolchain::omp::OMPC_thread_limit, StartLoc, LParenLoc,
                         EndLoc, N),
        OMPClauseWithPreInit(this) {}

  /// Build an empty clause.
  OMPThreadLimitClause(unsigned N)
      : OMPVarListClause(toolchain::omp::OMPC_thread_limit, SourceLocation(),
                         SourceLocation(), SourceLocation(), N),
        OMPClauseWithPreInit(this) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_thread_limit;
  }
};
...
public:
  ...
  OMPPriorityClause(Expr *Priority, Stmt *HelperPriority,
                    OpenMPDirectiveKind CaptureRegion, SourceLocation StartLoc,
                    SourceLocation LParenLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_priority, StartLoc, EndLoc),
  ...
  /// Build an empty clause.
  OMPPriorityClause()
      : OMPClause(toolchain::omp::OMPC_priority, SourceLocation(), SourceLocation()),
        OMPClauseWithPreInit(this) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_priority;
  }
};
...
public:
  ...
  OMPGrainsizeClause(OpenMPGrainsizeClauseModifier Modifier, Expr *Size,
                     ...
                     SourceLocation StartLoc, SourceLocation LParenLoc,
                     SourceLocation ModifierLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_grainsize, StartLoc, EndLoc),
        OMPClauseWithPreInit(this), LParenLoc(LParenLoc), Modifier(Modifier),
  ...
  explicit OMPGrainsizeClause()
      : OMPClause(toolchain::omp::OMPC_grainsize, SourceLocation(),
                  SourceLocation()),
        OMPClauseWithPreInit(this) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_grainsize;
  }
};
...
public:
  ...
  OMPNogroupClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_nogroup, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OMPNogroupClause()
      : OMPClause(toolchain::omp::OMPC_nogroup, SourceLocation(), SourceLocation()) {
  }
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_nogroup;
  }
};
...
public:
  ...
  OMPNumTasksClause(OpenMPNumTasksClauseModifier Modifier, Expr *Size,
                    ...
                    SourceLocation StartLoc, SourceLocation LParenLoc,
                    SourceLocation ModifierLoc, SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_num_tasks, StartLoc, EndLoc),
        OMPClauseWithPreInit(this), LParenLoc(LParenLoc), Modifier(Modifier),
  ...
  explicit OMPNumTasksClause()
      : OMPClause(toolchain::omp::OMPC_num_tasks, SourceLocation(),
                  SourceLocation()),
        OMPClauseWithPreInit(this) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_num_tasks;
  }
};
...
public:
  ...
  OMPHintClause(Expr *Hint, SourceLocation StartLoc, SourceLocation LParenLoc,
                SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_hint, StartLoc, EndLoc), LParenLoc(LParenLoc),
        Hint(Hint) {}

  /// Build an empty clause.
  OMPHintClause()
      : OMPClause(toolchain::omp::OMPC_hint, SourceLocation(), SourceLocation()) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_hint;
  }
};
...
public:
  ...
  OMPDistScheduleClause(SourceLocation StartLoc, SourceLocation LParenLoc,
      ...
      : OMPClause(toolchain::omp::OMPC_dist_schedule, StartLoc, EndLoc),
        OMPClauseWithPreInit(this), LParenLoc(LParenLoc), Kind(Kind),
        KindLoc(KLoc), CommaLoc(CommaLoc), ChunkSize(ChunkSize) {
    setPreInitStmt(HelperChunkSize);
  }
  ...
  explicit OMPDistScheduleClause()
      : OMPClause(toolchain::omp::OMPC_dist_schedule, SourceLocation(),
                  SourceLocation()),
        OMPClauseWithPreInit(this) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_dist_schedule;
  }
};
...
public:
  ...
  OMPDefaultmapClause(SourceLocation StartLoc, SourceLocation LParenLoc,
      ...
      : OMPClause(toolchain::omp::OMPC_defaultmap, StartLoc, EndLoc),
        LParenLoc(LParenLoc), Modifier(M), ModifierLoc(MLoc), Kind(Kind),
        KindLoc(KLoc) {}

  /// Build an empty clause.
  explicit OMPDefaultmapClause()
      : OMPClause(toolchain::omp::OMPC_defaultmap, SourceLocation(),
                  SourceLocation()) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_defaultmap;
  }
};
...
class OMPToClause final : public OMPMappableExprListClause<OMPToClause>,
  ...
  explicit OMPToClause(const OMPMappableExprListSizeTy &Sizes)
      : OMPMappableExprListClause(toolchain::omp::OMPC_to, OMPVarListLocTy(), Sizes,
                                  /*SupportsMapper=*/true) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_to;
  }
};
...
class OMPFromClause final
  ...
  explicit OMPFromClause(ArrayRef<OpenMPMotionModifierKind> TheMotionModifiers,
                         ...
                         const OMPVarListLocTy &Locs,
                         const OMPMappableExprListSizeTy &Sizes)
      : OMPMappableExprListClause(toolchain::omp::OMPC_from, Locs, Sizes,
                                  /*SupportsMapper=*/true, &MapperQualifierLoc,
                                  &MapperIdInfo) {
    assert(std::size(MotionModifiers) == TheMotionModifiers.size() &&
           "Unexpected number of motion modifiers.");
  ...
  explicit OMPFromClause(const OMPMappableExprListSizeTy &Sizes)
      : OMPMappableExprListClause(toolchain::omp::OMPC_from, OMPVarListLocTy(),
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_from;
  }
};
...
class OMPUseDevicePtrClause final
  ...
  explicit OMPUseDevicePtrClause(const OMPVarListLocTy &Locs,
                                 const OMPMappableExprListSizeTy &Sizes)
      : OMPMappableExprListClause(toolchain::omp::OMPC_use_device_ptr, Locs, Sizes) {
  }
  ...
  explicit OMPUseDevicePtrClause(const OMPMappableExprListSizeTy &Sizes)
      : OMPMappableExprListClause(toolchain::omp::OMPC_use_device_ptr,
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_use_device_ptr;
  }
};
...
class OMPUseDeviceAddrClause final
  ...
  explicit OMPUseDeviceAddrClause(const OMPVarListLocTy &Locs,
                                  const OMPMappableExprListSizeTy &Sizes)
      : OMPMappableExprListClause(toolchain::omp::OMPC_use_device_addr, Locs,
                                  Sizes) {}
  ...
  explicit OMPUseDeviceAddrClause(const OMPMappableExprListSizeTy &Sizes)
      : OMPMappableExprListClause(toolchain::omp::OMPC_use_device_addr,
                                  OMPVarListLocTy(), Sizes) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_use_device_addr;
  }
};
...
class OMPIsDevicePtrClause final
  ...
  explicit OMPIsDevicePtrClause(const OMPVarListLocTy &Locs,
                                const OMPMappableExprListSizeTy &Sizes)
      : OMPMappableExprListClause(toolchain::omp::OMPC_is_device_ptr, Locs, Sizes) {}
  ...
  explicit OMPIsDevicePtrClause(const OMPMappableExprListSizeTy &Sizes)
      : OMPMappableExprListClause(toolchain::omp::OMPC_is_device_ptr,
                                  OMPVarListLocTy(), Sizes) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_is_device_ptr;
  }
};
...
class OMPHasDeviceAddrClause final
  ...
  explicit OMPHasDeviceAddrClause(const OMPVarListLocTy &Locs,
                                  const OMPMappableExprListSizeTy &Sizes)
      : OMPMappableExprListClause(toolchain::omp::OMPC_has_device_addr, Locs,
                                  Sizes) {}
  ...
  explicit OMPHasDeviceAddrClause(const OMPMappableExprListSizeTy &Sizes)
      : OMPMappableExprListClause(toolchain::omp::OMPC_has_device_addr,
                                  OMPVarListLocTy(), Sizes) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_has_device_addr;
  }
};
...
class OMPNontemporalClause final
    : public OMPVarListClause<OMPNontemporalClause>,
      private toolchain::TrailingObjects<OMPNontemporalClause, Expr *> {
  friend class OMPClauseReader;
  friend OMPVarListClause;
  friend TrailingObjects;
  ...
  OMPNontemporalClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                       SourceLocation EndLoc, unsigned N)
      : OMPVarListClause<OMPNontemporalClause>(toolchain::omp::OMPC_nontemporal,
                                               StartLoc, LParenLoc, EndLoc, N) {
  }
  ...
  explicit OMPNontemporalClause(unsigned N)
      : OMPVarListClause<OMPNontemporalClause>(
            toolchain::omp::OMPC_nontemporal, SourceLocation(), SourceLocation(),
            SourceLocation(), N) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_nontemporal;
  }
};
...
public:
  ...
  OMPOrderClause(OpenMPOrderClauseKind A, SourceLocation ALoc,
                 ...
                 SourceLocation MLoc)
      : OMPClause(toolchain::omp::OMPC_order, StartLoc, EndLoc),
        LParenLoc(LParenLoc), Kind(A), KindKwLoc(ALoc), Modifier(Modifier),
        ModifierKwLoc(MLoc) {}

  /// Build an empty clause.
  OMPOrderClause()
      : OMPClause(toolchain::omp::OMPC_order, SourceLocation(), SourceLocation()) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_order;
  }
};
...
class OMPInitClause final
    : public OMPVarListClause<OMPInitClause>,
      private toolchain::TrailingObjects<OMPInitClause, Expr *> {
  friend class OMPClauseReader;
  friend OMPVarListClause;
  friend TrailingObjects;
  ...
  OMPInitClause(bool IsTarget, bool IsTargetSync, SourceLocation StartLoc,
                ...
                SourceLocation EndLoc, unsigned N)
      : OMPVarListClause<OMPInitClause>(toolchain::omp::OMPC_init, StartLoc,
                                        LParenLoc, EndLoc, N),
        VarLoc(VarLoc), IsTarget(IsTarget), IsTargetSync(IsTargetSync) {}

  /// Build an empty clause.
  OMPInitClause(unsigned N)
      : OMPVarListClause<OMPInitClause>(toolchain::omp::OMPC_init, SourceLocation(),
                                        SourceLocation(), SourceLocation(), N) {
  }
...
public:
  ...
  using prefs_range = toolchain::iterator_range<prefs_iterator>;
  using const_prefs_range = toolchain::iterator_range<const_prefs_iterator>;
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_init;
  }
};
...
public:
  ...
  OMPUseClause(Expr *InteropVar, SourceLocation StartLoc,
               SourceLocation LParenLoc, SourceLocation VarLoc,
               SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_use, StartLoc, EndLoc), LParenLoc(LParenLoc),
        VarLoc(VarLoc), InteropVar(InteropVar) {}

  /// Build an empty clause.
  OMPUseClause()
      : OMPClause(toolchain::omp::OMPC_use, SourceLocation(), SourceLocation()) {}
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_use;
  }
};
...
public:
  ...
  OMPDestroyClause(Expr *InteropVar, SourceLocation StartLoc,
                   SourceLocation LParenLoc, SourceLocation VarLoc,
                   SourceLocation EndLoc)
      : OMPClause(toolchain::omp::OMPC_destroy, StartLoc, EndLoc),
  ...
  /// Build an empty clause.
  OMPDestroyClause()
      : OMPClause(toolchain::omp::OMPC_destroy, SourceLocation(), SourceLocation()) {
  }
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_destroy;
  }
};
...
class OMPNovariantsClause final
    : public OMPOneStmtClause<toolchain::omp::OMPC_novariants, OMPClause>,
      public OMPClauseWithPreInit {
  friend class OMPClauseReader;
...
class OMPNocontextClause final
    : public OMPOneStmtClause<toolchain::omp::OMPC_nocontext, OMPClause>,
      public OMPClauseWithPreInit {
  friend class OMPClauseReader;
...
class OMPDetachClause final
    : public OMPOneStmtClause<toolchain::omp::OMPC_detach, OMPClause> {
  friend class OMPClauseReader;
...
class OMPInclusiveClause final
    : public OMPVarListClause<OMPInclusiveClause>,
      private toolchain::TrailingObjects<OMPInclusiveClause, Expr *> {
  friend class OMPClauseReader;
  friend OMPVarListClause;
  friend TrailingObjects;
  ...
  OMPInclusiveClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                     SourceLocation EndLoc, unsigned N)
      : OMPVarListClause<OMPInclusiveClause>(toolchain::omp::OMPC_inclusive,
                                             StartLoc, LParenLoc, EndLoc, N) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_inclusive;
  }
};
...
class OMPExclusiveClause final
    : public OMPVarListClause<OMPExclusiveClause>,
      private toolchain::TrailingObjects<OMPExclusiveClause, Expr *> {
  friend class OMPClauseReader;
  friend OMPVarListClause;
  friend TrailingObjects;
  ...
  OMPExclusiveClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                     SourceLocation EndLoc, unsigned N)
      : OMPVarListClause<OMPExclusiveClause>(toolchain::omp::OMPC_exclusive,
                                             StartLoc, LParenLoc, EndLoc, N) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_exclusive;
  }
};
...
class OMPUsesAllocatorsClause final
    : public OMPClause,
      private toolchain::TrailingObjects<OMPUsesAllocatorsClause, Expr *,
                                    SourceLocation> {
public:
...
private:
  ...
  OMPUsesAllocatorsClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                          SourceLocation EndLoc, unsigned N)
      : OMPClause(toolchain::omp::OMPC_uses_allocators, StartLoc, EndLoc),
  ...
  explicit OMPUsesAllocatorsClause(unsigned N)
      : OMPClause(toolchain::omp::OMPC_uses_allocators, SourceLocation(),
                  SourceLocation()),
        NumOfAllocators(N) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_uses_allocators;
  }
};
...
class OMPAffinityClause final
    : public OMPVarListClause<OMPAffinityClause>,
      private toolchain::TrailingObjects<OMPAffinityClause, Expr *> {
  friend class OMPClauseReader;
  friend OMPVarListClause;
  friend TrailingObjects;
  ...
  OMPAffinityClause(SourceLocation StartLoc, SourceLocation LParenLoc,
      ...
      : OMPVarListClause<OMPAffinityClause>(toolchain::omp::OMPC_affinity, StartLoc,
                                            LParenLoc, EndLoc, N) {}
  ...
  explicit OMPAffinityClause(unsigned N)
      : OMPVarListClause<OMPAffinityClause>(toolchain::omp::OMPC_affinity,
                                            SourceLocation(), SourceLocation(),
                                            SourceLocation(), N) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_affinity;
  }
};
...
class OMPFilterClause final
    : public OMPOneStmtClause<toolchain::omp::OMPC_filter, OMPClause>,
      public OMPClauseWithPreInit {
  friend class OMPClauseReader;
...
/// \endcode
class OMPBindClause final : public OMPNoChildClause<toolchain::omp::OMPC_bind> {
  friend class OMPClauseReader;
...
struct OMPTraitProperty {
  toolchain::omp::TraitProperty Kind = toolchain::omp::TraitProperty::invalid;
...
struct OMPTraitSelector {
  ...
  toolchain::omp::TraitSelector Kind = toolchain::omp::TraitSelector::invalid;
  SmallVector<OMPTraitProperty, 1> Properties;
};

struct OMPTraitSet {
  toolchain::omp::TraitSet Kind = toolchain::omp::TraitSet::invalid;
...
public:
  ...
  toolchain::SmallVector<OMPTraitSet, 2> Sets;

  bool anyScoreOrCondition(
      toolchain::function_ref<bool(Expr *&, bool /* IsScore */)> Cond) {
    return toolchain::any_of(Sets, [&](OMPTraitSet &Set) {
      return toolchain::any_of(
          Set.Selectors, [&](OMPTraitSelector &Selector) {
            return Cond(Selector.ScoreOrCondition,
                        /* IsScore */ Selector.Kind !=
                            toolchain::omp::TraitSelector::user_condition);
          });
    });
  }
  ...
  /// latter uses language::Core::Expr to store the score/condition while the former is
  /// independent of clang. Thus, expressions and conditions are evaluated in
  /// this method.
  void getAsVariantMatchInfo(ASTContext &ASTCtx,
                             toolchain::omp::VariantMatchInfo &VMI) const;

  /// Return a string representation identifying this context selector.
  std::string getMangledName() const;

  /// Check the extension trait \p TP is active.
  bool isExtensionActive(toolchain::omp::TraitProperty TP) {
    for (const OMPTraitSet &Set : Sets) {
      if (Set.Kind != toolchain::omp::TraitSet::implementation)
        continue;
      for (const OMPTraitSelector &Selector : Set.Selectors) {
        if (Selector.Kind != toolchain::omp::TraitSelector::implementation_extension)
          continue;
  ...
  void print(toolchain::raw_ostream &OS, const PrintingPolicy &Policy) const;
};
toolchain::raw_ostream &operator<<(toolchain::raw_ostream &OS, const OMPTraitInfo &TI);
toolchain::raw_ostream &operator<<(toolchain::raw_ostream &OS, const OMPTraitInfo *TI);

/// Clang specific specialization of the OMPContext to lookup target features.
struct TargetOMPContext final : public toolchain::omp::OMPContext {
  TargetOMPContext(ASTContext &ASTCtx,
                   std::function<void(StringRef)> &&DiagUnknownTrait,
                   const FunctionDecl *CurrentFunctionDecl,
                   ArrayRef<toolchain::omp::TraitProperty> ConstructTraits,
                   int DeviceNum);

  virtual ~TargetOMPContext() = default;

  /// See toolchain::omp::OMPContext::matchesISATrait
...
class OMPChildren final
    : private toolchain::TrailingObjects<OMPChildren, OMPClause *, Stmt *> {
  friend TrailingObjects;
  friend class OMPClauseReader;
...
public:
  ...
  getCapturedStmt(OpenMPDirectiveKind RegionKind,
    ...
    assert(toolchain::is_contained(CaptureRegions, RegionKind) &&
    ...
    toolchain_unreachable("Incorrect RegionKind specified for directive.");
  }
...
class OMPXDynCGroupMemClause
    : public OMPOneStmtClause<toolchain::omp::OMPC_ompx_dyn_cgroup_mem, OMPClause>,
      public OMPClauseWithPreInit {
  friend class OMPClauseReader;
...
class OMPDoacrossClause final
    : public OMPVarListClause<OMPDoacrossClause>,
      private toolchain::TrailingObjects<OMPDoacrossClause, Expr *> {
  friend class OMPClauseReader;
  friend OMPVarListClause;
  friend TrailingObjects;
  ...
  OMPDoacrossClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                    SourceLocation EndLoc, unsigned N, unsigned NumLoops)
      : OMPVarListClause<OMPDoacrossClause>(toolchain::omp::OMPC_doacross, StartLoc,
                                            LParenLoc, EndLoc, N),
        NumLoops(NumLoops) {}
  ...
  explicit OMPDoacrossClause(unsigned N, unsigned NumLoops)
      : OMPVarListClause<OMPDoacrossClause>(toolchain::omp::OMPC_doacross,
                                            SourceLocation(), SourceLocation(),
                                            SourceLocation(), N),
        NumLoops(NumLoops) {}
...
public:
  ...
  static bool classof(const OMPClause *T) {
    return T->getClauseKind() == toolchain::omp::OMPC_doacross;
  }
};
...
class OMPXAttributeClause
    : public OMPNoChildClause<toolchain::omp::OMPC_ompx_attribute> {
  friend class OMPClauseReader;
...
/// clause.
class OMPXBareClause : public OMPNoChildClause<toolchain::omp::OMPC_ompx_bare> {
public:
...
#endif // LANGUAGE_CORE_AST_OPENMPCLAUSE_H
