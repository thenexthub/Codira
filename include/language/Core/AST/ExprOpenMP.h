...
#ifndef LANGUAGE_CORE_AST_EXPROPENMP_H
#define LANGUAGE_CORE_AST_EXPROPENMP_H
...
class OMPArrayShapingExpr final
    : public Expr,
      private toolchain::TrailingObjects<OMPArrayShapingExpr, Expr *, SourceRange> {
...
class OMPIteratorExpr final
    : public Expr,
      private toolchain::TrailingObjects<OMPIteratorExpr, Decl *, Expr *,
