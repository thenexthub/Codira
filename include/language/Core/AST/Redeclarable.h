...
#ifndef LANGUAGE_CORE_AST_REDECLARABLE_H
#define LANGUAGE_CORE_AST_REDECLARABLE_H
...
protected:
  class DeclLink {
    ...
    using NotKnownLatest = toolchain::PointerUnion<Previous, UninitializedLatest>;

    mutable toolchain::PointerUnion<NotKnownLatest, KnownLatest> Link;
...
private:
  friend struct toolchain::DenseMapInfo<CanonicalDeclPtr<decl_type>>;
  friend struct toolchain::PointerLikeTypeTraits<CanonicalDeclPtr<decl_type>>;
...
template <typename decl_type>
struct DenseMapInfo<language::Core::CanonicalDeclPtr<decl_type>> {
  using CanonicalDeclPtr = language::Core::CanonicalDeclPtr<decl_type>;
...
template <typename decl_type>
struct PointerLikeTypeTraits<language::Core::CanonicalDeclPtr<decl_type>> {
  static inline void *getAsVoidPointer(language::Core::CanonicalDeclPtr<decl_type> P) {
    return P.Ptr;
  }
  static inline language::Core::CanonicalDeclPtr<decl_type> getFromVoidPointer(void *P) {
    language::Core::CanonicalDeclPtr<decl_type> C;
...
#endif // LANGUAGE_CORE_AST_REDECLARABLE_H
