...
//
//===----------------------------------------------------------------------===//
#ifndef LANGUAGE_CORE_AST_DYNAMIC_RECURSIVE_AST_VISITOR_H
#define LANGUAGE_CORE_AST_DYNAMIC_RECURSIVE_AST_VISITOR_H
...
#endif // LANGUAGE_CORE_AST_DYNAMIC_RECURSIVE_AST_VISITOR_H
