...
#ifndef LANGUAGE_CORE_AST_DECLARATIONNAME_H
#define LANGUAGE_CORE_AST_DECLARATIONNAME_H
...
public:
  void Profile(toolchain::FoldingSetNodeID &ID) { ID.AddPointer(Template); }
};
...
public:
  void Profile(toolchain::FoldingSetNodeID &FSID) { FSID.AddPointer(ID); }
};
...
public:
  ...
  enum NameKind {
    ...
    CXXDeductionGuideName = toolchain::addEnumValues(
        UncommonNameKindOffset,
        detail::DeclarationNameExtra::CXXDeductionGuideName),
    CXXLiteralOperatorName = toolchain::addEnumValues(
        UncommonNameKindOffset,
        detail::DeclarationNameExtra::CXXLiteralOperatorName),
    CXXUsingDirective =
        toolchain::addEnumValues(UncommonNameKindOffset,
...
class DeclarationNameTable {
  ...
  toolchain::FoldingSet<detail::CXXSpecialNameExtra> CXXConstructorNames;
  ...
  toolchain::FoldingSet<detail::CXXSpecialNameExtra> CXXDestructorNames;
  ...
  /// conversion function.
  toolchain::FoldingSet<detail::CXXSpecialNameExtra> CXXConversionFunctionNames;
  ...
  toolchain::FoldingSet<detail::CXXLiteralOperatorIdName> CXXLiteralOperatorNames;
  ...
  toolchain::FoldingSet<detail::CXXDeductionGuideNameExtra> CXXDeductionGuideNames;
...
template<>
struct DenseMapInfo<language::Core::DeclarationName> {
  static inline language::Core::DeclarationName getEmptyKey() {
    return language::Core::DeclarationName::getEmptyMarker();
  }

  static inline language::Core::DeclarationName getTombstoneKey() {
    return language::Core::DeclarationName::getTombstoneMarker();
  }

  static unsigned getHashValue(language::Core::DeclarationName Name) {
    return DenseMapInfo<void*>::getHashValue(Name.getAsOpaquePtr());
  }

  static inline bool
  isEqual(language::Core::DeclarationName LHS, language::Core::DeclarationName RHS) {
    return LHS == RHS;
  }
};

template <> struct PointerLikeTypeTraits<language::Core::DeclarationName> {
  static inline void *getAsVoidPointer(language::Core::DeclarationName P) {
    return P.getAsOpaquePtr();
  }
  static inline language::Core::DeclarationName getFromVoidPointer(void *P) {
    return language::Core::DeclarationName::getFromOpaquePtr(P);
  }
...
#endif // LANGUAGE_CORE_AST_DECLARATIONNAME_H
