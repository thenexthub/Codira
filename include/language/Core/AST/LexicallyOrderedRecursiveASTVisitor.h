...
#ifndef LANGUAGE_CORE_AST_LEXICALLYORDEREDRECURSIVEASTVISITOR_H
#define LANGUAGE_CORE_AST_LEXICALLYORDEREDRECURSIVEASTVISITOR_H
...
private:
  ...
  toolchain::SmallVector<Decl *, 8> LexicallyNestedDeclarations;
};

} // end namespace language::Core

#endif // LANGUAGE_CORE_AST_LEXICALLYORDEREDRECURSIVEASTVISITOR_H
