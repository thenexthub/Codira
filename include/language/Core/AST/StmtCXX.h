...
#ifndef LANGUAGE_CORE_AST_STMTCXX_H
#define LANGUAGE_CORE_AST_STMTCXX_H
...
class CXXTryStmt final : public Stmt,
                         private toolchain::TrailingObjects<CXXTryStmt, Stmt *> {
...
class CoroutineBodyStmt final
    : public Stmt,
      private toolchain::TrailingObjects<CoroutineBodyStmt, Stmt *> {
  enum SubStmt {
...
public:
  ...
  Expr *getReturnValue() const {
    auto *RS = dyn_cast_or_null<language::Core::ReturnStmt>(getReturnStmt());
