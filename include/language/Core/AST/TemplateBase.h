...
#ifndef LANGUAGE_CORE_AST_TEMPLATEBASE_H
#define LANGUAGE_CORE_AST_TEMPLATEBASE_H
...
// Provide PointerLikeTypeTraits for language::Core::Expr*, this default one requires a
// full definition of Expr, but this file only sees a forward del because of
// the dependency.
template <> struct PointerLikeTypeTraits<language::Core::Expr *> {
  static inline void *getAsVoidPointer(language::Core::Expr *P) { return P; }
  static inline language::Core::Expr *getFromVoidPointer(void *P) {
    return static_cast<language::Core::Expr *>(P);
  }
...
public:
  ...
  enum ArgKind {
    ...
    /// The template argument is an integral value stored in an toolchain::APSInt
...
private:
  ...
  void initFromIntegral(const ASTContext &Ctx, const toolchain::APSInt &Value,
...
public:
  ...
  TemplateArgument(const ASTContext &Ctx, const toolchain::APSInt &Value,
  ...
  toolchain::APSInt getAsIntegral() const {
...
private:
  toolchain::PointerUnion<TemplateTemplateArgLocInfo *, Expr *, TypeSourceInfo *>
      Pointer;
};
...
struct ASTTemplateArgumentListInfo final
    : private toolchain::TrailingObjects<ASTTemplateArgumentListInfo,
                                    TemplateArgumentLoc> {
private:
...
#endif // LANGUAGE_CORE_AST_TEMPLATEBASE_H
