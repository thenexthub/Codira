...
#ifndef LANGUAGE_CORE_AST_STMTOPENACC_H
#define LANGUAGE_CORE_AST_STMTOPENACC_H
...
class OpenACCComputeConstruct final
    : public OpenACCAssociatedStmtConstruct,
      private toolchain::TrailingObjects<OpenACCComputeConstruct,
                                    const OpenACCClause *> {
  friend class ASTStmtWriter;
  friend class ASTStmtReader;
...
class OpenACCLoopConstruct final
    : public OpenACCAssociatedStmtConstruct,
      private toolchain::TrailingObjects<OpenACCLoopConstruct,
                                   const OpenACCClause *> {
...
class OpenACCCombinedConstruct final
    : public OpenACCAssociatedStmtConstruct,
      private toolchain::TrailingObjects<OpenACCCombinedConstruct,
                                   const OpenACCClause *> {
  friend TrailingObjects;
...
class OpenACCDataConstruct final
    : public OpenACCAssociatedStmtConstruct,
      private toolchain::TrailingObjects<OpenACCDataConstruct,
                                   const OpenACCClause *> {
  friend TrailingObjects;
...
class OpenACCEnterDataConstruct final
    : public OpenACCConstructStmt,
      private toolchain::TrailingObjects<OpenACCEnterDataConstruct,
                                   const OpenACCClause *> {
  friend TrailingObjects;
...
class OpenACCExitDataConstruct final
    : public OpenACCConstructStmt,
      private toolchain::TrailingObjects<OpenACCExitDataConstruct,
                                   const OpenACCClause *> {
  friend TrailingObjects;
...
class OpenACCHostDataConstruct final
    : public OpenACCAssociatedStmtConstruct,
      private toolchain::TrailingObjects<OpenACCHostDataConstruct,
                                   const OpenACCClause *> {
  friend TrailingObjects;
...
class OpenACCWaitConstruct final
    : public OpenACCConstructStmt,
      private toolchain::TrailingObjects<OpenACCWaitConstruct, Expr *,
                                    OpenACCClause *> {
  ...
  OpenACCWaitConstruct(SourceLocation Start, SourceLocation DirectiveLoc,
    ...
    toolchain::uninitialized_copy(ArrayRef(DevNumExpr), getExprPtr());
    toolchain::uninitialized_copy(QueueIdExprs, getExprPtr() + 1);
...
class OpenACCCacheConstruct final
    : public OpenACCConstructStmt,
      private toolchain::TrailingObjects<OpenACCCacheConstruct, Expr *> {
  friend TrailingObjects;
  friend class ASTStmtWriter;
  friend class ASTStmtReader;
  ...
  OpenACCCacheConstruct(SourceLocation Start, SourceLocation DirectiveLoc,
    ...
    toolchain::uninitialized_copy(VarList, getTrailingObjects());
  }
...
class OpenACCInitConstruct final
    : public OpenACCConstructStmt,
      private toolchain::TrailingObjects<OpenACCInitConstruct,
                                    const OpenACCClause *> {
  friend TrailingObjects;
...
class OpenACCShutdownConstruct final
    : public OpenACCConstructStmt,
      private toolchain::TrailingObjects<OpenACCShutdownConstruct,
                                    const OpenACCClause *> {
  friend TrailingObjects;
...
class OpenACCSetConstruct final
    : public OpenACCConstructStmt,
      private toolchain::TrailingObjects<OpenACCSetConstruct,
                                    const OpenACCClause *> {
  friend TrailingObjects;
...
class OpenACCUpdateConstruct final
    : public OpenACCConstructStmt,
      private toolchain::TrailingObjects<OpenACCUpdateConstruct,
                                    const OpenACCClause *> {
  friend TrailingObjects;
...
class OpenACCAtomicConstruct final
    : public OpenACCAssociatedStmtConstruct,
      private toolchain::TrailingObjects<OpenACCAtomicConstruct,
                                    const OpenACCClause *> {
...
#endif // LANGUAGE_CORE_AST_STMTOPENACC_H
