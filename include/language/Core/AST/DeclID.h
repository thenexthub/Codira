...
#ifndef LANGUAGE_CORE_AST_DECLID_H
#define LANGUAGE_CORE_AST_DECLID_H
...
class LocalDeclID : public DeclIDBase {
  ...
  friend struct toolchain::DenseMapInfo<language::Core::LocalDeclID>;
...
class DeclIDIterator
    : public toolchain::iterator_adaptor_base<DeclIDIterator<FromTy, ToTy>,
                                         const FromTy *,
...
namespace toolchain {
template <> struct DenseMapInfo<language::Core::GlobalDeclID> {
  using GlobalDeclID = language::Core::GlobalDeclID;
...
template <> struct DenseMapInfo<language::Core::LocalDeclID> {
  using LocalDeclID = language::Core::LocalDeclID;
