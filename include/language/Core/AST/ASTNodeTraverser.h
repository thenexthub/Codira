...
#ifndef LANGUAGE_CORE_AST_ASTNODETRAVERSER_H
#define LANGUAGE_CORE_AST_ASTNODETRAVERSER_H
...
public:
  ...
  void Visit(const Decl *D, bool VisitLocs = false) {
    ...
    getNodeDelegate().AddChild([=] {
      ...
      {
        toolchain::SaveAndRestore RestoreVisitLocs(this->VisitLocs, VisitLocs);
...
#include "language/Core/AST/AttrNodeTraverse.inc"
};

} // namespace language::Core

#endif // LANGUAGE_CORE_AST_ASTNODETRAVERSER_H
