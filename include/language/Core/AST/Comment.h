...
#ifndef LANGUAGE_CORE_AST_COMMENT_H
#define LANGUAGE_CORE_AST_COMMENT_H
...
public:
  ...
  Comment(CommentKind K,
    ...
    CommentBits.Kind = toolchain::to_underlying(K);
  }
...
public:
  InlineCommandComment(SourceLocation LocBegin, SourceLocation LocEnd,
      ...
      : InlineContentComment(CommentKind::InlineCommandComment, LocBegin,
                             LocEnd),
        Args(Args) {
    InlineCommandCommentBits.RenderKind = toolchain::to_underlying(RK);
  ...
  InlineCommandComment(SourceLocation LocBegin, SourceLocation LocEnd,
    ...
    InlineCommandCommentBits.RenderKind = toolchain::to_underlying(RK);
    InlineCommandCommentBits.CommandID = CommandID;
    InlineCommandCommentBits.CommandMarker = toolchain::to_underlying(CommandMarker);
  }
...
public:
  ...
  ParamCommandComment(SourceLocation LocBegin, SourceLocation LocEnd,
    ...
    ParamCommandCommentBits.Direction =
        toolchain::to_underlying(ParamCommandPassDirection::In);
  ...
  void setDirection(ParamCommandPassDirection Direction, bool Explicit) {
    ParamCommandCommentBits.Direction = toolchain::to_underlying(Direction);
