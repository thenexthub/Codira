...
///
/// This file defines the language::Core::Type interface and subclasses, used to
/// represent types for languages in the C family.
//
//===----------------------------------------------------------------------===//

#ifndef LANGUAGE_CORE_AST_TYPE_H
#define LANGUAGE_CORE_AST_TYPE_H
...
#include "language/Core/Basic/AttrKinds.h"
...
#include "language/Core/Basic/Visibility.h"
...
namespace toolchain {
  ...
  template<>
  struct PointerLikeTypeTraits< ::language::Core::Type*> {
    static inline void *getAsVoidPointer(::language::Core::Type *P) { return P; }

    static inline ::language::Core::Type *getFromVoidPointer(void *P) {
      return static_cast< ::language::Core::Type*>(P);
    }

    static constexpr int NumLowBitsAvailable = language::Core::TypeAlignmentInBits;
  };

  template<>
  struct PointerLikeTypeTraits< ::language::Core::ExtQuals*> {
    static inline void *getAsVoidPointer(::language::Core::ExtQuals *P) { return P; }

    static inline ::language::Core::ExtQuals *getFromVoidPointer(void *P) {
      return static_cast< ::language::Core::ExtQuals*>(P);
    }
  ...
  PointerAuthQualifier(unsigned Key, bool IsAddressDiscriminated,
      ...
      : Data(EnabledMask |
             (IsAddressDiscriminated
                  ? toolchain::to_underlying(AddressDiscriminatedMask)
                  : 0) |
             (Key << KeyShift) |
             (toolchain::to_underlying(AuthenticationMode)
              << AuthenticationModeShift) |
...
public:
  ...
  void Profile(toolchain::FoldingSetNodeID &ID) const { ID.AddInteger(Data); }
};
...
public:
  ...
  void Profile(toolchain::FoldingSetNodeID &ID) const { ID.AddInteger(Mask); }
...
class QualType {
  ...
  toolchain::PointerIntPair<toolchain::PointerUnion<const Type *, const ExtQuals *>,
...
public:
  ...
  void dump() const;
  void dump(toolchain::raw_ostream &OS, const ASTContext &Context) const;
...
template<> struct simplify_type< ::language::Core::QualType> {
  using SimpleType = const ::language::Core::Type *;

  static SimpleType getSimplifiedValue(::language::Core::QualType Val) {
...
template<>
struct PointerLikeTypeTraits<language::Core::QualType> {
  static inline void *getAsVoidPointer(language::Core::QualType P) {
    return P.getAsOpaquePtr();
  }

  static inline language::Core::QualType getFromVoidPointer(void *P) {
    return language::Core::QualType::getFromOpaquePtr(P);
  }
...
private:
  ...
  class TypeBitfields {
    ...
    unsigned Dependence : toolchain::BitWidth<TypeDependence>;
  ...
  enum { NumTypeBits = 8 + toolchain::BitWidth<TypeDependence> + 6 };
...
protected:
  ...
  Type(TypeClass tc, QualType canon, TypeDependence Dependence)
    ...
    TypeBits.CachedLinkage = toolchain::to_underlying(Linkage::Invalid);
...
class ComplexType : public Type, public toolchain::FoldingSetNode {
  friend class ASTContext; // ASTContext creates these.
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, QualType Element) {
...
class ParenType : public Type, public toolchain::FoldingSetNode {
  friend class ASTContext; // ASTContext creates these.
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, QualType Inner) {
    Inner.Profile(ID);
  }
...
class PointerType : public Type, public toolchain::FoldingSetNode {
  friend class ASTContext; // ASTContext creates these.
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, QualType Pointee) {
...
public:
  using BaseTy = toolchain::PointerIntPair<ValueDecl *, 1, unsigned>;
...
class BoundsAttributedType : public Type, public toolchain::FoldingSetNode {
  QualType WrappedTy;
...
public:
  ...
  using decl_range = toolchain::iterator_range<decl_iterator>;
...
class CountAttributedType final
    : public BoundsAttributedType,
      public toolchain::TrailingObjects<CountAttributedType,
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, QualType WrappedTy,
...
class AdjustedType : public Type, public toolchain::FoldingSetNode {
  QualType OriginalTy;
  QualType AdjustedTy;
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, QualType Orig, QualType New) {
...
class BlockPointerType : public Type, public toolchain::FoldingSetNode {
  friend class ASTContext; // ASTContext creates these.
...
class ReferenceType : public Type, public toolchain::FoldingSetNode {
  QualType PointeeType;
...
class MemberPointerType : public Type, public toolchain::FoldingSetNode {
  friend class ASTContext; // ASTContext creates these.
...
public:
  ...
  void Profile(toolchain::FoldingSetNodeID &ID) {
    ...
    // issues (see https://github.com/toolchain/toolchain-project/pull/137910).
...
class ArrayType : public Type, public toolchain::FoldingSetNode {
private:
...
class ConstantArrayType : public ArrayType {
  ...
  struct ExternalSize {
    ExternalSize(const toolchain::APInt &Sz, const Expr *SE)
        : Size(Sz), SizeExpr(SE) {}
    toolchain::APInt Size; // Allows us to unique the type.
    const Expr *SizeExpr;
  };
  ...
  static ConstantArrayType *Create(const ASTContext &Ctx, QualType ET,
                                   QualType Can, const toolchain::APInt &Sz,
...
public:
  ...
  toolchain::APInt getSize() const {
    return ConstantArrayTypeBits.HasExternalSize
               ? SizePtr->Size
               : toolchain::APInt(ConstantArrayTypeBits.SizeWidth * 8, Size);
  }
  ...
  static unsigned getNumAddressingBits(const ASTContext &Context,
                                       QualType ElementType,
                                       const toolchain::APInt &NumElements);
  ...
  void Profile(toolchain::FoldingSetNodeID &ID, const ASTContext &Ctx) {
    Profile(ID, Ctx, getElementType(), getZExtSize(), getSizeExpr(),
            getSizeModifier(), getIndexTypeCVRQualifiers());
  }

  static void Profile(toolchain::FoldingSetNodeID &ID, const ASTContext &Ctx,
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, QualType ET,
                      ArraySizeModifier SizeMod, unsigned TypeQuals) {
    ID.AddPointer(ET.getAsOpaquePtr());
    ID.AddInteger(toolchain::to_underlying(SizeMod));
...
public:
  ...
  void Profile(toolchain::FoldingSetNodeID &ID) {
    toolchain_unreachable("Cannot unique VariableArrayTypes.");
  }
};
...
public:
  ...
  void Profile(toolchain::FoldingSetNodeID &ID, const ASTContext &Context) {
    Profile(ID, Context, getElementType(),
            getSizeModifier(), getIndexTypeCVRQualifiers(), getSizeExpr());
  }

  static void Profile(toolchain::FoldingSetNodeID &ID, const ASTContext &Context,
...
/// }
/// \endcode
class DependentAddressSpaceType : public Type, public toolchain::FoldingSetNode {
  friend class ASTContext;
...
/// }
/// \endcode
class DependentSizedExtVectorType : public Type, public toolchain::FoldingSetNode {
  friend class ASTContext;
...
class VectorType : public Type, public toolchain::FoldingSetNode {
protected:
  friend class ASTContext; // ASTContext creates these.
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, QualType ElementType,
                      unsigned NumElements, TypeClass TypeClass,
                      VectorKind VecKind) {
    ID.AddPointer(ElementType.getAsOpaquePtr());
    ID.AddInteger(NumElements);
    ID.AddInteger(TypeClass);
    ID.AddInteger(toolchain::to_underlying(VecKind));
  }
...
/// }
/// \endcode
class DependentVectorType : public Type, public toolchain::FoldingSetNode {
  friend class ASTContext;
...
class MatrixType : public Type, public toolchain::FoldingSetNode {
protected:
  friend class ASTContext;
...
public:
  ...
  struct alignas(void *) FunctionTypeExtraAttributeInfo {
    ...
    void Profile(toolchain::FoldingSetNodeID &ID) const { ID.AddString(CFISalt); }
  };
...
class FunctionNoProtoType : public FunctionType, public toolchain::FoldingSetNode {
  friend class ASTContext; // ASTContext creates these.
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, QualType ResultType,
                      ExtInfo Info) {
    Info.Profile(ID);
...
public:
  ...
  Flags flags() const {
    ...
    toolchain_unreachable("unknown effect kind");
  }
...
private:
  ...
  getExceptionSpecSize(ExceptionSpecificationType EST, unsigned NumExceptions) {
    ...
    toolchain_unreachable("bad exception specification kind");
  }
...
public:
  ...
  void Profile(toolchain::FoldingSetNodeID &ID, const ASTContext &Ctx);
  static void Profile(toolchain::FoldingSetNodeID &ID, QualType Result,
...
protected:
  ...
  KeywordWrapper(ElaboratedTypeKeyword Keyword, As &&...as)
      : T(std::forward<As>(as)...) {
    this->KeywordWrapperBits.Keyword = toolchain::to_underlying(Keyword);
  }
...
template <class T> struct FoldingSetPlaceholder : toolchain::FoldingSetNode {
  void Profile(toolchain::FoldingSetNodeID &ID) { getType()->Profile(ID); }

  inline const T *getType() const {
    constexpr unsigned long Offset =
        toolchain::alignTo(sizeof(T), alignof(FoldingSetPlaceholder));
    const auto *Addr = reinterpret_cast<const T *>(
        reinterpret_cast<const char *>(this) - Offset);
    assert(toolchain::isAddrAligned(toolchain::Align(alignof(T)), Addr));
    return Addr;
  }
};
...
class UnresolvedUsingType final
    : public TypeWithKeyword,
      private toolchain::TrailingObjects<UnresolvedUsingType,
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, ElaboratedTypeKeyword Keyword,
                      NestedNameSpecifier Qualifier,
                      const UnresolvedUsingTypenameDecl *D) {
    static_assert(toolchain::to_underlying(ElaboratedTypeKeyword::None) <= 7);
    ID.AddInteger(uintptr_t(D) | toolchain::to_underlying(Keyword));
    if (Qualifier)
...
class UsingType final : public TypeWithKeyword,
                        public toolchain::FoldingSetNode,
                        toolchain::TrailingObjects<UsingType, NestedNameSpecifier> {
  UsingShadowDecl *D;
...
class TypedefType final
    : public TypeWithKeyword,
      private toolchain::TrailingObjects<TypedefType,
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, ElaboratedTypeKeyword Keyword,
    ...
    if (Keyword != ElaboratedTypeKeyword::None)
      ID.AddInteger(toolchain::to_underlying(Keyword));
    if (Qualifier)
      Qualifier.Profile(ID);
...
class DependentDecltypeType : public DecltypeType, public toolchain::FoldingSetNode {
public:
...
class PackIndexingType final
    : public Type,
      public toolchain::FoldingSetNode,
      private toolchain::TrailingObjects<PackIndexingType, QualType> {
  friend TrailingObjects;
...
class UnaryTransformType : public Type, public toolchain::FoldingSetNode {
public:
  enum UTTKind {
#define TRANSFORM_TYPE_TRAIT_DEF(Enum, _) Enum,
#include "language/Core/Basic/TransformTypeTraits.def"
  };
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, QualType BaseType,
...
struct TagTypeFoldingSetPlaceholder : public toolchain::FoldingSetNode {
...
class AttributedType : public Type, public toolchain::FoldingSetNode {
public:
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, Kind attrKind,
                      QualType modified, QualType equivalent,
                      const Attr *attr) {
...
class BTFTagAttributedType : public Type, public toolchain::FoldingSetNode {
private:
  friend class ASTContext; // ASTContext creates these
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, QualType Wrapped,
                      const BTFTypeTagAttr *BTFAttr) {
...
class HLSLAttributedResourceType : public Type, public toolchain::FoldingSetNode {
public:
  struct Attributes {
    // Data gathered from HLSL resource attributes
    toolchain::dxil::ResourceClass ResourceClass;
    ...
    Attributes(toolchain::dxil::ResourceClass ResourceClass, bool IsROV = false,
               bool RawBuffer = false)
        : ResourceClass(ResourceClass), IsROV(IsROV), RawBuffer(RawBuffer) {}

    Attributes() : Attributes(toolchain::dxil::ResourceClass::UAV, false, false) {}
...
private:
  ...
  QualType ResultType;
  toolchain::APInt Value; // Signedness of constants is represented by ResultType.

public:
  SpirvOperand() : Kind(Invalid), ResultType(), Value() {}

  SpirvOperand(SpirvOperandKind Kind, QualType ResultType, toolchain::APInt Value)
  ...
  toolchain::APInt getValue() const {
  ...
  static SpirvOperand createConstant(QualType ResultType, toolchain::APInt Val) {
    return SpirvOperand(ConstantId, ResultType, std::move(Val));
  }

  static SpirvOperand createLiteral(toolchain::APInt Val) {
    return SpirvOperand(Literal, QualType(), std::move(Val));
  }

  static SpirvOperand createType(QualType T) {
    return SpirvOperand(TypeId, T, toolchain::APSInt());
  }
...
class HLSLInlineSpirvType final
    : public Type,
      public toolchain::FoldingSetNode,
      private toolchain::TrailingObjects<HLSLInlineSpirvType, SpirvOperand> {
  friend class ASTContext; // ASTContext creates these
  friend TrailingObjects;
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, uint32_t Opcode,
...
class TemplateTypeParmType : public Type, public toolchain::FoldingSetNode {
  friend class ASTContext; // ASTContext creates these
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, unsigned Depth,
...
class SubstTemplateTypeParmType final
    : public Type,
      public toolchain::FoldingSetNode,
      private toolchain::TrailingObjects<SubstTemplateTypeParmType, QualType> {
  friend class ASTContext;
  friend class toolchain::TrailingObjects<SubstTemplateTypeParmType, QualType>;
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, QualType Replacement,
...
class SubstTemplateTypeParmPackType : public Type, public toolchain::FoldingSetNode {
  friend class ASTContext;
  ...
  toolchain::PointerIntPair<Decl *, 1, bool> AssociatedDeclAndFinal;
...
public:
  ...
  void Profile(toolchain::FoldingSetNodeID &ID);
  static void Profile(toolchain::FoldingSetNodeID &ID, const Decl *AssociatedDecl,
                      unsigned Index, bool Final,
                      const TemplateArgument &ArgPack);
...
public:
  ...
  void Profile(toolchain::FoldingSetNodeID &ID, const ASTContext &Ctx);
  static void Profile(toolchain::FoldingSetNodeID &ID, TemplateName T,
...
/// instantiation.
class DependentNameType : public TypeWithKeyword, public toolchain::FoldingSetNode {
  friend class ASTContext; // ASTContext creates these
...
class PackExpansionType : public Type, public toolchain::FoldingSetNode {
  friend class ASTContext; // ASTContext creates these
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, QualType Pattern,
                      UnsignedOrNone NumExpansions) {
...
public:
  ...
  using qual_range = toolchain::iterator_range<qual_iterator>;
...
class ObjCObjectType : public Type,
  ...
  mutable toolchain::PointerIntPair<const ObjCObjectType *, 1, bool>
...
class ObjCObjectTypeImpl : public ObjCObjectType, public toolchain::FoldingSetNode {
  friend class ASTContext;
...
class ObjCObjectPointerType : public Type, public toolchain::FoldingSetNode {
  friend class ASTContext; // ASTContext creates these.
...
class AtomicType : public Type, public toolchain::FoldingSetNode {
  friend class ASTContext; // ASTContext creates these.
...
/// PipeType - OpenCL20.
class PipeType : public Type, public toolchain::FoldingSetNode {
  friend class ASTContext; // ASTContext creates these.
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, QualType T, bool isRead) {
    ID.AddPointer(T.getAsOpaquePtr());
...
class BitIntType final : public Type, public toolchain::FoldingSetNode {
  friend class ASTContext;
  LLVM_PREFERRED_TYPE(bool)
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, bool IsUnsigned,
                      unsigned NumBits) {
...
class DependentBitIntType final : public Type, public toolchain::FoldingSetNode {
  friend class ASTContext;
  toolchain::PointerIntPair<Expr*, 1, bool> ExprAndUnsigned;
...
private:
  PredefinedSugarType(Kind KD, const IdentifierInfo *IdentName,
      ...
      : Type(PredefinedSugar, CanonicalType, TypeDependence::None),
        Name(IdentName) {
    PredefinedSugarTypeBits.Kind = toolchain::to_underlying(KD);
  }
...
inline const StreamingDiagnostic &operator<<(const StreamingDiagnostic &PD,
                                             LangAS AS) {
  PD.AddTaggedVal(toolchain::to_underlying(AS),
...
void FixedPointValueToString(SmallVectorImpl<char> &Str, toolchain::APSInt Val,
                             unsigned Scale);
...
#endif // LANGUAGE_CORE_AST_TYPE_H
