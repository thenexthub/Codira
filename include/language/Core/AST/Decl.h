...
#ifndef LANGUAGE_CORE_AST_DECL_H
#define LANGUAGE_CORE_AST_DECL_H

#include "language/Core/AST/APNumericStorage.h"
#include "language/Core/AST/APValue.h"
#include "language/Core/AST/ASTContextAllocate.h"
...
#include "language/Core/Basic/UnsignedOrNone.h"
...
#include "toolchain/BinaryFormat/DXContainer.h"
...
class PragmaCommentDecl final
    : public Decl,
      private toolchain::TrailingObjects<PragmaCommentDecl, char> {
...
class PragmaDetectMismatchDecl final
    : public Decl,
      private toolchain::TrailingObjects<PragmaDetectMismatchDecl, char> {
  friend class ASTDeclReader;
  friend class ASTDeclWriter;
  friend TrailingObjects;
...
public:
  ...
  bool isExternallyVisible() const {
    return language::Core::isExternallyVisible(getLinkageInternal());
  }
...
class DeclaratorDecl : public ValueDecl {
  ...
  toolchain::PointerUnion<TypeSourceInfo *, ExtInfo *> DeclInfo;
...
protected:
  ...
  using InitType = toolchain::PointerUnion<Stmt *, EvaluatedStmt *>;
...
public:
  ...
  ImplicitParamDecl(ASTContext &C, DeclContext *DC, SourceLocation IdLoc,
    ...
    NonParmVarDeclBits.ImplicitParamKind = toolchain::to_underlying(ParamKind);
    setImplicit();
  }
...
public:
  ...
  class DefaultedOrDeletedFunctionInfo final
      : toolchain::TrailingObjects<DefaultedOrDeletedFunctionInfo, DeclAccessPair,
                              StringLiteral *> {
    friend TrailingObjects;
    unsigned NumLookups;
...
private:
  ...
  /// that specialization.
  toolchain::PointerUnion<NamedDecl *, MemberSpecializationInfo *,
...
public:
  ...
  toolchain::APSInt getInitVal() const {
    return toolchain::APSInt(getValue(), IsUnsigned);
  }

  void setInitExpr(Expr *E) { Init = (Stmt*) E; }
  void setInitVal(const ASTContext &C, const toolchain::APSInt &V) {
    setValue(C, V);
...
class TypedefNameDecl : public TypeDecl, public Redeclarable<TypedefNameDecl> {
  ...
  mutable toolchain::PointerIntPair<
      toolchain::PointerUnion<TypeSourceInfo *, ModedTInfo *>, 2>
      MaybeModedTInfo;
...
private:
  ...
  toolchain::PointerUnion<TypedefNameDecl *, ExtInfo *> TypedefNameDeclOrQualifier;
...
public:
  ...
  void setTagKind(TagKind TK) {
    TagDeclBits.TagDeclKind = toolchain::to_underlying(TK);
  }
...
class EnumDecl : public TagDecl {
  ...
  toolchain::PointerUnion<const Type *, TypeSourceInfo *> IntegerType;
...
public:
  ...
  using enumerator_range =
      toolchain::iterator_range<specific_decl_iterator<EnumConstantDecl>>;
  ...
  void getValueRange(toolchain::APInt &Max, toolchain::APInt &Min) const;
...
public:
  ...
  void setArgPassingRestrictions(RecordArgPassingKind Kind) {
    RecordDeclBits.ArgPassingRestrictions = toolchain::to_underlying(Kind);
  }
  ...
  using field_range = toolchain::iterator_range<specific_decl_iterator<FieldDecl>>;
...
public:
  ...
  class Capture {
    ...
    toolchain::PointerIntPair<VarDecl*, 2> VariableAndFlags;
...
class OutlinedFunctionDecl final
    : public Decl,
      public DeclContext,
      private toolchain::TrailingObjects<OutlinedFunctionDecl, ImplicitParamDecl *> {
private:
  /// The number of parameters to the outlined function.
  unsigned NumParams;

  /// The body of the outlined function.
  toolchain::PointerIntPair<Stmt *, 1, bool> BodyAndNothrow;
...
public:
  ...
  using parameter_const_range = toolchain::iterator_range<parameter_const_iterator>;
...
class CapturedDecl final
    : public Decl,
      public DeclContext,
      private toolchain::TrailingObjects<CapturedDecl, ImplicitParamDecl *> {
protected:
...
public:
  ...
  using param_range = toolchain::iterator_range<param_iterator>;
...
class ImportDecl final : public Decl,
                         toolchain::TrailingObjects<ImportDecl, SourceLocation> {
  friend class ASTContext;
  friend class ASTDeclReader;
  friend class ASTReader;
  friend TrailingObjects;
  ...
  toolchain::PointerIntPair<ImportDecl *, 1, bool> NextLocalImportAndComplete;
...
public:
  ...
  //
  // The iterator uses toolchain::concat_iterator to concatenate the lists
  // `decls()` and `DefaultBufferDecls`. For non-default buffers
  // `DefaultBufferDecls` is always empty.
  using buffer_decl_iterator =
      toolchain::concat_iterator<Decl *const, SmallVector<Decl *>::const_iterator,
                            decl_iterator>;
  using buffer_decl_range = toolchain::iterator_range<buffer_decl_iterator>;
...
class HLSLRootSignatureDecl final
    : public NamedDecl,
      private toolchain::TrailingObjects<HLSLRootSignatureDecl,
                                    toolchain::hlsl::rootsig::RootElement> {
  friend TrailingObjects;
  ...
  toolchain::hlsl::rootsig::RootElement *getElems() { return getTrailingObjects(); }

  const toolchain::hlsl::rootsig::RootElement *getElems() const {
...
public:
  ...
  toolchain::dxbc::RootSignatureVersion getVersion() const { return Version; }

  ArrayRef<toolchain::hlsl::rootsig::RootElement> getRootElements() const {
...
#endif // LANGUAGE_CORE_AST_DECL_H
