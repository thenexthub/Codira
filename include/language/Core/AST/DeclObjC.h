...
#ifndef LANGUAGE_CORE_AST_DECLOBJC_H
#define LANGUAGE_CORE_AST_DECLOBJC_H
...
public:
  ...
  using param_const_range = toolchain::iterator_range<param_const_iterator>;
  ...
  using param_type_iterator =
      toolchain::mapped_iterator<param_const_iterator, GetTypeFn>;

  param_type_iterator param_type_begin() const {
    return toolchain::map_iterator(param_begin(), GetTypeFn());
  }

  param_type_iterator param_type_end() const {
    return toolchain::map_iterator(param_end(), GetTypeFn());
  }
  ...
  void setDeclImplementation(ObjCImplementationControl ic) {
    ObjCMethodDeclBits.DeclImplementation = toolchain::to_underlying(ic);
  }
...
class ObjCTypeParamList final
    : private toolchain::TrailingObjects<ObjCTypeParamList, ObjCTypeParamDecl *> {
...
public:
  ...
  using prop_range =
      toolchain::iterator_range<specific_decl_iterator<ObjCPropertyDecl>>;
  ...
  using instprop_range = toolchain::iterator_range<instprop_iterator>;
  ...
  using classprop_range = toolchain::iterator_range<classprop_iterator>;
  ...
  using method_range =
      toolchain::iterator_range<specific_decl_iterator<ObjCMethodDecl>>;
  ...
  using instmeth_range = toolchain::iterator_range<instmeth_iterator>;
  ...
  using classmeth_range = toolchain::iterator_range<classmeth_iterator>;
  ...
  using PropertyMap =
      toolchain::MapVector<std::pair<IdentifierInfo *, unsigned /*isClassProperty*/>,
                      ObjCPropertyDecl *>;
  using ProtocolPropertySet = toolchain::SmallDenseSet<const ObjCProtocolDecl *, 8>;
  using PropertyDeclOrder = toolchain::SmallVector<ObjCPropertyDecl *, 8>;
...
class ObjCInterfaceDecl : public ObjCContainerDecl
  ...
  toolchain::PointerIntPair<DefinitionData *, 1, bool> Data;
...
public:
  ...
  using protocol_range = toolchain::iterator_range<protocol_iterator>;
  ...
  using protocol_loc_range = toolchain::iterator_range<protocol_loc_iterator>;
  ...
  using all_protocol_range = toolchain::iterator_range<all_protocol_iterator>;
  ...
  using ivar_range = toolchain::iterator_range<specific_decl_iterator<ObjCIvarDecl>>;
  ...
  void getDesignatedInitializers(
                  toolchain::SmallVectorImpl<const ObjCMethodDecl *> &Methods) const;
...
public:
  ...
  using visible_categories_range =
      toolchain::iterator_range<visible_categories_iterator>;
...
public:
  ...
  using known_categories_range =
     toolchain::iterator_range<known_categories_iterator>;
...
public:
  ...
  using visible_extensions_range =
      toolchain::iterator_range<visible_extensions_iterator>;
...
public:
  ...
  using known_extensions_range =
      toolchain::iterator_range<known_extensions_iterator>;
...
public:
  ...
  /// hierarchy.
  void getImpliedProtocols(toolchain::DenseSet<const ObjCProtocolDecl *> &IPs) const;
...
public:
  ...
  using propimpl_range =
      toolchain::iterator_range<specific_decl_iterator<ObjCPropertyImplDecl>>;
...
#endif // LANGUAGE_CORE_AST_DECLOBJC_H
