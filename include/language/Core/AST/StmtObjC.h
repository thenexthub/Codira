...
#ifndef LANGUAGE_CORE_AST_STMTOBJC_H
#define LANGUAGE_CORE_AST_STMTOBJC_H
...
class ObjCAtTryStmt final
    : public Stmt,
      private toolchain::TrailingObjects<ObjCAtTryStmt, Stmt *> {
...
public:
  ...
  using catch_range = toolchain::iterator_range<catch_stmt_iterator>;
  using catch_const_range = toolchain::iterator_range<const_catch_stmt_iterator>;
