...
#ifndef LANGUAGE_CORE_AST_JSONNODEDUMPER_H
#define LANGUAGE_CORE_AST_JSONNODEDUMPER_H
...
class JSONNodeDumper
  ...
  toolchain::json::Object createQualType(QualType QT, bool Desugar = true);
  toolchain::json::Object createBareDeclRef(const Decl *D);
  toolchain::json::Object createFPOptions(FPOptionsOverride FPO);
  void writeBareDeclRef(const Decl *D);
  toolchain::json::Object createCXXRecordDefinitionData(const CXXRecordDecl *RD);
  toolchain::json::Object createCXXBaseSpecifier(const CXXBaseSpecifier &BS);
  std::string createAccessSpecifier(AccessSpecifier AS);
  toolchain::json::Array createCastPath(const CastExpr *C);
...
#endif // LANGUAGE_CORE_AST_JSONNODEDUMPER_H
