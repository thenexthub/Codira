...
#ifndef LANGUAGE_CORE_AST_DECLOPENMP_H
#define LANGUAGE_CORE_AST_DECLOPENMP_H
...
public:
  ...
  typedef toolchain::iterator_range<varlist_iterator> varlist_range;
  typedef toolchain::iterator_range<varlist_const_iterator> varlist_const_range;
...
public:
  ...
  void setInitializer(Expr *E, OMPDeclareReductionInitKind IK) {
    Initializer = E;
    OMPDeclareReductionDeclBits.InitializerKind = toolchain::to_underlying(IK);
  }
...
public:
  ...
  using clauselist_range = toolchain::iterator_range<clauselist_iterator>;
  using clauselist_const_range =
      toolchain::iterator_range<clauselist_const_iterator>;
...
public:
  ...
  using clauselist_const_iterator = ArrayRef<const OMPClause *>::iterator;
  using clauselist_range = toolchain::iterator_range<clauselist_iterator>;
  using clauselist_const_range = toolchain::iterator_range<clauselist_const_iterator>;
