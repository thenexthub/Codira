...
//
/// \file
/// Defines the language::Core::ASTContext interface.
//
//===----------------------------------------------------------------------===//

#ifndef LANGUAGE_CORE_AST_ASTCONTEXT_H
#define LANGUAGE_CORE_AST_ASTCONTEXT_H
...
#include "language/Core/AST/SYCLKernelInfo.h"
...
class ASTContext : public RefCountedBase<ASTContext> {
  ...
  mutable toolchain::FoldingSet<ExtQuals> ExtQualNodes;
  mutable toolchain::FoldingSet<ComplexType> ComplexTypes;
  mutable toolchain::FoldingSet<PointerType> PointerTypes{GeneralTypesLog2InitSize};
  mutable toolchain::FoldingSet<AdjustedType> AdjustedTypes;
  mutable toolchain::FoldingSet<BlockPointerType> BlockPointerTypes;
  mutable toolchain::FoldingSet<LValueReferenceType> LValueReferenceTypes;
  mutable toolchain::FoldingSet<RValueReferenceType> RValueReferenceTypes;
  mutable toolchain::FoldingSet<MemberPointerType> MemberPointerTypes;
  mutable toolchain::ContextualFoldingSet<ConstantArrayType, ASTContext &>
      ConstantArrayTypes;
  mutable toolchain::FoldingSet<IncompleteArrayType> IncompleteArrayTypes;
  mutable std::vector<VariableArrayType*> VariableArrayTypes;
  mutable toolchain::ContextualFoldingSet<DependentSizedArrayType, ASTContext &>
      DependentSizedArrayTypes;
  mutable toolchain::ContextualFoldingSet<DependentSizedExtVectorType, ASTContext &>
      DependentSizedExtVectorTypes;
  mutable toolchain::ContextualFoldingSet<DependentAddressSpaceType, ASTContext &>
      DependentAddressSpaceTypes;
  mutable toolchain::FoldingSet<VectorType> VectorTypes;
  mutable toolchain::ContextualFoldingSet<DependentVectorType, ASTContext &>
      DependentVectorTypes;
  mutable toolchain::FoldingSet<ConstantMatrixType> MatrixTypes;
  mutable toolchain::ContextualFoldingSet<DependentSizedMatrixType, ASTContext &>
      DependentSizedMatrixTypes;
  mutable toolchain::FoldingSet<FunctionNoProtoType> FunctionNoProtoTypes;
  mutable toolchain::ContextualFoldingSet<FunctionProtoType, ASTContext&>
    FunctionProtoTypes;
  mutable toolchain::ContextualFoldingSet<DependentTypeOfExprType, ASTContext &>
      DependentTypeOfExprTypes;
  mutable toolchain::ContextualFoldingSet<DependentDecltypeType, ASTContext &>
      DependentDecltypeTypes;

  mutable toolchain::ContextualFoldingSet<PackIndexingType, ASTContext &>
      DependentPackIndexingTypes;

  mutable toolchain::FoldingSet<TemplateTypeParmType> TemplateTypeParmTypes;
  mutable toolchain::FoldingSet<ObjCTypeParamType> ObjCTypeParamTypes;
  mutable toolchain::FoldingSet<SubstTemplateTypeParmType>
    SubstTemplateTypeParmTypes;
  mutable toolchain::FoldingSet<SubstTemplateTypeParmPackType>
    SubstTemplateTypeParmPackTypes;
  mutable toolchain::ContextualFoldingSet<TemplateSpecializationType, ASTContext&>
    TemplateSpecializationTypes;
  mutable toolchain::FoldingSet<ParenType> ParenTypes{GeneralTypesLog2InitSize};
  mutable toolchain::FoldingSet<TagTypeFoldingSetPlaceholder> TagTypes;
  mutable toolchain::FoldingSet<FoldingSetPlaceholder<UnresolvedUsingType>>
      UnresolvedUsingTypes;
  mutable toolchain::FoldingSet<UsingType> UsingTypes;
  mutable toolchain::FoldingSet<FoldingSetPlaceholder<TypedefType>> TypedefTypes;
  mutable toolchain::FoldingSet<DependentNameType> DependentNameTypes;
  mutable toolchain::DenseMap<toolchain::FoldingSetNodeID,
                         DependentTemplateSpecializationType *>
      DependentTemplateSpecializationTypes;
  mutable toolchain::FoldingSet<PackExpansionType> PackExpansionTypes;
  mutable toolchain::FoldingSet<ObjCObjectTypeImpl> ObjCObjectTypes;
  mutable toolchain::FoldingSet<ObjCObjectPointerType> ObjCObjectPointerTypes;
  mutable toolchain::FoldingSet<UnaryTransformType> UnaryTransformTypes;
  ...
  mutable toolchain::DenseMap<toolchain::FoldingSetNodeID, AutoType *> AutoTypes;
  mutable toolchain::FoldingSet<DeducedTemplateSpecializationType>
    DeducedTemplateSpecializationTypes;
  mutable toolchain::FoldingSet<AtomicType> AtomicTypes;
  mutable toolchain::FoldingSet<AttributedType> AttributedTypes;
  mutable toolchain::FoldingSet<PipeType> PipeTypes;
  mutable toolchain::FoldingSet<BitIntType> BitIntTypes;
  mutable toolchain::ContextualFoldingSet<DependentBitIntType, ASTContext &>
      DependentBitIntTypes;
  mutable toolchain::FoldingSet<BTFTagAttributedType> BTFTagAttributedTypes;
  toolchain::FoldingSet<HLSLAttributedResourceType> HLSLAttributedResourceTypes;
  toolchain::FoldingSet<HLSLInlineSpirvType> HLSLInlineSpirvTypes;

  mutable toolchain::FoldingSet<CountAttributedType> CountAttributedTypes;

  mutable toolchain::FoldingSet<QualifiedTemplateName> QualifiedTemplateNames;
  mutable toolchain::FoldingSet<DependentTemplateName> DependentTemplateNames;
  mutable toolchain::FoldingSet<SubstTemplateTemplateParmStorage>
    SubstTemplateTemplateParms;
  mutable toolchain::ContextualFoldingSet<SubstTemplateTemplateParmPackStorage,
                                     ASTContext&>
    SubstTemplateTemplateParmPacks;
  mutable toolchain::ContextualFoldingSet<DeducedTemplateStorage, ASTContext &>
      DeducedTemplates;

  mutable toolchain::ContextualFoldingSet<ArrayParameterType, ASTContext &>
      ArrayParameterTypes;

  /// Store the unique Type corresponding to each Kind.
  mutable std::array<Type *,
                     toolchain::to_underlying(PredefinedSugarType::Kind::Last) + 1>
      PredefinedSugarTypes{};

  /// Internal storage for NestedNameSpecifiers.
  ///
  /// This set is managed by the NestedNameSpecifier class.
  mutable toolchain::FoldingSet<NamespaceAndPrefixStorage>
      NamespaceAndPrefixStorages;

  /// A cache mapping from RecordDecls to ASTRecordLayouts.
  ///
  /// This is lazily created.  This is intentionally not serialized.
  mutable toolchain::DenseMap<const RecordDecl*, const ASTRecordLayout*>
    ASTRecordLayouts;
  mutable toolchain::DenseMap<const ObjCInterfaceDecl *, const ASTRecordLayout *>
      ObjCLayouts;

  /// A cache from types to size and alignment information.
  using TypeInfoMap = toolchain::DenseMap<const Type *, struct TypeInfo>;
  ...
  using UnadjustedAlignMap = toolchain::DenseMap<const Type *, unsigned>;
  mutable UnadjustedAlignMap MemoizedUnadjustedAlign;

  /// A cache mapping from CXXRecordDecls to key functions.
  toolchain::DenseMap<const CXXRecordDecl*, LazyDeclPtr> KeyFunctions;

  /// Mapping from ObjCContainers to their ObjCImplementations.
  toolchain::DenseMap<ObjCContainerDecl*, ObjCImplDecl*> ObjCImpls;

  /// Mapping from ObjCMethod to its duplicate declaration in the same
  /// interface.
  toolchain::DenseMap<const ObjCMethodDecl*,const ObjCMethodDecl*> ObjCMethodRedecls;

  /// Mapping from __block VarDecls to BlockVarCopyInit.
  toolchain::DenseMap<const VarDecl *, BlockVarCopyInit> BlockVarCopyInits;

  /// Mapping from GUIDs to the corresponding MSGuidDecl.
  mutable toolchain::FoldingSet<MSGuidDecl> MSGuidDecls;

  /// Mapping from APValues to the corresponding UnnamedGlobalConstantDecl.
  mutable toolchain::FoldingSet<UnnamedGlobalConstantDecl>
      UnnamedGlobalConstantDecls;

  /// Mapping from APValues to the corresponding TemplateParamObjects.
  mutable toolchain::FoldingSet<TemplateParamObjectDecl> TemplateParamObjectDecls;

  /// A cache mapping a string value to a StringLiteral object with the same
  /// value.
  ///
  /// This is lazily created.  This is intentionally not serialized.
  mutable toolchain::StringMap<StringLiteral *> StringLiteralCache;

  mutable toolchain::DenseSet<const FunctionDecl *> DestroyingOperatorDeletes;
  mutable toolchain::DenseSet<const FunctionDecl *> TypeAwareOperatorNewAndDeletes;
  ...
  class CanonicalTemplateTemplateParm : public toolchain::FoldingSetNode {
  ...
  public:
    ...
    void Profile(toolchain::FoldingSetNodeID &ID, const ASTContext &C) {
      Profile(ID, C, Parm);
    }
  ...
  mutable toolchain::ContextualFoldingSet<CanonicalTemplateTemplateParm,
                                     const ASTContext&>
...
#include "language/Core/Basic/BuiltinTemplates.inc"
  ...
  toolchain::DenseMap<const Decl*, AttrVec*> DeclAttrs;

  /// A mapping from non-redeclarable declarations in modules that were
  /// merged with other declarations to the canonical declaration that they were
  /// merged into.
  toolchain::DenseMap<Decl*, Decl*> MergedDecls;

  /// A mapping from a defining declaration to a list of modules (other
  /// than the owning module of the declaration) that contain merged
  /// definitions of that entity.
  toolchain::DenseMap<NamedDecl*, toolchain::TinyPtrVector<Module*>> MergedDefModules;
  ...
  struct PerModuleInitializers {
    toolchain::SmallVector<Decl*, 4> Initializers;
    toolchain::SmallVector<GlobalDeclID, 4> LazyInitializers;

    void resolve(ASTContext &Ctx);
  };
  toolchain::DenseMap<Module*, PerModuleInitializers*> ModuleInitializers;
  ...
  mutable toolchain::StringMap<const Module *> PrimaryModuleNameMap;
  mutable toolchain::DenseMap<const Module *, const Module *> SameModuleLookupSet;
...
public:
  ...
  using TemplateOrSpecializationInfo =
      toolchain::PointerUnion<VarTemplateDecl *, MemberSpecializationInfo *>;
...
private:
  ...
  toolchain::DenseMap<const VarDecl *, TemplateOrSpecializationInfo>
  ...
  toolchain::DenseMap<NamedDecl *, NamedDecl *> InstantiatedFromUsingDecl;
  ...
  toolchain::DenseMap<UsingEnumDecl *, UsingEnumDecl *>
      InstantiatedFromUsingEnumDecl;

  /// Similarly maps instantiated UsingShadowDecls to their origin.
  toolchain::DenseMap<UsingShadowDecl*, UsingShadowDecl*>
    InstantiatedFromUsingShadowDecl;

  toolchain::DenseMap<FieldDecl *, FieldDecl *> InstantiatedFromUnnamedFieldDecl;
  ...
  using CXXMethodVector = toolchain::TinyPtrVector<const CXXMethodDecl *>;
  toolchain::DenseMap<const CXXMethodDecl *, CXXMethodVector> OverriddenMethods;

  /// Mapping from each declaration context to its corresponding
  /// mangling numbering context (used for constructs like lambdas which
  /// need to be consistently numbered for the mangler).
  toolchain::DenseMap<const DeclContext *, std::unique_ptr<MangleNumberingContext>>
      MangleNumberingContexts;
  toolchain::DenseMap<const Decl *, std::unique_ptr<MangleNumberingContext>>
      ExtraMangleNumberingContexts;

  /// Side-table of mangling numbers for declarations which rarely
  /// need them (like static local vars).
  toolchain::MapVector<const NamedDecl *, unsigned> MangleNumbers;
  toolchain::MapVector<const VarDecl *, unsigned> StaticLocalNumbers;
  /// Mapping the associated device lambda mangling number if present.
  mutable toolchain::DenseMap<const CXXRecordDecl *, unsigned>
      DeviceLambdaManglingNumbers;

  /// Mapping that stores parameterIndex values for ParmVarDecls when
  /// that value exceeds the bitfield size of ParmVarDeclBits.ParameterIndex.
  using ParameterIndexTable = toolchain::DenseMap<const VarDecl *, unsigned>;
...
private:
  toolchain::DenseMap<const CXXRecordDecl *, CXXRecordDeclRelocationInfo>
      RelocatableClasses;
  ...
  toolchain::DenseMap<const RecordDecl *, PointerAuthContent>
...
#include "language/Core/Basic/BuiltinTemplates.inc"
  ...
  mutable toolchain::BumpPtrAllocator BumpAlloc;
  ...
  language::Core::PrintingPolicy PrintingPolicy;
...
public:
  ...
  const language::Core::PrintingPolicy &getPrintingPolicy() const {
    return PrintingPolicy;
  }

  void setPrintingPolicy(const language::Core::PrintingPolicy &Policy) {
  ...
  toolchain::BumpPtrAllocator &getAllocator() const {
    return BumpAlloc;
  }
  ...
  toolchain::StringRef backupStr(toolchain::StringRef S) const {
    char *Buf = new (*this) char[S.size()];
    toolchain::copy(S, Buf);
    return toolchain::StringRef(Buf, S.size());
  }

  /// Allocates a \c DeclListNode or returns one from the \c ListNodeFreeList
  /// pool.
  DeclListNode *AllocateDeclListNode(language::Core::NamedDecl *ND) {
  ...
  /// lazily.
  mutable toolchain::DenseMap<const Decl *, const RawComment *> DeclRawComments;
  ...
  /// Raw comments are owned by Comments list.  This mapping is populated
  /// lazily.
  mutable toolchain::DenseMap<const Decl *, const Decl *> RedeclChainComments;
  ...
  mutable toolchain::DenseMap<const Decl *, const Decl *> CommentlessRedeclChains;

  /// Mapping from declarations to parsed comments attached to any
  /// redeclaration.
  mutable toolchain::DenseMap<const Decl *, comments::FullComment *> ParsedComments;
...
public:
  ...
  using overridden_method_range =
      toolchain::iterator_range<overridden_cxx_method_iterator>;
  ...
  using import_range = toolchain::iterator_range<import_iterator>;
  ...
  ///
  /// FIXME: The signature may be confusing since `language::Core::Module` means to
...
#include "language/Core/Basic/HLSLIntangibleTypes.def"
  ...
  toolchain::DenseSet<const VarDecl *> CUDADeviceVarODRUsedByHost;

  /// Keep track of CUDA/HIP external kernels or device variables ODR-used by
  /// host code. SetVector is used to maintain the order.
  toolchain::SetVector<const ValueDecl *> CUDAExternalDeviceDeclODRUsedByHost;

  /// Keep track of CUDA/HIP implicit host device functions used on device side
  /// in device compilation.
  toolchain::DenseSet<const FunctionDecl *> CUDAImplicitHostDeviceFunUsedByDevice;
  ...
  toolchain::DenseMap<CanQualType, SYCLKernelInfo> SYCLKernels;
  ...
  /// are stored here.
  toolchain::DenseMap<const CXXMethodDecl *, CXXCastPath> LambdaCastPaths;
...
public:
  ...
  /// the specified element type.
  QualType getConstantArrayType(QualType EltTy, const toolchain::APInt &ArySize,
  ...
  struct BuiltinVectorTypeInfo {
    ...
    toolchain::ElementCount EC;
    unsigned NumVectors;
    BuiltinVectorTypeInfo(QualType ElementType, toolchain::ElementCount EC,
                          unsigned NumVectors)
...
public:
  ...
  /// the given type T.
  bool isRepresentableIntegerValue(toolchain::APSInt &Value, QualType T);
  ...
  bool computeEnumBits(RangeT EnumConstants, unsigned &NumNegativeBits,
    ...
    for (auto *Elem : EnumConstants) {
      ...
      toolchain::APSInt InitVal = ECD->getInitVal();
...
#include "language/Core/Basic/BuiltinTemplates.inc"
  ...
  toolchain::FixedPointSemantics getFixedPointSemantics(QualType Ty) const;
  toolchain::APFixedPoint getFixedPointMax(QualType Ty) const;
  toolchain::APFixedPoint getFixedPointMin(QualType Ty) const;
...
public:
  ...
  /// point type.
  const toolchain::fltSemantics &getFloatTypeSemantics(QualType T) const;
...
public:
  ...
  toolchain::APSInt MakeIntValue(uint64_t Value, QualType Type) const {
    // If Type is a signed integer type larger than 64 bits, we need to be sure
    // to sign extend Res appropriately.
    toolchain::APSInt Res(64, !Type->isSignedIntegerOrEnumerationType());
    Res = Value;
  ...
  void getFunctionFeatureMap(toolchain::StringMap<bool> &FeatureMap,
...
private:
  ...
  using DeallocationFunctionsAndArguments =
      toolchain::SmallVector<std::pair<void (*)(void *), void *>, 16>;
  mutable DeallocationFunctionsAndArguments Deallocations;

  // FIXME: This currently contains the set of StoredDeclMaps used
  // by DeclContext objects.  This probably should not be in ASTContext,
  // but we include it here so that ASTContext can quickly deallocate them.
  toolchain::PointerIntPair<StoredDeclsMap *, 1> LastSDM;
...
public:
  ...
  toolchain::StringMap<SectionInfo> SectionInfos;
...
private:
  ...
  toolchain::DenseMap<GlobalDecl, toolchain::StringSet<>> ThunksToBeAbbreviated;
};
...
inline void *operator new(size_t Bytes, const language::Core::ASTContext &C,
                          size_t Alignment /* = 8 */) {
...
inline void operator delete(void *Ptr, const language::Core::ASTContext &C, size_t) {
  C.Deallocate(Ptr);
}
...
template <typename Owner, typename T,
          void (language::Core::ExternalASTSource::*Update)(Owner)>
typename language::Core::LazyGenerationalUpdatePtr<Owner, T, Update>::ValueType
    language::Core::LazyGenerationalUpdatePtr<Owner, T, Update>::makeValue(
        const language::Core::ASTContext &Ctx, T Value) {
...
#endif // LANGUAGE_CORE_AST_ASTCONTEXT_H
