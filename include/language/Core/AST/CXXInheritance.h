...
#ifndef LANGUAGE_CORE_AST_CXXINHERITANCE_H
#define LANGUAGE_CORE_AST_CXXINHERITANCE_H
...
class CXXBasePaths {
  ...
  toolchain::SmallDenseMap<QualType, IsVirtBaseAndNumberNonVirtBases, 8>
      ClassSubobjects;

  /// VisitedDependentRecords - Records the dependent records that have been
  /// already visited.
  toolchain::SmallPtrSet<const CXXRecordDecl *, 4> VisitedDependentRecords;
...
class OverridingMethods {
  ...
  using MapType = toolchain::MapVector<unsigned, ValuesT>;
...
class CXXFinalOverriderMap
  : public toolchain::MapVector<const CXXMethodDecl *, OverridingMethods> {};

/// A set of all the primary bases for a class.
class CXXIndirectPrimaryBaseSet
  : public toolchain::SmallSet<const CXXRecordDecl*, 32> {};
...
#endif // LANGUAGE_CORE_AST_CXXINHERITANCE_H
