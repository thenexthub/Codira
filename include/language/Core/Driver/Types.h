...
#ifndef LANGUAGE_CORE_DRIVER_TYPES_H
#define LANGUAGE_CORE_DRIVER_TYPES_H
...
#undef TYPE
  ...
  /// extension \p Ext.
  ID lookupTypeForExtension(toolchain::StringRef Ext);
  ...
  toolchain::SmallVector<phases::ID, phases::MaxNumberOfPhases>
  getCompilationPhases(const language::Core::driver::Driver &Driver,
