...
#ifndef LANGUAGE_CORE_DRIVER_MULTILIB_H
#define LANGUAGE_CORE_DRIVER_MULTILIB_H
...
public:
  ...
  using FilterCallback = toolchain::function_ref<bool(const Multilib &)>;
...
public:
  ...
  bool select(const Driver &D, const Multilib::flags_list &Flags,
              toolchain::SmallVectorImpl<Multilib> &,
              toolchain::SmallVector<StringRef> * = nullptr) const;
  ...
  toolchain::StringSet<> expandFlags(const Multilib::flags_list &) const;
  ...
  static toolchain::ErrorOr<MultilibSet>
  parseYaml(toolchain::MemoryBufferRef, toolchain::SourceMgr::DiagHandlerTy = nullptr,
...
#endif // LANGUAGE_CORE_DRIVER_MULTILIB_H
