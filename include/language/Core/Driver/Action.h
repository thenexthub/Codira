...
#ifndef LANGUAGE_CORE_DRIVER_ACTION_H
#define LANGUAGE_CORE_DRIVER_ACTION_H
...
public:
  ...
  using input_range = toolchain::iterator_range<input_iterator>;
  using input_const_range = toolchain::iterator_range<input_const_iterator>;
...
public:
  InputAction(const toolchain::opt::Arg &Input, types::ID Type,
...
public:
  ...
  using OffloadActionWorkTy =
      toolchain::function_ref<void(Action *, const ToolChain *, const char *)>;
...
#endif // LANGUAGE_CORE_DRIVER_ACTION_H
