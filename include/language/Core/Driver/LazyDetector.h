...
#ifndef LANGUAGE_CORE_DRIVER_LAZYDETECTOR_H
#define LANGUAGE_CORE_DRIVER_LAZYDETECTOR_H
...
public:
  LazyDetector(const driver::Driver &D, const toolchain::Triple &Triple,
               const toolchain::opt::ArgList &Args)
...
#endif // LANGUAGE_CORE_DRIVER_LAZYDETECTOR_H
