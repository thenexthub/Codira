...
#ifndef LANGUAGE_CORE_ANALYSIS_FLOWSENSITIVE_ASTOPS_H
#define LANGUAGE_CORE_ANALYSIS_FLOWSENSITIVE_ASTOPS_H
...
/// iteration order.
using FieldSet = toolchain::SmallSetVector<const FieldDecl *, 4>;
...
struct ReferencedDecls {
  ...
  /// necessarily called).
  toolchain::DenseSet<const FunctionDecl *> Functions;
  ...
  toolchain::DenseSet<const ParmVarDecl *> LambdaCapturedParams;
};
...
#endif // LANGUAGE_CORE_ANALYSIS_FLOWSENSITIVE_ASTOPS_H
