...
//
//===----------------------------------------------------------------------===//
#ifndef LANGUAGE_CORE_ANALYSIS_FLOWSENSITIVE__ARENA_H
#define LANGUAGE_CORE_ANALYSIS_FLOWSENSITIVE__ARENA_H
...
public:
  ...
  IntegerValue &makeIntLiteral(toolchain::APInt Value);
  ...
  toolchain::Expected<const Formula &> parseFormula(toolchain::StringRef);
...
private:
  ...
  toolchain::DenseMap<toolchain::APInt, IntegerValue *> IntegerLiterals;
  using FormulaPair = std::pair<const Formula *, const Formula *>;
  toolchain::DenseMap<FormulaPair, const Formula *> Ands;
  toolchain::DenseMap<FormulaPair, const Formula *> Ors;
  toolchain::DenseMap<const Formula *, const Formula *> Nots;
  toolchain::DenseMap<FormulaPair, const Formula *> Implies;
  toolchain::DenseMap<FormulaPair, const Formula *> Equals;
  toolchain::DenseMap<Atom, const Formula *> AtomRefs;

  toolchain::DenseMap<const Formula *, BoolValue *> FormulaValues;
  unsigned NextAtom = 0;
...
#endif // LANGUAGE_CORE_ANALYSIS_FLOWSENSITIVE__ARENA_H
