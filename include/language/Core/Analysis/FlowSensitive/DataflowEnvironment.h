...
#ifndef LANGUAGE_CORE_ANALYSIS_FLOWSENSITIVE_DATAFLOWENVIRONMENT_H
#define LANGUAGE_CORE_ANALYSIS_FLOWSENSITIVE_DATAFLOWENVIRONMENT_H
...
public:
  ...
  public:
    ...
    virtual std::optional<WidenResult> widen(QualType Type, Value &Prev,
      ...
      toolchain_unreachable("all cases in switch covered");
    }
  };
  ...
  /// `Value`
  IntegerValue &getIntLiteralValue(toolchain::APInt Value) const {
...
private:
  using PrValueToResultObject =
      toolchain::DenseMap<const Expr *, RecordStorageLocation *>;
  ...
  /// `Type`.
  void initializeFieldsWithValues(RecordStorageLocation &Loc, QualType Type,
                                  toolchain::DenseSet<QualType> &Visited, int Depth,
  ...
  // https://github.com/toolchain/toolchain-project/issues/59005
  ...
  toolchain::MapVector<const Expr *, Value *> ExprToVal;
  toolchain::MapVector<const StorageLocation *, Value *> LocToVal;
...
#endif // LANGUAGE_CORE_ANALYSIS_FLOWSENSITIVE_DATAFLOWENVIRONMENT_H
