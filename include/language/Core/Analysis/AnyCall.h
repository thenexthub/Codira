...
//===----------------------------------------------------------------------===//
//
#ifndef LANGUAGE_CORE_ANALYSIS_ANYCALL_H
#define LANGUAGE_CORE_ANALYSIS_ANYCALL_H
...
public:
  ...
  QualType getReturnType(ASTContext &Ctx) const {
    ...
    toolchain_unreachable("Unknown AnyCall::Kind");
  }
...
#endif // LANGUAGE_CORE_ANALYSIS_ANYCALL_H
