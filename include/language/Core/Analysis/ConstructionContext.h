...
#ifndef LANGUAGE_CORE_ANALYSIS_CONSTRUCTIONCONTEXT_H
#define LANGUAGE_CORE_ANALYSIS_CONSTRUCTIONCONTEXT_H
...
public:
  ...
  LLVM_DUMP_METHOD static StringRef getKindAsString(ItemKind K) {
    ...
    toolchain_unreachable("Unknown ItemKind");
  }
...
#endif // LANGUAGE_CORE_ANALYSIS_CONSTRUCTIONCONTEXT_H
