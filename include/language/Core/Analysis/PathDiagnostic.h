...
#ifndef LANGUAGE_CORE_ANALYSIS_PATHDIAGNOSTIC_H
#define LANGUAGE_CORE_ANALYSIS_PATHDIAGNOSTIC_H
...
public:
  class PDFileEntry : public toolchain::FoldingSetNode {
  public:
    PDFileEntry(toolchain::FoldingSetNodeID &NodeID) : NodeID(NodeID) {}
    ...
    const toolchain::FoldingSetNodeID NodeID;

    /// Used for profiling in the FoldingSet.
    void Profile(toolchain::FoldingSetNodeID &ID) { ID = NodeID; }
  };

  class FilesMade {
    toolchain::BumpPtrAllocator Alloc;
    toolchain::FoldingSet<PDFileEntry> Set;
...
protected:
  bool flushed = false;
  toolchain::FoldingSet<PathDiagnostic> Diags;
};
...
using LocationOrAnalysisDeclContext =
    toolchain::PointerUnion<const LocationContext *, AnalysisDeclContext *>;
...
class PathDiagnosticPiece: public toolchain::FoldingSetNode {
public:
...
public:
  ...
  virtual void Profile(toolchain::FoldingSetNodeID &ID) const;
...
class PathDiagnostic : public toolchain::FoldingSetNode {
...
public:
  ...
  /// different profiles.
  void FullProfile(toolchain::FoldingSetNodeID &ID) const;
};

} // namespace ento
} // namespace language::Core

#endif // LANGUAGE_CORE_ANALYSIS_PATHDIAGNOSTIC_H
