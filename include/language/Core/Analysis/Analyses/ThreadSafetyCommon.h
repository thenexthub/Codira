...
#ifndef LANGUAGE_CORE_ANALYSIS_ANALYSES_THREADSAFETYCOMMON_H
#define LANGUAGE_CORE_ANALYSIS_ANALYSES_THREADSAFETYCOMMON_H
...
#include "language/Core/Analysis/Analyses/ThreadSafetyTraverse.h"
...
private:
  ...
  toolchain::PointerIntPair<const til::SExpr *, 2, unsigned> CapExpr;
...
// Translate language::Core::Expr to til::SExpr.
class SExprBuilder {
public:
  ...
  struct CallingContext {
    ...
    toolchain::PointerUnion<const Expr *, til::SExpr *> SelfArg = nullptr;

    // Number of funArgs
    unsigned NumArgs = 0;

    // Function arguments
    toolchain::PointerUnion<const Expr *const *, til::SExpr *> FunArgs = nullptr;
...
private:
  ...
  using StatementMap = toolchain::DenseMap<const Stmt *, til::SExpr *>;

  // Map from clang local variables to indices in a LVarDefinitionMap.
  using LVarIndexMap = toolchain::DenseMap<const ValueDecl *, unsigned>;
...
#ifndef NDEBUG
// Dump an SCFG to toolchain::errs().
...
#endif // LANGUAGE_CORE_ANALYSIS_ANALYSES_THREADSAFETYCOMMON_H
