...
#ifndef LANGUAGE_CORE_ANALYSIS_ANALYSES_CONSUMED_H
#define LANGUAGE_CORE_ANALYSIS_ANALYSES_CONSUMED_H
...
namespace consumed {
  ...
  class ConsumedStateMap {
    using VarMapType = toolchain::DenseMap<const VarDecl *, ConsumedState>;
    using TmpMapType =
        toolchain::DenseMap<const CXXBindTemporaryExpr *, ConsumedState>;
...
#endif // LANGUAGE_CORE_ANALYSIS_ANALYSES_CONSUMED_H
