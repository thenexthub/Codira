...
#ifndef LANGUAGE_CORE_ANALYSIS_ANALYSES_THREADSAFETYTRAVERSE_H
#define LANGUAGE_CORE_ANALYSIS_ANALYSES_THREADSAFETYTRAVERSE_H
...
#endif // LANGUAGE_CORE_ANALYSIS_ANALYSES_THREADSAFETYTRAVERSE_H
