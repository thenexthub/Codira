...
#ifndef LANGUAGE_CORE_ANALYSIS_ANALYSES_INTERVALPARTITION_H
#define LANGUAGE_CORE_ANALYSIS_ANALYSES_INTERVALPARTITION_H
...
struct CFGIntervalNode {
  ...
  const toolchain::SmallDenseSet<const CFGIntervalNode *> &preds() const {
    return Predecessors;
  }
  const toolchain::SmallDenseSet<const CFGIntervalNode *> &succs() const {
    return Successors;
  }
  ...
  // interval.
  toolchain::SmallDenseSet<const CFGIntervalNode *> Predecessors;
  ...
  // interval.
  toolchain::SmallDenseSet<const CFGIntervalNode *> Successors;
};
...
#endif // LANGUAGE_CORE_ANALYSIS_ANALYSES_INTERVALPARTITION_H
