...
#ifndef LANGUAGE_CORE_ANALYSIS_ANALYSES_UNSAFEBUFFERUSAGE_H
#define LANGUAGE_CORE_ANALYSIS_ANALYSES_UNSAFEBUFFERUSAGE_H
...
private:
  using MapTy = toolchain::DenseMap<const VarDecl *, Kind>;
...
public:
  ...
  using FixItList = toolchain::SmallVectorImpl<FixItHint>;
...
bool anyConflict(const toolchain::SmallVectorImpl<FixItHint> &FixIts,
...
#endif /* LANGUAGE_CORE_ANALYSIS_ANALYSES_UNSAFEBUFFERUSAGE_H */
