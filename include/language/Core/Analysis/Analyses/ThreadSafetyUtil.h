...
#ifndef LANGUAGE_CORE_ANALYSIS_ANALYSES_THREADSAFETYUTIL_H
#define LANGUAGE_CORE_ANALYSIS_ANALYSES_THREADSAFETYUTIL_H
...
public:
  ...
  MemRegionRef(toolchain::BumpPtrAllocator *A) : Allocator(A) {}
...
private:
  toolchain::BumpPtrAllocator *Allocator = nullptr;
};
...
inline void *operator new(size_t Sz,
                          language::Core::threadSafety::til::MemRegionRef &R) {
...
public:
  ...
  toolchain::iterator_range<reverse_iterator> reverse() {
    return toolchain::reverse(*this);
  }

  toolchain::iterator_range<const_reverse_iterator> reverse() const {
    return toolchain::reverse(*this);
  }
...
#endif // LANGUAGE_CORE_ANALYSIS_ANALYSES_THREADSAFETYUTIL_H
