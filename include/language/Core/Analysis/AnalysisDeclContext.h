...
#ifndef LANGUAGE_CORE_ANALYSIS_ANALYSISDECLCONTEXT_H
#define LANGUAGE_CORE_ANALYSIS_ANALYSISDECLCONTEXT_H
...
class AnalysisDeclContext {
  ...
  toolchain::DenseMap<const BlockDecl *, void *> *ReferencedBlockVars = nullptr;
...
public:
  ...
  toolchain::iterator_range<referenced_decls_iterator>
...
class LocationContext : public toolchain::FoldingSetNode {
public:
...
public:
  ...
  virtual void Profile(toolchain::FoldingSetNodeID &ID) = 0;
  ...
  static void ProfileCommon(toolchain::FoldingSetNodeID &ID, ContextKind ck,
                            AnalysisDeclContext *ctx,
...
public:
  ...
  static void Profile(toolchain::FoldingSetNodeID &ID, AnalysisDeclContext *ADC,
...
class LocationContextManager {
  toolchain::FoldingSet<LocationContext> Contexts;
...
class AnalysisDeclContextManager {
  using ContextMap =
      toolchain::DenseMap<const Decl *, std::unique_ptr<AnalysisDeclContext>>;
...
#endif // LANGUAGE_CORE_ANALYSIS_ANALYSISDECLCONTEXT_H
