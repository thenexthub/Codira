...
#ifndef LANGUAGE_CORE_ANALYSIS_CFG_H
#define LANGUAGE_CORE_ANALYSIS_CFG_H

#include "language/Core/AST/Attr.h"
#include "language/Core/AST/ExprCXX.h"
#include "language/Core/AST/ExprObjC.h"
#include "language/Core/Analysis/ConstructionContext.h"
...
protected:
  ...
  toolchain::PointerIntPair<void *, 2> Data1;
  toolchain::PointerIntPair<void *, 2> Data2;
...
public:
  ...
  void dumpToStream(toolchain::raw_ostream &OS,
...
private:
  ...
  toolchain::PointerIntPair<Stmt *, KindBits> Data;
...
class CFGBlock {
  ...
  public:
    ...
    void dumpToStream(toolchain::raw_ostream &OS) const {
...
public:
  ...
  class AdjacentBlock {
    ...
    toolchain::PointerIntPair<CFGBlock *, 2> UnreachableBlock;
...
public:
  ...
  using ref_iterator_range = toolchain::iterator_range<ref_iterator>;
  using const_ref_iterator = ElementRefIterator<false, true>;
  using const_ref_iterator_range = toolchain::iterator_range<const_ref_iterator>;

  using reverse_ref_iterator = ElementRefIterator<true, false>;
  using reverse_ref_iterator_range = toolchain::iterator_range<reverse_ref_iterator>;

  using const_reverse_ref_iterator = ElementRefIterator<true, true>;
  using const_reverse_ref_iterator_range =
      toolchain::iterator_range<const_reverse_ref_iterator>;
  ...
  using pred_range = toolchain::iterator_range<pred_iterator>;
  using pred_const_range = toolchain::iterator_range<const_pred_iterator>;
  ...
  using succ_range = toolchain::iterator_range<succ_iterator>;
  using succ_const_range = toolchain::iterator_range<const_succ_iterator>;
...
public:
  ...
  public:
    using ForcedBlkExprs = toolchain::DenseMap<const Stmt *, const CFGBlock *>;
  ...
  toolchain::iterator_range<iterator> nodes() { return {begin(), end()}; }
  toolchain::iterator_range<const_iterator> const_nodes() const {
    return {begin(), end()};
  }
  ...
  toolchain::iterator_range<reverse_iterator> reverse_nodes() {
    return {rbegin(), rend()};
  }
  toolchain::iterator_range<const_reverse_iterator> const_reverse_nodes() const {
    return {rbegin(), rend()};
  }
  ...
  using try_block_range = toolchain::iterator_range<try_block_iterator>;
  ...
  using synthetic_stmt_iterator =
      toolchain::DenseMap<const DeclStmt *, const DeclStmt *>::const_iterator;
  using synthetic_stmt_range = toolchain::iterator_range<synthetic_stmt_iterator>;
  ...
  toolchain::BumpPtrAllocator& getAllocator() {
...
private:
  ...
  /// source DeclStmt.
  toolchain::DenseMap<const DeclStmt *, const DeclStmt *> SyntheticDeclStmts;
};
...
template <> struct simplify_type< ::language::Core::CFGTerminator> {
  using SimpleType = ::language::Core::Stmt *;

  static SimpleType getSimplifiedValue(::language::Core::CFGTerminator Val) {
    return Val.getStmt();
  }
};
...
template <> struct GraphTraits< ::language::Core::CFGBlock *> {
  using NodeRef = ::language::Core::CFGBlock *;
  using ChildIteratorType = ::language::Core::CFGBlock::succ_iterator;

  static NodeRef getEntryNode(::language::Core::CFGBlock *BB) { return BB; }
  static ChildIteratorType child_begin(NodeRef N) { return N->succ_begin(); }
  static ChildIteratorType child_end(NodeRef N) { return N->succ_end(); }
};

template <> struct GraphTraits< const ::language::Core::CFGBlock *> {
  using NodeRef = const ::language::Core::CFGBlock *;
  using ChildIteratorType = ::language::Core::CFGBlock::const_succ_iterator;

  static NodeRef getEntryNode(const language::Core::CFGBlock *BB) { return BB; }
  static ChildIteratorType child_begin(NodeRef N) { return N->succ_begin(); }
  static ChildIteratorType child_end(NodeRef N) { return N->succ_end(); }
};

template <> struct GraphTraits<Inverse< ::language::Core::CFGBlock *>> {
  using NodeRef = ::language::Core::CFGBlock *;
  using ChildIteratorType = ::language::Core::CFGBlock::const_pred_iterator;

  static NodeRef getEntryNode(Inverse<::language::Core::CFGBlock *> G) {
    return G.Graph;
  }
...
template <> struct GraphTraits<Inverse<const ::language::Core::CFGBlock *>> {
  using NodeRef = const ::language::Core::CFGBlock *;
  using ChildIteratorType = ::language::Core::CFGBlock::const_pred_iterator;

  static NodeRef getEntryNode(Inverse<const ::language::Core::CFGBlock *> G) {
    return G.Graph;
  }
...
template <> struct GraphTraits< ::language::Core::CFG* >
    : public GraphTraits< ::language::Core::CFGBlock *>  {
  using nodes_iterator = ::language::Core::CFG::iterator;

  static NodeRef getEntryNode(::language::Core::CFG *F) { return &F->getEntry(); }
  static nodes_iterator nodes_begin(::language::Core::CFG* F) { return F->nodes_begin();}
  static nodes_iterator   nodes_end(::language::Core::CFG* F) { return F->nodes_end(); }
  static unsigned              size(::language::Core::CFG* F) { return F->size(); }
};

template <> struct GraphTraits<const ::language::Core::CFG* >
    : public GraphTraits<const ::language::Core::CFGBlock *>  {
  using nodes_iterator = ::language::Core::CFG::const_iterator;

  static NodeRef getEntryNode(const ::language::Core::CFG *F) { return &F->getEntry(); }
  ...
  static unsigned size(const ::language::Core::CFG* F) {
    return F->size();
  }
};

template <> struct GraphTraits<Inverse< ::language::Core::CFG *>>
  : public GraphTraits<Inverse< ::language::Core::CFGBlock *>> {
  using nodes_iterator = ::language::Core::CFG::iterator;

  static NodeRef getEntryNode(::language::Core::CFG *F) { return &F->getExit(); }
  static nodes_iterator nodes_begin( ::language::Core::CFG* F) {return F->nodes_begin();}
  static nodes_iterator nodes_end( ::language::Core::CFG* F) { return F->nodes_end(); }
};

template <> struct GraphTraits<Inverse<const ::language::Core::CFG *>>
  : public GraphTraits<Inverse<const ::language::Core::CFGBlock *>> {
  using nodes_iterator = ::language::Core::CFG::const_iterator;

  static NodeRef getEntryNode(const ::language::Core::CFG *F) { return &F->getExit(); }
...
#endif // LANGUAGE_CORE_ANALYSIS_CFG_H
