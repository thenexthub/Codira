...
#ifndef LANGUAGE_CORE_ANALYSIS_RETAINSUMMARYMANAGER_H
#define LANGUAGE_CORE_ANALYSIS_RETAINSUMMARYMANAGER_H
...
/// its arguments.
typedef toolchain::ImmutableMap<unsigned, ArgEffect> ArgEffects;
...
class ObjCSummaryCache {
  typedef toolchain::DenseMap<ObjCSummaryKey, const RetainSummary *> MapTy;
  MapTy M;
public:
  ObjCSummaryCache() {}
...
class RetainSummaryManager {
  typedef toolchain::DenseMap<const FunctionDecl*, const RetainSummary *>
          FuncSummariesTy;

  typedef ObjCSummaryCache ObjCMethodSummariesTy;

  typedef toolchain::FoldingSetNodeWrapper<RetainSummary> CachedSummaryNode;
  ...
  /// effects.
  toolchain::FoldingSet<CachedSummaryNode> SimpleSummaries;
