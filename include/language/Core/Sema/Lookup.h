...
#ifndef LANGUAGE_CORE_SEMA_LOOKUP_H
#define LANGUAGE_CORE_SEMA_LOOKUP_H
...
private:
  ...
  toolchain::MapVector<NamedDecl*, NamedDecl*> Decls;
...
public:
  ...
  using iterator =
      toolchain::mapped_iterator<decltype(Decls)::iterator, select_second>;
...
#endif // LANGUAGE_CORE_SEMA_LOOKUP_H
