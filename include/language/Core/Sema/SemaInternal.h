...
#ifndef LANGUAGE_CORE_SEMA_SEMAINTERNAL_H
#define LANGUAGE_CORE_SEMA_SEMAINTERNAL_H
...
class TypoCorrectionConsumer : public VisibleDeclConsumer {
  ...
  typedef toolchain::StringMap<TypoResultList> TypoResultsMap;
...
public:
  ...
  void
  addNamespaces(const toolchain::MapVector<NamespaceDecl *, bool> &KnownNamespaces);
