...
#ifndef LANGUAGE_CORE_SEMA_SCOPE_H
#define LANGUAGE_CORE_SEMA_SCOPE_H
...
private:
  ...
  using DeclSetTy = toolchain::SmallPtrSet<Decl *, 32>;
  ...
  toolchain::SmallPtrSet<VarDecl *, 8> ReturnSlots;
...
public:
  ...
  using decl_range = toolchain::iterator_range<DeclSetTy::iterator>;
  ...
  using using_directives_range =
      toolchain::iterator_range<UsingDirectivesTy::iterator>;
...
#endif // LANGUAGE_CORE_SEMA_SCOPE_H
