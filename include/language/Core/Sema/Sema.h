...
#ifndef LANGUAGE_CORE_SEMA_SEMA_H
#define LANGUAGE_CORE_SEMA_SEMA_H
...
typedef std::pair<toolchain::PointerUnion<const TemplateTypeParmType *, NamedDecl *>,
                  SourceLocation>
...
class FileNullabilityMap {
  ...
  toolchain::DenseMap<FileID, FileNullability> Map;
...
public:
  ...
  void enterFunctionArgument(SourceLocation Tok,
                             toolchain::function_ref<QualType()> ComputeType);
...
public:
  ...
  typedef toolchain::SmallVector<DeleteExprLoc, 4> DeleteLocs;
  /// Retrieves list of suspicious delete-expressions that will be checked at
  /// the end of translation unit.
  const toolchain::MapVector<FieldDecl *, DeleteLocs> &
  ...
  /// The maximum alignment, same as in toolchain::Value. We duplicate them here
  /// because that allows us not to duplicate the constants in clang code,
  /// which we must to since we can't directly use the toolchain constants.
  /// The value is verified against toolchain here: lib/CodeGen/CGDecl.cpp
  ///
  ...
  toolchain::BumpPtrAllocator BumpAlloc;
...
public:
  ...
  AccessResult CheckBaseClassAccess(
      ...
      toolchain::function_ref<void(PartialDiagnostic &PD)> SetupPDiag,
...
public:
  ...
  template <typename ValueType> struct PragmaStack {
    struct Slot {
      toolchain::StringRef StackSlotLabel;
      ValueType Value;
      SourceLocation PragmaLocation;
      SourceLocation PragmaPushLocation;
      Slot(toolchain::StringRef StackSlotLabel, ValueType Value,
    ...
    void Act(SourceLocation PragmaLocation, PragmaMsStackAction Action,
             toolchain::StringRef StackSlotLabel, ValueType Value) {
      if (Action == PSK_Reset) {
      ...
      if (Action & PSK_Push)
        ...
        if (!StackSlotLabel.empty()) {
          ...
          auto I = toolchain::find_if(toolchain::reverse(Stack), [&](const Slot &x) {
  ...
  toolchain::StringMap<std::tuple<StringRef, SourceLocation>> FunctionToSectionMap;
  ...
  toolchain::SmallSetVector<StringRef, 4> MSFunctionNoBuiltins;
  ...
  /// Add [[language::Core:::lifetimebound]] attr for std:: functions and methods.
  void inferLifetimeBoundAttribute(FunctionDecl *FD);

  /// Add [[language::Core:::lifetime_capture_by(this)]] to STL container methods.
  ...
  LifetimeCaptureByAttr *ParseLifetimeCaptureByAttr(const ParsedAttr &AL,
                                                    StringRef ParamName);
  // Processes the argument 'X' in [[language::Core::lifetime_capture_by(X)]]. Since 'X'
  ...
  void ActOnPragmaMSSeg(SourceLocation PragmaLocation,
                        PragmaMsStackAction Action,
                        toolchain::StringRef StackSlotLabel,
                        StringLiteral *SegmentName, toolchain::StringRef PragmaName);
  ...
  using InstantiationContextDiagFuncRef =
      toolchain::function_ref<void(SourceLocation, PartialDiagnostic)>;
  ...
  ActOnPragmaMSFunction(SourceLocation Loc,
                        const toolchain::SmallVectorImpl<StringRef> &NoBuiltins);
  ...
  void ActOnPragmaFEnvRound(SourceLocation Loc, toolchain::RoundingMode);
...
public:
  ...
  bool BuiltinConstantArg(CallExpr *TheCall, int ArgNum, toolchain::APSInt &Result);
...
private:
  ...
  std::unique_ptr<toolchain::DenseMap<TypeTagMagicValue, TypeTagData>>
...
public:
  ...
  // with [[language::Core::coro_wrapper]] if it returns a type marked with
  // [[language::Core::coro_return_type]].
...
public:
  ...
  toolchain::SmallPtrSet<const NamedDecl *, 4> TypoCorrectedFunctionDefinitions;

  /// A cache of the flags available in enumerations with the flag_bits
  /// attribute.
  mutable toolchain::DenseMap<const EnumDecl *, toolchain::APInt> FlagBitsCache;
  ...
  toolchain::MapVector<
      IdentifierInfo *,
      toolchain::SetVector<
          WeakInfo, toolchain::SmallVector<WeakInfo, 1u>,
          toolchain::SmallDenseSet<WeakInfo, 2u, WeakInfo::DenseMapInfoByAliasOnly>>>
  ...
  toolchain::DenseMap<IdentifierInfo *, AsmLabelAttr *> ExtnameUndeclaredIdentifiers;

  /// Set containing all typedefs that are likely unused.
  toolchain::SmallSetVector<const TypedefNameDecl *, 4>
  ...
  public:
    ...
    TemplateNameKind getTemplateNameKind() const {
      ...
      default:
        toolchain_unreachable("unsupported name classification.");
      }
    }
  };
  ...
  CheckCXX2CRelocatableAndReplaceable(const language::Core::CXXRecordDecl *D);
  ...
  typedef toolchain::function_ref<void(SourceLocation Loc, PartialDiagnostic PD)>
      DiagReceiverTy;
  ...
  toolchain::SmallPtrSet<const Decl *, 4> ParsingInitForAutoVars;
  ...
  bool IsValueInFlagEnum(const EnumDecl *ED, const toolchain::APInt &Val,
  ...
  toolchain::SmallSetVector<Decl *, 4> DeclsToCheckForDeferredDiags;

private:
  /// Map of current shadowing declarations to shadowed declarations. Warn if
  /// it looks like the user is trying to modify the shadowing declaration.
  toolchain::DenseMap<const NamedDecl *, const NamedDecl *> ShadowingDecls;
...
public:
  ...
  bool checkUInt32Argument(const AttrInfo &AI, const Expr *Expr, uint32_t &Val,
    ...
    std::optional<toolchain::APSInt> I = toolchain::APSInt(32);
  ...
  toolchain::Error isValidSectionSpecifier(StringRef Str);
  ...
  bool checkFunctionOrMethodParameterIndex(
    ...
    std::optional<toolchain::APSInt> IdxInt;
...
public:
  ...
  class ImplicitExceptionSpecification {
    ...
    toolchain::SmallPtrSet<CanQualType, 4> ExceptionsSeen;
  ...
  void MarkVirtualBaseDestructorsReferenced(
      ...
      toolchain::SmallPtrSetImpl<const CXXRecordDecl *> *DirectVirtualBases =
          nullptr);
  ...
  /// by code generation).
  toolchain::DenseMap<CXXRecordDecl *, bool> VTablesUsed;
  ...
  unsigned ActOnReenterTemplateScope(Decl *Template,
                                     toolchain::function_ref<Scope *()> EnterScope);
  ...
  public:
    DefaultedFunctionKind()
        : SpecialMember(toolchain::to_underlying(CXXSpecialMemberKind::Invalid)),
          Comparison(toolchain::to_underlying(DefaultedComparisonKind::None)) {}
    DefaultedFunctionKind(CXXSpecialMemberKind CSM)
        : SpecialMember(toolchain::to_underlying(CSM)),
          Comparison(toolchain::to_underlying(DefaultedComparisonKind::None)) {}
    DefaultedFunctionKind(DefaultedComparisonKind Comp)
        : SpecialMember(toolchain::to_underlying(CXXSpecialMemberKind::Invalid)),
          Comparison(toolchain::to_underlying(Comp)) {}
    ...
    unsigned getDiagnosticIndex() const {
      static_assert(toolchain::to_underlying(CXXSpecialMemberKind::Invalid) >
                        toolchain::to_underlying(CXXSpecialMemberKind::Destructor),
  ...
  typedef toolchain::SmallSetVector<const NamedDecl *, 16> NamedDeclSetType;
  /// Set containing all declared private fields that are not used.
  NamedDeclSetType UnusedPrivateFields;

  typedef toolchain::SmallPtrSet<const CXXRecordDecl *, 8> RecordDeclSetTy;
  ...
  // argument locations.
  toolchain::DenseMap<ParmVarDecl *, SourceLocation> UnparsedDefaultArgLocs;

  /// UndefinedInternals - all the used, undefined objects which require a
  /// definition in this translation unit.
  toolchain::MapVector<NamedDecl *, SourceLocation> UndefinedButUsed;

  typedef toolchain::PointerIntPair<CXXRecordDecl *, 3, CXXSpecialMemberKind>
      SpecialMemberDecl;

  /// The C++ special members which we are currently in the process of
  /// declaring. If this process recursively triggers the declaration of the
  /// same special member, we should act as if it is not yet declared.
  toolchain::SmallPtrSet<SpecialMemberDecl, 4> SpecialMembersBeingDeclared;
...
private:
  ...
  toolchain::SmallBitVector FullyCheckedComparisonCategories;
...
public:
  ...
  using MaybeODRUseExprSet = toolchain::SmallSetVector<Expr *, 4>;
  MaybeODRUseExprSet MaybeODRUseExprs;

  using ImmediateInvocationCandidate = toolchain::PointerIntPair<ConstantExpr *, 1>;
  ...
  struct ExpressionEvaluationContextRecord {
    ...
    toolchain::SmallPtrSet<const Expr *, 8> PossibleDerefs;
    ...
    toolchain::SmallVector<ImmediateInvocationCandidate, 4>
        ImmediateInvocationCandidates;

    /// Set of DeclRefExprs referencing a consteval function when used in a
    /// context not already known to be immediately invoked.
    toolchain::SmallPtrSet<DeclRefExpr *, 4> ReferenceToConsteval;
  ...
  /// assignment.
  toolchain::DenseMap<const VarDecl *, int> RefsMinusAssignments;
  ...
  ExprResult
  VerifyIntegerConstantExpression(Expr *E, toolchain::APSInt *Result,
  ...
  VerifyIntegerConstantExpression(Expr *E, toolchain::APSInt *Result,
                                  ...
                                  AllowFoldKind CanFold = AllowFoldKind::No);
  ExprResult
  VerifyIntegerConstantExpression(Expr *E, toolchain::APSInt *Result = nullptr,
                                  AllowFoldKind CanFold = AllowFoldKind::No);
  ExprResult
  ...
  InnermostDeclarationWithDelayedImmediateInvocations() const {
    assert(!ExprEvalContexts.empty() &&
           "Must be in an expression evaluation context");
    for (const auto &Ctx : toolchain::reverse(ExprEvalContexts)) {
  ...
  OutermostDeclarationWithDelayedImmediateInvocations() const {
    ...
    for (auto &Ctx : toolchain::reverse(ExprEvalContexts)) {
      if (Ctx.Context == ExpressionEvaluationContext::PotentiallyEvaluated &&
  ...
  toolchain::SmallPtrSet<ConstantExpr *, 4> FailedImmediateInvocations;

  /// List of SourceLocations where 'self' is implicitly retained inside a
  /// block.
  toolchain::SmallVector<std::pair<SourceLocation, const BlockDecl *>, 1>
...
public:
  ...
  toolchain::MapVector<FieldDecl *, DeleteLocs> DeleteExprs;
...
public:
  ...
  toolchain::SmallVector<QualType, 4> CurrentParameterCopyTypes;

  toolchain::DenseMap<unsigned, CXXDeductionGuideDecl *>
...
public:
  ...
  typedef toolchain::SmallSet<SourceLocation, 2> SrcLocSet;
  typedef toolchain::DenseMap<IdentifierInfo *, SrcLocSet> IdentifierSourceLocations;
  ...
  private:
    toolchain::PointerIntPair<CXXMethodDecl *, 2> Pair;
  ...
  class SpecialMemberOverloadResultEntry : public toolchain::FastFoldingSetNode,
                                           public SpecialMemberOverloadResult {
  public:
    SpecialMemberOverloadResultEntry(const toolchain::FoldingSetNodeID &ID)
        : FastFoldingSetNode(ID) {}
  };

  /// A cache of special member function overload resolution results
  /// for C++ records.
  toolchain::FoldingSet<SpecialMemberOverloadResultEntry> SpecialMemberCache;

  enum class AcceptableKind { Visible, Reachable };

  // Members have to be NamespaceDecl* or TranslationUnitDecl*.
  // TODO: make this is a typesafe union.
  typedef toolchain::SmallSetVector<DeclContext *, 16> AssociatedNamespaceSet;
  typedef toolchain::SmallSetVector<CXXRecordDecl *, 16> AssociatedClassSet;
  ...
  toolchain::DenseSet<Module *> &getLookupModules();
...
private:
  ...
  toolchain::MapVector<NamespaceDecl *, bool> KnownNamespaces;
  ...
  toolchain::DenseSet<const Module *> UsableModuleUnitsCache;
...
private:
  ...
  language::Core::Module *TheImplicitGlobalModuleFragment = nullptr;

  /// Namespace definitions that we will export when they finish.
  toolchain::SmallPtrSet<const NamespaceDecl *, 8> DeferredExportedNamespaces;
  ...
  toolchain::SmallPtrSet<const FunctionDecl *, 8> PendingInlineFuncDecls;
  ...
  toolchain::SmallVector<std::pair<FunctionDecl *, SourceLocation>>
...
public:
  ...
  ExprResult CheckConvertedConstantExpression(Expr *From, QualType T,
                                              toolchain::APSInt &Value, CCEKind CCE);
  ExprResult CheckConvertedConstantExpression(Expr *From, QualType T,
...
public:
  ...
  void FillInlineAsmIdentifierInfo(Expr *Res,
                                   toolchain::InlineAsmIdentifierInfo &Info);
...
public:
  ...
  ArrayRef<InventedTemplateParameterInfo> getInventedParameterInfos() const {
    return toolchain::ArrayRef(InventedParameterInfos.begin() +
  ...
  ArrayRef<sema::FunctionScopeInfo *> getFunctionScopes() const {
    return toolchain::ArrayRef(FunctionScopes.begin() + FunctionScopesStart,
                          FunctionScopes.end());
  }

  typedef toolchain::MapVector<const FunctionDecl *,
...
public:
  ...
  typedef toolchain::DenseMap<Decl *, SmallVector<PartialDiagnosticAt, 1>>
  ...
  TemplateDeductionResult FinishTemplateArgumentDeduction(
      ...
      toolchain::function_ref<bool(bool)> CheckNonDependent =
          [](bool /*OnlyInitializeNonUserDefinedConversions*/) {
            return false;
          });
  ...
  TemplateDeductionResult DeduceTemplateArguments(
      ...
      Expr::Classification ObjectClassification,
      bool ForOverloadSetAddressResolution,
      toolchain::function_ref<bool(ArrayRef<QualType>, bool)> CheckNonDependent);
  ...
  void MarkUsedTemplateParameters(const Expr *E, bool OnlyDeduced,
                                  unsigned Depth, toolchain::SmallBitVector &Used);
  ...
  MarkDeducedTemplateParameters(const FunctionTemplateDecl *FunctionTemplate,
                                toolchain::SmallBitVector &Deduced) {
...
public:
  ...
  typedef toolchain::DenseMap<ParmVarDecl *, toolchain::TinyPtrVector<ParmVarDecl *>>
  ...
  toolchain::DenseSet<std::pair<Decl *, unsigned>> InstantiatingSpecializations;

  /// Non-dependent types used in templates that have already been instantiated
  /// by some template instantiation.
  toolchain::DenseSet<QualType> InstantiatedNonDependentTypes;
  ...
  toolchain::DenseSet<Module *> LookupModulesCache;

  /// Map from the most recent declaration of a namespace to the most
  /// recent visible declaration of that namespace.
  toolchain::DenseMap<NamedDecl *, NamedDecl *> VisibleNamespaceCache;
  ...
  using EntityPrinter = toolchain::function_ref<void(toolchain::raw_ostream &)>;
...
public:
  ...
  UnsignedOrNone getNumArgumentsInExpansionFromUnexpanded(
      toolchain::ArrayRef<UnexpandedParameterPack> Unexpanded,
      const MultiLevelTemplateArgumentList &TemplateArgs);
...
public:
  void PushSatisfactionStackEntry(const NamedDecl *D,
                                  const toolchain::FoldingSetNodeID &ID) {
  ...
  bool SatisfactionStackContains(const NamedDecl *D,
                                 const toolchain::FoldingSetNodeID &ID) const {
    const NamedDecl *Can = cast<NamedDecl>(D->getCanonicalDecl());
    return toolchain::is_contained(SatisfactionStack,
                              SatisfactionStackEntryTy{Can, ID});
  }

  using SatisfactionStackEntryTy =
      std::pair<const NamedDecl *, toolchain::FoldingSetNodeID>;
  ...
  class SatisfactionStackResetRAII {
    toolchain::SmallVector<SatisfactionStackEntryTy, 10> BackupSatisfactionStack;
    Sema &SemaRef;
  ...
  void SwapSatisfactionStack(
      toolchain::SmallVectorImpl<SatisfactionStackEntryTy> &NewSS) {
  ...
  bool CheckConstraintSatisfaction(
    ...
    toolchain::SmallVector<Expr *, 4> Converted;
  ...
  bool CheckConstraintSatisfaction(
      const NamedDecl *Template,
      ArrayRef<AssociatedConstraint> AssociatedConstraints,
      toolchain::SmallVectorImpl<Expr *> &ConvertedConstraints,
...
private:
  ...
  toolchain::DenseMap<std::pair<const NamedDecl *, const NamedDecl *>, bool>
      SubsumptionCache;
  /// Caches the normalized associated constraints of declarations (concepts or
  /// constrained declarations). If an error occurred while normalizing the
  /// associated constraints of the template or concept, nullptr will be cached
  /// here.
  toolchain::DenseMap<const NamedDecl *, NormalizedConstraint *> NormalizationCache;

  toolchain::ContextualFoldingSet<ConstraintSatisfaction, const ASTContext &>
      SatisfactionCache;

  // The current stack of constraint satisfactions, so we can exit-early.
  toolchain::SmallVector<SatisfactionStackEntryTy, 10> SatisfactionStack;
