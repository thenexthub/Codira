...
#ifndef LANGUAGE_CORE_SEMA_DECLSPEC_H
#define LANGUAGE_CORE_SEMA_DECLSPEC_H
...
public:
  ...
  static const TSCS TSCS_unspecified = language::Core::TSCS_unspecified;
  static const TSCS TSCS___thread = language::Core::TSCS___thread;
  static const TSCS TSCS_thread_local = language::Core::TSCS_thread_local;
  static const TSCS TSCS__Thread_local = language::Core::TSCS__Thread_local;
  ...
  static const TST TST_unspecified = language::Core::TST_unspecified;
  static const TST TST_void = language::Core::TST_void;
  static const TST TST_char = language::Core::TST_char;
  static const TST TST_wchar = language::Core::TST_wchar;
  static const TST TST_char8 = language::Core::TST_char8;
  static const TST TST_char16 = language::Core::TST_char16;
  static const TST TST_char32 = language::Core::TST_char32;
  static const TST TST_int = language::Core::TST_int;
  static const TST TST_int128 = language::Core::TST_int128;
  static const TST TST_bitint = language::Core::TST_bitint;
  static const TST TST_half = language::Core::TST_half;
  static const TST TST_BFloat16 = language::Core::TST_BFloat16;
  static const TST TST_float = language::Core::TST_float;
  static const TST TST_double = language::Core::TST_double;
  static const TST TST_float16 = language::Core::TST_Float16;
  static const TST TST_accum = language::Core::TST_Accum;
  static const TST TST_fract = language::Core::TST_Fract;
  static const TST TST_float128 = language::Core::TST_float128;
  static const TST TST_ibm128 = language::Core::TST_ibm128;
  static const TST TST_bool = language::Core::TST_bool;
  static const TST TST_decimal32 = language::Core::TST_decimal32;
  static const TST TST_decimal64 = language::Core::TST_decimal64;
  static const TST TST_decimal128 = language::Core::TST_decimal128;
  static const TST TST_enum = language::Core::TST_enum;
  static const TST TST_union = language::Core::TST_union;
  static const TST TST_struct = language::Core::TST_struct;
  static const TST TST_interface = language::Core::TST_interface;
  static const TST TST_class = language::Core::TST_class;
  static const TST TST_typename = language::Core::TST_typename;
  static const TST TST_typeofType = language::Core::TST_typeofType;
  static const TST TST_typeofExpr = language::Core::TST_typeofExpr;
  static const TST TST_typeof_unqualType = language::Core::TST_typeof_unqualType;
  static const TST TST_typeof_unqualExpr = language::Core::TST_typeof_unqualExpr;
  static const TST TST_decltype = language::Core::TST_decltype;
  static const TST TST_decltype_auto = language::Core::TST_decltype_auto;
  static const TST TST_typename_pack_indexing =
      language::Core::TST_typename_pack_indexing;
#define TRANSFORM_TYPE_TRAIT_DEF(_, Trait)                                     \
  static const TST TST_##Trait = language::Core::TST_##Trait;
#include "language/Core/Basic/TransformTypeTraits.def"
  static const TST TST_auto = language::Core::TST_auto;
  static const TST TST_auto_type = language::Core::TST_auto_type;
  static const TST TST_unknown_anytype = language::Core::TST_unknown_anytype;
  static const TST TST_atomic = language::Core::TST_atomic;
#define GENERIC_IMAGE_TYPE(ImgType, Id) \
  static const TST TST_##ImgType##_t = language::Core::TST_##ImgType##_t;
#include "language/Core/Basic/OpenCLImageTypes.def"
#define HLSL_INTANGIBLE_TYPE(Name, Id, SingletonId)                            \
  static const TST TST_##Name = language::Core::TST_##Name;
#include "language/Core/Basic/HLSLIntangibleTypes.def"
  static const TST TST_error = language::Core::TST_error;
...
#include "language/Core/Basic/TransformTypeTraits.def"
  ...
  void forEachCVRUQualifier(
      toolchain::function_ref<void(TQ, StringRef, SourceLocation)> Handle);
...
struct DeclaratorChunk {
  ...
  struct FunctionTypeInfo {
    ...
    ArrayRef<NamedDecl *> getDeclsInPrototype() const {
      assert(ExceptionSpecType == EST_None);
      return toolchain::ArrayRef(DeclsInPrototype, NumExceptionsOrDecls);
    }
...
public:
  ...
  void clear() {
    ...
    if (DeleteBindings)
      ...
      for (Binding &B : toolchain::MutableArrayRef(Bindings, NumBindings))
        B.Attrs.reset();
    Bindings = nullptr;
    NumBindings = 0;
  ...
  ArrayRef<Binding> bindings() const {
    return toolchain::ArrayRef(Bindings, NumBindings);
  }
...
public:
  ...
  Declarator(const DeclSpec &DS, const ParsedAttributesView &DeclarationAttrs,
    ...
    assert(toolchain::all_of(DeclarationAttrs,
                        [](const ParsedAttr &AL) {
  ...
  bool mayOmitIdentifier() const {
    ...
    toolchain_unreachable("unknown context kind!");
  }
  ...
  typedef toolchain::iterator_range<type_object_iterator> type_object_range;
  ...
  bool isFunctionDeclarator(unsigned& idx) const {
    for (unsigned i = 0, i_end = DeclTypeInfo.size(); i < i_end; ++i) {
      ...
      toolchain_unreachable("Invalid type chunk");
    }
    return false;
  }
...
#endif // LANGUAGE_CORE_SEMA_DECLSPEC_H
