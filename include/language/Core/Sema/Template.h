...
#ifndef LANGUAGE_CORE_SEMA_TEMPLATE_H
#define LANGUAGE_CORE_SEMA_TEMPLATE_H
...
enum class TemplateSubstitutionKind : char {
  ...
  public:
    ...
    LLVM_DUMP_METHOD void dump() const {
      ...
      toolchain::errs() << "NumRetainedOuterLevels: " << NumRetainedOuterLevels
                   << "\n";
      for (unsigned Depth = NumRetainedOuterLevels; Depth < getNumLevels();
           ++Depth) {
        toolchain::errs() << Depth << ": ";
  ...
  private:
    ...
    using LocalDeclsMap =
        toolchain::SmallDenseMap<const Decl *,
                            toolchain::PointerUnion<Decl *, DeclArgumentPack *>, 4>;
  ...
  public:
    ...
    LocalInstantiationScope *cloneScopes(LocalInstantiationScope *Outermost) {
      ...
      for (LocalDeclsMap::iterator I = LocalDecls.begin(), E = LocalDecls.end();
        ...
        toolchain::PointerUnion<Decl *, DeclArgumentPack *> &Stored =
    ...
    /// returns NULL.
    toolchain::PointerUnion<Decl *, DeclArgumentPack *> *
...
#endif // LANGUAGE_CORE_SEMA_TEMPLATE_H
