...
#ifndef LANGUAGE_CORE_SEMA_SEMAOBJC_H
#define LANGUAGE_CORE_SEMA_SEMAOBJC_H
...
public:
  ...
  /// of -Wselector.
  toolchain::MapVector<Selector, SourceLocation> ReferencedSelectors;

  using GlobalMethodPool =
      toolchain::DenseMap<Selector, std::pair<ObjCMethodList, ObjCMethodList>>;
  ...
  typedef toolchain::SmallPtrSet<Selector, 8> SelectorSet;
...
public:
  ...
  ExprResult
  ActOnObjCAvailabilityCheckExpr(toolchain::ArrayRef<AvailabilitySpec> AvailSpecs,
...
#endif // LANGUAGE_CORE_SEMA_SEMAOBJC_H
