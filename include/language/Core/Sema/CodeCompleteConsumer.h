...
#ifndef LANGUAGE_CORE_SEMA_CODECOMPLETECONSUMER_H
#define LANGUAGE_CORE_SEMA_CODECOMPLETECONSUMER_H
...
public:
  ...
  using VisitedContextSet = toolchain::SmallPtrSet<DeclContext *, 8>;
...
toolchain::StringRef getCompletionKindString(CodeCompletionContext::Kind Kind);
...
class CodeCompletionAllocator : public toolchain::BumpPtrAllocator {
public:
...
class CodeCompletionTUInfo {
  toolchain::DenseMap<const DeclContext *, StringRef> ParentNames;
...
#endif // LANGUAGE_CORE_SEMA_CODECOMPLETECONSUMER_H
