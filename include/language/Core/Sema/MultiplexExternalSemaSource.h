...
//
//===----------------------------------------------------------------------===//
#ifndef LANGUAGE_CORE_SEMA_MULTIPLEXEXTERNALSEMASOURCE_H
#define LANGUAGE_CORE_SEMA_MULTIPLEXEXTERNALSEMASOURCE_H
...
private:
  SmallVector<toolchain::IntrusiveRefCntPtr<ExternalSemaSource>, 2> Sources;
...
public:
  ...
  ///
  MultiplexExternalSemaSource(toolchain::IntrusiveRefCntPtr<ExternalSemaSource> S1,
  ...
  ///
  void AddSource(toolchain::IntrusiveRefCntPtr<ExternalSemaSource> Source);
