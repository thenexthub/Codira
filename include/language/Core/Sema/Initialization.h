...
#ifndef LANGUAGE_CORE_SEMA_INITIALIZATION_H
#define LANGUAGE_CORE_SEMA_INITIALIZATION_H
...
private:
  ...
  union {
    ...
    toolchain::PointerIntPair<ParmVarDecl *, 1> Parameter;
    ...
    /// virtual base.
    toolchain::PointerIntPair<const CXXBaseSpecifier *, 1> Base;
...
public:
  ...
  using step_range = toolchain::iterator_range<step_iterator>;
...
#endif // LANGUAGE_CORE_SEMA_INITIALIZATION_H
