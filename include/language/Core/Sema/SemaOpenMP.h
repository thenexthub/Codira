...
#ifndef LANGUAGE_CORE_SEMA_SEMAOPENMP_H
#define LANGUAGE_CORE_SEMA_SEMAOPENMP_H
...
public:
  ...
  struct DeclareTargetContextInfo {
    ...
    toolchain::DenseMap<NamedDecl *, MapInfo> ExplicitlyMapped;
  ...
  using VarsWithInheritedDSAType =
      toolchain::SmallDenseMap<const ValueDecl *, const Expr *, 4>;
  ...
  OMPClause *ActOnOpenMPDefaultClause(toolchain::omp::DefaultKind Kind,
                                      SourceLocation KindLoc,
                                      SourceLocation StartLoc,
                                      SourceLocation LParenLoc,
                                      SourceLocation EndLoc);
  /// Called on well-formed 'proc_bind' clause.
  OMPClause *ActOnOpenMPProcBindClause(toolchain::omp::ProcBindKind Kind,
                                       SourceLocation KindLoc,
                                       SourceLocation StartLoc,
                                       SourceLocation LParenLoc,
                                       SourceLocation EndLoc);
  ...
  OMPClause *ActOnOpenMPDirectivePresenceClause(
      OpenMPClauseKind CK, toolchain::ArrayRef<OpenMPDirectiveKind> DKVec,
...
#endif // LANGUAGE_CORE_SEMA_SEMAOPENMP_H
