...
//
/// \file
/// Defines the classes language::Core::DelayedDiagnostic and
/// language::Core::AccessedEntity.
///
...
#ifndef LANGUAGE_CORE_SEMA_DELAYEDDIAGNOSTIC_H
#define LANGUAGE_CORE_SEMA_DELAYEDDIAGNOSTIC_H
...
public:
  ...
  ArrayRef<SourceLocation> getAvailabilitySelectorLocs() const {
    assert(Kind == Availability && "Not an availability diagnostic.");
    return toolchain::ArrayRef(AvailabilityData.SelectorLocs,
...
#endif // LANGUAGE_CORE_SEMA_DELAYEDDIAGNOSTIC_H
