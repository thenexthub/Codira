...
#ifndef LANGUAGE_CORE_SEMA_OVERLOAD_H
#define LANGUAGE_CORE_SEMA_OVERLOAD_H
...
class Sema;
  ...
  public:
    ...
    unsigned getKindRank() const {
      ...
      toolchain_unreachable("Invalid ImplicitConversionSequence::Kind!");
    }
  ...
  using ConversionSequenceList =
      toolchain::MutableArrayRef<ImplicitConversionSequence>;
  ...
  private:
    ...
    OverloadCandidate()
        : IsSurrogate(false), IgnoreObjectArgument(false),
          ...
          IsADLCandidate(toolchain::to_underlying(CallExpr::NotADL)),
  ...
  private:
    ...
    toolchain::SmallPtrSet<uintptr_t, 16> Functions;
    ...
    toolchain::BumpPtrAllocator SlabAllocator;
  ...
  public:
    ...
    toolchain::MutableArrayRef<Expr *> getPersistentArgsArray(unsigned N) {
      Expr **Exprs = slabAllocate<Expr *>(N);
      return toolchain::MutableArrayRef<Expr *>(Exprs, N);
    }

    template <typename... T>
    toolchain::MutableArrayRef<Expr *> getPersistentArgsArray(T *...Exprs) {
      toolchain::MutableArrayRef<Expr *> Arr =
          getPersistentArgsArray(sizeof...(Exprs));
      toolchain::copy(std::initializer_list<Expr *>{Exprs...}, Arr.data());
      return Arr;
    }
...
#endif // LANGUAGE_CORE_SEMA_OVERLOAD_H
