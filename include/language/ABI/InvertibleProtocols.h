...
#ifndef LANGUAGE_ABI_INVERTIBLEPROTOCOLS_H
#define LANGUAGE_ABI_INVERTIBLEPROTOCOLS_H
...
#include "language/ABI/InvertibleProtocols.def"
  ...
  ///
  /// This can occur when an older Codira runtime is working with metadata
  /// or mangled names generated by a newer compiler that has introduced
  /// another kind of invertible protocol. The Codira runtime will need to
...
#endif // LANGUAGE_ABI_INVERTIBLEPROTOCOLS_H
