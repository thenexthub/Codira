...
#define ALL_FUNCTIONS(macro)                                                   \
  macro(language_retain, 1)                                                       \
  macro(language_release, 0)                                                      \
  macro(language_bridgeObjectRetain, 1)                                           \
  macro(language_bridgeObjectRelease, 0)
...
#define MAKE_CALL_FUNC(reg, fn)                                              \
  static inline void call_##fn##_x##reg(void **regs) {                       \
    PASS_REGS                                                                  \
    asm("bl _" #fn "_x" #reg : : REG_INPUTS "i"(0));                         \
  }
