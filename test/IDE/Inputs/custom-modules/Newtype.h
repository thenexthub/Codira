...
typedef struct T *TRef __attribute((language_newtype(struct)));
typedef const struct T *ConstTRef __attribute((language_newtype(struct)));
...
extern void mutate_TRef_Pointee(_Null_unspecified TRef) __attribute((language_name("TRef.mutatePointee(self:)")));
extern void mutate_TRef(_Null_unspecified TRef * _Null_unspecified) __attribute((language_name("TRef.mutate(self:)")));
extern void use_ConstT(_Null_unspecified ConstTRef)
    __attribute((language_name("ConstTRef.use(self:)")));

typedef struct T *_Nonnull *TRefRef __attribute((language_newtype(struct)));
...
extern void mutate_TRefRef_Pointee(_Null_unspecified TRefRef)
    __attribute((language_name("TRefRef.mutatePointee(self:)")));
extern void mutate_TRefRef(_Null_unspecified TRefRef* _Null_unspecified)
    __attribute((language_name("TRefRef.mutate(self:)")));
extern void use_ConstTRef(_Null_unspecified ConstTRefRef)
    __attribute((language_name("ConstTRefRef.use(self:)")));

typedef NSString *MyString __attribute__((__language_newtype__(struct)));
