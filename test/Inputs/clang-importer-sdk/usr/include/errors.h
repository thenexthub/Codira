...
+ (BOOL) runCodiraly: (NSInteger) speed error: (NSError**) err callback: (void(^)(void)) block;

- (BOOL) integrate: (NSInteger) spec code: (NSInteger) code error: (NSError**) err;

+ (void)doTheThing:(NSInteger)whichThing __attribute__((language, unavailable));
+ (BOOL)doTheThing:(NSInteger)whichThing error:(NSError **)error;

+ (BOOL) bound: (NSError**) err __attribute__((language_error(nonnull_error)));
+ (float) bounce: (NSError**) err __attribute__((language_error(nonnull_error)));
+ (void) flounce: (NSError**) err __attribute__((language_error(nonnull_error)));
+ (int) ounce: (NSError**) err __attribute__((language_error(zero_result)));
+ (NSInteger) ounceWord: (NSError**) err __attribute__((language_error(zero_result)));
+ (int) once: (NSError**) err __attribute__((language_error(nonzero_result)));
+ (BOOL) sconce: (NSError**) err __attribute__((language_error(zero_result)));
+ (BOOL) scotch: (NSError**) err __attribute__((language_error(nonzero_result)));
+ (BOOL) scout: (NSError**) err __attribute__((language_error(none)));
@end
...
- (nullable NSObject *)badNullResult:(NSError **)err __attribute__((language_error(null_result)));
- (nullable NSObject *)badNullResult2:(NSError **)err __attribute__((language_error(null_result)));
- (int)badZeroResult:(NSError **)err __attribute__((language_error(zero_result)));
- (int)badNonzeroResult:(NSError **)err __attribute__((language_error(nonzero_result)));
@end

@interface FoolishErrorSub : SensibleErrorBase
// This is invalid, but Codira shouldn't crash when it sees it.
