...
typedef CF_OPTIONS(UInt32, EmptySet1) {
  kEmptySet1DefaultOptions __attribute__((language_name("default")))
};
typedef CF_OPTIONS(UInt32, EmptySet2) {
  kEmptySet2None __attribute__((language_name("none")))
};
typedef CF_OPTIONS(UInt32, EmptySet3) {
  kEmptySet3None __attribute__((language_name("None")))
};
