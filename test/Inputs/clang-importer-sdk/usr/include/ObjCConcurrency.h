...
#define UI_ACTOR __attribute__((language_attr("@UIActor")))

#ifdef __LANGUAGE_ATTR_SUPPORTS_SENDABLE_DECLS
  #define SENDABLE __attribute__((__language_attr__("@Sendable")))
  #define NONSENDABLE __attribute__((__language_attr__("@_nonSendable")))
  #define ASSUME_NONSENDABLE_BEGIN _Pragma("clang attribute ASSUME_NONSENDABLE.push (__attribute__((language_attr(\"@_nonSendable(_assumed)\"))), apply_to = any(objc_interface, record, enum))")
...
#define NS_STRING_ENUM __attribute((language_newtype(enum)))
#define NS_EXTENSIBLE_STRING_ENUM __attribute__((language_wrapper(struct)))
...
-(void)findAnswerAsynchronously:(void (^)(NSString *_Nullable, NSError * _Nullable))handler __attribute__((language_name("findAnswer(completionHandler:)")));
-(BOOL)findAnswerFailinglyWithError:(NSError * _Nullable * _Nullable)error completion:(void (^)(NSString *_Nullable, NSError * _Nullable))handler __attribute__((language_name("findAnswerFailingly(completionHandler:)")));
...
-(void)findMultipleAnswersWithCompletionHandler:(void (^)(NSString *_Nullable, NSInteger, NSError * _Nullable))handler __attribute__((language_name("findMultipleAnswers(completionHandler:)")));

-(void)findDifferentlyFlavoredBooleansWithCompletionHandler:(void (^)(BOOL wholeMilk, _Bool onePercent, NSError *_Nullable))handler __attribute__((language_name("findDifferentlyFlavoredBooleans(completionHandler:)")));
...
-(void)poorlyNamed:(NSString *)operation completionHandler:(void (^)(NSInteger))handler __attribute__((language_async_name("bestName(_:)")));

-(void)customizedWithString:(NSString *)operation completionHandler:(void (^)(NSInteger))handler __attribute__((language_name("customize(with:completionHandler:)"))) __attribute__((language_async_name("customize(_:)")));

-(void)unavailableMethod __attribute__((__language_attr__("@_unavailableFromAsync")));
-(void)unavailableMethodWithMessage __attribute__((__language_attr__("@_unavailableFromAsync(message: \"Blarpy!\")")));

-(void)dance:(NSString *)step andThen:(void (^)(NSString *))doSomething __attribute__((language_async(not_language_private,2)));
-(void)leap:(NSInteger)height andThen:(void (^)(NSString *))doSomething __attribute__((language_async(language_private,2)));

-(void)repeatTrick:(NSString *)trick completionHandler:(void (^)(NSInteger))handler __attribute__((language_async(none)));
...
// rdar://72604599
- (void)stopRecordingWithHandler:(nullable void (^)(NSObject *_Nullable_result x, NSError *_Nullable error))handler __attribute__((language_async_name("stopRecording()"))) __attribute__((language_async(not_language_private, 1)));
...
-(void)doSomethingFlaggyWithCompletionHandler:(void (^)(BOOL, NSString *_Nullable, NSError *_Nullable))completionHandler __attribute__((language_async_error(nonzero_argument, 1)));
-(void)doSomethingZeroFlaggyWithCompletionHandler:(void (^)(NSString *_Nullable, BOOL, NSError *_Nullable))completionHandler __attribute__((language_async_error(zero_argument, 2)));
-(void)doSomethingMultiResultFlaggyWithCompletionHandler:(void (^)(BOOL, NSString *_Nullable, NSError *_Nullable, NSString *_Nullable))completionHandler __attribute__((language_async_error(zero_argument, 1)));

-(void)runOnMainThreadWithCompletionHandler:(MAIN_ACTOR void (^ _Nullable)(NSString *))completion;

// Both would be imported as the same decl - require language_async(none) on one
-(void)asyncImportSame:(NSString *)operation completionHandler:(void (^)(NSInteger))handler;
-(void)asyncImportSame:(NSString *)operation replyTo:(void (^)(NSInteger))handler __attribute__((language_async(none)));
...
@protocol ProtocolWithCodiraAttributes
-(void)independentMethod __attribute__((__language_attr__("@actorIndependent")));
-(void)nonisolatedMethod __attribute__((__language_attr__("nonisolated")));
-(void)mainActorMethod __attribute__((__language_attr__("@MainActor")));
-(void)uiActorMethod __attribute__((__language_attr__("@UIActor")));

@optional
-(void)missingAtAttributeMethod __attribute__((__language_attr__("MainActor")));
@end
...
__attribute__((__language_attr__("@MainActor")))
...
void doSomethingConcurrentlyButUnsafe(__attribute__((noescape)) __attribute__((language_attr("@Sendable"))) void (^block)(void));


MAIN_ACTOR MAIN_ACTOR __attribute__((__language_attr__("@MainActor"))) @protocol TripleMainActor
@end

@protocol ProtocolWithAsync
- (void)protocolMethodWithCompletionHandler:(void (^)(void))completionHandler;
- (void)customAsyncNameProtocolMethodWithCompletionHandler:(void (^)(void))completionHandler __attribute__((language_async_name("customAsyncName()")));
@end

@interface ClassWithAsync: NSObject <ProtocolWithAsync>
- (void)instanceMethodWithCompletionHandler:(void (^)(void))completionHandler __attribute__((language_async_name("instanceAsync()")));
@end
...
// expected-warning@-3 {{cannot make error code type 'NonSendableErrorCode' non-Sendable because Codira errors are always sendable}}
...
SENDABLE id StructWithSendableContentsGetSendableComputed(struct StructWithSendableContents contents)
  __attribute__((language_name("getter:StructWithSendableContents.sendableComputed(self:)")));
