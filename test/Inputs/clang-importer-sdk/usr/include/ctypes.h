...
// Names from MacTypes.h that conflict with language's library types.
// rdar://14175675
...
// Struct with an __attribute((language_name)) field.
struct Rdar86069786 {
    double c_name __attribute__((language_name("languageName")));
};
...
// Functions that get Codira types which cannot be used to re-derive the
// Clang type.
...
typedef double real_t __attribute__((availability(language,unavailable,message="use double")));
