...
typedef NS_ENUM(NSInteger, NSPrefixWordBreakCustom) {
  PrefixWordBreakProblemCase __attribute__((language_name("problemCase"))),
  NSPrefixWordBreakDeprecatedGoodCase __attribute__((deprecated)),
};

typedef NS_ENUM(NSInteger, NSPrefixWordBreak2Custom) {
  PrefixWordBreak2ProblemCase __attribute__((language_name("problemCase"))),
...
typedef NS_ENUM(NSInteger, NSPrefixWordBreakReversedCustom) {
  ...
  PrefixWordBreakReversedProblemCase __attribute__((language_name("problemCase"))),
};

typedef NS_ENUM(NSInteger, NSPrefixWordBreakReorderedCustom) {
  PrefixWordBreakReorderedProblemCase __attribute__((language_name("problemCase"))),
...
typedef NS_ENUM(NSInteger, NSPrefixWordBreakReordered2Custom) {
  ...
  PrefixWordBreakReordered2ProblemCase __attribute__((language_name("problemCase"))),
...
typedef NS_ENUM(NSInteger, NSCodiraNameAllTheThings) {
  NSCodiraNameAllTheThingsA __attribute__((language_name("Foo"))),
  NSCodiraNameAllTheThingsB __attribute__((language_name("Bar"))),
};

typedef NS_ENUM(NSInteger, NSCodiraNameBad) {
  NSCodiraNameBadA __attribute__((language_name("class"))),
};
...
typedef NS_ENUM(NSUInteger, NSXMLNodeKind) {
  ...
  NSXMLCommentKind,
  NSXMLTextKind,
  NSXMLDTDKind __attribute__((language_name("DTDKind"))),
...
typedef NS_OPTIONS(NSUInteger, NSOptionsAlsoGetCodiraName) {
  ThisIsAnNSOptionsCaseWithCodiraName __attribute__((language_name("Case"))) = 0x1
};

#define CF_LANGUAGE_UNAVAILABLE(_msg) __attribute__((availability(language, unavailable, message=_msg)))
#define NS_LANGUAGE_UNAVAILABLE(_msg) CF_LANGUAGE_UNAVAILABLE(_msg)
...
typedef NS_ENUM(NSUInteger, NSRectEdge) {
  ...
  NSMinXEdge NS_LANGUAGE_UNAVAILABLE("Use NSRectEdge.MinX instead") = NSRectEdgeMinX,
  NSMinYEdge NS_LANGUAGE_UNAVAILABLE("Use NSRectEdge.MinY instead") = NSRectEdgeMinY,
  NSMaxXEdge __attribute__((availability(language, unavailable, message="Use NSRectEdge.MaxX instead"))) = NSRectEdgeMaxX,
  NSMaxYEdge __attribute__((availability(language, unavailable, message="Use NSRectEdge.MaxY instead"))) = NSRectEdgeMaxY,
};
...
NS_LANGUAGE_UNAVAILABLE("NSInvocation and related APIs not available")
...
@property (readonly) Class classForPortCoder NS_LANGUAGE_UNAVAILABLE("Use NSXPCConnection instead");
@end
...
NS_LANGUAGE_UNAVAILABLE("Use NSXPCConnection instead")
...
@end
NS_LANGUAGE_UNAVAILABLE("Use NSCalendar and NSDateComponents and NSDateFormatter instead")
...
extern void NSSetZoneName(NSZone *_Nonnull zone, NSString *_Nonnull name)
    NS_LANGUAGE_UNAVAILABLE("Zone-based memory management is unavailable");
extern NSString *NSZoneName(NSZone *zone) NS_LANGUAGE_UNAVAILABLE("Zone-based memory management is unavailable");
extern NSZone *NSCreateZone(NSUInteger startSize, NSUInteger granularity, BOOL canFree) NS_LANGUAGE_UNAVAILABLE("Zone-based memory management is unavailable");
...
static const NSClothingStyle NSClothingStyleOfficeCasual __attribute__((availability(language,unavailable,replacement="NSClothingStyleSemiFormal"))) = NSClothingStyleSemiFormal;
...
typedef enum __attribute__((ns_error_domain(NSLaundryErrorDomain))) __attribute__((language_name("NSLaundromat.Error"))) NSLaundryErrorCode {
