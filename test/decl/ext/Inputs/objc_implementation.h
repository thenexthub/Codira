...
@interface ObjCClass (CodiraNameTests)

- (void)methodObjCName1 __attribute__((language_name("methodCodiraName1()")));
- (void)methodObjCName2 __attribute__((language_name("methodCodiraName2()")));
- (void)methodObjCName3 __attribute__((language_name("methodCodiraName3()")));
- (void)methodObjCName4 __attribute__((language_name("methodCodiraName4()")));
- (void)methodObjCName5 __attribute__((language_name("methodCodiraName5()")));
- (void)methodObjCName6A __attribute__((language_name("methodCodiraName6A()")));
- (void)methodObjCName6B __attribute__((language_name("methodCodiraName6B()")));

@end

@interface ObjCClass (AmbiguousMethods)

- (void)ambiguousMethod1WithCInt:(int)param  __attribute__((language_name("ambiguousMethod1(with:)")));
- (void)ambiguousMethod1WithCChar:(char)param  __attribute__((language_name("ambiguousMethod1(with:)")));

- (void)ambiguousMethod2WithCInt:(int)param  __attribute__((language_name("ambiguousMethod2(with:)")));
- (void)ambiguousMethod2WithCChar:(char)param  __attribute__((language_name("ambiguousMethod2(with:)")));

- (void)ambiguousMethod3WithCInt:(int)param  __attribute__((language_name("ambiguousMethod3(with:)")));
- (void)ambiguousMethod3WithCChar:(char)param  __attribute__((language_name("ambiguousMethod3(with:)")));

- (void)ambiguousMethod4WithCInt:(int)param  __attribute__((language_name("ambiguousMethod4(with:)")));
...
- (void)doSomethingOverloaded __attribute__((__language_attr__("@_unavailableFromAsync(message: \"Use async doSomethingOverloaded instead.\")")));
...
- (int)doSomethingThatCanFailWithWeirdReturnCodeWithError:(NSError **)error __attribute__((language_error(nonzero_result)));
...
@interface ObjCClassWithWeirdCodiraAttributeCombo : ObjCBaseClass
...
void CImplFuncRenamed_C(int param) __attribute__((language_name("CImplFuncRenamed_Codira(arg:)")));
...
int CImplGetComputedGlobal1(void) __attribute__((language_name("getter:cImplComputedGlobal1()")));
void CImplSetComputedGlobal1(int param) __attribute__((language_name("setter:cImplComputedGlobal1(newValue:)")));

typedef struct CImplStruct {} CImplStruct;

void CImplStructStaticFunc1(int param) __attribute__((language_name("CImplStruct.staticFunc1(_:)")));
