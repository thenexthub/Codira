; RUN: %language -target x86_64-apple-darwin10 -emit-object %s
...
define languagecc i64 @"$s11TestBitcode3add1x1yS2i_SitF"(i64, i64) #0 {
entry:
  %2 = call { i64, i1 } @toolchain.sadd.with.overflow.i64(i64 %0, i64 %1)
...
declare { i64, i1 } @toolchain.sadd.with.overflow.i64(i64, i64) #1

declare void @toolchain.trap() #2
...
!toolchain.module.flags = !{!0, !1, !2, !3, !4, !5, !6, !7}
!toolchain.linker.options = !{!8, !9, !10}
...
!7 = !{i32 1, !"Codira Version", i32 6}
!8 = !{!"-llanguageCodiraOnoneSupport"}
!9 = !{!"-llanguageCore"}
!10 = !{!"-lobjc"}
