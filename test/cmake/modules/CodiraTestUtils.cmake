# CodiraTestUtils.cmake
#
# Utility functions for Codira testing targets

# Get the possible build flavors for testing
function(get_language_test_build_flavors build_flavors_out_var sdk)
...
function(get_language_test_variant_suffix variant_suffix_out_var sdk arch build_flavor)
  if(build_flavor STREQUAL "ios-like")
    set(variant_suffix "-${LANGUAGE_SDK_${sdk}_LIB_SUBDIR}-maccatalyst-${arch}")
  else()
...
function(get_language_test_versioned_target_triple variant_triple_out_var sdk arch build_flavor)
  if(build_flavor STREQUAL "ios-like")
    ...
    get_versioned_target_triple(variant_triple ${sdk} ${arch} "${LANGUAGE_SDK_${sdk}_DEPLOYMENT_VERSION}")
  endif()
