...
+ (StrangeSelectors *):(int)x b:(int)y __attribute__((language_name("init(a:b:)")));
- (void):(int)x;
- (void):(int)x :(int)y __attribute__((language_name("empty(_:_:)")));
@end
...
@interface SubclassWithCodiraPrivateDesignatedInit : SuperclassWithDesignatedInitInCategory
...
__attribute__((language_attr("@_hasMissingDesignatedInitializers")))
