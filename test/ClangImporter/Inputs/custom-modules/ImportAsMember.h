...
extern struct IAMStruct1 IAMStruct1CreateFull(double x, double y, double z)
    __attribute__((language_name("Struct1.init(x:y:z:)")));
...
typedef int MNInnerInt __attribute__((language_name("IAMMultipleNested.Inner")));
typedef float MNInnerFloat __attribute__((language_name("IAMMultipleNested.Inner")));

typedef int IAMBadInnerInt
    __attribute__((language_name("IAMNonexistent.Inner")));
