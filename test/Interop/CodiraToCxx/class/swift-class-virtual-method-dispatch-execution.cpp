...
// RUN: %target-interop-build-language %S/language-class-virtual-method-dispatch.code -o %t/language-class-execution -Xlinker %t/language-class-execution.o -module-name Class -Xfrontend -entry-point-function-name -Xfrontend languageMain
