...
// RUN: %target-interop-build-language %S/generic-struct-in-cxx.code -D KNOWN_LAYOUT -D INDIRECT_KNOWN_LAYOUT -o %t/language-generics-execution -Xlinker %t/language-generics-execution.o -module-name Generics -Xfrontend -entry-point-function-name -Xfrontend languageMain
