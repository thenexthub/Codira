...
// FRT or LANGUAGE_SHARED_REFERENCE type
struct FRTStruct {
...
__attribute__((language_attr("retain:retainFRTStruct")))
__attribute__((language_attr("release:releaseFRTStruct")));

// Retain function for the FRT or LANGUAGE_SHARED_REFERENCE type FRTStruct
void retainFRTStruct(FRTStruct *_Nonnull b) {}

// Release function for the FRT or LANGUAGE_SHARED_REFERENCE type FRTStruct
...
// language_attr("returns_retained") or LANGUAGE_RETURNS_RETAINED
...
// Global/free C++ functions returning FRT with attribute
// language_attr("returns_unretained") or LANGUAGE_RETURNS_UNRETAINED
...
// language_attr("returns_unretained") and language_attr("returns_retained")
FRTStruct
    *_Nonnull global_function_returning_FRT_with_both_attrs_returns_retained_returns_unretained() // expected-error {{'global_function_returning_FRT_with_both_attrs_returns_retained_returns_unretained' cannot be annotated with both LANGUAGE_RETURNS_RETAINED and LANGUAGE_RETURNS_UNRETAINED}}
        __attribute__((language_attr("returns_retained")))
        __attribute__((language_attr("returns_unretained")));
...
struct
  ...
  static FRTStruct *_Nonnull StaticMethodReturningFRT() // expected-error {{'StaticMethodReturningFRT' cannot be annotated with both LANGUAGE_RETURNS_RETAINED and LANGUAGE_RETURNS_UNRETAINED}}
      __attribute__((language_attr("returns_retained")))
      __attribute__((language_attr("returns_unretained")));
};

// A c++ struct not annotated with LANGUAGE_SHARED_REFERENCE,
// LANGUAGE_IMMORTAL_REFERENCE or LANGUAGE_UNSAFE_REFERENCE
struct NonFRTStruct {};

// A c++ struct annotated with LANGUAGE_IMMORTAL_REFERENCE
struct ImmortalRefStruct {
} __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:immortal")))
__attribute__((language_attr("release:immortal")));

// A c++ struct annotated with LANGUAGE_UNSAFE_REFERENCE
...
struct StructWithAPIsReturningNonCxxFrt {
  ...
  static NonFRTStruct *_Nonnull StaticMethodReturningNonCxxFrtWithAnnotation() // expected-error {{'StaticMethodReturningNonCxxFrtWithAnnotation' cannot be annotated with either LANGUAGE_RETURNS_RETAINED or LANGUAGE_RETURNS_UNRETAINED because it is not returning a LANGUAGE_SHARED_REFERENCE type}}
      __attribute__((language_attr("returns_retained")));
};

NonFRTStruct *_Nonnull global_function_returning_non_cxx_frt();
NonFRTStruct *_Nonnull global_function_returning_non_cxx_frt_with_annotations() // expected-error {{'global_function_returning_non_cxx_frt_with_annotations' cannot be annotated with either LANGUAGE_RETURNS_RETAINED or LANGUAGE_RETURNS_UNRETAINED because it is not returning a LANGUAGE_SHARED_REFERENCE type}}
    __attribute__((language_attr("returns_retained")));

// C++ APIs returning LANGUAGE_IMMORTAL_REFERENCE types (for testing diagnostics)
struct StructWithAPIsReturningImmortalReference {
  ...
  static ImmortalRefStruct
      *_Nonnull StaticMethodReturningImmortalReferenceWithAnnotation() // expected-error {{'StaticMethodReturningImmortalReferenceWithAnnotation' cannot be annotated with either LANGUAGE_RETURNS_RETAINED or LANGUAGE_RETURNS_UNRETAINED because it is not returning a LANGUAGE_SHARED_REFERENCE type}}
          __attribute__((language_attr("returns_retained")));
};

ImmortalRefStruct *_Nonnull global_function_returning_immortal_reference();
ImmortalRefStruct
    *_Nonnull global_function_returning_immortal_reference_with_annotations() // expected-error {{'global_function_returning_immortal_reference_with_annotations' cannot be annotated with either LANGUAGE_RETURNS_RETAINED or LANGUAGE_RETURNS_UNRETAINED because it is not returning a LANGUAGE_SHARED_REFERENCE type}}
        __attribute__((language_attr("returns_retained")));

// C++ APIs returning LANGUAGE_UNSAFE_REFERENCE types (for testing diagnostics)
struct StructWithAPIsReturningUnsafeReference {
  ...
  static UnsafeRefStruct
      *_Nonnull StaticMethodReturningUnsafeReferenceWithAnnotation() // expected-error {{'StaticMethodReturningUnsafeReferenceWithAnnotation' cannot be annotated with either LANGUAGE_RETURNS_RETAINED or LANGUAGE_RETURNS_UNRETAINED because it is not returning a LANGUAGE_SHARED_REFERENCE type}}
          __attribute__((language_attr("returns_retained")));
};

UnsafeRefStruct *_Nonnull global_function_returning_unsafe_reference();
UnsafeRefStruct
    *_Nonnull global_function_returning_unsafe_reference_with_annotations() // expected-error {{'global_function_returning_unsafe_reference_with_annotations' cannot be annotated with either LANGUAGE_RETURNS_RETAINED or LANGUAGE_RETURNS_UNRETAINED because it is not returning a LANGUAGE_SHARED_REFERENCE type}}
        __attribute__((language_attr("returns_retained")));
...
FRTStruct
    *_Nonnull global_templated_function_returning_FRT_with_attr_returns_retained(
        T a) __attribute__((language_attr("returns_retained")));
...
FRTStruct
    *_Nonnull global_templated_function_returning_FRT_with_attr_returns_unretained(
        T a) __attribute__((language_attr("returns_unretained")));
...
__attribute__((language_attr("retain:retain_FRTOverloadedOperators")))
__attribute__((language_attr(
    "release:release_FRTOverloadedOperators"))) FRTOverloadedOperators {

public:
  FRTOverloadedOperators *_Nonnull
  operator+(const FRTOverloadedOperators &other) // expected-warning {{LANGUAGE_RETURNS_RETAINED and LANGUAGE_RETURNS_UNRETAINED is not supported yet for overloaded C++ 'operator+'. Overloaded C++ operators always return LANGUAGE_SHARED_REFERENCE types as owned}}
      __attribute__((language_attr("returns_unretained")));
  FRTOverloadedOperators *_Nonnull
...
using FunctionVoidToFRTStruct =
    std::function<FRTStruct *_Nonnull(void)> __attribute__((
        language_attr("returns_retained")));
...
struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:defRetain2")))
__attribute__((language_attr("release:defRelease2"))) 
__attribute__((language_attr("returned_as_unretained_by_default"))) RefTyDefUnretained {};
...
struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:defaultRetain1")))
__attribute__((language_attr("release:defaultRelease1")))
__attribute__((language_attr("returned_as_unretained_by_default"))) RefTyDefUnretained {};
...
struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:rretain")))
__attribute__((language_attr("release:rrelease"))) RefType {};

RefType *returnRefType() { return new RefType(); }

struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:dretain")))
__attribute__((language_attr("release:drelease"))) 
__attribute__((language_attr("returned_as_unretained_by_default"))) RefTyDefUnretained {};
...
struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:baseRetain")))
__attribute__((language_attr("release:baseRelease")))
__attribute__((language_attr("returned_as_unretained_by_default"))) BaseType {};

struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:derivedRetain")))
__attribute__((language_attr("release:derivedRelease"))) DerivedType
    : public BaseType {};

struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:derivedRetain2")))
__attribute__((language_attr("release:derivedRelease2"))) DerivedType2
    : public DerivedType {};
...
struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:bRetain")))
__attribute__((language_attr("release:bRelease"))) BaseTypeNonDefault {};

struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:dRetain")))
__attribute__((language_attr("release:dRelease"))) DerivedTypeNonDefault
