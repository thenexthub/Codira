...
// A wrapper around C++'s static_cast(), which allows Codira to get around interop's current lack of support for inheritance.
...
__attribute__((language_attr("retain:immortal")))
__attribute__((language_attr("release:immortal"))) ImmortalRefType {};
...
struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:ret1")))
__attribute__((language_attr("release:rel1"))) RefType {};
...
struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:ret2")))
__attribute__((language_attr("release:rel2"))) DerivedFromValueTypeAndAnnotated
    : ValueType {};
...
struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:ret3")))
__attribute__((language_attr("release:rel3"))) DerivedFromRefTypeAndAnnotated
    : RefType {};
...
struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:retain_A")))
__attribute__((language_attr("release:release_A"))) RefTypeA {};

struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:retain_B")))
__attribute__((language_attr("release:release_B"))) RefTypeB {};

struct DerivedFromRefTypeAAndB : RefTypeA, RefTypeB {}; // expected-warning {{unable to infer LANGUAGE_SHARED_REFERENCE for 'DerivedFromRefTypeAAndB', although one of its transitive base types is marked as LANGUAGE_SHARED_REFERENCE}}
DerivedFromRefTypeAAndB *returnDerivedFromRefTypeAAndB() {
    return new DerivedFromRefTypeAAndB();
}

struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:retain_C")))
__attribute__((language_attr("release:release_C"))) DerivedFromRefTypeAAndBAnnotated
    : RefTypeA,
        RefTypeB {};
...
__attribute__((language_attr("release:RCRelease"))) RefType {};
...
struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:baseRetain1")))
__attribute__((language_attr("release:baseRelease1"))) BaseRef1 {};

struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:baseRetain2")))
__attribute__((language_attr("release:baseRelease2"))) BaseRef2 {};

struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:baseRetain1")))
__attribute__((language_attr("release:baseRelease1"))) BaseRef3 : BaseRef1 {};

struct DerivedFromBaseRef1AndBaseRef2 : BaseRef1, BaseRef2 {}; // expected-warning {{unable to infer LANGUAGE_SHARED_REFERENCE for 'DerivedFromBaseRef1AndBaseRef2', although one of its transitive base types is marked as LANGUAGE_SHARED_REFERENCE}}
...
struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:bRetain1")))
__attribute__((language_attr("release:bRelease1"))) B1 {};

struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:bRetain2")))
__attribute__((language_attr("release:bRelease2"))) B2 {};

struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:bRetain3")))
__attribute__((language_attr("release:bRelease3"))) B3 {};

struct D : B1, B2, B3 {}; // expected-warning {{unable to infer LANGUAGE_SHARED_REFERENCE for 'D', although one of its transitive base types is marked as LANGUAGE_SHARED_REFERENCE}}
...
// when infering LANGUAGE_SHARED_REFERENCE
namespace MultipleInheritanceExample3 {
struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:retain1")))
__attribute__((language_attr("release:release1"))) B1 {};

struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:retain2")))
__attribute__((language_attr("release:release2"))) B2 {};

struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:retain1")))
__attribute__((language_attr("release:release1"))) B3 : B1 {};
...
struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:sameretain")))
__attribute__((language_attr("release:samerelease"))) B1 {}; // expected-error {{multiple functions 'sameretain' found; there must be exactly one retain function for reference type 'B1'}}
                                                          // expected-error@-1 {{multiple functions 'samerelease' found; there must be exactly one release function for reference type 'B1'}}


struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:sameretain")))
__attribute__((language_attr("release:samerelease"))) B2 {};  // expected-error {{multiple functions 'sameretain' found; there must be exactly one retain function for reference type 'B2'}}
...
struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:retainA")))
__attribute__((language_attr("release:releaseA"))) A {};
...
struct Diamond : B, C {}; // expected-warning {{unable to infer LANGUAGE_SHARED_REFERENCE for 'Diamond', although one of its transitive base types is marked as LANGUAGE_SHARED_REFERENCE}}
...
struct __attribute__((language_attr("import_reference")))
__attribute__((language_attr("retain:retainB")))
__attribute__((language_attr("release:releaseB"))) B : A {};
...
__attribute__((language_attr("retain:forestRetain"))) __attribute__((
    language_attr("release:forestRelease"))) IntrusiveRefCountedTemplate {
public:
