...
struct __attribute__((language_attr("import_owned"))) ArgTyOwnedPtr {
  ArgTy *ptr;
};

struct __attribute__((language_attr("import_reference"),
                      language_attr("retain:immortal"),
                      language_attr("release:immortal"))) ArgFRT {
  int value;
...
__attribute__((language_attr("release:releaseFn"))) ArgRefCounted {
  int value;
  int refCount = 1;
...
inline bool isArgViewNullUnsafeParam(__attribute__((language_attr("import_unsafe"))) ArgTyView a = {nullptr}) { return a.ptr == nullptr; }
inline bool isArgViewNullUnsafeFunc(ArgTyView a = {nullptr}) __attribute__((language_attr("import_unsafe"))) { return a.ptr == nullptr; }
...
public:
  ...
  // This should not get a default value in Codira:
