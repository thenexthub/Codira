...
struct __attribute__((language_attr("import_unsafe"))) StructWithCopyConstructor {
...
struct __attribute__((language_attr("import_unsafe"))) StructWithCopyAssignment {
...
struct __attribute__((language_attr("import_unsafe"))) StructWithDestructor {
...
struct __attribute__((language_attr("import_owned")))
...
struct __attribute__((language_attr("~Copyable"))) StructCopyableMovableAnnotatedNonCopyable {
