...
typedef NS_OPTIONS(unsigned long, Foo) {
  NS_LANGUAGE_NAMED_OptionOne __attribute__((language_name("CodiraOptionOne"))) = 0,
  NS_LANGUAGE_NAMED_OptionTwo __attribute__((language_name("CodiraOptionTwo"))) = 1
                                                                           << 0,
  NS_LANGUAGE_NAMED_OptionThree
  __attribute__((language_name("CodiraOptionThree"))) = 1 << 1,
  NS_LANGUAGE_NAMED_OptionFour
  __attribute__((language_name("CodiraOptionFour"))) = NS_LANGUAGE_NAMED_OptionOne |
                                                   NS_LANGUAGE_NAMED_OptionTwo
};
