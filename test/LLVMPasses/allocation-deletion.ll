...
declare void @language_retain(ptr ) nounwind
declare { i64, i64, i64 } @language_retainAndReturnThree(ptr , i64, i64 , i64 )

; rdar://11542743
define i64 @max_test(i64 %x) nounwind {
entry:
  %0 = tail call noalias ptr @language_allocObject(ptr null, i64 24, i64 8) nounwind
  tail call void @language_retain(ptr %0) nounwind
  tail call void @language_release(ptr %0) nounwind
  %1 = icmp sgt i64 %x, 0
...
; trivial destructor.
@trivial_dtor_metadata = internal constant %language.heapmetadata { ptr @trivial_dtor, ptr null }
define internal i64 @trivial_dtor(ptr nocapture) nounwind readonly {
entry:
  %1 = getelementptr inbounds %language.refcounted, ptr %0, i64 1
...
entry:
  %0 = tail call noalias ptr @language_allocObject(ptr @trivial_dtor_metadata, i64 24, i64 8) nounwind
  tail call void @language_release(ptr %0) nounwind
  ret void
}
...
@trivial_dtor_metadata2 = internal constant %language.heapmetadata { ptr @trivial_dtor2, ptr null }
define internal i64 @trivial_dtor2(ptr nocapture %this) nounwind readonly {
entry:
  %0 = getelementptr inbounds %language.refcounted, ptr %this, i64 1, i32 0
  store ptr inttoptr (i64 4 to ptr), ptr %0, align 8
  tail call void @language_retain(ptr %this)
  ret i64 48
}
define void @trivial_alloc_eliminate2(i64 %x) nounwind {
entry:
  %0 = tail call noalias ptr @language_allocObject(ptr @trivial_dtor_metadata2, i64 24, i64 8) nounwind
  tail call void @language_release(ptr %0) nounwind
  ret void
}
...
@external_dtor_metadata = external global %language.heapmetadata, align 8
define void @external_dtor_alloc_eliminate() nounwind {
entry:
  %0 = tail call noalias ptr @language_allocObject(ptr nonnull @external_dtor_metadata, i64 24, i64 8) nounwind
  tail call void @language_release(ptr %0) nounwind
  ret void
}
...
; CHECK-NEXT: entry:
; CHECK-NEXT: language_allocObject
