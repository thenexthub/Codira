; RUN: %language-toolchain-opt -passes='language-merge-functions' -languagemergefunc-threshold=4 %s | %FileCheck %s
; REQUIRES: CODEGENERATOR=AArch64

target triple = "arm64e-apple-macosx11.0.0"

; CHECK: [[RELOC1:@[0-9]+]] = private constant { ptr, i32, i64, i64 } { ptr @callee1, i32 0, i64 0, i64 [[DISCR:[0-9]+]] }, section "toolchain.ptrauth"
; CHECK: [[RELOC2:@[0-9]+]] = private constant { ptr, i32, i64, i64 } { ptr @callee2, i32 0, i64 0, i64 [[DISCR]] }, section "toolchain.ptrauth"
