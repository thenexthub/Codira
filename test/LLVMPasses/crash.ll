;  RUN: %language-toolchain-opt -passes=language-toolchain-arc-optimize %s > /dev/null
...
entry:
  ...
  call void @language_release(ptr null) nounwind
  call void @language_release(ptr %11) nounwind
  ret void
}
