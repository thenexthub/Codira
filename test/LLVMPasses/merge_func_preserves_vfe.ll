; RUN: %language-toolchain-opt -passes='language-merge-functions' -languagemergefunc-threshold=2 %s | %FileCheck %s

@g1 = external global i1
@g2 = external global i1
@g3 = external global i1

declare { ptr, i1 } @toolchain.type.checked.load(ptr, i32, metadata)

define i1 @merge_candidate_a(ptr %ptr, i32 %offset) {
    %1 = call { ptr, i1 } @toolchain.type.checked.load(ptr %ptr, i32 %offset, metadata !"common_metadata")
...
define i1 @merge_candidate_c(ptr %ptr, i32 %offset) {
    %1 = call { ptr, i1 } @toolchain.type.checked.load(ptr %ptr, i32 %offset, metadata !"different_metadata")
    %2 = extractvalue { ptr, i1 } %1, 1
    %3 = load i1, i1* @g3
    %4 = and i1 %2, %3
    ret i1 %4
...
; CHECK:       @toolchain.type.checked.load(ptr %ptr, i32 %offset, metadata !"different_metadata")
; CHECK-NOT:   call i1 @merge_candidate_aTm
; CHECK:       ret
