...
function(manpage)
  ...
  add_custom_command_target(
      ...
      COMMAND
        ...
        "--center" "${MP_PAGE_HEADER}" "--release=\"language ${LANGUAGE_VERSION}\""
  ...
  if("${LANGUAGE_HOST_VARIANT_SDK}" STREQUAL "OPENBSD")
    set(MANPAGE_DEST "")
  endif()
  language_install_in_component(FILES "${output_file_name}"
