include(CodiraAddCustomCommandTarget)
...
#
# flags ...
#    gyb flags in addition to ${LANGUAGE_GYB_FLAGS}.
#
# depends ...
...
function(handle_gyb_source_single dependency_out_var_name)
  ...
  set(gyb_tool "${LANGUAGE_SOURCE_DIR}/utils/gyb")
  ...
  add_custom_command_target(
      ...
      COMMAND
          "${CMAKE_COMMAND}" -E env "$<TARGET_FILE:Python3::Interpreter>" "${gyb_tool}" ${LANGUAGE_GYB_FLAGS} ${GYB_SINGLE_FLAGS} -o "${GYB_SINGLE_OUTPUT}.tmp" "${GYB_SINGLE_SOURCE}"
      COMMAND
...
function(handle_gyb_sources dependency_out_var_name sources_var_name)
  ...
  set(gyb_extra_sources
      ...
      "${LANGUAGE_SOURCE_DIR}/utils/CodiraFloatingPointTypes.py"
      "${LANGUAGE_SOURCE_DIR}/utils/UnicodeData/GraphemeBreakProperty.txt"
      "${LANGUAGE_SOURCE_DIR}/utils/UnicodeData/GraphemeBreakTest.txt"
      "${LANGUAGE_SOURCE_DIR}/utils/gyb_stdlib_support.py")
