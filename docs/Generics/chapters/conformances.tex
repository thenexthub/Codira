...
\end{Verbatim}
Finally, both the conforming type and conformed protocol can be declared in modules separate from ours. This is called a \IndexDefinition{retroactive conformance}\emph{retroactive conformance}, and the compiler warns about this as of \IndexCodira{6.0}Codira~6 \cite{se0364}:
\begin{Verbatim}
...
\end{tabular}
\end{center}
Hence the four fundamental semantic objects in the Codira generics implementation: generic signatures, requirement signatures, substitution maps, and conformances.
...
Key source files:
\begin{itemize}
\item \SourceFile{include/language/AST/ConformanceLookup.h}
...
Key source files:
\begin{itemize}
\item \SourceFile{include/language/AST/ProtocolConformanceRef.h}
