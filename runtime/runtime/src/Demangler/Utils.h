...
#ifndef CODIRA_DEMANGLER_UTILS_H
#define CODIRA_DEMANGLER_UTILS_H

#include <unordered_map>
#include <cstring>

namespace Codira {
const char MANGLE_CODIRA_PREFIX[] = "_C";
...
#endif // CODIRA_DEMANGLER_UTILS_H
