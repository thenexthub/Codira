...
#ifndef MRT_CODETHREAD_MODEL_H
#define MRT_CODETHREAD_MODEL_H
...
class CODEThreadModel : public ConcurrencyModel {
public:
    CODEThreadModel() = default;
    ~CODEThreadModel() override = default;
