...
{
    ScopedEntryTrace trace("CODERT_GC_PREFORWARD");
    ...
    // forward and fix code future objects
...
class CODEFunc : public BaseObject {
public:
...
class CODEInteropContext : public BaseObject {
public:
    CODEFunc* GetCODEFunc()
    {
        return static_cast<CODEFunc*>(Heap::GetBarrier().ReadReference(this,
            *reinterpret_cast<RefField<false>*>(&codeFunc)));
    }
private:
    CODEFunc* codeFunc = nullptr;
};

class CODEForeignProxy : public BaseObject {
public:
    CODEInteropContext* GetCODEInteropContext()
    {
        return static_cast<CODEInteropContext*>(Heap::GetBarrier().ReadReference(this,
            *reinterpret_cast<RefField<false>*>(&interopContext)));
    }
private:
    CODEInteropContext* interopContext = nullptr;
};

CrossRefHandler WCollector::GetCrossRefHandler(BaseObject *foreignProxy)
{
    return static_cast<CODEForeignProxy*>(foreignProxy)->GetCODEInteropContext()->GetCODEFunc()->GetHandler();
}
