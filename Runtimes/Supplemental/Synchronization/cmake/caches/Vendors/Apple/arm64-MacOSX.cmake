...
set(CMAKE_Codira_COMPILER_TARGET "arm64-apple-macosx${CMAKE_OSX_DEPLOYMENT_TARGET}" CACHE STRING "")

set(CodiraSynchronization_ARCH_SUBDIR arm64 CACHE STRING "")
set(CodiraSynchronization_PLATFORM_SUBDIR macosx CACHE STRING "")

set(CodiraSynchronization_COMPILER_VARIANT_TARGET "arm64-apple-ios${CodiraSynchronization_TARGET_VARIANT_DEPLOYMENT_TARGET}-macabi" CACHE STRING "")
