...
FileProviderItemIdentifier const
    FileProviderRootContainerItemIdentifier NS_LANGUAGE_NAME(FileProviderItemIdentifier.rootContainer);
FileProviderItemIdentifier const
    FileProviderWorkingSetContainerItemIdentifier NS_LANGUAGE_NAME(FileProviderItemIdentifier.workingSet);
FileProviderItemIdentifier const
    FileProviderTrashContainerItemIdentifier NS_LANGUAGE_NAME(FileProviderItemIdentifier.trashContainer);
