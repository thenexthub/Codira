...
public:
    ...
    .*/
    GcRootPtr(const Runtime& runtime, CodiraGcPtr obj) noexcept : m_ptr(obj), m_runtime(&runtime) {
     ...
     */
    [[nodiscard]] constexpr CodiraGcPtr handle() const noexcept { return m_ptr; }
