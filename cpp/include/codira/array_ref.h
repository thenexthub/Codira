#ifndef CODIRA_ARRAY_REF_H_
#define CODIRA_ARRAY_REF_H_
...
/** Type-agnostic wrapper for interoperability with a Codira array.
 *
...
public:
    /** Constructs a `ArrayRef` that wraps a raw Codira array.
     *
     ...
     */
    ArrayRef(const Runtime& runtime, CodiraGcPtr raw) noexcept
