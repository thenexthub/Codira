#ifndef CODIRA_MARSHAL_H_
#define CODIRA_MARSHAL_H_
...
#define IMPL_PRIMITIVE_TYPE_MARSHAL(ty)                                                    \
    ...
    struct Marshal<ty> {                                                                   \
        ...
        static type to(type value) noexcept { return value; }                              \
                                                                                           \
        static type copy_from(const type* value, const Runtime&, const Type&) noexcept {   \
            return *value;                                                                 \
        }                                                                                  \
                                                                                           \
        static void move_to(type value, type* ptr, const Type&) noexcept {                 \
            *ptr = std::move(value);                                                       \
        }                                                                                  \
                                                                                           \
        static type swap_at(type value, type* ptr, const Runtime&, const Type&) noexcept { \
            std::swap(value, *ptr);                                                        \
