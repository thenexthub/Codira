#ifndef CODIRA_INVOKE_FN_H_
#define CODIRA_INVOKE_FN_H_

#include <iostream>
#include <optional>
#include <string_view>

#include "codira/invoke_result.h"
...
InvokeResult<Output, Args...> invoke_fn(Runtime& runtime, std::string_view fn_name,
    ...
    if (auto fn_info = runtime.find_function_info(fn_name, &error); error.is_error()) {
        ...
        auto fn = reinterpret_cast<typename Marshal<Output>::type(CODIRA_CALLTYPE*)(
