...
TEST(StaticObjects, ini) {
  RaceTest_ExpectEqual<const Metadata *>(
     [&]() -> const Metadata * {
       ...
       HeapObject *o = language_initStaticObject(&StaticTestMD, &StaticTestObj.obj);
       ...
       for (int i = 0; i < NumRcOps; i++) {
         language_retain(&StaticTestObj.obj);
       }
       for (int i = 0; i < NumRcOps; i++) {
         language_release(&StaticTestObj.obj);
       }
       return StaticTestObj.obj.metadata;
     });
  EXPECT_EQ(language_retainCount(&StaticTestObj.obj), 1u);
}
...
TEST(MetadataTest, getMetatypeMetadata) {
  auto inst1 = RaceTest_ExpectEqual<const MetatypeMetadata *>(
    [&]() -> const MetatypeMetadata * {
      auto inst = language_getMetatypeMetadata(&METADATA_SYM(Bi64_).base);
  ...
  auto inst2 = RaceTest_ExpectEqual<const MetatypeMetadata *>(
    [&]() -> const MetatypeMetadata * {
      auto inst = language_getMetatypeMetadata(&METADATA_SYM(Bi32_).base);
  ...
  auto inst3 = RaceTest_ExpectEqual<const MetatypeMetadata *>(
    [&]() -> const MetatypeMetadata * {
      auto inst = language_getMetatypeMetadata(&MetadataTest2);
  ...
  auto inst4 = RaceTest_ExpectEqual<const MetatypeMetadata *>(
    [&]() -> const MetatypeMetadata * {
      auto inst = language_getMetatypeMetadata(inst3);
      EXPECT_EQ(sizeof(void*), inst->getValueWitnesses()->size);
      return inst;
    });
  ...
  auto inst5 = RaceTest_ExpectEqual<const MetatypeMetadata *>(
    [&]() -> const MetatypeMetadata * {
      auto inst = language_getMetatypeMetadata(inst1);
      EXPECT_EQ(sizeof(void*), inst->getValueWitnesses()->size);
      return inst;
    });
...
ProtocolDescriptor ProtocolA{
  ...
  ProtocolDescriptorFlags()
    ...
    .withDispatchStrategy(ProtocolDispatchStrategy::Codira)
};
...
TEST(MetadataTest, getExistentialMetadata) {
  RaceTest_ExpectEqual<const ExistentialTypeMetadata *>(
    [&]() -> const ExistentialTypeMetadata * {
      auto any = language_getExistentialTypeMetadata(ProtocolClassConstraint::Any,
                                                  /*superclass=*/nullptr,
                                                  0, nullptr);
  ...
  ProtocolDescriptorRef protoList2[] = {
    ProtocolDescriptorRef::forCodira(&ProtocolA)
  };
  auto exA = RaceTest_ExpectEqual<const ExistentialTypeMetadata *>(
    [&]() -> const ExistentialTypeMetadata * {
      auto a = language_getExistentialTypeMetadata(ProtocolClassConstraint::Any,
                                                /*superclass=*/nullptr,
                                                1, protoList2);
      ...
      EXPECT_EQ(&ProtocolA, a->getProtocols()[0].getCodiraProtocol());
      EXPECT_EQ(SpecialProtocol::None,
  ...
  ProtocolDescriptorRef protoList3[] = {
    ProtocolDescriptorRef::forCodira(&ProtocolB)
  };
  RaceTest_ExpectEqual<const ExistentialTypeMetadata *>(
    [&]() -> const ExistentialTypeMetadata * {
      auto b = language_getExistentialTypeMetadata(ProtocolClassConstraint::Any,
                                                /*superclass=*/nullptr,
                                                1, protoList3);
      EXPECT_NE(exA, b);
      ...
      EXPECT_EQ(&ProtocolB, b->getProtocols()[0].getCodiraProtocol());
      EXPECT_EQ(SpecialProtocol::None,
  ...
  ProtocolDescriptorRef protoList6[] = {
    ProtocolDescriptorRef::forCodira(&ProtocolClassConstrained)
  };
  RaceTest_ExpectEqual<const ExistentialTypeMetadata *>(
    [&]() -> const ExistentialTypeMetadata * {
      auto classConstrained
        = language_getExistentialTypeMetadata(ProtocolClassConstraint::Class,
                                           /*superclass=*/nullptr,
                                           1, protoList6);
      ...
      EXPECT_EQ(&ProtocolClassConstrained,
                classConstrained->getProtocols()[0].getCodiraProtocol());
      EXPECT_EQ(nullptr,
...
#define EXAMPLE_OBJC_PROTOCOL_NAME "NSCopying"
  ...
  ProtocolDescriptorRef protoList9[] = {
    ProtocolDescriptorRef::forCodira(&ProtocolError)
  };
  RaceTest_ExpectEqual<const ExistentialTypeMetadata *>(
    [&]() -> const ExistentialTypeMetadata * {
      auto special
...
static ProtocolDescriptor OpaqueProto1 = { "OpaqueProto1", nullptr,
  ProtocolDescriptorFlags().withCodira(true)
                          .withDispatchStrategy(ProtocolDispatchStrategy::Codira)
                          .withClassConstraint(ProtocolClassConstraint::Any)
};
...
TEST(MetadataTest, getExistentialTypeMetadata_opaque) {
  ProtocolDescriptorRef protoList1[] = {
    ProtocolDescriptorRef::forCodira(&OpaqueProto1)
  };
  RaceTest_ExpectEqual<const ExistentialTypeMetadata *>(
    [&]() -> const ExistentialTypeMetadata * {
      auto ex1 = language_getExistentialTypeMetadata(ProtocolClassConstraint::Any,
                                                  /*superclass=*/nullptr,
                                                  1, protoList1);
  ...
  ProtocolDescriptorRef protoList2[] = {
    ProtocolDescriptorRef::forCodira(&OpaqueProto1),
    ProtocolDescriptorRef::forCodira(&OpaqueProto2)
  };
  RaceTest_ExpectEqual<const ExistentialTypeMetadata *>(
    [&]() -> const ExistentialTypeMetadata * {
      auto ex2 = language_getExistentialTypeMetadata(ProtocolClassConstraint::Any,
                                                  /*superclass=*/nullptr,
                                                  2, protoList2);
  ...
  ProtocolDescriptorRef protoList3[] = {
    ProtocolDescriptorRef::forCodira(&OpaqueProto1),
    ProtocolDescriptorRef::forCodira(&OpaqueProto2),
    ProtocolDescriptorRef::forCodira(&OpaqueProto3)
  };
  RaceTest_ExpectEqual<const ExistentialTypeMetadata *>(
    [&]() -> const ExistentialTypeMetadata * {
      auto ex3 = language_getExistentialTypeMetadata(ProtocolClassConstraint::Any,
                                                  /*superclass=*/nullptr,
                                                  3, protoList3);
...
TEST(MetadataTest, getExistentialTypeMetadata_class) {
  ProtocolDescriptorRef protoList1[] = {
    ProtocolDescriptorRef::forCodira(&ClassProto1)
  };
  RaceTest_ExpectEqual<const ExistentialTypeMetadata *>(
    [&]() -> const ExistentialTypeMetadata * {
      auto ex1 = language_getExistentialTypeMetadata(ProtocolClassConstraint::Class,
                                                  /*superclass=*/nullptr,
                                                  1, protoList1);
      EXPECT_EQ(MetadataKind::Existential, ex1->getKind());
  ...
  RaceTest_ExpectEqual<const ExistentialTypeMetadata *>(
    [&]() -> const ExistentialTypeMetadata * {
      auto ex2 = language_getExistentialTypeMetadata(ProtocolClassConstraint::Class,
                                                  /*superclass=*/nullptr,
                                                  2, protoList2);
      EXPECT_EQ(MetadataKind::Existential, ex2->getKind());
  ...
  RaceTest_ExpectEqual<const ExistentialTypeMetadata *>(
    [&]() -> const ExistentialTypeMetadata * {
      auto ex3 = language_getExistentialTypeMetadata(ProtocolClassConstraint::Class,
                                                  /*superclass=*/nullptr,
                                                  3, protoList3);
      EXPECT_EQ(MetadataKind::Existential, ex3->getKind());
...
TEST(MetadataTest, getExistentialTypeMetadata_subclass) {
  RaceTest_ExpectEqual<const ExistentialTypeMetadata *>(
    [&]() -> const ExistentialTypeMetadata * {
      ...
      EXPECT_EQ(&OpaqueProto1, ex1->getProtocols()[0].getCodiraProtocol());
  ...
  RaceTest_ExpectEqual<const ExistentialTypeMetadata *>(
    [&]() -> const ExistentialTypeMetadata * {
      ...
      EXPECT_TRUE(ex2->getProtocols()[0].getCodiraProtocol() == &OpaqueProto1 &&
                  ex2->getProtocols()[1].getCodiraProtocol() == &ClassProto1);
...
TEST(TestOpaqueExistentialBox, test_assignWithCopy_indirect_indirect) {
  ...
  auto refAndObjectAddr = BoxPair(language_allocBox(metadata));
  language_retain(refAndObjectAddr.object);
  auto refAndObjectAddr2 = BoxPair(language_allocBox(metadata2));
  struct {
    ValueBuffer buffer;
    Metadata *type;
    uintptr_t canary;
  ...
  EXPECT_EQ(language_retainCount(refAndObjectAddr.object), 1u);
  EXPECT_EQ(language_retainCount(refAndObjectAddr2.object), 2u);
}
...
TEST(TestOpaqueExistentialBox, test_assignWithTake_indirect_indirect) {
  ...
  EXPECT_EQ(existBox.buffer.PrivateData[0], refAndObjectAddr2.object);
  EXPECT_EQ(language_retainCount(refAndObjectAddr.object), 1u);
  EXPECT_EQ(language_retainCount(refAndObjectAddr2.object), 1u);
}
...
TEST(TestOpaqueExistentialBox, test_assignWithCopy_indirect_pod) {
  ...
  language_retain(refAndObjectAddr2.object);
  struct {
    ValueBuffer buffer;
    Metadata *type;
    uintptr_t canary;
