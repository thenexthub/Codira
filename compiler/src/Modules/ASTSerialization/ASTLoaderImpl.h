...
#ifndef CODIRA_MODULES_ASTSERIALIZATION_ASTLOADER_IMPL_H
#define CODIRA_MODULES_ASTSERIALIZATION_ASTLOADER_IMPL_H
...
friend ASTLoader;
    ...
    inline const PackageFormat::Decl* GetFormatDeclByIndex(FormattedIndex declIndex) const
    {
        ...
        CODEC_ASSERT(declIndex != INVALID_FORMAT_INDEX);
    ...
    inline const PackageFormat::Expr* GetFormatExprByIndex(FormattedIndex exprIndex) const
    {
        ...
        CODEC_ASSERT(exprIndex != INVALID_FORMAT_INDEX);
