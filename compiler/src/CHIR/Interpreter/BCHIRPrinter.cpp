...
void BCHIRPrinter::DefinitionPrinter::PrintOPSwitch()
{
    ...
    CODEC_ASSERT(it != CHIR::TYPEKIND_TO_STRING.end());
...
const std::unordered_map<Codira::OverflowStrategy, std::string> BCHIRPrinter::OVERFLOW_STRAT2STRING = {
    {Codira::OverflowStrategy::NA, "NA"},
    {Codira::OverflowStrategy::CHECKED, "CHECKED"},
    {Codira::OverflowStrategy::WRAPPING, "WRAPPING"},
    {Codira::OverflowStrategy::THROWING, "THROWING"},
    {Codira::OverflowStrategy::SATURATING, "SATURATING"},
};
...
void BCHIRPrinter::DefinitionPrinter::PrintOPBinRshift(OpCode opCode)
{
    ...
    CODEC_ASSERT(sit != OVERFLOW_STRAT2STRING.end());
    ...
    if (opCode == OpCode::BIN_LSHIFT || opCode == OpCode::BIN_RSHIFT || opCode == OpCode::BIN_RSHIFT_EXC ||
        ...
        CODEC_ASSERT(it2 != CHIR::TYPEKIND_TO_STRING.end());
...
void BCHIRPrinter::DefinitionPrinter::PrintOPIntrinsic(OpCode opCode)
{
    ...
    CODEC_ASSERT(kind == CHIR::IntrinsicKind::ARRAY_SLICE || kind == CHIR::IntrinsicKind::ARRAY_SLICE_GET_ELEMENT ||
...
std::fstream BCHIRPrinter::GetBCHIROutputFile(
    const Codira::GlobalOptions& options, const std::string& fullPackageName, const std::string& stageName)
{
    std::fstream f;
    std::string bchirDir;
