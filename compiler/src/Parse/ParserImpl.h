...
#ifndef CODIRA_PARSE_PARSERIMPL_H
#define CODIRA_PARSE_PARSERIMPL_H
...
private:
    ...
    // codemp parser implementation class
    ...
    void CheckCODEMappingAttr(Decl& decl) const;
