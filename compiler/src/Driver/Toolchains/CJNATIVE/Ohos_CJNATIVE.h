 ...
 * @file
 *
 * This file declares the Ohos_CODENATIVE ToolChain class.
 */

#ifndef CODIRA_DRIVER_TOOLCHAIN_Ohos_CODENATIVE_H
#define CODIRA_DRIVER_TOOLCHAIN_Ohos_CODENATIVE_H
...
namespace Codira {
class Ohos_CODENATIVE : public Linux_CODENATIVE {
public:
    Ohos_CODENATIVE(const Codira::Driver& driver, const DriverOptions& driverOptions,
        std::vector<ToolBatch>& backendCmds)
        : Linux_CODENATIVE(driver, driverOptions, backendCmds) {};
    ~Ohos_CODENATIVE() override = default;
...
#endif // CODIRA_DRIVER_TOOLCHAIN_Ohos_CODENATIVE_H
