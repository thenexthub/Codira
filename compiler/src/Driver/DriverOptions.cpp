...
#define CODIRA_X86_64_TARGET_CPU(TARGET_CPU_NAME) (TARGET_CPU_NAME),
#include "TargetCPUs.inc"
#undef CODIRA_X86_64_TARGET_CPU
};
const std::unordered_set<std::string> AARCH64_TARGET_CPUS = {
#define CODIRA_AARCH64_TARGET_CPU(TARGET_CPU_NAME) (TARGET_CPU_NAME),
#include "TargetCPUs.inc"
#undef CODIRA_AARCH64_TARGET_CPU
};
}
