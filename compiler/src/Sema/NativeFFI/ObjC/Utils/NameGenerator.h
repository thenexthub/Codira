...
#ifndef CODIRA_SEMA_OBJ_C_UTILS_NAME_GENERATOR_H
#define CODIRA_SEMA_OBJ_C_UTILS_NAME_GENERATOR_H
...
public:
    ...
    std::string GenerateInitCodeObjectName(const AST::FuncDecl& target);
    std::string GenerateDeleteCodeObjectName(const AST::Decl& target);
...
#endif // CODIRA_SEMA_OBJ_C_UTILS_NAME_GENERATOR_H
