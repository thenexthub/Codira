...
#ifndef CODIRA_SEMA_OBJ_C_UTILS_AST_FACTORY_H
#define CODIRA_SEMA_OBJ_C_UTILS_AST_FACTORY_H
...
public:
    ...
    OwnedPtr<AST::FuncDecl> CreateInitCodeObject(
        const AST::Decl& target, AST::FuncDecl& ctor, bool generateForOneWayMapping = false);
    OwnedPtr<AST::FuncDecl> CreateDeleteCodeObject(AST::Decl& target, bool generateForOneWayMapping = false);
    /**
...
#endif // CODIRA_SEMA_OBJ_C_UTILS_AST_FACTORY_H
