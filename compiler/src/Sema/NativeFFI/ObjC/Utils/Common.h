 ...
 * @file
 *
 * This file declares common utils for Codira <-> Objective-C interop.
 * Needs to be structured properly in the future.
 */

#ifndef CODIRA_SEMA_OBJ_C_UTILS_COMMON_H
#define CODIRA_SEMA_OBJ_C_UTILS_COMMON_H
...
#endif // CODIRA_SEMA_OBJ_C_UTILS_COMMON_H
