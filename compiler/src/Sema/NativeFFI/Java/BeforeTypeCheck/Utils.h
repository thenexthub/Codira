 ...
 */
#ifndef CODIRA_SEMA_NATIVE_FFI_JAVA_BEFORE_TYPE_CHECK_UTILS
#define CODIRA_SEMA_NATIVE_FFI_JAVA_BEFORE_TYPE_CHECK_UTILS
...
#endif // CODIRA_SEMA_NATIVE_FFI_JAVA_BEFORE_TYPE_CHECK_UTILS
