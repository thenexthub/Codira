...
#ifndef CODIRA_SEMA_GENERIC_INSTANTIATION_MANAGER_IMPL_H
#define CODIRA_SEMA_GENERIC_INSTANTIATION_MANAGER_IMPL_H
...
private:
    ...
    /**
     * Since codenative backend only generate instantiated decls as local symbols,
...
#endif // CODIRA_SEMA_GENERIC_INSTANTIATION_MANAGER_IMPL_H
