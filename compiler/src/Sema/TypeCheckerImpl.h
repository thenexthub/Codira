...
#ifndef CODIRA_SEMA_TYPECHECKER_IMPL_H
#define CODIRA_SEMA_TYPECHECKER_IMPL_H
...
private:
    ...
    template <typename T>
    void CheckInheritanceCycleHelper(ASTContext& ctx, const AST::Decl& decl, const Codira::AST::Type& te,
    ...
    void MergeCODEMPExtensions(ASTContext& ctx, const std::unordered_set<Ptr<AST::ExtendDecl>>& extends);
    ...
    /** Desugar 'propDecl' after typecheck but still inside 'Sema' stage. Keep this order for codeLint usage. */
    ...
    // Desugar primary constructor into `init` and fields before codemp customDef merging
    ...
    */
    ...
    // codemp typechecker implementation class
