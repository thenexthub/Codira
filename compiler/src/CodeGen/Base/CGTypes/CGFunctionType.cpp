    ...
    : CGType(cgMod, cgCtx, chirType, CGTypeKind::CG_FUNCTION)
{
    ...
    CODEC_ASSERT(!forWrapper && !extraInfo.forWrapper);
}
...
void CGFunctionType::GenContainedCGTypes()
{
    ...
    // On CODENative backend, the parameters of structure type are passed by reference.
