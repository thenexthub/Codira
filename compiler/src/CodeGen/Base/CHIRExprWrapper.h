 ...
 */
#ifndef CODIRA_CHIREXPRWRAPPER_H
#define CODIRA_CHIREXPRWRAPPER_H
...
#endif
            CODEC_ASSERT_WITH_MSG(false, "Incorrect ApplyExpr from CHIR, type arguments are missing.");
        }
    }
...
public:
    ...
    const CHIR::Value* GetThisParam() const override
    {
        CODEC_ASSERT(false && "InvokeStatic doesn't have this param.");
        return nullptr;
    }
...
#endif // CODIRA_CHIREXPRWRAPPER_H
