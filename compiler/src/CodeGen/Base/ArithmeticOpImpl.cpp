    ...
    IRBuilder2& irBuilder, const CGValue* leftVal, const CGValue* rightVal)
{
    ...
    llvm::Value* ret = irBuilder.CallIntrinsicFunction(float64Type, "CODE_CORE_CPow", {&cgValLeft, &cgValRight});
#endif
...
llvm::Value* CreateFastPowerCallForFloat64PowerInt64(IRBuilder2& irBuilder, CGValue* leftVal, CGValue* rightVal)
{
    ...
    std::string runtimeFunc = "CODE_CORE_FastPowerDoubleInt64";
#ifdef CODIRA_CODEGEN_CODENATIVE_BACKEND
    ...
    IRBuilder2& irBuilder, const CGValue* leftVal, const CGValue* rightVal)
{
    ...
    CODEC_ASSERT(lType->isIntegerTy());
    CODEC_ASSERT(rType->isIntegerTy());
