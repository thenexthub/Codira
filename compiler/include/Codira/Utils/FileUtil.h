...
#ifndef CODIRA_UTILS_FILEUTIL_H
#define CODIRA_UTILS_FILEUTIL_H
 ...
 * @param[in] buffer Save .codeo file.
...
/**
 * Write buffer into .codeo file.
 * @param filePath string like "path/file.codeo".
 ...
 * @param notSkipTest whether skip source file whose name is ending with '_test', some like 'xxx_test.code'.
...
/**
 * Convert package name 'std.pkg' to a form of 'codira-<std>-<pkg>'
 */
...
/**
 * Convert filename '<file>.<ext>' to a form of 'codira-<file>'
 */
std::string ConvertFilenameToLibCodiraBaseFormat(const std::string& objectFile);

/**
 * Convert filename '<file>.<ext>' to a form of 'libcodira-<file><.extension>'
 */
std::string ConvertFilenameToLibCodiraFormat(const std::string& objectFile, const std::string& extension);
#else
/**
 * Convert filename '<file>.<ext>' to a form of 'codira-<file><sanitizerSuffix>'
 */
std::string ConvertFilenameToLibCodiraBaseFormat(
    const std::string& objectFile, const std::string& sanitizerSuffix = "");

/**
 * Convert filename '<file>.<ext>' to a form of 'libcodira-<file><sanitizerSuffix><.extension>'
 */
std::string ConvertFilenameToLibCodiraFormat(
...
/**
 * Find Program by an executable name, like: ./codec, codec, and return the full path with the executable name.
