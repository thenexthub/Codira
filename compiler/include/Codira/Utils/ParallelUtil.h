...
#ifndef CODIRA_UTILS_PARALLELUTIL_H
#define CODIRA_UTILS_PARALLELUTIL_H
...
public:
    ...
    void RunAST2CHIRInParallel(const std::vector<Ptr<const AST::Decl>>& decls, const CHIRType& chirType,
        const Codira::GlobalOptions& opts, const GenericInstantiationManager* gim, AST2CHIRNodeMap<Value>& globalCache,
