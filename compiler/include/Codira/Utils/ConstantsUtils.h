...
#ifndef CODIRA_CONSTANTSUTILS_H
#define CODIRA_CONSTANTSUTILS_H
...
inline const std::string CODIRA_HOME = "CODIRA_HOME";
...
// File extension.
inline const std::string SERIALIZED_FILE_EXTENSION = ".codeo";
inline const std::string CODE_D_FILE_EXTENSION = ".code.d";
...
inline const std::string CACHED_IMPORTED_CODEO_EXTENSION = ".iast";
