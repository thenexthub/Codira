...
#ifndef CODIRA_MODULES_NODESERIALIZATION_H
#define CODIRA_MODULES_NODESERIALIZATION_H
...
using AstNode = Ptr<const Codira::AST::Node>;
using AstExpr = Ptr<const Codira::AST::Expr>;
using AstCallExpr = Ptr<const Codira::AST::CallExpr>;
using AstLambdaExpr = Ptr<const Codira::AST::LambdaExpr>;
using AstType = Ptr<const Codira::AST::Type>;
using AstRefType = Ptr<const Codira::AST::RefType>;
using AstRefExpr = Ptr<const Codira::AST::RefExpr>;
using AstPrimitiveType = Ptr<const Codira::AST::PrimitiveType>;
using AstAnnotation = Ptr<const Codira::AST::Annotation>;
using AstModifier = Ptr<const Codira::AST::Modifier>;
using AstDecl = Ptr<const Codira::AST::Decl>;
using AstVarDecl = Ptr<const Codira::AST::VarDecl>;
using AstMainDecl = Ptr<const Codira::AST::MainDecl>;
using AstFuncDecl = Ptr<const Codira::AST::FuncDecl>;
using AstMacroDecl = Ptr<const Codira::AST::MacroDecl>;
using AstMacroExpandDecl = Ptr<const Codira::AST::MacroExpandDecl>;
using AstFuncArg = Ptr<const Codira::AST::FuncArg>;
using AstFuncBody = Ptr<const Codira::AST::FuncBody>;
using AstFuncParam = Ptr<const Codira::AST::FuncParam>;
using AstMacroExpandParam = Ptr<const Codira::AST::MacroExpandParam>;
using AstBlock = Ptr<const Codira::AST::Block>;
using AstStructBody = Ptr<const Codira::AST::StructBody>;
using AstInterfaceBody = Ptr<const Codira::AST::InterfaceBody>;
using AstClassBody = Ptr<const Codira::AST::ClassBody>;
using AstGeneric = Ptr<const Codira::AST::Generic>;
using AstGenericParamDecl = Ptr<const Codira::AST::GenericParamDecl>;
using AstGenericConstraint = Ptr<const Codira::AST::GenericConstraint>;
using AstPattern = Ptr<const Codira::AST::Pattern>;
using AstEnumPattern = Ptr<const Codira::AST::EnumPattern>;
using AstMatchCase = Ptr<const Codira::AST::MatchCase>;
using AstMatchCaseOther = Ptr<const Codira::AST::MatchCaseOther>;
using AstFile = Ptr<const Codira::AST::File>;
using AstFeaturesDirective = Ptr<const Codira::AST::FeaturesDirective>;
using AstPackageSpec = Ptr<const Codira::AST::PackageSpec>;
using AstImportSpec = Ptr<const Codira::AST::ImportSpec>;
...
private:
    ...
    flatbuffers::Offset<flatbuffers::Vector<const NodeFormat::Position*>> CreatePositionVector(
        const std::vector<Codira::Position>& positions);
    ...
    std::vector<flatbuffers::Offset<NodeFormat::Token>> TokensVectorCreateHelper(
        std::vector<Codira::Token> tokenVector);
...
#endif // CODIRA_MODULES_NODESERIALIZATION_H
