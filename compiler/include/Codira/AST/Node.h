...
#ifndef CODIRA_AST_NODE_H
#define CODIRA_AST_NODE_H
...
struct Annotation : public Node {
    ...
    {
        CODEC_ASSERT(static_cast<uint64_t>(t) <
 ...
 * This enum has a correspondence with class TokenKindHelper in std.ast/TokenKind.code
