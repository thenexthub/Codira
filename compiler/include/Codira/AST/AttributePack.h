...
#ifndef CODIRA_AST_ATTRIBUTE_H
#define CODIRA_AST_ATTRIBUTE_H
#include <bitset>
#include <cstddef>
#include <cstdint>
#include <sstream>
...
enum class Attribute {
    ...
    /**
     * Mark if foreign variable is volatile in codeo.
     * W: AUTOSDK.
     * R: Sema.
     */
    IS_VOLATILE,
    ...
    /**
     * Mark whether a pure codira decl is mapped to use by java side.
     * W: Parser
     * R: Sema.
     */
    JAVA_CODE_MAPPING,
...
static const std::unordered_map<AST::Attribute, std::string> ATTR2STR{
    ...
    {AST::Attribute::JAVA_CODE_MAPPING, "JAVA_CODE_MAPPING"},
