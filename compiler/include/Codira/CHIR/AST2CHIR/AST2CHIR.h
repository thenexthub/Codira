...
#ifndef CODIRA_CHIR_AST2CHIR_H
#define CODIRA_CHIR_AST2CHIR_H
...
public:
    ...
    public:
        ...
        AST2CHIR Build()
        {
            CODEC_NULLPTR_CHECK(opts);
            CODEC_NULLPTR_CHECK(import);
            CODEC_NULLPTR_CHECK(types);
            CODEC_NULLPTR_CHECK(diag);
...
private:
    ...
    // Try to deserialize common part for CODEMP.
    ...
    // Check whether the decl need be translated for CODEMP.
