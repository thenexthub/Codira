...
#ifndef CODIRA_CHIR_VALUE_H
#define CODIRA_CHIR_VALUE_H

#include "Codira/CHIR/AnnoInfo.h"
#include "Codira/CHIR/AttributeInfo.h"
#include "Codira/CHIR/Base.h"
...
/**
 * this class represent imported/non-imported global var and static member var in Codira's source code.
 */
...
protected:
     ...
     *  but codedb need original type to show
     *  e.g. func foo<T1>() {
...
private:
    ...
    DebugLocation propLoc;     // when this is setter or getter, it has prop location, needed by codelint
