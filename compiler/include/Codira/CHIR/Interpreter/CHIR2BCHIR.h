...
#ifndef CODIRA_CHIR_INTERRETER_CHIR2BCHIR_H
#define CODIRA_CHIR_INTERRETER_CHIR2BCHIR_H
...
private:
    ...
    void TranslateCApplyExpression(Context& ctx, const Apply& apply, const Codira::CHIR::FuncType& funcTy);
...
#endif // CODIRA_CHIR_INTERRETER_CHIR2BCHIR_H
