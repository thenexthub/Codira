...
#ifndef CODIRA_CHIR_INTERRETER_BCHIR_H
#define CODIRA_CHIR_INTERRETER_BCHIR_H
...
public:
    ...
    public:
        ...
        inline uint64_t Get8bytes(ByteCodeIndex index) const
        {
            ...
            CODEC_ASSERT(index + 1 < bytecode.size());
            return bytecode[static_cast<size_t>(index)] +
