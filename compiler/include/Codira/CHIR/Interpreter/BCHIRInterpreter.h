...
#ifndef CODIRA_CHIR_INTERRETER_BCHIRINTERPRETER_H
#define CODIRA_CHIR_INTERRETER_BCHIRINTERPRETER_H

// we need to undefine X86_64 and AARCH64 because of include/codira/Option/Option.h
#if defined(X86_64)
#undef X86_64
#endif
#if defined(AARCH64)
...
#include "Codira/CHIR/Interpreter/BCHIRPrinter.h"
#include "Codira/CHIR/Interpreter/BCHIRResult.h"
#include "Codira/CHIR/Interpreter/InterpreterArena.h"
#include "Codira/CHIR/Interpreter/InterpreterEnv.h"
#include "Codira/CHIR/Interpreter/InterpreterStack.h"
...
private:
    ...
    template <OpCode op> bool BinOpTyKindAndOverflowStrat(CHIR::Type::TypeKind kind, Codira::OverflowStrategy strat);
    ...
    template <OpCode op, typename T, typename S> bool BinOpInt(Codira::OverflowStrategy strat);
    /** @brief Binary exponential. Returns true if excetion is raised. */
    bool BinExpOpInt(Codira::OverflowStrategy strat);
    ...
    template <OpCode op, typename T, typename S> bool BinRegOpInt(Codira::OverflowStrategy strat);
    ...
    template <typename T, typename S> bool PushIfNotOverflow(bool overflow, S res, Codira::OverflowStrategy strat);
    ...
    void InterpretRefEq();
    void InterpretCODECodeCanUseSIMD();
...
#endif // CODIRA_CHIR_INTERRETER_BCHIRINTERPRETER_H
