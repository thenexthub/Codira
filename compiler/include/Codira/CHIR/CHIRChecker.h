...
#ifndef CODIRA_CHIR_CHIR_CHECKER_H
#define CODIRA_CHIR_CHIR_CHECKER_H
...
public:
    ...
    CHIRChecker(const Package& package, const Codira::GlobalOptions& opts, CHIRBuilder& builder);
...
private:
    ...
    void ParallelCheck(F check, const std::vector<Arg>& items)
    {
        ...
        std::vector<Codira::Utils::TaskResult<void>> results;
