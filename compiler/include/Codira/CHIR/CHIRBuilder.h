...
#ifndef CODIRA_CHIR_CHIRBUILDER_H
#define CODIRA_CHIR_CHIRBUILDER_H
...
public:
    ...
    Constant* CreateConstantExpression(Type* resultTy, Block* parentBlock, Args&&... args)
    {
        ...
        this->allocatedExprs.push_back(expr);
        CODEC_NULLPTR_CHECK(parentBlock->GetTopLevelFunc());
        ...
        const std::vector<GenericType*>& genericTypeParams = {}, bool addToIR = true)
    {
        ...
        CODEC_NULLPTR_CHECK(importDecl);
...
#endif // CODIRA_CHIR_CHIRBUILDER_H
