...
#ifndef CODIRA_CHIR_ANALYSIS_SINT_DOMAIN_H
#define CODIRA_CHIR_ANALYSIS_SINT_DOMAIN_H
...
struct CHIRArithmeticBinopArgs {
    ...
    CHIRArithmeticBinopArgs(const SIntDomain& ld, const SIntDomain& rd, PtrSymbol l, PtrSymbol r, ExprKind op,
        Codira::OverflowStrategy ov, bool isUnsigned)
        : ld{ld},
          rd{rd},
          l{std::move(l)},
          r{std::move(r)},
