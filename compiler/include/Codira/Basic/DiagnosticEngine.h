...
#ifndef CODIRA_BASIC_DIAGNOSTICENGINE_H
#define CODIRA_BASIC_DIAGNOSTICENGINE_H
...
#include "Codira/Basic/DiagRefactor/DiagnosticAll.def"
#undef WARNING
#undef ERROR
};
...
public:
    ...
    ///@{
    /// The two api below are used by CODELint and lsp.
...
#endif // CODIRA_BASIC_DIAGNOSTICENGINE_H
