...
#ifndef CODIRA_MANGLE_BASEMANGLER_H
#define CODIRA_MANGLE_BASEMANGLER_H
...
public:
    ...
    /**
     * @brief Determine whether fileName ends with ".code", if yes, strip it.
     *
...
#include "Codira/Mangle/StdPkg.inc"
};
...
#endif // CODIRA_MANGLE_BASEMANGLER_H
