...
#ifndef CODIRA_FRONTENDTOOL_FRONTENDTOOL_H
#define CODIRA_FRONTENDTOOL_FRONTENDTOOL_H

#include <string>
#include <vector>

#include "Codira/Frontend/FrontendObserver.h"
...
#endif // CODIRA_FRONTENDTOOL_FRONTENDTOOL_H
