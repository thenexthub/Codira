...
#ifndef CODIRA_PARSE_PARSER_H
#define CODIRA_PARSE_PARSER_H
...
public:
    ...
    /// \param parseDeclFile true if this parser is used to parse .code.d file. When parsing these files, do not report
