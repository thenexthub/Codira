...
PackageFormat::Linkage Serialize(const Codira::Linkage& kind)
{
    using namespace PackageFormat;
...
PackageFormat::SkipKind Serialize(const Codira::CHIR::SkipKind& kind)
{
    using namespace PackageFormat;
...
PackageFormat::OverflowStrategy Serialize(const Codira::OverflowStrategy& kind)
{
    using namespace PackageFormat;
...
PackageFormat::IntrinsicKind Serialize(const IntrinsicKind& kind)
{
    ...
    switch (kind) {
        ...
        case SET_GC_THRESHOLD:
            ...
            break;
        case DUMP_CODE_HEAP_DATA:
            ret = IntrinsicKind_DUMP_CODE_HEAP_DATA;
            break;
        case GET_GC_COUNT:
        ...
        case GET_GC_FREED_SIZE:
            ...
            break;
        case START_CODE_CPU_PROFILING:
            ret = IntrinsicKind_START_CODE_CPU_PROFILING;
            break;
        case STOP_CODE_CPU_PROFILING:
            ret = IntrinsicKind_STOP_CODE_CPU_PROFILING;
            break;
        case BLACK_BOX:
        ...
        case VECTOR_INDEX_BYTE_32:
            ...
            break;
        case CODE_CORE_CAN_USE_SIMD:
            ret = IntrinsicKind_CODE_CORE_CAN_USE_SIMD;
            break;
        case CODE_TLS_DYN_SET_SESSION_CALLBACK:
            ret = IntrinsicKind_CODE_TLS_DYN_SET_SESSION_CALLBACK;
            break;
        case CODE_TLS_DYN_SSL_INIT:
            ret = IntrinsicKind_CODE_TLS_DYN_SSL_INIT;
            break;
        ...
        case GET_METHOD_ANNOTATIONS:
            ...
            break;
        case APPLY_CODE_METHOD:
            ret = IntrinsicKind_APPLY_CODE_METHOD;
            break;
        case APPLY_CODE_STATIC_METHOD:
            ret = IntrinsicKind_APPLY_CODE_STATIC_METHOD;
            break;
        case APPLY_CODE_GENERIC_METHOD:
            ret = IntrinsicKind_APPLY_CODE_GENERIC_METHOD;
            break;
        case APPLY_CODE_GENERIC_STATIC_METHOD:
            ret = IntrinsicKind_APPLY_CODE_GENERIC_STATIC_METHOD;
            break;
        ...
        case MUTEX_INIT:
            ...
            break;
        case CODE_MUTEX_LOCK:
            ret = IntrinsicKind_CODE_MUTEX_LOCK;
            break;
        case MUTEX_TRY_LOCK:
        ...
        case REMOVE_EXPORTED_REF:
            ...
            break;
        case FFI_CODE_AST_LEX:
            ret = IntrinsicKind_FFI_CODE_AST_LEX;
            break;
        case FFI_CODE_AST_PARSEEXPR:
            ret = IntrinsicKind_FFI_CODE_AST_PARSEEXPR;
            break;
        case FFI_CODE_AST_PARSEDECL:
            ret = IntrinsicKind_FFI_CODE_AST_PARSEDECL;
            break;
        case FFI_CODE_AST_PARSE_PROPMEMBERDECL:
            ret = IntrinsicKind_FFI_CODE_AST_PARSE_PROPMEMBERDECL;
            break;
        case FFI_CODE_AST_PARSE_PRICONSTRUCTOR:
            ret = IntrinsicKind_FFI_CODE_AST_PARSE_PRICONSTRUCTOR;
            break;
        case FFI_CODE_AST_PARSE_PATTERN:
            ret = IntrinsicKind_FFI_CODE_AST_PARSE_PATTERN;
            break;
        case FFI_CODE_AST_PARSE_TYPE:
            ret = IntrinsicKind_FFI_CODE_AST_PARSE_TYPE;
            break;
        case FFI_CODE_AST_PARSETOPLEVEL:
            ret = IntrinsicKind_FFI_CODE_AST_PARSETOPLEVEL;
            break;
        case FFI_CODE_AST_DIAGREPORT:
            ret = IntrinsicKind_FFI_CODE_AST_DIAGREPORT;
            break;
        case FFI_CODE_PARENT_CONTEXT:
            ret = IntrinsicKind_FFI_CODE_PARENT_CONTEXT;
            break;
        case FFI_CODE_MACRO_ITEM_INFO:
            ret = IntrinsicKind_FFI_CODE_MACRO_ITEM_INFO;
            break;
        case FFI_CODE_GET_CHILD_MESSAGES:
            ret = IntrinsicKind_FFI_CODE_GET_CHILD_MESSAGES;
            break;
        case FFI_CODE_CHECK_ADD_SPACE:
            ret = IntrinsicKind_FFI_CODE_CHECK_ADD_SPACE;
            break;
...
PackageFormat::Phase Serialize(const Codira::CHIR::ToCHIR::Phase& kind)
{
    using namespace PackageFormat;
    auto ret = Phase_RAW;
    switch (kind) {
        ...
        case ToCHIR::Phase::ANALYSIS_FOR_CODELINT:
            ret = Phase_ANALYSIS_FOR_CODELINT;
            break;
    }
    return ret;
}
TEST_F(CHIRSerialzierTest, TypeKindEnum)
{
    ...
    EXPECT_EQ(static_cast<size_t>(enumEnd) + 1, static_cast<size_t>(Codira::CHIR::Type::TypeKind::MAX_TYPE_KIND));
...
{
    using namespace PackageFormat;
    Codira::CHIR::IntrinsicKind enumBegin = NOT_INTRINSIC;
    Codira::CHIR::IntrinsicKind enumEnd = IS_SUBTYPE_TYPES; // make sure this is max one we defined

    EXPECT_EQ(static_cast<size_t>(enumBegin), 0);
    for (size_t i = static_cast<size_t>(enumBegin); i <= static_cast<size_t>(enumEnd); i++) {
        EXPECT_EQ(PackageFormat::IntrinsicKind(static_cast<Codira::CHIR::IntrinsicKind>(i)),
            Serialize(static_cast<Codira::CHIR::IntrinsicKind>(i)))
            << "cur i: " << i;
    }
}
