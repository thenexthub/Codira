...
Codira::Linkage DeSerialize(const PackageFormat::Linkage& kind)
{
    using namespace PackageFormat;
    using Codira::Linkage;
    auto ret = Codira::Linkage::WEAK_ODR;
    switch (kind) {
        case Linkage_WEAK_ODR:
            ret = Codira::Linkage::WEAK_ODR;
            break;
        case Linkage_EXTERNAL:
            ret = Codira::Linkage::EXTERNAL;
            break;
        case Linkage_INTERNAL:
            ret = Codira::Linkage::INTERNAL;
            break;
        case Linkage_LINKONCE_ODR:
            ret = Codira::Linkage::LINKONCE_ODR;
            break;
        case Linkage_EXTERNAL_WEAK:
            ret = Codira::Linkage::EXTERNAL_WEAK;
            break;
    }
    return ret;
}

Codira::CHIR::SkipKind DeSerialize(const PackageFormat::SkipKind& kind)
{
    using namespace PackageFormat;
    using Codira::CHIR::SkipKind;
...
Codira::OverflowStrategy DeSerialize(const PackageFormat::OverflowStrategy& kind)
{
    using namespace PackageFormat;
    using Codira::OverflowStrategy;
...
{
    using namespace PackageFormat;
    using Codira::CHIR::ConstantValueKind;
...
{
    using namespace PackageFormat;
    using Codira::CHIR::CustomDefKind;
...
IntrinsicKind DeSerialize(const PackageFormat::IntrinsicKind& kind)
{
    ...
    switch (kind) {
        ...
        case IntrinsicKind_OBJECT_REFEQ:
            ret = OBJECT_REFEQ;
            break;
        case IntrinsicKind_RAW_ARRAY_REFEQ: // codenative only
            ret = RAW_ARRAY_REFEQ;
            break;
        case IntrinsicKind_FUNC_REFEQ: // codenative only
            ret = FUNC_REFEQ;
            break;
        ...
        case IntrinsicKind_SET_GC_THRESHOLD:
            ...
            break;
        case IntrinsicKind_DUMP_CODE_HEAP_DATA:
            ret = DUMP_CODE_HEAP_DATA;
            break;
        ...
        case IntrinsicKind_GET_GC_FREED_SIZE:
            ...
            break;
        case IntrinsicKind_START_CODE_CPU_PROFILING:
            ret = START_CODE_CPU_PROFILING;
            break;
        case IntrinsicKind_STOP_CODE_CPU_PROFILING:
            ret = STOP_CODE_CPU_PROFILING;
            break;
        ...
        case IntrinsicKind_FUTURE_INIT:
            ret = FUTURE_INIT;
            break;
        case IntrinsicKind_FUTURE_IS_COMPLETE: // codenative only
            ret = FUTURE_IS_COMPLETE;
            break;
        case IntrinsicKind_FUTURE_WAIT: // codenative only
            ret = FUTURE_WAIT;
            break;
        case IntrinsicKind_FUTURE_NOTIFYALL: // codenative only
        ...
        case IntrinsicKind_VECTOR_COMPARE_32: // codenative only
            ret = VECTOR_COMPARE_32;
            break;
        case IntrinsicKind_VECTOR_INDEX_BYTE_32: // codenative only
            ret = VECTOR_INDEX_BYTE_32;
            break;
        case IntrinsicKind_CODE_CORE_CAN_USE_SIMD: // codenative only
            ret = CODE_CORE_CAN_USE_SIMD;
            break;
        case IntrinsicKind_CODE_TLS_DYN_SET_SESSION_CALLBACK:
            ret = CODE_TLS_DYN_SET_SESSION_CALLBACK;
            break;
        case IntrinsicKind_CODE_TLS_DYN_SSL_INIT:
            ret = CODE_TLS_DYN_SSL_INIT;
            break;
        ...
        case IntrinsicKind_GET_METHOD_ANNOTATIONS:
            ...
            break;
        case IntrinsicKind_APPLY_CODE_METHOD:
            ret = APPLY_CODE_METHOD;
            break;
        case IntrinsicKind_APPLY_CODE_STATIC_METHOD:
            ret = APPLY_CODE_STATIC_METHOD;
            break;
        case IntrinsicKind_APPLY_CODE_GENERIC_METHOD:
            ret = APPLY_CODE_GENERIC_METHOD;
            break;
        case IntrinsicKind_APPLY_CODE_GENERIC_STATIC_METHOD:
            ret = APPLY_CODE_GENERIC_STATIC_METHOD;
            break;
        ...
        case IntrinsicKind_MUTEX_INIT:
            ret = MUTEX_INIT;
            break;
        case IntrinsicKind_CODE_MUTEX_LOCK:
            ret = CODE_MUTEX_LOCK;
            break;
        ...
        // Syscall
        // AST lib FFI
        case IntrinsicKind_FFI_CODE_AST_LEX:
            ret = FFI_CODE_AST_LEX;
            break;
        case IntrinsicKind_FFI_CODE_AST_PARSEEXPR:
            ret = FFI_CODE_AST_PARSEEXPR;
            break;
        case IntrinsicKind_FFI_CODE_AST_PARSEDECL:
            ret = FFI_CODE_AST_PARSEDECL;
            break;
        case IntrinsicKind_FFI_CODE_AST_PARSE_PROPMEMBERDECL:
            ret = FFI_CODE_AST_PARSE_PROPMEMBERDECL;
            break;
        case IntrinsicKind_FFI_CODE_AST_PARSE_PRICONSTRUCTOR:
            ret = FFI_CODE_AST_PARSE_PRICONSTRUCTOR;
            break;
        case IntrinsicKind_FFI_CODE_AST_PARSE_PATTERN:
            ret = FFI_CODE_AST_PARSE_PATTERN;
            break;
        case IntrinsicKind_FFI_CODE_AST_PARSE_TYPE:
            ret = FFI_CODE_AST_PARSE_TYPE;
            break;
        case IntrinsicKind_FFI_CODE_AST_PARSETOPLEVEL:
            ret = FFI_CODE_AST_PARSETOPLEVEL;
            break;
        case IntrinsicKind_FFI_CODE_AST_DIAGREPORT:
            ret = FFI_CODE_AST_DIAGREPORT;
            break;
        // Macro With Context FFI
        case IntrinsicKind_FFI_CODE_PARENT_CONTEXT:
            ret = FFI_CODE_PARENT_CONTEXT;
            break;
        case IntrinsicKind_FFI_CODE_MACRO_ITEM_INFO:
            ret = FFI_CODE_MACRO_ITEM_INFO;
            break;
        case IntrinsicKind_FFI_CODE_GET_CHILD_MESSAGES:
            ret = FFI_CODE_GET_CHILD_MESSAGES;
            break;
        case IntrinsicKind_FFI_CODE_CHECK_ADD_SPACE:
            ret = FFI_CODE_CHECK_ADD_SPACE;
            break;
        // CodeGen
...
ToCHIR::Phase DeSerialize(const PackageFormat::Phase& kind)
{
    ...
    switch (kind) {
        ...
        case Phase_PLUGIN:
            ...
            break;
        case Phase_ANALYSIS_FOR_CODELINT:
            ret = ToCHIR::Phase::ANALYSIS_FOR_CODELINT;
            break;
    }
    return ret;
}
...
TEST_F(CHIRDeSerialzierTest, LinkageEnum)
{
    ...
    for (size_t i = static_cast<size_t>(enumBegin); i <= static_cast<size_t>(enumEnd); i++) {
        EXPECT_EQ(Codira::Linkage(static_cast<PackageFormat::Linkage>(i)),
...
TEST_F(CHIRDeSerialzierTest, IntrinsicKindEnum)
{
    ...
    for (size_t i = static_cast<size_t>(enumBegin); i <= static_cast<size_t>(enumEnd); i++) {
        EXPECT_EQ(Codira::CHIR::IntrinsicKind(static_cast<PackageFormat::IntrinsicKind>(i)),
