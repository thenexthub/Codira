...
function(compile_rtlib target_name)
    ...
    if(NOT WIN32 AND NOT IOS)
        ...
        set(CODIRA_LIBFUZZER_BUILD_ENABLED ON)
    else()
        set(CODIRA_LIBFUZZER_BUILD_ENABLED OFF)
    endif()
    ...
    set(RTLIBS_C_FLAGS
        "${C_OTHER_FLAGS} -pipe -fno-common -fno-strict-aliasing -O3 -U_FORTIFY_SOURCE --prefix=${CODIRA_TARGET_TOOLCHAIN}"
    )
    ...
    set(LLVM_CMAKE_ARGS
        ...
        -DCOMPILER_RT_BUILD_SANITIZERS=${CODIRA_SANITIZER_SUPPORT_ENABLED}
        ${SANITIZER_BUILD_TARGET}
        -DCOMPILER_RT_BUILD_XRAY=OFF
        -DCOMPILER_RT_BUILD_LIBFUZZER=${CODIRA_LIBFUZZER_BUILD_ENABLED}
    ...
    if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/llvm-project)
        ...
        if(CODIRA_USE_OH_LLVM_REPO)
            set(REPOSITORY_PATH "https://gitcode.com/openharmony/third_party_llvm-project.git")
            set(LLVM_TAG master)
        else()
            set(REPOSITORY_PATH "https://gitcode.com/Codira/llvm-project.git")
            set(LLVM_TAG dev)
        endif()
