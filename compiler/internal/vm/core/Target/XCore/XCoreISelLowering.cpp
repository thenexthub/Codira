...
{
  // Whist toolchain does not support aggregate varargs we can ignore
...
SDValue XCoreTargetLowering::LowerFRAMEADDR(SDValue Op,
                                            SelectionDAG &DAG) const {
  // This nodes represent toolchain.frameaddress on the DAG.
...
LowerRETURNADDR(SDValue Op, SelectionDAG &DAG) const {
  // This nodes represent toolchain.returnaddress on the DAG.
