...
public:
  ...
  /// method is necessary to lower the toolchain.read_register.* and
  /// toolchain.write_register.* intrinsics. Allocatable registers must be reserved
...
private:
  ...
  void validateCCReservedRegs(
      const SmallVectorImpl<std::pair<toolchain::Register, toolchain::SDValue>> &Regs,
