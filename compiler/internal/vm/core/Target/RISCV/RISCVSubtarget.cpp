...
namespace vm::core::RISCVTuneInfoTable {
...
unsigned RISCVSubtarget::getMaxLMULForFixedLengthVectors() const {
  ...
  assert(RVVVectorLMULMax <= 8 &&
         toolchain::has_single_bit<uint32_t>(RVVVectorLMULMax) &&
         "V extension requires a LMUL to be at most 8 and a power of 2!");
  return toolchain::bit_floor(std::clamp<unsigned>(RVVVectorLMULMax, 1, 8));
}
