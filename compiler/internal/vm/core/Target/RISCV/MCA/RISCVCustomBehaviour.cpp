...
#define DEBUG_TYPE "toolchain-mca-riscv-custombehaviour"
...
const toolchain::StringRef RISCVLMULInstrument::DESC_NAME = "RISCV-LMUL";

bool RISCVLMULInstrument::isDataValid(toolchain::StringRef Data) {
...
const toolchain::StringRef RISCVSEWInstrument::DESC_NAME = "RISCV-SEW";

bool RISCVSEWInstrument::isDataValid(toolchain::StringRef Data) {
...
bool RISCVInstrumentManager::supportsInstrumentType(
    toolchain::StringRef Type) const {
...
UniqueInstrument
RISCVInstrumentManager::createInstrument(toolchain::StringRef Desc,
