...
public:
  ...
  /// Intrinsics",
  /// https://toolchain.org/docs/LangRef.html#vector-predication-intrinsics and
  /// "IR-level VP intrinsics",
  /// https://toolchain.org/docs/Proposals/VectorPredication.html#ir-level-vp-intrinsics).
