...
RISCVAsmBackend::RISCVAsmBackend(const MCSubtargetInfo &STI, uint8_t OSABI,
    ...
    : MCAsmBackend(IsLittleEndian ? toolchain::endianness::little
...
void RISCVAsmBackend::applyFixup(const MCFragment &F, const MCFixup &Fixup,
  ...
  bool SwapValue = Endian == toolchain::endianness::big && isDataFixup(Kind);
...
MCAsmBackend *toolchain::createRISCVAsmBackend(const Target &T,
                                          const MCSubtargetInfo &STI,
