...
private:
  ...
  /// Perform several checks on the arguments of @toolchain.get.active.lane.mask
...
//
//    @toolchain.get.active.lane.mask(IV, TC)
//
...
void MVETailPredication::InsertVCTPIntrinsic(IntrinsicInst *ActiveLaneMask,
  ...
  // Replace @toolchain.get.active.mask() with the ARM specific VCTP intrinic, and
...
Pass *toolchain::createMVETailPredicationPass() {
