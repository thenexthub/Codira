...
//===----------------------------------------------------------------------===//
//
/// This pass custom lowers toolchain.gather and toolchain.scatter instructions to
...
Pass *toolchain::createMVEGatherScatterLoweringPass() {
...
Instruction *MVEGatherScatterLowering::lowerGather(IntrinsicInst *I) {
  ...
  // @toolchain.masked.gather.*(Ptrs, alignment, Mask, Src0)
...
Instruction *MVEGatherScatterLowering::lowerScatter(IntrinsicInst *I) {
  ...
  // @toolchain.masked.scatter.*(data, ptrs, alignment, mask)
