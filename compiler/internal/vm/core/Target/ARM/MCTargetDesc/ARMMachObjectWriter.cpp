...
static bool getARMFixupKindMachOInfo(unsigned Kind, unsigned &RelocType,
  ...
  case FK_Data_1:
    Log2Size = toolchain::Log2_32(1);
    return true;
  case FK_Data_2:
    Log2Size = toolchain::Log2_32(2);
    return true;
  case FK_Data_4:
    Log2Size = toolchain::Log2_32(4);
    return true;
  case FK_Data_8:
    Log2Size = toolchain::Log2_32(8);
    return false;
...
toolchain::createARMMachObjectWriter(bool Is64Bit, uint32_t CPUType,
                                uint32_t CPUSubtype) {
...
MCTargetStreamer *toolchain::createARMObjectTargetMachOStreamer(MCStreamer &S) {
