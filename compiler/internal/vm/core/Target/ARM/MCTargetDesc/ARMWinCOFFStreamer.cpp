...
MCStreamer *
toolchain::createARMWinCOFFStreamer(MCContext &Context,
...
namespace {
class ARMTargetWinCOFFStreamer : public toolchain::ARMTargetStreamer {
public:
  ARMTargetWinCOFFStreamer(toolchain::MCStreamer &S) : ARMTargetStreamer(S) {}
...
MCTargetStreamer *toolchain::createARMObjectTargetWinCOFFStreamer(MCStreamer &S) {
