...
#include "vm/core/CodeGen/IndirectThunks.h"
...
void SLSBLRThunkInserter::populateThunk(MachineFunction &MF) {
  ...
  auto ThunkIt = toolchain::find_if(
...
MachineBasicBlock &ARMSLSHardening::ConvertIndirectCallToIndirectJump(
  ...
  auto ThunkIt = toolchain::find_if(SLSBLRThunks, [Reg, isThumb](auto T) {
...
FunctionPass *toolchain::createARMSLSHardeningPass() {
...
FunctionPass *toolchain::createARMIndirectThunks() {
