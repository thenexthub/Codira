...
static MachineInstr *getBlockStructInstr(Register ParamReg,
  ...
  //   %0:_(pN) = G_INTRINSIC_W_SIDE_EFFECTS intrinsic(@toolchain.spv.alloca)
  //   or       = G_GLOBAL_VALUE @block_literal_global
  //   %1:_(pN) = G_INTRINSIC_W_SIDE_EFFECTS intrinsic(@toolchain.spv.bitcast), %0
...
static bool buildAPFixedPointInst(const SPIRV::IncomingCall *Call,
  ...
  if (IsSRet) {
    ...
    if (InputType->getTypeID() == toolchain::Type::TypeID::TypedPointerTyID) {
