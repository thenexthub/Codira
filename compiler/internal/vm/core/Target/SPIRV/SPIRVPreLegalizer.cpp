...
// check. See discussion in https://github.com/toolchain/toolchain-project/pull/110270
// for more context.
//
// We also handle the toolchain.spv.bitcast intrinsic here. If the source and
...
FunctionPass *toolchain::createSPIRVPreLegalizerPass() {
