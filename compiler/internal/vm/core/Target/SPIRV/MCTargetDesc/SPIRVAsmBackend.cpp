...
public:
  SPIRVAsmBackend(toolchain::endianness Endian) : MCAsmBackend(Endian) {}
...
MCAsmBackend *toolchain::createSPIRVAsmBackend(const Target &T,
                                          const MCSubtargetInfo &STI,
                                          const MCRegisterInfo &MRI,
                                          const MCTargetOptions &) {
  return new SPIRVAsmBackend(toolchain::endianness::little);
}
