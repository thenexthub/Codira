...
MachineFunctionPass *
toolchain::createSPIRVEmitNonSemanticDIPass(SPIRVTargetMachine *TM) {
...
bool SPIRVEmitNonSemanticDI::emitGlobalDI(MachineFunction &MF) {
  ...
  // information like DwarfVersion or SourceLanguage
  {
    ...
    const NamedMDNode *DbgCu = M->getNamedMetadata("toolchain.dbg.cu");
    if (!DbgCu)
      return false;
    ...
    const NamedMDNode *ModuleFlags = M->getNamedMetadata("toolchain.module.flags");
    assert(ModuleFlags && "Expected toolchain.module.flags metadata to be present");
