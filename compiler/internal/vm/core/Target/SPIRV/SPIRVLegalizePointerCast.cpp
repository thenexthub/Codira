...
class SPIRVLegalizePointerCast : public FunctionPass {
  ...
  // Creates an spv_insertelt instruction (equivalent to toolchain's insertelement).
  ...
  // Creates an spv_extractelt instruction (equivalent to toolchain's
  // extractelement).
...
FunctionPass *toolchain::createSPIRVLegalizePointerCastPass(SPIRVTargetMachine *TM) {
