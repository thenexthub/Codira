...
cl::opt<bool> toolchain::HexagonDisableCompound
  ("mno-compound",
   cl::desc("Disable looking for compound instructions for Hexagon"));

cl::opt<bool> toolchain::HexagonDisableDuplex
  ("mno-pairing",
...
unsigned toolchain::HexagonGetLastSlot() { return HexagonItinerariesV5FU::SLOT3; }

unsigned toolchain::HexagonConvertUnits(unsigned ItinUnits, unsigned *Lanes) {
  enum {
    CVI_NONE = 0,
    CVI_XLANE = 1 << 0,
    CVI_SHIFT = 1 << 1,
...
toolchain::MCInstrInfo *toolchain::createHexagonMCInstrInfo() {
...
MCSubtargetInfo *Hexagon_MC::createHexagonMCSubtargetInfo(const Triple &TT,
  ...
  if (checkFeature(X, Hexagon::ExtensionHVXV68) &&
    ...
    toolchain::FeatureBitset Features = X->getFeatureBits();
...
unsigned Hexagon_MC::GetELFFlags(const MCSubtargetInfo &STI) {
  return StringSwitch<unsigned>(STI.getCPU())
      .Case("generic", toolchain::ELF::EF_HEXAGON_MACH_V5)
      .Case("hexagonv5", toolchain::ELF::EF_HEXAGON_MACH_V5)
      .Case("hexagonv55", toolchain::ELF::EF_HEXAGON_MACH_V55)
      .Case("hexagonv60", toolchain::ELF::EF_HEXAGON_MACH_V60)
      .Case("hexagonv62", toolchain::ELF::EF_HEXAGON_MACH_V62)
      .Case("hexagonv65", toolchain::ELF::EF_HEXAGON_MACH_V65)
      .Case("hexagonv66", toolchain::ELF::EF_HEXAGON_MACH_V66)
      .Case("hexagonv67", toolchain::ELF::EF_HEXAGON_MACH_V67)
      .Case("hexagonv67t", toolchain::ELF::EF_HEXAGON_MACH_V67T)
      .Case("hexagonv68", toolchain::ELF::EF_HEXAGON_MACH_V68)
      .Case("hexagonv69", toolchain::ELF::EF_HEXAGON_MACH_V69)
      .Case("hexagonv71", toolchain::ELF::EF_HEXAGON_MACH_V71)
      .Case("hexagonv71t", toolchain::ELF::EF_HEXAGON_MACH_V71T)
      .Case("hexagonv73", toolchain::ELF::EF_HEXAGON_MACH_V73)
      .Case("hexagonv75", toolchain::ELF::EF_HEXAGON_MACH_V75)
      .Case("hexagonv79", toolchain::ELF::EF_HEXAGON_MACH_V79)
      .Case("hexagonv81", toolchain::ELF::EF_HEXAGON_MACH_V81);
}

toolchain::ArrayRef<MCPhysReg> Hexagon_MC::GetVectRegRev() {
