...
public:
  HexagonAsmBackend(const Target &T, const Triple &TT, uint8_t OSABI,
                    StringRef CPU)
      : MCAsmBackend(toolchain::endianness::little), OSABI(OSABI), CPU(CPU),
  ...
  bool isInstRelaxable(MCInst const &HMI) const {
    ...
    if (toolchain::HexagonMCInstrInfo::getType(*MCII, HMI) == HexagonII::TypeJ ||
        (toolchain::HexagonMCInstrInfo::getType(*MCII, HMI) == HexagonII::TypeCODE &&
         MCID.isBranch()) ||
        (toolchain::HexagonMCInstrInfo::getType(*MCII, HMI) == HexagonII::TypeNCODE &&
         MCID.isBranch()) ||
        (toolchain::HexagonMCInstrInfo::getType(*MCII, HMI) == HexagonII::TypeCR &&
        ...
        case MCFragment::FT_Align: {
          ...
          for (auto K = J; K != 0 && Size >= HEXAGON_PACKET_SIZE;) {
            ...
            case MCFragment::FT_Relaxable: {
              ...
              const bool WouldTraverseLabel = toolchain::any_of(
...
// MCAsmBackend
MCAsmBackend *toolchain::createHexagonAsmBackend(Target const &T,
