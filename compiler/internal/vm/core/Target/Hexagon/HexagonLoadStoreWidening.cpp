...
bool HexagonLoadStoreWidening::replaceInsts(InstrGroup &OG, InstrGroup &NG) {
  ...
  InstrSet OldMemInsts(toolchain::from_range, OG);
...
FunctionPass *toolchain::createHexagonStoreWidening() {
  return new HexagonStoreWidening();
}

FunctionPass *toolchain::createHexagonLoadWidening() {
