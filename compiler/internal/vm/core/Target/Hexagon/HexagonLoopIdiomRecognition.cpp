...
bool PolynomialMultiplyRecognize::promoteTypes(BasicBlock *LoopB,
  ...
  SmallVector<Instruction *> LoopIns(toolchain::make_pointer_range(*LoopB));
...
bool PolynomialMultiplyRecognize::convertShiftsToLeft(BasicBlock *LoopB,
  ...
  ValueSeq Users(toolchain::from_range, Cycled);
  ...
  ValueSeq Internal(toolchain::from_range, Users);
  ValueSeq Inputs;
...
void PolynomialMultiplyRecognize::cleanupLoopBody(BasicBlock *LoopB) {
  ...
  for (Instruction &I : toolchain::make_early_inc_range(*LoopB))
...
bool HexagonLoopIdiomRecognize::coverLoop(Loop *L,
  ...
  SetVector<Instruction *> Worklist(toolchain::from_range, Insts);
...
Pass *toolchain::createHexagonLoopIdiomPass() {
