...
public:
  X86AsmBackend(const Target &T, const MCSubtargetInfo &STI)
      : MCAsmBackend(toolchain::endianness::little), STI(STI),
...
MCAsmBackend *toolchain::createX86_32AsmBackend(const Target &T,
                                           const MCSubtargetInfo &STI,
                                           const MCRegisterInfo &MRI,
...
MCAsmBackend *toolchain::createX86_64AsmBackend(const Target &T,
                                           const MCSubtargetInfo &STI,
                                           const MCRegisterInfo &MRI,
                                           const MCTargetOptions &Options) {
  const Triple &TheTriple = STI.getTargetTriple();
...
MCStreamer *toolchain::createX86ELFStreamer(const Triple &T, MCContext &Context,
