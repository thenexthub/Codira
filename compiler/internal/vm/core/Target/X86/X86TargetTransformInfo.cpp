...
/// values reported by the CPU scheduler models (and toolchain-mca).
...
/// by the CPU scheduler models (and toolchain-mca), to ensure that they are
...
InstructionCost X86TTIImpl::getShuffleCost(TTI::ShuffleKind Kind,
  ...
  if (ST->hasSSE2()) {
    bool IsLoad =
        toolchain::any_of(Args, [](const auto &V) { return isa<LoadInst>(V); });
...
InstructionCost X86TTIImpl::getCastInstrCost(unsigned Opcode, Type *Dst,
  ...
  static const TypeConversionCostKindTblEntry SSE2ConversionTbl[] = {
    ...
    // output of toolchain-mca for our various supported scheduler models
...
X86TTIImpl::getIntrinsicInstrCost(const IntrinsicCostAttributes &ICA,
  ...
  // BITREVERSE: toolchain\test\CodeGen\X86\vector-bitreverse.ll
  // BSWAP: toolchain\test\CodeGen\X86\bswap-vector.ll
  // CTLZ: toolchain\test\CodeGen\X86\vector-lzcnt-*.ll
  // CTPOP: toolchain\test\CodeGen\X86\vector-popcnt-*.ll
  // CTTZ: toolchain\test\CodeGen\X86\vector-tzcnt-*.ll
...
bool X86TTIImpl::areTypesABICompatible(const Function *Caller,
  ...
  return toolchain::none_of(Types,
