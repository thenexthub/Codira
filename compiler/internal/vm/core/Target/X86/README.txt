...
entry:
  %t = call {i32, i1} @toolchain.sadd.with.overflow.i32(i32 %v1, i32 %v2)
...
normal:
  ret i32 %sum
overflow:
  call void @toolchain.trap()
  unreachable
}
declare {i32, i1} @toolchain.sadd.with.overflow.i32(i32, i32)
declare void @toolchain.trap()
...
define <16 x float> @foo(<16 x float> %A) nounwind {
	...
	call void @toolchain.memcpy.i64(i8* %s, i8* %s2, i64 64, i32 16)
	%R = load <16 x float>* %tmp2
	ret <16 x float> %R
}

declare void @toolchain.memcpy.i64(i8* nocapture, i8* nocapture, i64, i32) nounwind
...
entry:
  %uadd = tail call %0 @toolchain.uadd.with.overflow.i32(i32 %sum, i32 %x)
...
declare %0 @toolchain.uadd.with.overflow.i32(i32, i32) nounwind readnone
