...
static const IntrinsicData IntrinsicsWithoutChain[] = {
    ...
    X86_INTRINSIC_DATA(avx10_vcvtbf162ibs512, INTR_TYPE_1OP, X86ISD::CVTP2IBS,
                       0),
    X86_INTRINSIC_DATA(avx10_vcvtbf162iubs128, INTR_TYPE_1OP, X86ISD::CVTP2IUBS,
                       0),
    X86_INTRINSIC_DATA(avx10_vcvtbf162iubs256, INTR_TYPE_1OP, X86ISD::CVTP2IUBS,
                       0),
    ...
    X86_INTRINSIC_DATA(avx10_vcvttbf162ibs256, INTR_TYPE_1OP, X86ISD::CVTTP2IBS,
                       0),
    X86_INTRINSIC_DATA(avx10_vcvttbf162ibs512, INTR_TYPE_1OP, X86ISD::CVTTP2IBS,
                       0),
...
static void verifyIntrinsicTables() {
  assert(toolchain::is_sorted(IntrinsicsWithoutChain) &&
         toolchain::is_sorted(IntrinsicsWithChain) &&
