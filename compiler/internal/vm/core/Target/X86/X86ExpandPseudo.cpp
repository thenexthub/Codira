...
#include "vm/core/CodeGen/Passes.h" // For IDs of passes that are preserved.
...
void X86ExpandPseudoImpl::expandCALL_RVMARKER(
  ...
  for (MachineOperand &Op : toolchain::drop_begin(MI.operands())) {
...
FunctionPass *toolchain::createX86ExpandPseudoLegacyPass() {
