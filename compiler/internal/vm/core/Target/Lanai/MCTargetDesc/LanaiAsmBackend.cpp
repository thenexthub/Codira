...
public:
  LanaiAsmBackend(const Target &T, Triple::OSType OST)
      : MCAsmBackend(toolchain::endianness::big), OSType(OST) {}
...
MCFixupKindInfo LanaiAsmBackend::getFixupKindInfo(MCFixupKind Kind) const {
  static const MCFixupKindInfo Infos[Lanai::NumTargetFixupKinds] = {
      ...
      //   for these 21-bit relocation as toolchain/lib/MC/MCAsmStreamer.cpp checks
...
MCAsmBackend *toolchain::createLanaiAsmBackend(const Target &T,
