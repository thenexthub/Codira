...
static toolchain::cl::opt<bool> DisableMemAluCombiner(
    "disable-lanai-mem-alu-combiner", toolchain::cl::init(false),
    toolchain::cl::desc("Do not combine ALU and memory operators"),
    toolchain::cl::Hidden);
...
FunctionPass *toolchain::createLanaiMemAluCombinerPass() {
