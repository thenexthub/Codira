...
LanaiTargetLowering::LanaiTargetLowering(const TargetMachine &TM,
  ...
  MaxStoresPerMemset = 16; // For @toolchain.memset -> sequence of stores
  MaxStoresPerMemsetOptSize = 8;
  MaxStoresPerMemcpy = 16; // For @toolchain.memcpy -> sequence of stores
  MaxStoresPerMemcpyOptSize = 8;
  MaxStoresPerMemmove = 16; // For @toolchain.memmove -> sequence of stores
