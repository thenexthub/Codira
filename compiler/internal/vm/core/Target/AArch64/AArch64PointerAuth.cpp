...
using namespace vm::core::AArch64PAuth;
...
FunctionPass *toolchain::createAArch64PointerAuthPass() {
...
unsigned toolchain::AArch64PAuth::getCheckerSizeInBytes(AuthCheckMethod Method) {
  switch (Method) {
