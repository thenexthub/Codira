...
AArch64LegalizerInfo::AArch64LegalizerInfo(const AArch64Subtarget &ST)
  ...
  getActionDefinitionsBuilder(G_STORE)
      ...
      .legalForTypesWithMemDesc({
          ...
          //       See #92130
          // https://github.com/toolchain/toolchain-project/pull/92130#discussion_r1616888461
          {nxv16s8, p0, nxv16s8, 8},
          {nxv8s16, p0, nxv8s16, 8},
          {nxv4s32, p0, nxv4s32, 8},
          {nxv2s64, p0, nxv2s64, 8},
  ...
  auto IndexedLoadBasicPred = [=](const LegalityQuery &Query) {
    ...
    if (!toolchain::is_contained(PackedVectorAllTypesVec, LdTy) &&
        !toolchain::is_contained(ScalarAndPtrTypesVec, LdTy) && LdTy != s128)
      return false;
    if (PtrTy != p0)
      return false;
    return true;
