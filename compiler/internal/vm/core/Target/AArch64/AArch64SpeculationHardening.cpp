...
//  https://toolchain.org/docs/SpeculativeLoadHardening.html), the following
// implementation choices are made for AArch64:
//   - Many of the optimizations described at
//     https://toolchain.org/docs/SpeculativeLoadHardening.html to harden fewer
...
bool AArch64SpeculationHardening::slhLoads(MachineBasicBlock &MBB) {
  ...
  for (; MBBI != E; MBBI = NextMBBI) {
    ...
    bool AllDefsAreGPR = toolchain::all_of(MI.defs(), [&](MachineOperand &Op) {
    ...
    // https://toolchain.org/docs/SpeculativeLoadHardening.html
...
FunctionPass *toolchain::createAArch64SpeculationHardeningPass() {
