...
static bool splitBitmaskImm(T Imm, unsigned RegSize, T &Imm1Enc, T &Imm2Enc) {
  ...
  unsigned LowestBitSet = toolchain::countr_zero(UImm);
...
static bool splitDisjointBitmaskImm(T Imm, unsigned RegSize, T &Imm1Enc,
  ...
  unsigned LowestBitSet = toolchain::countr_zero(Imm);
  unsigned LowestGapBitUnset =
      LowestBitSet + toolchain::countr_one(Imm >> LowestBitSet);
...
FunctionPass *toolchain::createAArch64MIPeepholeOptPass() {
