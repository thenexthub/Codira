...
bool M68kInstrInfo::AnalyzeBranchImpl(MachineBasicBlock &MBB,
  ...
  std::vector<std::reference_wrapper<toolchain::MachineInstr>> EraseList;
  toolchain::scope_exit FinalizeOnReturn([&EraseList] {
...
FunctionPass *toolchain::createM68kGlobalBaseRegPass() {
