...
public:
  M68kAsmBackend(const Target &T, const MCSubtargetInfo &STI)
      : MCAsmBackend(toolchain::endianness::big),
        Allows32BitBranch(toolchain::StringSwitch<bool>(STI.getCPU())
...
MCAsmBackend *toolchain::createM68kAsmBackend(const Target &T,
