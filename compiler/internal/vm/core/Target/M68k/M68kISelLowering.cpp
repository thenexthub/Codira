...
SDValue M68kTargetLowering::LowerExternalSymbolCall(SelectionDAG &DAG,
                                                    SDLoc Loc,
                                                    toolchain::StringRef SymbolName,
...
SDValue M68kTargetLowering::getPICODEumpTableRelocBase(SDValue Table,
                                                     SelectionDAG &DAG) const {
...
const MCExpr *M68kTargetLowering::getPICODEumpTableRelocBaseExpr(
