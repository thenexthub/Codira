...
// Functions that are toolchain intrinsics and don't need helpers.
static const char *const IntrinsicInline[] = {
  "fabs", "fabsf",
  "toolchain.ceil.f32", "toolchain.ceil.f64",
  "toolchain.copysign.f32", "toolchain.copysign.f64",
  "toolchain.cos.f32", "toolchain.cos.f64",
  "toolchain.exp.f32", "toolchain.exp.f64",
  "toolchain.exp2.f32", "toolchain.exp2.f64",
  "toolchain.fabs.f32", "toolchain.fabs.f64",
  "toolchain.floor.f32", "toolchain.floor.f64",
  "toolchain.fma.f32", "toolchain.fma.f64",
  "toolchain.log.f32", "toolchain.log.f64",
  "toolchain.log10.f32", "toolchain.log10.f64",
  "toolchain.nearbyint.f32", "toolchain.nearbyint.f64",
  "toolchain.pow.f32", "toolchain.pow.f64",
  "toolchain.powi.f32.i32", "toolchain.powi.f64.i32",
  "toolchain.rint.f32", "toolchain.rint.f64",
  "toolchain.round.f32", "toolchain.round.f64",
  "toolchain.sin.f32", "toolchain.sin.f64",
  "toolchain.sqrt.f32", "toolchain.sqrt.f64",
  "toolchain.trunc.f32", "toolchain.trunc.f64",
};

static bool isIntrinsicInline(Function *F) {
  return toolchain::binary_search(IntrinsicInline, F->getName());
}
...
ModulePass *toolchain::createMips16HardFloatPass() {
