...
typedef toolchain::SmallVector<ReduceEntry, 32> ReduceEntryVector;
...
public:
  ...
  toolchain::StringRef getPassName() const override {
...
FunctionPass *toolchain::createMicroMipsSizeReducePass() {
