...
private:
  ...
  void writeDIAssignID(const DIAssignID *N, SmallVectorImpl<uint64_t> &Record,
    ...
    //   See https://github.com/toolchain/toolchain-project/issues/58989
...
void DXILBitcodeWriter::writeFunctionLevelValueSymbolTable(
  ...
  toolchain::sort(SortedTable, [](const ValueName *A, const ValueName *B) {
...
void DXILBitcodeWriter::write() {
  // The identification block is new since toolchain-3.7, but the old bitcode reader
  // will skip it.
