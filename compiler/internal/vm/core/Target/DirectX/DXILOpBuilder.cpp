...
struct OpCodeProperty {
  ...
  toolchain::SmallVector<OpOverload> Overloads;
  toolchain::SmallVector<OpStage> Stages;
...
// toolchain function attribute that is set onto the instruction
...
Expected<CallInst *> DXILOpBuilder::tryCreateOp(dxil::OpCode OpCode,
  ...
  OpArgs.push_back(IRB.getInt32(toolchain::to_underlying(OpCode)));
