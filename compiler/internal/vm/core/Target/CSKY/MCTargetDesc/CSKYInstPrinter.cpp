...
// The command-line flags above are used by toolchain-mc and llc. They can be used by
// `toolchain-objdump`, but we override their values here to handle options passed to
