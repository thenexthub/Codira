...
MCFixupKindInfo CSKYAsmBackend::getFixupKindInfo(MCFixupKind Kind) const {
  ...
  static toolchain::DenseMap<unsigned, MCFixupKindInfo> Infos = {
...
void CSKYAsmBackend::applyFixup(const MCFragment &F, const MCFixup &Fixup,
  ...
  bool IsLittleEndian = (Endian == toolchain::endianness::little);
...
MCAsmBackend *toolchain::createCSKYAsmBackend(const Target &T,
