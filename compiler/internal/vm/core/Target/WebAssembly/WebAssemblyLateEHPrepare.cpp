...
FunctionPass *toolchain::createWebAssemblyLateEHPrepare() {
...
bool WebAssemblyLateEHPrepare::replaceFuncletReturns(MachineFunction &MF) {
  ...
  for (auto &MBB : MF) {
    ...
    case WebAssembly::RETHROW:
      // These RETHROWs here were lowered from toolchain.wasm.rethrow() intrinsics,
      ...
      // argument.) For these toolchain.wasm.rethrow()s, we can safely assume the
