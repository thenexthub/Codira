...
static APInt encodeFunctionSignature(SelectionDAG *DAG, SDLoc &DL,
  ...
  auto toWasmValType = [](MVT VT) {
    ...
    LLVM_DEBUG(errs() << "Unhandled type for toolchain.wasm.ref.test.func: " << VT
                      << "\n");
    llvm_unreachable("Unhandled type for toolchain.wasm.ref.test.func");
  };
...
FunctionPass *toolchain::createWebAssemblyISelDag(WebAssemblyTargetMachine &TM,
                                             CodeGenOptLevel OptLevel) {
