...
bool PPCLowerMASSVEntries::isMASSVFunc(StringRef Name) {
  return toolchain::is_contained(MASSVFuncs, Name);
}
...
/// If there are proper fast-math flags, this function creates toolchain.pow
...
char &toolchain::PPCLowerMASSVEntriesID = PPCLowerMASSVEntries::ID;

INITIALIZE_PASS(PPCLowerMASSVEntries, DEBUG_TYPE, "Lower MASSV entries", false,
                false)

ModulePass *toolchain::createPPCLowerMASSVEntriesPass() {
