...
FunctionPass *toolchain::createPPCLoopInstrFormPrepPass(PPCTargetMachine &TM) {
...
bool PPCLoopInstrFormPrep::rewriteLoadStores(
  ...
  for (const BucketElement &BE : toolchain::drop_begin(BucketChain.Elements)) {
