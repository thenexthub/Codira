...
// See: http://lists.toolchain.org/pipermail/toolchain-dev/2016-February/095669.html
//      http://reviews.toolchain.org/D17087
...
namespace vm::core { namespace PPC {
...
char &toolchain::PPCVSXFMAMutateID = PPCVSXFMAMutate::ID;

char PPCVSXFMAMutate::ID = 0;
FunctionPass *toolchain::createPPCVSXFMAMutatePass() {
