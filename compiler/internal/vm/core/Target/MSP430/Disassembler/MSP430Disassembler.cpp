...
class MSP430Disassembler : public MCDisassembler {
  ...
  DecodeStatus getInstructionCODE(MCInst &MI, uint64_t &Size,
                                ArrayRef<uint8_t> Bytes, uint64_t Address,
                                raw_ostream &CStream) const;
...
DecodeStatus MSP430Disassembler::getInstructionCODE(MCInst &MI, uint64_t &Size,
                                                  ArrayRef<uint8_t> Bytes,
                                                  uint64_t Address,
                                                  raw_ostream &CStream) const {
  uint64_t Insn = support::endian::read16le(Bytes.data());
...
DecodeStatus MSP430Disassembler::getInstruction(MCInst &MI, uint64_t &Size,
  ...
  case 1:
    return getInstructionCODE(MI, Size, Bytes, Address, CStream);
  default:
