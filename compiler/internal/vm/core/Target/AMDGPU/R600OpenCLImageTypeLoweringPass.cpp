...
static StringRef GetImageSizeFunc =         "toolchain.OpenCL.image.get.size";
static StringRef GetImageFormatFunc =       "toolchain.OpenCL.image.get.format";
static StringRef GetImageResourceIDFunc =   "toolchain.OpenCL.image.get.resource.id";
static StringRef GetSamplerResourceIDFunc =
    "toolchain.OpenCL.sampler.get.resource.id";
...
ModulePass *toolchain::createR600OpenCLImageTypeLoweringPass() {
