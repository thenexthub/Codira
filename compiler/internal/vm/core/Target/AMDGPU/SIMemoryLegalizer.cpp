...
/// found here:
///   http://toolchain.org/docs/AMDGPUUsage.html#memory-model
//
//===----------------------------------------------------------------------===//
...
char &toolchain::SIMemoryLegalizerID = SIMemoryLegalizerLegacy::ID;

FunctionPass *toolchain::createSIMemoryLegalizerPass() {
