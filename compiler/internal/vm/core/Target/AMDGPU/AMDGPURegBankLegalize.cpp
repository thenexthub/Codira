...
using namespace vm::core::MIPatternMatch;
...
char &toolchain::AMDGPURegBankLegalizeID = AMDGPURegBankLegalize::ID;

FunctionPass *toolchain::createAMDGPURegBankLegalizePass() {
