...
char &toolchain::SIWholeQuadModeID = SIWholeQuadModeLegacy::ID;

FunctionPass *toolchain::createSIWholeQuadModeLegacyPass() {
...
char SIWholeQuadMode::scanInstructions(MachineFunction &MF,
  ...
  // semantics of @toolchain.amdgcn.set.inactive.
  // Similarly for SOFT_WQM instructions, implementing @toolchain.amdgcn.softwqm.
...
void SIWholeQuadMode::lowerBlock(MachineBasicBlock &MBB, BlockInfo &BI) {
  ...
  for (MachineInstr &MI : toolchain::make_early_inc_range(
           toolchain::make_range(MBB.getFirstNonPHI(), MBB.end()))) {
