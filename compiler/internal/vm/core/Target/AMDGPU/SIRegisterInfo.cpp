...
SIRegisterInfo::SIRegisterInfo(const GCNSubtarget &ST)
  ...
  static toolchain::once_flag InitializeRegSplitPartsFlag;
  ...
  static toolchain::once_flag InitializeSubRegFromChannelTableFlag;
  ...
  toolchain::call_once(InitializeRegSplitPartsFlag, InitializeRegSplitPartsOnce);
  toolchain::call_once(InitializeSubRegFromChannelTableFlag,
...
BitVector SIRegisterInfo::getReservedRegs(const MachineFunction &MF) const {
  ...
  // M0 has to be reserved so that toolchain accepts it as a live-in into a block.
