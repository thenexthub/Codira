...
#include "vm/core/Analysis/CallGraphSCCPass.h"
...
#include "vm/core/CodeGen/MIRParser/MIParser.h"
...
#include "vm/core/Passes/CodeGenPassBuilder.h"
...
#include "vm/core/Transforms/Utils/LCSSA.h"
...
static toolchain::once_flag InitializeDefaultSGPRRegisterAllocatorFlag;
static toolchain::once_flag InitializeDefaultVGPRRegisterAllocatorFlag;
static toolchain::once_flag InitializeDefaultWWMRegisterAllocatorFlag;
...
AMDGPUTargetMachine::AMDGPUTargetMachine(const Target &T, const Triple &TT,
  ...
  if (TT.isAMDGCN()) {
    if (getMCSubtargetInfo()->checkFeatures("+wavefrontsize64"))
      MRI.reset(toolchain::createGCNMCRegisterInfo(AMDGPUDwarfFlavour::Wave64));
    else if (getMCSubtargetInfo()->checkFeatures("+wavefrontsize32"))
      MRI.reset(toolchain::createGCNMCRegisterInfo(AMDGPUDwarfFlavour::Wave32));
  }
}
...
std::unique_ptr<CSEConfigBase> toolchain::AMDGPUPassConfig::getCSEConfig() const {
...
FunctionPass *GCNPassConfig::createSGPRAllocPass(bool Optimized) {
  ...
  toolchain::call_once(InitializeDefaultSGPRRegisterAllocatorFlag,
...
FunctionPass *GCNPassConfig::createVGPRAllocPass(bool Optimized) {
  // Initialize the global default.
  toolchain::call_once(InitializeDefaultVGPRRegisterAllocatorFlag,
...
FunctionPass *GCNPassConfig::createWWMRegAllocPass(bool Optimized) {
  // Initialize the global default.
  toolchain::call_once(InitializeDefaultWWMRegisterAllocatorFlag,
