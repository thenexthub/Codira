...
AMDGPURegisterBankInfo::AMDGPURegisterBankInfo(const GCNSubtarget &ST)
  ...
  static toolchain::once_flag InitializeRegisterBankFlag;
  ...
  toolchain::call_once(InitializeRegisterBankFlag, InitializeRegisterBankOnce);
}
...
// Analyze a combined offset from an toolchain.amdgcn.s.buffer intrinsic and store
