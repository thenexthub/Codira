...
static toolchain::cl::opt<unsigned> DefaultAMDHSACodeObjectVersion(
    "amdhsa-code-object-version", toolchain::cl::Hidden,
    toolchain::cl::init(toolchain::AMDGPU::AMDHSA_COV6),
    toolchain::cl::desc("Set default AMDHSA Code Object Version (module flag "
...
bool isInlinableLiteral64(int64_t Literal, bool HasInv2Pi) {
  ...
  return (Val == toolchain::bit_cast<uint64_t>(0.0)) ||
         (Val == toolchain::bit_cast<uint64_t>(1.0)) ||
         (Val == toolchain::bit_cast<uint64_t>(-1.0)) ||
         (Val == toolchain::bit_cast<uint64_t>(0.5)) ||
         (Val == toolchain::bit_cast<uint64_t>(-0.5)) ||
         (Val == toolchain::bit_cast<uint64_t>(2.0)) ||
         (Val == toolchain::bit_cast<uint64_t>(-2.0)) ||
         (Val == toolchain::bit_cast<uint64_t>(4.0)) ||
         (Val == toolchain::bit_cast<uint64_t>(-4.0)) ||
...
bool isInlinableLiteral32(int32_t Literal, bool HasInv2Pi) {
  ...
  return (Val == toolchain::bit_cast<uint32_t>(0.0f)) ||
         (Val == toolchain::bit_cast<uint32_t>(1.0f)) ||
         (Val == toolchain::bit_cast<uint32_t>(-1.0f)) ||
         (Val == toolchain::bit_cast<uint32_t>(0.5f)) ||
         (Val == toolchain::bit_cast<uint32_t>(-0.5f)) ||
         (Val == toolchain::bit_cast<uint32_t>(2.0f)) ||
         (Val == toolchain::bit_cast<uint32_t>(-2.0f)) ||
         (Val == toolchain::bit_cast<uint32_t>(4.0f)) ||
         (Val == toolchain::bit_cast<uint32_t>(-4.0f)) ||
