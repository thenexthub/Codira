...
// clang-format off
// This must be in sync with toolchain::AMDGPU::Swizzle::Id enum members, see SIDefines.h.
...
// This must be in sync with toolchain::AMDGPU::VGPRIndexMode::Id enum members, see SIDefines.h.
const char* const IdSymbolic[] = {
  "SRC0",
  "SRC1",
  "SRC2",
