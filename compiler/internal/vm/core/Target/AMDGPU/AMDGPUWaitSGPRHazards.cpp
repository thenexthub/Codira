  ...
  bool runOnMachineBasicBlock(MachineBasicBlock &MBB, bool Emit) {
    ...
    for (MachineBasicBlock::instr_iterator MI = MBB.instr_begin(),
      ...
      const bool HasImplicitVCC =
          toolchain::any_of(MI->getDesc().implicit_uses(), isVCC) ||
          toolchain::any_of(MI->getDesc().implicit_defs(), isVCC);
...
char &toolchain::AMDGPUWaitSGPRHazardsLegacyID = AMDGPUWaitSGPRHazardsLegacy::ID;
