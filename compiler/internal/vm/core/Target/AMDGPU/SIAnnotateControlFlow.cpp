...
private:
  ...
  Value *
  handleLoopCondition(Value *Cond, PHINode *Broken, toolchain::Loop *L,
                      BranchInst *Term);
...
Value *SIAnnotateControlFlow::handleLoopCondition(
    Value *Cond, PHINode *Broken, toolchain::Loop *L, BranchInst *Term) {
...
bool SIAnnotateControlFlow::handleLoop(BranchInst *Term) {
  ...
  toolchain::Loop *L = LI->getLoopFor(BB);
  if (!L)
    return false;
...
FunctionPass *toolchain::createSIAnnotateControlFlowLegacyPass() {
