...
/// https://toolchain.org/docs/AMDGPUUsage.html#initial-kernel-execution-state)
...
public:
  ...
  tryAllocHiddenArgPreloadSGPRs(uint64_t ImplicitArgsBaseOffset,
    ...
    auto *PreloadEnd = toolchain::find_if(
...
ModulePass *
toolchain::createAMDGPUPreloadKernelArgumentsLegacyPass(const TargetMachine *TM) {
