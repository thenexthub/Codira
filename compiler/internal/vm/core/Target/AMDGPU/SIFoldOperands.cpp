...
char &toolchain::SIFoldOperandsLegacyID = SIFoldOperandsLegacy::ID;
...
FunctionPass *toolchain::createSIFoldOperandsLegacyPass() {
...
void SIFoldOperandsImpl::foldOperand(
  ...
  if (UseMI->isRegSequence()) {
    ...
    SmallVector<MachineOperand *, 4> UsesToProcess(
        toolchain::make_pointer_range(MRI->use_nodbg_operands(RegSeqDstReg)));
...
bool SIFoldOperandsImpl::foldInstOperand(MachineInstr &MI,
  ...
  SmallVector<MachineOperand *, 4> UsesToProcess(
      toolchain::make_pointer_range(MRI->use_nodbg_operands(Dst.getReg())));
...
bool SIFoldOperandsImpl::tryFoldLoad(MachineInstr &MI) {
  ...
  SmallVector<const MachineInstr *, 8> Users(
      toolchain::make_pointer_range(MRI->use_nodbg_instructions(DefReg)));
