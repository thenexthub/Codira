...
char &toolchain::AMDGPUPrintfRuntimeBindingID = AMDGPUPrintfRuntimeBinding::ID;

ModulePass *toolchain::createAMDGPUPrintfRuntimeBinding() {
...
bool AMDGPUPrintfRuntimeBindingImpl::lowerPrintfForGpu(Module &M) {
  ...
  // extracted and passed as metadata. This avoids polluting toolchain's symbol
