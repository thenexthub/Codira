...
char &toolchain::SIPostRABundlerLegacyID = SIPostRABundlerLegacy::ID;

FunctionPass *toolchain::createSIPostRABundlerPass() {
...
bool SIPostRABundler::run(MachineFunction &MF) {
  ...
  for (MachineBasicBlock &MBB : MF) {
    bool HasIGLPInstrs = toolchain::any_of(MBB.instrs(), [](MachineInstr &MI) {
