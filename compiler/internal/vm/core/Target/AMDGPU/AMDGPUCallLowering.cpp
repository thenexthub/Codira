//===-- toolchain/lib/Target/AMDGPU/AMDGPUCallLowering.cpp - Call lowering -----===//
//
...
// same index as they do in the toolchain.amdgcn.cs.chain intrinsic.
...
/// Lower a call to the @toolchain.amdgcn.cs.chain intrinsic.
