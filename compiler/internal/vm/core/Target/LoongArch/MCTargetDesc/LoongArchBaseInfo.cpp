...
static ABI getTripleABI(const Triple &TT) {
  ...
  case toolchain::Triple::EnvironmentType::UnknownEnvironment:
    TripleABI = ABI_Unknown;
    break;
  case toolchain::Triple::EnvironmentType::GNUSF:
  case toolchain::Triple::EnvironmentType::MuslSF:
    TripleABI = Is64Bit ? ABI_LP64S : ABI_ILP32S;
    break;
  case toolchain::Triple::EnvironmentType::GNUF32:
  case toolchain::Triple::EnvironmentType::MuslF32:
    TripleABI = Is64Bit ? ABI_LP64F : ABI_ILP32F;
    break;
  // Let the fallback case behave like {ILP32,LP64}D.
  case toolchain::Triple::EnvironmentType::GNUF64:
  default:
