...
#define MCSTROPT(NAME)                                                         \
  ...
  StringRef toolchain::mc::get##NAME() {                                            \
    assert(NAME##View && "RegisterMCTargetOptionsFlags not created.");         \
    return *NAME##View;                                                        \
  }
...
#define MCOPT_EXP(TY, NAME)                                                    \
  MCOPT(TY, NAME)                                                              \
  std::optional<TY> toolchain::mc::getExplicit##NAME() {                            \
...
toolchain::mc::RegisterMCTargetOptionsFlags::RegisterMCTargetOptionsFlags() {
...
MCTargetOptions toolchain::mc::InitMCTargetOptionsFromFlags() {
