...
#define HANDLE_SWIFT_SECTION(KIND, MACHO, ELF, COFF)                           \
  Swift5ReflectionSections                                                     \
      [toolchain::binaryformat::Swift5ReflectionSectionKind::KIND] =                \
...
void MCObjectFileInfo::initELFMCObjectFileInfo(const Triple &T, bool Large) {
  ...
  CallGraphSection =
      Ctx->getELFSection(".toolchain.callgraph", ELF::SHT_LLVM_CALL_GRAPH, 0);
...
MCObjectFileInfo::getCallGraphSection(const MCSection &TextSec) const {
  ...
  return Ctx->getELFSection(
      ".toolchain.callgraph", ELF::SHT_LLVM_CALL_GRAPH, Flags, 0, GroupName,
