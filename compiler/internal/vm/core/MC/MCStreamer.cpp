...
void MCStreamer::emitIntValue(uint64_t Value, unsigned Size) {
  ...
  uint64_t Swapped = support::endian::byte_swap(
      Value, IsLittleEndian ? toolchain::endianness::little : toolchain::endianness::big);
...
void toolchain::MCStreamer::emitNops(int64_t NumBytes, int64_t ControlledNopLen,
                                toolchain::SMLoc, const MCSubtargetInfo& STI) {}
