...
#include "vm/core/Transforms/IPO/ProfiledCallGraph.h"
...
public:
  GUIDToFuncNameMapper(Module &M, SampleProfileReader &Reader,
    ...
    for (const auto &F : CurrentModule) {
      ...
      // will rename the var and add suffix like ".toolchain.xxx" to the
  ...
  SampleProfileLoader(
      ...
      : SampleProfileLoaderBaseImpl(std::string(Name), std::string(RemapName),
        ...
        AnnotatedPassName(AnnotateSampleProfileInlinePhase
                              ? toolchain::AnnotateInlinePassName(InlineContext{
...
protected:
  ...
  toolchain::DenseSet<uint64_t> GUIDsInProfile;
...
bool SampleProfileLoader::tryPromoteAndInlineCandidate(
  ...
  // recursive. As toolchain does not inline recursive calls, we will
...
bool SampleProfileLoader::tryInlineCandidate(
  ...
  if (InlinedCallSites) {
    ...
    toolchain::append_range(*InlinedCallSites, IFI.InlinedCallSites);
  }
...
SampleProfileLoader::shouldInlineCandidate(InlineCandidate &Candidate) {
  ...
  // With CSSPGO, the preinliner in toolchain-profgen can estimate global inline
