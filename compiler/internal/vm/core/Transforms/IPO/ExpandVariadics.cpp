...
// in create(toolchain::Triple) at the end of this file.
...
ExpandVariadics::defineVariadicWrapper(Module &M, IRBuilder<> &Builder,
  ...
  SmallVector<Value *> Args(toolchain::make_pointer_range(F.args()));
...
ModulePass *toolchain::createExpandVariadicsPass(ExpandVariadicsMode M) {
