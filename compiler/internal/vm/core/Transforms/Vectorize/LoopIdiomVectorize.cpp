...
// that support @toolchain.experimental.vector.match. For example, on AArch64 targets
...
//   @toolchain.experimental.vector.match doesn't have direct support in hardware.
//
//===----------------------------------------------------------------------===//
//
...
Value *LoopIdiomVectorize::expandFindMismatch(
  ...
  const uint64_t AddrShiftAmt = toolchain::Log2_64(MinPageSize);
