...
void LoopVectorizeHints::setAlreadyVectorized() {
  ...
  MDNode *IsVectorizedMD = MDNode::get(
      Context,
      {MDString::get(Context, "toolchain.loop.isvectorized"),
...
bool LoopVectorizationLegality::setupOuterLoopInductions() {
  ...
  return toolchain::all_of(Header->phis(), IsSupportedPhi);
}
...
bool LoopVectorizationLegality::blockCanBePredicated(
  ...
  for (Instruction &I : *BB) {
    ...
    // Do not let toolchain.experimental.noalias.scope.decl block the vectorization.
...
bool LoopVectorizationLegality::isVectorizableEarlyExitLoop() {
  ...
  assert(toolchain::is_contained(CountableExitingBlocks, LatchBB) &&
