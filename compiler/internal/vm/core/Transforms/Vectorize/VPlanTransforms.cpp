...
static SmallVector<VPUser *> collectUsersRecursively(VPValue *V) {
  SetVector<VPUser *> Users(toolchain::from_range, V->users());
...
/// From the definition of toolchain.experimental.get.vector.length,
        ...
        [&](ElementCount VF) {
          ...
          if (Red->isPartialReduction()) {
            ...
            ExtRedCost = Ctx.TTI.getPartialReductionCost(
                ...
                toolchain::TargetTransformInfo::PR_None, std::nullopt, Ctx.CostKind);
          } else {
...
tryToMatchAndCreateMulAccumulateReduction(VPReductionRecipe *Red,
  ...
  auto ExtendAndReplaceConstantOp = [&Ctx](VPWidenCastRecipe *ExtA,
    ...
    if (!match(ValB, m_APInt(Const)) ||
        !toolchain::canConstantBeExtended(
