...
bool SimplifyIndvar::strengthenOverflowingOperation(BinaryOperator *BO,
  ...
  // compile-time impact, see https://bugs.toolchain.org/show_bug.cgi?id=50384.
  return true;
}
...
class WidenIV {
  ...
  // Does the module have any calls to the toolchain.experimental.guard intrinsic
...
PHINode *toolchain::createWideIV(const WideIVInfo &WI,
