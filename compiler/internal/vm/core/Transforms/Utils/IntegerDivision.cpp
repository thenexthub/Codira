...
static Value *generateUnsignedDivisionCode(Value *Dividend, Value *Divisor,
  ...
  // ;   %tmp0        = tail call i32 @toolchain.ctlz.i32(i32 %divisor, i1 true)
  // ;   %tmp1        = tail call i32 @toolchain.ctlz.i32(i32 %dividend, i1 true)
...
bool toolchain::expandRemainder(BinaryOperator *Rem) {
...
bool toolchain::expandDivision(BinaryOperator *Div) {
...
bool toolchain::expandRemainderUpTo32Bits(BinaryOperator *Rem) {
  assert((Rem->getOpcode() == Instruction::SRem ||
          Rem->getOpcode() == Instruction::URem) &&
          "Trying to expand remainder from a non-remainder function");
...
///
/// Replace Rem with emulation code.
bool toolchain::expandRemainderUpTo64Bits(BinaryOperator *Rem) {
  assert((Rem->getOpcode() == Instruction::SRem ||
          Rem->getOpcode() == Instruction::URem) &&
          "Trying to expand remainder from a non-remainder function");
...
bool toolchain::expandDivisionUpTo32Bits(BinaryOperator *Div) {
  assert((Div->getOpcode() == Instruction::SDiv ||
          Div->getOpcode() == Instruction::UDiv) &&
          "Trying to expand division from a non-division function");
...
///
/// Replace Div with emulation code.
bool toolchain::expandDivisionUpTo64Bits(BinaryOperator *Div) {
  assert((Div->getOpcode() == Instruction::SDiv ||
          Div->getOpcode() == Instruction::UDiv) &&
          "Trying to expand division from a non-division function");
