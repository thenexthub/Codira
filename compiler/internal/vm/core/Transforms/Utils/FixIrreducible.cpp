...
#include "vm/core/Transforms/Utils/ControlFlowUtils.h"
...
FunctionPass *toolchain::createFixIrreduciblePass() { return new FixIrreducible(); }
...
static void reconnectChildLoops(LoopInfo &LI, Loop *ParentLoop, Loop *NewLoop,
  ...
  auto FirstChild = toolchain::partition(CandidateLoops, [&](Loop *L) {
