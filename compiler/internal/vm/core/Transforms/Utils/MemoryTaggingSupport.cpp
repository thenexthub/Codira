...
bool forAllReachableExits(const DominatorTree &DT, const PostDominatorTree &PDT,
                          ...
                          toolchain::function_ref<void(Instruction *)> Callback) {
...
void alignAndPadAlloca(memtag::AllocaInfo &Info, toolchain::Align Alignment) {
...
void annotateDebugRecords(AllocaInfo &Info, unsigned int Tag) {
  ...
  toolchain::for_each(Info.DbgVariableRecords, AnnotateDbgRecord);
}
...
Value *incrementThreadLong(IRBuilder<> &IRB, Value *ThreadLong,
  ...
  //   https://bugs.toolchain.org/show_bug.cgi?id=39030
