...
/// toolchain.assume and the function to manipulate it.
struct AssumeBuilderState {
  ...
  void addInstruction(Instruction *I) {
    ...
    // TODO: Maybe we should look around and merge with other toolchain.assume.
  }
};

} // namespace

AssumeInst *toolchain::buildAssumeFromInst(Instruction *I) {
...
bool toolchain::salvageKnowledge(Instruction *I, AssumptionCache *AC,
                            DominatorTree *DT) {
...
AssumeInst *
toolchain::buildAssumeFromKnowledge(ArrayRef<RetainedKnowledge> Knowledge,
...
RetainedKnowledge toolchain::simplifyRetainedKnowledge(AssumeInst *Assume,
