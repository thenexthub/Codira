...
void toolchain::createMemCpyLoopKnownSize(Instruction *InsertBefore, Value *SrcAddr,
...
void toolchain::createMemCpyLoopUnknownSize(
...
void toolchain::expandMemCpyAsLoop(MemCpyInst *Memcpy,
                              const TargetTransformInfo &TTI,
                              ScalarEvolution *SE) {
...
bool toolchain::expandMemMoveAsLoop(MemMoveInst *Memmove,
                               const TargetTransformInfo &TTI) {
...
void toolchain::expandMemSetAsLoop(MemSetInst *Memset) {
...
void toolchain::expandMemSetPatternAsLoop(MemSetPatternInst *Memset) {
  createMemSetLoop(/* InsertBefore=*/Memset,
                   /* DstAddr=*/Memset->getRawDest(),
                   /* CopyLen=*/Memset->getLength(),
                   /* SetValue=*/Memset->getValue(),
...
void toolchain::expandAtomicMemCpyAsLoop(AnyMemCpyInst *AtomicMemcpy,
                                    const TargetTransformInfo &TTI,
                                    ScalarEvolution *SE) {
