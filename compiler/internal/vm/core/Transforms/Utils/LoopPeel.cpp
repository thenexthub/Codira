...
static const char *PeeledCountMetaData = "toolchain.loop.peeled.count";

extern cl::opt<bool> ProfcheckDisableMetadataFixes;
} // namespace vm::core

// Check whether we are capable of peeling this loop.
bool toolchain::canPeel(const Loop *L) {
  ...
  // updating.
  return toolchain::all_of(Exits, IsBlockFollowedByDeoptOrUnreachable);
}
...
bool toolchain::canPeelLastIteration(const Loop &L, ScalarEvolution &SE) {
...
void toolchain::computePeelCount(Loop *L, unsigned LoopSize,
...
toolchain::gatherPeelingPreferences(Loop *L, ScalarEvolution &SE,
                               const TargetTransformInfo &TTI,
...
/// optimizations.
bool toolchain::peelLoop(Loop *L, unsigned PeelCount, bool PeelLast, LoopInfo *LI,
