...
/// that are outside the current loop.  If so, insert LCSSA PHI nodes and
/// rewrite the uses.
bool toolchain::formLCSSAForInstructions(SmallVectorImpl<Instruction *> &Worklist,
                                    const DominatorTree &DT, const LoopInfo &LI,
                                    ScalarEvolution *SE,
                                    SmallVectorImpl<PHINode *> *PHIsToRemove,
                                    SmallVectorImpl<PHINode *> *InsertedPHIs) {
...
bool toolchain::formLCSSA(Loop &L, const DominatorTree &DT, const LoopInfo *LI,
                     ScalarEvolution *SE) {
  LoopExitBlocksTy LoopExitBlocks;
...
/// Process a loop nest depth first.
bool toolchain::formLCSSARecursively(Loop &L, const DominatorTree &DT,
                                const LoopInfo *LI, ScalarEvolution *SE) {
  LoopExitBlocksTy LoopExitBlocks;
...
Pass *toolchain::createLCSSAPass() { return new LCSSAWrapperPass(); }
char &toolchain::LCSSAID = LCSSAWrapperPass::ID;
