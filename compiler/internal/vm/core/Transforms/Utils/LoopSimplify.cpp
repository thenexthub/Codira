...
static void placeSplitBlockCarefully(BasicBlock *NewBB,
  ...
  if (toolchain::is_contained(SplitPreds, &*BBI))
    return;
...
///
BasicBlock *toolchain::InsertPreheaderForLoop(Loop *L, DominatorTree *DT,
...
static BasicBlock *insertUniqueBackedgeBlock(Loop *L, BasicBlock *Preheader,
  ...
  // If one of the backedges has toolchain.loop metadata attached, we remove
...
bool toolchain::simplifyLoop(Loop *L, DominatorTree *DT, LoopInfo *LI,
                        ScalarEvolution *SE, AssumptionCache *AC,
                        MemorySSAUpdater *MSSAU, bool PreserveLCSSA) {
  bool Changed = false;
...
char &toolchain::LoopSimplifyID = LoopSimplify::ID;
Pass *toolchain::createLoopSimplifyPass() { return new LoopSimplify(); }
