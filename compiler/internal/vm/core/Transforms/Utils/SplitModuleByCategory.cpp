...
#include "vm/core/Transforms/Utils/SplitModuleByCategory.h"
...
/// Annotates an toolchain::Module with information necessary to perform and track
/// the result of code (toolchain::Module instances) splitting:
...
void toolchain::splitModuleTransitiveFromEntryPoints(
    std::unique_ptr<Module> M,
