...
template <> struct toolchain::GraphTraits<RematGraph *> {
...
bool toolchain::coro::defaultMaterializable(Instruction &V) {
  return (isa<CastInst>(&V) || isa<GetElementPtrInst>(&V) ||
          isa<BinaryOperator>(&V) || isa<CmpInst>(&V) || isa<SelectInst>(&V));
}

bool toolchain::coro::isTriviallyMaterializable(Instruction &V) {
