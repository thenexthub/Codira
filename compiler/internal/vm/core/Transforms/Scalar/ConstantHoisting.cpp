...
FunctionPass *toolchain::createConstantHoistingPass() {
...
static void findBestInsertionSet(DominatorTree &DT, BlockFrequencyInfo &BFI,
  ...
  for (BasicBlock *Node : toolchain::reverse(Orders)) {
...
void ConstantHoistingPass::findBaseConstants(GlobalVariable *BaseGV) {
  ...
  toolchain::stable_sort(ConstCandVec, [](const ConstantCandidate &LHS,
...
bool ConstantHoistingPass::runImpl(Function &Fn, TargetTransformInfo &TTI,
  ...
  this->Entry = &Entry;
  this->PSI = PSI;
  this->OptForSize = toolchain::shouldOptimizeForSize(Entry.getParent(), PSI, BFI,
