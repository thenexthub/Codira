...
using PostorderStackTy = toolchain::SmallVector<PointerIntPair<Value *, 1, bool>, 4>;
...
void InferAddressSpacesImpl::inferAddressSpaces(
    ...
    ValueToAddrSpaceMapTy &InferredAddrSpace,
    PredicatedAddrSpaceMapTy &PredicatedAS) const {
  SetVector<Value *> Worklist(toolchain::from_range, Postorder);
...
FunctionPass *toolchain::createInferAddressSpacesPass(unsigned AddressSpace) {
