...
FunctionPass *toolchain::createScalarizeMaskedMemIntrinLegacyPass() {
...
// <16 x i32 > @toolchain.masked.load( <16 x i32>* %addr,
...
// void @toolchain.masked.store(<16 x i32> %src, <16 x i32>* %addr,
//                               <16 x i1> %mask)
...
// <16 x i32 > @toolchain.masked.gather.v16i32( <16 x i32*> %Ptrs, i32 4,
...
// void @toolchain.masked.scatter.v16i32(<16 x i32> %Src, <16 x i32*>* %Ptrs, i32 4,
//                                  <16 x i1> %Mask)
// to a chain of basic blocks, that stores element one-by-one if
// the appropriate mask bit is set.
//
