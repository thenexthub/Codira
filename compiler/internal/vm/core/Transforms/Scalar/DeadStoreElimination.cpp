...
struct DSEState {
  ...
  /// If \p I is a memory  terminator like toolchain.lifetime.end or free, return a
  ...
  /// toolchain.lifetime.end or free.
  ...
  getDomMemoryDef(MemoryDef *KillingDef, MemoryAccess *StartAccess,
    ...
    if (!isInvisibleToCallerAfterRet(KillingUndObj)) {
      ...
      for (BasicBlock *BB : toolchain::drop_begin(KillingBlocks)) {
        if (!CommonPred)
          break;
  ...
  bool eliminateDeadWritesAtEndOfFunction() {
    ...
    do {
      ...
      for (MemoryDef *Def : toolchain::reverse(MemDefs)) {
...
LLVM_ABI FunctionPass *toolchain::createDeadStoreEliminationPass() {
