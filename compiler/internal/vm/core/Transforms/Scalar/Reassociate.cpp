...
///          operand as "E | 0"
class toolchain::reassociate::XorOpnd {
public:
  XorOpnd(Value *V);
...
Value *ReassociatePass::OptimizeXor(Instruction *I,
  ...
  toolchain::stable_sort(OpndPtrs, [](XorOpnd *LHS, XorOpnd *RHS) {
...
static bool collectMultiplyFactors(SmallVectorImpl<ValueEntry> &Ops,
  ...
  toolchain::stable_sort(Factors, [](const Factor &LHS, const Factor &RHS) {
...
ReassociatePass::buildMinimalMultiplyDAG(IRBuilderBase &Builder,
  ...
  // base.
  Factors.erase(toolchain::unique(Factors,
...
Value *ReassociatePass::OptimizeMul(BinaryOperator *I,
  ...
  Ops.insert(toolchain::lower_bound(Ops, NewEntry), NewEntry);
  return nullptr;
}
...
FunctionPass *toolchain::createReassociatePass() {
