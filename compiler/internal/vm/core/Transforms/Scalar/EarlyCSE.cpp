...
template <> struct toolchain::DenseMapInfo<SimpleValue> {
...
template <> struct toolchain::DenseMapInfo<CallValue> {
...
template <> struct toolchain::DenseMapInfo<GEPValue> {
...
FunctionPass *toolchain::createEarlyCSEPass(bool UseMemorySSA) {
  if (UseMemorySSA)
