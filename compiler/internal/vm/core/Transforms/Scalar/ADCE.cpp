...
bool AggressiveDeadCodeElimination::isAlwaysLive(Instruction &I) {
  // TODO -- use toolchain::isInstructionTriviallyDead
...
bool AggressiveDeadCodeElimination::isInstrumentsConstant(Instruction &I) {
  // TODO -- move this test into toolchain::isInstructionTriviallyDead
...
void AggressiveDeadCodeElimination::markLiveBranchesFromControlDependences() {
  ...
  const SmallPtrSet<BasicBlock *, 16> BWDT(toolchain::from_range,
...
ADCEChanged AggressiveDeadCodeElimination::removeDeadInstructions() {
  ...
  for (Instruction &I : toolchain::reverse(instructions(F))) {
