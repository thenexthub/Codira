...
#include "vm/core/Transforms/Utils/LoopConstrainer.h"
...
class InductiveRangeCheckElimination {
  ...
  using GetBFIFunc = toolchain::function_ref<toolchain::BlockFrequencyInfo &()>;
  GetBFIFunc GetBFI;
...
InductiveRangeCheck::computeSafeIterationSpace(ScalarEvolution &SE,
  ...
  // variable, that may or may not exist as a real toolchain::Value in the loop) and
