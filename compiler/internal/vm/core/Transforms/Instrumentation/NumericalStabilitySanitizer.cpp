...
const KnownIntrinsic::WidenedIntrinsic KnownIntrinsic::kWidenedIntrinsics[] = {
    ...
    // e.g. toolchain.x86.sse2.min.sd means extract first element, min, insert back.
    // Intrinsics that take any non-vector FT types:
    // NOTE: Right now because of
    // https://github.com/toolchain/toolchain-project/issues/44744
    // for f128 we need to use makeX86FP80X86FP80 (go to a lower precision and
    // come back).
    {"toolchain.sqrt.f32", Intrinsic::sqrt, makeDoubleDouble},
    {"toolchain.sqrt.f64", Intrinsic::sqrt, makeX86FP80X86FP80},
    {"toolchain.sqrt.f80", Intrinsic::sqrt, makeX86FP80X86FP80},
    {"toolchain.powi.f32", Intrinsic::powi, makeDoubleDoubleI32},
    {"toolchain.powi.f64", Intrinsic::powi, makeX86FP80X86FP80I32},
    {"toolchain.powi.f80", Intrinsic::powi, makeX86FP80X86FP80I32},
    {"toolchain.sin.f32", Intrinsic::sin, makeDoubleDouble},
    {"toolchain.sin.f64", Intrinsic::sin, makeX86FP80X86FP80},
    {"toolchain.sin.f80", Intrinsic::sin, makeX86FP80X86FP80},
    {"toolchain.cos.f32", Intrinsic::cos, makeDoubleDouble},
    {"toolchain.cos.f64", Intrinsic::cos, makeX86FP80X86FP80},
    {"toolchain.cos.f80", Intrinsic::cos, makeX86FP80X86FP80},
    {"toolchain.pow.f32", Intrinsic::pow, makeDoubleDoubleDouble},
    {"toolchain.pow.f64", Intrinsic::pow, makeX86FP80X86FP80X86FP80},
    {"toolchain.pow.f80", Intrinsic::pow, makeX86FP80X86FP80X86FP80},
    {"toolchain.exp.f32", Intrinsic::exp, makeDoubleDouble},
    {"toolchain.exp.f64", Intrinsic::exp, makeX86FP80X86FP80},
    {"toolchain.exp.f80", Intrinsic::exp, makeX86FP80X86FP80},
    {"toolchain.exp2.f32", Intrinsic::exp2, makeDoubleDouble},
    {"toolchain.exp2.f64", Intrinsic::exp2, makeX86FP80X86FP80},
    {"toolchain.exp2.f80", Intrinsic::exp2, makeX86FP80X86FP80},
    {"toolchain.log.f32", Intrinsic::log, makeDoubleDouble},
    {"toolchain.log.f64", Intrinsic::log, makeX86FP80X86FP80},
    {"toolchain.log.f80", Intrinsic::log, makeX86FP80X86FP80},
    {"toolchain.log10.f32", Intrinsic::log10, makeDoubleDouble},
    {"toolchain.log10.f64", Intrinsic::log10, makeX86FP80X86FP80},
    {"toolchain.log10.f80", Intrinsic::log10, makeX86FP80X86FP80},
    {"toolchain.log2.f32", Intrinsic::log2, makeDoubleDouble},
    {"toolchain.log2.f64", Intrinsic::log2, makeX86FP80X86FP80},
    {"toolchain.log2.f80", Intrinsic::log2, makeX86FP80X86FP80},
    {"toolchain.fma.f32", Intrinsic::fma, makeDoubleDoubleDoubleDouble},

    {"toolchain.fmuladd.f32", Intrinsic::fmuladd, makeDoubleDoubleDoubleDouble},

    {"toolchain.fma.f64", Intrinsic::fma, makeX86FP80X86FP80X86FP80X86FP80},

    {"toolchain.fmuladd.f64", Intrinsic::fma, makeX86FP80X86FP80X86FP80X86FP80},

    {"toolchain.fma.f80", Intrinsic::fma, makeX86FP80X86FP80X86FP80X86FP80},
    {"toolchain.fabs.f32", Intrinsic::fabs, makeDoubleDouble},
    {"toolchain.fabs.f64", Intrinsic::fabs, makeX86FP80X86FP80},
    {"toolchain.fabs.f80", Intrinsic::fabs, makeX86FP80X86FP80},
    {"toolchain.minnum.f32", Intrinsic::minnum, makeDoubleDoubleDouble},
    {"toolchain.minnum.f64", Intrinsic::minnum, makeX86FP80X86FP80X86FP80},
    {"toolchain.minnum.f80", Intrinsic::minnum, makeX86FP80X86FP80X86FP80},
    {"toolchain.maxnum.f32", Intrinsic::maxnum, makeDoubleDoubleDouble},
    {"toolchain.maxnum.f64", Intrinsic::maxnum, makeX86FP80X86FP80X86FP80},
    {"toolchain.maxnum.f80", Intrinsic::maxnum, makeX86FP80X86FP80X86FP80},
    {"toolchain.minimum.f32", Intrinsic::minimum, makeDoubleDoubleDouble},
    {"toolchain.minimum.f64", Intrinsic::minimum, makeX86FP80X86FP80X86FP80},
    {"toolchain.minimum.f80", Intrinsic::minimum, makeX86FP80X86FP80X86FP80},
    {"toolchain.maximum.f32", Intrinsic::maximum, makeDoubleDoubleDouble},
    {"toolchain.maximum.f64", Intrinsic::maximum, makeX86FP80X86FP80X86FP80},
    {"toolchain.maximum.f80", Intrinsic::maximum, makeX86FP80X86FP80X86FP80},
    {"toolchain.copysign.f32", Intrinsic::copysign, makeDoubleDoubleDouble},
    {"toolchain.copysign.f64", Intrinsic::copysign, makeX86FP80X86FP80X86FP80},
    {"toolchain.copysign.f80", Intrinsic::copysign, makeX86FP80X86FP80X86FP80},
    {"toolchain.floor.f32", Intrinsic::floor, makeDoubleDouble},
    {"toolchain.floor.f64", Intrinsic::floor, makeX86FP80X86FP80},
    {"toolchain.floor.f80", Intrinsic::floor, makeX86FP80X86FP80},
    {"toolchain.ceil.f32", Intrinsic::ceil, makeDoubleDouble},
    {"toolchain.ceil.f64", Intrinsic::ceil, makeX86FP80X86FP80},
    {"toolchain.ceil.f80", Intrinsic::ceil, makeX86FP80X86FP80},
    {"toolchain.trunc.f32", Intrinsic::trunc, makeDoubleDouble},
    {"toolchain.trunc.f64", Intrinsic::trunc, makeX86FP80X86FP80},
    {"toolchain.trunc.f80", Intrinsic::trunc, makeX86FP80X86FP80},
    {"toolchain.rint.f32", Intrinsic::rint, makeDoubleDouble},
    {"toolchain.rint.f64", Intrinsic::rint, makeX86FP80X86FP80},
    {"toolchain.rint.f80", Intrinsic::rint, makeX86FP80X86FP80},
    {"toolchain.nearbyint.f32", Intrinsic::nearbyint, makeDoubleDouble},
    {"toolchain.nearbyint.f64", Intrinsic::nearbyint, makeX86FP80X86FP80},
    {"toolchain.nearbyin80f64", Intrinsic::nearbyint, makeX86FP80X86FP80},
    {"toolchain.round.f32", Intrinsic::round, makeDoubleDouble},
    {"toolchain.round.f64", Intrinsic::round, makeX86FP80X86FP80},
    {"toolchain.round.f80", Intrinsic::round, makeX86FP80X86FP80},
    {"toolchain.lround.f32", Intrinsic::lround, makeDoubleDouble},
    {"toolchain.lround.f64", Intrinsic::lround, makeX86FP80X86FP80},
    {"toolchain.lround.f80", Intrinsic::lround, makeX86FP80X86FP80},
    {"toolchain.llround.f32", Intrinsic::llround, makeDoubleDouble},
    {"toolchain.llround.f64", Intrinsic::llround, makeX86FP80X86FP80},
    {"toolchain.llround.f80", Intrinsic::llround, makeX86FP80X86FP80},
    {"toolchain.lrint.f32", Intrinsic::lrint, makeDoubleDouble},
    {"toolchain.lrint.f64", Intrinsic::lrint, makeX86FP80X86FP80},
    {"toolchain.lrint.f80", Intrinsic::lrint, makeX86FP80X86FP80},
    {"toolchain.llrint.f32", Intrinsic::llrint, makeDoubleDouble},
    {"toolchain.llrint.f64", Intrinsic::llrint, makeX86FP80X86FP80},
    {"toolchain.llrint.f80", Intrinsic::llrint, makeX86FP80X86FP80},
};

const KnownIntrinsic::LFEntry KnownIntrinsic::kLibfuncIntrinsics[] = {
    {LibFunc_sqrtf, "toolchain.sqrt.f32"},
    {LibFunc_sqrt, "toolchain.sqrt.f64"},
    {LibFunc_sqrtl, "toolchain.sqrt.f80"},
    {LibFunc_sinf, "toolchain.sin.f32"},
    {LibFunc_sin, "toolchain.sin.f64"},
    {LibFunc_sinl, "toolchain.sin.f80"},
    {LibFunc_cosf, "toolchain.cos.f32"},
    {LibFunc_cos, "toolchain.cos.f64"},
    {LibFunc_cosl, "toolchain.cos.f80"},
    {LibFunc_powf, "toolchain.pow.f32"},
    {LibFunc_pow, "toolchain.pow.f64"},
    {LibFunc_powl, "toolchain.pow.f80"},
    {LibFunc_expf, "toolchain.exp.f32"},
    {LibFunc_exp, "toolchain.exp.f64"},
    {LibFunc_expl, "toolchain.exp.f80"},
    {LibFunc_exp2f, "toolchain.exp2.f32"},
    {LibFunc_exp2, "toolchain.exp2.f64"},
    {LibFunc_exp2l, "toolchain.exp2.f80"},
    {LibFunc_logf, "toolchain.log.f32"},
    {LibFunc_log, "toolchain.log.f64"},
    {LibFunc_logl, "toolchain.log.f80"},
    {LibFunc_log10f, "toolchain.log10.f32"},
    {LibFunc_log10, "toolchain.log10.f64"},
    {LibFunc_log10l, "toolchain.log10.f80"},
    {LibFunc_log2f, "toolchain.log2.f32"},
    {LibFunc_log2, "toolchain.log2.f64"},
    {LibFunc_log2l, "toolchain.log2.f80"},
    {LibFunc_fabsf, "toolchain.fabs.f32"},
    {LibFunc_fabs, "toolchain.fabs.f64"},
    {LibFunc_fabsl, "toolchain.fabs.f80"},
    {LibFunc_copysignf, "toolchain.copysign.f32"},
    {LibFunc_copysign, "toolchain.copysign.f64"},
    {LibFunc_copysignl, "toolchain.copysign.f80"},
    {LibFunc_floorf, "toolchain.floor.f32"},
    {LibFunc_floor, "toolchain.floor.f64"},
    {LibFunc_floorl, "toolchain.floor.f80"},
    {LibFunc_fmaxf, "toolchain.maxnum.f32"},
    {LibFunc_fmax, "toolchain.maxnum.f64"},
    {LibFunc_fmaxl, "toolchain.maxnum.f80"},
    {LibFunc_fminf, "toolchain.minnum.f32"},
    {LibFunc_fmin, "toolchain.minnum.f64"},
    {LibFunc_fminl, "toolchain.minnum.f80"},
    {LibFunc_ceilf, "toolchain.ceil.f32"},
    {LibFunc_ceil, "toolchain.ceil.f64"},
    {LibFunc_ceill, "toolchain.ceil.f80"},
    {LibFunc_truncf, "toolchain.trunc.f32"},
    {LibFunc_trunc, "toolchain.trunc.f64"},
    {LibFunc_truncl, "toolchain.trunc.f80"},
    {LibFunc_rintf, "toolchain.rint.f32"},
    {LibFunc_rint, "toolchain.rint.f64"},
    {LibFunc_rintl, "toolchain.rint.f80"},
    {LibFunc_nearbyintf, "toolchain.nearbyint.f32"},
    {LibFunc_nearbyint, "toolchain.nearbyint.f64"},
    {LibFunc_nearbyintl, "toolchain.nearbyint.f80"},
    {LibFunc_roundf, "toolchain.round.f32"},
    {LibFunc_round, "toolchain.round.f64"},
    {LibFunc_roundl, "toolchain.round.f80"},
};
...
//   - memory transfers of floating-point data through other pointer types (toolchain
