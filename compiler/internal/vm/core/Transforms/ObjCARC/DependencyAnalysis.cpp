...
bool toolchain::objcarc::CanAlterRefCount(const Instruction *Inst, const Value *Ptr,
...
bool toolchain::objcarc::CanDecrementRefCount(const Instruction *Inst,
                                         const Value *Ptr,
                                         ProvenanceAnalysis &PA,
                                         ARCInstKind Class) {
...
bool toolchain::objcarc::CanUse(const Instruction *Inst, const Value *Ptr,
...
bool
toolchain::objcarc::Depends(DependenceKind Flavor, Instruction *Inst,
...
toolchain::Instruction *toolchain::objcarc::findSingleDependency(DependenceKind Flavor,
                                                       const Value *Arg,
                                                       BasicBlock *StartBB,
