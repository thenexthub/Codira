///===- toolchain/Frontend/Offloading/PropertySet.cpp --------------------------===//
//
...
#include "vm/core/Frontend/Offloading/PropertySet.h"
...
void toolchain::offloading::writePropertiesToJSON(
...
// but it uses toolchain::format instead of toolchain::formatv, which does
// not work with json::Value. This is a helper function to use
// toolchain::formatv with createStringError.
...
toolchain::offloading::readPropertiesFromJSON(MemoryBufferRef Buf) {
