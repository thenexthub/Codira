...
#define ADD_PATCHES_LIST(T)                                                    \
  ...
  void emitBinaryData(toolchain::StringRef Data);
...
protected:
  ...
  /// Sets output format.
  void setOutputFormat(dwarf::FormParams Format, toolchain::endianness Endianess) {
    this->Format = Format;
...
public:
  ...
  void setOutputFormat(dwarf::FormParams Format, toolchain::endianness Endianness) {
    this->Format = Format;
  ...
  toolchain::endianness getEndianness() const { return Endianness; }
...
protected:
  ...
  toolchain::endianness Endianness = toolchain::endianness::native;
