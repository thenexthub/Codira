...
#include "ArrayList.h"
#include "vm/core/ADT/ConcurrentHashtable.h"
...
public:
  ...
  create(toolchain::parallel::PerThreadBumpPtrAllocator &Allocator) {
...
protected:
  ...
  TypeEntryBody(toolchain::parallel::PerThreadBumpPtrAllocator &Allocator)
      : Children(&Allocator) {}
};
...
class TypePool
    : ConcurrentHashTableByPtr<StringRef, TypeEntry,
                               toolchain::parallel::PerThreadBumpPtrAllocator,
                               TypeEntryInfo> {
public:
  TypePool()
      : ConcurrentHashTableByPtr<StringRef, TypeEntry,
