...
cl::opt<bool> toolchain::EmitLongStrLiterals(
...
int toolchain::TableGenMain(const char *argv0, MultiFileTableGenMainFn MainFn) {
...
int toolchain::TableGenMain(const char *argv0, TableGenMainFn MainFn) {
