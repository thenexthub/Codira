...
#include "vm/core/ProfileData/Coverage/CoverageMappingWriter.h"
...
void CoverageMappingWriter::write(raw_ostream &OS) {
  ...
  toolchain::stable_sort(MappingRegions, [](const CounterMappingRegion &LHS,
...
void TestingFormatWriter::write(raw_ostream &OS, TestingFormatVersion Version) {
  auto ByteSwap = [](uint64_t N) {
    return support::endian::byte_swap<uint64_t>(N, toolchain::endianness::little);
  };
