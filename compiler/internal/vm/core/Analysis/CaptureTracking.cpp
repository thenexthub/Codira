...
unsigned toolchain::getDefaultMaxUsesToExploreForCaptureTracking() {
...
CaptureComponents toolchain::PointerMayBeCaptured(
...
bool toolchain::PointerMayBeCaptured(const Value *V, bool ReturnCaptures,
...
CaptureComponents toolchain::PointerMayBeCapturedBefore(
...
bool toolchain::PointerMayBeCapturedBefore(const Value *V, bool ReturnCaptures,
                                      const Instruction *I,
...
toolchain::FindEarliestCapture(const Value *V, Function &F, bool ReturnCaptures,
...
UseCaptureInfo toolchain::DetermineUseCaptureKind(const Use &U, const Value *Base) {
...
void toolchain::PointerMayBeCaptured(const Value *V, CaptureTracker *Tracker,
                                unsigned MaxUsesToExplore) {
