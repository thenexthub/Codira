...
void toolchain::collectParametricTerms(ScalarEvolution &SE, const SCEV *Expr,
                                  SmallVectorImpl<const SCEV *> &Terms) {
...
void toolchain::findArrayDimensions(ScalarEvolution &SE,
                               SmallVectorImpl<const SCEV *> &Terms,
                               SmallVectorImpl<const SCEV *> &Sizes,
  ...
  Terms.erase(toolchain::unique(Terms), Terms.end());

  // Put larger terms first.
  toolchain::sort(Terms, [](const SCEV *LHS, const SCEV *RHS) {
...
void toolchain::computeAccessFunctions(ScalarEvolution &SE, const SCEV *Expr,
...
void toolchain::delinearize(ScalarEvolution &SE, const SCEV *Expr,
                       SmallVectorImpl<const SCEV *> &Subscripts,
                       SmallVectorImpl<const SCEV *> &Sizes,
                       const SCEV *ElementSize) {
...
bool toolchain::findFixedSizeArrayDimensions(ScalarEvolution &SE, const SCEV *Expr,
  ...
  toolchain::sort(Sizes.rbegin(), Sizes.rend());
  Sizes.erase(toolchain::unique(Sizes), Sizes.end());
...
bool toolchain::delinearizeFixedSizeArray(ScalarEvolution &SE, const SCEV *Expr,
                                     SmallVectorImpl<const SCEV *> &Subscripts,
                                     SmallVectorImpl<const SCEV *> &Sizes,
                                     const SCEV *ElementSize) {
  // Clear output vectors.
...
bool toolchain::validateDelinearizationResult(ScalarEvolution &SE,
...
bool toolchain::getIndexExpressionsFromGEP(ScalarEvolution &SE,
