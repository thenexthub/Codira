...
void ImportedFunctionsInliningStatistics::calculateRealInlines() {
  ...
  toolchain::sort(NonImportedCallers);
  NonImportedCallers.erase(toolchain::unique(NonImportedCallers),
...
ImportedFunctionsInliningStatistics::getSortedNodes() {
  ...
  toolchain::sort(SortedNodes, [&](const SortedNodesTy::value_type &Lhs,
