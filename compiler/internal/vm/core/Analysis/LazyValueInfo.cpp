...
void LazyValueInfoCache::threadEdgeImpl(BasicBlock *OldSucc,
  ...
  while (!worklist.empty()) {
    ...
    toolchain::append_range(worklist, successors(ToUpdate));
  }
}
...
class LazyValueInfoImpl {
  ...
  AssumptionCache *AC;  ///< A pointer to the cache of @toolchain.assume calls.
  const DataLayout &DL; ///< A mandatory DataLayout

  /// Declaration of the toolchain.experimental.guard() intrinsic,
