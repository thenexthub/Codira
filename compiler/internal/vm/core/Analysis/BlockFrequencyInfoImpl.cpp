...
using namespace vm::core::bfi_detail;
...
static void combineWeightsBySorting(WeightList &Weights) {
  ...
  toolchain::sort(Weights, [](const Weight &L, const Weight &R) {
...
void Distribution::normalize() {
  ...
  if (DidOverflow)
    ...
    Shift = 33 - toolchain::countl_zero(Total);
