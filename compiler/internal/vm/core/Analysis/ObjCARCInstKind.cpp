...
raw_ostream &toolchain::objcarc::operator<<(raw_ostream &OS,
...
ARCInstKind toolchain::objcarc::GetFunctionClass(const Function *F) {
...
ARCInstKind toolchain::objcarc::GetARCInstKind(const Value *V) {
...
bool toolchain::objcarc::IsUser(ARCInstKind Class) {
  switch (Class) {
  case ARCInstKind::User:
  case ARCInstKind::CallOrUser:
  case ARCInstKind::IntrinsicUser:
...
bool toolchain::objcarc::IsRetain(ARCInstKind Class) {
  switch (Class) {
  case ARCInstKind::Retain:
  case ARCInstKind::RetainRV:
    return true;
...
bool toolchain::objcarc::IsAutorelease(ARCInstKind Class) {
  switch (Class) {
  case ARCInstKind::Autorelease:
  case ARCInstKind::AutoreleaseRV:
    return true;
...
/// argument verbatim.
bool toolchain::objcarc::IsForwarding(ARCInstKind Class) {
  switch (Class) {
  case ARCInstKind::Retain:
  case ARCInstKind::RetainRV:
  case ARCInstKind::UnsafeClaimRV:
...
bool toolchain::objcarc::IsNoopOnNull(ARCInstKind Class) {
  switch (Class) {
  case ARCInstKind::Retain:
  case ARCInstKind::RetainRV:
  case ARCInstKind::UnsafeClaimRV:
...
bool toolchain::objcarc::IsNoopOnGlobal(ARCInstKind Class) {
  switch (Class) {
  case ARCInstKind::Retain:
  case ARCInstKind::RetainRV:
  case ARCInstKind::UnsafeClaimRV:
...
bool toolchain::objcarc::IsAlwaysTail(ARCInstKind Class) {
...
/// to mark with the "tail" keyword.
bool toolchain::objcarc::IsNeverTail(ARCInstKind Class) {
...
bool toolchain::objcarc::IsNoThrow(ARCInstKind Class) {
...
bool toolchain::objcarc::CanInterruptRV(ARCInstKind Class) {
  switch (Class) {
  case ARCInstKind::AutoreleasepoolPop:
  case ARCInstKind::CallOrUser:
  case ARCInstKind::Call:
...
bool toolchain::objcarc::CanDecrementRefCount(ARCInstKind Kind) {
  switch (Kind) {
  case ARCInstKind::Retain:
  case ARCInstKind::RetainRV:
  case ARCInstKind::Autorelease:
