...
#include "vm/core/Analysis/InlineOrder.h"
...
toolchain::InlineCost getInlineCostWrapper(CallBase &CB,
...
public:
  ...
  void erase_if(function_ref<bool(T)> Pred) override {
    ...
    toolchain::erase_if(Heap, PredWrapper);
...
AnalysisKey toolchain::PluginInlineOrderAnalysis::Key;

std::unique_ptr<InlineOrder<std::pair<CallBase *, int>>>
toolchain::getDefaultInlineOrder(FunctionAnalysisManager &FAM,
                            const InlineParams &Params,
...
std::unique_ptr<InlineOrder<std::pair<CallBase *, int>>>
toolchain::getInlineOrder(FunctionAnalysisManager &FAM, const InlineParams &Params,
                     ModuleAnalysisManager &MAM, Module &M) {
