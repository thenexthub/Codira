//===- toolchain/Analysis/TargetTransformInfo.cpp ------------------------------===//
//
...
#include "vm/core/Analysis/TargetTransformInfoImpl.h"
...
toolchain::TargetTransformInfo::getInstructionUniformity(const Value *V) const {
...
bool toolchain::TargetTransformInfo::isValidAddrSpaceCast(unsigned FromAS,
                                                     unsigned ToAS) const {
  return TTIImpl->isValidAddrSpaceCast(FromAS, ToAS);
}

bool toolchain::TargetTransformInfo::addrspacesMayAlias(unsigned FromAS,
                                                   unsigned ToAS) const {
...
ImmutablePass *
toolchain::createTargetTransformInfoWrapperPass(TargetIRAnalysis TIRA) {
