...
unsigned toolchain::getICmpCode(CmpInst::Predicate Pred) {
  switch (Pred) {
      // False -> 0
...
Constant *toolchain::getPredForICmpCode(unsigned Code, bool Sign, Type *OpTy,
...
bool toolchain::predicatesFoldable(ICmpInst::Predicate P1, ICmpInst::Predicate P2) {
  return (CmpInst::isSigned(P1) == CmpInst::isSigned(P2)) ||
         (CmpInst::isSigned(P1) && ICmpInst::isEquality(P2)) ||
         (CmpInst::isSigned(P2) && ICmpInst::isEquality(P1));
}

Constant *toolchain::getPredForFCmpCode(unsigned Code, Type *OpTy,
                                   CmpInst::Predicate &Pred) {
...
toolchain::decomposeBitTestICmp(Value *LHS, Value *RHS, CmpInst::Predicate Pred,
...
std::optional<DecomposedBitTest> toolchain::decomposeBitTest(Value *Cond,
