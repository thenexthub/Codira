...
// http://toolchain.org/docs/AliasAnalysis.html#OtherItfs).
//
...
AliasResult TypeBasedAAResult::aliasErrno(const MemoryLocation &Loc,
  ...
  const auto *ErrnoTBAAMD = M->getNamedMetadata("toolchain.errno.tbaa");
...
ImmutablePass *toolchain::createTypeBasedAAWrapperPass() {
