...
static Triple::EnvironmentType parseEnvironment(StringRef EnvironmentName) {
  return StringSwitch<Triple::EnvironmentType>(EnvironmentName)
      ...
      .StartsWith("toolchain", Triple::LLVM)
...
VersionTuple Triple::getVulkanVersion() const {
  ...
  toolchain::DenseMap<VersionTuple, SubArchType> ValidVersionMap = {
...
VersionTuple Triple::getDXILVersion() const {
  ...
  // Tracked by https://github.com/toolchain/toolchain-project/issues/91388
  return DXILVersion;
}
...
unsigned Triple::getArchPointerBitWidth(toolchain::Triple::ArchType Arch) {
  switch (Arch) {
  ...
  case toolchain::Triple::riscv32be:
  ...
  case toolchain::Triple::riscv64be:
