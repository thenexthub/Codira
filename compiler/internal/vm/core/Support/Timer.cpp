...
std::unique_ptr<raw_ostream> toolchain::CreateInfoOutputFile() {
...
void TimerGroup::PrintQueuedTimers(raw_ostream &OS) {
  ...
  for (const PrintRecord &Record : toolchain::reverse(TimersToPrint)) {
...
void toolchain::initTimerOptions() { *ManagedTimerGlobals; }
