...
std::error_code toolchain::setzOSFileTag(int FD, int CCSID, bool Text) {
...
ErrorOr<__ccsid_t> toolchain::getzOSFileTag(const Twine &FileName, const int FD) {
...
ErrorOr<bool> toolchain::needzOSConversion(const Twine &FileName, const int FD) {
