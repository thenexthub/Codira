...
#include "vm/core/ADT/SlowDynamicAPInt.h"
#include "vm/core/ADT/Hashing.h"
#include "vm/core/Support/Debug.h"
#include "vm/core/Support/raw_ostream.h"

using namespace vm::core;
using namespace vm::core::detail;
...
hash_code toolchain::detail::hash_value(const SlowDynamicAPInt &X) {
...
/// ---------------------------------------------------------------------------
SlowDynamicAPInt &toolchain::detail::operator+=(SlowDynamicAPInt &A, int64_t B) {
...
bool toolchain::detail::operator==(const SlowDynamicAPInt &A, int64_t B) {
  return A == SlowDynamicAPInt(B);
}
bool toolchain::detail::operator!=(const SlowDynamicAPInt &A, int64_t B) {
  return A != SlowDynamicAPInt(B);
...
SlowDynamicAPInt toolchain::detail::operator+(const SlowDynamicAPInt &A, int64_t B) {
  return A + SlowDynamicAPInt(B);
}
SlowDynamicAPInt toolchain::detail::operator-(const SlowDynamicAPInt &A, int64_t B) {
  return A - SlowDynamicAPInt(B);
...
bool toolchain::detail::operator==(int64_t A, const SlowDynamicAPInt &B) {
...
SlowDynamicAPInt toolchain::detail::operator+(int64_t A, const SlowDynamicAPInt &B) {
  return SlowDynamicAPInt(A) + B;
}
SlowDynamicAPInt toolchain::detail::operator-(int64_t A, const SlowDynamicAPInt &B) {
  return SlowDynamicAPInt(A) - B;
...
SlowDynamicAPInt toolchain::detail::abs(const SlowDynamicAPInt &X) {
  return X >= 0 ? X : -X;
}
SlowDynamicAPInt toolchain::detail::ceilDiv(const SlowDynamicAPInt &LHS,
...
SlowDynamicAPInt toolchain::detail::floorDiv(const SlowDynamicAPInt &LHS,
                                        const SlowDynamicAPInt &RHS) {
  if (RHS == -1)
    return -LHS;
  unsigned Width = getMaxWidth(LHS.Val, RHS.Val);
...
SlowDynamicAPInt toolchain::detail::mod(const SlowDynamicAPInt &LHS,
                                   const SlowDynamicAPInt &RHS) {
  assert(RHS >= 1 && "mod is only supported for positive divisors!");
  return LHS % RHS < 0 ? LHS % RHS + RHS : LHS % RHS;
}

SlowDynamicAPInt toolchain::detail::gcd(const SlowDynamicAPInt &A,
...
SlowDynamicAPInt toolchain::detail::lcm(const SlowDynamicAPInt &A,
                                   const SlowDynamicAPInt &B) {
