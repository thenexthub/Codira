//===- toolchain/Support/Parallel.cpp - Parallel algorithms --------------------===//
//
...
toolchain::ThreadPoolStrategy toolchain::parallel::strategy;
...
void toolchain::parallelFor(size_t Begin, size_t End,
                       toolchain::function_ref<void(size_t)> Fn) {
#if LLVM_ENABLE_THREADS
