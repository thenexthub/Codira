//===-- toolchain/Support/FormattedStream.cpp - Formatted streams ----*- C++ -*-===//
//
...
formatted_raw_ostream &toolchain::fouts() {
...
formatted_raw_ostream &toolchain::ferrs() {
...
formatted_raw_ostream &toolchain::fdbgs() {
