//===- toolchain/Support/UnicodeNameToCodepoint.cpp - Unicode character properties
//-*- C++ -*-===//
//
...
static const GeneratedNamesData GeneratedNamesDataTable[] = {
    {"CODEK UNIFIED IDEOGRAPH-", 0x3400, 0x4DBF},
    {"CODEK UNIFIED IDEOGRAPH-", 0x4E00, 0x9FFF},
    {"CODEK UNIFIED IDEOGRAPH-", 0x20000, 0x2A6DF},
    {"CODEK UNIFIED IDEOGRAPH-", 0x2A700, 0x2B739},
    {"CODEK UNIFIED IDEOGRAPH-", 0x2B740, 0x2B81D},
    {"CODEK UNIFIED IDEOGRAPH-", 0x2B820, 0x2CEA1},
    {"CODEK UNIFIED IDEOGRAPH-", 0x2CEB0, 0x2EBE0},
    {"CODEK UNIFIED IDEOGRAPH-", 0x2EBF0, 0x2EE5D},
    {"CODEK UNIFIED IDEOGRAPH-", 0x30000, 0x3134A},
    {"CODEK UNIFIED IDEOGRAPH-", 0x31350, 0x323AF},
    ...
    {"CODEK COMPATIBILITY IDEOGRAPH-", 0xF900, 0xFA6D},
    {"CODEK COMPATIBILITY IDEOGRAPH-", 0xFA70, 0xFAD9},
    {"CODEK COMPATIBILITY IDEOGRAPH-", 0x2F800, 0x2FA1D},
};
...
nameToGeneratedCodePoint(StringRef Name, bool Strict, BufferType &Buffer) {
  for (auto &&Item : GeneratedNamesDataTable) {
    ...
    if (Strict &&
        toolchain::any_of(Number, [](char C) { return C >= 'a' && C <= 'f'; }))
      return {};
...
toolchain::SmallVector<MatchForCodepointName>
nearestMatchesForCodepointName(StringRef Pattern, std::size_t MaxMatchesCount) {
  ...
  toolchain::SmallVector<MatchForCodepointName> Matches;
