...
#include "vm/core/Support/Duration.h"
...
static int getFD(StringRef Filename, std::error_code &EC,
  ...
  // FIXME(sandboxing): Remove this by adopting `toolchain::vfs::OutputBackend`.
  ...
  do {
    ...
    if (ret < 0) {
      ...
      if (WinLastError == ERROR_BROKEN_PIPE ||
        ...
        toolchain::sys::CallOneShotPipeSignalHandler();
        errno = EPIPE;
      }
#endif
...
Error toolchain::writeToOutput(StringRef OutputFileName,
