...
uint8_t DataExtractor::getU8(uint64_t *offset_ptr, toolchain::Error *Err) const {
...
uint16_t DataExtractor::getU16(uint64_t *offset_ptr, toolchain::Error *Err) const {
...
uint32_t DataExtractor::getU32(uint64_t *offset_ptr, toolchain::Error *Err) const {
...
uint64_t DataExtractor::getU64(uint64_t *offset_ptr, toolchain::Error *Err) const {
