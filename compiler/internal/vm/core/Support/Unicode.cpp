//===- toolchain/Support/Unicode.cpp - Unicode character properties  -*- C++ -*-===//
//
...
#include "vm/core/Support/UnicodeCharRanges.h"
...
///   * 2 for CODEK characters excluding halfwidth forms;
