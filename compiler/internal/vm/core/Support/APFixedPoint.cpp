...
#include "vm/core/ADT/APFixedPoint.h"
...
void FixedPointSemantics::print(toolchain::raw_ostream &OS) const {
  OS << "width=" << getWidth() << ", ";
...
uint32_t FixedPointSemantics::toOpaqueInt() const {
  return toolchain::bit_cast<uint32_t>(*this);
}
...
LLVM_DUMP_METHOD void APFixedPoint::dump() const { print(toolchain::errs()); }
#endif
