...
bool toolchain::VerifyDomInfo = false;
...
template class LLVM_EXPORT_TEMPLATE toolchain::DomTreeNodeBase<BasicBlock>;
template class LLVM_EXPORT_TEMPLATE
    toolchain::DominatorTreeBase<BasicBlock, false>; // DomTreeBase
template class LLVM_EXPORT_TEMPLATE
    toolchain::DominatorTreeBase<BasicBlock, true>; // PostDomTreeBase

template class toolchain::cfg::Update<BasicBlock *>;

template LLVM_EXPORT_TEMPLATE void
toolchain::DomTreeBuilder::Calculate<DomTreeBuilder::BBDomTree>(
    DomTreeBuilder::BBDomTree &DT);
template LLVM_EXPORT_TEMPLATE void
toolchain::DomTreeBuilder::CalculateWithUpdates<DomTreeBuilder::BBDomTree>(
    DomTreeBuilder::BBDomTree &DT, BBUpdates U);

template LLVM_EXPORT_TEMPLATE void
toolchain::DomTreeBuilder::Calculate<DomTreeBuilder::BBPostDomTree>(
    DomTreeBuilder::BBPostDomTree &DT);
// No CalculateWithUpdates<PostDomTree> instantiation, unless a usecase arises.

template LLVM_EXPORT_TEMPLATE void
toolchain::DomTreeBuilder::InsertEdge<DomTreeBuilder::BBDomTree>(
    DomTreeBuilder::BBDomTree &DT, BasicBlock *From, BasicBlock *To);
template LLVM_EXPORT_TEMPLATE void
toolchain::DomTreeBuilder::InsertEdge<DomTreeBuilder::BBPostDomTree>(
    DomTreeBuilder::BBPostDomTree &DT, BasicBlock *From, BasicBlock *To);

template LLVM_EXPORT_TEMPLATE void
toolchain::DomTreeBuilder::DeleteEdge<DomTreeBuilder::BBDomTree>(
    DomTreeBuilder::BBDomTree &DT, BasicBlock *From, BasicBlock *To);
template LLVM_EXPORT_TEMPLATE void
toolchain::DomTreeBuilder::DeleteEdge<DomTreeBuilder::BBPostDomTree>(
    DomTreeBuilder::BBPostDomTree &DT, BasicBlock *From, BasicBlock *To);

template LLVM_EXPORT_TEMPLATE void
toolchain::DomTreeBuilder::ApplyUpdates<DomTreeBuilder::BBDomTree>(
    DomTreeBuilder::BBDomTree &DT, DomTreeBuilder::BBDomTreeGraphDiff &,
    DomTreeBuilder::BBDomTreeGraphDiff *);
template LLVM_EXPORT_TEMPLATE void
toolchain::DomTreeBuilder::ApplyUpdates<DomTreeBuilder::BBPostDomTree>(
...
toolchain::DomTreeBuilder::Verify<DomTreeBuilder::BBDomTree>(
    const DomTreeBuilder::BBDomTree &DT,
    DomTreeBuilder::BBDomTree::VerificationLevel VL);
template LLVM_EXPORT_TEMPLATE bool
toolchain::DomTreeBuilder::Verify<DomTreeBuilder::BBPostDomTree>(
