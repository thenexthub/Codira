...
Constant *toolchain::ConstantFoldCastInstruction(unsigned opc, Constant *V,
                                            Type *DestTy) {
...
Constant *toolchain::ConstantFoldSelectInstruction(Constant *Cond,
...
Constant *toolchain::ConstantFoldExtractElementInstruction(Constant *Val,
                                                      Constant *Idx) {
...
Constant *toolchain::ConstantFoldInsertElementInstruction(Constant *Val,
                                                     Constant *Elt,
                                                     Constant *Idx) {
...
Constant *toolchain::ConstantFoldShuffleVectorInstruction(Constant *V1, Constant *V2,
                                                     ArrayRef<int> Mask) {
...
Constant *toolchain::ConstantFoldExtractValueInstruction(Constant *Agg,
...
Constant *toolchain::ConstantFoldInsertValueInstruction(Constant *Agg,
                                                   Constant *Val,
                                                   ArrayRef<unsigned> Idxs) {
...
Constant *toolchain::ConstantFoldUnaryInstruction(unsigned Opcode, Constant *C) {
...
Constant *toolchain::ConstantFoldBinaryInstruction(unsigned Opcode, Constant *C1,
                                              Constant *C2) {
      ...
      if (ConstantExpr *CE1 = dyn_cast<ConstantExpr>(C1)) {
        ...
        if ((CE1->getOpcode() == Instruction::PtrToInt ||
          ...
          if (Module *TheModule = GV->getParent()) {
            ...
            // increased code size (see https://reviews.toolchain.org/D55115)
...
Constant *toolchain::ConstantFoldCompareInstruction(CmpInst::Predicate Predicate,
...
Constant *toolchain::ConstantFoldGetElementPtr(Type *PointeeTy, Constant *C,
