...
template <> void toolchain::invalidateParentIListOrdering(BasicBlock *BB) {
  BB->invalidateOrders();
}

// Explicit instantiation of SymbolTableListTraits since some of the methods
// are not in the public header file...
template class toolchain::SymbolTableListTraits<
...
void BasicBlock::removePredecessor(BasicBlock *Pred,
  ...
  assert((hasNUsesOrMore(16) || toolchain::is_contained(predecessors(this), Pred)) &&
...
BasicBlock::iterator toolchain::skipDebugIntrinsics(BasicBlock::iterator It) {
