...
DIBuilder::DIBuilder(Module &m, bool AllowUnresolvedNodes, DICompileUnit *CU)
  ...
  if (CUNode) {
    ...
    if (const auto &MNs = CUNode->getMacros())
      AllMacrosPerParent.insert({nullptr, {toolchain::from_range, MNs}});
  }
}
...
void DIBuilder::finalize() {
  ...
  for (const auto &I : AllMacrosPerParent) {
    ...
    replaceTemporary(toolchain::TempDIMacroNode(TMF), MF);
  }
...
DIBuilder::createStaticMemberType(DIScope *Scope, StringRef Name, DIFile *File,
                                  ...
                                  DINode::DIFlags Flags, toolchain::Constant *Val,
...
DbgInstPtr DIBuilder::insertDbgValueIntrinsic(toolchain::Value *Val,
...
Instruction *DIBuilder::insertDbgIntrinsic(toolchain::Function *IntrinsicFn,
