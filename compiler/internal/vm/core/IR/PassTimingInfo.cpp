...
#include "vm/core/Support/TypeName.h"
...
bool toolchain::TimePassesIsEnabled = false;
bool toolchain::TimePassesPerRun = false;
...
Timer *toolchain::getPassTimer(Pass *P) {
...
/// them.
void toolchain::reportAndResetTimings(raw_ostream *OutStream) {
  if (legacy::PassTimingInfo::TheTimeInfo)
