...
template class toolchain::DominatorTreeBase<Block, /*IsPostDom=*/false>;
template class toolchain::DominatorTreeBase<Block, /*IsPostDom=*/true>;
template class toolchain::DomTreeNodeBase<Block>;
...
auto DominanceInfoBase<IsPostDom>::getDominanceInfo(Region *region,
    ...
    -> toolchain::PointerIntPair<DomTree *, 1, bool> {
