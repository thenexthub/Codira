...
VariantValue::VariantValue(const toolchain::StringRef string)
    : type(ValueType::String) {
  value.String = new toolchain::StringRef(string);
}
...
const toolchain::StringRef &VariantValue::getString() const {
  assert(isString());
  return *value.String;
}

void VariantValue::setString(const toolchain::StringRef &newValue) {
  reset();
  type = ValueType::String;
  value.String = new toolchain::StringRef(newValue);
}
