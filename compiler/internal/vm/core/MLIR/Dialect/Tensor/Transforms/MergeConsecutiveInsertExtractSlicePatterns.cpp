...
struct DropRedundantRankExpansionOnExtractSliceOfInsertSlice
  ...
  LogicalResult matchAndRewrite(ExtractSliceOp extractSliceOp,
    ...
    toolchain::SmallBitVector droppedDims = extractSliceOp.getDroppedDims();
    if (droppedDims.none())
      return failure();
    ...
    if (!insertSliceOp)
      return failure();
    toolchain::SmallBitVector expandedDims = insertSliceOp.getDroppedDims();
...
struct DropRedundantRankExpansionOnInsertSliceOfExtractSlice final
  ...
  LogicalResult matchAndRewrite(tensor::InsertSliceOp insertSliceOp,
    ...
    toolchain::SmallBitVector extractDroppedDims = extractSliceOp.getDroppedDims();
    toolchain::SmallBitVector insertDroppedDims = insertSliceOp.getDroppedDims();
