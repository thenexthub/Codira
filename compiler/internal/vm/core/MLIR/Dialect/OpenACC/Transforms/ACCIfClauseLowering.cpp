...
void ACCIfClauseLowering::lowerIfClauseForComputeConstruct(
  ...
  LLVM_DEBUG(toolchain::dbgs() << "Converting " << computeConstructOp->getName()
  ...
  for (Operation *dataEntryOp : toolchain::reverse(dataEntryOps))
  ...
  LLVM_DEBUG(toolchain::dbgs() << "Cloning " << dataEntryOps.size()
