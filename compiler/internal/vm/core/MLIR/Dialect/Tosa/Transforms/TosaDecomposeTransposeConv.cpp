...
public:
  ...
  LogicalResult matchAndRewrite(tosa::TransposeConv2DOp op,
    ...
    toolchain::ArrayRef<int64_t> stride = op.getStride();
    toolchain::ArrayRef<int64_t> pad = op.getOutPad();
    ...
    if (toolchain::any_of(stride, [](int64_t v) { return v != 1; }))
      return failure();
    ...
    toolchain::SmallVector<int64_t> convPad(4, 0);
...
public:
  ...
  LogicalResult matchAndRewrite(tosa::TransposeConv2DOp op,
    ...
    if (toolchain::all_of(stride, [](int64_t v) { return v == 1; }))
    ...
    toolchain::SmallVector<int64_t, 8> weightPadding = {0, 0, 0, 0, 0, 0, 0, 0};
    weightPadding[3] =
    ...
    toolchain::SmallVector<int64_t, 6> weightReshapeDims0 = {
    ...
    toolchain::SmallVector<int64_t, 4> weightReshapeDims1 = {
    ...
    toolchain::SmallVector<int64_t, 8> inputPadding = {0, 0, 0, 0, 0, 0, 0, 0};
    ...
    toolchain::SmallVector<int64_t, 6> convReshapeDims0 = {
    ...
    toolchain::SmallVector<int64_t, 6> convReshapeDims1 = {
    ...
    toolchain::SmallVector<int64_t, 4> sliceBegin = {0, resultSliceTop,
                                                resultSliceLeft, 0};
    toolchain::SmallVector<int64_t, 4> sliceSize(convReshapeDims1.begin(),
    ...
    toolchain::SmallVector<int64_t, 8> resultPadding = {0, 0, 0, 0, 0, 0, 0, 0};
