...
constexpr const ::toolchain::StringLiteral
...
template <typename T>
using detect_has_region_builder = toolchain::is_detected<has_region_builder, T>;
...
void addNamedOpBuilderImpl(
    toolchain::StringMap<LinalgDialect::RegionBuilderFunType> &map) {
  // Do nothing.
}
