...
// <operation> ::=
//     `toolchain.amdgcn.raw.buffer.load.* %rsrc, %offset, %soffset, %aux
//     : result_type`
...
// <operation> ::=
//     `toolchain.amdgcn.raw.buffer.store.* %vdata, %rsrc,  %offset,
...
// <operation> ::=
//     `toolchain.amdgcn.raw.buffer.atomic.fadd.* %vdata, %rsrc,  %offset,
//     %soffset, %aux : result_type`
...
// <operation> ::=
//     `toolchain.amdgcn.raw.buffer.atomic.fmax.* %vdata, %rsrc,  %offset,
//     %soffset, %aux : result_type`
...
// <operation> ::=
//     `toolchain.amdgcn.raw.buffer.atomic.smax.* %vdata, %rsrc,  %offset,
//     %soffset, %aux : result_type`
...
// <operation> ::=
//     `toolchain.amdgcn.raw.buffer.atomic.umin.* %vdata, %rsrc,  %offset,
//     %soffset, %aux : result_type`
...
// TODO: This should be the toolchain.rocdl dialect once this is supported.
