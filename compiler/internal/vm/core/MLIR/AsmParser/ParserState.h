...
struct SymbolState {
  ...
  toolchain::StringMap<Attribute> attributeAliasDefinitions;

  /// A map from type alias identifier to Type.
  toolchain::StringMap<Type> typeAliasDefinitions;
  ...
  DenseMap<const OpAsmDialectInterface *,
           toolchain::StringMap<std::pair<std::string, AsmDialectResourceHandle>>>
      dialectResources;
...
struct ParserState {
  ParserState(const toolchain::SourceMgr &sourceMgr, const ParserConfig &config,
