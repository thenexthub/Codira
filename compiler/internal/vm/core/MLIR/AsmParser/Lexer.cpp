...
Lexer::Lexer(const toolchain::SourceMgr &sourceMgr, MLIRContext *context,
...
Token Lexer::lexToken() {
  ...
  while (true) {
    ...
    case 0:
      ...
      // marker that toolchain::MemoryBuffer guarantees will be there.
...
Token Lexer::lexBareIdentifierOrKeyword(const char *tokStart) {
  ...
  auto isAllDigit = [](StringRef str) {
    return toolchain::all_of(str, toolchain::isDigit);
  };
