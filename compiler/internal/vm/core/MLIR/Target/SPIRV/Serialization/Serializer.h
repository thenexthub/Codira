...
private:
  ...
  toolchain::StringMap<uint32_t> specConstIDMap;
  ...
  toolchain::StringMap<uint32_t> globalVarIDMap;

  /// Map from FuncOps name to <id>s.
  toolchain::StringMap<uint32_t> funcIDMap;
  ...
  toolchain::StringMap<uint32_t> extendedInstSetIDMap;
