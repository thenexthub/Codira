...
/// key.
using BlockMergeInfoMap = toolchain::MapVector<Block *, BlockMergeInfo>;
...
private:
  ...
  StringAttr getSymbolDecoration(StringRef decorationName) {
    auto attrName = toolchain::convertToSnakeFromCamelCase(decorationName);
...
private:
  ...
  toolchain::SmallSetVector<spirv::Capability, 4> capabilities;

  /// The list of extensions used by the module.
  toolchain::SmallSetVector<spirv::Extension, 2> extensions;
