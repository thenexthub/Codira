...
lookupOrCreateBinaryFn(OpBuilder &b, SymbolOpInterface symTable, StringRef name,
  ...
  std::string funcName = (toolchain::Twine("_mlir_apfloat_") + name).str();
...
static Value forEachScalarValue(RewriterBase &rewriter, Location loc,
  ...
  for (auto [scalar1, scalar2] : toolchain::zip_equal(sclars1, scalars2)) {
...
static LogicalResult checkPreconditions(RewriterBase &rewriter, Operation *op) {
  for (Value value : toolchain::concat<Value>(op->getOperands(), op->getResults())) {
  ...
  LogicalResult matchAndRewrite(arith::CmpFOp op,
    ...
    Value repl = forEachScalarValue(
        ...
        [&](Value lhs, Value rhs, Type resultType) {
          ...
          auto checkResult = [&](toolchain::APFloat::cmpResult val) {
          ...
          std::function<Value(ArrayRef<toolchain::APFloat::cmpResult>)>
              checkResults = [&](ArrayRef<toolchain::APFloat::cmpResult> vals) {
          ...
          case arith::CmpFPredicate::OEQ:
            result = checkResult(toolchain::APFloat::cmpEqual);
            break;
          case arith::CmpFPredicate::OGT:
            result = checkResult(toolchain::APFloat::cmpGreaterThan);
            break;
          case arith::CmpFPredicate::OGE:
            result = checkResults(
                {toolchain::APFloat::cmpGreaterThan, toolchain::APFloat::cmpEqual});
            break;
          case arith::CmpFPredicate::OLT:
            result = checkResult(toolchain::APFloat::cmpLessThan);
            break;
          case arith::CmpFPredicate::OLE:
            result = checkResults(
                {toolchain::APFloat::cmpLessThan, toolchain::APFloat::cmpEqual});
            break;
          case arith::CmpFPredicate::ONE:
            // Not cmpUnordered and not cmpUnordered.
            result = checkResults(
                {toolchain::APFloat::cmpLessThan, toolchain::APFloat::cmpGreaterThan});
            break;
          case arith::CmpFPredicate::ORD:
            // Not cmpUnordered.
            result = checkResults({toolchain::APFloat::cmpLessThan,
                                   toolchain::APFloat::cmpGreaterThan,
                                   toolchain::APFloat::cmpEqual});
            break;
          case arith::CmpFPredicate::UEQ:
            result = checkResults(
                {toolchain::APFloat::cmpUnordered, toolchain::APFloat::cmpEqual});
            break;
          case arith::CmpFPredicate::UGT:
            result = checkResults(
                {toolchain::APFloat::cmpUnordered, toolchain::APFloat::cmpGreaterThan});
            break;
          case arith::CmpFPredicate::UGE:
            result = checkResults({toolchain::APFloat::cmpUnordered,
                                   toolchain::APFloat::cmpGreaterThan,
                                   toolchain::APFloat::cmpEqual});
            break;
          case arith::CmpFPredicate::ULT:
            result = checkResults(
                {toolchain::APFloat::cmpUnordered, toolchain::APFloat::cmpLessThan});
            break;
          case arith::CmpFPredicate::ULE:
            result = checkResults({toolchain::APFloat::cmpUnordered,
                                   toolchain::APFloat::cmpLessThan,
                                   toolchain::APFloat::cmpEqual});
            break;
          case arith::CmpFPredicate::UNE:
            ...
            result = checkResults({toolchain::APFloat::cmpLessThan,
                                   toolchain::APFloat::cmpGreaterThan,
                                   toolchain::APFloat::cmpUnordered});
            break;
          case arith::CmpFPredicate::UNO:
            result = checkResult(toolchain::APFloat::cmpUnordered);
            break;
