...
LogicalResult IndexSwitchOpLowering::matchAndRewrite(
  ...
  for (auto pair :
       toolchain::zip(adaptor.getCaseRegions(), loweredSwitch.getCaseRegions())) {
