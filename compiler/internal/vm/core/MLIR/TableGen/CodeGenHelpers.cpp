...
#include "vm/core/TableGen/CodeGenHelpers.h"
...
static ::toolchain::LogicalResult {0}(
    ::mlir::Operation *op, ::mlir::Type type, ::toolchain::StringRef valueKind,
    unsigned valueIndex) {
  if (!({1})) {
...
static ::toolchain::LogicalResult {0}(
    ::mlir::Attribute attr, ::toolchain::StringRef attrName, toolchain::function_ref<::mlir::InFlightDiagnostic()> emitError) {{
  if (attr && !({1}))
...
static ::toolchain::LogicalResult {0}(
    ::mlir::Operation *op, ::mlir::Attribute attr, ::toolchain::StringRef attrName) {{
...
static const char *const propConstraintCode = R"(
  static ::toolchain::LogicalResult {0}(
      {3} prop, ::toolchain::StringRef propName, toolchain::function_ref<::mlir::InFlightDiagnostic()> emitError) {{
    if (!({1}))
  ...
  static ::toolchain::LogicalResult {0}(
      ::mlir::Operation *op, {3} prop, ::toolchain::StringRef propName) {{
...
static ::toolchain::LogicalResult {0}(
    ...
    ::toolchain::StringRef successorName, unsigned successorIndex) {
  if (!({1})) {
...
static ::toolchain::LogicalResult {0}(
    ::mlir::Operation *op, ::mlir::Region &region, ::toolchain::StringRef regionName,
...
static ::toolchain::LogicalResult {0}(
    ...
    ::toolchain::StringRef failureStr) {
  if (!({1})) {
