...
#include "vm/core/XRay/InstrumentationMap.h"
...
loadObj(StringRef Filename, object::OwningBinary<object::ObjectFile> &ObjFile,
  ...
  uint64_t Address = 0;
  auto I = toolchain::find_if(Sections, [&](object::SectionRef Section) {
...
toolchain::xray::loadInstrumentationMap(StringRef Filename) {
