...
struct CodeSignatureInfo {
  ...
  static constexpr size_t BlobHeadersSize = toolchain::alignTo<8>(
      sizeof(toolchain::MachO::CS_SuperBlob) + sizeof(toolchain::MachO::CS_BlobIndex));
  ...
  static constexpr uint32_t FixedHeadersSize =
      BlobHeadersSize + sizeof(toolchain::MachO::CS_CodeDirectory);
