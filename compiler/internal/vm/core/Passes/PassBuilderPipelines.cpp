...
#include "vm/core/Transforms/IPO/Inliner.h"
...
#include "vm/core/Transforms/IPO/ModuleInliner.h"
...
#include "vm/core/Transforms/Utils/ExtraPassManager.h"
...
PassBuilder::buildModuleSimplificationPipeline(OptimizationLevel Level,
  ...
  if (Phase != ThinOrFullLTOPhase::ThinLTOPostLink) {
    ...
    // Lower toolchain.expect to metadata before attempting transforms.
...
PassBuilder::buildModuleOptimizationPipeline(OptimizationLevel Level,
  ...
  // FIXME: see discussion in https://reviews.toolchain.org/D112851,
  ...
  // toolchain.loop.distribute=true or when -enable-loop-distribute is specified.
...
PassBuilder::buildPerModuleDefaultPipeline(OptimizationLevel Level,
  ...
  // Convert @toolchain.global.annotations to !annotation metadata.
...
PassBuilder::buildFatLTODefaultPipeline(OptimizationLevel Level, bool ThinLTO,
  ...
  // module optimization and generate machine code. If toolchain.type.test() isn't in
