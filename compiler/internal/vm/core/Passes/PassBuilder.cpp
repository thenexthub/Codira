...
#include "vm/core/Analysis/AliasAnalysisEvaluator.h"
#include "vm/core/Analysis/AliasSetTracker.h"
...
#include "vm/core/Analysis/Delinearization.h"
#include "vm/core/Analysis/DemandedBits.h"
#include "vm/core/Analysis/DependenceAnalysis.h"
#include "vm/core/Analysis/DomPrinter.h"
#include "vm/core/Analysis/DominanceFrontier.h"
#include "vm/core/Analysis/EphemeralValuesCache.h"
#include "vm/core/Analysis/FunctionPropertiesAnalysis.h"
#include "vm/core/Analysis/GlobalsModRef.h"
#include "vm/core/Analysis/HashRecognize.h"
#include "vm/core/Analysis/IR2Vec.h"
#include "vm/core/Analysis/IVUsers.h"
#include "vm/core/Analysis/InlineAdvisor.h"
...
#include "vm/core/Analysis/LazyValueInfo.h"
#include "vm/core/Analysis/Lint.h"
#include "vm/core/Analysis/LoopAccessAnalysis.h"
#include "vm/core/Analysis/LoopCacheAnalysis.h"
#include "vm/core/Analysis/LoopInfo.h"
#include "vm/core/Analysis/LoopNestAnalysis.h"
...
#include "vm/core/Analysis/MustExecute.h"
#include "vm/core/Analysis/ObjCARCAliasAnalysis.h"
#include "vm/core/Analysis/PhiValues.h"
...
#include "vm/core/Analysis/ScalarEvolutionDivision.h"
...
#include "vm/core/Analysis/TypeBasedAliasAnalysis.h"
#include "vm/core/Analysis/UniformityAnalysis.h"
#include "vm/core/CodeGen/AssignmentTrackingAnalysis.h"
#include "vm/core/CodeGen/AtomicExpand.h"
#include "vm/core/CodeGen/BasicBlockSectionsProfileReader.h"
#include "vm/core/CodeGen/BranchFoldingPass.h"
#include "vm/core/CodeGen/BranchRelaxation.h"
#include "vm/core/CodeGen/CallBrPrepare.h"
#include "vm/core/CodeGen/CodeGenPrepare.h"
#include "vm/core/CodeGen/ComplexDeinterleavingPass.h"
#include "vm/core/CodeGen/DeadMachineInstructionElim.h"
#include "vm/core/CodeGen/DetectDeadLanes.h"
#include "vm/core/CodeGen/DwarfEHPrepare.h"
#include "vm/core/CodeGen/EarlyIfConversion.h"
#include "vm/core/CodeGen/EdgeBundles.h"
#include "vm/core/CodeGen/ExpandIRInsts.h"
#include "vm/core/CodeGen/ExpandMemCmp.h"
...
#include "vm/core/CodeGen/FixupStatepointCallerSaved.h"
...
#include "vm/core/CodeGen/GlobalMerge.h"
#include "vm/core/CodeGen/GlobalMergeFunctions.h"
#include "vm/core/CodeGen/HardwareLoops.h"
#include "vm/core/CodeGen/IndirectBrExpand.h"
#include "vm/core/CodeGen/InitUndef.h"
#include "vm/core/CodeGen/InterleavedAccess.h"
#include "vm/core/CodeGen/InterleavedLoadCombine.h"
...
#include "vm/core/CodeGen/LocalStackSlotAllocation.h"
...
#include "vm/core/CodeGen/MachineBlockPlacement.h"
#include "vm/core/CodeGen/MachineBranchProbabilityInfo.h"
#include "vm/core/CodeGen/MachineCSE.h"
#include "vm/core/CodeGen/MachineCopyPropagation.h"
#include "vm/core/CodeGen/MachineDominators.h"
#include "vm/core/CodeGen/MachineFunctionAnalysis.h"
#include "vm/core/CodeGen/MachineLICM.h"
#include "vm/core/CodeGen/MachineLateInstrsCleanup.h"
...
#include "vm/core/CodeGen/MachineSink.h"
#include "vm/core/CodeGen/MachineTraceMetrics.h"
...
#include "vm/core/CodeGen/PEI.h"
#include "vm/core/CodeGen/PHIElimination.h"
#include "vm/core/CodeGen/PatchableFunction.h"
#include "vm/core/CodeGen/PeepholeOptimizer.h"
#include "vm/core/CodeGen/PostRAHazardRecognizer.h"
#include "vm/core/CodeGen/PostRAMachineSink.h"
#include "vm/core/CodeGen/PostRASchedulerList.h"
#include "vm/core/CodeGen/PreISelIntrinsicLowering.h"
#include "vm/core/CodeGen/ProcessImplicitDefs.h"
#include "vm/core/CodeGen/ReachingDefAnalysis.h"
#include "vm/core/CodeGen/RegAllocEvictionAdvisor.h"
#include "vm/core/CodeGen/RegAllocFast.h"
#include "vm/core/CodeGen/RegAllocGreedyPass.h"
#include "vm/core/CodeGen/RegAllocPriorityAdvisor.h"
#include "vm/core/CodeGen/RegUsageInfoCollector.h"
#include "vm/core/CodeGen/RegUsageInfoPropagate.h"
#include "vm/core/CodeGen/RegisterCoalescerPass.h"
...
#include "vm/core/CodeGen/RenameIndependentSubregs.h"
#include "vm/core/CodeGen/ReplaceWithVeclib.h"
#include "vm/core/CodeGen/SafeStack.h"
#include "vm/core/CodeGen/SanitizerBinaryMetadata.h"
#include "vm/core/CodeGen/SelectOptimize.h"
#include "vm/core/CodeGen/ShadowStackGCLowering.h"
#include "vm/core/CodeGen/ShrinkWrap.h"
#include "vm/core/CodeGen/SjLjEHPrepare.h"
#include "vm/core/CodeGen/SlotIndexes.h"
#include "vm/core/CodeGen/SpillPlacement.h"
#include "vm/core/CodeGen/StackColoring.h"
#include "vm/core/CodeGen/StackFrameLayoutAnalysisPass.h"
...
#include "vm/core/CodeGen/TwoAddressInstructionPass.h"
#include "vm/core/CodeGen/TypePromotion.h"
#include "vm/core/CodeGen/UnreachableBlockElim.h"
#include "vm/core/CodeGen/VirtRegMap.h"
#include "vm/core/CodeGen/WasmEHPrepare.h"
#include "vm/core/CodeGen/WinEHPrepare.h"
...
#include "vm/core/IR/SafepointIRVerifier.h"
...
#include "vm/core/Transforms/AggressiveInstCombine/AggressiveInstCombine.h"
#include "vm/core/Transforms/CFGuard.h"
...
#include "vm/core/Transforms/Coroutines/CoroEarly.h"
#include "vm/core/Transforms/Coroutines/CoroElide.h"
#include "vm/core/Transforms/Coroutines/CoroSplit.h"
#include "vm/core/Transforms/HipStdPar/HipStdPar.h"
#include "vm/core/Transforms/IPO/AlwaysInliner.h"
#include "vm/core/Transforms/IPO/Annotation2Metadata.h"
#include "vm/core/Transforms/IPO/ArgumentPromotion.h"
#include "vm/core/Transforms/IPO/Attributor.h"
#include "vm/core/Transforms/IPO/BlockExtractor.h"
#include "vm/core/Transforms/IPO/CalledValuePropagation.h"
#include "vm/core/Transforms/IPO/ConstantMerge.h"
#include "vm/core/Transforms/IPO/CrossDSOCFI.h"
#include "vm/core/Transforms/IPO/DeadArgumentElimination.h"
#include "vm/core/Transforms/IPO/ElimAvailExtern.h"
#include "vm/core/Transforms/IPO/EmbedBitcodePass.h"
#include "vm/core/Transforms/IPO/ExpandVariadics.h"
#include "vm/core/Transforms/IPO/FatLTOCleanup.h"
#include "vm/core/Transforms/IPO/ForceFunctionAttrs.h"
#include "vm/core/Transforms/IPO/FunctionAttrs.h"
#include "vm/core/Transforms/IPO/FunctionImport.h"
#include "vm/core/Transforms/IPO/GlobalDCE.h"
#include "vm/core/Transforms/IPO/GlobalOpt.h"
#include "vm/core/Transforms/IPO/GlobalSplit.h"
#include "vm/core/Transforms/IPO/HotColdSplitting.h"
#include "vm/core/Transforms/IPO/IROutliner.h"
#include "vm/core/Transforms/IPO/InferFunctionAttrs.h"
#include "vm/core/Transforms/IPO/Internalize.h"
#include "vm/core/Transforms/IPO/LoopExtractor.h"
#include "vm/core/Transforms/IPO/LowerTypeTests.h"
#include "vm/core/Transforms/IPO/MemProfContextDisambiguation.h"
#include "vm/core/Transforms/IPO/MergeFunctions.h"
#include "vm/core/Transforms/IPO/OpenMPOpt.h"
#include "vm/core/Transforms/IPO/PartialInlining.h"
#include "vm/core/Transforms/IPO/SCCP.h"
#include "vm/core/Transforms/IPO/SampleProfile.h"
#include "vm/core/Transforms/IPO/SampleProfileProbe.h"
#include "vm/core/Transforms/IPO/StripDeadPrototypes.h"
#include "vm/core/Transforms/IPO/StripSymbols.h"
#include "vm/core/Transforms/IPO/WholeProgramDevirt.h"
#include "vm/core/Transforms/InstCombine/InstCombine.h"
#include "vm/core/Transforms/Instrumentation/AddressSanitizer.h"
#include "vm/core/Transforms/Instrumentation/AllocToken.h"
#include "vm/core/Transforms/Instrumentation/BoundsChecking.h"
#include "vm/core/Transforms/Instrumentation/CGProfile.h"
#include "vm/core/Transforms/Instrumentation/ControlHeightReduction.h"
#include "vm/core/Transforms/Instrumentation/DataFlowSanitizer.h"
#include "vm/core/Transforms/Instrumentation/GCOVProfiler.h"
#include "vm/core/Transforms/Instrumentation/HWAddressSanitizer.h"
#include "vm/core/Transforms/Instrumentation/InstrProfiling.h"
#include "vm/core/Transforms/Instrumentation/KCFI.h"
#include "vm/core/Transforms/Instrumentation/LowerAllowCheckPass.h"
#include "vm/core/Transforms/Instrumentation/MemProfInstrumentation.h"
#include "vm/core/Transforms/Instrumentation/MemProfUse.h"
#include "vm/core/Transforms/Instrumentation/MemorySanitizer.h"
#include "vm/core/Transforms/Instrumentation/NumericalStabilitySanitizer.h"
#include "vm/core/Transforms/Instrumentation/PGOCtxProfFlattening.h"
#include "vm/core/Transforms/Instrumentation/PGOCtxProfLowering.h"
...
#include "vm/core/Transforms/Instrumentation/SanitizerCoverage.h"
#include "vm/core/Transforms/Instrumentation/ThreadSanitizer.h"
#include "vm/core/Transforms/Instrumentation/TypeSanitizer.h"
#include "vm/core/Transforms/ObjCARC.h"
#include "vm/core/Transforms/Scalar/ADCE.h"
#include "vm/core/Transforms/Scalar/AlignmentFromAssumptions.h"
#include "vm/core/Transforms/Scalar/AnnotationRemarks.h"
#include "vm/core/Transforms/Scalar/BDCE.h"
#include "vm/core/Transforms/Scalar/CallSiteSplitting.h"
#include "vm/core/Transforms/Scalar/ConstantHoisting.h"
#include "vm/core/Transforms/Scalar/ConstraintElimination.h"
#include "vm/core/Transforms/Scalar/CorrelatedValuePropagation.h"
#include "vm/core/Transforms/Scalar/DCE.h"
#include "vm/core/Transforms/Scalar/DFAJumpThreading.h"
#include "vm/core/Transforms/Scalar/DeadStoreElimination.h"
#include "vm/core/Transforms/Scalar/DivRemPairs.h"
#include "vm/core/Transforms/Scalar/DropUnnecessaryAssumes.h"
#include "vm/core/Transforms/Scalar/EarlyCSE.h"
#include "vm/core/Transforms/Scalar/FlattenCFG.h"
#include "vm/core/Transforms/Scalar/Float2Int.h"
#include "vm/core/Transforms/Scalar/GVN.h"
#include "vm/core/Transforms/Scalar/GuardWidening.h"
#include "vm/core/Transforms/Scalar/IVUsersPrinter.h"
#include "vm/core/Transforms/Scalar/IndVarSimplify.h"
#include "vm/core/Transforms/Scalar/InductiveRangeCheckElimination.h"
#include "vm/core/Transforms/Scalar/InferAddressSpaces.h"
...
#include "vm/core/Transforms/Scalar/JumpThreading.h"
#include "vm/core/Transforms/Scalar/LICM.h"
#include "vm/core/Transforms/Scalar/LoopAccessAnalysisPrinter.h"
#include "vm/core/Transforms/Scalar/LoopBoundSplit.h"
#include "vm/core/Transforms/Scalar/LoopDataPrefetch.h"
#include "vm/core/Transforms/Scalar/LoopDeletion.h"
#include "vm/core/Transforms/Scalar/LoopDistribute.h"
#include "vm/core/Transforms/Scalar/LoopFlatten.h"
#include "vm/core/Transforms/Scalar/LoopFuse.h"
#include "vm/core/Transforms/Scalar/LoopIdiomRecognize.h"
#include "vm/core/Transforms/Scalar/LoopInstSimplify.h"
#include "vm/core/Transforms/Scalar/LoopInterchange.h"
#include "vm/core/Transforms/Scalar/LoopLoadElimination.h"
#include "vm/core/Transforms/Scalar/LoopPassManager.h"
#include "vm/core/Transforms/Scalar/LoopPredication.h"
#include "vm/core/Transforms/Scalar/LoopRotation.h"
#include "vm/core/Transforms/Scalar/LoopSimplifyCFG.h"
#include "vm/core/Transforms/Scalar/LoopSink.h"
#include "vm/core/Transforms/Scalar/LoopStrengthReduce.h"
#include "vm/core/Transforms/Scalar/LoopTermFold.h"
#include "vm/core/Transforms/Scalar/LoopUnrollAndJamPass.h"
#include "vm/core/Transforms/Scalar/LoopUnrollPass.h"
#include "vm/core/Transforms/Scalar/LoopVersioningLICM.h"
#include "vm/core/Transforms/Scalar/LowerAtomicPass.h"
#include "vm/core/Transforms/Scalar/LowerConstantIntrinsics.h"
#include "vm/core/Transforms/Scalar/LowerExpectIntrinsic.h"
#include "vm/core/Transforms/Scalar/LowerGuardIntrinsic.h"
#include "vm/core/Transforms/Scalar/LowerMatrixIntrinsics.h"
#include "vm/core/Transforms/Scalar/LowerWidenableCondition.h"
#include "vm/core/Transforms/Scalar/MakeGuardsExplicit.h"
#include "vm/core/Transforms/Scalar/MemCpyOptimizer.h"
#include "vm/core/Transforms/Scalar/MergeICmps.h"
#include "vm/core/Transforms/Scalar/MergedLoadStoreMotion.h"
#include "vm/core/Transforms/Scalar/NaryReassociate.h"
#include "vm/core/Transforms/Scalar/NewGVN.h"
#include "vm/core/Transforms/Scalar/PartiallyInlineLibCalls.h"
#include "vm/core/Transforms/Scalar/PlaceSafepoints.h"
#include "vm/core/Transforms/Scalar/Reassociate.h"
#include "vm/core/Transforms/Scalar/Reg2Mem.h"
#include "vm/core/Transforms/Scalar/RewriteStatepointsForGC.h"
#include "vm/core/Transforms/Scalar/SCCP.h"
#include "vm/core/Transforms/Scalar/SROA.h"
#include "vm/core/Transforms/Scalar/ScalarizeMaskedMemIntrin.h"
#include "vm/core/Transforms/Scalar/Scalarizer.h"
#include "vm/core/Transforms/Scalar/SeparateConstOffsetFromGEP.h"
#include "vm/core/Transforms/Scalar/SimpleLoopUnswitch.h"
#include "vm/core/Transforms/Scalar/SimplifyCFG.h"
#include "vm/core/Transforms/Scalar/Sink.h"
#include "vm/core/Transforms/Scalar/SpeculativeExecution.h"
#include "vm/core/Transforms/Scalar/StraightLineStrengthReduce.h"
#include "vm/core/Transforms/Scalar/StructurizeCFG.h"
#include "vm/core/Transforms/Scalar/TailRecursionElimination.h"
#include "vm/core/Transforms/Scalar/WarnMissedTransforms.h"
#include "vm/core/Transforms/Utils/AddDiscriminators.h"
#include "vm/core/Transforms/Utils/AssumeBundleBuilder.h"
#include "vm/core/Transforms/Utils/BreakCriticalEdges.h"
#include "vm/core/Transforms/Utils/CanonicalizeAliases.h"
#include "vm/core/Transforms/Utils/CanonicalizeFreezeInLoops.h"
#include "vm/core/Transforms/Utils/CountVisits.h"
...
#include "vm/core/Transforms/Utils/FixIrreducible.h"
#include "vm/core/Transforms/Utils/HelloWorld.h"
#include "vm/core/Transforms/Utils/IRNormalizer.h"
#include "vm/core/Transforms/Utils/InjectTLIMappings.h"
#include "vm/core/Transforms/Utils/InstructionNamer.h"
#include "vm/core/Transforms/Utils/LibCallsShrinkWrap.h"
#include "vm/core/Transforms/Utils/LoopSimplify.h"
#include "vm/core/Transforms/Utils/LoopVersioning.h"
...
#include "vm/core/Transforms/Utils/LowerSwitch.h"
#include "vm/core/Transforms/Utils/Mem2Reg.h"
#include "vm/core/Transforms/Utils/MetaRenamer.h"
#include "vm/core/Transforms/Utils/MoveAutoInit.h"
#include "vm/core/Transforms/Utils/NameAnonGlobals.h"
#include "vm/core/Transforms/Utils/PredicateInfo.h"
#include "vm/core/Transforms/Utils/ProfileVerify.h"
#include "vm/core/Transforms/Utils/RelLookupTableConverter.h"
#include "vm/core/Transforms/Utils/StripGCRelocates.h"
#include "vm/core/Transforms/Utils/StripNonLineTableDebugInfo.h"
#include "vm/core/Transforms/Utils/SymbolRewriter.h"
#include "vm/core/Transforms/Utils/UnifyFunctionExitNodes.h"
#include "vm/core/Transforms/Utils/UnifyLoopExits.h"
#include "vm/core/Transforms/Vectorize/LoadStoreVectorizer.h"
#include "vm/core/Transforms/Vectorize/LoopIdiomVectorize.h"
#include "vm/core/Transforms/Vectorize/LoopVectorize.h"
#include "vm/core/Transforms/Vectorize/SLPVectorizer.h"
#include "vm/core/Transforms/Vectorize/SandboxVectorizer/SandboxVectorizer.h"
#include "vm/core/Transforms/Vectorize/VectorCombine.h"
#include <optional>

using namespace vm::core;

cl::opt<bool> toolchain::PrintPipelinePasses(
...
#define MACHINE_FUNCTION_PASS_WITH_PARAMS(NAME, CLASS, CREATE_PASS, PARSER,    \
                                          PARAMS)                              \
  PIC->addClassToPassName(CLASS, NAME);
#include "vm/core/Passes/MachinePassRegistry.def"
    });
  }
