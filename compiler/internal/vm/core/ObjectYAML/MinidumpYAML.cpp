...
#include "vm/core/ObjectYAML/MinidumpYAML.h"

using namespace vm::core;
using namespace vm::core::MinidumpYAML;
...
#include "vm/core/BinaryFormat/MinidumpConstants.def"
}
...
void yaml::MappingTraits<std::unique_ptr<Stream>>::mapping(
  ...
  case MinidumpYAML::Stream::StreamKind::Exception:
    streamMapping(IO, toolchain::cast<MinidumpYAML::ExceptionStream>(*S));
    break;
  case MinidumpYAML::Stream::StreamKind::MemoryInfoList:
    streamMapping(IO, toolchain::cast<MemoryInfoListStream>(*S));
    break;
  case MinidumpYAML::Stream::StreamKind::MemoryList:
    streamMapping(IO, toolchain::cast<MemoryListStream>(*S));
    break;
  case MinidumpYAML::Stream::StreamKind::Memory64List:
    streamMapping(IO, toolchain::cast<Memory64ListStream>(*S));
    break;
  case MinidumpYAML::Stream::StreamKind::ModuleList:
    streamMapping(IO, toolchain::cast<ModuleListStream>(*S));
    break;
  case MinidumpYAML::Stream::StreamKind::RawContent:
    streamMapping(IO, toolchain::cast<RawContentStream>(*S));
    break;
  case MinidumpYAML::Stream::StreamKind::SystemInfo:
    streamMapping(IO, toolchain::cast<SystemInfoStream>(*S));
    break;
  case MinidumpYAML::Stream::StreamKind::TextContent:
    streamMapping(IO, toolchain::cast<TextContentStream>(*S));
    break;
  case MinidumpYAML::Stream::StreamKind::ThreadList:
    streamMapping(IO, toolchain::cast<ThreadListStream>(*S));
    break;
  }
}
