...
#include "vm/core/DebugInfo/CodeView/TypeStreamMerger.h"
...
private:
  ...
  Error errorCorruptRecord() const {
    return toolchain::make_error<CodeViewError>(cv_error_code::corrupt_record);
  }
...
Error toolchain::codeview::mergeTypeRecords(MergingTypeTableBuilder &Dest,
...
Error toolchain::codeview::mergeIdRecords(MergingTypeTableBuilder &Dest,
                                     ArrayRef<TypeIndex> TypeSourceToDest,
                                     SmallVectorImpl<TypeIndex> &SourceToDest,
                                     const CVTypeArray &Ids) {
  TypeStreamMerger M(SourceToDest);
...
Error toolchain::codeview::mergeTypeAndIdRecords(
    MergingTypeTableBuilder &DestIds, MergingTypeTableBuilder &DestTypes,
...
Error toolchain::codeview::mergeTypeRecords(GlobalTypeTableBuilder &Dest,
                                       SmallVectorImpl<TypeIndex> &SourceToDest,
                                       const CVTypeArray &Types,
                                       ArrayRef<GloballyHashedType> Hashes,
                                       std::optional<PCHMergerInfo> &PCHInfo) {
...
Error toolchain::codeview::mergeIdRecords(GlobalTypeTableBuilder &Dest,
