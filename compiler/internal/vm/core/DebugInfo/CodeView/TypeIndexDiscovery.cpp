...
void toolchain::codeview::discoverTypeIndices(const CVType &Type,
                                         SmallVectorImpl<TiReference> &Refs) {
...
static void resolveTypeIndexReferences(ArrayRef<uint8_t> RecordData,
  ...
  BinaryStreamReader Reader(RecordData, toolchain::endianness::little);
...
void toolchain::codeview::discoverTypeIndices(ArrayRef<uint8_t> RecordData,
                                         SmallVectorImpl<TypeIndex> &Indices) {
...
bool toolchain::codeview::discoverTypeIndicesInSymbol(
