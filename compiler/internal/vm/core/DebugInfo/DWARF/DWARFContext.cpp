...
#include "vm/core/Object/RelocationResolver.h"
...
static void dumpRnglistsSection(
    ...
    toolchain::function_ref<std::optional<object::SectionedAddress>(uint32_t)>
        LookupPooledAddress,
    DIDumpOptions DumpOpts) {
  uint64_t Offset = 0;
  while (rnglistData.isValidOffset(Offset)) {
    toolchain::DWARFDebugRnglistTable Rnglists;
    uint64_t TableOffset = Offset;
...
static Error createError(const Twine &Reason, toolchain::Error E) {
