...
void DWARFDebugNames::NameIndex::dumpAbbreviations(ScopedPrinter &W) const {
  ...
  toolchain::sort(AbbrevsVect, [](const Abbrev *LHS, const Abbrev *RHS) {
...
std::optional<ObjCSelectorNames> toolchain::getObjCNamesIfSelector(StringRef Name) {
...
std::optional<StringRef> toolchain::StripTemplateParameters(StringRef Name) {
