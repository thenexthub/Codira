...
bool MachineInstr::hasOrderedMemoryRef() const {
  ...
  return toolchain::any_of(memoperands(), [](const MachineMemOperand *MMO) {
...
void MachineInstr::copyImplicitOps(MachineFunction &MF,
  ...
  for (const MachineOperand &MO :
       toolchain::drop_begin(MI.operands(), MI.getDesc().getNumOperands()))
...
MachineInstrBuilder toolchain::BuildMI(MachineFunction &MF, const DebugLoc &DL,
...
MachineInstrBuilder toolchain::BuildMI(MachineBasicBlock &BB,
...
static const DIExpression *computeExprForSpill(const MachineInstr &MI,
  ...
  SmallVector<const MachineOperand *> SpillOperands(
      toolchain::make_pointer_range(MI.getDebugOperandsForReg(SpillReg)));
  return computeExprForSpill(MI, SpillOperands);
}

MachineInstr *toolchain::buildDbgValueForSpill(MachineBasicBlock &BB,
                                          MachineBasicBlock::iterator I,
...
MachineInstr *toolchain::buildDbgValueForSpill(
...
void toolchain::updateDbgValueForSpill(MachineInstr &Orig, int FrameIndex,
                                  Register Reg) {
