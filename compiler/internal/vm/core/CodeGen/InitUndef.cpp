...
//
//
// See also: https://github.com/toolchain/toolchain-project/issues/50157
//
...
char &toolchain::InitUndefID = InitUndefLegacy::ID;

static bool isEarlyClobberMI(MachineInstr &MI) {
  return toolchain::any_of(MI.all_defs(), [](const MachineOperand &DefMO) {
