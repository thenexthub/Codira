...
Spiller *
toolchain::createInlineSpiller(const InlineSpiller::RequiredAnalyses &Analyses,
                          MachineFunction &MF, VirtRegMap &VRM,
...
void InlineSpiller::collectRegsToSpill() {
  ...
  for (MachineInstr &MI : toolchain::make_early_inc_range(MRI.reg_bundles(Reg))) {
...
void InlineSpiller::eliminateRedundantSpills(LiveInterval &SLI, VNInfo *VNI) {
  ...
  do {
    ...
    for (MachineInstr &MI :
         toolchain::make_early_inc_range(MRI.use_nodbg_bundles(Reg))) {
...
void InlineSpiller::spillAll() {
  ...
  for (Register Reg : RegsToSpill) {
    for (MachineInstr &MI :
         toolchain::make_early_inc_range(MRI.reg_instructions(Reg))) {
