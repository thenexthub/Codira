...
#include "vm/core/CodeGen/MIR2Vec.h"
...
MachineFunctionPass *
toolchain::createMIR2VecVocabPrinterLegacyPass(raw_ostream &OS) {
...
MachineFunctionPass *toolchain::createMIR2VecPrinterLegacyPass(raw_ostream &OS) {
