...
#include "vm/core/CodeGen/CFIFixup.h"
...
FunctionPass *toolchain::createCFIFixup() { return new CFIFixup(); }
...
static bool containsEpilogue(const MachineBasicBlock &MBB) {
  return toolchain::any_of(toolchain::reverse(MBB), [](const auto &MI) {
    return MI.getOpcode() == TargetOpcode::CFI_INSTRUCTION &&
