...
PreservedAnalyses
toolchain::StackFrameLayoutAnalysisPass::run(MachineFunction &MF,
...
char &toolchain::StackFrameLayoutAnalysisPassID = StackFrameLayoutAnalysisLegacy::ID;
...
MachineFunctionPass *toolchain::createStackFrameLayoutAnalysisPass() {
