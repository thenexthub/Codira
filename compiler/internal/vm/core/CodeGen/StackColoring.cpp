...
char &toolchain::StackColoringLegacyID = StackColoringLegacy::ID;
...
void StackColoring::remapInstructions(DenseMap<int, int> &SlotRemap) {
  ...
  for (const std::pair<int, int> &SI : SlotRemap) {
    ...
    // The new alloca might not be valid in a toolchain.dbg.declare for this
...
bool StackColoring::run(MachineFunction &Func, bool OnlyRemoveMarkers) {
  ...
  toolchain::stable_sort(SortedSlots, [this](int LHS, int RHS) {
