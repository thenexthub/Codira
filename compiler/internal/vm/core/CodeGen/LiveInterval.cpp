...
private:
  ...
  iterator findInsertPos(Segment S) { return toolchain::upper_bound(*LR, S.start); }
};
...
LiveRange::iterator LiveRange::find(SlotIndex Pos) {
  return toolchain::partition_point(*this,
...
raw_ostream& toolchain::operator<<(raw_ostream& OS, const LiveRange::Segment &S) {
...
void ConnectedVNInfoEqClasses::Distribute(LiveInterval &LI, LiveInterval *LIV[],
  ...
  for (MachineOperand &MO :
       toolchain::make_early_inc_range(MRI.reg_operands(LI.reg()))) {
