...
// https://discourse.toolchain.org/t/rfc-profile-guided-static-data-partitioning/83744
...
StaticDataSplitter::getConstant(const MachineOperand &Op,
  ...
  if (Op.isGlobal()) {
    ...
    if (!GV || !toolchain::memprof::IsAnnotationOK(*GV) ||
...
MachineFunctionPass *toolchain::createStaticDataSplitterPass() {
