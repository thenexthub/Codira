...
#include "vm/core/CodeGen/AtomicExpandUtils.h"
...
private:
  ...
  friend bool
  toolchain::expandAtomicRMWToCmpXchg(AtomicRMWInst *AI,
...
char &toolchain::AtomicExpandID = AtomicExpandLegacy::ID;
...
FunctionPass *toolchain::createAtomicExpandLegacyPass() {
...
bool toolchain::expandAtomicRMWToCmpXchg(AtomicRMWInst *AI,
                                    CreateCmpXchgInstFun CreateCmpXchg) {
