...
bool SwitchCG::SwitchLowering::buildBitTests(CaseClusterVector &Clusters,
  ...
  BitTestInfo BTI;
  toolchain::sort(CBV, [](const CaseBits &a, const CaseBits &b) {
...
void SwitchCG::sortAndRangeify(CaseClusterVector &Clusters) {
  ...
  toolchain::sort(Clusters, [](const CaseCluster &a, const CaseCluster &b) {
...
toolchain::SwitchCG::SwitchLowering::SplitWorkItemInfo
