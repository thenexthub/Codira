...
char &toolchain::BranchFolderPassID = BranchFolderLegacy::ID;
...
ProfitableToMerge(MachineBasicBlock *MBB1, MachineBasicBlock *MBB2,
  ...
  bool OptForSize = toolchain::shouldOptimizeForSize(MBB1, PSI, &MBBFreqInfo) &&
                    toolchain::shouldOptimizeForSize(MBB2, PSI, &MBBFreqInfo);
...
bool BranchFolder::HoistCommonCode(MachineFunction &MF) {
  bool MadeChange = false;
  for (MachineBasicBlock &MBB : toolchain::make_early_inc_range(MF))
