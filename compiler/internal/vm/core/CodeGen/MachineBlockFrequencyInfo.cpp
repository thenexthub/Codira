...
template <> struct toolchain::GraphTraits<MachineBlockFrequencyInfo *> {
...
template <>
struct toolchain::DOTGraphTraits<MachineBlockFrequencyInfo *>
...
Printable toolchain::printBlockFreq(const MachineBlockFrequencyInfo &MBFI,
                               BlockFrequency Freq) {
