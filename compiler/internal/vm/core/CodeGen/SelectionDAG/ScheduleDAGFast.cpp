...
toolchain::ScheduleDAGSDNodes *toolchain::createFastDAGScheduler(SelectionDAGISel *IS,
                                                       CodeGenOptLevel) {
  return new ScheduleDAGFast(*IS->MF);
}

toolchain::ScheduleDAGSDNodes *toolchain::createDAGLinearizer(SelectionDAGISel *IS,
                                                    CodeGenOptLevel) {
