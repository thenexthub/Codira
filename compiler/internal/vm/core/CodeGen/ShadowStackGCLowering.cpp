...
char &toolchain::ShadowStackGCLoweringID = ShadowStackGCLowering::ID;
...
FunctionPass *toolchain::createShadowStackGCLoweringPass() { return new ShadowStackGCLowering(); }
...
bool ShadowStackGCLoweringImpl::runOnFunction(Function &F,
  ...
  // Find calls to toolchain.gcroot.
  CollectRoots(F);
