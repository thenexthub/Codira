...
FunctionPass *toolchain::createWasmEHPass() { return new WasmEHPrepare(); }
...
bool WasmEHPrepareImpl::prepareThrows(Function &F) {
  ...
  // Insert an unreachable instruction after a call to @toolchain.wasm.throw and
...
void toolchain::calculateWasmEHInfo(const Function *F, WasmEHFuncInfo &EHInfo) {
