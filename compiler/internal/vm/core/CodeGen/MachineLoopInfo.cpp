...
template class LLVM_EXPORT_TEMPLATE
    toolchain::LoopBase<MachineBasicBlock, MachineLoop>;
template class LLVM_EXPORT_TEMPLATE
    toolchain::LoopInfoBase<MachineBasicBlock, MachineLoop>;
...
char &toolchain::MachineLoopInfoID = MachineLoopInfoWrapperPass::ID;
