...
class MemCmpExpansion {
  ...
  computeGreedyLoadSequence(uint64_t Size, toolchain::ArrayRef<unsigned> LoadSizes,
...
MemCmpExpansion::LoadEntryVector MemCmpExpansion::computeGreedyLoadSequence(
    uint64_t Size, toolchain::ArrayRef<unsigned> LoadSizes,
...
MemCmpExpansion::MemCmpExpansion(
  ...
  toolchain::ArrayRef<unsigned> LoadSizes(Options.LoadSizes);
...
///  %4 = load i64, i64* %2
///  %5 = load i64, i64* %3
///  %6 = call i64 @toolchain.bswap.i64(i64 %4)
///  %7 = call i64 @toolchain.bswap.i64(i64 %5)
///  %8 = sub i64 %6, %7
///  %9 = icmp ne i64 %8, 0
...
///  %18 = load i32, i32* %16
///  %19 = load i32, i32* %17
///  %20 = call i32 @toolchain.bswap.i32(i32 %18)
///  %21 = call i32 @toolchain.bswap.i32(i32 %19)
...
///  %32 = load i16, i16* %30
///  %33 = load i16, i16* %31
///  %34 = call i16 @toolchain.bswap.i16(i16 %32)
///  %35 = call i16 @toolchain.bswap.i16(i16 %33)
...
FunctionPass *toolchain::createExpandMemCmpLegacyPass() {
