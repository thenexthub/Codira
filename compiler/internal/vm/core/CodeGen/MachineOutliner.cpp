...
///
/// http://www.toolchain.org/devmtg/2016-11/Slides/Paquette-Outliner.pdf
///
...
///
/// http://lists.toolchain.org/pipermail/toolchain-dev/2016-August/104170.html
///
/// For more information on the suffix tree data structure, please see
/// https://www.cs.helsinki.fi/u/ukkonen/SuffixT1withFigs.pdf
///
//===----------------------------------------------------------------------===//
#include "vm/core/CodeGen/MachineOutliner.h"
...
#include "vm/core/CGData/CodeGenDataReader.h"
...
struct MachineOutliner : public ModulePass {
  ...
  /// A post-process using toolchain-cgdata, lld, or ThinLTO can merge them into
...
ModulePass *toolchain::createMachineOutlinerPass(RunOutliner RunOutlinerMode) {
...
void MachineOutliner::findCandidates(
  ...
  for (SuffixTree::RepeatedSubstring &RS : ST) {
    ...
    toolchain::sort(RS.StartIndices);
...
void MachineOutliner::emitOutlinedHashTree(Module &M) {
  ...
  if (!LocalHashTree->empty()) {
    ...
    toolchain::StringRef Data(Buf.data(), Buf.size());
