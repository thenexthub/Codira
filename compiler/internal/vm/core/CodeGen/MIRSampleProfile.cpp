...
#include "vm/core/CodeGen/MIRSampleProfile.h"
...
#include "vm/core/Transforms/Utils/SampleProfileLoaderBaseImpl.h"
#include "vm/core/Transforms/Utils/SampleProfileLoaderBaseUtil.h"
#include <optional>

using namespace vm::core;
using namespace sampleprof;
using namespace vm::core::sampleprofutil;
...
char &toolchain::MIRProfileLoaderPassID = MIRProfileLoaderPass::ID;

FunctionPass *
toolchain::createMIRProfileLoaderPass(std::string File, std::string RemappingFile,
