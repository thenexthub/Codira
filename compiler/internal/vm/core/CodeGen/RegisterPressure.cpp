...
LLVM_DUMP_METHOD
void toolchain::dumpRegSetPressure(ArrayRef<unsigned> SetPressure,
...
static LaneBitmask getRegLanes(ArrayRef<VRegMaskOrUnit> RegUnits,
                               VirtRegOrUnit VRegOrUnit) {
  auto I = toolchain::find_if(RegUnits, [VRegOrUnit](const VRegMaskOrUnit Other) {
...
class RegisterOperandsCollector {
  friend class toolchain::RegisterOperands;
