...
char &toolchain::TwoAddressInstructionPassID = TwoAddressInstructionLegacyPass::ID;
...
void TwoAddressInstructionImpl::processTiedPairs(MachineInstr *MI,
                                                 ...
                                                 unsigned &Dist) {
  bool IsEarlyClobber = toolchain::any_of(TiedPairs, [MI](auto const &TP) {
