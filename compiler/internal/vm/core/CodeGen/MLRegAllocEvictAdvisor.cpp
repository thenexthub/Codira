...
FunctionPass *toolchain::createRegAllocScoringPass() {
...
using FeaturesListNormalizer =
    toolchain::SmallVector<float, FeatureIDs::FeatureCount>;
...
protected:
  ...
  loadInterferenceFeatures(const LiveInterval &VirtReg, MCRegister PhysReg,
                           ...
                           toolchain::SmallVectorImpl<float> &Largest, size_t Pos,
...
bool MLEvictAdvisor::loadInterferenceFeatures(
    ...
    toolchain::SmallVectorImpl<float> &Largest, size_t Pos,
    toolchain::SmallVectorImpl<LRStartEndInfo> &LRPosInfo) const {
...
void MLEvictAdvisor::extractFeatures(
    ...
    toolchain::SmallVectorImpl<float> &Largest, size_t Pos, int64_t IsHint,
...
toolchain::createDevelopmentModeAdvisorAnalysisLegacy() {
...
toolchain::createReleaseModeAdvisorProvider(LLVMContext &Ctx) {
  return new ReleaseModeEvictionAdvisorProvider(Ctx);
}

RegAllocEvictionAdvisorProvider *
toolchain::createDevelopmentModeAdvisorProvider(LLVMContext &Ctx) {
...
RegAllocEvictionAdvisorAnalysisLegacy *
toolchain::createReleaseModeAdvisorAnalysisLegacy() {
