...
char toolchain::GISelValueTrackingAnalysisLegacy::ID = 0;
...
void GISelValueTracking::computeKnownFPClass(Register R,
  ...
  toolchain::scope_exit ClearClassesFromFlags(
  ...
  case TargetOpcode::G_SHUFFLE_VECTOR: {
    ...
    if (DstTy.isScalableVector()) {
      ...
      if (!toolchain::getShuffleDemandedElts(DstTy.getNumElements(), Shuf.getMask(),
