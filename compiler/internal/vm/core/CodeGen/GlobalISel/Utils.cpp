//===- toolchain/CodeGen/GlobalISel/Utils.cpp -------------------------*- C++ -*-==//
//
...
#include "vm/core/CodeGen/CodeGenCommonISel.h"
...
Register toolchain::constrainRegToClass(MachineRegisterInfo &MRI,
...
Register toolchain::constrainOperandRegClass(
...
bool toolchain::constrainSelectedInstRegOperands(MachineInstr &I,
                                            const TargetInstrInfo &TII,
...
bool toolchain::canReplaceReg(Register DstReg, Register SrcReg,
...
bool toolchain::isTriviallyDead(const MachineInstr &MI,
...
void toolchain::reportGISelWarning(MachineFunction &MF,
                              MachineOptimizationRemarkEmitter &MORE,
                              MachineOptimizationRemarkMissed &R) {
  reportGISelDiagnostic(DS_Warning, MF, MORE, R);
}

void toolchain::reportGISelFailure(MachineFunction &MF,
                              MachineOptimizationRemarkEmitter &MORE,
                              MachineOptimizationRemarkMissed &R) {
...
unsigned toolchain::getInverseGMinMaxOpcode(unsigned MinMaxOpc) {
  switch (MinMaxOpc) {
...
std::optional<APInt> toolchain::getIConstantVRegVal(Register VReg,
                                               const MachineRegisterInfo &MRI) {
...
const APInt &toolchain::getIConstantFromReg(Register Reg,
                                       const MachineRegisterInfo &MRI) {
...
toolchain::getIConstantVRegSExtVal(Register VReg, const MachineRegisterInfo &MRI) {
...
std::optional<ValueAndVReg> toolchain::getIConstantVRegValWithLookThrough(
    Register VReg, const MachineRegisterInfo &MRI, bool LookThroughInstrs) {
  return getConstantVRegValWithLookThrough<isIConstant, getCImmAsAPInt>(
      VReg, MRI, LookThroughInstrs);
}

std::optional<ValueAndVReg> toolchain::getAnyConstantVRegValWithLookThrough(
    Register VReg, const MachineRegisterInfo &MRI, bool LookThroughInstrs,
...
std::optional<FPValueAndVReg> toolchain::getFConstantVRegValWithLookThrough(
    Register VReg, const MachineRegisterInfo &MRI, bool LookThroughInstrs) {
  auto Reg =
...
const ConstantFP *
toolchain::getConstantFPVRegVal(Register VReg, const MachineRegisterInfo &MRI) {
...
toolchain::getDefSrcRegIgnoringCopies(Register Reg, const MachineRegisterInfo &MRI) {
...
MachineInstr *toolchain::getDefIgnoringCopies(Register Reg,
                                         const MachineRegisterInfo &MRI) {
...
Register toolchain::getSrcRegIgnoringCopies(Register Reg,
                                       const MachineRegisterInfo &MRI) {
  std::optional<DefinitionAndSourceRegister> DefSrcReg =
      getDefSrcRegIgnoringCopies(Reg, MRI);
...
void toolchain::extractParts(Register Reg, LLT Ty, int NumParts,
...
bool toolchain::extractParts(Register Reg, LLT RegTy, LLT MainTy, LLT &LeftoverTy,
                        SmallVectorImpl<Register> &VRegs,
...
void toolchain::extractVectorParts(Register Reg, unsigned NumElts,
                              SmallVectorImpl<Register> &VRegs,
                              MachineIRBuilder &MIRBuilder,
                              MachineRegisterInfo &MRI) {
...
MachineInstr *toolchain::getOpcodeDef(unsigned Opcode, Register Reg,
                                 const MachineRegisterInfo &MRI) {
  MachineInstr *DefMI = getDefIgnoringCopies(Reg, MRI);
  return DefMI && DefMI->getOpcode() == Opcode ? DefMI : nullptr;
}

APFloat toolchain::getAPFloatFromSize(double Val, unsigned Size) {
  if (Size == 32)
...
std::optional<APInt> toolchain::ConstantFoldBinOp(unsigned Opcode,
                                             const Register Op1,
                                             const Register Op2,
                                             const MachineRegisterInfo &MRI) {
...
toolchain::ConstantFoldFPBinOp(unsigned Opcode, const Register Op1,
...
SmallVector<APInt>
toolchain::ConstantFoldVectorBinop(unsigned Opcode, const Register Op1,
                              const Register Op2,
                              const MachineRegisterInfo &MRI) {
...
bool toolchain::isKnownNeverNaN(Register Val, const MachineRegisterInfo &MRI,
                           bool SNaN) {
...
Align toolchain::inferAlignFromPtrInfo(MachineFunction &MF,
...
Register toolchain::getFunctionLiveInPhysReg(MachineFunction &MF,
                                        const TargetInstrInfo &TII,
                                        MCRegister PhysReg,
...
std::optional<APInt> toolchain::ConstantFoldExtOp(unsigned Opcode,
...
std::optional<APInt> toolchain::ConstantFoldCastOp(unsigned Opcode, LLT DstTy,
                                              const Register Op0,
                                              const MachineRegisterInfo &MRI) {
...
std::optional<APFloat>
toolchain::ConstantFoldIntToFloat(unsigned Opcode, LLT DstTy, Register Src,
                             const MachineRegisterInfo &MRI) {
...
toolchain::ConstantFoldCountZeros(Register Src, const MachineRegisterInfo &MRI,
...
toolchain::ConstantFoldICmp(unsigned Pred, const Register Op1, const Register Op2,
...
bool toolchain::isKnownToBeAPowerOfTwo(Register Reg, const MachineRegisterInfo &MRI,
  ...
  case TargetOpcode::G_BUILD_VECTOR: {
    ...
    for (const MachineOperand &MO : toolchain::drop_begin(MI.operands()))
...
void toolchain::getSelectionDAGFallbackAnalysisUsage(AnalysisUsage &AU) {
  AU.addPreserved<StackProtector>();
}

LLT toolchain::getLCMType(LLT OrigTy, LLT TargetTy) {
...
LLT toolchain::getCoverTy(LLT OrigTy, LLT TargetTy) {
...
LLT toolchain::getGCDType(LLT OrigTy, LLT TargetTy) {
  if (OrigTy.getSizeInBits() == TargetTy.getSizeInBits())
    return OrigTy;
...
std::optional<int> toolchain::getSplatIndex(MachineInstr &MI) {
...
bool toolchain::isBuildVectorConstantSplat(const Register Reg,
                                      const MachineRegisterInfo &MRI,
...
bool toolchain::isBuildVectorConstantSplat(const MachineInstr &MI,
                                      const MachineRegisterInfo &MRI,
                                      int64_t SplatValue, bool AllowUndef) {
...
std::optional<APInt>
toolchain::getIConstantSplatVal(const Register Reg, const MachineRegisterInfo &MRI) {
...
std::optional<APInt>
toolchain::getIConstantSplatVal(const MachineInstr &MI,
                           const MachineRegisterInfo &MRI) {
  return getIConstantSplatVal(MI.getOperand(0).getReg(), MRI);
}

std::optional<int64_t>
toolchain::getIConstantSplatSExtVal(const Register Reg,
                               const MachineRegisterInfo &MRI) {
  if (auto SplatValAndReg =
          getAnyConstantSplat(Reg, MRI, /* AllowUndef */ false))
...
std::optional<int64_t>
toolchain::getIConstantSplatSExtVal(const MachineInstr &MI,
                               const MachineRegisterInfo &MRI) {
  return getIConstantSplatSExtVal(MI.getOperand(0).getReg(), MRI);
}

std::optional<FPValueAndVReg>
toolchain::getFConstantSplat(Register VReg, const MachineRegisterInfo &MRI,
                        bool AllowUndef) {
...
bool toolchain::isBuildVectorAllZeros(const MachineInstr &MI,
                                 const MachineRegisterInfo &MRI,
                                 bool AllowUndef) {
  return isBuildVectorConstantSplat(MI, MRI, 0, AllowUndef);
}

bool toolchain::isBuildVectorAllOnes(const MachineInstr &MI,
                                const MachineRegisterInfo &MRI,
                                bool AllowUndef) {
...
toolchain::getVectorSplat(const MachineInstr &MI, const MachineRegisterInfo &MRI) {
  unsigned Opc = MI.getOpcode();
...
bool toolchain::isConstantOrConstantVector(MachineInstr &MI,
                                      const MachineRegisterInfo &MRI) {
...
bool toolchain::isConstantOrConstantVector(const MachineInstr &MI,
                                      const MachineRegisterInfo &MRI,
...
std::optional<APInt>
toolchain::isConstantOrConstantSplatVector(MachineInstr &MI,
                                      const MachineRegisterInfo &MRI) {
  Register Def = MI.getOperand(0).getReg();
  if (auto C = getIConstantVRegValWithLookThrough(Def, MRI))
    return C->Value;
...
std::optional<APFloat>
toolchain::isConstantOrConstantSplatVectorFP(MachineInstr &MI,
                                        const MachineRegisterInfo &MRI) {
  Register Def = MI.getOperand(0).getReg();
...
bool toolchain::isNullOrNullSplat(const MachineInstr &MI,
...
bool toolchain::isAllOnesOrAllOnesSplat(const MachineInstr &MI,
                                   const MachineRegisterInfo &MRI,
                                   bool AllowUndefs) {
  switch (MI.getOpcode()) {
  case TargetOpcode::G_IMPLICIT_DEF:
...
bool toolchain::matchUnaryPredicate(
...
bool toolchain::isConstTrueVal(const TargetLowering &TLI, int64_t Val, bool IsVector,
                          bool IsFP) {
...
bool toolchain::isConstFalseVal(const TargetLowering &TLI, int64_t Val,
...
int64_t toolchain::getICmpTrueVal(const TargetLowering &TLI, bool IsVector,
                             bool IsFP) {
  switch (TLI.getBooleanContents(IsVector, IsFP)) {
  case TargetLowering::UndefinedBooleanContent:
  case TargetLowering::ZeroOrOneBooleanContent:
...
void toolchain::saveUsesAndErase(MachineInstr &MI, MachineRegisterInfo &MRI,
...
void toolchain::eraseInstrs(ArrayRef<MachineInstr *> DeadInstrs,
                       MachineRegisterInfo &MRI,
                       LostDebugLocObserver *LocObserver) {
  SmallInstListTy DeadInstChain;
...
void toolchain::eraseInstr(MachineInstr &MI, MachineRegisterInfo &MRI,
                      LostDebugLocObserver *LocObserver) {
  return eraseInstrs({&MI}, MRI, LocObserver);
}

void toolchain::salvageDebugInfo(const MachineRegisterInfo &MRI, MachineInstr &MI) {
...
bool toolchain::isPreISelGenericFloatingPointOpcode(unsigned Opc) {
  switch (Opc) {
...
bool toolchain::canCreateUndefOrPoison(Register Reg, const MachineRegisterInfo &MRI,
                                  bool ConsiderFlagsAndMetadata) {
...
bool toolchain::isGuaranteedNotToBeUndefOrPoison(Register Reg,
                                            const MachineRegisterInfo &MRI,
                                            unsigned Depth) {
...
bool toolchain::isGuaranteedNotToBePoison(Register Reg,
                                     const MachineRegisterInfo &MRI,
                                     unsigned Depth) {
  return ::isGuaranteedNotToBeUndefOrPoison(Reg, MRI, Depth,
                                            UndefPoisonKind::PoisonOnly);
...
bool toolchain::isGuaranteedNotToBeUndef(Register Reg,
                                    const MachineRegisterInfo &MRI,
                                    unsigned Depth) {
  return ::isGuaranteedNotToBeUndefOrPoison(Reg, MRI, Depth,
...
Type *toolchain::getTypeForLLT(LLT Ty, LLVMContext &C) {
  if (Ty.isVector())
...
bool toolchain::isAssertMI(const MachineInstr &MI) {
  switch (MI.getOpcode()) {
  default:
    return false;
...
APInt toolchain::GIConstant::getScalarValue() const {
...
toolchain::GIConstant::getConstant(Register Const, const MachineRegisterInfo &MRI) {
...
APFloat toolchain::GFConstant::getScalarValue() const {
...
toolchain::GFConstant::getConstant(Register Const, const MachineRegisterInfo &MRI) {
  MachineInstr *Constant = getDefIgnoringCopies(Const, MRI);
