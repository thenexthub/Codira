...
/// LowerIntrinsics - This pass rewrites calls to the toolchain.gcread or
/// toolchain.gcwrite intrinsics, replacing them with simple loads and stores as
...
FunctionPass *toolchain::createGCLoweringPass() { return new LowerIntrinsics(); }

char LowerIntrinsics::ID = 0;
char &toolchain::GCLoweringID = LowerIntrinsics::ID;
...
static bool CouldBecomeSafePoint(Instruction *I) {
  ...
  // toolchain.gcroot is safe because it doesn't do anything at runtime.
...
char &toolchain::GCMachineCodeAnalysisID = GCMachineCodeAnalysis::ID;
