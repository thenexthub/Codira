...
#include "vm/core/Support/GenericIteratedDominanceFrontier.h"
#include "vm/core/Support/TypeSize.h"
#include "vm/core/Support/raw_ostream.h"
#include "vm/core/Target/TargetMachine.h"
#include "vm/core/Transforms/Utils/SSAUpdaterImpl.h"
#include <algorithm>
#include <cassert>
#include <climits>
#include <cstdint>
...
public:
  ...
  void loadVarInloc(MachineBasicBlock &MBB, DbgOpIDMap &DbgOpStore,
    ...
    for (DbgOpID ID : Value.getDbgOpIDs()) {
      ...
      auto ValuesPreferredLoc =
          toolchain::lower_bound(ValueToLoc, Probe, ValueToLocSort);
  ...
  loadInlocs(MachineBasicBlock &MBB, ValueTable &MLocs, DbgOpIDMap &DbgOpStore,
    ...
    toolchain::sort(ValueToLoc, ValueToLocSort);
    ...
    for (auto Location : MTracker->locations()) {
      ...
      auto VIt = toolchain::lower_bound(ValueToLoc, Probe, ValueToLocSort);
  ...
  void transferMlocs(LocIdx Src, LocIdx Dst, MachineBasicBlock::iterator Pos) {
    ...
    for (DebugVariableID VarID : MovingVars) {
      ...
      toolchain::replace(ActiveVLocIt->second.Ops, SrcOp, DstOp);
  ...
  for (size_t Idx = 0; Idx < Properties.getLocationOpCount(); ++Idx) {
    ...
    if (LocID >= NumRegs) {
      ...
      if (Offset == 0) {
        ...
        // https://github.com/toolchain/toolchain-project/issues/64093
...
std::optional<ValueIDNum> InstrRefBasedLDV::getValueForInstrRef(
  ...
  auto LowerBoundIt = toolchain::lower_bound(MF.DebugValueSubstitutions, SoughtSub);
  while (LowerBoundIt != MF.DebugValueSubstitutions.end() &&
    ...
    LowerBoundIt = toolchain::lower_bound(MF.DebugValueSubstitutions, SoughtSub);
  }
  ...
  auto PHIIt = toolchain::lower_bound(DebugPHINumToValue, InstNo);
...
bool InstrRefBasedLDV::mlocJoin(
  ...
  toolchain::sort(BlockOrders, Cmp);
...
void InstrRefBasedLDV::initialSetup(MachineFunction &MF) {
  ...
  toolchain::sort(MF.DebugValueSubstitutions);
...
bool InstrRefBasedLDV::emitTransfers() {
  ...
  for (auto &P : TTracker->Transfers) {
    ...
    // DVMap.
    toolchain::sort(P.Insts, toolchain::less_first());
...
bool InstrRefBasedLDV::ExtendRanges(MachineFunction &MF,
  ...
  toolchain::sort(DebugPHINumToValue);
...
LDVImpl *toolchain::makeInstrRefBasedLiveDebugValues() {
...
std::optional<ValueIDNum> InstrRefBasedLDV::resolveDbgPHIsImpl(
  ...
  toolchain::sort(SortedPHIs, [&](LDVSSAPhi *A, LDVSSAPhi *B) {
