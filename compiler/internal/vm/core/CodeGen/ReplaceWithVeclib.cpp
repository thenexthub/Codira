...
STATISTIC(NumFuncUsedAdded,
          "Number of functions added to `toolchain.compiler.used`");
...
Function *getTLIFunction(Module *M, FunctionType *VectorFTy,
  ...
  if (!TLIFunc) {
    ...
    ++NumTLIFuncDeclAdded;
    // Add the freshly created function to toolchain.compiler.used, similar to as it
...
FunctionPass *toolchain::createReplaceWithVeclibLegacyPass() {
