...
char &toolchain::MachineCopyPropagationID = MachineCopyPropagationLegacy::ID;
...
void MachineCopyPropagation::BackwardCopyPropagateBlock(
  ...
  for (MachineInstr &MI : toolchain::make_early_inc_range(toolchain::reverse(MBB))) {
...
MachineFunctionPass *
toolchain::createMachineCopyPropagationPass(bool UseCopyInstr = false) {
