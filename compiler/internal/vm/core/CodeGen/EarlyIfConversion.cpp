...
bool SSAIfConv::canSpeculateInstrs(MachineBasicBlock *MBB) {
  ...
  for (MachineInstr &MI :
       toolchain::make_range(MBB->begin(), MBB->getFirstTerminator())) {
    if (MI.isDebugInstr())
      continue;
...
char &toolchain::EarlyIfConverterLegacyID = EarlyIfConverterLegacy::ID;
...
char &toolchain::EarlyIfPredicatorID = EarlyIfPredicator::ID;
