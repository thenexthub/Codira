...
#include "vm/core/CodeGen/LatencyPriorityQueue.h"
...
char &toolchain::PostRASchedulerID = PostRASchedulerLegacy::ID;
...
void SchedulePostRATDList::ListScheduleTopDown() {
  ...
  unsigned Noops = toolchain::count(Sequence, nullptr);
