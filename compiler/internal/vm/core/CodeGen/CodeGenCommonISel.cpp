...
toolchain::findSplitPointForStackProtector(MachineBasicBlock *BB,
...
FPClassTest toolchain::invertFPClassTestIfSimpler(FPClassTest Test, bool UseFCmp) {
...
void toolchain::salvageDebugInfoForDbgValue(const MachineRegisterInfo &MRI,
                                       MachineInstr &MI,
