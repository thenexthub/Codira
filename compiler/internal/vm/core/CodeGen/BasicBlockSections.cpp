...
#include "vm/core/CodeGen/BasicBlockMatchingAndInference.h"
...
#include "vm/core/Support/UniqueBBID.h"
...
cl::opt<std::string> toolchain::BBSectionsColdTextPrefix(
...
void toolchain::sortBasicBlocksAndUpdateBranches(
...
void toolchain::avoidZeroOffsetLandingPad(MachineFunction &MF) {
...
bool toolchain::hasInstrProfHashMismatch(MachineFunction &MF) {
...
MachineFunctionPass *toolchain::createBasicBlockSectionsPass() {
