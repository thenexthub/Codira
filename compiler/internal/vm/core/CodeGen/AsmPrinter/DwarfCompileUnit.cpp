//===- toolchain/CodeGen/DwarfCompileUnit.cpp - Dwarf Compile Units ------------===//
//
    ...
    if (Global) {
      ...
      if (Global->isThreadLocal()) {
        if (Asm->TM.getTargetTriple().isWasm()) {
          ...
          // https://github.com/toolchain/toolchain-project/blob/19afbfe33156d211fa959dadeea46cd17b9c723c/lld/wasm/Driver.cpp#L786-L823
...
void DwarfCompileUnit::attachLowHighPC(DIE &D, const MCSymbol *Begin,
  ...
  if (DD->getDwarfVersion() >= 4 &&
      (!isDwoUnit() || !toolchain::isRangeRelaxable(Begin, End))) {
