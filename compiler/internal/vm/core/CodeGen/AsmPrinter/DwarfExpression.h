//===- toolchain/CodeGen/DwarfExpression.h - Dwarf Compile Unit ------*- C++ -*-===//
//
...
protected:
  ...
  virtual bool isFrameRegister(const TargetRegisterInfo &TRI,
                               toolchain::Register MachineReg) = 0;
  ...
  bool addMachineReg(const TargetRegisterInfo &TRI, toolchain::Register MachineReg,
                     unsigned MaxSize = ~1U);
...
public:
  ...
  bool addExpression(
      DIExpressionCursor &&Expr,
      toolchain::function_ref<bool(unsigned, DIExpressionCursor &)> InsertArg);
...
class DebugLocDwarfExpression final : public DwarfExpression {
  ...
  bool isFrameRegister(const TargetRegisterInfo &TRI,
                       toolchain::Register MachineReg) override;
