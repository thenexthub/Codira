...
#include "vm/core/TextAPI/DylibReader.h"
...
#include "vm/core/TextAPI/RecordsSlice.h"
...
using namespace vm::core::MachO::DylibReader;
...
static Error readSymbols(MachOObjectFile *Obj, RecordsSlice &Slice,
  ...
  // in the trie than in n-list due to stripping. This is common for codira
  // mangled symbols.
...
accumulateLocs(MachOObjectFile &Obj,
  ...
  for (const auto &Symbol : Obj.symbols()) {
    ...
    const std::string File = DIE.getDeclFile(
        toolchain::DILineInfoSpecifier::FileLineInfoKind::AbsoluteFilePath);
