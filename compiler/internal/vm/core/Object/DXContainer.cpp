...
Error DirectX::RootSignature::parse() {
  ...
  Version = support::endian::read<uint32_t, toolchain::endianness::little>(Current);
  Current += sizeof(uint32_t);

  NumParameters =
      support::endian::read<uint32_t, toolchain::endianness::little>(Current);
  Current += sizeof(uint32_t);
  ...
  Flags = support::endian::read<uint32_t, toolchain::endianness::little>(Current);
  Current += sizeof(uint32_t);
