...
bool MachOObjectFile::isValidArch(StringRef ArchFlag) {
  ...
  return toolchain::is_contained(validArchs, ArchFlag);
}
...
toolchain::binaryformat::Swift5ReflectionSectionKind
MachOObjectFile::mapReflectionSectionNameToEnumValue(
    StringRef SectionName) const {
#define HANDLE_SWIFT_SECTION(KIND, MACHO, ELF, COFF)                           \
  .Case(MACHO, toolchain::binaryformat::Swift5ReflectionSectionKind::KIND)
  return StringSwitch<toolchain::binaryformat::Swift5ReflectionSectionKind>(
             SectionName)
#include "vm/core/BinaryFormat/Swift.def"
      .Default(toolchain::binaryformat::Swift5ReflectionSectionKind::unknown);
