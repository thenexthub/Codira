...
#include "vm/core/Object/SFrameParser.h"
...
static Error readArray(ArrayRef<uint8_t> Data, uint64_t Count, uint64_t &Offset,
  ...
  Vec.resize(Count);
  toolchain::copy(*RawArray, Vec.begin());
...
template class LLVM_EXPORT_TEMPLATE toolchain::object::SFrameParser<endianness::big>;
template class LLVM_EXPORT_TEMPLATE
    toolchain::object::SFrameParser<endianness::little>;
