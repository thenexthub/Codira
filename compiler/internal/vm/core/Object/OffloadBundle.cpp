...
#include "vm/core/Object/OffloadBundle.h"
...
Error OffloadBundleFatBin::readEntries(StringRef Buffer,
  ...
  BinaryStreamReader Reader(Buffer, toolchain::endianness::little);
...
Error object::extractOffloadBundleFatBinary(
  ...
  for (SectionRef Sec : Obj.sections()) {
    ...
    if ((toolchain::identify_magic(*Buffer) == file_magic::offload_bundle) ||
        (toolchain::identify_magic(*Buffer) ==
         file_magic::offload_bundle_compressed)) {
