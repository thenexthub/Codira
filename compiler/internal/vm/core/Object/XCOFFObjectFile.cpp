...
template struct LLVM_EXPORT_TEMPLATE XCOFFRelocation<toolchain::support::ubig32_t>;
template struct LLVM_EXPORT_TEMPLATE XCOFFRelocation<toolchain::support::ubig64_t>;

template LLVM_EXPORT_TEMPLATE
    toolchain::Expected<toolchain::ArrayRef<toolchain::object::XCOFFRelocation64>>
    toolchain::object::XCOFFObjectFile::relocations<
        toolchain::object::XCOFFSectionHeader64, toolchain::object::XCOFFRelocation64>(
        toolchain::object::XCOFFSectionHeader64 const &) const;
template LLVM_EXPORT_TEMPLATE
    toolchain::Expected<toolchain::ArrayRef<toolchain::object::XCOFFRelocation32>>
    toolchain::object::XCOFFObjectFile::relocations<
        toolchain::object::XCOFFSectionHeader32, toolchain::object::XCOFFRelocation32>(
        toolchain::object::XCOFFSectionHeader32 const &) const;
