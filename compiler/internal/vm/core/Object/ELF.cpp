...
StringRef toolchain::object::getELFRelocationTypeName(uint32_t Machine,
                                                 uint32_t Type) {
  switch (Machine) {
  case ELF::EM_68K:
    switch (Type) {
#include "vm/core/BinaryFormat/ELFRelocs/M68k.def"
    default:
      break;
    }
    break;
  case ELF::EM_X86_64:
    switch (Type) {
#include "vm/core/BinaryFormat/ELFRelocs/x86_64.def"
    default:
      break;
    }
    break;
  ...
  case ELF::EM_IAMCU:
    switch (Type) {
#include "vm/core/BinaryFormat/ELFRelocs/i386.def"
    default:
      break;
    }
    break;
  case ELF::EM_MIPS:
    switch (Type) {
#include "vm/core/BinaryFormat/ELFRelocs/Mips.def"
    default:
      break;
    }
    break;
  case ELF::EM_AARCH64:
    switch (Type) {
#include "vm/core/BinaryFormat/ELFRelocs/AArch64.def"
    default:
      break;
    }
    break;
  case ELF::EM_ARM:
    switch (Type) {
#include "vm/core/BinaryFormat/ELFRelocs/ARM.def"
    default:
      break;
    }
    break;
  ...
  case ELF::EM_ARC_COMPACT2:
    switch (Type) {
#include "vm/core/BinaryFormat/ELFRelocs/ARC.def"
    default:
      break;
    }
    break;
...
#include "vm/core/BinaryFormat/ELFRelocs/AVR.def"
  ...
  case ELF::EM_HEXAGON:
    switch (Type) {
#include "vm/core/BinaryFormat/ELFRelocs/Hexagon.def"
    default:
      break;
    }
    break;
  case ELF::EM_LANAI:
    switch (Type) {
#include "vm/core/BinaryFormat/ELFRelocs/Lanai.def"
    default:
      break;
    }
    break;
  case ELF::EM_PPC:
    switch (Type) {
#include "vm/core/BinaryFormat/ELFRelocs/PowerPC.def"
    default:
      break;
    }
    break;
  case ELF::EM_PPC64:
    switch (Type) {
#include "vm/core/BinaryFormat/ELFRelocs/PowerPC64.def"
    default:
      break;
    }
    break;
  case ELF::EM_RISCV:
    switch (Type) {
#include "vm/core/BinaryFormat/ELFRelocs/RISCV.def"
    default:
      break;
    }
    break;
...
#include "vm/core/BinaryFormat/ELFRelocs/Sparc.def"
  ...
  case ELF::EM_AMDGPU:
    switch (Type) {
#include "vm/core/BinaryFormat/ELFRelocs/AMDGPU.def"
    default:
      break;
    }
    break;
  case ELF::EM_BPF:
    switch (Type) {
#include "vm/core/BinaryFormat/ELFRelocs/BPF.def"
    default:
      break;
    }
    break;
  case ELF::EM_MSP430:
    switch (Type) {
#include "vm/core/BinaryFormat/ELFRelocs/MSP430.def"
    default:
      break;
    }
    break;
  case ELF::EM_VE:
    switch (Type) {
#include "vm/core/BinaryFormat/ELFRelocs/VE.def"
    default:
      break;
    }
    break;
  case ELF::EM_CSKY:
    switch (Type) {
#include "vm/core/BinaryFormat/ELFRelocs/CSKY.def"
    default:
      break;
    }
    break;
  case ELF::EM_LOONGARCH:
    switch (Type) {
#include "vm/core/BinaryFormat/ELFRelocs/LoongArch.def"
    default:
      break;
    }
    break;
  case ELF::EM_XTENSA:
    switch (Type) {
#include "vm/core/BinaryFormat/ELFRelocs/Xtensa.def"
    default:
      break;
    }
    break;
...
StringRef toolchain::object::getRISCVVendorRelocationTypeName(uint32_t Type,
                                                         StringRef Vendor) {
#define ELF_RISCV_NONSTANDARD_RELOC(vendor, name, number)                      \
  if (Vendor == #vendor && Type == number)                                     \
    return #name;

#include "vm/core/BinaryFormat/ELFRelocs/RISCV_nonstandard.def"
...
uint32_t toolchain::object::getELFRelativeRelocationType(uint32_t Machine) {
  switch (Machine) {
  case ELF::EM_X86_64:
...
StringRef toolchain::object::getELFSectionTypeName(uint32_t Machine, unsigned Type) {
  switch (Machine) {
  case ELF::EM_ARM:
    switch (Type) {
...
#include "vm/core/BinaryFormat/DynamicTags.def"
...
ELFFile<ELFT>::toMappedAddr(uint64_t VAddr, WarningHandler WarnHandler) const {
  ...
  toolchain::SmallVector<Elf_Phdr *, 4> LoadSegments;
  ...
  if (!toolchain::is_sorted(LoadSegments, SortPred)) {
    if (Error E =
            WarnHandler("loadable segments are unsorted by virtual address"))
      return std::move(E);
    toolchain::stable_sort(LoadSegments, SortPred);
  }

  const Elf_Phdr *const *I = toolchain::upper_bound(
...
decodeBBAddrMapImpl(const ELFFile<ELFT> &EF,
  ...
  toolchain::DenseMap<uint64_t, uint64_t> FunctionOffsetTranslations;
  ...
  if (Sec.sh_flags & toolchain::ELF::SHF_COMPRESSED) {
  ...
  while (!ULEBSizeErr && !MetadataDecodeErr && Cur &&
    ...
    if (PGOAnalyses || FeatEnable.hasPGOAnalysis()) {
      ...
      for (uint32_t BlockIndex = 0;
        ...
        // Branch probability
        toolchain::SmallVector<PGOAnalysisMap::PGOBBEntry::SuccessorEntry, 2>
            Successors;
...
template class LLVM_EXPORT_TEMPLATE toolchain::object::ELFFile<ELF32LE>;
template class LLVM_EXPORT_TEMPLATE toolchain::object::ELFFile<ELF32BE>;
template class LLVM_EXPORT_TEMPLATE toolchain::object::ELFFile<ELF64LE>;
template class LLVM_EXPORT_TEMPLATE toolchain::object::ELFFile<ELF64BE>;
