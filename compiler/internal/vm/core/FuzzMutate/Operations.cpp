...
#include "vm/core/FuzzMutate/Operations.h"
...
void toolchain::describeFuzzerIntOps(std::vector<fuzzerop::OpDescriptor> &Ops) {
...
void toolchain::describeFuzzerFloatOps(std::vector<fuzzerop::OpDescriptor> &Ops) {
...
void toolchain::describeFuzzerUnaryOperations(
    std::vector<fuzzerop::OpDescriptor> &Ops) {
  Ops.push_back(fnegDescriptor(1));
}

void toolchain::describeFuzzerControlFlowOps(
    std::vector<fuzzerop::OpDescriptor> &Ops) {
  Ops.push_back(splitBlockDescriptor(1));
}

void toolchain::describeFuzzerOtherOps(std::vector<fuzzerop::OpDescriptor> &Ops) {
  Ops.push_back(selectDescriptor(1));
}

void toolchain::describeFuzzerPointerOps(std::vector<fuzzerop::OpDescriptor> &Ops) {
  Ops.push_back(gepDescriptor(1));
}

void toolchain::describeFuzzerAggregateOps(
    std::vector<fuzzerop::OpDescriptor> &Ops) {
  Ops.push_back(extractValueDescriptor(1));
  Ops.push_back(insertValueDescriptor(1));
}

void toolchain::describeFuzzerVectorOps(std::vector<fuzzerop::OpDescriptor> &Ops) {
  Ops.push_back(extractElementDescriptor(1));
  Ops.push_back(insertElementDescriptor(1));
  Ops.push_back(shuffleVectorDescriptor(1));
}

OpDescriptor toolchain::fuzzerop::selectDescriptor(unsigned Weight) {
...
OpDescriptor toolchain::fuzzerop::fnegDescriptor(unsigned Weight) {
  auto buildOp = [](ArrayRef<Value *> Srcs, BasicBlock::iterator InsertPt) {
...
OpDescriptor toolchain::fuzzerop::binOpDescriptor(unsigned Weight,
...
OpDescriptor toolchain::fuzzerop::cmpOpDescriptor(unsigned Weight,
...
OpDescriptor toolchain::fuzzerop::splitBlockDescriptor(unsigned Weight) {
...
OpDescriptor toolchain::fuzzerop::gepDescriptor(unsigned Weight) {
...
OpDescriptor toolchain::fuzzerop::extractValueDescriptor(unsigned Weight) {
...
OpDescriptor toolchain::fuzzerop::insertValueDescriptor(unsigned Weight) {
...
OpDescriptor toolchain::fuzzerop::extractElementDescriptor(unsigned Weight) {
  auto buildExtract = [](ArrayRef<Value *> Srcs,
                         BasicBlock::iterator InsertPt) {
...
OpDescriptor toolchain::fuzzerop::insertElementDescriptor(unsigned Weight) {
  auto buildInsert = [](ArrayRef<Value *> Srcs, BasicBlock::iterator InsertPt) {
...
OpDescriptor toolchain::fuzzerop::shuffleVectorDescriptor(unsigned Weight) {
