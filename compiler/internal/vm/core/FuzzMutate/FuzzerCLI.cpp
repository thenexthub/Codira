...
#include "vm/core/FuzzMutate/FuzzerCLI.h"
...
void toolchain::parseFuzzerCLOpts(int ArgC, char *ArgV[]) {
...
void toolchain::handleExecNameEncodedBEOpts(StringRef ExecName) {
...
void toolchain::handleExecNameEncodedOptimizerOpts(StringRef ExecName) {
...
int toolchain::runFuzzerOnInputs(int ArgC, char *ArgV[], FuzzerTestFun TestOne,
                            FuzzerInitFun Init) {
