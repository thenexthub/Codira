...
#include "vm/core/ExecutionEngine/RuntimeDyldChecker.h"
...
#define RTDYLD_INVALID_SECTION_ID ((RuntimeDyldImpl::SID)(-1))
  ...
  void writeInt16BE(uint8_t *Addr, uint16_t Value) {
    toolchain::support::endian::write<uint16_t>(Addr, Value,
  ...
  void writeInt32BE(uint8_t *Addr, uint32_t Value) {
    toolchain::support::endian::write<uint32_t>(Addr, Value,
                                           IsTargetLittleEndian
                                               ? toolchain::endianness::little
                                               : toolchain::endianness::big);
  }
  ...
  void writeInt64BE(uint8_t *Addr, uint64_t Value) {
    toolchain::support::endian::write<uint64_t>(Addr, Value,
                                           IsTargetLittleEndian
                                               ? toolchain::endianness::little
                                               : toolchain::endianness::big);
  }
