...
#include "vm/core/ExecutionEngine/JITLink/JITLinkDylib.h"
...
#include "vm/core/ExecutionEngine/Orc/Shared/MemoryFlags.h"
...
public:
  ...
  using GetLoadAddressFn = toolchain::unique_function<ExecutorAddr(StringRef)>;
