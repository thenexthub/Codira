...
#include "vm/core/ExecutionEngine/Orc/TargetProcess/ExecutorSharedMemoryMapperService.h"
#include "vm/core/Config/toolchain-config.h" // for LLVM_ON_UNIX
...

  {
    ...
    for (auto Base : toolchain::reverse(Bases)) {
      ...
      for (auto &Reservation : Reservations) {
        auto AllocationIt = toolchain::find(Reservation.second.Allocations, Base);
