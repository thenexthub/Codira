...
#include "vm/core/ExecutionEngine/Orc/TargetProcess/JITLoaderVTune.h"
#include "vm/core/ExecutionEngine/Orc/Shared/VTuneSharedStructs.h"
...
// For Testing: following code comes from toolchain-jitlistener.cpp in toolchain tools
namespace {
...
static Error unsupportedBatch(const VTuneMethodBatch &MB) {
  return toolchain::make_error<StringError>("unsupported for Intel VTune",
