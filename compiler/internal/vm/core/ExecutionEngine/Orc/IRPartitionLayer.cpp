...
#include "vm/core/ExecutionEngine/Orc/IRPartitionLayer.h"
#include "vm/core/ExecutionEngine/Orc/ExecutionUtils.h"
#include "vm/core/ExecutionEngine/Orc/IndirectionUtils.h"
...
void IRPartitionLayer::emitPartition(
  ...
  auto ExtractedTSM = TSM.withModuleDo([&](Module &M)
    ...
    std::string SubModuleName;
    {
      ...
      toolchain::append_range(HashGVs, *GVsToExtract);
      toolchain::sort(HashGVs, [](const GlobalValue *LHS, const GlobalValue *RHS) {
