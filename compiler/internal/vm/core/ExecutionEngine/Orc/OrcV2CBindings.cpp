...
#include "vm/core-c/LLJIT.h"
#include "vm/core-c/Orc.h"
#include "vm/core-c/OrcEE.h"
#include "vm/core-c/TargetMachine.h"

#include "vm/core/ExecutionEngine/JITLink/JITLinkMemoryManager.h"
...
class OrcCAPIMaterializationUnit : public toolchain::orc::MaterializationUnit {
public:
  OrcCAPIMaterializationUnit(
      ...
      : toolchain::orc::MaterializationUnit(
...
public:
  ...
  Error tryToGenerate(LookupState &LS, LookupKind K, JITDylib &JD,
    ...
    LLVMOrcJITDylibLookupFlags CODEDLookupFlags =
...
void LLVMOrcExecutionSessionLookup(
    ...
    LLVMOrcCODEITDylibSearchOrder SearchOrder, size_t SearchOrderSize,
...
LLVMOrcObjectLayerRef
LLVMOrcCreateRTDyldObjectLinkingLayerWithMCODEITMemoryManagerLikeCallbacks(
  ...
  struct MCODEITMemoryManagerLikeCallbacks {
    MCODEITMemoryManagerLikeCallbacks() = default;
    MCODEITMemoryManagerLikeCallbacks(
    ...
    MCODEITMemoryManagerLikeCallbacks(MCODEITMemoryManagerLikeCallbacks &&Other) {
  ...
  class MCODEITMemoryManagerLikeCallbacksMemMgr : public RTDyldMemoryManager {
  public:
    MCODEITMemoryManagerLikeCallbacksMemMgr(
        const MCODEITMemoryManagerLikeCallbacks &CBs)
        : CBs(CBs) {
      Opaque = CBs.CreateContext(CBs.CreateContextCtx);
    }
    ~MCODEITMemoryManagerLikeCallbacksMemMgr() override { CBs.Destroy(Opaque); }
  ...
  MCODEITMemoryManagerLikeCallbacks CBs(
  ...
  return wrap(new RTDyldObjectLinkingLayer(
      *unwrap(ES), [CBs = std::move(CBs)](const MemoryBuffer &) {
        return std::make_unique<MCODEITMemoryManagerLikeCallbacksMemMgr>(CBs);
      }));
