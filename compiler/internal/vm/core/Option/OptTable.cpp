...
#include "vm/core/Option/OptSpecifier.h"
#include "vm/core/Option/Option.h"
#include "vm/core/Support/CommandLine.h" // for expandResponseFiles
...
void OptTable::internalPrintHelp(
  ...
  auto ActiveSubCommand = toolchain::find_if(
  ...
  auto DoesOptionBelongToSubcommand = [&](const Info &CandidateInfo) {
    ...
    // Option.
    return toolchain::is_contained(SubCommandIDs, ActiveSubCommandID);
  };
