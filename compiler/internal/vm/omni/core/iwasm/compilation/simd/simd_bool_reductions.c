              ...
              enum integer_all_true itype)
{
    ...
    const char *intrinsic[] = {
        "toolchain.vector.reduce.and.v16i1",
        "toolchain.vector.reduce.and.v8i1",
        "toolchain.vector.reduce.and.v4i1",
        "toolchain.vector.reduce.and.v2i1",
    };
    LLVMValueRef zero[] = {
                               ...
                               AOTFuncContext *func_ctx)
{
    ...
    if (!(result = aot_call_llvm_intrinsic(
              comp_ctx, func_ctx, "toolchain.vector.reduce.or.v128i1", INT1_TYPE,
