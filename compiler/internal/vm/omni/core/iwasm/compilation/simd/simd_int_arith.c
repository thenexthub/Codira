                              ...
                              AOTFuncContext *func_ctx)
{
    ...
    if (!(result = aot_call_llvm_intrinsic(comp_ctx, func_ctx,
                                           "toolchain.ctpop.v16i8", V128_i8x16_TYPE,
...
{
    return simd_v128_abs(comp_ctx, func_ctx, "toolchain.abs.v16i8", V128_i8x16_TYPE);
}

bool
aot_compile_simd_i16x8_abs(AOTCompContext *comp_ctx, AOTFuncContext *func_ctx)
{
    return simd_v128_abs(comp_ctx, func_ctx, "toolchain.abs.v8i16", V128_i16x8_TYPE);
}

bool
aot_compile_simd_i32x4_abs(AOTCompContext *comp_ctx, AOTFuncContext *func_ctx)
{
    return simd_v128_abs(comp_ctx, func_ctx, "toolchain.abs.v4i32", V128_i32x4_TYPE);
}

bool
aot_compile_simd_i64x2_abs(AOTCompContext *comp_ctx, AOTFuncContext *func_ctx)
{
    return simd_v128_abs(comp_ctx, func_ctx, "toolchain.abs.v2i64", V128_i64x2_TYPE);
}
