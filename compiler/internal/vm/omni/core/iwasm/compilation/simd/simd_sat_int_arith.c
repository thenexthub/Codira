...
{
    char *intrinsics[][2] = {
        { "toolchain.sadd.sat.v16i8", "toolchain.uadd.sat.v16i8" },
        { "toolchain.ssub.sat.v16i8", "toolchain.usub.sat.v16i8" },
    };
...
{
    char *intrinsics[][2] = {
        { "toolchain.sadd.sat.v8i16", "toolchain.uadd.sat.v8i16" },
        { "toolchain.ssub.sat.v8i16", "toolchain.usub.sat.v8i16" },
    };
