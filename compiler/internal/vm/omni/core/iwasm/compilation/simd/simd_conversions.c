              ...
              LLVMValueRef min, LLVMValueRef max, bool is_signed)
{
    ...
    const char *smin_intrinsic[] = {
        "toolchain.smin.v8i16",
        "toolchain.smin.v4i32",
        "toolchain.smin.v2i64",
        "toolchain.smin.v8i32",
    };

    const char *umin_intrinsic[] = {
        "toolchain.umin.v8i16",
        "toolchain.umin.v4i32",
        "toolchain.umin.v2i64",
        "toolchain.umin.v8i32",
    };

    const char *smax_intrinsic[] = {
        "toolchain.smax.v8i16",
        "toolchain.smax.v4i32",
        "toolchain.smax.v2i64",
        "toolchain.smax.v8i32",
    };

    const char *umax_intrinsic[] = {
        "toolchain.umax.v8i16",
        "toolchain.umax.v4i32",
        "toolchain.umax.v2i64",
        "toolchain.umax.v8i32",
    };
                                    ...
                                    AOTFuncContext *func_ctx, bool is_signed)
{
    if (is_target_x86(comp_ctx)) {
        return simd_integer_narrow_x86(
            ...
            is_signed ? "toolchain.x86.sse2.packsswb.128"
                      : "toolchain.x86.sse2.packuswb.128");
    }
    else {
                                    ...
                                    AOTFuncContext *func_ctx, bool is_signed)
{
    if (is_target_x86(comp_ctx)) {
        return simd_integer_narrow_x86(comp_ctx, func_ctx, V128_i32x4_TYPE,
                                       V128_i16x8_TYPE,
                                       is_signed ? "toolchain.x86.sse2.packssdw.128"
                                                 : "toolchain.x86.sse41.packusdw");
    }
    else {
                                       ...
                                       AOTFuncContext *func_ctx, bool is_signed)
{
    ...
    if (!(result = simd_trunc_sat(comp_ctx, func_ctx,
                                  is_signed ? "toolchain.fptosi.sat.v4i32.v4f32"
                                            : "toolchain.fptoui.sat.v4i32.v4f32",
                                       ...
                                       AOTFuncContext *func_ctx, bool is_signed)
{
    ...
    if (!(result = simd_trunc_sat(comp_ctx, func_ctx,
                                  is_signed ? "toolchain.fptosi.sat.v2i32.v2f64"
                                            : "toolchain.fptoui.sat.v2i32.v2f64",
