...
check_exception_thrown(AOTCompContext *comp_ctx, AOTFuncContext *func_ctx)
{
    ...
    if (!(value = LLVMBuildLoad2(comp_ctx->builder, INT8_TYPE,
        ...
        || !(cmp = LLVMBuildICmp(comp_ctx->builder, LLVMIntEQ, value, I8_ZERO,
                                 "cmp"))) {
        aot_set_last_error("toolchain build icmp failed.");
        return false;
    }
                            ...
                            LLVMValueRef *p_res)
{
    ...
    if (!(func_type =
        ...
        aot_set_last_error("toolchain add function type failed.");
        return false;
    }
    ...
    for (i = 0; i < param_count; i++) {
        if (!(elem_idx = I32_CONST(cell_num))
            ...
            aot_set_last_error("toolchain add const or pointer type failed.");
            return false;
        }
        ...
        if (!(elem_ptr =
            ...
            || !(elem_ptr = LLVMBuildBitCast(comp_ctx->builder, elem_ptr,
                                             elem_ptr_type, buf))) {
            aot_set_last_error("toolchain build bit cast failed.");
            return false;
        }

        if (!(res = LLVMBuildStore(comp_ctx->builder, param_values[i],
                                   elem_ptr))) {
            aot_set_last_error("toolchain build store failed.");
            return false;
        }
    ...
    if (!func_param_values[2]) {
        aot_set_last_error("toolchain create const failed.");
        return false;
    }
    ...
    if (!(res = LLVMBuildCall2(comp_ctx->builder, func_type, func,
        ...
        aot_set_last_error("toolchain build call failed.");
        return false;
    }
    ...
    if (wasm_ret_type != VALUE_TYPE_VOID) {
        if (!(ret_ptr_type = LLVMPointerType(ret_type, 0))) {
            aot_set_last_error("toolchain add pointer type failed.");
            return false;
        }
        ...
        if (!(*p_value_ret = LLVMBuildLoad2(comp_ctx->builder, ret_type,
                                            value_ret, "value_ret"))) {
            aot_set_last_error("toolchain build load failed.");
            return false;
        }
    }
                             ...
                             LLVMValueRef *params)
{
    ...
    if (!int8_ptr_type) {
        aot_set_last_error("create toolchain pointer type failed");
        return false;
    }
                         ...
                         uint32 func_idx)
{
    ...
    if (!comp_ctx->enable_gc) {
        ...
        if (!(wasm_stack_top =
            ...
            aot_set_last_error("toolchain build in bounds gep failed");
            return false;
        }
    ...
    if (comp_ctx->enable_gc) {
        ...
        if (func_idx < import_func_count) {
            ...
            if (!(frame_sp_ptr = LLVMBuildInBoundsGEP2(
                ...
                aot_set_last_error("toolchain get frame_sp_ptr failed");
                return false;
            }
        ...
        if (!comp_ctx->is_jit_mode) {
            ...
            if (!(frame_ref_ptr = LLVMBuildInBoundsGEP2(
                ...
                aot_set_last_error("toolchain get frame_ref_ptr failed");
                return false;
            }
    ...
    if (!(prev_frame_ptr = LLVMBuildBitCast(comp_ctx->builder, new_frame,
        ...
        aot_set_last_error("toolchain build bitcast failed");
        return false;
    }
    ...
    if (!comp_ctx->is_jit_mode) {
        if (comp_ctx->call_stack_features.func_idx) {
            ...
            if (!(func_idx_ptr = LLVMBuildInBoundsGEP2(
                ...
                aot_set_last_error("toolchain get func_idx_ptr failed");
                return false;
            }
        ...
        if (!(functions = LLVMBuildInBoundsGEP2(comp_ctx->builder, INT8_TYPE,
                                                ...
                                                "functions_addr"))) {
            aot_set_last_error("toolchain build inbounds gep failed");
            return false;
        }
        ...
        if (!(func_inst_ptr =
            ...
            aot_set_last_error("toolchain get func_inst_ptr failed");
            return false;
        }
    ...
    if (ext_ret_count > 0) {
        ...
        for (i = 0; i < ext_ret_count; i++) {
            ...
            if (!(ext_ret_ptr = LLVMBuildInBoundsGEP2(
                      ...
                      &ext_ret_idx, 1, buf))) {
                aot_set_last_error("toolchain build GEP failed.");
                goto fail;
            }
    ...
    if (func_idx < import_func_count) {
            ...
            if (signature) {
                ...
                if (signature[i + 1] == '*') {
                    ...
                    if (!(native_addr_size = LLVMBuildZExtOrBitCast(
                        ...
                        aot_set_last_error("toolchain build zextOrBitCast failed.");
                        goto fail;
                    }
        ...
        if (!signature) {
            ...
            if (!(func = LLVMBuildBitCast(comp_ctx->builder, func_ptr,
                ...
                aot_set_last_error("toolchain bit cast failed.");
                goto fail;
            }
            ...
            if (func_ctxes[func_idx - import_func_count] == func_ctx) {
                ...
                if (!comp_ctx->is_jit_mode) {
                    ...
                    if (!(func_idx_const = I32_CONST(func_idx))) {
                        aot_set_last_error("toolchain build const failed.");
                        goto fail;
                    }
    ...
    for (i = 0; i < result_count; i++) {
        ...
        if (!(ret_ptr =
            ...
            || !(ret_ptr = LLVMBuildBitCast(comp_ctx->builder, ret_ptr,
                                            ret_ptr_type, buf))) {
            aot_set_last_error("toolchain build GEP or bit cast failed.");
            return false;
        }
                             ...
                             uint32 type_idx, uint32 tbl_idx)
{
    ...
    if (IS_TABLE64(tbl_idx)) {
        ...
        if (!(elem_idx = LLVMBuildTrunc(comp_ctx->builder, elem_idx, I32_TYPE,
                                        "elem_idx_i32"))) {
            aot_set_last_error("toolchain build trunc failed.");
            goto fail;
        }
    }
#endif
    ...
    if (IS_TABLE64(tbl_idx)) {
        if (!(cmp_elem_idx =
            ...
            aot_set_last_error("toolchain build or failed.");
            goto fail;
        }
    }
#endif
    ...
    if (!(table_elem_base = LLVMBuildInBoundsGEP2(comp_ctx->builder, INT8_TYPE,
        ...
        aot_set_last_error("toolchain build add failed.");
        goto fail;
    }
    ...
    if (comp_ctx->enable_gc) {
        ...
        if (!(cmp_func_obj = LLVMBuildIsNull(comp_ctx->builder, table_elem,
                                             "cmp_func_obj"))) {
            aot_set_last_error("toolchain build isnull failed.");
            goto fail;
        }
        ...
        if (!(func_idx = LLVMBuildIntCast2(comp_ctx->builder, func_idx,
            ...
            aot_set_last_error("toolchain build int cast failed.");
            goto fail;
        }
    ...
    for (i = 1; i < func_result_count; i++, j++) {
        ...
        if (!(param_types[j] = LLVMPointerType(param_types[j], 0))) {
            aot_set_last_error("toolchain get pointer type failed.");
            goto fail;
        }
    }
