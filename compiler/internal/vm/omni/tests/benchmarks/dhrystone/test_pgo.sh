...
${WAMRC} --enable-toolchain-pgo -o dhrystone_pgo.aot dhrystone.wasm
...
rm -f dhrystone.profdata && toolchain-profdata merge -output=dhrystone.profdata dhrystone.profraw
...
# toolchain-profdata show --all-functions --detailed-summary --binary-ids --counts \
