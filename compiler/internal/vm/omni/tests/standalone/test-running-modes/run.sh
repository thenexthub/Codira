...
${IWASM_CMD} --heap-size=16384 --toolchain-jit wasm-apps/mytest.wasm
${IWASM_CMD} --heap-size=16384 --toolchain-jit --toolchain-jit-size-level=1 wasm-apps/mytest.wasm
${IWASM_CMD} --heap-size=16384 --toolchain-jit --toolchain-jit-size-level=2 --toolchain-jit-opt-level=1 wasm-apps/mytest.wasm
...
cd c-embed/build
./c_embed_test --default-running-mode=toolchain-jit --module-running-mode=multi-tier-jit
