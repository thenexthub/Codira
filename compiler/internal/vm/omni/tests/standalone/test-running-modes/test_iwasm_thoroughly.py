...
def main():
    ...
    IWASM_CLI_ARGS: list[str] = [
        ...
        "--heap-size=16384 --toolchain-jit",
        "--heap-size=16384 --multi-tier-jit",
        "--heap-size=16384 --toolchain-jit --toolchain-jit-size-level=1",
        "--heap-size=16384 --toolchain-jit --toolchain-jit-size-level=2 --toolchain-jit-opt-level=1"
    ]
