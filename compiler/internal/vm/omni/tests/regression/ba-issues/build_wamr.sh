...
# build toolchain-jit iwasm for testing toolchain-jit
build_iwasm "-DWAMR_BUILD_REF_TYPES=1 -DWAMR_BUILD_JIT=1" "toolchain-jit"
...
# build toolchain-jit iwasm for testing toolchain-jit with libc-wasi disabled
build_iwasm "-DWAMR_BUILD_REF_TYPES=1 -DWAMR_BUILD_JIT=1 -DWAMR_BUILD_LIBC_WASI=0" "toolchain-jit-wasi-disabled"
