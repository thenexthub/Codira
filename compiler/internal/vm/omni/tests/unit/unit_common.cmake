...
# config_common.cmake only sets up the toolchain environment when
# JIT is enabled. but in unit tests, we need toolchain environment
# for aot compilation.
if (NOT DEFINED LLVM_DIR)
  set (LLVM_SRC_ROOT "${WAMR_ROOT_DIR}/core/deps/toolchain")
  ...
  set (LLVM_DIR ${LLVM_BUILD_ROOT}/lib/cmake/toolchain)
endif ()
