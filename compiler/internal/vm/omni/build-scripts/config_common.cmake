...
if (WAMR_BUILD_JIT EQUAL 1)
  ...
  if (CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    ...
    # Enable exporting symbols after toolchain-17, or LLVM JIT may run failed
...
if (WAMR_BUILD_LINUX_PERF EQUAL 1)
  if (NOT WAMR_BUILD_JIT AND NOT WAMR_BUILD_AOT)
    message(WARNING "only support perf in aot and toolchain-jit")
...
if (WAMR_BUILD_AOT EQUAL 1)
  ...
  # Disable aot intrinsics for interp, fast-jit and toolchain-jit
  add_definitions (-DWASM_ENABLE_AOT_INTRINSICS=0)
endif ()
