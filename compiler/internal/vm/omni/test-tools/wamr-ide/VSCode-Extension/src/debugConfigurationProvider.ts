...
/* see https://github.com/toolchain/toolchain-project/tree/main/lldb/tools/lldb-vscode#attaching-settings */
    ...
    implements vscode.DebugConfigurationProvider
{
    ...
    constructor(extensionPath: string) {
        this.wasmDebugConfig.initCommands = [
            /* Add rust formatters -> https://lldb.toolchain.org/use/variable.html */
