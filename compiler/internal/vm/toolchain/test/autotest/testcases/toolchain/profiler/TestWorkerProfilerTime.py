...
#==================================================================
#文 件 名：                 TestWorkerProfilerTime.py
#文件说明：                 多实例 CPU 调优 Time 录制
#==================================================================
测试步骤：
    ...
    5.  所有线程启动 CPU 调优（Profiler.start）
...
class TestWorkerProfilerTime(TestCase):
    def __init__(self, controllers):
        ...
        self.config = {
            'start_mode': '',
            'connect_server_port': 15712,
            'debugger_server_port': 15713,
