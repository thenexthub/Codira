...
#==================================================================
#文 件 名：                 TestMainExceptionBreakpoints03.py
#文件说明：                 主线程 debug 调试异常断点 NONE 模式
#==================================================================
测试步骤：
...
class TestMainExceptionBreakpoints03(TestCase):
    def __init__(self, controllers):
        ...
        self.config = {
            'start_mode': '-D',
            'connect_server_port': 15616,
            'debugger_server_port': 15617,
