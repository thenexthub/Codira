...
#==================================================================
#文 件 名：                 TestWorkerProfilerHeapSampling.py
#文件说明：                 多实例内存调优 HeapSampling 录制
#==================================================================
测试步骤：
    1.  拉起应用，attach 主线程
...
class TestWorkerProfilerHeapSampling(TestCase):
    def __init__(self, controllers):
        ...
        self.config = {
            'start_mode': '',
            'connect_server_port': 15708,
            'debugger_server_port': 15709,
    ...
    async def test(self, websocket):
        ...
        assert response['result']['profile'] is not None, f'Profile in result can not be None'
        ################################################################################################################
