...
#==================================================================
#文 件 名：                 TestWorkerExceptionBreakpoints02.py
#文件说明：                 多实例 debug 调试异常断点 CAUGHT 和 UNCAUGHT 模式
#==================================================================
测试步骤：
...
class TestWorkerExceptionBreakpoints02(TestCase):
    def __init__(self, controllers):
        ...
        self.config = {
            'start_mode': '-D',
            'connect_server_port': 15642,
            'debugger_server_port': 15643,
