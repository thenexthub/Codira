...
#include "baseptsbreakpointgetname_fuzzer.h"
...
namespace OHOS {
    void BasePtsBreakpointGetNameFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::BasePtsBreakpointGetNameFuzzTest(data, size);
    return 0;
}