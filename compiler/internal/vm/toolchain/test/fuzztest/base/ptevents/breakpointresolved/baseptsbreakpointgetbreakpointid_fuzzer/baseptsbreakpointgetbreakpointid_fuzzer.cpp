...
#include "baseptsbreakpointgetbreakpointid_fuzzer.h"
...
namespace OHOS {
    void BasePtsBreakpointGetBreakpointIdFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::BasePtsBreakpointGetBreakpointIdFuzzTest(data, size);
    return 0;
}