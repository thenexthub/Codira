...
#include "baseptsbreakpointgetlocation_fuzzer.h"
...
namespace OHOS {
    void BasePtsBreakpointGetLocationFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::BasePtsBreakpointGetLocationFuzzTest(data, size);
    return 0;
}