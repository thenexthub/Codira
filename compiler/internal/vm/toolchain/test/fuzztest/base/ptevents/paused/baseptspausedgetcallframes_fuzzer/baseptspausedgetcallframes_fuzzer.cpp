...
#include "baseptspausedgetcallframes_fuzzer.h"
...
namespace OHOS {
    void BasePtsPausedGetCallFramesFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::BasePtsPausedGetCallFramesFuzzTest(data, size);
    return 0;
}