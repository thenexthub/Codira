...
#include "baseptspausedgetreason_fuzzer.h"
...
namespace OHOS {
    void BasePtsPausedGetReasonFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::BasePtsPausedGetReasonFuzzTest(data, size);
    return 0;
}