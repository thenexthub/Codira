...
#include "baseptspausedsetcallframes_fuzzer.h"
...
namespace OHOS {
    void BasePtsPausedSetCallFramesFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::BasePtsPausedSetCallFramesFuzzTest(data, size);
    return 0;
}