...
#include "baseptspausedgethitbreakpoints_fuzzer.h"
...
namespace OHOS {
    void BasePtsPausedGetHitBreakpointsFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::BasePtsPausedGetHitBreakpointsFuzzTest(data, size);
    return 0;
}