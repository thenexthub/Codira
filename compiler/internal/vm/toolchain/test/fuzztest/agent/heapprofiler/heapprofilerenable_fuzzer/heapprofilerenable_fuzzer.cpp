...
#include "heapprofilerenable_fuzzer.h"
...
namespace OHOS {
    void HeapprofilerEnableFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::HeapprofilerEnableFuzzTest(data, size);
    return 0;
}