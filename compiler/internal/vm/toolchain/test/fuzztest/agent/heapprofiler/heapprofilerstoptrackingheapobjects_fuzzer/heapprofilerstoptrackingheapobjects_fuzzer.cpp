...
#include "heapprofilerstoptrackingheapobjects_fuzzer.h"
...
namespace OHOS {
    void HeapprofilerStopTrackingHeapObjectsFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::HeapprofilerStopTrackingHeapObjectsFuzzTest(data, size);
    return 0;
}