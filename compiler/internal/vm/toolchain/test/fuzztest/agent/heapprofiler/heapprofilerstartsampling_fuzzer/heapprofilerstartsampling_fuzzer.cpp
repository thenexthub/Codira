...
#include "heapprofilerstartsampling_fuzzer.h"
...
namespace OHOS {
    void HeapprofilerStartSamplingFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::HeapprofilerStartSamplingFuzzTest(data, size);
    return 0;
}