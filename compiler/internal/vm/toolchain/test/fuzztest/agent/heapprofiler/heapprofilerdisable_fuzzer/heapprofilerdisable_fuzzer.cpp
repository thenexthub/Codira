...
#include "heapprofilerdisable_fuzzer.h"
...
namespace OHOS {
    void HeapprofilerDisableFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::HeapprofilerDisableFuzzTest(data, size);
    return 0;
}