...
namespace OHOS {
    void HeapprofilerGetheapObjectIdFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        dispatcherImpl->GetHeapObjectId(*req);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::HeapprofilerGetheapObjectIdFuzzTest(data, size);
    return 0;
}