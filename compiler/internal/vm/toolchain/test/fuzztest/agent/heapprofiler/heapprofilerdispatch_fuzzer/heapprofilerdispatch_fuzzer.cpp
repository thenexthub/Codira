...
#include "heapprofilerdispatch_fuzzer.h"
...
namespace OHOS {
    void HeapprofilerDispatchFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::HeapprofilerDispatchFuzzTest(data, size);
    return 0;
}