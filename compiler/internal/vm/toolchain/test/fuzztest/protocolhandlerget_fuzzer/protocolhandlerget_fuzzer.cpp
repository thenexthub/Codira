...
#include "protocolhandlerget_fuzzer.h"
...
namespace OHOS {
    void ProtocolHandlerGetFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ProtocolHandlerGetFuzzTest(data, size);
    return 0;
}
