...
#ifndef ECMASCRIPT_TOOLING_TEST_TESTCASES_JS_STEPOUT_ASYNC_TEST_H
#define ECMASCRIPT_TOOLING_TEST_TESTCASES_JS_STEPOUT_ASYNC_TEST_H

#include "tooling/dynamic/test/client_utils/test_util.h"

namespace panda::ecmascript::tooling::test {
class JsStepoutAsyncTest : public TestActions {
public:
    JsStepoutAsyncTest()
    {
        testAction = {
            ...
            {SocketAction::SEND, "b " DEBUGGER_JS_DIR "async_func.js 17"},
            {SocketAction::RECV, "", ActionRule::CUSTOM_RULE, MatchRule::replySuccess},
            ...
            {SocketAction::RECV, "", ActionRule::CUSTOM_RULE, MatchRule::replySuccess},
            {SocketAction::RECV, "Debugger.paused", ActionRule::CUSTOM_RULE,
                [this](auto recv, auto, auto) -> bool { return RecvStepoutInfo(recv, "func_main_0", 24); }},
...
std::unique_ptr<TestActions> GetJsStepoutAsyncTest()
{
    return std::make_unique<JsStepoutAsyncTest>();
}
}  // namespace panda::ecmascript::tooling::test

#endif // ECMASCRIPT_TOOLING_TEST_TESTCASES_JS_STEPOUT_ASYNC_TEST_H
