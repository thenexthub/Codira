...
#ifndef ECMASCRIPT_TOOLING_TEST_TESTCASES_JS_STEPOUT_BEFORE_FUNCTION_TEST_H
#define ECMASCRIPT_TOOLING_TEST_TESTCASES_JS_STEPOUT_BEFORE_FUNCTION_TEST_H

#include "tooling/dynamic/test/client_utils/test_util.h"

namespace panda::ecmascript::tooling::test {
class JsStepoutBeforeFunctionTest : public TestActions {
public:
    JsStepoutBeforeFunctionTest()
    {
        testAction = {
            ...
            {SocketAction::SEND, "b " DEBUGGER_JS_DIR "common_func.js 22"},
            {SocketAction::RECV, "", ActionRule::CUSTOM_RULE, MatchRule::replySuccess},
            ...
            {SocketAction::RECV, "", ActionRule::CUSTOM_RULE, MatchRule::replySuccess},
            {SocketAction::RECV, "Debugger.paused", ActionRule::CUSTOM_RULE,
                [this](auto recv, auto, auto) -> bool { return RecvStepoutInfo(recv, 22); }},

            {SocketAction::SEND, "so"},
            {SocketAction::RECV, "Debugger.resumed", ActionRule::STRING_CONTAIN},
            {SocketAction::RECV, "", ActionRule::CUSTOM_RULE, MatchRule::replySuccess},
            {SocketAction::RECV, "Debugger.paused", ActionRule::CUSTOM_RULE,
                [this](auto recv, auto, auto) -> bool { return RecvStepoutInfo(recv, 23); }},
    ...
    bool RecvStepoutInfo(std::string recv, int lineNumber)
    {
        std::unique_ptr<PtJson> json = PtJson::Parse(recv);
        Result ret;
        std::string method = "";
        ...
        if (ret != Result::SUCCESS || functionName != "func_main_0") {
            return false;
        }
    ...
    ~JsStepoutBeforeFunctionTest() = default;
...
std::unique_ptr<TestActions> GetJsStepoutBeforeFunctionTest()
{
    return std::make_unique<JsStepoutBeforeFunctionTest>();
}
} // namespace panda::ecmascript::tooling::test

#endif // ECMASCRIPT_TOOLING_TEST_TESTCASES_JS_STEPOUT_BEFORE_FUNCTION_TEST_H
