...
#ifndef ECMASCRIPT_TOOLING_TEST_TESTCASES_JS_HEAPDUMP_LOOP_TEST_H
...
class JsHeapdumpLoopTest : public TestActions {
public:
    JsHeapdumpLoopTest()
    {
        testAction = {
...
std::unique_ptr<TestActions> GetJsHeapdumpLoopTest()
{
    return std::make_unique<JsHeapdumpLoopTest>();
}
}  // namespace panda::ecmascript::tooling::test

#endif // ECMASCRIPT_TOOLING_TEST_TESTCASES_JS_HEAPDUMP_LOOP_TEST_H
