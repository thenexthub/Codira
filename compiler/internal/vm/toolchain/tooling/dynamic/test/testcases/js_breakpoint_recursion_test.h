...
#ifndef ECMASCRIPT_TOOLING_TEST_TESTCASES_JS_BREAKPOINT_RECURSION_TEST_H
...
class JsBreakpointRecursionTest : public TestActions {
public:
    JsBreakpointRecursionTest()
    {
        testAction = {
            ...
            {SocketAction::RECV, "Debugger.paused", ActionRule::CUSTOM_RULE,
                [this](auto recv, auto, auto) -> bool { return RecvBreakInfo(recv, "factorial", 60); }},
            {SocketAction::SEND, "resume"},
            {SocketAction::RECV, "Debugger.resumed", ActionRule::STRING_CONTAIN},
            {SocketAction::RECV, "", ActionRule::CUSTOM_RULE, MatchRule::replySuccess},
            {SocketAction::RECV, "Debugger.paused", ActionRule::CUSTOM_RULE,
    ...
    ~JsBreakpointRecursionTest() = default;
...
std::unique_ptr<TestActions> GetJsBreakpointRecursionTest()
{
    return std::make_unique<JsBreakpointRecursionTest>();
}
} // namespace panda::ecmascript::tooling::test

#endif // ECMASCRIPT_TOOLING_TEST_TESTCASES_JS_BREAKPOINT_RECURSION_TEST_H
