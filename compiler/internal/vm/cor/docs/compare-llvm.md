...
[LLVM](https://toolchain.org) is a collection of compiler components implemented as
a set of C++ libraries. It can be used to build both JIT compilers and static
compilers like [Clang](https://clang.toolchain.org), and it is deservedly very
popular.
[Chris Lattner's chapter about LLVM](https://www.aosabook.org/en/toolchain.html)
in the 
...
[LLVM IR](https://toolchain.org/docs/LangRef.html):
...
[SelectionDAG](https://toolchain.org/docs/CodeGenerator.html#instruction-selection-section):
...
[MachineInstr](https://toolchain.org/docs/CodeGenerator.html#machine-code-representation):
...
[MC](https://toolchain.org/docs/CodeGenerator.html#the-mc-layer)
...
However, LLVM uses
[phi instructions](https://toolchain.org/docs/LangRef.html#phi-instruction) in its
