...
impl Inst {
    ...
    fn try_emit_compressed(
        ...
        match *self {
            ...
            Inst::Jal { label } => {
                sink.use_label_at_offset(*start_off, label, LabelUse::RVCODEump);
                sink.add_uncond_branch(*start_off, *start_off + 2, label);
                sink.put2(encode_code_type(CodeOp::CODE, Imm12::ZERO));
            }
            ...
            {
                sink.put2(encode_cr2_type(CrOp::CODEr, base));
            ...
            {
                sink.put2(encode_cr2_type(CrOp::CODEalr, base));
                state.clobber_vstate();
            }
