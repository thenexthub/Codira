...
use crate::isa::riscv64::lower::isle::generated_code::{CodeOp, MInst, VecAluOpRRImm5, VecAluOpRRR};
...
impl MachInstLabelUse for LabelUse {
    ...
    fn supports_veneer(self) -> bool {
        match self {
            Self::Jal20 | Self::B12 | Self::RVCODEump => true,
            _ => false,
        }
    }
    ...
    fn veneer_size(self) -> CodeOffset {
        match self {
            Self::B12 | Self::Jal20 | Self::RVCODEump => 8,
            _ => unreachable!(),
        }
    }
...
impl LabelUse {
    ...
    fn patch_raw_offset(self, buffer: &mut [u8], offset: i64) {
        let insn = match self {
            LabelUse::RVCODEump => u16::from_le_bytes(buffer[..2].try_into().unwrap()) as u32,
        ...
        match self {
            ...
            LabelUse::RVCODEump => {
                ...
                buffer[0..2].clone_from_slice(&u16::to_le_bytes(encode_code_type(
                    CodeOp::CODE,
