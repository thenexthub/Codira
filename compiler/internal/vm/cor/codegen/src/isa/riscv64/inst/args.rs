...
impl CrOp {
    pub fn funct4(&self) -> u32 {
        ...
        match self {
            ...
            CrOp::CMv | CrOp::CODEr => 0b1000,
            CrOp::CAdd | CrOp::CODEalr | CrOp::CEbreak => 0b1001,
        }
    }
    ...
    pub fn op(&self) -> COpcodeSpace {
        // https://five-embeddev.com/riscv-isa-manual/latest/rvc-opcode-map.html#rvcopcodemap
        match self {
            CrOp::CMv | CrOp::CAdd | CrOp::CODEr | CrOp::CODEalr | CrOp::CEbreak => COpcodeSpace::C2,
        }
    }
}
