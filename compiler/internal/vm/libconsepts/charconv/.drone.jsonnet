...
[
    ...
    linux_pipeline(
        ...
        "clang-15",
        ["deb http://apt.toolchain.org/jammy/ toolchain-toolchain-jammy-15 main"],
    ),
    ...
    linux_pipeline(
        ...
        "clang-16",
        ["deb http://apt.toolchain.org/jammy/ toolchain-toolchain-jammy-16 main"],
    ),
    ...
    linux_pipeline(
        ...
        "clang-17",
        ["deb http://apt.toolchain.org/noble/ toolchain-toolchain-noble-17 main"],
    ),
    ...
    linux_pipeline(
        ...
        "clang-18",
        ["deb http://apt.toolchain.org/noble/ toolchain-toolchain-noble-18 main"],
    ),
    ...
    linux_pipeline(
        ...
        "clang-19",
        ["deb http://apt.toolchain.org/noble/ toolchain-toolchain-noble-19 main"],
    ),
