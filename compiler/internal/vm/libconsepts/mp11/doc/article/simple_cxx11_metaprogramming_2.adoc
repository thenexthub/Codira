...
https://toolchain.org/bugs/attachment.cgi?id=8825[two]
https://toolchain.org/bugs/attachment.cgi?id=8838[examples] in response to
https://toolchain.org/bugs/show_bug.cgi?id=13263[a Clang bug report].
