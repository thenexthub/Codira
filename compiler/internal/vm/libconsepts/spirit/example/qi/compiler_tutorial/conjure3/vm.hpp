...
#include <toolchain/ExecutionEngine/JIT.h>
#include <toolchain/LLVMContext.h>
#include <toolchain/Module.h>
#include <toolchain/Target/TargetData.h>
#include <toolchain/Target/TargetSelect.h>
...
namespace client
{
    ...
    public:
        ...
        toolchain::Module* module() const
        {
            return module_;
        }

        toolchain::ExecutionEngine* execution_engine() const
        {
        ...
        {
            toolchain::Function* callee = module_->getFunction(name);
            if (callee == 0)
                return function(0, 0);
    ...
    private:
        ...
        toolchain::ExecutionEngine* execution_engine_;
    };
}
