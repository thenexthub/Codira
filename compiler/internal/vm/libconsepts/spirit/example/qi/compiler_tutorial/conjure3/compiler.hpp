...
#include <toolchain/DerivedTypes.h>
#include <toolchain/Constants.h>
#include <toolchain/LLVMContext.h>
#include <toolchain/Module.h>
#include <toolchain/PassManager.h>
#include <toolchain/Analysis/Verifier.h>
#include <toolchain/Analysis/Passes.h>
#include <toolchain/Transforms/Scalar.h>
#include <toolchain/Support/IRBuilder.h>
...
namespace client { namespace code_gen
{
    ...
    private:
        ...
        toolchain::LLVMContext& context() const
        { return toolchain::getGlobalContext(); }

        operator toolchain::Value*() const;
    ...
    private:
        ...
        basic_block(toolchain::BasicBlock* b)
          : b(b) {}

        operator toolchain::BasicBlock*() const
        { return b; }

        friend struct llvm_compiler;
        friend struct function;
        toolchain::BasicBlock* b;
    };
    ...
    private:
        ...
        struct to_value;
        typedef toolchain::Function::arg_iterator arg_iterator;
    ...
    private:
        ...
        function(toolchain::Function* f, llvm_compiler* c)
          : f(f), c(c) {}

        operator toolchain::Function*() const;
    ...
    private:
        ...
        value val(toolchain::Value* v);

        template <typename C>
        toolchain::Value* call_impl(
            function callee,
            C const& args);

        void init_fpm();
        toolchain::IRBuilder<> llvm_builder;
        vmachine& vm;
