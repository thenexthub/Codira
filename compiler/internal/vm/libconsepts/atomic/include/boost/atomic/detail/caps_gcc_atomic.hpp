...
// https://bugs.toolchain.org/show_bug.cgi?id=19149
...
// On 32-bit x86, there is a clang bug for 64-bit atomics: https://bugs.toolchain.org/show_bug.cgi?id=19355. The compiler defines
