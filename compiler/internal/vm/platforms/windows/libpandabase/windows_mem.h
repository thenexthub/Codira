...
#ifndef PLATFORMS_WINDOWS_LIBPANDABASE_WINDOWS_MEM_H
#define PLATFORMS_WINDOWS_LIBPANDABASE_WINDOWS_MEM_H
...
#endif  // PLATFORMS_WINDOWS_LIBPANDABASE_WINDOWS_MEM_H
