...
constexpr auto CALL_MODULE_OHMURL = "@normalized:N&&&modules/ApiControl&";
...
TEST_F(AbckitRegressionCTestClean, LibAbcKitTestDynamicReplaceCallSiteOhmurlClean)
{
    std::string inputPath =
        ABCKIT_ABC_DIR "regression/issue_IC78XV/c_api/replace_call_site_ohmurl/replace_call_site.abc";
    std::string outputPath =
        ABCKIT_ABC_DIR "regression/issue_IC78XV/c_api/replace_call_site_ohmurl/replace_call_site_modified.abc";
