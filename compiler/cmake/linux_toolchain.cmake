...
option(CODIRA_ENABLE_GCOV "Enable gcov (debug, Linux builds only)" OFF)
if(CODIRA_ENABLE_GCOV)
    set(C_FLAGS "${C_FLAGS} ${GCOV_FLAGS}")
    set(CPP_FLAGS "${CPP_FLAGS} ${GCOV_FLAGS}")
    add_compile_definitions(CODIRA_ENABLE_GCOV)
endif()
if(CODIRA_ENABLE_ASAN_COV)
...
option(CODIRA_ENABLE_ASAN "Enable asan (relwithbebinfo or debug, Linux builds only)" OFF)
if(CODIRA_ENABLE_ASAN)
    set(C_FLAGS "${C_FLAGS} ${ASAN_FLAGS}")
    set(CPP_FLAGS "${CPP_FLAGS} ${ASAN_FLAGS}")
endif()

option(CODIRA_ENABLE_HWASAN "Enable hardware asan (relwithdebinfo or debug, OHOS builds only)" OFF)
