...
export PATH=${CODIRA_HOME}/bin:${CODIRA_HOME}/tools/bin:${CODIRA_HOME}/tools/lib:${CODIRA_HOME}/runtime/lib/windows_x86_64_codenative:${CODIRA_HOME}/third_party/llvm/lldb/lib:$PATH:${USERPROFILE}/.codepm/bin
