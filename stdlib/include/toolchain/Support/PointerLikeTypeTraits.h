//===- toolchain/Support/PointerLikeTypeTraits.h - Pointer Traits ----*- C++ -*-===//
//
...
#ifndef TOOLCHAIN_SUPPORT_POINTERLIKETYPETRAITS_H
#define TOOLCHAIN_SUPPORT_POINTERLIKETYPETRAITS_H
