...
#ifndef TOOLCHAIN_SUPPORT_ALLOCATOR_H
#define TOOLCHAIN_SUPPORT_ALLOCATOR_H

#include "toolchain/ADT/SmallVector.h"
#include "toolchain/Support/Alignment.h"
#include "toolchain/Support/AllocatorBase.h"
...
public:
...
#if TOOLCHAIN_ADDRESS_SANITIZER_BUILD
  ...
  inline TOOLCHAIN_ATTRIBUTE_RETURNS_NONNULL TOOLCHAIN_ATTRIBUTE_RETURNS_NOALIAS void *
...
operator new(size_t Size,
             __language::__runtime::toolchain::BumpPtrAllocatorImpl<AllocatorT,
                                                            SlabSize,
                                                            SizeThreshold,
                                                            GrowthDelay> &Allocator) {
  return Allocator.Allocate(Size, std::min((size_t)toolchain::NextPowerOf2(Size),
...
#endif // TOOLCHAIN_SUPPORT_ALLOCATOR_H
