//===- toolchain/Support/type_traits.h - Simplified type traits -------*- C++ -*-===//
//
...
#ifndef TOOLCHAIN_SUPPORT_TYPE_TRAITS_H
#define TOOLCHAIN_SUPPORT_TYPE_TRAITS_H
...
struct is_trivially_copy_constructible
    : std::is_copy_constructible<
          __language::__runtime::toolchain::detail::copy_construction_triviality_helper<T>> {};
template <typename T>
...
struct is_trivially_move_constructible
    : std::is_move_constructible<
          __language::__runtime::toolchain::detail::move_construction_triviality_helper<T>> {};
template <typename T>
...
#endif // TOOLCHAIN_SUPPORT_TYPE_TRAITS_H
