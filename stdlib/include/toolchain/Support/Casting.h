//===- toolchain/Support/Casting.h - Allow flexible, checked, casts --*- C++ -*-===//
//
...
#ifndef TOOLCHAIN_SUPPORT_CASTING_H
#define TOOLCHAIN_SUPPORT_CASTING_H
...
#endif // TOOLCHAIN_SUPPORT_CASTING_H
