...
#ifndef TOOLCHAIN_ADT_ARRAYREF_H
#define TOOLCHAIN_ADT_ARRAYREF_H
...
namespace toolchain {
  ...
  /// value.
  template<typename T>
  class TOOLCHAIN_GSL_POINTER [[nodiscard]] ArrayRef {
  public:
    using value_type = T;
...
#if TOOLCHAIN_GNUC_PREREQ(9, 0, 0)
...
#endif // TOOLCHAIN_ADT_ARRAYREF_H
