...
#ifndef TOOLCHAIN_ADT_STLEXTRAS_H
#define TOOLCHAIN_ADT_STLEXTRAS_H
...
using remove_cvref_t // NOLINT(readability-identifier-naming)
    = typename toolchain::remove_cvref<T>::type;
...
class indexed_accessor_iterator
    : public toolchain::iterator_facade_base<DerivedT,
...
inline void presortShuffle(IteratorTy Start, IteratorTy End) {
  ...
  toolchain::shuffle(Start, End, Generator);
}
...
#endif // TOOLCHAIN_ADT_STLEXTRAS_H
