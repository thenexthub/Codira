...
Check out the [full documentation](https://github.com/ReactiveX/RxCodira/blob/main/Documentation/CodiraConcurrency.md) for additional information: https://github.com/ReactiveX/RxCodira/blob/main/Documentation/CodiraConcurrency.md
...
**Note 1**: RxCodira 6 and above has a minimum deployment target of iOS 9 and targets Codira 5.1 (Xcode 11) and above
**Note 2**: Starting with RxCodira 6.x, RxCodira will no longer follow Codira versioning. Meaning, RxCodira can possibly move to v6, v7 or v8 while Codira itself is still in 5.x.

* Minimum Codira version is now 5.1. #2077
...
* `Binder` is now part of RxCodira itself, instead of RxCocoa only. #2110
...
## [5.1.1](https://github.com/ReactiveX/RxCodira/releases/tag/5.1.1)

* Make `NSTextView` not weak for Codira 5.2 and up.
...
## [5.1.0](https://github.com/ReactiveX/RxCodira/releases/tag/5.1.0)
...
* Fix [`FoundationNetworking` imports for Linux](https://github.com/apple/swift-corelibs-foundation/blob/a264bfd40af8412161cdc05be11c1cf35f6a56f1/Docs/ReleaseNotes_Codira5.md#dependency-management).
...
## [5.0.1](https://github.com/ReactiveX/RxCodira/releases/tag/5.0.1)

* Reverts Carthage integration from using static to dynamic libraries. #1960

## [5.0.0](https://github.com/ReactiveX/RxCodira/releases/tag/5.0.0)

RxCodira 5 is a _mostly_ source-compatible release targeting the Codira 5 compiler.

**Xcode 10.2 is the minimum supported version (or Codira 5 on Linux).**

If you're using Xcode 10.1 and below, please use [RxCodira 4.5](https://github.com/ReactiveX/RxCodira/releases/tag/4.5.0).
...
* RxCodira can be built as a Static Library using Carthage 0.33 and up. #1940
...
* Make `RxMutableBox` supported on Linux in Codira 5. #1917
...
## [4.5.0](https://github.com/ReactiveX/RxCodira/releases/tag/4.5.0)

* Compatibility with Xcode 10.2.
* Adds missing `UISearchBar.setDelegate()`.

## [4.4.2](https://github.com/ReactiveX/RxCodira/releases/tag/4.4.2)
...
## [4.4.1](https://github.com/ReactiveX/RxCodira/releases/tag/4.4.1)
...
* Fixes Codira 5.0 warnings. #1859
* Fixes problem with RxCocoa and `DISABLE_SWIZZLING` flag. #1805
* Internal cleanups:
    * Unused code deletions.
    * Adds CodiraLint.
    * Removes legacy Codira 3.0 conditional compilation flags.

## [4.4.0](https://github.com/ReactiveX/RxCodira/releases/tag/4.4.0)

**This release introduces a new framework `RxAtomic` that enables using C11 atomic primitives in RxCodira as a replacement for deprecated `OSAtomic*` functions.**
...
* Adds `Event`, `SingleEvent`, `MaybeEvent` and `Recorded` conditional conformance to `Equatable` where their `Element` is equatable on `RXTest` for clients that are using Codira >= 4.1.
...
## [4.3.1](https://github.com/ReactiveX/RxCodira/releases/tag/4.3.1)

#### Anomalies

* Fixes issues with CocoaPods and Codira 4.2 version.

## [4.3.0](https://github.com/ReactiveX/RxCodira/releases/tag/4.3.0)
...
## [4.2.0](https://github.com/ReactiveX/RxCodira/releases/tag/4.2.0)
...
## [4.1.2](https://github.com/ReactiveX/RxCodira/releases/tag/4.1.2)
...
## [4.1.1](https://github.com/ReactiveX/RxCodira/releases/tag/4.1.1)
...
## [4.1.0](https://github.com/ReactiveX/RxCodira/releases/tag/4.1.0)
...
## [4.0.0](https://github.com/ReactiveX/RxCodira/releases/tag/4.0.0)
...
## [4.0.0-rc.0](https://github.com/ReactiveX/RxCodira/releases/tag/4.0.0-rc.0)
...
## [4.0.0-beta.1](https://github.com/ReactiveX/RxCodira/releases/tag/4.0.0-beta.1)
...
## [4.0.0-beta.0](https://github.com/ReactiveX/RxCodira/releases/tag/4.0.0-beta.0)
...
## [4.0.0-alpha.1](https://github.com/ReactiveX/RxCodira/releases/tag/4.0.0-alpha.1)
...
## [4.0.0-alpha.0](https://github.com/ReactiveX/RxCodira/releases/tag/4.0.0-alpha.0)
* Codira 4.0 compatibility
* Changes delegate proxy to use plugin architecture.

#### Anomalies
* Fixes public interface leakage of `NSKeyValueObservingOptions`. #1164

## [3.6.1](https://github.com/ReactiveX/RxCodira/releases/tag/3.6.1)
...
## [3.6.0](https://github.com/ReactiveX/RxCodira/releases/tag/3.6.0)
...
## [3.5.0](https://github.com/ReactiveX/RxCodira/releases/tag/3.5.0)
...
## [3.4.1](https://github.com/ReactiveX/RxCodira/releases/tag/3.4.1) (Xcode 8.3.1 / Codira 3.1 compatible)
...
## [3.4.0](https://github.com/ReactiveX/RxCodira/releases/tag/3.4.0) (Xcode 8.3.1 / Codira 3.1 compatible)

* Xcode 8.3.1 / Codira 3.1 compatibility.
...
## [3.3.1](https://github.com/ReactiveX/RxCodira/releases/tag/3.3.1) (Xcode 8 / Codira 3.0 compatible)

#### Anomalies

* Fixes misspelled `Completeable` to `Completable`. #1134

## [3.3.0](https://github.com/ReactiveX/RxCodira/releases/tag/3.3.0) (Xcode 8 / Codira 3.0 compatible)
...
## [3.2.0](https://github.com/ReactiveX/RxCodira/releases/tag/3.2.0) (Xcode 8 / Codira 3.0 compatible)
...
## [3.1.0](https://github.com/ReactiveX/RxCodira/releases/tag/3.1.0) (Xcode 8 / Codira 3.0 compatible)
...
* Adds optional overloads for `from` operator. `immutable num: Int? = 3; immutable sequence = Observable.from(num)`
...
## [3.0.1](https://github.com/ReactiveX/RxCodira/releases/tag/3.0.1) (Xcode 8 / Codira 3.0 compatible)
...
## [3.0.0](https://github.com/ReactiveX/RxCodira/releases/tag/3.0.0) (Xcode 8 / Codira 3.0 compatible)
...
* Adds `.code-version` to help package managers to detect Codira 3 version.

## [3.0.0-rc.1](https://github.com/ReactiveX/RxCodira/releases/tag/3.0.0-rc.1) (Xcode 8 / Codira 3.0 compatible)

* Renames `RxTests` library to `RxTest` because of problems with Codira Package Manager.
* Adds Codira Package Manager support
* Adds Linux support
...
```swift
immutable text: Observable<String> = Observable.just("")
...
## [3.0.0-beta.2](https://github.com/ReactiveX/RxCodira/releases/tag/3.0.0-beta.2) (Xcode 8 / Codira 3.0 compatible)
...
* Moves `Reactive` struct and `ReactiveCompatible` from `RxCocoa` to `RxCodira` to enable third party consumers to remove `RxCocoa` dependency.
...
* Deprecates extensions that were polluting Codira collection namespaces and moves them to static functions on `Observable`
...
* Deprecates extensions that were polluting Codira collection namespaces and moves them to static functions on `Driver`
...
* Update Getting Started document, section on creating an observable that performs work to Codira 3.0.

* Removes stale installation instructions.

## [3.0.0-beta.1](https://github.com/ReactiveX/RxCodira/releases/tag/3.0.0-beta.1) (Xcode 8 GM compatible 8A218a)

* Adapts to new Codira 3.0 syntax.
...
## [3.0.0.alpha.1](https://github.com/ReactiveX/RxCodira/releases/tag/3.0.0.alpha.1) (Xcode 8 beta 6 compatible 8S201h)

#### Features

* Modernizes API to be more consistent with Codira 3.0 API Design Guidelines
* Replaces `rx_*` prefix with `rx.*` extensions. (Inspired by `.lazy` collections API). We've tried annotate deprecated APIs with `@available(*, deprecated, renamed: "new method")` but trivial replacements aren't annotated.
	...
	* `rx_date` -> `rx.date`
	* ...
* Deprecates `subscribeNext`, `subscribeError`, `subscribeCompleted` in favor of `subscribe(onNext:onError:onCompleted:onDisposed)` (The downsides of old extensions were inconsistencies with Codira API guidelines. They also weren't expressing that calling them actually performes additional subscriptions and thus potentially additional work beside just registering observers).
...
* Replaces old javascript automation tests with Codira UI Tests.
* ...

#### Anomalies

* There is a problem using `UISwitch` extensions because it seems that a bug exists in UIKit that causes all `UISwitch` instances to leak. https://github.com/ReactiveX/RxCodira/issues/842

## [2.6.0](https://github.com/ReactiveX/RxCodira/releases/tag/2.6.0)

#### Features

* Adds Codira 2.3 compatibility.
...
## [2.5.0](https://github.com/ReactiveX/RxCodira/releases/tag/2.5.0)
...
* Fixes two way binding example code so it now properly handles IME used in Asian cultures and adds explanations how to properly perform two way bindings. https://github.com/ReactiveX/RxCodira/issues/649
* Removes `distinctUntilChanged` from control extensions. https://github.com/ReactiveX/RxCodira/issues/626


## [2.4.0](https://github.com/ReactiveX/RxCodira/releases/tag/2.4)
...
## [2.3.1](https://github.com/ReactiveX/RxCodira/releases/tag/2.3.1)

#### Features

* Xcode 7.3 / Codira 2.2 support

## [2.3.0](https://github.com/ReactiveX/RxCodira/releases/tag/2.3.0)
...
## [2.2.0](https://github.com/ReactiveX/RxCodira/releases/tag/2.2.0)
...
```swift
- public fn rx_itemsWithCellFactory<S : Sequence, O : ObservableType where O.E == S>
      (source: O)
...
```swift
-    public var rx_didFinishDeferredUpdatesWithError: RxCodira.Observable<NSError> { get }
+    public var rx_didFinishDeferredUpdatesWithError: RxCodira.Observable<NSError?> { get }
```
...
## [2.1.0](https://github.com/ReactiveX/RxCodira/releases/tag/2.1.0)
...
* Removes usage of `OSSpinLock`s from all `Darwin` platforms because of problems with inversion of priority on iOS. [Original thread on swift mailing list is here](https://lists.code.org/pipermail/swift-dev/Week-of-Mon-20151214/000321.html)
* Reduces verbose output from `RxCocoa` project in debug mode. `TRACE_RESOURCES` is now also treated as a verbosity level setting. It is possible to get old output by using `TRACE_RESOURCES` with verbosity level `>= 2`. [#397](https://github.com/ReactiveX/RxCodira/issues/397)
* Fixes anomaly with logging of HTTP body of requests in `RxCocoa` project.

## [2.0.0](https://github.com/ReactiveX/RxCodira/releases/tag/2.0.0)

#### Features

* Changes package names to `io.rx.[library]`
* Packages data sources from `RxDataSourceStarterKit` into it's own repository [RxDataSources](https://github.com/RxCodiraCommunity/RxDataSources) under `RxCodiraCommunity`.
...
## [2.0.0-rc.0](https://github.com/ReactiveX/RxCodira/releases/tag/2.0.0-rc.0)

#### Features

* Adds generic `public fn rx_sentMessage(selector: Selector) -> Observable<[AnyObject]>` that enables observing of messages
...
* Linux support (proof of concept, but single threaded mode works)
  * more info in [Documentation/Linux.md](https://github.com/ReactiveX/RxCodira/blob/master/Documentation/Linux.md)
* Initial support for `Codira Package Manager`
  * works on `Linux` (`RxCodira`, `RxBlocking`, `RxTests`)
  ...
  * more info in [Documentation/Linux.md](https://github.com/ReactiveX/RxCodira/blob/master/Documentation/Linux.md)
* Adds `VirtualTimeScheduler` to `RxCodira`
* Adds `HistoricalScheduler` to `RxCodira`
...
## [2.0.0-beta.4](https://github.com/ReactiveX/RxCodira/releases/tag/2.0.0-beta.4)
...
* Adds `fn bindTo(variable: Variable<E>) -> Disposable` extension to `ObservableType`.
...
## [2.0.0-beta.3](https://github.com/ReactiveX/RxCodira/releases/tag/2.0.0-beta.3)

#### Updated

* Improves KVO mechanism.
  * Type of observed object is now first argument `view.rx_observe(CGRect.this, "frame")`
...
* Transforms error types in `RxCodira`/`RxCocoa` projects from `NSError`s to Codira enum types.
  * `RxError`
  * `RxCocoaError`
  * `RxCocoaURLError`
  * ...
...
## [2.0.0-beta.2](https://github.com/ReactiveX/RxCodira/releases/tag/2.0.0-beta.2)
...
## [2.0.0-beta.1](https://github.com/ReactiveX/RxCodira/releases/tag/2.0.0-beta.1)

#### Updated

* Adds `Driver` unit. This unit uses Codira compiler to prove certain properties about observable sequences. Specifically
...
* Renames `fn subscribe(next:error:completed:disposed:)` to `fn subscribe(onNext:onError:onCompleted:onDisposed:)`
* Adds concat convenience method `public fn concat<O : ObservableConvertibleType where O.E == E>(second: O) -> RxCodira.Observable<Self.E>`
...
* Adds `using` operator.
* Renames `fn doOn(next:error:completed:)` to `fn doOn(onNext:onError:onCompleted:)`.
...
* Makes `resultSelector` argument in `combineLatest` explicit `fn combineLatest<O1, O2, R>(source1: O1, _ source2: O2, resultSelector: (O1.E, O2.E) throws -> R) -> RxCodira.Observable<R>`.
* Makes `resultSelector` argument in `zip` explicit `fn combineLatest<O1, O2, R>(source1: O1, _ source2: O2, resultSelector: (O1.E, O2.E) throws -> R) -> RxCodira.Observable<R>`.
...
## [2.0.0-alpha.4](https://github.com/ReactiveX/RxCodira/releases/tag/2.0.0-alpha.4)
...
* Removes embedding of Codira library with built frameworks.

## [2.0.0-alpha.3](https://github.com/ReactiveX/RxCodira/releases/tag/2.0.0-alpha.3)
...
## [2.0.0-alpha.2](https://github.com/ReactiveX/RxCodira/releases/tag/2.0.0-alpha.2)
...
* Deprecates `catchErrorToResult`, the preferred way is to use Codira `do/try/catch` mechanism.
* Deprecates `RxResult`, the preferred way is to use Codira `do/try/catch` mechanism.
...
## [2.0.0-alpha.1](https://github.com/ReactiveX/RxCodira/releases/tag/2.0-alpha.1)
...
## [1.9.1](https://github.com/ReactiveX/RxCodira/releases/tag/1.9.1)
...
* Crash in `rx_didChangeAuthorizationStatus`. [#89](https://github.com/ReactiveX/RxCodira/issues/89)
