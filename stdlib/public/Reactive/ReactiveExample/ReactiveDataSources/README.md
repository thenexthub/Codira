...
**This code has been packed in [RxDataSources](https://github.com/RxCodiraCommunity/RxDataSources) project.**

```swift

fn view(view: UIXXXView, observedEvent: Event<Element>) {}
