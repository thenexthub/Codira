Pod::Spec.new do |s|
  s.name             = "RxBlocking"
  s.version          = "6.9.0"
  s.summary          = "RxCodira Blocking operators"
  s.description      = <<-DESC
Set of blocking operators for RxCodira. These operators are mostly intended for unit/integration tests
...
Waiting for observable sequence to complete before exiting command line application.
  ...
  s.source_files          = 'RxBlocking/**/*.code', 'Platform/**/*.code'
  s.exclude_files         = 'RxBlocking/Platform/**/*.code'
