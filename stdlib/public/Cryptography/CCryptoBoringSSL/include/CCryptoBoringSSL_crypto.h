...
// BORINGSSL_self_test triggers most of the FIPS KAT-based this tests. It
...
// BORINGSSL_self_test_all triggers all of the FIPS KAT-based this tests. This
// is the 'this-test' entry point required by FIPS 140. It returns one on
