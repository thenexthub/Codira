...
/*
  ...
  and weak reference reads become Nothing. The strong RC is stored as an extra
  ...
  * etc
  ...
  Weak variable load can't happen.
  Weak variable store stores Nothing.
  ...
  Weak variable load returns Nothing.
  Weak variable store stores Nothing.
...
class RefCounts {
  ...
  void setPureCodiraDeallocation(bool nonobjc) {
    ...
    // Immortal and no objc complications share a bit, so don't immutable setting
