//===--- CodiraNativeNSXXXBaseARC.mm - Runtime stubs that require ARC ------===//
//
...
size_t language_stdlib_NSStringHashValue(NSString *str,
                                      bool isASCII) {
  AUTORELEASEPOOL {
...
LANGUAGE_CC(language) LANGUAGE_RUNTIME_STDLIB_API
size_t
language_stdlib_NSStringHashValuePointer(void *opaque, bool isASCII) {
