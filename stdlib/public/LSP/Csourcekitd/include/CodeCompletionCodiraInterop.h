...
typedef void *languageide_api_connection_t;

/// Opaque completion item handle, used to retrieve additional information that
/// may be more expensive to compute.
typedef void *languageide_api_completion_item_t;

typedef enum languageide_api_completion_kind_t: uint32_t {
...
} languageide_api_completion_kind_t;

typedef enum languageide_api_completion_item_kind_t: uint32_t {
...
} languageide_api_completion_item_kind_t;

typedef enum languageide_api_completion_item_decl_kind_t: uint32_t {
...
} languageide_api_completion_item_decl_kind_t;

typedef enum languageide_api_completion_type_relation_t: uint32_t {
...
} languageide_api_completion_type_relation_t;

typedef enum languageide_api_completion_semantic_context_t: uint32_t {
...
} languageide_api_completion_semantic_context_t;

typedef enum languageide_api_completion_flair_t: uint32_t {
...
} languageide_api_completion_flair_t;

typedef enum languageide_api_completion_not_recommended_reason_t: uint32_t {
...
} languageide_api_completion_not_recommended_reason_t;

typedef enum languageide_api_completion_diagnostic_severity_t: uint32_t {
...
} languageide_api_completion_diagnostic_severity_t;

typedef void *languageide_api_completion_request_t;

typedef void *languageide_api_completion_response_t;

typedef void *languageide_api_fuzzy_match_pattern_t;

typedef void *languageide_api_cache_invalidation_options_t;

/// languageide equivalent of sourcekitd_request_handle_t
typedef const void *languageide_api_request_handle_t;
...
typedef struct {
  ...
  void (*_Nonnull connection_dispose)(
    _Null_unspecified languageide_api_connection_t
  );

  void (*_Nonnull connection_mark_cached_compiler_instance_should_be_invalidated)(
    _Null_unspecified languageide_api_connection_t,
    _Null_unspecified languageide_api_cache_invalidation_options_t
  );
  ...
  void (*_Nonnull set_file_contents)(
    _Null_unspecified languageide_api_connection_t connection,
  ...
  void (*_Nonnull cancel_request)(
    _Null_unspecified languageide_api_connection_t _conn,
    _Null_unspecified languageide_api_request_handle_t handle
  );

  _Null_unspecified languageide_api_completion_request_t (*_Nonnull completion_request_create)(
    const char *_Null_unspecified path,
    uint32_t offset,
  ...
  void (*_Nonnull completion_request_dispose)(
    _Null_unspecified languageide_api_completion_request_t
  );
  ...
  _Null_unspecified languageide_api_completion_response_t (*_Nonnull complete_cancellable)(
    _Null_unspecified languageide_api_connection_t _conn,
    _Null_unspecified languageide_api_completion_request_t _req,
    _Null_unspecified languageide_api_request_handle_t handle
  );

  void (*_Nonnull completion_result_dispose)(
    _Null_unspecified languageide_api_completion_response_t
  );
  ...
  void (*_Nonnull completion_result_get_completions)(
    ...
    void (^_Null_unspecified completions_handler)(
      const _Null_unspecified languageide_api_completion_item_t *_Null_unspecified completions,
      const char *_Null_unspecified *_Null_unspecified filter_names,
      uint64_t num_completions
    )
  );

  _Null_unspecified languageide_api_completion_item_t (*_Nonnull completion_result_get_completion_at_index)(
    _Null_unspecified languageide_api_completion_response_t,
    uint64_t index
  );

  languageide_api_completion_kind_t (*_Nonnull completion_result_get_kind)(
    _Null_unspecified languageide_api_completion_response_t
  );
  ...
  const char *_Null_unspecified  (*_Nonnull completion_item_description_copy)(
    _Null_unspecified languageide_api_completion_item_t
  );
  ...
  bool (*_Nonnull completion_item_has_diagnostic)(
    _Null_unspecified languageide_api_completion_item_t _item
  );

  void (*_Nonnull completion_item_get_diagnostic)(
    _Null_unspecified languageide_api_completion_response_t,
    _Null_unspecified languageide_api_completion_item_t,
    void (^_Null_unspecified handler)(languageide_api_completion_diagnostic_severity_t, const char *_Null_unspecified)
  );
  ...
  void (*_Nonnull completion_item_get_module_name)(
    _Null_unspecified languageide_api_completion_response_t _response,
    _Null_unspecified languageide_api_completion_item_t _item,
    void (^_Null_unspecified handler)(const char *_Null_unspecified)
  );
  ...
  _Null_unspecified languageide_api_fuzzy_match_pattern_t (*_Nonnull fuzzy_match_pattern_create)(
    const char *_Null_unspecified pattern
  );

  bool (*_Nonnull fuzzy_match_pattern_matches_candidate)(
    _Null_unspecified languageide_api_fuzzy_match_pattern_t pattern,
    const char *_Null_unspecified candidate,
    double *_Null_unspecified outScore
  );

  void (*_Nonnull fuzzy_match_pattern_dispose)(
    _Null_unspecified languageide_api_fuzzy_match_pattern_t
  );
