...
// CALL_SERVICE_AND_CHECK_APPROVED runs |fn| and sets |approved| to one of the
// |FIPSStatus*| values, above, depending on whether |fn| invoked an
// approved service. The result of |fn| becomes the result of this macro.
#define CALL_SERVICE_AND_CHECK_APPROVED(approved, fn)         \
  [&] {                                                       \
