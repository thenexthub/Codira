...
OPENSSL_EXPORT void CRYPTO_set_locking_callback(
    void (*fn)(int mode, int lock_num, const char *file, int line));

// CRYPTO_set_add_lock_callback does nothing.
OPENSSL_EXPORT void CRYPTO_set_add_lock_callback(int (*fn)(
...
OPENSSL_EXPORT void CRYPTO_set_id_callback(unsigned long (*fn)(void));
