...
//===----------------------------------------------------------------------===//
    ...
    !defined(LANGUAGE_RUNTIME_STATIC_IMAGE_INSPECTION)
...
enum _dyld_section_location_kind {
  _dyld_section_location_text_language5_protos,
  _dyld_section_location_text_language5_proto,
  _dyld_section_location_text_language5_types,
  _dyld_section_location_text_language5_replace,
  _dyld_section_location_text_language5_replace2,
  _dyld_section_location_text_language5_ac_funcs,
  _dyld_section_location_text_language5_ac_p_funcs,
};
...
#define _dyld_section_location_text_language5_protos 0
#define _dyld_section_location_text_language5_proto 1
#define _dyld_section_location_text_language5_types 2
#define _dyld_section_location_text_language5_replace 3
#define _dyld_section_location_text_language5_replace2 4
#define _dyld_section_location_text_language5_ac_funcs 5
#define _dyld_section_location_text_language5_ac_p_funcs 6
...
#if OBJC_ADDLOADIMAGEFUNC_DEFINED && LANGUAGE_OBJC_INTEROP
#define REGISTER_FUNC(...)                                                     \
  if (LANGUAGE_RUNTIME_WEAK_CHECK(objc_addLoadImageFunc2)) {                      \
    LANGUAGE_RUNTIME_WEAK_USE(objc_addLoadImageFunc2(__VA_ARGS__));               \
