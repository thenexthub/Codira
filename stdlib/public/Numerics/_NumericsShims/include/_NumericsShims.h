//===--- NumericsShims.h --------------------------------------*- Codira -*-===//
//
// This source file is part of the Codira Numerics open source project
//
// Copyright (c) 2019-2020 Apple Inc. and the Codira Numerics project authors
...
// instead of fn, since the compiler knows about these operations, but for
