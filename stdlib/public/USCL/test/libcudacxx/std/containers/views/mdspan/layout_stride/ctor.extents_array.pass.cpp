...
__host__ __device__ constexpr bool test()
{
  ...
  }
  {
    ...
    test_construction(cuda::std::extents<int, D>(7), s);
  }
  {
  ...
  }
  {
    ...
    test_construction(cuda::std::extents<int64_t, D, 8, D, D>(0, 9, 10), s);
    test_construction(cuda::std::extents<int64_t, D, 8, D, D>(0, 8, 0), s);
  }
  {
    cuda::std::array<int, 4> s{200, 20, 20, 2000};
    test_construction(cuda::std::extents<int64_t, D, D, D, D>(7, 0, 8, 9), s);
    test_construction(cuda::std::extents<int64_t, D, D, D, D>(7, 8, 0, 9), s);
    test_construction(cuda::std::extents<int64_t, D, D, D, D>(7, 1, 8, 9), s);
    test_construction(cuda::std::extents<int64_t, D, D, D, D>(7, 8, 1, 9), s);
    test_construction(cuda::std::extents<int64_t, D, D, D, D>(7, 1, 1, 9), s);
    test_construction(cuda::std::extents<int64_t, D, D, D, D>(7, 0, 0, 9), s);
    test_construction(cuda::std::extents<int64_t, D, D, D, D>(7, 1, 1, 9), s);
    test_construction(cuda::std::extents<int64_t, D, D, D, D>(7, 1, 0, 9), s);
    test_construction(cuda::std::extents<int64_t, D, D, D, D>(7, 0, 1, 9), s);
  }
