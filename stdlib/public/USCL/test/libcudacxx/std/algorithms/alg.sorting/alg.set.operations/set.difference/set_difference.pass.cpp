...
__host__ __device__ constexpr void test4()
{
  ...
  const T b[] = {22, 32, 43, 42, 52};
  {
    T result[20] = {};
    T expected[] = {11, 31};
    OutIter end  = cuda::std::set_difference(Iter1(a), Iter1(a + 4), Iter2(b), Iter2(b + 5), OutIter(result));
  ...
  }
  {
    T result[20] = {};
    T expected[] = {22, 42, 52};
    OutIter end  = cuda::std::set_difference(Iter1(b), Iter1(b + 5), Iter2(a), Iter2(a + 4), OutIter(result));
