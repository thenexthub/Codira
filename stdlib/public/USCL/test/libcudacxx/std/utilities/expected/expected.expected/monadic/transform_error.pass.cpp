...
__host__ __device__ constexpr void test_val_types()
{
  ...
  // Test & overload
  {
    // Without & qualifier on F's operator()
    {
      ...
      static_assert(cuda::std::is_same_v<decltype(i.transform_error(LVal{})), cuda::std::expected<int, int>>);
    }
    ...
    // With & qualifier on F's operator()
    {
      ...
      static_assert(cuda::std::is_same_v<decltype(i.transform_error(l)), cuda::std::expected<int, int>>);
    }
  ...
  // Test const& overload
  {
    // Without & qualifier on F's operator()
    {
      ...
      static_assert(cuda::std::is_same_v<decltype(i.transform_error(CLVal{})), cuda::std::expected<int, int>>);
    }
  ...
  // Test && overload
  {
    // Without & qualifier on F's operator()
    {
      ...
      static_assert(
        cuda::std::is_same_v<decltype(cuda::std::move(i).transform_error(RVal{})), cuda::std::expected<int, int>>);
    }
    ...
    // With & qualifier on F's operator()
    {
      ...
      static_assert(cuda::std::is_same_v<decltype(i.transform_error(RVRefQual{})), cuda::std::expected<int, int>>);
    }
  ...
  // Test const&& overload
  {
    // Without & qualifier on F's operator()
    {
      ...
      static_assert(
        cuda::std::is_same_v<decltype(cuda::std::move(i).transform_error(CRVal{})), cuda::std::expected<int, int>>);
    }
    ...
    // With & qualifier on F's operator()
    {
      ...
      static_assert(
        cuda::std::is_same_v<decltype(i.transform_error(cuda::std::move(l))), cuda::std::expected<int, int>>);
    }
