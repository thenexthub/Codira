...
__host__ __device__ constexpr void test_val_types()
{
  ...
  // Test & overload
  {
    // Without & qualifier on F's operator()
    {
      ...
      static_assert(cuda::std::is_same_v<decltype(i.or_else(LVal{})), cuda::std::expected<int, TestError>>);
    }
    ...
    // With & qualifier on F's operator()
    {
      ...
      static_assert(cuda::std::is_same_v<decltype(i.or_else(l)), cuda::std::expected<int, TestError>>);
    }
  ...
  // Test const& overload
  {
    // Without & qualifier on F's operator()
    {
      ...
      static_assert(cuda::std::is_same_v<decltype(i.or_else(CLVal{})), cuda::std::expected<int, TestError>>);
    }
  ...
  // Test && overload
  {
    // Without & qualifier on F's operator()
    {
      ...
      static_assert(
        cuda::std::is_same_v<decltype(cuda::std::move(i).or_else(RVal{})), cuda::std::expected<int, TestError>>);
    }
    ...
    // With & qualifier on F's operator()
    {
      ...
      static_assert(cuda::std::is_same_v<decltype(i.or_else(RVRefQual{})), cuda::std::expected<int, TestError>>);
    }
  ...
  // Test const&& overload
  {
    // Without & qualifier on F's operator()
    {
      ...
      static_assert(
        cuda::std::is_same_v<decltype(cuda::std::move(i).or_else(CRVal{})), cuda::std::expected<int, TestError>>);
    }
    ...
    // With & qualifier on F's operator()
    {
      ...
      static_assert(cuda::std::is_same_v<decltype(i.or_else(cuda::std::move(l))), cuda::std::expected<int, TestError>>);
    }
