...
#ifndef _CUDA_STD___TYPE_TRAITS_IS_DEFAULT_CONSTRUCTIBLE_H
#define _CUDA_STD___TYPE_TRAITS_IS_DEFAULT_CONSTRUCTIBLE_H
...
#endif // _CUDA_STD___TYPE_TRAITS_IS_DEFAULT_CONSTRUCTIBLE_H
