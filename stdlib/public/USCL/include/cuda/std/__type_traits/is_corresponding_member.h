...
#ifndef _CUDA_STD___TYPE_TRAITS_IS_CORRESPONDING_MEMBER_H
#define _CUDA_STD___TYPE_TRAITS_IS_CORRESPONDING_MEMBER_H
...
#endif // _CUDA_STD___TYPE_TRAITS_IS_CORRESPONDING_MEMBER_H
