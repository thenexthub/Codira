...
#include "language/Core/Basic/TransformTypeTraits.def"
  ...
  toolchain_unreachable("Invalid TypeSpecType!");
}
...
const char *DeclSpec::getSpecifierName(DeclSpec::SCS S) {
  ...
  toolchain_unreachable("Unknown typespec!");
}
...
const char *DeclSpec::getSpecifierName(ConstexprSpecKind C) {
  ...
  toolchain_unreachable("Unknown ConstexprSpecKind");
}
...
bool DeclSpec::SetTypeQual(TQ T, SourceLocation Loc) {
  ...
  toolchain_unreachable("Unknown type qualifier!");
}
...
bool VirtSpecifiers::SetSpecifier(Specifier VS, SourceLocation Loc,
  ...
  switch (VS) {
  default: toolchain_unreachable("Unknown specifier!");
