...
bool SemaLoongArch::CheckLoongArchBuiltinFunctionCall(const TargetInfo &TI,
  ...
  case LoongArch::BI__builtin_loongarch_cacop_w: {
    return SemaRef.BuiltinConstantArgRange(TheCall, 0, 0, toolchain::maxUIntN(5)) ||
           SemaRef.BuiltinConstantArgRange(TheCall, 2, toolchain::minIntN(12),
                                           toolchain::maxIntN(12));
  }
  ...
  case LoongArch::BI__builtin_loongarch_movgr2fcsr:
    return SemaRef.BuiltinConstantArgRange(TheCall, 0, 0, toolchain::maxUIntN(2));
