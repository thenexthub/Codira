...
ExprResult Parser::ParseInitializerWithPotentialDesignator(
  ...
  if (Tok.is(tok::identifier)) {
    ...
    toolchain::raw_svector_ostream(NewSyntax) << '.' << FieldName->getName()
                                         << " = ";
