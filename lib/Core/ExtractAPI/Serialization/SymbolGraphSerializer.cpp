...
StringRef getLanguageName(Language Lang) {
  ...
  case Language::CIR:
    toolchain_unreachable("Unsupported language kind");
  }
...
Object serializeSymbolKind(APIRecord::RecordKind RK, Language Lang) {
  ...
  case APIRecord::RK_Typedef:
    ...
    break;
  default:
    toolchain_unreachable("API Record with uninstantiable kind");
  }
...
Object SymbolGraphSerializer::serializeMetadata() const {
  ...
  Metadata["generator"] = language::Core::getClangFullVersion();
  return Metadata;
}
...
StringRef SymbolGraphSerializer::getRelationshipString(RelationshipKind Kind) {
  ...
  toolchain_unreachable("Unhandled relationship kind");
}
...
void SymbolGraphSerializer::serializeRelationship(RelationshipKind Kind,
  ...
  if (EmitSymbolLabelsForTesting) {
    toolchain::raw_svector_ostream OS(TestRelLabel);
...
StringRef SymbolGraphSerializer::getConstraintString(ConstraintKind Kind) {
  ...
  toolchain_unreachable("Unhandled constraint kind");
}
...
void SymbolGraphSerializer::serializeWithExtensionGraphs(
    ...
    toolchain::function_ref<std::unique_ptr<toolchain::raw_pwrite_stream>(Twine BaseName)>
        CreateOutputStream,
    SymbolGraphSerializerOption Options) {
