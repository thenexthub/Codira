...
#ifndef LANGUAGE_CORE_AST_INTERP_INTERPFRAME_H
#define LANGUAGE_CORE_AST_INTERP_INTERPFRAME_H
...
public:
  ...
  void dump() const { dump(toolchain::errs(), 0); }
...
private:
  ...
  toolchain::DenseMap<unsigned, std::unique_ptr<char[]>> Params;
  bool IsBottom = false;
};
