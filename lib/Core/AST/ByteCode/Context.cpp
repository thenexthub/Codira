...
static PrimType integralTypeToPrimTypeS(unsigned BitWidth) {
  ...
  toolchain_unreachable("Unhandled BitWidth");
}
...
/// little shorter.
const toolchain::fltSemantics &Context::getFloatSemantics(QualType T) const {
...
const Function *Context::getOrCreateFunction(const FunctionDecl *FuncDecl) {
  ...
  toolchain::DenseMap<unsigned, Function::ParamDescriptor> ParamDescriptors;
