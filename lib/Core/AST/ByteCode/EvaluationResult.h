...
#ifndef LANGUAGE_CORE_AST_INTERP_EVALUATION_RESULT_H
#define LANGUAGE_CORE_AST_INTERP_EVALUATION_RESULT_H
...
public:
  ...
  using DeclTy = toolchain::PointerUnion<const Decl *, const Expr *>;
