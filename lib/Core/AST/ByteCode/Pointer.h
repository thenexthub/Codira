...
#ifndef LANGUAGE_CORE_AST_INTERP_POINTER_H
#define LANGUAGE_CORE_AST_INTERP_POINTER_H
...
class Pointer;
inline toolchain::raw_ostream &operator<<(toolchain::raw_ostream &OS, const Pointer &P);
