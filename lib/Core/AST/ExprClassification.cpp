...
static Cl::Kinds ClassifyExprValueKind(const LangOptions &Lang,
  ...
  toolchain_unreachable("Invalid value category of implicit cast.");
}
...
#include "language/Core/AST/StmtNodes.inc"
    toolchain_unreachable("cannot classify a statement");
  ...
  toolchain_unreachable("unhandled expression kind in classification");
}
...
Expr::isModifiableLvalue(ASTContext &Ctx, SourceLocation *Loc) const {
  ...
  case Cl::CM_Untested: toolchain_unreachable("Did not test modifiability");
  case Cl::CM_Modifiable: return MLV_Valid;
  case Cl::CM_RValue: toolchain_unreachable("CM_RValue and CL_LValue don't match");
  case Cl::CM_Function: return MLV_NotObjectType;
  case Cl::CM_LValueCast:
    toolchain_unreachable("CM_LValueCast and CL_LValue don't match");
  ...
  toolchain_unreachable("Unhandled modifiable type");
}
