...
using language::Core::analyze_scanf::ScanfConversionSpecifier;
using language::Core::analyze_scanf::ScanfSpecifier;
using language::Core::UpdateOnReturn;
using namespace language::Core;

typedef language::Core::analyze_format_string::SpecifierResult<ScanfSpecifier>
...
static ScanfSpecifierResult ParseScanfSpecifier(FormatStringHandler &H,
  ...
  using namespace language::Core::analyze_scanf;
  const char *I = Beg;
  ...
  const OptionalAmount &Amt = language::Core::analyze_format_string::ParseAmount(I, E);
...
ArgType ScanfSpecifier::getArgType(ASTContext &Ctx) const {
  ...
  switch(CS.getKind()) {
    ...
    case ConversionSpecifier::iArg:
      ...
      toolchain_unreachable("Unsupported LengthModifier Type");
...
bool language::Core::analyze_format_string::ParseScanfString(FormatStringHandler &H,
                                                    const char *I,
                                                    const char *E,
                                                    const LangOptions &LO,
                                                    const TargetInfo &Target) {
