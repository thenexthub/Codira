...
using language::Core::analyze_os_log::OSLogBufferItem;
using language::Core::analyze_os_log::OSLogBufferLayout;
...
private:
  ...
  getKind(analyze_format_string::ConversionSpecifier::Kind K) {
    switch (K) {
    case language::Core::analyze_format_string::ConversionSpecifier::sArg: // "%s"
      return OSLogBufferItem::StringKind;
    case language::Core::analyze_format_string::ConversionSpecifier::SArg: // "%S"
      return OSLogBufferItem::WideStringKind;
    case language::Core::analyze_format_string::ConversionSpecifier::PArg: { // "%P"
      return OSLogBufferItem::PointerKind;
    case language::Core::analyze_format_string::ConversionSpecifier::ObjCObjArg: // "%@"
      return OSLogBufferItem::ObjCObjKind;
    case language::Core::analyze_format_string::ConversionSpecifier::PrintErrno: // "%m"
  ...
  bool HandlePrintfSpecifier(const analyze_printf::PrintfSpecifier &FS,
    ...
    if (!FS.consumesDataArgument() &&
        FS.getConversionSpecifier().getKind() !=
            language::Core::analyze_format_string::ConversionSpecifier::PrintErrno)
      return true;
    ...
    case language::Core::analyze_format_string::ConversionSpecifier::SArg: { // "%S"
      ...
      case language::Core::analyze_format_string::OptionalAmount::NotSpecified: // "%s"
        break;
      case language::Core::analyze_format_string::OptionalAmount::Constant: // "%.16s"
        ArgsData.back().Size = precision.getConstantAmount();
        break;
      case language::Core::analyze_format_string::OptionalAmount::Arg: // "%.*s"
        ArgsData.back().Count = Args[precision.getArgIndex()];
        break;
      case language::Core::analyze_format_string::OptionalAmount::Invalid:
        return false;
      }
      break;
    }
    case language::Core::analyze_format_string::ConversionSpecifier::PArg: { // "%P"
      auto &precision = FS.getPrecision();
      switch (precision.getHowSpecified()) {
      case language::Core::analyze_format_string::OptionalAmount::NotSpecified: // "%P"
        return false; // length must be supplied with pointer format specifier
      case language::Core::analyze_format_string::OptionalAmount::Constant: // "%.16P"
        ArgsData.back().Size = precision.getConstantAmount();
        break;
      case language::Core::analyze_format_string::OptionalAmount::Arg: // "%.*P"
        ArgsData.back().Count = Args[precision.getArgIndex()];
        break;
      case language::Core::analyze_format_string::OptionalAmount::Invalid:
        return false;
...
bool language::Core::analyze_os_log::computeOSLogBufferLayout(
  ...
  case Builtin::BI__builtin_os_log_format:
    ...
    break;
  default:
    toolchain_unreachable("non-os_log builtin passed to computeOSLogBufferLayout");
  }
