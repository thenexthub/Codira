...
using language::Core::analyze_format_string::ArgType;
using language::Core::analyze_format_string::FormatStringHandler;
using language::Core::analyze_format_string::FormatSpecifier;
using language::Core::analyze_format_string::LengthModifier;
using language::Core::analyze_format_string::OptionalAmount;
using language::Core::analyze_format_string::ConversionSpecifier;
...
OptionalAmount
language::Core::analyze_format_string::ParseAmount(const char *&Beg, const char *E) {
  const char *I = Beg;
...
OptionalAmount
language::Core::analyze_format_string::ParseNonPositionAmount(const char *&Beg,
                                                     const char *E,
                                                     unsigned &argIndex) {
  if (*Beg == '*') {
    ++Beg;
...
OptionalAmount
language::Core::analyze_format_string::ParsePositionAmount(FormatStringHandler &H,
                                                  const char *Start,
                                                  const char *&Beg,
                                                  const char *E,
                                                  PositionContext p) {
...
bool
language::Core::analyze_format_string::ParseFieldWidth(FormatStringHandler &H,
                                              FormatSpecifier &CS,
                                              const char *Start,
...
bool
language::Core::analyze_format_string::ParseArgPosition(FormatStringHandler &H,
                                               FormatSpecifier &FS,
                                               const char *Start,
                                               const char *&Beg,
                                               const char *E) {
...
bool
language::Core::analyze_format_string::ParseVectorModifier(FormatStringHandler &H,
                                                  FormatSpecifier &FS,
                                                  const char *&I,
                                                  const char *E,
...
bool
language::Core::analyze_format_string::ParseLengthModifier(FormatSpecifier &FS,
                                                  const char *&I,
                                                  const char *E,
                                                  const LangOptions &LO,
                                                  bool IsScanf) {
...
bool language::Core::analyze_format_string::ParseUTF8InvalidSpecifier(
    const char *SpecifierBegin, const char *FmtStrEnd, unsigned &Len) {
  if (SpecifierBegin + 1 >= FmtStrEnd)
    return false;

  const toolchain::UTF8 *SB =
      reinterpret_cast<const toolchain::UTF8 *>(SpecifierBegin + 1);
  const toolchain::UTF8 *SE = reinterpret_cast<const toolchain::UTF8 *>(FmtStrEnd);
  ...
  unsigned NumBytes = toolchain::getNumBytesForUTF8(FirstByte);
  if (NumBytes == 1)
    return false;
  if (SB + NumBytes > SE)
    return false;
...
static language::Core::analyze_format_string::ArgType::MatchKind
matchesSizeTPtrdiffT(ASTContext &C, QualType T, QualType E) {
  using MatchKind = language::Core::analyze_format_string::ArgType::MatchKind;
...
language::Core::analyze_format_string::ArgType::MatchKind
ArgType::matchesType(ASTContext &C, QualType argTy) const {
  ...
  switch (K) {
    case InvalidTy:
      toolchain_unreachable("ArgType must be valid");
  ...
  toolchain_unreachable("Invalid ArgType Kind!");
}
...
QualType ArgType::getRepresentativeType(ASTContext &C) const {
  ...
  switch (K) {
    case InvalidTy:
      toolchain_unreachable("No representative type for Invalid ArgType");
    case UnknownTy:
      toolchain_unreachable("No representative type for Unknown ArgType");
    case AnyCharTy:
      Res = C.CharTy;
      break;
    case SpecificTy:
...
bool FormatSpecifier::hasValidLengthModifier(const TargetInfo &Target,
  ...
  toolchain_unreachable("Invalid LengthModifier Kind!");
}
...
bool FormatSpecifier::hasStandardConversionSpecifier(
  ...
  toolchain_unreachable("Invalid ConversionSpecifier Kind!");
}
