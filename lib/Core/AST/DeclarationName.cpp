...
void DeclarationName::print(raw_ostream &OS,
  ...
  toolchain_unreachable("Unexpected declaration name kind");
}
...
void *DeclarationName::getFETokenInfoSlow() const {
  switch (getNameKind()) {
  case Identifier:
    toolchain_unreachable("case Identifier already handled by getFETokenInfo!");
  ...
  default:
    toolchain_unreachable("DeclarationName has no FETokenInfo!");
  }
}
...
void DeclarationName::setFETokenInfoSlow(void *T) {
  switch (getNameKind()) {
  case Identifier:
    toolchain_unreachable("case Identifier already handled by setFETokenInfo!");
  case CXXConstructorName:
  case CXXDestructorName:
  case CXXConversionFunctionName:
...
DeclarationNameTable::getCXXSpecialName(DeclarationName::NameKind Kind,
  ...
  default:
    toolchain_unreachable("Invalid kind in getCXXSpecialName!");
  }
}
...
bool DeclarationNameInfo::containsUnexpandedParameterPack() const {
  ...
  toolchain_unreachable("All name kinds handled.");
}
...
raw_ostream &language::Core::operator<<(raw_ostream &OS, DeclarationNameInfo DNInfo) {
  LangOptions LO;
