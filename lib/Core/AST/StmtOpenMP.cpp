...
void OMPChildren::setClauses(ArrayRef<OMPClause *> Clauses) {
  ...
  toolchain::copy(Clauses, getTrailingObjects<OMPClause *>());
}
...
void OMPLoopDirective::setCounters(ArrayRef<Expr *> A) {
  ...
  toolchain::copy(A, getCounters().begin());
}
...
void OMPLoopDirective::setFinalsConditions(ArrayRef<Expr *> A) {
  ...
  toolchain::copy(A, getFinalsConditions().begin());
}
...
#include "language/Core/AST/StmtNodes.inc"
  default:
    toolchain_unreachable("Not a loop transformation");
  }
}
