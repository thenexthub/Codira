...
#include "language/Core/ASTMatchers/Dynamic/Parser.h"
...
bool Parser::parseExpressionImpl(VariantValue *Value) {
  ...
  toolchain_unreachable("Unknown token kind.");
}

static toolchain::ManagedStatic<Parser::RegistrySema> DefaultRegistrySema;
