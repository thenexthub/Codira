...
bool isSafePtr(language::Core::CXXRecordDecl *Decl) {
...
bool tryToFindPtrOrigin(
  ...
  while (E) {
    ...
    if (auto *cast = dyn_cast<CastExpr>(E)) {
      ...
      // in checkers. See https://reviews.toolchain.org/D37023 for reference.
      E = cast->getSubExpr();
      continue;
    }
...
bool EnsureFunctionAnalysis::isACallToEnsureFn(const language::Core::Expr *E) const {
