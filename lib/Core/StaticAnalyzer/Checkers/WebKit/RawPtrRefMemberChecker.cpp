...
private:
  ...
  mutable toolchain::DenseSet<const ObjCIvarDecl *> IvarDeclsToIgnore;
...
public:
  ...
  bool shouldSkipDecl(const RecordDecl *RD) const {
    ...
    auto CXXRD = toolchain::dyn_cast_or_null<CXXRecordDecl>(RD);
  ...
  virtual PrintDeclKind printPointer(toolchain::raw_svector_ostream &Os,
                                     const Type *T) const {
...
public:
  ...
  PrintDeclKind printPointer(toolchain::raw_svector_ostream &Os,
