...
public:
  ...
  void checkASTDecl(const TranslationUnitDecl *TUD, AnalysisManager &MGR,
    ...
    struct LocalVisitor : DynamicRecursiveASTVisitor {
      ...
      toolchain::DenseSet<const DeclRefExpr *> DeclRefExprsToIgnore;
      toolchain::DenseSet<const LambdaExpr *> LambdasToIgnore;
      toolchain::DenseSet<const ValueDecl *> ProtectedThisDecls;
      toolchain::DenseSet<const CXXConstructExpr *> ConstructToIgnore;
      ...
      bool TraverseCXXMethodDecl(CXXMethodDecl *CXXMD) override {
        toolchain::SaveAndRestore SavedDecl(ClsType);
        if (CXXMD->isInstance())
