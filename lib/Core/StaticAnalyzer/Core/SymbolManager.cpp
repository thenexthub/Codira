...
LLVM_DUMP_METHOD void SymExpr::dump() const { dumpToStream(toolchain::errs()); }
...
void SymExpr::symbol_iterator::expand() {
  ...
  toolchain_unreachable("unhandled expansion case");
}
...
void SymbolReaper::markLazilyCopied(const language::Core::ento::MemRegion *region) {
