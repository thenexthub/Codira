...
REGISTER_MAP_WITH_PROGRAMSTATE(DynamicTypeMap, const language::Core::ento::MemRegion *,
                               language::Core::ento::DynamicTypeInfo)

/// A set factory of dynamic cast informations.
REGISTER_SET_FACTORY_WITH_PROGRAMSTATE(CastSet, language::Core::ento::DynamicCastInfo)

/// A map from symbols to cast informations.
REGISTER_MAP_WITH_PROGRAMSTATE(DynamicCastMap, const language::Core::ento::MemRegion *,
                               CastSet)

// A map from Class object symbols to the most likely pointed-to type.
REGISTER_MAP_WITH_PROGRAMSTATE(DynamicClassObjectMap, language::Core::ento::SymbolRef,
                               language::Core::ento::DynamicTypeInfo)
