...
bool ConstructionContextLayer::isStrictlyMoreSpecificThan(
  ...
  toolchain_unreachable("The above loop can only be terminated via return!");
}
...
const ConstructionContext *ConstructionContext::createBoundTemporaryFromLayers(
  ...
  case ConstructionContextItem::NewAllocatorKind: {
    toolchain_unreachable("This context does not accept a bound temporary!");
  }
  ...
  case ConstructionContextItem::TemporaryDestructorKind: {
    toolchain_unreachable("Duplicate CXXBindTemporaryExpr in the AST!");
  }
  case ConstructionContextItem::ElidedDestructorKind: {
    toolchain_unreachable("Elided destructor items are not produced by the CFG!");
  }
  case ConstructionContextItem::ElidableConstructorKind: {
    toolchain_unreachable("Materialization is necessary to put temporary into a "
  ...
  toolchain_unreachable("Unexpected construction context with destructor!");
}
...
const ConstructionContext *ConstructionContext::createFromLayers(
  ...
  case ConstructionContextItem::ElidableConstructorKind: {
    toolchain_unreachable("The argument needs to be materialized first!");
  }
  case ConstructionContextItem::LambdaCaptureKind: {
    assert(TopLayer->isLast());
  ...
  toolchain_unreachable("Unexpected construction context!");
}
