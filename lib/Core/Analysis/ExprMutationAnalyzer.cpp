...
//
//===----------------------------------------------------------------------===//
#include "language/Core/Analysis/Analyses/ExprMutationAnalyzer.h"
...
AST_MATCHER_P(LambdaExpr, hasCaptureInit, const Expr *, E) {
  return toolchain::is_contained(Node.capture_inits(), E);
}
...
const Stmt *ExprMutationAnalyzer::Analyzer::findMutationMemoized(
    const Expr *Exp, toolchain::ArrayRef<MutationFinder> Finders,
