...
#include "language/Core/Analysis/FlowSensitive/NoopAnalysis.h"
...
static BoolValue &unpackValue(BoolValue &V, Environment &Env) {
  if (auto *Top = toolchain::dyn_cast<TopBoolValue>(&V)) {
...
private:
  ...
  BoolValue &getLogicOperatorSubExprValue(const Expr &SubExpr) {
    ...
    // (see https://discourse.toolchain.org/t/70775). In this case, visit `SubExpr`
