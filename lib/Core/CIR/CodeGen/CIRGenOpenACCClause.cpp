...
class OpenACCClauseCIREmitter final
  ...
  toolchain::SmallVector<mlir::acc::DeviceType> lastDeviceTypeValues;
  ...
  toolchain::SmallVector<mlir::Operation *> dataOperands;
  ...
  mlir::acc::DeviceType decodeDeviceType(const IdentifierInfo *ii) {
    ...
    return toolchain::StringSwitch<mlir::acc::DeviceType>(ii->getName())
  ...
  mlir::acc::GangArgType decodeGangType(OpenACCGangKind gk) {
    ...
    toolchain_unreachable("unknown gang kind");
  }
  ...
  mlir::ArrayAttr getAsyncOnlyAttr() {
    if constexpr (isOneOfTypes<OpTy, mlir::acc::ParallelOp, mlir::acc::SerialOp,
      ...
      toolchain::SmallVector<mlir::Attribute> devTysTemp;
    ...
    toolchain_unreachable("getting asyncOnly when clause not valid on operation?");
  }
  ...
  void updateDataOperandAsyncValues() {
    ...
    for (mlir::Operation *dataOp : dataOperands) {
      toolchain::TypeSwitch<mlir::Operation *, void>(dataOp)
          ...
          .Default([&](mlir::Operation *) {
            toolchain_unreachable("Not a data operation?");
          });
    }
  }
  ...
  RecipeTy getOrCreateRecipe(ASTContext &astCtx, const Expr *varRef,
    ...
    {
      toolchain::raw_string_ostream stream(recipeName);
    ...
    // Init section.
    {
      toolchain::SmallVector<mlir::Type> argsTys{mainOp.getType()};
      toolchain::SmallVector<mlir::Location> argsLocs{loc};
...
public:
  ...
  void VisitDefaultClause(const OpenACCDefaultClause &clause) {
    ...
    if constexpr (isOneOfTypes<OpTy, mlir::acc::ParallelOp, mlir::acc::SerialOp,
      ...
      toolchain_unreachable("Unknown construct kind in VisitDefaultClause");
    }
  }
  ...
  void VisitNumWorkersClause(const OpenACCNumWorkersClause &clause) {
    if constexpr (isOneOfTypes<OpTy, mlir::acc::ParallelOp,
      ...
      toolchain_unreachable("Unknown construct kind in VisitNumGangsClause");
    }
  }
  ...
  void VisitVectorLengthClause(const OpenACCVectorLengthClause &clause) {
    if constexpr (isOneOfTypes<OpTy, mlir::acc::ParallelOp,
      ...
      toolchain_unreachable("Unknown construct kind in VisitVectorLengthClause");
    }
  }
  ...
  void VisitSelfClause(const OpenACCSelfClause &clause) {
    if constexpr (isOneOfTypes<OpTy, mlir::acc::ParallelOp, mlir::acc::SerialOp,
      ...
      if (clause.isEmptySelfClause()) {
        ...
        toolchain_unreachable("var-list version of self shouldn't get here");
      }
      ...
      toolchain_unreachable("Unknown construct kind in VisitSelfClause");
    }
  }
  ...
  void VisitHostClause(const OpenACCHostClause &clause) {
    if constexpr (isOneOfTypes<OpTy, mlir::acc::UpdateOp>) {
      ...
      toolchain_unreachable("Unknown construct kind in VisitHostClause");
    }
  }
  ...
  void VisitDeviceClause(const OpenACCDeviceClause &clause) {
    if constexpr (isOneOfTypes<OpTy, mlir::acc::UpdateOp>) {
      ...
      toolchain_unreachable("Unknown construct kind in VisitDeviceClause");
    }
  }
  ...
  void VisitIfClause(const OpenACCIfClause &clause) {
    if constexpr (isOneOfTypes<OpTy, mlir::acc::ParallelOp, mlir::acc::SerialOp,
      ...
      toolchain_unreachable("Unknown construct kind in VisitIfClause");
    }
  }
  ...
  void VisitIfPresentClause(const OpenACCIfPresentClause &clause) {
    if constexpr (isOneOfTypes<OpTy, mlir::acc::HostDataOp,
      ...
      toolchain_unreachable("unknown construct kind in VisitIfPresentClause");
    }
  }
  ...
  void VisitDefaultAsyncClause(const OpenACCDefaultAsyncClause &clause) {
    if constexpr (isOneOfTypes<OpTy, mlir::acc::SetOp>) {
      ...
      toolchain_unreachable("set, is only valid device_num constructs");
    }
  }
  ...
  void VisitCollapseClause(const OpenACCCollapseClause &clause) {
    if constexpr (isOneOfTypes<OpTy, mlir::acc::LoopOp>) {
      ...
      toolchain_unreachable("Unknown construct kind in VisitCollapseClause");
    }
  }
  ...
  void VisitTileClause(const OpenACCTileClause &clause) {
    if constexpr (isOneOfTypes<OpTy, mlir::acc::LoopOp>) {
      ...
      toolchain_unreachable("Unknown construct kind in VisitTileClause");
    }
  }
  ...
  void VisitGangClause(const OpenACCGangClause &clause) {
    if constexpr (isOneOfTypes<OpTy, mlir::acc::LoopOp>) {
      if (clause.getNumExprs() == 0) {
        ...
        toolchain::SmallVector<mlir::Value> values;
        toolchain::SmallVector<mlir::acc::GangArgType> argTypes;
        for (unsigned i : toolchain::index_range(0u, clause.getNumExprs())) {
      ...
      toolchain_unreachable("Unknown construct kind in VisitGangClause");
    }
  }
  ...
  void VisitDeleteClause(const OpenACCDeleteClause &clause) {
    if constexpr (isOneOfTypes<OpTy, mlir::acc::ExitDataOp>) {
      ...
      toolchain_unreachable("Unknown construct kind in VisitDeleteClause");
    }
  }
  ...
  void VisitDetachClause(const OpenACCDetachClause &clause) {
    if constexpr (isOneOfTypes<OpTy, mlir::acc::ExitDataOp>) {
      ...
      toolchain_unreachable("Unknown construct kind in VisitDetachClause");
    }
  }
  ...
  void VisitFinalizeClause(const OpenACCFinalizeClause &clause) {
    if constexpr (isOneOfTypes<OpTy, mlir::acc::ExitDataOp>) {
      ...
      toolchain_unreachable("Unknown construct kind in VisitFinalizeClause");
    }
  }
  ...
  void VisitUseDeviceClause(const OpenACCUseDeviceClause &clause) {
    if constexpr (isOneOfTypes<OpTy, mlir::acc::HostDataOp>) {
      ...
      toolchain_unreachable("Unknown construct kind in VisitUseDeviceClause");
    }
  }
  ...
  void VisitNoCreateClause(const OpenACCNoCreateClause &clause) {
    if constexpr (isOneOfTypes<OpTy, mlir::acc::ParallelOp, mlir::acc::SerialOp,
      ...
      toolchain_unreachable("Unknown construct kind in VisitNoCreateClause");
    }
  }
  ...
  void VisitAttachClause(const OpenACCAttachClause &clause) {
    if constexpr (isOneOfTypes<OpTy, mlir::acc::ParallelOp, mlir::acc::SerialOp,
      ...
      toolchain_unreachable("Unknown construct kind in VisitAttachClause");
    }
  }
  ...
  void VisitPrivateClause(const OpenACCPrivateClause &clause) {
    if constexpr (isOneOfTypes<OpTy, mlir::acc::ParallelOp, mlir::acc::SerialOp,
      ...
      for (const auto [varExpr, varRecipe] :
           toolchain::zip_equal(clause.getVarList(), clause.getInitRecipes())) {
        CIRGenFunction::OpenACCDataOperandInfo opInfo =
      ...
      toolchain_unreachable("Unknown construct kind in VisitPrivateClause");
    }
  }
};
