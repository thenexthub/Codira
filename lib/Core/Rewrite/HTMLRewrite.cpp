...
void html::EscapeText(Rewriter &R, FileID FID,
  ...
  toolchain::MemoryBufferRef Buf = R.getSourceMgr().getBufferOrFake(FID);
...
static void SyntaxHighlightImpl(
    ...
    toolchain::function_ref<void(RewriteBuffer &, unsigned, unsigned, const char *,
  ...
  while (Tok.isNot(tok::eof)) {
    ...
    default: break;
    case tok::identifier:
      toolchain_unreachable("tok::identifier in raw lexing mode!");
...
static void HighlightMacrosImpl(
    Rewriter &R, FileID FID, const Preprocessor &PP,
    toolchain::function_ref<void(Rewriter &, SourceLocation, SourceLocation,
