...
class language::Core::syntax::FactoryImpl {
public:
...
syntax::Leaf *language::Core::syntax::createLeaf(syntax::Arena &A,
                                        TokenBufferTokenManager &TBTM,
                                        tok::TokenKind K, StringRef Spelling) {
  auto Tokens =
      FactoryImpl::lexBuffer(TBTM, toolchain::MemoryBuffer::getMemBufferCopy(Spelling))
          .second;
...
syntax::Tree *language::Core::syntax::createTree(
    syntax::Arena &A,
...
syntax::Node *language::Core::syntax::deepCopyExpandingMacros(syntax::Arena &A,
                                                    TokenBufferTokenManager &TBTM,
                                                     const syntax::Node *N) {
...
syntax::EmptyStatement *language::Core::syntax::createEmptyStatement(syntax::Arena &A,  TokenBufferTokenManager &TBTM) {
