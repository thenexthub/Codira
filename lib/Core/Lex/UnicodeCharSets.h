...
//
//===----------------------------------------------------------------------===//
#ifndef LANGUAGE_CORE_LIB_LEX_UNICODECHARSETS_H
#define LANGUAGE_CORE_LIB_LEX_UNICODECHARSETS_H

#include "toolchain/Support/UnicodeCharRanges.h"

// Unicode 15.1 XID_Start
static const toolchain::sys::UnicodeCharRange XIDStartRanges[] = {
...
static const toolchain::sys::UnicodeCharRange XIDContinueRanges[] = {
...
// Math_Start
static const toolchain::sys::UnicodeCharRange
...
static const toolchain::sys::UnicodeCharRange C11AllowedIDCharRanges[] = {
  // 1
...
// C99 Annex D
static const toolchain::sys::UnicodeCharRange C99AllowedIDCharRanges[] = {
  // Latin (1)
  { 0x00AA, 0x00AA },
...
static const toolchain::sys::UnicodeCharRange C11DisallowedInitialIDCharRanges[] = {
...
static const toolchain::sys::UnicodeCharRange C99DisallowedInitialIDCharRanges[] = {
...
static const toolchain::sys::UnicodeCharRange UnicodeWhitespaceCharRanges[] = {
