...
#ifndef LANGUAGE_CORE_LIB_CODEGEN_CGRECORDLAYOUT_H
#define LANGUAGE_CORE_LIB_CODEGEN_CGRECORDLAYOUT_H
...
private:
  ...
  toolchain::StructType *CompleteObjectType;

  /// The LLVM type for the non-virtual part of this record layout;
  /// used when laying it out as a base subobject.
  toolchain::StructType *BaseSubobjectType;

  /// Map from (non-bit-field) struct field to the corresponding toolchain struct
  /// type field no. This info is populated by record builder.
  toolchain::DenseMap<const FieldDecl *, unsigned> FieldInfo;

  /// Map from (bit-field) struct field to the corresponding toolchain struct type
  ...
  toolchain::DenseMap<const CXXRecordDecl *, unsigned> CompleteObjectVirtualBases;
...
public:
  CGRecordLayout(toolchain::StructType *CompleteObjectType,
                 toolchain::StructType *BaseSubobjectType,
  ...
  /// this record.
  toolchain::StructType *getLLVMType() const {
    return CompleteObjectType;
  }

  /// Return the "base subobject" LLVM type associated with
  /// this record.
  toolchain::StructType *getBaseSubobjectLLVMType() const {
  ...
  /// Return toolchain::StructType element number that corresponds to the
  /// field FD.
  ...
  const CGBitFieldInfo &getBitFieldInfo(const FieldDecl *FD) const {
    ...
    toolchain::DenseMap<const FieldDecl *, CGBitFieldInfo>::const_iterator
