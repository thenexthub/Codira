...
#include "toolchain/IR/IntrinsicsAArch64.h"
#include "toolchain/IR/IntrinsicsARM.h"
#include "toolchain/IR/IntrinsicsBPF.h"
...
translateAarch64ToMsvcIntrin(unsigned BuiltinID) {
  ...
  default:
    return std::nullopt;
  case language::Core::AArch64::BI_BitScanForward:
  case language::Core::AArch64::BI_BitScanForward64:
    return MSVCIntrin::_BitScanForward;
  case language::Core::AArch64::BI_BitScanReverse:
  case language::Core::AArch64::BI_BitScanReverse64:
    return MSVCIntrin::_BitScanReverse;
  case language::Core::AArch64::BI_InterlockedAnd64:
    return MSVCIntrin::_InterlockedAnd;
  case language::Core::AArch64::BI_InterlockedExchange64:
    return MSVCIntrin::_InterlockedExchange;
  case language::Core::AArch64::BI_InterlockedExchangeAdd64:
    return MSVCIntrin::_InterlockedExchangeAdd;
  case language::Core::AArch64::BI_InterlockedExchangeSub64:
    return MSVCIntrin::_InterlockedExchangeSub;
  case language::Core::AArch64::BI_InterlockedOr64:
    return MSVCIntrin::_InterlockedOr;
  case language::Core::AArch64::BI_InterlockedXor64:
    return MSVCIntrin::_InterlockedXor;
  case language::Core::AArch64::BI_InterlockedDecrement64:
    return MSVCIntrin::_InterlockedDecrement;
  case language::Core::AArch64::BI_InterlockedIncrement64:
    return MSVCIntrin::_InterlockedIncrement;
  case language::Core::AArch64::BI_InterlockedExchangeAdd8_acq:
  case language::Core::AArch64::BI_InterlockedExchangeAdd16_acq:
  case language::Core::AArch64::BI_InterlockedExchangeAdd_acq:
  case language::Core::AArch64::BI_InterlockedExchangeAdd64_acq:
    return MSVCIntrin::_InterlockedExchangeAdd_acq;
  case language::Core::AArch64::BI_InterlockedExchangeAdd8_rel:
  case language::Core::AArch64::BI_InterlockedExchangeAdd16_rel:
  case language::Core::AArch64::BI_InterlockedExchangeAdd_rel:
  case language::Core::AArch64::BI_InterlockedExchangeAdd64_rel:
    return MSVCIntrin::_InterlockedExchangeAdd_rel;
  case language::Core::AArch64::BI_InterlockedExchangeAdd8_nf:
  case language::Core::AArch64::BI_InterlockedExchangeAdd16_nf:
  case language::Core::AArch64::BI_InterlockedExchangeAdd_nf:
  case language::Core::AArch64::BI_InterlockedExchangeAdd64_nf:
    return MSVCIntrin::_InterlockedExchangeAdd_nf;
  case language::Core::AArch64::BI_InterlockedExchange8_acq:
  case language::Core::AArch64::BI_InterlockedExchange16_acq:
  case language::Core::AArch64::BI_InterlockedExchange_acq:
  case language::Core::AArch64::BI_InterlockedExchange64_acq:
  case language::Core::AArch64::BI_InterlockedExchangePointer_acq:
    return MSVCIntrin::_InterlockedExchange_acq;
  case language::Core::AArch64::BI_InterlockedExchange8_rel:
  case language::Core::AArch64::BI_InterlockedExchange16_rel:
  case language::Core::AArch64::BI_InterlockedExchange_rel:
  case language::Core::AArch64::BI_InterlockedExchange64_rel:
  case language::Core::AArch64::BI_InterlockedExchangePointer_rel:
    return MSVCIntrin::_InterlockedExchange_rel;
  case language::Core::AArch64::BI_InterlockedExchange8_nf:
  case language::Core::AArch64::BI_InterlockedExchange16_nf:
  case language::Core::AArch64::BI_InterlockedExchange_nf:
  case language::Core::AArch64::BI_InterlockedExchange64_nf:
  case language::Core::AArch64::BI_InterlockedExchangePointer_nf:
    return MSVCIntrin::_InterlockedExchange_nf;
  case language::Core::AArch64::BI_InterlockedCompareExchange8_acq:
  case language::Core::AArch64::BI_InterlockedCompareExchange16_acq:
  case language::Core::AArch64::BI_InterlockedCompareExchange_acq:
  case language::Core::AArch64::BI_InterlockedCompareExchange64_acq:
  case language::Core::AArch64::BI_InterlockedCompareExchangePointer_acq:
    return MSVCIntrin::_InterlockedCompareExchange_acq;
  case language::Core::AArch64::BI_InterlockedCompareExchange8_rel:
  case language::Core::AArch64::BI_InterlockedCompareExchange16_rel:
  case language::Core::AArch64::BI_InterlockedCompareExchange_rel:
  case language::Core::AArch64::BI_InterlockedCompareExchange64_rel:
  case language::Core::AArch64::BI_InterlockedCompareExchangePointer_rel:
    return MSVCIntrin::_InterlockedCompareExchange_rel;
  case language::Core::AArch64::BI_InterlockedCompareExchange8_nf:
  case language::Core::AArch64::BI_InterlockedCompareExchange16_nf:
  case language::Core::AArch64::BI_InterlockedCompareExchange_nf:
  case language::Core::AArch64::BI_InterlockedCompareExchange64_nf:
    return MSVCIntrin::_InterlockedCompareExchange_nf;
  case language::Core::AArch64::BI_InterlockedCompareExchange128:
    return MSVCIntrin::_InterlockedCompareExchange128;
  case language::Core::AArch64::BI_InterlockedCompareExchange128_acq:
    return MSVCIntrin::_InterlockedCompareExchange128_acq;
  case language::Core::AArch64::BI_InterlockedCompareExchange128_nf:
    return MSVCIntrin::_InterlockedCompareExchange128_nf;
  case language::Core::AArch64::BI_InterlockedCompareExchange128_rel:
    return MSVCIntrin::_InterlockedCompareExchange128_rel;
  case language::Core::AArch64::BI_InterlockedOr8_acq:
  case language::Core::AArch64::BI_InterlockedOr16_acq:
  case language::Core::AArch64::BI_InterlockedOr_acq:
  case language::Core::AArch64::BI_InterlockedOr64_acq:
    return MSVCIntrin::_InterlockedOr_acq;
  case language::Core::AArch64::BI_InterlockedOr8_rel:
  case language::Core::AArch64::BI_InterlockedOr16_rel:
  case language::Core::AArch64::BI_InterlockedOr_rel:
  case language::Core::AArch64::BI_InterlockedOr64_rel:
    return MSVCIntrin::_InterlockedOr_rel;
  case language::Core::AArch64::BI_InterlockedOr8_nf:
  case language::Core::AArch64::BI_InterlockedOr16_nf:
  case language::Core::AArch64::BI_InterlockedOr_nf:
  case language::Core::AArch64::BI_InterlockedOr64_nf:
    return MSVCIntrin::_InterlockedOr_nf;
  case language::Core::AArch64::BI_InterlockedXor8_acq:
  case language::Core::AArch64::BI_InterlockedXor16_acq:
  case language::Core::AArch64::BI_InterlockedXor_acq:
  case language::Core::AArch64::BI_InterlockedXor64_acq:
    return MSVCIntrin::_InterlockedXor_acq;
  case language::Core::AArch64::BI_InterlockedXor8_rel:
  case language::Core::AArch64::BI_InterlockedXor16_rel:
  case language::Core::AArch64::BI_InterlockedXor_rel:
  case language::Core::AArch64::BI_InterlockedXor64_rel:
    return MSVCIntrin::_InterlockedXor_rel;
  case language::Core::AArch64::BI_InterlockedXor8_nf:
  case language::Core::AArch64::BI_InterlockedXor16_nf:
  case language::Core::AArch64::BI_InterlockedXor_nf:
  case language::Core::AArch64::BI_InterlockedXor64_nf:
    return MSVCIntrin::_InterlockedXor_nf;
  case language::Core::AArch64::BI_InterlockedAnd8_acq:
  case language::Core::AArch64::BI_InterlockedAnd16_acq:
  case language::Core::AArch64::BI_InterlockedAnd_acq:
  case language::Core::AArch64::BI_InterlockedAnd64_acq:
    return MSVCIntrin::_InterlockedAnd_acq;
  case language::Core::AArch64::BI_InterlockedAnd8_rel:
  case language::Core::AArch64::BI_InterlockedAnd16_rel:
  case language::Core::AArch64::BI_InterlockedAnd_rel:
  case language::Core::AArch64::BI_InterlockedAnd64_rel:
    return MSVCIntrin::_InterlockedAnd_rel;
  case language::Core::AArch64::BI_InterlockedAnd8_nf:
  case language::Core::AArch64::BI_InterlockedAnd16_nf:
  case language::Core::AArch64::BI_InterlockedAnd_nf:
  case language::Core::AArch64::BI_InterlockedAnd64_nf:
    return MSVCIntrin::_InterlockedAnd_nf;
  case language::Core::AArch64::BI_InterlockedIncrement16_acq:
  case language::Core::AArch64::BI_InterlockedIncrement_acq:
  case language::Core::AArch64::BI_InterlockedIncrement64_acq:
    return MSVCIntrin::_InterlockedIncrement_acq;
  case language::Core::AArch64::BI_InterlockedIncrement16_rel:
  case language::Core::AArch64::BI_InterlockedIncrement_rel:
  case language::Core::AArch64::BI_InterlockedIncrement64_rel:
    return MSVCIntrin::_InterlockedIncrement_rel;
  case language::Core::AArch64::BI_InterlockedIncrement16_nf:
  case language::Core::AArch64::BI_InterlockedIncrement_nf:
  case language::Core::AArch64::BI_InterlockedIncrement64_nf:
    return MSVCIntrin::_InterlockedIncrement_nf;
  case language::Core::AArch64::BI_InterlockedDecrement16_acq:
  case language::Core::AArch64::BI_InterlockedDecrement_acq:
  case language::Core::AArch64::BI_InterlockedDecrement64_acq:
    return MSVCIntrin::_InterlockedDecrement_acq;
  case language::Core::AArch64::BI_InterlockedDecrement16_rel:
  case language::Core::AArch64::BI_InterlockedDecrement_rel:
  case language::Core::AArch64::BI_InterlockedDecrement64_rel:
    return MSVCIntrin::_InterlockedDecrement_rel;
  case language::Core::AArch64::BI_InterlockedDecrement16_nf:
  case language::Core::AArch64::BI_InterlockedDecrement_nf:
  case language::Core::AArch64::BI_InterlockedDecrement64_nf:
    return MSVCIntrin::_InterlockedDecrement_nf;
  }
  toolchain_unreachable("must return from switch");
}
...
translateArmToMsvcIntrin(unsigned BuiltinID) {
  ...
  default:
    return std::nullopt;
  case language::Core::ARM::BI_BitScanForward:
  case language::Core::ARM::BI_BitScanForward64:
    return MSVCIntrin::_BitScanForward;
  case language::Core::ARM::BI_BitScanReverse:
  case language::Core::ARM::BI_BitScanReverse64:
    return MSVCIntrin::_BitScanReverse;
  case language::Core::ARM::BI_InterlockedAnd64:
    return MSVCIntrin::_InterlockedAnd;
  case language::Core::ARM::BI_InterlockedExchange64:
    return MSVCIntrin::_InterlockedExchange;
  case language::Core::ARM::BI_InterlockedExchangeAdd64:
    return MSVCIntrin::_InterlockedExchangeAdd;
  case language::Core::ARM::BI_InterlockedExchangeSub64:
    return MSVCIntrin::_InterlockedExchangeSub;
  case language::Core::ARM::BI_InterlockedOr64:
    return MSVCIntrin::_InterlockedOr;
  case language::Core::ARM::BI_InterlockedXor64:
    return MSVCIntrin::_InterlockedXor;
  case language::Core::ARM::BI_InterlockedDecrement64:
    return MSVCIntrin::_InterlockedDecrement;
  case language::Core::ARM::BI_InterlockedIncrement64:
    return MSVCIntrin::_InterlockedIncrement;
  case language::Core::ARM::BI_InterlockedExchangeAdd8_acq:
  case language::Core::ARM::BI_InterlockedExchangeAdd16_acq:
  case language::Core::ARM::BI_InterlockedExchangeAdd_acq:
  case language::Core::ARM::BI_InterlockedExchangeAdd64_acq:
    return MSVCIntrin::_InterlockedExchangeAdd_acq;
  case language::Core::ARM::BI_InterlockedExchangeAdd8_rel:
  case language::Core::ARM::BI_InterlockedExchangeAdd16_rel:
  case language::Core::ARM::BI_InterlockedExchangeAdd_rel:
  case language::Core::ARM::BI_InterlockedExchangeAdd64_rel:
    return MSVCIntrin::_InterlockedExchangeAdd_rel;
  case language::Core::ARM::BI_InterlockedExchangeAdd8_nf:
  case language::Core::ARM::BI_InterlockedExchangeAdd16_nf:
  case language::Core::ARM::BI_InterlockedExchangeAdd_nf:
  case language::Core::ARM::BI_InterlockedExchangeAdd64_nf:
    return MSVCIntrin::_InterlockedExchangeAdd_nf;
  case language::Core::ARM::BI_InterlockedExchange8_acq:
  case language::Core::ARM::BI_InterlockedExchange16_acq:
  case language::Core::ARM::BI_InterlockedExchange_acq:
  case language::Core::ARM::BI_InterlockedExchange64_acq:
  case language::Core::ARM::BI_InterlockedExchangePointer_acq:
    return MSVCIntrin::_InterlockedExchange_acq;
  case language::Core::ARM::BI_InterlockedExchange8_rel:
  case language::Core::ARM::BI_InterlockedExchange16_rel:
  case language::Core::ARM::BI_InterlockedExchange_rel:
  case language::Core::ARM::BI_InterlockedExchange64_rel:
  case language::Core::ARM::BI_InterlockedExchangePointer_rel:
    return MSVCIntrin::_InterlockedExchange_rel;
  case language::Core::ARM::BI_InterlockedExchange8_nf:
  case language::Core::ARM::BI_InterlockedExchange16_nf:
  case language::Core::ARM::BI_InterlockedExchange_nf:
  case language::Core::ARM::BI_InterlockedExchange64_nf:
  case language::Core::ARM::BI_InterlockedExchangePointer_nf:
    return MSVCIntrin::_InterlockedExchange_nf;
  case language::Core::ARM::BI_InterlockedCompareExchange8_acq:
  case language::Core::ARM::BI_InterlockedCompareExchange16_acq:
  case language::Core::ARM::BI_InterlockedCompareExchange_acq:
  case language::Core::ARM::BI_InterlockedCompareExchange64_acq:
  case language::Core::ARM::BI_InterlockedCompareExchangePointer_acq:
    return MSVCIntrin::_InterlockedCompareExchange_acq;
  case language::Core::ARM::BI_InterlockedCompareExchange8_rel:
  case language::Core::ARM::BI_InterlockedCompareExchange16_rel:
  case language::Core::ARM::BI_InterlockedCompareExchange_rel:
  case language::Core::ARM::BI_InterlockedCompareExchange64_rel:
  case language::Core::ARM::BI_InterlockedCompareExchangePointer_rel:
    return MSVCIntrin::_InterlockedCompareExchange_rel;
  case language::Core::ARM::BI_InterlockedCompareExchange8_nf:
  case language::Core::ARM::BI_InterlockedCompareExchange16_nf:
  case language::Core::ARM::BI_InterlockedCompareExchange_nf:
  case language::Core::ARM::BI_InterlockedCompareExchange64_nf:
    return MSVCIntrin::_InterlockedCompareExchange_nf;
  case language::Core::ARM::BI_InterlockedOr8_acq:
  case language::Core::ARM::BI_InterlockedOr16_acq:
  case language::Core::ARM::BI_InterlockedOr_acq:
  case language::Core::ARM::BI_InterlockedOr64_acq:
    return MSVCIntrin::_InterlockedOr_acq;
  case language::Core::ARM::BI_InterlockedOr8_rel:
  case language::Core::ARM::BI_InterlockedOr16_rel:
  case language::Core::ARM::BI_InterlockedOr_rel:
  case language::Core::ARM::BI_InterlockedOr64_rel:
    return MSVCIntrin::_InterlockedOr_rel;
  case language::Core::ARM::BI_InterlockedOr8_nf:
  case language::Core::ARM::BI_InterlockedOr16_nf:
  case language::Core::ARM::BI_InterlockedOr_nf:
  case language::Core::ARM::BI_InterlockedOr64_nf:
    return MSVCIntrin::_InterlockedOr_nf;
  case language::Core::ARM::BI_InterlockedXor8_acq:
  case language::Core::ARM::BI_InterlockedXor16_acq:
  case language::Core::ARM::BI_InterlockedXor_acq:
  case language::Core::ARM::BI_InterlockedXor64_acq:
    return MSVCIntrin::_InterlockedXor_acq;
  case language::Core::ARM::BI_InterlockedXor8_rel:
  case language::Core::ARM::BI_InterlockedXor16_rel:
  case language::Core::ARM::BI_InterlockedXor_rel:
  case language::Core::ARM::BI_InterlockedXor64_rel:
    return MSVCIntrin::_InterlockedXor_rel;
  case language::Core::ARM::BI_InterlockedXor8_nf:
  case language::Core::ARM::BI_InterlockedXor16_nf:
  case language::Core::ARM::BI_InterlockedXor_nf:
  case language::Core::ARM::BI_InterlockedXor64_nf:
    return MSVCIntrin::_InterlockedXor_nf;
  case language::Core::ARM::BI_InterlockedAnd8_acq:
  case language::Core::ARM::BI_InterlockedAnd16_acq:
  case language::Core::ARM::BI_InterlockedAnd_acq:
  case language::Core::ARM::BI_InterlockedAnd64_acq:
    return MSVCIntrin::_InterlockedAnd_acq;
  case language::Core::ARM::BI_InterlockedAnd8_rel:
  case language::Core::ARM::BI_InterlockedAnd16_rel:
  case language::Core::ARM::BI_InterlockedAnd_rel:
  case language::Core::ARM::BI_InterlockedAnd64_rel:
    return MSVCIntrin::_InterlockedAnd_rel;
  case language::Core::ARM::BI_InterlockedAnd8_nf:
  case language::Core::ARM::BI_InterlockedAnd16_nf:
  case language::Core::ARM::BI_InterlockedAnd_nf:
  case language::Core::ARM::BI_InterlockedAnd64_nf:
    return MSVCIntrin::_InterlockedAnd_nf;
  case language::Core::ARM::BI_InterlockedIncrement16_acq:
  case language::Core::ARM::BI_InterlockedIncrement_acq:
  case language::Core::ARM::BI_InterlockedIncrement64_acq:
    return MSVCIntrin::_InterlockedIncrement_acq;
  case language::Core::ARM::BI_InterlockedIncrement16_rel:
  case language::Core::ARM::BI_InterlockedIncrement_rel:
  case language::Core::ARM::BI_InterlockedIncrement64_rel:
    return MSVCIntrin::_InterlockedIncrement_rel;
  case language::Core::ARM::BI_InterlockedIncrement16_nf:
  case language::Core::ARM::BI_InterlockedIncrement_nf:
  case language::Core::ARM::BI_InterlockedIncrement64_nf:
    return MSVCIntrin::_InterlockedIncrement_nf;
  case language::Core::ARM::BI_InterlockedDecrement16_acq:
  case language::Core::ARM::BI_InterlockedDecrement_acq:
  case language::Core::ARM::BI_InterlockedDecrement64_acq:
    return MSVCIntrin::_InterlockedDecrement_acq;
  case language::Core::ARM::BI_InterlockedDecrement16_rel:
  case language::Core::ARM::BI_InterlockedDecrement_rel:
  case language::Core::ARM::BI_InterlockedDecrement64_rel:
    return MSVCIntrin::_InterlockedDecrement_rel;
  case language::Core::ARM::BI_InterlockedDecrement16_nf:
  case language::Core::ARM::BI_InterlockedDecrement_nf:
  case language::Core::ARM::BI_InterlockedDecrement64_nf:
    return MSVCIntrin::_InterlockedDecrement_nf;
  }
  toolchain_unreachable("must return from switch");
}
...
static toolchain::FixedVectorType *GetNeonType(CodeGenFunction *CGF,
  ...
  case NeonTypeFlags::MFloat8:
    return toolchain::FixedVectorType::get(CGF->Int8Ty, V1Ty ? 1 : (8 << IsQuad));
  case NeonTypeFlags::Int16:
  case NeonTypeFlags::Poly16:
    return toolchain::FixedVectorType::get(CGF->Int16Ty, V1Ty ? 1 : (4 << IsQuad));
  case NeonTypeFlags::BFloat16:
    if (AllowBFloatArgsAndRet)
      return toolchain::FixedVectorType::get(CGF->BFloatTy, V1Ty ? 1 : (4 << IsQuad));
    else
      return toolchain::FixedVectorType::get(CGF->Int16Ty, V1Ty ? 1 : (4 << IsQuad));
  case NeonTypeFlags::Float16:
    if (HasLegalHalfType)
      return toolchain::FixedVectorType::get(CGF->HalfTy, V1Ty ? 1 : (4 << IsQuad));
    else
      return toolchain::FixedVectorType::get(CGF->Int16Ty, V1Ty ? 1 : (4 << IsQuad));
  case NeonTypeFlags::Int32:
    return toolchain::FixedVectorType::get(CGF->Int32Ty, V1Ty ? 1 : (2 << IsQuad));
  case NeonTypeFlags::Int64:
  case NeonTypeFlags::Poly64:
    return toolchain::FixedVectorType::get(CGF->Int64Ty, V1Ty ? 1 : (1 << IsQuad));
  case NeonTypeFlags::Poly128:
    // FIXME: i128 and f128 doesn't get fully support in Clang and toolchain.
    // There is a lot of i128 and f128 API missing.
    // so we use v16i8 to represent poly128 and get pattern matched.
    return toolchain::FixedVectorType::get(CGF->Int8Ty, 16);
  case NeonTypeFlags::Float32:
    return toolchain::FixedVectorType::get(CGF->FloatTy, V1Ty ? 1 : (2 << IsQuad));
  case NeonTypeFlags::Float64:
    return toolchain::FixedVectorType::get(CGF->DoubleTy, V1Ty ? 1 : (1 << IsQuad));
  }
  toolchain_unreachable("Unknown vector element type!");
}

static toolchain::VectorType *GetFloatNeonType(CodeGenFunction *CGF,
                                          NeonTypeFlags IntTypeFlags) {
  int IsQuad = IntTypeFlags.isQuad();
  switch (IntTypeFlags.getEltType()) {
  case NeonTypeFlags::Int16:
    return toolchain::FixedVectorType::get(CGF->HalfTy, (4 << IsQuad));
  case NeonTypeFlags::Int32:
    return toolchain::FixedVectorType::get(CGF->FloatTy, (2 << IsQuad));
  case NeonTypeFlags::Int64:
    return toolchain::FixedVectorType::get(CGF->DoubleTy, (1 << IsQuad));
  default:
    toolchain_unreachable("Type can't be converted to floating-point!");
  }
}

Value *CodeGenFunction::EmitNeonSplat(Value *V, Constant *C,
                                      const ElementCount &Count) {
  Value *SV = toolchain::ConstantVector::getSplat(Count, C);
  return Builder.CreateShuffleVector(V, V, SV, "lane");
}

Value *CodeGenFunction::EmitNeonSplat(Value *V, Constant *C) {
  ElementCount EC = cast<toolchain::VectorType>(V->getType())->getElementCount();
...
toolchain::Value *CodeGenFunction::EmitFP8NeonFDOTCall(
    unsigned IID, bool ExtendLaneArg, toolchain::Type *RetTy,
    SmallVectorImpl<toolchain::Value *> &Ops, const CallExpr *E, const char *name) {

  const unsigned ElemCount = Ops[0]->getType()->getPrimitiveSizeInBits() /
                             RetTy->getPrimitiveSizeInBits();
  toolchain::Type *Tys[] = {toolchain::FixedVectorType::get(RetTy, ElemCount),
                       Ops[1]->getType()};
  if (ExtendLaneArg) {
    auto *VT = toolchain::FixedVectorType::get(Int8Ty, 16);
...
toolchain::Value *CodeGenFunction::EmitFP8NeonFMLACall(
    unsigned IID, bool ExtendLaneArg, toolchain::Type *RetTy,
    SmallVectorImpl<toolchain::Value *> &Ops, const CallExpr *E, const char *name) {
  ...
  const unsigned ElemCount = Ops[0]->getType()->getPrimitiveSizeInBits() /
                             RetTy->getPrimitiveSizeInBits();
  return EmitFP8NeonCall(IID, {toolchain::FixedVectorType::get(RetTy, ElemCount)},
                         Ops, E, name);
}

Value *CodeGenFunction::EmitNeonShiftVector(Value *V, toolchain::Type *Ty,
                                            bool neg) {
  int SV = cast<ConstantInt>(V)->getSExtValue();
  return ConstantInt::get(Ty, neg ? -SV : SV);
}

Value *CodeGenFunction::EmitFP8NeonCvtCall(unsigned IID, toolchain::Type *Ty0,
                                           toolchain::Type *Ty1, bool Extract,
                                           SmallVectorImpl<toolchain::Value *> &Ops,
                                           const CallExpr *E,
                                           const char *name) {
  toolchain::Type *Tys[] = {Ty0, Ty1};
  if (Extract) {
    // Op[0] is mfloat8x16_t, but the intrinsic converts only the lower part of
    // the vector.
    Tys[1] = toolchain::FixedVectorType::get(Int8Ty, 8);
...
Value *CodeGenFunction::EmitNeonRShiftImm(Value *Vec, Value *Shift,
                                          toolchain::Type *Ty, bool usgn,
                                          const char *name) {
  toolchain::VectorType *VTy = cast<toolchain::VectorType>(Ty);
  ...
  if (ShiftAmt == EltSize) {
    if (usgn) {
      ...
      return toolchain::ConstantAggregateZero::get(VTy);
    } else {
...
#include "language/Core/Basic/arm_sve_builtin_cg.inc"
#include "language/Core/Basic/BuiltinsAArch64NeonSVEBridge_cg.def"
...
#include "language/Core/Basic/arm_sme_builtin_cg.inc"
...
#ifndef NDEBUG
  if (!MapProvenSorted) {
    assert(toolchain::is_sorted(IntrinsicMap));
    MapProvenSorted = true;
  }
#endif

  const ARMVectorIntrinsicInfo *Builtin =
      toolchain::lower_bound(IntrinsicMap, BuiltinID);
...
Function *CodeGenFunction::LookupNeonLLVMIntrinsic(unsigned IntrinsicID,
  ...
  // Return type.
  SmallVector<toolchain::Type *, 3> Tys;
  if (Modifier & AddRetType) {
    toolchain::Type *Ty = ConvertType(E->getCallReturnType(getContext()));
    if (Modifier & VectorizeRetType)
      Ty = toolchain::FixedVectorType::get(
  ...
  if (Modifier & VectorizeArgTypes) {
    ...
    ArgType = toolchain::FixedVectorType::get(ArgType, Elts);
  }
...
static Value *EmitCommonNeonSISDBuiltinExpr(
  ...
  toolchain::Type *ArgTy = CGF.ConvertType(Arg->getType());
  ...
  for (Function::const_arg_iterator ai = F->arg_begin(), ae = F->arg_end();
       ai != ae; ++ai, ++j) {
    toolchain::Type *ArgTy = ai->getType();
    ...
    Ops[j] = CGF.Builder.CreateTruncOrBitCast(
        Ops[j], cast<toolchain::VectorType>(ArgTy)->getElementType());
    Ops[j] =
        CGF.Builder.CreateInsertElement(PoisonValue::get(ArgTy), Ops[j], C0);
  }

  Value *Result = CGF.EmitNeonCall(F, Ops, s);
  toolchain::Type *ResultType = CGF.ConvertType(E->getType());
...
Value *CodeGenFunction::EmitCommonNeonBuiltinExpr(
    ...
    SmallVectorImpl<toolchain::Value *> &Ops, Address PtrOp0, Address PtrOp1,
    toolchain::Triple::ArchType Arch) {
  // Get the last argument, which specifies the vector type.
  const Expr *Arg = E->getArg(E->getNumArgs() - 1);
  std::optional<toolchain::APSInt> NeonTypeConst =
  ...
  case NEON::BI__builtin_neon_vaddq_v: {
    toolchain::Type *VTy = toolchain::FixedVectorType::get(Int8Ty, Quad ? 16 : 8);
    Ops[0] = Builder.CreateBitCast(Ops[0], VTy);
  ...
  case NEON::BI__builtin_neon_vaddhn_v: {
    toolchain::FixedVectorType *SrcTy =
        toolchain::FixedVectorType::getExtendedElementVectorType(VTy);
  ...
  case NEON::BI__builtin_neon_vcagtq_v: {
    ...
    default: toolchain_unreachable("unexpected type");
    case 32:
      Ty = FloatTy;
      break;
    case 64:
    ...
    auto *VecFlt = toolchain::FixedVectorType::get(Ty, VTy->getNumElements());
    toolchain::Type *Tys[] = { VTy, VecFlt };
  ...
  case NEON::BI__builtin_neon_vcvtq_n_f16_u16: {
    toolchain::Type *Tys[2] = { GetFloatNeonType(this, Type), Ty };
  ...
  case NEON::BI__builtin_neon_vcvtq_n_u64_v: {
    toolchain::Type *Tys[2] = { Ty, GetFloatNeonType(this, Type) };
    Function *F = CGM.getIntrinsic(LLVMIntrinsic, Tys);
    return EmitNeonCall(F, Ops, "vcvt_n");
  }
  ...
  case NEON::BI__builtin_neon_vcvtx_f32_v: {
    toolchain::Type *Tys[2] = { VTy->getTruncatedElementVectorType(VTy), Ty};
    return EmitNeonCall(CGM.getIntrinsic(LLVMIntrinsic, Tys), Ops, NameHint);
  ...
  case NEON::BI__builtin_neon_vld1q_v: {
    toolchain::Type *Tys[] = {Ty, Int8PtrTy};
  ...
  case NEON::BI__builtin_neon_vld1q_x4_v: {
    toolchain::Type *Tys[2] = {VTy, UnqualPtrTy};
    Function *F = CGM.getIntrinsic(LLVMIntrinsic, Tys);
  ...
  case NEON::BI__builtin_neon_vld1q_dup_v: {
    ...
    toolchain::Constant *CI = ConstantInt::get(SizeTy, 0);
  ...
  case NEON::BI__builtin_neon_vmovl_v: {
    toolchain::FixedVectorType *DTy =
        toolchain::FixedVectorType::getTruncatedElementVectorType(VTy);
  ...
  case NEON::BI__builtin_neon_vpadalq_v: {
    ...
    toolchain::Type *EltTy =
      toolchain::IntegerType::get(getLLVMContext(), EltBits / 2);
    auto *NarrowTy =
        toolchain::FixedVectorType::get(EltTy, VTy->getNumElements() * 2);
    toolchain::Type *Tys[2] = { Ty, NarrowTy };
  ...
  case NEON::BI__builtin_neon_vpaddlq_v: {
    // The source operand type has twice as many elements of half the size.
    unsigned EltBits = VTy->getElementType()->getPrimitiveSizeInBits();
    toolchain::Type *EltTy = toolchain::IntegerType::get(getLLVMContext(), EltBits / 2);
    auto *NarrowTy =
        toolchain::FixedVectorType::get(EltTy, VTy->getNumElements() * 2);
    toolchain::Type *Tys[2] = { Ty, NarrowTy };
  ...
  case NEON::BI__builtin_neon_vqrdmulh_lane_v: {
    auto *RTy = cast<toolchain::FixedVectorType>(Ty);
    if (BuiltinID == NEON::BI__builtin_neon_vqdmulhq_lane_v ||
        BuiltinID == NEON::BI__builtin_neon_vqrdmulhq_lane_v)
      RTy = toolchain::FixedVectorType::get(RTy->getElementType(),
                                       RTy->getNumElements() * 2);
    toolchain::Type *Tys[2] = {
  ...
  case NEON::BI__builtin_neon_vst4q_lane_v: {
    toolchain::Type *Tys[] = {Int8PtrTy, Ty};
    Ops.push_back(getAlignmentValue32(PtrOp0));
  ...
  case NEON::BI__builtin_neon_vst1q_x4_v: {
    ...
    if (Arch == toolchain::Triple::aarch64 || Arch == toolchain::Triple::aarch64_be ||
        Arch == toolchain::Triple::aarch64_32) {
      toolchain::Type *Tys[2] = {VTy, UnqualPtrTy};
      std::rotate(Ops.begin(), Ops.begin() + 1, Ops.end());
      return EmitNeonCall(CGM.getIntrinsic(LLVMIntrinsic, Tys), Ops, "");
    }
    toolchain::Type *Tys[2] = {UnqualPtrTy, VTy};
    return EmitNeonCall(CGM.getIntrinsic(LLVMIntrinsic, Tys), Ops, "");
  }
  ...
  case NEON::BI__builtin_neon_vdotq_u32: {
    auto *InputTy =
        toolchain::FixedVectorType::get(Int8Ty, Ty->getPrimitiveSizeInBits() / 8);
    toolchain::Type *Tys[2] = { Ty, InputTy };
    return EmitNeonCall(CGM.getIntrinsic(Int, Tys), Ops, "vdot");
  }
  case NEON::BI__builtin_neon_vfmlal_low_f16:
  case NEON::BI__builtin_neon_vfmlalq_low_f16: {
    auto *InputTy =
        toolchain::FixedVectorType::get(HalfTy, Ty->getPrimitiveSizeInBits() / 16);
    toolchain::Type *Tys[2] = { Ty, InputTy };
  ...
  case NEON::BI__builtin_neon_vbfdotq_f32: {
    toolchain::Type *InputTy =
        toolchain::FixedVectorType::get(BFloatTy, Ty->getPrimitiveSizeInBits() / 16);
    toolchain::Type *Tys[2] = { Ty, InputTy };
    return EmitNeonCall(CGM.getIntrinsic(Int, Tys), Ops, "vbfdot");
  }
  case NEON::BI__builtin_neon___a32_vcvt_bf16_f32: {
    toolchain::Type *Tys[1] = { Ty };
    Function *F = CGM.getIntrinsic(Int, Tys);
...
Value *
CodeGenFunction::EmitAArch64CompareBuiltinExpr(Value *Op, toolchain::Type *Ty,
...
static Value *packTBLDVectorList(CodeGenFunction &CGF, ArrayRef<Value *> Ops,
                                 ...
                                 toolchain::Type *ResTy, unsigned IntID,
                                 const char *Name) {
  ...
  SmallVector<int, 16> Indices;
  auto *TblTy = cast<toolchain::FixedVectorType>(Ops[0]->getType());
...
Value *CodeGenFunction::GetValueForARMHint(unsigned BuiltinID) {
  ...
  default:
    return nullptr;
  case language::Core::ARM::BI__builtin_arm_nop:
    Value = 0;
    break;
  case language::Core::ARM::BI__builtin_arm_yield:
  case language::Core::ARM::BI__yield:
    Value = 1;
    break;
  case language::Core::ARM::BI__builtin_arm_wfe:
  case language::Core::ARM::BI__wfe:
    Value = 2;
    break;
  case language::Core::ARM::BI__builtin_arm_wfi:
  case language::Core::ARM::BI__wfi:
    Value = 3;
    break;
  case language::Core::ARM::BI__builtin_arm_sev:
  case language::Core::ARM::BI__sev:
    Value = 4;
    break;
  case language::Core::ARM::BI__builtin_arm_sevl:
  case language::Core::ARM::BI__sevl:
    Value = 5;
    break;
  }

  return Builder.CreateCall(CGM.getIntrinsic(Intrinsic::arm_hint),
                            toolchain::ConstantInt::get(Int32Ty, Value));
}
...
static Value *EmitSpecialRegisterBuiltin(CodeGenFunction &CGF,
  ...
  if (SysReg.empty()) {
    ...
    SysReg = cast<language::Core::StringLiteral>(SysRegStrExpr)->getString();
  }

  toolchain::Metadata *Ops[] = { toolchain::MDString::get(Context, SysReg) };
  toolchain::MDNode *RegName = toolchain::MDNode::get(Context, Ops);
  toolchain::Value *Metadata = toolchain::MetadataAsValue::get(Context, RegName);

  toolchain::Type *Types[] = { RegisterType };
  ...
  if (AccessKind != Write) {
    ...
    toolchain::Function *F = CGM.getIntrinsic(
        AccessKind == VolatileRead ? Intrinsic::read_volatile_register
                                   : Intrinsic::read_register,
        Types);
    toolchain::Value *Call = Builder.CreateCall(F, Metadata);
  ...
  toolchain::Function *F = CGM.getIntrinsic(Intrinsic::write_register, Types);
  toolchain::Value *ArgValue = CGF.EmitScalarExpr(E->getArg(1));
  if (MixedTypes) {
...
static bool HasExtraNeonArgument(unsigned BuiltinID) {
  ...
  case language::Core::ARM::BI_MoveToCoprocessor:
  case language::Core::ARM::BI_MoveToCoprocessor2:
    return false;
  }
  return true;
}
...
Value *CodeGenFunction::EmitARMBuiltinExpr(unsigned BuiltinID,
  ...
  if (BuiltinID == language::Core::ARM::BI__emit) {
    bool IsThumb = getTarget().getTriple().getArch() == toolchain::Triple::thumb;
    toolchain::FunctionType *FTy =
        toolchain::FunctionType::get(VoidTy, /*Variadic=*/false);

    Expr::EvalResult Result;
    if (!E->getArg(0)->EvaluateAsInt(Result, CGM.getContext()))
      toolchain_unreachable("Sema will ensure that the parameter is constant");

    toolchain::APSInt Value = Result.Val.getInt();
    uint64_t ZExtValue = Value.zextOrTrunc(IsThumb ? 16 : 32).getZExtValue();

    toolchain::InlineAsm *Emit =
  ...
  if (BuiltinID == language::Core::ARM::BI__builtin_arm_dbg) {
    Value *Option = EmitScalarExpr(E->getArg(0));
    return Builder.CreateCall(CGM.getIntrinsic(Intrinsic::arm_dbg), Option);
  }

  if (BuiltinID == language::Core::ARM::BI__builtin_arm_prefetch) {
    Value *Address = EmitScalarExpr(E->getArg(0));
    Value *RW      = EmitScalarExpr(E->getArg(1));
    Value *IsData  = EmitScalarExpr(E->getArg(2));

    // Locality is not supported on ARM target
    Value *Locality = toolchain::ConstantInt::get(Int32Ty, 3);

    Function *F = CGM.getIntrinsic(Intrinsic::prefetch, Address->getType());
    return Builder.CreateCall(F, {Address, RW, Locality, IsData});
  }

  if (BuiltinID == language::Core::ARM::BI__builtin_arm_rbit) {
    toolchain::Value *Arg = EmitScalarExpr(E->getArg(0));
    return Builder.CreateCall(
        CGM.getIntrinsic(Intrinsic::bitreverse, Arg->getType()), Arg, "rbit");
  }

  if (BuiltinID == language::Core::ARM::BI__builtin_arm_clz ||
      BuiltinID == language::Core::ARM::BI__builtin_arm_clz64) {
    toolchain::Value *Arg = EmitScalarExpr(E->getArg(0));
    Function *F = CGM.getIntrinsic(Intrinsic::ctlz, Arg->getType());
    Value *Res = Builder.CreateCall(F, {Arg, Builder.getInt1(false)});
    if (BuiltinID == language::Core::ARM::BI__builtin_arm_clz64)
      Res = Builder.CreateTrunc(Res, Builder.getInt32Ty());
    return Res;
  }


  if (BuiltinID == language::Core::ARM::BI__builtin_arm_cls) {
    toolchain::Value *Arg = EmitScalarExpr(E->getArg(0));
    return Builder.CreateCall(CGM.getIntrinsic(Intrinsic::arm_cls), Arg, "cls");
  }
  if (BuiltinID == language::Core::ARM::BI__builtin_arm_cls64) {
    toolchain::Value *Arg = EmitScalarExpr(E->getArg(0));
    return Builder.CreateCall(CGM.getIntrinsic(Intrinsic::arm_cls64), Arg,
                              "cls");
  }

  if (BuiltinID == language::Core::ARM::BI__clear_cache) {
    assert(E->getNumArgs() == 2 && "__clear_cache takes 2 arguments");
    const FunctionDecl *FD = E->getDirectCallee();
    Value *Ops[2];
    for (unsigned i = 0; i < 2; i++)
      Ops[i] = EmitScalarExpr(E->getArg(i));
    toolchain::Type *Ty = CGM.getTypes().ConvertType(FD->getType());
    toolchain::FunctionType *FTy = cast<toolchain::FunctionType>(Ty);
    StringRef Name = FD->getName();
    return EmitNounwindRuntimeCall(CGM.CreateRuntimeFunction(FTy, Name), Ops);
  }

  if (BuiltinID == language::Core::ARM::BI__builtin_arm_mcrr ||
      BuiltinID == language::Core::ARM::BI__builtin_arm_mcrr2) {
    Function *F;

    switch (BuiltinID) {
    default: toolchain_unreachable("unexpected builtin");
    case language::Core::ARM::BI__builtin_arm_mcrr:
      F = CGM.getIntrinsic(Intrinsic::arm_mcrr);
      break;
    case language::Core::ARM::BI__builtin_arm_mcrr2:
    ...
    Value *C1 = toolchain::ConstantInt::get(Int64Ty, 32);
  ...
  if (BuiltinID == language::Core::ARM::BI__builtin_arm_mrrc ||
      BuiltinID == language::Core::ARM::BI__builtin_arm_mrrc2) {
    Function *F;

    switch (BuiltinID) {
    default: toolchain_unreachable("unexpected builtin");
    case language::Core::ARM::BI__builtin_arm_mrrc:
      F = CGM.getIntrinsic(Intrinsic::arm_mrrc);
      break;
    case language::Core::ARM::BI__builtin_arm_mrrc2:
    ...
    Value *ShiftCast = toolchain::ConstantInt::get(Int64Ty, 32);
  ...
  if (BuiltinID == language::Core::ARM::BI__builtin_arm_ldrexd ||
      ((BuiltinID == language::Core::ARM::BI__builtin_arm_ldrex ||
        BuiltinID == language::Core::ARM::BI__builtin_arm_ldaex) &&
       getContext().getTypeSize(E->getType()) == 64) ||
      BuiltinID == language::Core::ARM::BI__ldrexd) {
    Function *F;

    switch (BuiltinID) {
    default: toolchain_unreachable("unexpected builtin");
    case language::Core::ARM::BI__builtin_arm_ldaex:
      F = CGM.getIntrinsic(Intrinsic::arm_ldaexd);
      break;
    case language::Core::ARM::BI__builtin_arm_ldrexd:
    case language::Core::ARM::BI__builtin_arm_ldrex:
    case language::Core::ARM::BI__ldrexd:
    ...
    Value *ShiftCst = toolchain::ConstantInt::get(Int64Ty, 32);
    Val = Builder.CreateShl(Val0, ShiftCst, "shl", true /* nuw */);
    Val = Builder.CreateOr(Val, Val1);
    return Builder.CreateBitCast(Val, ConvertType(E->getType()));
  }

  if (BuiltinID == language::Core::ARM::BI__builtin_arm_ldrex ||
      BuiltinID == language::Core::ARM::BI__builtin_arm_ldaex) {
    Value *LoadAddr = EmitScalarExpr(E->getArg(0));

    QualType Ty = E->getType();
    toolchain::Type *RealResTy = ConvertType(Ty);
    toolchain::Type *IntTy =
        toolchain::IntegerType::get(getLLVMContext(), getContext().getTypeSize(Ty));

    Function *F = CGM.getIntrinsic(
        BuiltinID == language::Core::ARM::BI__builtin_arm_ldaex ? Intrinsic::arm_ldaex
                                                       : Intrinsic::arm_ldrex,
        UnqualPtrTy);
    ...
    if (RealResTy->isPointerTy())
      ...
      toolchain::Type *IntResTy = toolchain::IntegerType::get(
  ...
  if (BuiltinID == language::Core::ARM::BI__builtin_arm_strexd ||
      ((BuiltinID == language::Core::ARM::BI__builtin_arm_stlex ||
        BuiltinID == language::Core::ARM::BI__builtin_arm_strex) &&
       getContext().getTypeSize(E->getArg(0)->getType()) == 64)) {
    Function *F = CGM.getIntrinsic(
        BuiltinID == language::Core::ARM::BI__builtin_arm_stlex ? Intrinsic::arm_stlexd
                                                       : Intrinsic::arm_strexd);
    toolchain::Type *STy = toolchain::StructType::get(Int32Ty, Int32Ty);
  ...
  if (BuiltinID == language::Core::ARM::BI__builtin_arm_strex ||
      BuiltinID == language::Core::ARM::BI__builtin_arm_stlex) {
    Value *StoreVal = EmitScalarExpr(E->getArg(0));
    Value *StoreAddr = EmitScalarExpr(E->getArg(1));

    QualType Ty = E->getArg(0)->getType();
    toolchain::Type *StoreTy =
        toolchain::IntegerType::get(getLLVMContext(), getContext().getTypeSize(Ty));

    if (StoreVal->getType()->isPointerTy())
      StoreVal = Builder.CreatePtrToInt(StoreVal, Int32Ty);
    else {
      toolchain::Type *IntTy = toolchain::IntegerType::get(
          getLLVMContext(),
    ...
    Function *F = CGM.getIntrinsic(
        BuiltinID == language::Core::ARM::BI__builtin_arm_stlex ? Intrinsic::arm_stlex
                                                       : Intrinsic::arm_strex,
        StoreAddr->getType());
  ...
  if (BuiltinID == language::Core::ARM::BI__builtin_arm_clrex) {
  ...
  switch (BuiltinID) {
  case language::Core::ARM::BI__builtin_arm_crc32b:
    CRCIntrinsicID = Intrinsic::arm_crc32b; break;
  case language::Core::ARM::BI__builtin_arm_crc32cb:
    CRCIntrinsicID = Intrinsic::arm_crc32cb; break;
  case language::Core::ARM::BI__builtin_arm_crc32h:
    CRCIntrinsicID = Intrinsic::arm_crc32h; break;
  case language::Core::ARM::BI__builtin_arm_crc32ch:
    CRCIntrinsicID = Intrinsic::arm_crc32ch; break;
  case language::Core::ARM::BI__builtin_arm_crc32w:
  case language::Core::ARM::BI__builtin_arm_crc32d:
    CRCIntrinsicID = Intrinsic::arm_crc32w; break;
  case language::Core::ARM::BI__builtin_arm_crc32cw:
  case language::Core::ARM::BI__builtin_arm_crc32cd:
  ...
  if (CRCIntrinsicID != Intrinsic::not_intrinsic) {
    ...
    if (BuiltinID == language::Core::ARM::BI__builtin_arm_crc32d ||
        BuiltinID == language::Core::ARM::BI__builtin_arm_crc32cd) {
      Value *C1 = toolchain::ConstantInt::get(Int64Ty, 32);
  ...
  if (BuiltinID == language::Core::ARM::BI__builtin_arm_rsr ||
      BuiltinID == language::Core::ARM::BI__builtin_arm_rsr64 ||
      BuiltinID == language::Core::ARM::BI__builtin_arm_rsrp ||
      BuiltinID == language::Core::ARM::BI__builtin_arm_wsr ||
      BuiltinID == language::Core::ARM::BI__builtin_arm_wsr64 ||
      BuiltinID == language::Core::ARM::BI__builtin_arm_wsrp) {
    ...
    bool IsPointerBuiltin = BuiltinID == language::Core::ARM::BI__builtin_arm_rsrp ||
                            BuiltinID == language::Core::ARM::BI__builtin_arm_wsrp;

    bool Is64Bit = BuiltinID == language::Core::ARM::BI__builtin_arm_rsr64 ||
                   BuiltinID == language::Core::ARM::BI__builtin_arm_wsr64;
  ...
  if (BuiltinID == ARM::BI__builtin_sponentry) {
    toolchain::Function *F = CGM.getIntrinsic(Intrinsic::sponentry, AllocaInt8PtrTy);
    return Builder.CreateCall(F);
  }
  ...
  auto It = toolchain::find_if(NEONEquivalentIntrinsicMap, [BuiltinID](auto &P) {
  ...
  case NEON::BI__builtin_neon_vrndns_f32: {
    ...
    toolchain::Type *Tys[] = {Arg->getType()};
  ...
  case language::Core::ARM::BI_MoveToCoprocessor:
  case language::Core::ARM::BI_MoveToCoprocessor2: {
    Function *F = CGM.getIntrinsic(BuiltinID == language::Core::ARM::BI_MoveToCoprocessor
                                       ? Intrinsic::arm_mcr
                                       : Intrinsic::arm_mcr2);
  ...
  assert(HasExtraArg);
  const Expr *Arg = E->getArg(E->getNumArgs()-1);
  std::optional<toolchain::APSInt> Result =
      Arg->getIntegerConstantExpr(getContext());
  if (!Result)
    return nullptr;

  if (BuiltinID == language::Core::ARM::BI__builtin_arm_vcvtr_f ||
      BuiltinID == language::Core::ARM::BI__builtin_arm_vcvtr_d) {
  ...
  case NEON::BI__builtin_neon_vld1q_lane_v:
    ...
    if (VTy->getElementType()->isIntegerTy(64)) {
      ...
      Value *SV = toolchain::ConstantVector::get(ConstantInt::get(Int32Ty, 1-Lane));
      Ops[1] = Builder.CreateShuffleVector(Ops[1], Ops[1], SV);
      // Load the value as a one-element vector.
      Ty = toolchain::FixedVectorType::get(VTy->getElementType(), 1);
      toolchain::Type *Tys[] = {Ty, Int8PtrTy};
  ...
  case NEON::BI__builtin_neon_vst1q_lane_v:
    ...
    if (VTy->getElementType()->isIntegerTy(64)) {
      Ops[1] = Builder.CreateBitCast(Ops[1], Ty);
      Value *SV = toolchain::ConstantVector::get(cast<toolchain::Constant>(Ops[2]));
      Ops[1] = Builder.CreateShuffleVector(Ops[1], Ops[1], SV);
      Ops[2] = getAlignmentValue32(PtrOp0);
      toolchain::Type *Tys[] = {Int8PtrTy, Ops[1]->getType()};
...
static toolchain::Value *SignOrZeroExtend(CGBuilderTy &Builder, toolchain::Value *V,
                                     toolchain::Type *T, bool Unsigned) {
...
static toolchain::Value *MVEImmediateShr(CGBuilderTy &Builder, toolchain::Value *V,
  ...
  unsigned LaneBits = cast<toolchain::VectorType>(V->getType())
                          ->getElementType()
  ...
  if (Shift == LaneBits) {
    ...
    if (Unsigned)
      return toolchain::Constant::getNullValue(V->getType());
    else
      --Shift;
  }
...
static toolchain::Value *ARMMVEVectorSplat(CGBuilderTy &Builder, toolchain::Value *V) {
...
static toolchain::Value *ARMMVEVectorReinterpret(CGBuilderTy &Builder,
                                            CodeGenFunction *CGF,
                                            toolchain::Value *V,
                                            toolchain::Type *DestType) {
...
static toolchain::Value *VectorUnzip(CGBuilderTy &Builder, toolchain::Value *V, bool Odd) {
  // Make a shufflevector that extracts every other element of a vector (evens
  // or odds, as desired).
  SmallVector<int, 16> Indices;
  unsigned InputElements =
      cast<toolchain::FixedVectorType>(V->getType())->getNumElements();
  for (unsigned i = 0; i < InputElements; i += 2)
    Indices.push_back(i + Odd);
  return Builder.CreateShuffleVector(V, Indices);
}

static toolchain::Value *VectorZip(CGBuilderTy &Builder, toolchain::Value *V0,
                              toolchain::Value *V1) {
  ...
  SmallVector<int, 16> Indices;
  unsigned InputElements =
      cast<toolchain::FixedVectorType>(V0->getType())->getNumElements();
...
static toolchain::Value *ARMMVEConstantSplat(CGBuilderTy &Builder, toolchain::Type *VT) {
  ...
  toolchain::Type *T = cast<toolchain::VectorType>(VT)->getElementType();
  unsigned LaneBits = T->getPrimitiveSizeInBits();
  uint32_t Value = HighBit << (LaneBits - 1);
  if (OtherBits)
    Value |= (1UL << (LaneBits - 1)) - 1;
  toolchain::Value *Lane = toolchain::ConstantInt::get(T, Value);
  return ARMMVEVectorSplat(Builder, Lane);
}

static toolchain::Value *ARMMVEVectorElementReverse(CGBuilderTy &Builder,
                                               toolchain::Value *V,
...
Value *CodeGenFunction::EmitARMMVEBuiltinExpr(unsigned BuiltinID,
  ...
  switch (BuiltinID) {
    #include "language/Core/Basic/arm_mve_builtin_cg.inc"
  ...
  case CustomCodeGen::VLD24: {
    toolchain::SmallVector<Value *, 4> Ops;
    toolchain::SmallVector<toolchain::Type *, 4> Tys;
  ...
  case CustomCodeGen::VST24: {
    ...
    for (unsigned i = 0; i < NumVectors; i++) {
      Ops.push_back(toolchain::ConstantInt::get(Int32Ty, i));
  ...
  toolchain_unreachable("unknown custom codegen type.");
}
...
Value *CodeGenFunction::EmitARMCDEBuiltinExpr(unsigned BuiltinID,
  ...
  default:
    return nullptr;
#include "language/Core/Basic/arm_cde_builtin_cg.inc"
  }
}
...
static Value *EmitAArch64TblBuiltinExpr(CodeGenFunction &CGF, unsigned BuiltinID,
  ...
  // Determine the type of this overloaded NEON intrinsic.
  NeonTypeFlags Type = Result->getZExtValue();
  toolchain::FixedVectorType *Ty = GetNeonType(&CGF, Type);
  if (!Ty)
    return nullptr;
  ...
  case NEON::BI__builtin_neon_vtbx1_v: {
    ...
    toolchain::Constant *EightV = ConstantInt::get(Ty, 8);
  ...
  case NEON::BI__builtin_neon_vtbx3_v: {
    ...
    toolchain::Constant *TwentyFourV = ConstantInt::get(Ty, 24);
...
Value *CodeGenFunction::vectorWrapScalar16(Value *Op) {
  auto *VTy = toolchain::FixedVectorType::get(Int16Ty, 4);
...
/// operand.
toolchain::Type *CodeGenFunction::SVEBuiltinMemEltTy(const SVETypeFlags &TypeFlags) {
  ...
  toolchain_unreachable("Unknown MemEltType");
}

toolchain::Type *CodeGenFunction::getEltType(const SVETypeFlags &TypeFlags) {
  switch (TypeFlags.getEltType()) {
  default:
    toolchain_unreachable("Invalid SVETypeFlag!");
...
// Return the toolchain predicate vector type corresponding to the specified element
// TypeFlags.
toolchain::ScalableVectorType *
CodeGenFunction::getSVEPredType(const SVETypeFlags &TypeFlags) {
  switch (TypeFlags.getEltType()) {
  default: toolchain_unreachable("Unhandled SVETypeFlag!");

  case SVETypeFlags::EltTyInt8:
    return toolchain::ScalableVectorType::get(Builder.getInt1Ty(), 16);
  case SVETypeFlags::EltTyInt16:
    return toolchain::ScalableVectorType::get(Builder.getInt1Ty(), 8);
  case SVETypeFlags::EltTyInt32:
    return toolchain::ScalableVectorType::get(Builder.getInt1Ty(), 4);
  case SVETypeFlags::EltTyInt64:
    return toolchain::ScalableVectorType::get(Builder.getInt1Ty(), 2);
...
// Return the toolchain vector type corresponding to the specified element TypeFlags.
toolchain::ScalableVectorType *
CodeGenFunction::getSVEType(const SVETypeFlags &TypeFlags) {
  ...
  case SVETypeFlags::EltTyInt8:
    return toolchain::ScalableVectorType::get(Builder.getInt8Ty(), 16);
  case SVETypeFlags::EltTyInt16:
    return toolchain::ScalableVectorType::get(Builder.getInt16Ty(), 8);
  case SVETypeFlags::EltTyInt32:
    return toolchain::ScalableVectorType::get(Builder.getInt32Ty(), 4);
  case SVETypeFlags::EltTyInt64:
    return toolchain::ScalableVectorType::get(Builder.getInt64Ty(), 2);

  case SVETypeFlags::EltTyMFloat8:
    return toolchain::ScalableVectorType::get(Builder.getInt8Ty(), 16);
  case SVETypeFlags::EltTyFloat16:
    return toolchain::ScalableVectorType::get(Builder.getHalfTy(), 8);
  case SVETypeFlags::EltTyBFloat16:
    return toolchain::ScalableVectorType::get(Builder.getBFloatTy(), 8);
  case SVETypeFlags::EltTyFloat32:
    return toolchain::ScalableVectorType::get(Builder.getFloatTy(), 4);
  case SVETypeFlags::EltTyFloat64:
    return toolchain::ScalableVectorType::get(Builder.getDoubleTy(), 2);
...
static toolchain::ScalableVectorType *getSVEVectorForElementType(toolchain::Type *EltTy) {
  unsigned NumElts = SVEBitsPerBlock / EltTy->getScalarSizeInBits();
  return toolchain::ScalableVectorType::get(EltTy, NumElts);
}

// Reinterpret the input predicate so that it can be used to correctly isolate
// the elements of the specified datatype.
Value *CodeGenFunction::EmitSVEPredicateCast(Value *Pred,
                                             toolchain::ScalableVectorType *VTy) {

  if (isa<TargetExtType>(Pred->getType()) &&
      cast<TargetExtType>(Pred->getType())->getName() == "aarch64.svcount")
    return Pred;

  auto *RTy = toolchain::VectorType::get(IntegerType::get(getLLVMContext(), 1), VTy);
  if (Pred->getType() == RTy)
    return Pred;

  unsigned IntID;
  toolchain::Type *IntrinsicTy;
  switch (VTy->getMinNumElements()) {
  default:
    toolchain_unreachable("unsupported element count!");
  case 1:
  case 2:
  case 4:
  case 8:
...
Value *CodeGenFunction::EmitSVEPredicateTupleCast(Value *PredTuple,
  ...
  Value *Ret = toolchain::PoisonValue::get(Ty);
  for (unsigned I = 0; I < Ty->getNumElements(); ++I) {
    Value *Pred = Builder.CreateExtractValue(PredTuple, I);
    Pred = EmitSVEPredicateCast(
        Pred, cast<toolchain::ScalableVectorType>(Ty->getTypeAtIndex(I)));
...
Value *CodeGenFunction::EmitSVEGatherLoad(const SVETypeFlags &TypeFlags,
  ...
  auto *OverloadedTy =
      toolchain::ScalableVectorType::get(SVEBuiltinMemEltTy(TypeFlags), ResultTy);
  ...
  Ops[0] = EmitSVEPredicateCast(
      Ops[0], cast<toolchain::ScalableVectorType>(F->getArg(0)->getType()));
...
Value *CodeGenFunction::EmitSVEScatterStore(const SVETypeFlags &TypeFlags,
  ...
  auto *OverloadedTy =
      toolchain::ScalableVectorType::get(SVEBuiltinMemEltTy(TypeFlags), SrcDataTy);
  ...
  Ops[1] = EmitSVEPredicateCast(
      Ops[1], cast<toolchain::ScalableVectorType>(F->getArg(1)->getType()));
...
Value *CodeGenFunction::EmitSVEGatherPrefetch(const SVETypeFlags &TypeFlags,
  ...
  auto *OverloadedTy = dyn_cast<toolchain::ScalableVectorType>(Ops[1]->getType());
  if (!OverloadedTy)
    OverloadedTy = cast<toolchain::ScalableVectorType>(Ops[2]->getType());
  ...
  if (Ops[1]->getType()->isVectorTy()) {
    if (Ops.size() == 3) {
      ...
      toolchain::Type *MemEltTy = SVEBuiltinMemEltTy(TypeFlags);
...
Value *CodeGenFunction::EmitSVEStructLoad(const SVETypeFlags &TypeFlags,
                                          SmallVectorImpl<Value*> &Ops,
                                          unsigned IntID) {
  toolchain::ScalableVectorType *VTy = getSVEType(TypeFlags);
...
Value *CodeGenFunction::EmitSVEStructStore(const SVETypeFlags &TypeFlags,
  ...
  case Intrinsic::aarch64_sve_st4q:
    ...
    break;
  default:
    toolchain_unreachable("unknown intrinsic!");
  }
  ...
  // The toolchain.aarch64.sve.st2/3/4 intrinsics take legal part vectors, so we
  // need to break up the tuple vector.
  SmallVector<toolchain::Value*, 5> Operands;
...
Value *CodeGenFunction::EmitSVEPMull(const SVETypeFlags &TypeFlags,
  ...
  toolchain::ScalableVectorType *Ty = getSVEType(TypeFlags);
...
Value *CodeGenFunction::EmitSVEMovl(const SVETypeFlags &TypeFlags,
  ...
  toolchain::Type *OverloadedTy = getSVEType(TypeFlags);
...
Value *CodeGenFunction::EmitSVEPrefetchLoad(const SVETypeFlags &TypeFlags,
  ...
  auto *MemoryTy = toolchain::ScalableVectorType::get(MemEltTy, VectorTy);
...
Value *CodeGenFunction::EmitSVEMaskedLoad(const CallExpr *E,
                                          toolchain::Type *ReturnTy,
                                          SmallVectorImpl<Value *> &Ops,
                                          unsigned IntrinsicID,
                                          bool IsZExtReturn) {
  QualType LangPTy = E->getArg(1)->getType();
  toolchain::Type *MemEltTy = CGM.getTypes().ConvertType(
  ...
  if (MemEltTy->isVectorTy()) {
    ...
    MemEltTy = cast<toolchain::VectorType>(MemEltTy)->getElementType();
  }

  // The vector type that is returned may be different from the
  // eventual type loaded from memory.
  auto VectorTy = cast<toolchain::ScalableVectorType>(ReturnTy);
  toolchain::ScalableVectorType *MemoryTy = nullptr;
  toolchain::ScalableVectorType *PredTy = nullptr;
  bool IsQuadLoad = false;
  switch (IntrinsicID) {
  case Intrinsic::aarch64_sve_ld1uwq:
  case Intrinsic::aarch64_sve_ld1udq:
    MemoryTy = toolchain::ScalableVectorType::get(MemEltTy, 1);
    PredTy = toolchain::ScalableVectorType::get(
        toolchain::Type::getInt1Ty(getLLVMContext()), 1);
    IsQuadLoad = true;
    break;
  default:
    MemoryTy = toolchain::ScalableVectorType::get(MemEltTy, VectorTy);
    PredTy = MemoryTy;
    break;
  }
  ...
  auto *Load =
      cast<toolchain::Instruction>(Builder.CreateCall(F, {Predicate, BasePtr}));
...
Value *CodeGenFunction::EmitSVEMaskedStore(const CallExpr *E,
  ...
  auto VectorTy = cast<toolchain::ScalableVectorType>(Ops.back()->getType());
  auto MemoryTy = toolchain::ScalableVectorType::get(MemEltTy, VectorTy);
  ...
  case Intrinsic::aarch64_sve_st1dq:
    AddrMemoryTy = toolchain::ScalableVectorType::get(MemEltTy, 1);
    PredTy =
        toolchain::ScalableVectorType::get(IntegerType::get(getLLVMContext(), 1), 1);
    IsQuadStore = true;
    break;
  default:
    break;
  ...
  auto *Store =
      cast<toolchain::Instruction>(Builder.CreateCall(F, {Val, Predicate, BasePtr}));
  auto TBAAInfo = CGM.getTBAAAccessInfo(LangPTy->getPointeeType());
...
Value *CodeGenFunction::EmitSMELd1St1(const SVETypeFlags &TypeFlags,
  ...
  toolchain::Value *BasePtr = Ops[3];
  toolchain::Value *RealSlice = Ops[1];
  ...
  if (Ops.size() == 5) {
    ...
    toolchain::Value *StreamingVectorLengthCall =
        Builder.CreateCall(StreamingVectorLength);
    toolchain::Value *Mulvl =
...
Value *CodeGenFunction::EmitSMEZero(const SVETypeFlags &TypeFlags,
  ...
  if (Ops.size() == 0)
    Ops.push_back(toolchain::ConstantInt::get(Int32Ty, 255));
  Function *F = CGM.getIntrinsic(IntID, {});
  return Builder.CreateCall(F, Ops);
}
...
// Limit the usage of scalable toolchain IR generated by the ACLE by using the
// sve dup.x intrinsic instead of IRBuilder::CreateVectorSplat.
Value *CodeGenFunction::EmitSVEDupX(Value *Scalar, toolchain::Type *Ty) {
  return Builder.CreateVectorSplat(
      cast<toolchain::VectorType>(Ty)->getElementCount(), Scalar);
}

Value *CodeGenFunction::EmitSVEDupX(Value *Scalar) {
  if (auto *Ty = Scalar->getType(); Ty->isVectorTy()) {
#ifndef NDEBUG
    auto *VecTy = cast<toolchain::VectorType>(Ty);
...
Value *CodeGenFunction::EmitSVEReinterpret(Value *Val, toolchain::Type *Ty) {
  ...
  if (auto *StructTy = dyn_cast<StructType>(Ty)) {
    Value *Tuple = toolchain::PoisonValue::get(Ty);
...
static void InsertExplicitZeroOperand(CGBuilderTy &Builder, toolchain::Type *Ty,
                                      SmallVectorImpl<Value *> &Ops) {
  auto *SplatZero = Constant::getNullValue(Ty);
  Ops.insert(Ops.begin(), SplatZero);
}

static void InsertExplicitUndefOperand(CGBuilderTy &Builder, toolchain::Type *Ty,
                                       SmallVectorImpl<Value *> &Ops) {
  auto *SplatUndef = UndefValue::get(Ty);
  Ops.insert(Ops.begin(), SplatUndef);
}

SmallVector<toolchain::Type *, 2>
CodeGenFunction::getSVEOverloadTypes(const SVETypeFlags &TypeFlags,
  ...
  toolchain::Type *DefaultType = getSVEType(TypeFlags);
...
void CodeGenFunction::GetAArch64SVEProcessedOperands(
  ...
  for (unsigned i = 0, e = E->getNumArgs(); i != e; i++) {
    ...
    if (IsICE) {
      ...
      // Immediates for SVE toolchain intrinsics are always 32bit.  We can safely
      ...
      *Result = Result->extOrTrunc(32);
      Ops.push_back(toolchain::ConstantInt::get(getLLVMContext(), *Result));
      continue;
    }
...
Value *CodeGenFunction::EmitAArch64SVEBuiltinExpr(unsigned BuiltinID,
                                                  const CallExpr *E) {
  toolchain::Type *Ty = ConvertType(E->getType());
  ...
  if (TypeFlags.isLoad())
    ...
    for (Value *&Op : Ops)
      if (auto PredTy = dyn_cast<toolchain::VectorType>(Op->getType()))
    ...
    if (TypeFlags.getMergeType() == SVETypeFlags::MergeZero) {
      toolchain::Type *OpndTy = Ops[1]->getType();
    ...
    if (auto PredTy = dyn_cast<toolchain::ScalableVectorType>(Ty))
      return EmitSVEPredicateCast(Call, PredTy);
    if (auto PredTupleTy = dyn_cast<toolchain::StructType>(Ty))
  ...
  case SVE::BI__builtin_sve_svreinterpret_b: {
    auto SVCountTy =
        toolchain::TargetExtType::get(getLLVMContext(), "aarch64.svcount");
  ...
  case SVE::BI__builtin_sve_svpsel_lane_c64: {
    ...
    toolchain::Value *Ops0 =
        IsSVCount ? Builder.CreateCall(CastFromSVCountF, Ops[0]) : Ops[0];
    toolchain::Value *Ops1 = EmitSVEPredicateCast(Ops[1], OverloadedTy);
    toolchain::Value *PSel = Builder.CreateCall(F, {Ops0, Ops1, Ops[2]});
  ...
  case SVE::BI__builtin_sve_svdup_n_b64: {
    ...
    toolchain::ScalableVectorType *OverloadedTy = getSVEType(TypeFlags);
    Value *Dup = EmitSVEDupX(CmpNE, OverloadedTy);
    return EmitSVEPredicateCast(Dup, cast<toolchain::ScalableVectorType>(Ty));
  }
  ...
  case SVE::BI__builtin_sve_svdupq_n_s32: {
    ...
    bool IsBoolTy =
        cast<toolchain::VectorType>(Ty)->getElementType()->isIntegerTy(1);
    ...
    return EmitSVEPredicateCast(Call, cast<toolchain::ScalableVectorType>(Ty));
  }
...
Value *readX18AsPtr(CodeGenFunction &CGF) {
  ...
  toolchain::Metadata *Ops[] = {toolchain::MDString::get(Context, "x18")};
  toolchain::MDNode *RegName = toolchain::MDNode::get(Context, Ops);
  toolchain::Value *Metadata = toolchain::MetadataAsValue::get(Context, RegName);
  toolchain::Function *F =
      CGF.CGM.getIntrinsic(Intrinsic::read_register, {CGF.Int64Ty});
  toolchain::Value *X18 = CGF.Builder.CreateCall(F, Metadata);
...
Value *CodeGenFunction::EmitAArch64BuiltinExpr(unsigned BuiltinID,
                                               const CallExpr *E,
                                               toolchain::Triple::ArchType Arch) {
  if (BuiltinID >= language::Core::AArch64::FirstSVEBuiltin &&
      BuiltinID <= language::Core::AArch64::LastSVEBuiltin)
    return EmitAArch64SVEBuiltinExpr(BuiltinID, E);

  if (BuiltinID >= language::Core::AArch64::FirstSMEBuiltin &&
      BuiltinID <= language::Core::AArch64::LastSMEBuiltin)
  ...
  switch (BuiltinID) {
  default: break;
  case language::Core::AArch64::BI__builtin_arm_nop:
    HintID = 0;
    break;
  case language::Core::AArch64::BI__builtin_arm_yield:
  case language::Core::AArch64::BI__yield:
    HintID = 1;
    break;
  case language::Core::AArch64::BI__builtin_arm_wfe:
  case language::Core::AArch64::BI__wfe:
    HintID = 2;
    break;
  case language::Core::AArch64::BI__builtin_arm_wfi:
  case language::Core::AArch64::BI__wfi:
    HintID = 3;
    break;
  case language::Core::AArch64::BI__builtin_arm_sev:
  case language::Core::AArch64::BI__sev:
    HintID = 4;
    break;
  case language::Core::AArch64::BI__builtin_arm_sevl:
  case language::Core::AArch64::BI__sevl:
    HintID = 5;
    break;
  }
  ...
  if (HintID != static_cast<unsigned>(-1)) {
    ...
    return Builder.CreateCall(F, toolchain::ConstantInt::get(Int32Ty, HintID));
  }

  if (BuiltinID == language::Core::AArch64::BI__builtin_arm_trap) {
    Function *F = CGM.getIntrinsic(Intrinsic::aarch64_break);
    toolchain::Value *Arg = EmitScalarExpr(E->getArg(0));
    return Builder.CreateCall(F, Builder.CreateZExt(Arg, CGM.Int32Ty));
  }

  if (BuiltinID == language::Core::AArch64::BI__builtin_arm_get_sme_state) {
    ...
    CallInst *CI = EmitRuntimeCall(CGM.CreateRuntimeFunction(
        toolchain::FunctionType::get(StructType::get(CGM.Int64Ty, CGM.Int64Ty), {},
                                false),
        "__arm_sme_state"));
  ...
  if (BuiltinID == language::Core::AArch64::BI__builtin_arm_rbit) {
  ...
  if (BuiltinID == language::Core::AArch64::BI__builtin_arm_rbit64) {
  ...
  if (BuiltinID == language::Core::AArch64::BI__builtin_arm_clz ||
      BuiltinID == language::Core::AArch64::BI__builtin_arm_clz64) {
    toolchain::Value *Arg = EmitScalarExpr(E->getArg(0));
    Function *F = CGM.getIntrinsic(Intrinsic::ctlz, Arg->getType());
    Value *Res = Builder.CreateCall(F, {Arg, Builder.getInt1(false)});
    if (BuiltinID == language::Core::AArch64::BI__builtin_arm_clz64)
      Res = Builder.CreateTrunc(Res, Builder.getInt32Ty());
    return Res;
  }

  if (BuiltinID == language::Core::AArch64::BI__builtin_arm_cls) {
    toolchain::Value *Arg = EmitScalarExpr(E->getArg(0));
    return Builder.CreateCall(CGM.getIntrinsic(Intrinsic::aarch64_cls), Arg,
                              "cls");
  }
  if (BuiltinID == language::Core::AArch64::BI__builtin_arm_cls64) {
    toolchain::Value *Arg = EmitScalarExpr(E->getArg(0));
    return Builder.CreateCall(CGM.getIntrinsic(Intrinsic::aarch64_cls64), Arg,
                              "cls");
  }

  if (BuiltinID == language::Core::AArch64::BI__builtin_arm_rint32zf ||
      BuiltinID == language::Core::AArch64::BI__builtin_arm_rint32z) {
    toolchain::Value *Arg = EmitScalarExpr(E->getArg(0));
    toolchain::Type *Ty = Arg->getType();
    return Builder.CreateCall(CGM.getIntrinsic(Intrinsic::aarch64_frint32z, Ty),
                              Arg, "frint32z");
  }

  if (BuiltinID == language::Core::AArch64::BI__builtin_arm_rint64zf ||
      BuiltinID == language::Core::AArch64::BI__builtin_arm_rint64z) {
    toolchain::Value *Arg = EmitScalarExpr(E->getArg(0));
    toolchain::Type *Ty = Arg->getType();
  ...
  if (BuiltinID == language::Core::AArch64::BI__builtin_arm_rint32xf ||
      BuiltinID == language::Core::AArch64::BI__builtin_arm_rint32x) {
    toolchain::Value *Arg = EmitScalarExpr(E->getArg(0));
    toolchain::Type *Ty = Arg->getType();
  ...
  if (BuiltinID == language::Core::AArch64::BI__builtin_arm_rint64xf ||
      BuiltinID == language::Core::AArch64::BI__builtin_arm_rint64x) {
    toolchain::Value *Arg = EmitScalarExpr(E->getArg(0));
    toolchain::Type *Ty = Arg->getType();
  ...
  if (BuiltinID == language::Core::AArch64::BI__builtin_arm_jcvt) {
    assert((getContext().getTypeSize(E->getType()) == 32) &&
  ...
  if (BuiltinID == language::Core::AArch64::BI__builtin_arm_ld64b ||
      BuiltinID == language::Core::AArch64::BI__builtin_arm_st64b ||
      BuiltinID == language::Core::AArch64::BI__builtin_arm_st64bv ||
      BuiltinID == language::Core::AArch64::BI__builtin_arm_st64bv0) {
    toolchain::Value *MemAddr = EmitScalarExpr(E->getArg(0));
    toolchain::Value *ValPtr = EmitScalarExpr(E->getArg(1));
    ...
    if (BuiltinID == language::Core::AArch64::BI__builtin_arm_ld64b) {
      ...
      toolchain::Value *Val = Builder.CreateCall(F, MemAddr);
      toolchain::Value *ToRet;
      for (size_t i = 0; i < 8; i++) {
        toolchain::Value *ValOffsetPtr =
      ...
      SmallVector<toolchain::Value *, 9> Args;
      ...
      auto Intr = (BuiltinID == language::Core::AArch64::BI__builtin_arm_st64b
  ...
  if (BuiltinID == language::Core::AArch64::BI__builtin_arm_rndr ||
      BuiltinID == language::Core::AArch64::BI__builtin_arm_rndrrs) {

    auto Intr = (BuiltinID == language::Core::AArch64::BI__builtin_arm_rndr
                     ? Intrinsic::aarch64_rndr
                     : Intrinsic::aarch64_rndrrs);
    Function *F = CGM.getIntrinsic(Intr);
    toolchain::Value *Val = Builder.CreateCall(F);
  ...
  if (BuiltinID == language::Core::AArch64::BI__clear_cache) {
    assert(E->getNumArgs() == 2 && "__clear_cache takes 2 arguments");
    const FunctionDecl *FD = E->getDirectCallee();
    Value *Ops[2];
    for (unsigned i = 0; i < 2; i++)
  ...
  if ((BuiltinID == language::Core::AArch64::BI__builtin_arm_ldrex ||
       BuiltinID == language::Core::AArch64::BI__builtin_arm_ldaex) &&
      getContext().getTypeSize(E->getType()) == 128) {
    Function *F =
        CGM.getIntrinsic(BuiltinID == language::Core::AArch64::BI__builtin_arm_ldaex
    ...
    Value *Val0 = Builder.CreateExtractValue(Val, 1);
    Value *Val1 = Builder.CreateExtractValue(Val, 0);
    toolchain::Type *Int128Ty = toolchain::IntegerType::get(getLLVMContext(), 128);
    Val0 = Builder.CreateZExt(Val0, Int128Ty);
    Val1 = Builder.CreateZExt(Val1, Int128Ty);

    Value *ShiftCst = toolchain::ConstantInt::get(Int128Ty, 64);
    Val = Builder.CreateShl(Val0, ShiftCst, "shl", true /* nuw */);
    Val = Builder.CreateOr(Val, Val1);
    return Builder.CreateBitCast(Val, ConvertType(E->getType()));
  } else if (BuiltinID == language::Core::AArch64::BI__builtin_arm_ldrex ||
             BuiltinID == language::Core::AArch64::BI__builtin_arm_ldaex) {
    Value *LoadAddr = EmitScalarExpr(E->getArg(0));
  ...
  if ((BuiltinID == language::Core::AArch64::BI__builtin_arm_strex ||
       BuiltinID == language::Core::AArch64::BI__builtin_arm_stlex) &&
      getContext().getTypeSize(E->getArg(0)->getType()) == 128) {
    Function *F =
        CGM.getIntrinsic(BuiltinID == language::Core::AArch64::BI__builtin_arm_stlex
                             ? Intrinsic::aarch64_stlxp
                             : Intrinsic::aarch64_stxp);
    toolchain::Type *STy = toolchain::StructType::get(Int64Ty, Int64Ty);

    Address Tmp = CreateMemTemp(E->getArg(0)->getType());
    EmitAnyExprToMem(E->getArg(0), Tmp, Qualifiers(), /*init*/ true);

    Tmp = Tmp.withElementType(STy);
    toolchain::Value *Val = Builder.CreateLoad(Tmp);
  ...
  if (BuiltinID == language::Core::AArch64::BI__getReg) {
    Expr::EvalResult Result;
    if (!E->getArg(0)->EvaluateAsInt(Result, CGM.getContext()))
      toolchain_unreachable("Sema will ensure that the parameter is constant");
    ...
    toolchain::Metadata *Ops[] = {toolchain::MDString::get(Context, Reg)};
    toolchain::MDNode *RegName = toolchain::MDNode::get(Context, Ops);
    toolchain::Value *Metadata = toolchain::MetadataAsValue::get(Context, RegName);
  ...
  if (BuiltinID == language::Core::AArch64::BI__break) {
    Expr::EvalResult Result;
    if (!E->getArg(0)->EvaluateAsInt(Result, CGM.getContext()))
      toolchain_unreachable("Sema will ensure that the parameter is constant");

    toolchain::Function *F = CGM.getIntrinsic(Intrinsic::aarch64_break);
    return Builder.CreateCall(F, {EmitScalarExpr(E->getArg(0))});
  }

  if (BuiltinID == language::Core::AArch64::BI__builtin_arm_clrex) {
    Function *F = CGM.getIntrinsic(Intrinsic::aarch64_clrex);
    return Builder.CreateCall(F);
  }

  if (BuiltinID == language::Core::AArch64::BI_ReadWriteBarrier)
    return Builder.CreateFence(toolchain::AtomicOrdering::SequentiallyConsistent,
                               toolchain::SyncScope::SingleThread);

  // CRC32
  Intrinsic::ID CRCIntrinsicID = Intrinsic::not_intrinsic;
  switch (BuiltinID) {
  case language::Core::AArch64::BI__builtin_arm_crc32b:
    CRCIntrinsicID = Intrinsic::aarch64_crc32b; break;
  case language::Core::AArch64::BI__builtin_arm_crc32cb:
    CRCIntrinsicID = Intrinsic::aarch64_crc32cb; break;
  case language::Core::AArch64::BI__builtin_arm_crc32h:
    CRCIntrinsicID = Intrinsic::aarch64_crc32h; break;
  case language::Core::AArch64::BI__builtin_arm_crc32ch:
    CRCIntrinsicID = Intrinsic::aarch64_crc32ch; break;
  case language::Core::AArch64::BI__builtin_arm_crc32w:
    CRCIntrinsicID = Intrinsic::aarch64_crc32w; break;
  case language::Core::AArch64::BI__builtin_arm_crc32cw:
    CRCIntrinsicID = Intrinsic::aarch64_crc32cw; break;
  case language::Core::AArch64::BI__builtin_arm_crc32d:
    CRCIntrinsicID = Intrinsic::aarch64_crc32x; break;
  case language::Core::AArch64::BI__builtin_arm_crc32cd:
  ...
  if (CRCIntrinsicID != Intrinsic::not_intrinsic) {
    ...
    toolchain::Type *DataTy = F->getFunctionType()->getParamType(1);
  ...
  switch (BuiltinID) {
  case language::Core::AArch64::BI__builtin_arm_irg:
    MTEIntrinsicID = Intrinsic::aarch64_irg; break;
  case language::Core::AArch64::BI__builtin_arm_addg:
    MTEIntrinsicID = Intrinsic::aarch64_addg; break;
  case language::Core::AArch64::BI__builtin_arm_gmi:
    MTEIntrinsicID = Intrinsic::aarch64_gmi; break;
  case language::Core::AArch64::BI__builtin_arm_ldg:
    MTEIntrinsicID = Intrinsic::aarch64_ldg; break;
  case language::Core::AArch64::BI__builtin_arm_stg:
    MTEIntrinsicID = Intrinsic::aarch64_stg; break;
  case language::Core::AArch64::BI__builtin_arm_subp:
  ...
  if (BuiltinID == language::Core::AArch64::BI__builtin_arm_rsr ||
      BuiltinID == language::Core::AArch64::BI__builtin_arm_rsr64 ||
      BuiltinID == language::Core::AArch64::BI__builtin_arm_rsr128 ||
      BuiltinID == language::Core::AArch64::BI__builtin_arm_rsrp ||
      BuiltinID == language::Core::AArch64::BI__builtin_arm_wsr ||
      BuiltinID == language::Core::AArch64::BI__builtin_arm_wsr64 ||
      BuiltinID == language::Core::AArch64::BI__builtin_arm_wsr128 ||
      BuiltinID == language::Core::AArch64::BI__builtin_arm_wsrp) {
    ...
    bool IsPointerBuiltin = BuiltinID == language::Core::AArch64::BI__builtin_arm_rsrp ||
                            BuiltinID == language::Core::AArch64::BI__builtin_arm_wsrp;

    bool Is32Bit = BuiltinID == language::Core::AArch64::BI__builtin_arm_rsr ||
                   BuiltinID == language::Core::AArch64::BI__builtin_arm_wsr;

    bool Is128Bit = BuiltinID == language::Core::AArch64::BI__builtin_arm_rsr128 ||
                    BuiltinID == language::Core::AArch64::BI__builtin_arm_wsr128;

    toolchain::Type *ValueType;
    toolchain::Type *RegisterType = Int64Ty;
    if (Is32Bit) {
      ValueType = Int32Ty;
    } else if (Is128Bit) {
      toolchain::Type *Int128Ty =
          toolchain::IntegerType::getInt128Ty(CGM.getLLVMContext());
      ValueType = Int128Ty;
  ...
  if (BuiltinID == language::Core::AArch64::BI_ReadStatusReg ||
      BuiltinID == language::Core::AArch64::BI_WriteStatusReg ||
      BuiltinID == language::Core::AArch64::BI__sys) {
    LLVMContext &Context = CGM.getLLVMContext();
    ...
    unsigned SysRegOp0 = (BuiltinID == language::Core::AArch64::BI_ReadStatusReg ||
                          BuiltinID == language::Core::AArch64::BI_WriteStatusReg)
                             ? ((1 << 1) | ((SysReg >> 14) & 1))
                             : 1;
    toolchain::raw_string_ostream(SysRegStr)
        << SysRegOp0 << ":" << ((SysReg >> 11) & 7) << ":"
        << ((SysReg >> 7) & 15) << ":" << ((SysReg >> 3) & 15) << ":"
        << (SysReg & 7);

    toolchain::Metadata *Ops[] = { toolchain::MDString::get(Context, SysRegStr) };
    toolchain::MDNode *RegName = toolchain::MDNode::get(Context, Ops);
    toolchain::Value *Metadata = toolchain::MetadataAsValue::get(Context, RegName);
    ...
    if (BuiltinID == language::Core::AArch64::BI_ReadStatusReg) {
      toolchain::Function *F = CGM.getIntrinsic(Intrinsic::read_register, Types);

      return Builder.CreateCall(F, Metadata);
    }

    toolchain::Function *F = CGM.getIntrinsic(Intrinsic::write_register, Types);
    toolchain::Value *ArgValue = EmitScalarExpr(E->getArg(1));
    toolchain::Value *Result = Builder.CreateCall(F, {Metadata, ArgValue});
    if (BuiltinID == language::Core::AArch64::BI__sys) {
  ...
  if (BuiltinID == language::Core::AArch64::BI_AddressOfReturnAddress) {
    toolchain::Function *F =
        CGM.getIntrinsic(Intrinsic::addressofreturnaddress, AllocaInt8PtrTy);
    return Builder.CreateCall(F);
  }

  if (BuiltinID == language::Core::AArch64::BI__builtin_sponentry) {
    toolchain::Function *F = CGM.getIntrinsic(Intrinsic::sponentry, AllocaInt8PtrTy);
    return Builder.CreateCall(F);
  }

  if (BuiltinID == language::Core::AArch64::BI__mulh ||
      BuiltinID == language::Core::AArch64::BI__umulh) {
    toolchain::Type *ResType = ConvertType(E->getType());
    toolchain::Type *Int128Ty = toolchain::IntegerType::get(getLLVMContext(), 128);

    bool IsSigned = BuiltinID == language::Core::AArch64::BI__mulh;
    Value *LHS =
  ...
  if (BuiltinID == AArch64::BI__writex18byte ||
    ...
    // Read x18 as i8*
    toolchain::Value *X18 = readX18AsPtr(*this);
  ...
  if (BuiltinID == AArch64::BI__readx18byte ||
    ...
    Value *Offset = Builder.CreateZExt(OffsetArg, Int64Ty);
    Value *Ptr = Builder.CreateGEP(Int8Ty, X18, Offset);
    toolchain::Type *IntTy = ConvertType(E->getType());
  ...
  if (BuiltinID == AArch64::BI_CopyDoubleFromInt64 ||
    ...
    Value *Arg = EmitScalarExpr(E->getArg(0));
    toolchain::Type *RetTy = ConvertType(E->getType());
  ...
  if (BuiltinID == AArch64::BI_CountLeadingOnes ||
    ...
    Value *Arg = EmitScalarExpr(E->getArg(0));
    toolchain::Type *ArgType = Arg->getType();
  ...
  if (BuiltinID == AArch64::BI_CountOneBits ||
    ...
    toolchain::Type *ArgType = ArgValue->getType();
  ...
  if (BuiltinID == AArch64::BI__prefetch) {
    Value *Address = EmitScalarExpr(E->getArg(0));
    Value *RW = toolchain::ConstantInt::get(Int32Ty, 0);
    Value *Locality = ConstantInt::get(Int32Ty, 3);
    Value *Data = toolchain::ConstantInt::get(Int32Ty, 1);
    Function *F = CGM.getIntrinsic(Intrinsic::prefetch, Address->getType());
  ...
  if (std::optional<toolchain::APSInt> Result =
          Arg->getIntegerConstantExpr(getContext()))
    // Determine the type of this overloaded NEON intrinsic.
  ...
  case NEON::BI__builtin_neon_vaddq_p128: {
    toolchain::Type *Ty = GetNeonType(this, NeonTypeFlags::Poly128);
    Ops.push_back(EmitScalarExpr(E->getArg(1)));
    Ops[0] = Builder.CreateBitCast(Ops[0], Ty);
    Ops[1] = Builder.CreateBitCast(Ops[1], Ty);
    Ops[0] =  Builder.CreateXor(Ops[0], Ops[1]);
    toolchain::Type *Int128Ty = toolchain::Type::getIntNTy(getLLVMContext(), 128);
  ...
  case NEON::BI__builtin_neon_vcvtd_f64_s64: {
    ...
    toolchain::Type *InTy = Is64 ? Int64Ty : Int32Ty;
    toolchain::Type *FTy = Is64 ? DoubleTy : FloatTy;
  ...
  case NEON::BI__builtin_neon_vcvth_s16_f16: {
    unsigned Int;
    toolchain::Type* InTy = Int32Ty;
    toolchain::Type* FTy  = HalfTy;
    toolchain::Type *Tys[2] = {InTy, FTy};
    Ops.push_back(EmitScalarExpr(E->getArg(0)));
    switch (BuiltinID) {
    default: toolchain_unreachable("missing builtin ID in switch!");
    case NEON::BI__builtin_neon_vcvtah_u16_f16:
  ...
  case NEON::BI__builtin_neon_vpaddd_s64: {
    auto *Ty = toolchain::FixedVectorType::get(Int64Ty, 2);
    Value *Vec = EmitScalarExpr(E->getArg(0));
    // The vector is v2f64, so make sure it's bitcast to that.
    Vec = Builder.CreateBitCast(Vec, Ty, "v2i64");
    toolchain::Value *Idx0 = toolchain::ConstantInt::get(SizeTy, 0);
    toolchain::Value *Idx1 = toolchain::ConstantInt::get(SizeTy, 1);
  ...
  case NEON::BI__builtin_neon_vpaddd_f64: {
    auto *Ty = toolchain::FixedVectorType::get(DoubleTy, 2);
    Value *Vec = EmitScalarExpr(E->getArg(0));
    // The vector is v2f64, so make sure it's bitcast to that.
  ...
  case NEON::BI__builtin_neon_vpadds_f32: {
    auto *Ty = toolchain::FixedVectorType::get(FloatTy, 2);
    Value *Vec = EmitScalarExpr(E->getArg(0));
  ...
  case NEON::BI__builtin_neon_vceqzd_u64: {
    ...
    Ops[0] =
        Builder.CreateICmpEQ(Ops[0], toolchain::Constant::getNullValue(Int64Ty));
  ...
  case NEON::BI__builtin_neon_vcgtd_f64: {
    toolchain::CmpInst::Predicate P;
    switch (BuiltinID) {
    default: toolchain_unreachable("missing builtin ID in switch!");
    case NEON::BI__builtin_neon_vceqd_f64: P = toolchain::FCmpInst::FCMP_OEQ; break;
    case NEON::BI__builtin_neon_vcled_f64: P = toolchain::FCmpInst::FCMP_OLE; break;
    case NEON::BI__builtin_neon_vcltd_f64: P = toolchain::FCmpInst::FCMP_OLT; break;
    case NEON::BI__builtin_neon_vcged_f64: P = toolchain::FCmpInst::FCMP_OGE; break;
    case NEON::BI__builtin_neon_vcgtd_f64: P = toolchain::FCmpInst::FCMP_OGT; break;
    }
    Ops.push_back(EmitScalarExpr(E->getArg(1)));
    Ops[0] = Builder.CreateBitCast(Ops[0], DoubleTy);
    Ops[1] = Builder.CreateBitCast(Ops[1], DoubleTy);
    if (P == toolchain::FCmpInst::FCMP_OEQ)
  ...
  case NEON::BI__builtin_neon_vcgts_f32: {
    ...
    switch (BuiltinID) {
    default: toolchain_unreachable("missing builtin ID in switch!");
    case NEON::BI__builtin_neon_vceqs_f32: P = toolchain::FCmpInst::FCMP_OEQ; break;
    case NEON::BI__builtin_neon_vcles_f32: P = toolchain::FCmpInst::FCMP_OLE; break;
    case NEON::BI__builtin_neon_vclts_f32: P = toolchain::FCmpInst::FCMP_OLT; break;
    case NEON::BI__builtin_neon_vcges_f32: P = toolchain::FCmpInst::FCMP_OGE; break;
    case NEON::BI__builtin_neon_vcgts_f32: P = toolchain::FCmpInst::FCMP_OGT; break;
    }
    Ops.push_back(EmitScalarExpr(E->getArg(1)));
  ...
  case NEON::BI__builtin_neon_vcgth_f16: {
    ...
    switch (BuiltinID) {
    default: toolchain_unreachable("missing builtin ID in switch!");
    case NEON::BI__builtin_neon_vceqh_f16: P = toolchain::FCmpInst::FCMP_OEQ; break;
    case NEON::BI__builtin_neon_vcleh_f16: P = toolchain::FCmpInst::FCMP_OLE; break;
    case NEON::BI__builtin_neon_vclth_f16: P = toolchain::FCmpInst::FCMP_OLT; break;
    case NEON::BI__builtin_neon_vcgeh_f16: P = toolchain::FCmpInst::FCMP_OGE; break;
    case NEON::BI__builtin_neon_vcgth_f16: P = toolchain::FCmpInst::FCMP_OGT; break;
    }
    Ops.push_back(EmitScalarExpr(E->getArg(1)));
  ...
  case NEON::BI__builtin_neon_vcled_s64: {
    ...
    default: toolchain_unreachable("missing builtin ID in switch!");
    case NEON::BI__builtin_neon_vceqd_s64:
    case NEON::BI__builtin_neon_vceqd_u64:P = toolchain::ICmpInst::ICMP_EQ;break;
    case NEON::BI__builtin_neon_vcgtd_s64:P = toolchain::ICmpInst::ICMP_SGT;break;
    case NEON::BI__builtin_neon_vcgtd_u64:P = toolchain::ICmpInst::ICMP_UGT;break;
    case NEON::BI__builtin_neon_vcltd_s64:P = toolchain::ICmpInst::ICMP_SLT;break;
    case NEON::BI__builtin_neon_vcltd_u64:P = toolchain::ICmpInst::ICMP_ULT;break;
    case NEON::BI__builtin_neon_vcged_u64:P = toolchain::ICmpInst::ICMP_UGE;break;
    case NEON::BI__builtin_neon_vcged_s64:P = toolchain::ICmpInst::ICMP_SGE;break;
    case NEON::BI__builtin_neon_vcled_u64:P = toolchain::ICmpInst::ICMP_ULE;break;
    case NEON::BI__builtin_neon_vcled_s64:P = toolchain::ICmpInst::ICMP_SLE;break;
    }
    Ops.push_back(EmitScalarExpr(E->getArg(1)));
    Ops[0] = Builder.CreateBitCast(Ops[0], Int64Ty);
  ...
  case NEON::BI__builtin_neon_vtstd_u64: {
    ...
    Ops[0] = Builder.CreateAnd(Ops[0], Ops[1]);
    Ops[0] = Builder.CreateICmp(ICmpInst::ICMP_NE, Ops[0],
                                toolchain::Constant::getNullValue(Int64Ty));
  ...
  case NEON::BI__builtin_neon_vset_lane_f64:
    ...
    Ops[1] =
        Builder.CreateBitCast(Ops[1], toolchain::FixedVectorType::get(DoubleTy, 1));
    Ops.push_back(EmitScalarExpr(E->getArg(2)));
    return Builder.CreateInsertElement(Ops[1], Ops[0], Ops[2], "vset_lane");
  case NEON::BI__builtin_neon_vset_lane_mf8:
  case NEON::BI__builtin_neon_vsetq_lane_mf8:
    ...
    Ops[0] =
        Builder.CreateBitCast(Ops[0], toolchain::Type::getInt8Ty(getLLVMContext()));
    return Builder.CreateInsertElement(Ops[1], Ops[0], Ops[2], "vset_lane");
  case NEON::BI__builtin_neon_vsetq_lane_f64:
    // The vector type needs a cast for the v2f64 variant.
    Ops[1] =
        Builder.CreateBitCast(Ops[1], toolchain::FixedVectorType::get(DoubleTy, 2));
    Ops.push_back(EmitScalarExpr(E->getArg(2)));
    return Builder.CreateInsertElement(Ops[1], Ops[0], Ops[2], "vset_lane");
  ...
  case NEON::BI__builtin_neon_vdupb_lane_i8:
    Ops[0] =
        Builder.CreateBitCast(Ops[0], toolchain::FixedVectorType::get(Int8Ty, 8));
    return Builder.CreateExtractElement(Ops[0], EmitScalarExpr(E->getArg(1)),
                                        "vget_lane");
  case NEON::BI__builtin_neon_vgetq_lane_i8:
  case NEON::BI__builtin_neon_vdupb_laneq_i8:
    Ops[0] =
        Builder.CreateBitCast(Ops[0], toolchain::FixedVectorType::get(Int8Ty, 16));
    return Builder.CreateExtractElement(Ops[0], EmitScalarExpr(E->getArg(1)),
                                        "vgetq_lane");
  case NEON::BI__builtin_neon_vget_lane_mf8:
  ...
  case NEON::BI__builtin_neon_vduph_lane_i16:
    Ops[0] =
        Builder.CreateBitCast(Ops[0], toolchain::FixedVectorType::get(Int16Ty, 4));
    return Builder.CreateExtractElement(Ops[0], EmitScalarExpr(E->getArg(1)),
                                        "vget_lane");
  case NEON::BI__builtin_neon_vgetq_lane_i16:
  case NEON::BI__builtin_neon_vduph_laneq_i16:
    Ops[0] =
        Builder.CreateBitCast(Ops[0], toolchain::FixedVectorType::get(Int16Ty, 8));
    return Builder.CreateExtractElement(Ops[0], EmitScalarExpr(E->getArg(1)),
                                        "vgetq_lane");
  case NEON::BI__builtin_neon_vget_lane_i32:
  case NEON::BI__builtin_neon_vdups_lane_i32:
    Ops[0] =
        Builder.CreateBitCast(Ops[0], toolchain::FixedVectorType::get(Int32Ty, 2));
    return Builder.CreateExtractElement(Ops[0], EmitScalarExpr(E->getArg(1)),
                                        "vget_lane");
  case NEON::BI__builtin_neon_vdups_lane_f32:
    Ops[0] =
        Builder.CreateBitCast(Ops[0], toolchain::FixedVectorType::get(FloatTy, 2));
    return Builder.CreateExtractElement(Ops[0], EmitScalarExpr(E->getArg(1)),
                                        "vdups_lane");
  case NEON::BI__builtin_neon_vgetq_lane_i32:
  case NEON::BI__builtin_neon_vdups_laneq_i32:
    Ops[0] =
        Builder.CreateBitCast(Ops[0], toolchain::FixedVectorType::get(Int32Ty, 4));
    return Builder.CreateExtractElement(Ops[0], EmitScalarExpr(E->getArg(1)),
                                        "vgetq_lane");
  case NEON::BI__builtin_neon_vget_lane_i64:
  case NEON::BI__builtin_neon_vdupd_lane_i64:
    Ops[0] =
        Builder.CreateBitCast(Ops[0], toolchain::FixedVectorType::get(Int64Ty, 1));
    return Builder.CreateExtractElement(Ops[0], EmitScalarExpr(E->getArg(1)),
                                        "vget_lane");
  case NEON::BI__builtin_neon_vdupd_lane_f64:
    Ops[0] =
        Builder.CreateBitCast(Ops[0], toolchain::FixedVectorType::get(DoubleTy, 1));
    return Builder.CreateExtractElement(Ops[0], EmitScalarExpr(E->getArg(1)),
                                        "vdupd_lane");
  case NEON::BI__builtin_neon_vgetq_lane_i64:
  case NEON::BI__builtin_neon_vdupd_laneq_i64:
    Ops[0] =
        Builder.CreateBitCast(Ops[0], toolchain::FixedVectorType::get(Int64Ty, 2));
    return Builder.CreateExtractElement(Ops[0], EmitScalarExpr(E->getArg(1)),
                                        "vgetq_lane");
  case NEON::BI__builtin_neon_vget_lane_f32:
    Ops[0] =
  ...
  case NEON::BI__builtin_neon_vdups_laneq_f32:
    Ops[0] =
        Builder.CreateBitCast(Ops[0], toolchain::FixedVectorType::get(FloatTy, 4));
    return Builder.CreateExtractElement(Ops[0], EmitScalarExpr(E->getArg(1)),
                                        "vgetq_lane");
  case NEON::BI__builtin_neon_vgetq_lane_f64:
  case NEON::BI__builtin_neon_vdupd_laneq_f64:
    Ops[0] =
        Builder.CreateBitCast(Ops[0], toolchain::FixedVectorType::get(DoubleTy, 2));
    return Builder.CreateExtractElement(Ops[0], EmitScalarExpr(E->getArg(1)),
                                        "vgetq_lane");
  ...
  case NEON::BI__builtin_neon_vqdmlslh_s16: {
    ...
    auto *VTy = toolchain::FixedVectorType::get(Int32Ty, 4);
  ...
  case NEON::BI__builtin_neon_vshld_n_u64: {
    toolchain::ConstantInt *Amt = cast<ConstantInt>(EmitScalarExpr(E->getArg(1)));
  ...
  case NEON::BI__builtin_neon_vsrad_n_s64: {
    toolchain::ConstantInt *Amt = cast<ConstantInt>(EmitScalarExpr(E->getArg(2)));
  ...
  case NEON::BI__builtin_neon_vcvt_bf16_f32: {
    toolchain::Type *V4F32 = FixedVectorType::get(Builder.getFloatTy(), 4);
    toolchain::Type *V4BF16 = FixedVectorType::get(Builder.getBFloatTy(), 4);
  ...
  case NEON::BI__builtin_neon_vcvtq_high_bf16_f32: {
    ...
    toolchain::Type *V4F32 = FixedVectorType::get(Builder.getFloatTy(), 4);
    toolchain::Type *V4BF16 = FixedVectorType::get(Builder.getBFloatTy(), 4);
    toolchain::Type *V8BF16 = FixedVectorType::get(Builder.getBFloatTy(), 8);
    toolchain::Value *Inactive = Builder.CreateShuffleVector(
  ...
  case language::Core::AArch64::BI_InterlockedAdd:
  case language::Core::AArch64::BI_InterlockedAdd_acq:
  case language::Core::AArch64::BI_InterlockedAdd_rel:
  case language::Core::AArch64::BI_InterlockedAdd_nf:
  case language::Core::AArch64::BI_InterlockedAdd64:
  case language::Core::AArch64::BI_InterlockedAdd64_acq:
  case language::Core::AArch64::BI_InterlockedAdd64_rel:
  case language::Core::AArch64::BI_InterlockedAdd64_nf: {
    ...
    case language::Core::AArch64::BI_InterlockedAdd:
    case language::Core::AArch64::BI_InterlockedAdd64:
      Ordering = toolchain::AtomicOrdering::SequentiallyConsistent;
      break;
    case language::Core::AArch64::BI_InterlockedAdd_acq:
    case language::Core::AArch64::BI_InterlockedAdd64_acq:
      Ordering = toolchain::AtomicOrdering::Acquire;
      break;
    case language::Core::AArch64::BI_InterlockedAdd_rel:
    case language::Core::AArch64::BI_InterlockedAdd64_rel:
      Ordering = toolchain::AtomicOrdering::Release;
      break;
    case language::Core::AArch64::BI_InterlockedAdd_nf:
    case language::Core::AArch64::BI_InterlockedAdd64_nf:
      Ordering = toolchain::AtomicOrdering::Monotonic;
      break;
    default:
      toolchain_unreachable("missing builtin ID in switch!");
    }
    AtomicRMWInst *RMWI =
  ...
  toolchain::FixedVectorType *VTy = GetNeonType(this, Type);
  toolchain::Type *Ty = VTy;
  if (!Ty)
    return nullptr;
  ...
  case NEON::BI__builtin_neon_vbslq_v: {
    toolchain::Type *BitTy = toolchain::VectorType::getInteger(VTy);
  ...
  case NEON::BI__builtin_neon_vfmaq_lane_v: { // Only used for FP types
    ...
    auto *SourceTy = BuiltinID == NEON::BI__builtin_neon_vfmaq_lane_v
                         ? toolchain::FixedVectorType::get(VTy->getElementType(),
                                                      VTy->getNumElements() / 2)
                         : VTy;
    toolchain::Constant *cst = cast<Constant>(Ops[3]);
    Value *SV = toolchain::ConstantVector::getSplat(VTy->getElementCount(), cst);
  ...
  case NEON::BI__builtin_neon_vfma_laneq_v: {
    auto *VTy = cast<toolchain::FixedVectorType>(Ty);
    ...
    auto *STy = toolchain::FixedVectorType::get(VTy->getElementType(),
                                           VTy->getNumElements() * 2);
    Ops[2] = Builder.CreateBitCast(Ops[2], STy);
    Value *SV = toolchain::ConstantVector::getSplat(VTy->getElementCount(),
  ...
  case NEON::BI__builtin_neon_vpadalq_v: {
    ...
    toolchain::IntegerType *EltTy = cast<IntegerType>(VTy->getElementType());
    unsigned BitWidth = EltTy->getBitWidth();
    auto *ArgTy = toolchain::FixedVectorType::get(
        toolchain::IntegerType::get(getLLVMContext(), BitWidth / 2), 2 * ArgElts);
    toolchain::Type* Tys[2] = { VTy, ArgTy };
    Int = usgn ? Intrinsic::aarch64_neon_uaddlp : Intrinsic::aarch64_neon_saddlp;
    SmallVector<toolchain::Value*, 1> TmpOps;
    TmpOps.push_back(Ops[1]);
    Function *F = CGM.getIntrinsic(Int, Tys);
    toolchain::Value *tmp = EmitNeonCall(F, TmpOps, "vpadal");
    toolchain::Value *addend = Builder.CreateBitCast(Ops[0], tmp->getType());
  ...
  case NEON::BI__builtin_neon_vaddv_s8: {
    ...
    Ty = Int32Ty;
    VTy = toolchain::FixedVectorType::get(Int8Ty, 8);
    toolchain::Type *Tys[2] = { Ty, VTy };
    Ops.push_back(EmitScalarExpr(E->getArg(0)));
  ...
  case NEON::BI__builtin_neon_vaddv_s16: {
    Int = usgn ? Intrinsic::aarch64_neon_uaddv : Intrinsic::aarch64_neon_saddv;
    Ty = Int32Ty;
    VTy = toolchain::FixedVectorType::get(Int16Ty, 4);
    toolchain::Type *Tys[2] = { Ty, VTy };
    Ops.push_back(EmitScalarExpr(E->getArg(0)));
    Ops[0] = EmitNeonCall(CGM.getIntrinsic(Int, Tys), Ops, "vaddv");
    return Builder.CreateTrunc(Ops[0], Int16Ty);
  ...
  case NEON::BI__builtin_neon_vaddvq_s8: {
    Int = usgn ? Intrinsic::aarch64_neon_uaddv : Intrinsic::aarch64_neon_saddv;
    Ty = Int32Ty;
    VTy = toolchain::FixedVectorType::get(Int8Ty, 16);
    toolchain::Type *Tys[2] = { Ty, VTy };
    Ops.push_back(EmitScalarExpr(E->getArg(0)));
    Ops[0] = EmitNeonCall(CGM.getIntrinsic(Int, Tys), Ops, "vaddv");
    return Builder.CreateTrunc(Ops[0], Int8Ty);
  ...
  case NEON::BI__builtin_neon_vaddvq_s16: {
    Int = usgn ? Intrinsic::aarch64_neon_uaddv : Intrinsic::aarch64_neon_saddv;
    Ty = Int32Ty;
    VTy = toolchain::FixedVectorType::get(Int16Ty, 8);
    toolchain::Type *Tys[2] = { Ty, VTy };
    Ops.push_back(EmitScalarExpr(E->getArg(0)));
    Ops[0] = EmitNeonCall(CGM.getIntrinsic(Int, Tys), Ops, "vaddv");
    return Builder.CreateTrunc(Ops[0], Int16Ty);
  ...
  case NEON::BI__builtin_neon_vmaxv_f16: {
    ...
    Ty = HalfTy;
    VTy = toolchain::FixedVectorType::get(HalfTy, 4);
    toolchain::Type *Tys[2] = { Ty, VTy };
    Ops.push_back(EmitScalarExpr(E->getArg(0)));
    Ops[0] = EmitNeonCall(CGM.getIntrinsic(Int, Tys), Ops, "vmaxv");
  ...
  case NEON::BI__builtin_neon_vmaxvq_f16: {
    Int = Intrinsic::aarch64_neon_fmaxv;
    Ty = HalfTy;
    VTy = toolchain::FixedVectorType::get(HalfTy, 8);
    toolchain::Type *Tys[2] = { Ty, VTy };
    Ops.push_back(EmitScalarExpr(E->getArg(0)));
    Ops[0] = EmitNeonCall(CGM.getIntrinsic(Int, Tys), Ops, "vmaxv");
    return Builder.CreateTrunc(Ops[0], HalfTy);
  ...
  case NEON::BI__builtin_neon_vsriq_n_v: {
    ...
    toolchain::Function *Intrin = CGM.getIntrinsic(Int, Ty);
  ...
  case NEON::BI__builtin_neon_vrsraq_n_v: {
    ...
    SmallVector<toolchain::Value*,2> TmpOps;
    TmpOps.push_back(Ops[1]);
    TmpOps.push_back(Ops[2]);
    Function* F = CGM.getIntrinsic(Int, Ty);
    toolchain::Value *tmp = EmitNeonCall(F, TmpOps, "vrshr_n", 1, true);
    Ops[0] = Builder.CreateBitCast(Ops[0], VTy);
  ...
  case NEON::BI__builtin_neon_vldap1q_lane_s64: {
    Ops[1] = Builder.CreateBitCast(Ops[1], Ty);
    toolchain::LoadInst *LI = Builder.CreateAlignedLoad(
        VTy->getElementType(), Ops[0], PtrOp0.getAlignment());
    LI->setAtomic(toolchain::AtomicOrdering::Acquire);
    Ops[0] = LI;
  ...
  case NEON::BI__builtin_neon_vld1q_dup_v: {
    ...
    Ops[0] = Builder.CreateAlignedLoad(VTy->getElementType(), Ops[0],
                                       PtrOp0.getAlignment());
    toolchain::Constant *CI = ConstantInt::get(Int32Ty, 0);
  ...
  case NEON::BI__builtin_neon_vstl1q_lane_s64: {
    Ops[1] = Builder.CreateBitCast(Ops[1], Ty);
    Ops[1] = Builder.CreateExtractElement(Ops[1], Ops[2]);
    toolchain::StoreInst *SI =
        Builder.CreateAlignedStore(Ops[1], Ops[0], PtrOp0.getAlignment());
    SI->setAtomic(toolchain::AtomicOrdering::Release);
    return SI;
  }
  case NEON::BI__builtin_neon_vld2_v:
  case NEON::BI__builtin_neon_vld2q_v: {
  ...
  case NEON::BI__builtin_neon_vld2_lane_v:
  case NEON::BI__builtin_neon_vld2q_lane_v: {
    toolchain::Type *Tys[2] = { VTy, Ops[1]->getType() };
  ...
  case NEON::BI__builtin_neon_vst2q_v: {
    std::rotate(Ops.begin(), Ops.begin() + 1, Ops.end());
    toolchain::Type *Tys[2] = { VTy, Ops[2]->getType() };
  ...
  case NEON::BI__builtin_neon_vst2q_lane_v: {
    std::rotate(Ops.begin(), Ops.begin() + 1, Ops.end());
    Ops[2] = Builder.CreateZExt(Ops[2], Int64Ty);
    toolchain::Type *Tys[2] = { VTy, Ops[3]->getType() };
  ...
  case NEON::BI__builtin_neon_vst3q_lane_v: {
    std::rotate(Ops.begin(), Ops.begin() + 1, Ops.end());
    Ops[3] = Builder.CreateZExt(Ops[3], Int64Ty);
    toolchain::Type *Tys[2] = { VTy, Ops[4]->getType() };
  ...
  case NEON::BI__builtin_neon_vst4q_lane_v: {
    std::rotate(Ops.begin(), Ops.begin() + 1, Ops.end());
    Ops[4] = Builder.CreateZExt(Ops[4], Int64Ty);
    toolchain::Type *Tys[2] = { VTy, Ops[5]->getType() };
  ...
  case NEON::BI__builtin_neon_vcvt1_high_bf16_mf8_fpm:
    return EmitFP8NeonCvtCall(Intrinsic::aarch64_neon_fp8_cvtl1,
                              toolchain::FixedVectorType::get(BFloatTy, 8),
  ...
  case NEON::BI__builtin_neon_vcvt1_high_f16_mf8_fpm:
    return EmitFP8NeonCvtCall(Intrinsic::aarch64_neon_fp8_cvtl1,
                              toolchain::FixedVectorType::get(HalfTy, 8),
                              Ops[0]->getType(), ExtractLow, Ops, E, "vbfcvt1");
  ...
  case NEON::BI__builtin_neon_vcvt_mf8_f32_fpm:
    return EmitFP8NeonCvtCall(Intrinsic::aarch64_neon_fp8_fcvtn,
                              toolchain::FixedVectorType::get(Int8Ty, 8),
                              Ops[0]->getType(), false, Ops, E, "vfcvtn");
  case NEON::BI__builtin_neon_vcvt_mf8_f16_fpm:
    return EmitFP8NeonCvtCall(Intrinsic::aarch64_neon_fp8_fcvtn,
                              toolchain::FixedVectorType::get(Int8Ty, 8),
                              toolchain::FixedVectorType::get(HalfTy, 4), false, Ops,
                              E, "vfcvtn");
  case NEON::BI__builtin_neon_vcvtq_mf8_f16_fpm:
    return EmitFP8NeonCvtCall(Intrinsic::aarch64_neon_fp8_fcvtn,
                              toolchain::FixedVectorType::get(Int8Ty, 16),
                              toolchain::FixedVectorType::get(HalfTy, 8), false, Ops,
                              E, "vfcvtn");
  case NEON::BI__builtin_neon_vcvt_high_mf8_f32_fpm: {
    toolchain::Type *Ty = toolchain::FixedVectorType::get(Int8Ty, 16);
  ...
  case NEON::BI__builtin_neon_vmlalbq_f16_mf8_fpm:
    return EmitFP8NeonCall(Intrinsic::aarch64_neon_fp8_fmlalb,
                           {toolchain::FixedVectorType::get(HalfTy, 8)}, Ops, E,
                           "vmlal");
  ...
  case NEON::BI__builtin_neon_vmlallbbq_f32_mf8_fpm:
    return EmitFP8NeonCall(Intrinsic::aarch64_neon_fp8_fmlallbb,
                           {toolchain::FixedVectorType::get(FloatTy, 4)}, Ops, E,
                           "vmlall");
...
Value *CodeGenFunction::EmitBPFBuiltinExpr(unsigned BuiltinID,
  ...
  switch (BuiltinID) {
  default:
    toolchain_unreachable("Unexpected BPF builtin");
  case BPF::BI__builtin_preserve_field_info: {
    ...
    toolchain::Function *FnGetFieldInfo = Intrinsic::getOrInsertDeclaration(
  ...
  case BPF::BI__builtin_preserve_type_info: {
    ...
    toolchain::DIType *DbgInfo = getDebugInfo()->getOrCreateStandaloneType(
  ...
  case BPF::BI__builtin_preserve_enum_value: {
    ...
    toolchain::Function *IntrinsicFn = Intrinsic::getOrInsertDeclaration(
...
toolchain::Value *CodeGenFunction::
BuildVector(ArrayRef<toolchain::Value*> Ops) {
  ...
  if (AllConstants) {
    SmallVector<toolchain::Constant*, 16> CstOps;
    for (toolchain::Value *Op : Ops)
      CstOps.push_back(cast<Constant>(Op));
    return toolchain::ConstantVector::get(CstOps);
  }

  // Otherwise, insertelement the values to build the vector.
  Value *Result = toolchain::PoisonValue::get(
      toolchain::FixedVectorType::get(Ops[0]->getType(), Ops.size()));
...
Value *CodeGenFunction::EmitAArch64CpuInit() {
  toolchain::FunctionType *FTy = toolchain::FunctionType::get(VoidTy, false);
  toolchain::FunctionCallee Func =
      CGM.CreateRuntimeFunction(FTy, "__init_cpu_features_resolver");
  cast<toolchain::GlobalValue>(Func.getCallee())->setDSOLocal(true);
  cast<toolchain::GlobalValue>(Func.getCallee())
      ->setDLLStorageClass(toolchain::GlobalValue::DefaultStorageClass);
...
Value *CodeGenFunction::EmitAArch64CpuSupports(const CallExpr *E) {
  ...
  toolchain::SmallVector<StringRef, 8> Features;
  ArgStr.split(Features, "+");
  for (auto &Feature : Features) {
    Feature = Feature.trim();
    if (!toolchain::AArch64::parseFMVExtension(Feature))
...
CodeGenFunction::EmitAArch64CpuSupports(ArrayRef<StringRef> FeaturesStrs) {
  toolchain::APInt FeaturesMask = toolchain::AArch64::getCpuSupportsMask(FeaturesStrs);
  ...
  if (FeaturesMask != 0) {
    ...
    toolchain::Type *STy = toolchain::StructType::get(Int64Ty);
    toolchain::Constant *AArch64CPUFeatures =
        CGM.CreateRuntimeVariable(STy, "__aarch64_cpu_features");
    cast<toolchain::GlobalValue>(AArch64CPUFeatures)->setDSOLocal(true);
    toolchain::Value *CpuFeatures = Builder.CreateGEP(
