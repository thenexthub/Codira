...
LoopInfo::createFollowupMetadata(const char *FollowupName,
                                 ArrayRef<toolchain::Metadata *> LoopProperties) {
...
LoopInfo::createPipeliningMetadata(const LoopAttributes &Attrs,
  ...
  if (Enabled != true) {
    if (Enabled == false) {
      Args.push_back(
          MDNode::get(Ctx, {MDString::get(Ctx, "toolchain.loop.pipeline.disable"),
                            ConstantAsMetadata::get(ConstantInt::get(
                                toolchain::Type::getInt1Ty(Ctx), 1))}));
    }
    return Args;
  }
  ...
  if (Attrs.PipelineInitiationInterval > 0) {
    Metadata *Vals[] = {
        MDString::get(Ctx, "toolchain.loop.pipeline.initiationinterval"),
        ConstantAsMetadata::get(ConstantInt::get(
            toolchain::Type::getInt32Ty(Ctx), Attrs.PipelineInitiationInterval))};
...
LoopInfo::createPartialUnrollMetadata(const LoopAttributes &Attrs,
  ...
  if (Enabled != true) {
    // createFullUnrollMetadata will already have added toolchain.loop.unroll.disable
  ...
  FollowupLoopProperties.push_back(
      MDNode::get(Ctx, MDString::get(Ctx, "toolchain.loop.unroll.disable")));
  ...
  if (Attrs.UnrollCount > 0) {
    Metadata *Vals[] = {MDString::get(Ctx, "toolchain.loop.unroll.count"),
                        ConstantAsMetadata::get(ConstantInt::get(
                            toolchain::Type::getInt32Ty(Ctx), Attrs.UnrollCount))};
    Args.push_back(MDNode::get(Ctx, Vals));
  }

  // Setting unroll.full or unroll.disable
  if (Attrs.UnrollEnable == LoopAttributes::Enable) {
    Metadata *Vals[] = {MDString::get(Ctx, "toolchain.loop.unroll.enable")};
    Args.push_back(MDNode::get(Ctx, Vals));
  }

  if (FollowupHasTransforms)
    Args.push_back(
        createFollowupMetadata("toolchain.loop.unroll.followup_all", Followup));
...
LoopInfo::createUnrollAndJamMetadata(const LoopAttributes &Attrs,
  ...
  if (Enabled != true) {
    ...
    if (Enabled == false) {
      ...
      NewLoopProperties.push_back(MDNode::get(
          Ctx, MDString::get(Ctx, "toolchain.loop.unroll_and_jam.disable")));
  ...
  FollowupLoopProperties.append(LoopProperties.begin(), LoopProperties.end());
  FollowupLoopProperties.push_back(
      MDNode::get(Ctx, MDString::get(Ctx, "toolchain.loop.unroll_and_jam.disable")));
  ...
  if (Attrs.UnrollAndJamCount > 0) {
    Metadata *Vals[] = {
        MDString::get(Ctx, "toolchain.loop.unroll_and_jam.count"),
        ConstantAsMetadata::get(ConstantInt::get(toolchain::Type::getInt32Ty(Ctx),
                                                 Attrs.UnrollAndJamCount))};
    Args.push_back(MDNode::get(Ctx, Vals));
  }

  if (Attrs.UnrollAndJamEnable == LoopAttributes::Enable) {
    Metadata *Vals[] = {MDString::get(Ctx, "toolchain.loop.unroll_and_jam.enable")};
    Args.push_back(MDNode::get(Ctx, Vals));
  }

  if (FollowupHasTransforms)
    Args.push_back(createFollowupMetadata(
        "toolchain.loop.unroll_and_jam.followup_outer", Followup));

  if (UnrollAndJamInnerFollowup.has_value())
    Args.push_back(createFollowupMetadata(
        "toolchain.loop.unroll_and_jam.followup_inner", *UnrollAndJamInnerFollowup));
...
LoopInfo::createLoopVectorizeMetadata(const LoopAttributes &Attrs,
  ...
  if (Enabled != true) {
    ...
    if (Enabled == false) {
      ...
      NewLoopProperties.push_back(
          MDNode::get(Ctx, {MDString::get(Ctx, "toolchain.loop.vectorize.enable"),
                            ConstantAsMetadata::get(ConstantInt::get(
                                toolchain::Type::getInt1Ty(Ctx), 0))}));
      LoopProperties = NewLoopProperties;
    }
  ...
  if (Attrs.VectorizePredicateEnable != LoopAttributes::Unspecified) {
    ...
    Metadata *Vals[] = {
        MDString::get(Ctx, "toolchain.loop.vectorize.predicate.enable"),
        ConstantAsMetadata::get(ConstantInt::get(toolchain::Type::getInt1Ty(Ctx),
                                                 IsVectorPredicateEnabled))};
    Args.push_back(MDNode::get(Ctx, Vals));
  }
  ...
  if (Attrs.VectorizeWidth > 0) {
    Metadata *Vals[] = {
        MDString::get(Ctx, "toolchain.loop.vectorize.width"),
        ConstantAsMetadata::get(ConstantInt::get(toolchain::Type::getInt32Ty(Ctx),
  ...
  if (Attrs.VectorizeScalable != LoopAttributes::Unspecified) {
    ...
    Metadata *Vals[] = {
        MDString::get(Ctx, "toolchain.loop.vectorize.scalable.enable"),
        ConstantAsMetadata::get(
            ConstantInt::get(toolchain::Type::getInt1Ty(Ctx), IsScalable))};
    Args.push_back(MDNode::get(Ctx, Vals));
  }
  ...
  if (Attrs.InterleaveCount > 0) {
    Metadata *Vals[] = {
        MDString::get(Ctx, "toolchain.loop.interleave.count"),
        ConstantAsMetadata::get(ConstantInt::get(toolchain::Type::getInt32Ty(Ctx),
  ...
  if (Attrs.VectorizeEnable != LoopAttributes::Unspecified ||
    ...
    Args.push_back(
        MDNode::get(Ctx, {MDString::get(Ctx, "toolchain.loop.vectorize.enable"),
                          ConstantAsMetadata::get(ConstantInt::get(
                              toolchain::Type::getInt1Ty(Ctx), VectorizeEnabled))}));
  }
  ...
  FollowupLoopProperties.push_back(
      MDNode::get(Ctx, MDString::get(Ctx, "toolchain.loop.isvectorized")));
  ...
  if (FollowupHasTransforms) {
    ...
    if (VectorizeEnabled)
      Args.push_back(
          createFollowupMetadata("toolchain.loop.vectorize.followup_all", Followup));
    else
...
LoopInfo::createLoopDistributeMetadata(const LoopAttributes &Attrs,
  ...
  if (Enabled != true) {
    ...
    if (Enabled == false) {
      NewLoopProperties.append(LoopProperties.begin(), LoopProperties.end());
      NewLoopProperties.push_back(
          MDNode::get(Ctx, {MDString::get(Ctx, "toolchain.loop.distribute.enable"),
                            ConstantAsMetadata::get(ConstantInt::get(
                                toolchain::Type::getInt1Ty(Ctx), 0))}));
      LoopProperties = NewLoopProperties;
    }
  ...
  Metadata *Vals[] = {MDString::get(Ctx, "toolchain.loop.distribute.enable"),
                      ConstantAsMetadata::get(ConstantInt::get(
                          toolchain::Type::getInt1Ty(Ctx),
                          (Attrs.DistributeEnable == LoopAttributes::Enable)))};
  Args.push_back(MDNode::get(Ctx, Vals));

  if (FollowupHasTransforms)
    Args.push_back(
        createFollowupMetadata("toolchain.loop.distribute.followup_all", Followup));
...
LoopInfo::createFullUnrollMetadata(const LoopAttributes &Attrs,
  ...
  SmallVector<Metadata *, 4> Args;
  Args.append(LoopProperties.begin(), LoopProperties.end());
  Args.push_back(MDNode::get(Ctx, MDString::get(Ctx, "toolchain.loop.unroll.full")));
...
SmallVector<Metadata *, 4> LoopInfo::createMetadata(
    ...
    toolchain::ArrayRef<toolchain::Metadata *> AdditionalLoopProperties,
    bool &HasUserTransforms) {
  ...
  if (Attrs.MustProgress)
    LoopProperties.push_back(
        MDNode::get(Ctx, MDString::get(Ctx, "toolchain.loop.mustprogress")));
  ...
  if (Attrs.IsParallel) {
    LoopProperties.push_back(MDNode::get(
        Ctx, {MDString::get(Ctx, "toolchain.loop.parallel_accesses"), AccGroup}));
  }

  // Setting language::Core::code_align attribute.
  if (Attrs.CodeAlign > 0) {
    Metadata *Vals[] = {MDString::get(Ctx, "toolchain.loop.align"),
                        ConstantAsMetadata::get(ConstantInt::get(
                            toolchain::Type::getInt32Ty(Ctx), Attrs.CodeAlign))};
    LoopProperties.push_back(MDNode::get(Ctx, Vals));
  }

  toolchain::append_range(LoopProperties, AdditionalLoopProperties);
...
void LoopInfo::finish() {
  ...
  if (Parent && (Parent->Attrs.UnrollAndJamEnable ||
    ...
    if (!Parent->UnrollAndJamInnerFollowup) {
      ...
      // stop 'toolchain.loop.isvectorized' (generated by vectorization in BeforeJam)
...
void LoopInfoStack::push(BasicBlock *Header, const toolchain::DebugLoc &StartLoc,
...
void LoopInfoStack::push(BasicBlock *Header, language::Core::ASTContext &Ctx,
                         const language::Core::CodeGenOptions &CGOpts,
                         ArrayRef<const language::Core::Attr *> Attrs,
                         const toolchain::DebugLoc &StartLoc,
                         const toolchain::DebugLoc &EndLoc, bool MustProgress) {
  ...
  for (const auto *Attr : Attrs) {
    ...
    if (OpenCLHint) {
      ...
      if (ValueExpr) {
        toolchain::APSInt ValueAPS = ValueExpr->EvaluateKnownConstInt(Ctx);
    ...
    case LoopHintAttr::Disable:
      ...
      case LoopHintAttr::PipelineInitiationInterval:
        toolchain_unreachable("Options cannot be disabled.");
        break;
      }
      break;
    case LoopHintAttr::Enable:
      ...
      case LoopHintAttr::PipelineDisabled:
      case LoopHintAttr::PipelineInitiationInterval:
        toolchain_unreachable("Options cannot enabled.");
        break;
      }
      break;
    case LoopHintAttr::AssumeSafety:
      ...
      case LoopHintAttr::Vectorize:
      case LoopHintAttr::Interleave:
        // Apply "toolchain.mem.parallel_loop_access" metadata to load/stores.
        setParallel(true);
        setVectorizeEnable(true);
        break;
      case LoopHintAttr::Unroll:
      ...
      case LoopHintAttr::PipelineDisabled:
      case LoopHintAttr::PipelineInitiationInterval:
        toolchain_unreachable("Options cannot be used to assume mem safety.");
        break;
      }
      break;
    case LoopHintAttr::Full:
      ...
      case LoopHintAttr::PipelineInitiationInterval:
      case LoopHintAttr::VectorizePredicate:
        toolchain_unreachable("Options cannot be used with 'full' hint.");
        break;
      }
      break;
    ...
    case LoopHintAttr::ScalableWidth:
      ...
      case LoopHintAttr::VectorizeWidth:
        ...
        break;
      default:
        toolchain_unreachable("Options cannot be used with 'scalable' hint.");
        break;
      }
      break;
    case LoopHintAttr::Numeric:
      ...
      case LoopHintAttr::Distribute:
      case LoopHintAttr::PipelineDisabled:
        toolchain_unreachable("Options cannot be assigned a value.");
        break;
      }
      break;
    }
...
void LoopInfoStack::InsertHelper(Instruction *I) const {
  if (I->mayReadOrWriteMemory()) {
    ...
    I->setMetadata("toolchain.access.group", UnionMD);
  }
  ...
  if (I->isTerminator()) {
    for (BasicBlock *Succ : successors(I))
      if (Succ == L.getHeader()) {
        I->setMetadata(toolchain::LLVMContext::MD_loop, L.getLoopID());
        break;
      }
    return;
  }
