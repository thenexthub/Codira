...
#include "toolchain/ADT/CachedHashString.h"
...
private:
  ...
  toolchain::FunctionCallee getMessageSendFn() const {
    // Add the non-lazy-bind attribute, since objc_msgSend is likely to
    // be called a lot.
    toolchain::Type *params[] = {ObjectPtrTy, SelectorPtrTy};
    return CGM.CreateRuntimeFunction(
        toolchain::FunctionType::get(ObjectPtrTy, params, true), "objc_msgSend",
        toolchain::AttributeList::get(CGM.getLLVMContext(),
                                 toolchain::AttributeList::FunctionIndex,
                                 toolchain::Attribute::NonLazyBind));
  }
  ...
  toolchain::FunctionCallee getMessageSendStretFn() const {
    toolchain::Type *params[] = {ObjectPtrTy, SelectorPtrTy};
    return CGM.CreateRuntimeFunction(
        toolchain::FunctionType::get(CGM.VoidTy, params, true),
        "objc_msgSend_stret");
  }
  ...
  /// would be unbalanced.
  toolchain::FunctionCallee getMessageSendFpretFn() const {
    toolchain::Type *params[] = {ObjectPtrTy, SelectorPtrTy};
    return CGM.CreateRuntimeFunction(
        toolchain::FunctionType::get(CGM.DoubleTy, params, true),
        "objc_msgSend_fpret");
  }
  ...
  toolchain::FunctionCallee getMessageSendFp2retFn() const {
    toolchain::Type *params[] = {ObjectPtrTy, SelectorPtrTy};
    toolchain::Type *longDoubleType = toolchain::Type::getX86_FP80Ty(VMContext);
    toolchain::Type *resultType =
        toolchain::StructType::get(longDoubleType, longDoubleType);

    return CGM.CreateRuntimeFunction(
        toolchain::FunctionType::get(resultType, params, true),
        "objc_msgSend_fp2ret");
  }
  ...
  /// class.
  toolchain::FunctionCallee getMessageSendSuperFn() const {
    toolchain::Type *params[] = {SuperPtrTy, SelectorPtrTy};
    return CGM.CreateRuntimeFunction(
        toolchain::FunctionType::get(ObjectPtrTy, params, true),
        "objc_msgSendSuper");
  }
  ...
  toolchain::FunctionCallee getMessageSendSuperFn2() const {
    toolchain::Type *params[] = {SuperPtrTy, SelectorPtrTy};
    return CGM.CreateRuntimeFunction(
        toolchain::FunctionType::get(ObjectPtrTy, params, true),
        "objc_msgSendSuper2");
  ...
  toolchain::FunctionCallee getMessageSendSuperStretFn() const {
    toolchain::Type *params[] = {Int8PtrTy, SuperPtrTy, SelectorPtrTy};
    return CGM.CreateRuntimeFunction(
        toolchain::FunctionType::get(CGM.VoidTy, params, true),
  ...
  toolchain::FunctionCallee getMessageSendSuperStretFn2() const {
    toolchain::Type *params[] = {Int8PtrTy, SuperPtrTy, SelectorPtrTy};
    return CGM.CreateRuntimeFunction(
        toolchain::FunctionType::get(CGM.VoidTy, params, true),
  ...
  toolchain::FunctionCallee getMessageSendSuperFpretFn() const {
    // There is no objc_msgSendSuper_fpret? How can that work?
    return getMessageSendSuperFn();
  }

  toolchain::FunctionCallee getMessageSendSuperFpretFn2() const {
    // There is no objc_msgSendSuper_fpret? How can that work?
...
public:
  toolchain::IntegerType *ShortTy, *IntTy, *LongTy;
  toolchain::PointerType *Int8PtrTy, *Int8PtrPtrTy;
  toolchain::PointerType *Int8PtrProgramASTy;
  toolchain::Type *IvarOffsetVarTy;

  /// ObjectPtrTy - LLVM type for object handles (typeof(id))
  toolchain::PointerType *ObjectPtrTy;

  /// PtrObjectPtrTy - LLVM type for id *
  toolchain::PointerType *PtrObjectPtrTy;

  /// SelectorPtrTy - LLVM type for selector handles (typeof(SEL))
  toolchain::PointerType *SelectorPtrTy;
  ...
  toolchain::StructType *SuperTy;
  /// SuperPtrTy - LLVM type for struct objc_super *.
  toolchain::PointerType *SuperPtrTy;

  /// PropertyTy - LLVM type for struct objc_property (struct _prop_t
  /// in GCC parlance).
  toolchain::StructType *PropertyTy;

  /// PropertyListTy - LLVM type for struct objc_property_list
  /// (_prop_list_t in GCC parlance).
  toolchain::StructType *PropertyListTy;
  /// PropertyListPtrTy - LLVM type for struct objc_property_list*.
  toolchain::PointerType *PropertyListPtrTy;

  // MethodTy - LLVM type for struct objc_method.
  toolchain::StructType *MethodTy;

  /// CacheTy - LLVM type for struct objc_cache.
  toolchain::Type *CacheTy;
  /// CachePtrTy - LLVM type for struct objc_cache *.
  toolchain::PointerType *CachePtrTy;

  toolchain::FunctionCallee getGetPropertyFn() {
    ...
    toolchain::FunctionType *FTy = Types.GetFunctionType(
        Types.arrangeBuiltinFunctionDeclaration(IdType, Params));
    return CGM.CreateRuntimeFunction(FTy, "objc_getProperty");
  }

  toolchain::FunctionCallee getSetPropertyFn() {
    CodeGen::CodeGenTypes &Types = CGM.getTypes();
    ASTContext &Ctx = CGM.getContext();
  ...
  toolchain::FunctionCallee getOptimizedSetPropertyFn(bool atomic, bool copy) {
    CodeGen::CodeGenTypes &Types = CGM.getTypes();
    ASTContext &Ctx = CGM.getContext();
  ...
  toolchain::FunctionCallee getCopyStructFn() {
    CodeGen::CodeGenTypes &Types = CGM.getTypes();
    ASTContext &Ctx = CGM.getContext();
  ...
  toolchain::FunctionCallee getCppAtomicObjectFunction() {
    CodeGen::CodeGenTypes &Types = CGM.getTypes();
    ASTContext &Ctx = CGM.getContext();
  ...
  toolchain::FunctionCallee getEnumerationMutationFn() {
    CodeGen::CodeGenTypes &Types = CGM.getTypes();
    ASTContext &Ctx = CGM.getContext();
  ...
  toolchain::FunctionCallee getLookUpClassFn() {
    CodeGen::CodeGenTypes &Types = CGM.getTypes();
    ASTContext &Ctx = CGM.getContext();
  ...
  toolchain::FunctionCallee getGcReadWeakFn() {
    // id objc_read_weak (id *)
    toolchain::Type *args[] = {CGM.UnqualPtrTy};
    toolchain::FunctionType *FTy = toolchain::FunctionType::get(ObjectPtrTy, args, false);
    return CGM.CreateRuntimeFunction(FTy, "objc_read_weak");
  }

  /// GcAssignWeakFn -- LLVM objc_assign_weak function.
  toolchain::FunctionCallee getGcAssignWeakFn() {
    // id objc_assign_weak (id, id *)
    toolchain::Type *args[] = {ObjectPtrTy, CGM.UnqualPtrTy};
    toolchain::FunctionType *FTy = toolchain::FunctionType::get(ObjectPtrTy, args, false);
    return CGM.CreateRuntimeFunction(FTy, "objc_assign_weak");
  }

  /// GcAssignGlobalFn -- LLVM objc_assign_global function.
  toolchain::FunctionCallee getGcAssignGlobalFn() {
  ...
  toolchain::FunctionCallee getGcAssignThreadLocalFn() {
  ...
  toolchain::FunctionCallee getGcAssignIvarFn() {
    // id objc_assign_ivar(id, id *, ptrdiff_t)
    toolchain::Type *args[] = {ObjectPtrTy, CGM.UnqualPtrTy, CGM.PtrDiffTy};
    toolchain::FunctionType *FTy = toolchain::FunctionType::get(ObjectPtrTy, args, false);
    return CGM.CreateRuntimeFunction(FTy, "objc_assign_ivar");
  }

  /// GcMemmoveCollectableFn -- LLVM objc_memmove_collectable function.
  toolchain::FunctionCallee GcMemmoveCollectableFn() {
    // void *objc_memmove_collectable(void *dst, const void *src, size_t size)
    toolchain::Type *args[] = {Int8PtrTy, Int8PtrTy, LongTy};
    toolchain::FunctionType *FTy = toolchain::FunctionType::get(Int8PtrTy, args, false);
    return CGM.CreateRuntimeFunction(FTy, "objc_memmove_collectable");
  }

  /// GcAssignStrongCastFn -- LLVM objc_assign_strongCast function.
  toolchain::FunctionCallee getGcAssignStrongCastFn() {
  ...
  toolchain::FunctionCallee getExceptionThrowFn() {
    // void objc_exception_throw(id)
    toolchain::Type *args[] = {ObjectPtrTy};
    toolchain::FunctionType *FTy = toolchain::FunctionType::get(CGM.VoidTy, args, false);
    return CGM.CreateRuntimeFunction(FTy, "objc_exception_throw");
  }

  /// ExceptionRethrowFn - LLVM objc_exception_rethrow function.
  toolchain::FunctionCallee getExceptionRethrowFn() {
    // void objc_exception_rethrow(void)
    toolchain::FunctionType *FTy = toolchain::FunctionType::get(CGM.VoidTy, false);
    return CGM.CreateRuntimeFunction(FTy, "objc_exception_rethrow");
  }

  /// SyncEnterFn - LLVM object_sync_enter function.
  toolchain::FunctionCallee getSyncEnterFn() {
    // int objc_sync_enter (id)
    toolchain::Type *args[] = {ObjectPtrTy};
    toolchain::FunctionType *FTy = toolchain::FunctionType::get(CGM.IntTy, args, false);
    return CGM.CreateRuntimeFunction(FTy, "objc_sync_enter");
  }

  /// SyncExitFn - LLVM object_sync_exit function.
  toolchain::FunctionCallee getSyncExitFn() {
  ...
  toolchain::FunctionCallee getSendFn(bool IsSuper) const {
    return IsSuper ? getMessageSendSuperFn() : getMessageSendFn();
  }

  toolchain::FunctionCallee getSendFn2(bool IsSuper) const {
    return IsSuper ? getMessageSendSuperFn2() : getMessageSendFn();
  }

  toolchain::FunctionCallee getSendStretFn(bool IsSuper) const {
    return IsSuper ? getMessageSendSuperStretFn() : getMessageSendStretFn();
  }

  toolchain::FunctionCallee getSendStretFn2(bool IsSuper) const {
    return IsSuper ? getMessageSendSuperStretFn2() : getMessageSendStretFn();
  }

  toolchain::FunctionCallee getSendFpretFn(bool IsSuper) const {
    return IsSuper ? getMessageSendSuperFpretFn() : getMessageSendFpretFn();
  }

  toolchain::FunctionCallee getSendFpretFn2(bool IsSuper) const {
    return IsSuper ? getMessageSendSuperFpretFn2() : getMessageSendFpretFn();
  }

  toolchain::FunctionCallee getSendFp2retFn(bool IsSuper) const {
    return IsSuper ? getMessageSendSuperFn() : getMessageSendFp2retFn();
  }

  toolchain::FunctionCallee getSendFp2RetFn2(bool IsSuper) const {
...
public:
  ...
  toolchain::StructType *SymtabTy;
  /// SymtabPtrTy - LLVM type for struct objc_symtab *.
  toolchain::PointerType *SymtabPtrTy;
  /// ModuleTy - LLVM type for struct objc_module.
  toolchain::StructType *ModuleTy;

  /// ProtocolTy - LLVM type for struct objc_protocol.
  toolchain::StructType *ProtocolTy;
  /// ProtocolPtrTy - LLVM type for struct objc_protocol *.
  toolchain::PointerType *ProtocolPtrTy;
  /// ProtocolExtensionTy - LLVM type for struct
  /// objc_protocol_extension.
  toolchain::StructType *ProtocolExtensionTy;
  /// ProtocolExtensionTy - LLVM type for struct
  /// objc_protocol_extension *.
  toolchain::PointerType *ProtocolExtensionPtrTy;
  /// MethodDescriptionTy - LLVM type for struct
  /// objc_method_description.
  toolchain::StructType *MethodDescriptionTy;
  /// MethodDescriptionListTy - LLVM type for struct
  /// objc_method_description_list.
  toolchain::StructType *MethodDescriptionListTy;
  /// MethodDescriptionListPtrTy - LLVM type for struct
  /// objc_method_description_list *.
  toolchain::PointerType *MethodDescriptionListPtrTy;
  /// ProtocolListTy - LLVM type for struct objc_property_list.
  toolchain::StructType *ProtocolListTy;
  /// ProtocolListPtrTy - LLVM type for struct objc_property_list*.
  toolchain::PointerType *ProtocolListPtrTy;
  /// CategoryTy - LLVM type for struct objc_category.
  toolchain::StructType *CategoryTy;
  /// ClassTy - LLVM type for struct objc_class.
  toolchain::StructType *ClassTy;
  /// ClassPtrTy - LLVM type for struct objc_class *.
  toolchain::PointerType *ClassPtrTy;
  /// ClassExtensionTy - LLVM type for struct objc_class_ext.
  toolchain::StructType *ClassExtensionTy;
  /// ClassExtensionPtrTy - LLVM type for struct objc_class_ext *.
  toolchain::PointerType *ClassExtensionPtrTy;
  // IvarTy - LLVM type for struct objc_ivar.
  toolchain::StructType *IvarTy;
  /// IvarListTy - LLVM type for struct objc_ivar_list.
  toolchain::StructType *IvarListTy;
  /// IvarListPtrTy - LLVM type for struct objc_ivar_list *.
  toolchain::PointerType *IvarListPtrTy;
  /// MethodListTy - LLVM type for struct objc_method_list.
  toolchain::StructType *MethodListTy;
  /// MethodListPtrTy - LLVM type for struct objc_method_list *.
  toolchain::PointerType *MethodListPtrTy;

  /// ExceptionDataTy - LLVM type for struct _objc_exception_data.
  toolchain::StructType *ExceptionDataTy;

  /// ExceptionTryEnterFn - LLVM objc_exception_try_enter function.
  toolchain::FunctionCallee getExceptionTryEnterFn() {
    toolchain::Type *params[] = {CGM.UnqualPtrTy};
    return CGM.CreateRuntimeFunction(
        toolchain::FunctionType::get(CGM.VoidTy, params, false),
        "objc_exception_try_enter");
  }

  /// ExceptionTryExitFn - LLVM objc_exception_try_exit function.
  toolchain::FunctionCallee getExceptionTryExitFn() {
    toolchain::Type *params[] = {CGM.UnqualPtrTy};
    return CGM.CreateRuntimeFunction(
        toolchain::FunctionType::get(CGM.VoidTy, params, false),
  ...
  toolchain::FunctionCallee getExceptionExtractFn() {
    toolchain::Type *params[] = {CGM.UnqualPtrTy};
    return CGM.CreateRuntimeFunction(
        toolchain::FunctionType::get(ObjectPtrTy, params, false),
        "objc_exception_extract");
  }

  /// ExceptionMatchFn - LLVM objc_exception_match function.
  toolchain::FunctionCallee getExceptionMatchFn() {
    toolchain::Type *params[] = {ClassPtrTy, ObjectPtrTy};
    return CGM.CreateRuntimeFunction(
        toolchain::FunctionType::get(CGM.Int32Ty, params, false),
        "objc_exception_match");
  }

  /// SetJmpFn - LLVM _setjmp function.
  toolchain::FunctionCallee getSetJmpFn() {
    // This is specifically the prototype for x86.
    toolchain::Type *params[] = {CGM.UnqualPtrTy};
    return CGM.CreateRuntimeFunction(
        toolchain::FunctionType::get(CGM.Int32Ty, params, false), "_setjmp",
        toolchain::AttributeList::get(CGM.getLLVMContext(),
                                 toolchain::AttributeList::FunctionIndex,
                                 toolchain::Attribute::NonLazyBind));
  }
...
public:
  ...
  toolchain::StructType *MethodListnfABITy;

  // MethodListnfABIPtrTy - LLVM for struct _method_list_t*
  toolchain::PointerType *MethodListnfABIPtrTy;

  // ProtocolnfABITy = LLVM for struct _protocol_t
  toolchain::StructType *ProtocolnfABITy;

  // ProtocolnfABIPtrTy = LLVM for struct _protocol_t*
  toolchain::PointerType *ProtocolnfABIPtrTy;

  // ProtocolListnfABITy - LLVM for struct _objc_protocol_list
  toolchain::StructType *ProtocolListnfABITy;

  // ProtocolListnfABIPtrTy - LLVM for struct _objc_protocol_list*
  toolchain::PointerType *ProtocolListnfABIPtrTy;

  // ClassnfABITy - LLVM for struct _class_t
  toolchain::StructType *ClassnfABITy;

  // ClassnfABIPtrTy - LLVM for struct _class_t*
  toolchain::PointerType *ClassnfABIPtrTy;

  // IvarnfABITy - LLVM for struct _ivar_t
  toolchain::StructType *IvarnfABITy;

  // IvarListnfABITy - LLVM for struct _ivar_list_t
  toolchain::StructType *IvarListnfABITy;

  // IvarListnfABIPtrTy = LLVM for struct _ivar_list_t*
  toolchain::PointerType *IvarListnfABIPtrTy;

  // ClassRonfABITy - LLVM for struct _class_ro_t
  toolchain::StructType *ClassRonfABITy;

  // ImpnfABITy - LLVM for id (*)(id, SEL, ...)
  toolchain::PointerType *ImpnfABITy;

  // CategorynfABITy - LLVM for struct _category_t
  toolchain::StructType *CategorynfABITy;
  ...
  //   SEL name;
  // };
  toolchain::StructType *MessageRefTy;
  // MessageRefCTy - clang type for struct _message_ref_t
  QualType MessageRefCTy;

  // MessageRefPtrTy - LLVM for struct _message_ref_t*
  toolchain::Type *MessageRefPtrTy;
  ...
  //   SEL name;
  // };
  toolchain::StructType *SuperMessageRefTy;

  // SuperMessageRefPtrTy - LLVM for struct _super_message_ref_t*
  toolchain::PointerType *SuperMessageRefPtrTy;

  toolchain::FunctionCallee getMessageSendFixupFn() {
    // id objc_msgSend_fixup(id, struct message_ref_t*, ...)
    toolchain::Type *params[] = {ObjectPtrTy, MessageRefPtrTy};
    return CGM.CreateRuntimeFunction(
        toolchain::FunctionType::get(ObjectPtrTy, params, true),
        "objc_msgSend_fixup");
  }

  toolchain::FunctionCallee getMessageSendFpretFixupFn() {
  ...
  toolchain::FunctionCallee getMessageSendStretFixupFn() {
  ...
  toolchain::FunctionCallee getMessageSendSuper2FixupFn() {
    // id objc_msgSendSuper2_fixup (struct objc_super *,
    //                              struct _super_message_ref_t*, ...)
    toolchain::Type *params[] = {SuperPtrTy, SuperMessageRefPtrTy};
    return CGM.CreateRuntimeFunction(
        toolchain::FunctionType::get(ObjectPtrTy, params, true),
        "objc_msgSendSuper2_fixup");
  }

  toolchain::FunctionCallee getMessageSendSuper2StretFixupFn() {
  ...
  toolchain::FunctionCallee getObjCEndCatchFn() {
    return CGM.CreateRuntimeFunction(toolchain::FunctionType::get(CGM.VoidTy, false),
                                     "objc_end_catch");
  }

  toolchain::FunctionCallee getObjCBeginCatchFn() {
    toolchain::Type *params[] = {Int8PtrTy};
    return CGM.CreateRuntimeFunction(
        toolchain::FunctionType::get(Int8PtrTy, params, false), "objc_begin_catch");
  }
  ...
  toolchain::FunctionCallee getLoadClassrefFn() const {
    ...
    toolchain::Type *params[] = {Int8PtrPtrTy};
    toolchain::LLVMContext &C = CGM.getLLVMContext();
    toolchain::AttributeSet AS = toolchain::AttributeSet::get(
        C, {
               toolchain::Attribute::get(C, toolchain::Attribute::NonLazyBind),
               toolchain::Attribute::getWithMemoryEffects(
                   C, toolchain::MemoryEffects::none()),
               toolchain::Attribute::get(C, toolchain::Attribute::NoUnwind),
           });
    toolchain::FunctionCallee F = CGM.CreateRuntimeFunction(
        toolchain::FunctionType::get(ClassnfABIPtrTy, params, false),
        "objc_loadClassref",
        toolchain::AttributeList::get(CGM.getLLVMContext(),
                                 toolchain::AttributeList::FunctionIndex, AS));
    if (!CGM.getTriple().isOSBinFormatCOFF())
      cast<toolchain::Function>(F.getCallee())
          ->setLinkage(toolchain::Function::ExternalWeakLinkage);

    return F;
  }

  toolchain::StructType *EHTypeTy;
  toolchain::Type *EHTypePtrTy;
...
protected:
  ...
  toolchain::SetVector<IdentifierInfo *> LazySymbols;

  /// DefinedSymbols - External symbols which are defined by this
  /// module. The symbols in this list and LazySymbols are used to add
  /// special linker symbols which ensure that Objective-C modules are
  /// linked properly.
  toolchain::SetVector<IdentifierInfo *> DefinedSymbols;

  /// ClassNames - uniqued class names.
  toolchain::StringMap<toolchain::GlobalVariable *> ClassNames;

  /// MethodVarNames - uniqued method variable names.
  toolchain::DenseMap<Selector, toolchain::GlobalVariable *> MethodVarNames;

  /// DefinedCategoryNames - list of category names in form Class_Category.
  toolchain::SmallSetVector<toolchain::CachedHashString, 16> DefinedCategoryNames;

  /// MethodVarTypes - uniqued method type signatures. We have to use
  /// a StringMap here because have no other unique reference.
  toolchain::StringMap<toolchain::GlobalVariable *> MethodVarTypes;

  /// MethodDefinitions - map of methods which have been defined in
  /// this translation unit.
  toolchain::DenseMap<const ObjCMethodDecl *, toolchain::Function *> MethodDefinitions;

  /// DirectMethodDefinitions - map of direct methods which have been defined in
  /// this translation unit.
  toolchain::DenseMap<const ObjCMethodDecl *, toolchain::Function *>
      DirectMethodDefinitions;

  /// PropertyNames - uniqued method variable names.
  toolchain::DenseMap<IdentifierInfo *, toolchain::GlobalVariable *> PropertyNames;

  /// ClassReferences - uniqued class references.
  toolchain::DenseMap<IdentifierInfo *, toolchain::GlobalVariable *> ClassReferences;

  /// SelectorReferences - uniqued selector references.
  toolchain::DenseMap<Selector, toolchain::GlobalVariable *> SelectorReferences;

  /// Protocols - Protocols for which an objc_protocol structure has
  /// been emitted. Forward declarations are handled by creating an
  /// empty structure whose initializer is filled in when/if defined.
  toolchain::DenseMap<IdentifierInfo *, toolchain::GlobalVariable *> Protocols;

  /// DefinedProtocols - Protocols which have actually been
  /// defined. We should not need this, see FIXME in GenerateProtocol.
  toolchain::DenseSet<IdentifierInfo *> DefinedProtocols;

  /// DefinedClasses - List of defined classes.
  SmallVector<toolchain::GlobalValue *, 16> DefinedClasses;

  /// ImplementedClasses - List of @implemented classes.
  SmallVector<const ObjCInterfaceDecl *, 16> ImplementedClasses;

  /// DefinedNonLazyClasses - List of defined "non-lazy" classes.
  SmallVector<toolchain::GlobalValue *, 16> DefinedNonLazyClasses;

  /// DefinedCategories - List of defined categories.
  SmallVector<toolchain::GlobalValue *, 16> DefinedCategories;

  /// DefinedStubCategories - List of defined categories on class stubs.
  SmallVector<toolchain::GlobalValue *, 16> DefinedStubCategories;

  /// DefinedNonLazyCategories - List of defined "non-lazy" categories.
  SmallVector<toolchain::GlobalValue *, 16> DefinedNonLazyCategories;

  /// Cached reference to the class for constant strings. This value has type
  /// int * but is actually an Obj-C class pointer.
  toolchain::WeakTrackingVH ConstantStringClassRef;

  /// The LLVM type corresponding to NSConstantString.
  toolchain::StructType *NSConstantStringType = nullptr;

  toolchain::StringMap<toolchain::GlobalVariable *> NSConstantStringMap;

  /// GetMethodVarName - Return a unique constant for the given
  /// selector's name. The return value has type char *.
  toolchain::Constant *GetMethodVarName(Selector Sel);
  toolchain::Constant *GetMethodVarName(IdentifierInfo *Ident);

  /// GetMethodVarType - Return a unique constant for the given
  /// method's type encoding string. The return value has type char *.

  // FIXME: This is a horrible name.
  toolchain::Constant *GetMethodVarType(const ObjCMethodDecl *D,
                                   bool Extended = false);
  toolchain::Constant *GetMethodVarType(const FieldDecl *D);

  /// GetPropertyName - Return a unique constant for the given
  /// name. The return value has type char *.
  toolchain::Constant *GetPropertyName(IdentifierInfo *Ident);

  // FIXME: This can be dropped once string functions are unified.
  toolchain::Constant *GetPropertyTypeString(const ObjCPropertyDecl *PD,
  ...
  toolchain::Constant *GetClassName(StringRef RuntimeName);

  toolchain::Function *GetMethodDefinition(const ObjCMethodDecl *MD);
  ...
  toolchain::Constant *BuildIvarLayout(const ObjCImplementationDecl *OI,
                                  CharUnits beginOffset, CharUnits endOffset,
                                  bool forStrongLayout, bool hasMRCWeakIvars);

  toolchain::Constant *BuildStrongIvarLayout(const ObjCImplementationDecl *OI,
                                        CharUnits beginOffset,
                                        CharUnits endOffset) {
    return BuildIvarLayout(OI, beginOffset, endOffset, true, false);
  }

  toolchain::Constant *BuildWeakIvarLayout(const ObjCImplementationDecl *OI,
                                      CharUnits beginOffset,
                                      CharUnits endOffset,
  ...
  void BuildRCRecordLayout(const toolchain::StructLayout *RecLayout,
                           const RecordDecl *RD,
  ...
  toolchain::Constant *getBitmapBlockLayout(bool ComputeByrefLayout);

  /// GetIvarLayoutName - Returns a unique constant for the given
  /// ivar layout bitmap.
  toolchain::Constant *GetIvarLayoutName(IdentifierInfo *Ident,
                                    const ObjCCommonTypesHelper &ObjCTypes);

  /// EmitPropertyList - Emit the given property list. The return
  /// value has type PropertyListPtrTy.
  toolchain::Constant *EmitPropertyList(Twine Name, const Decl *Container,
  ...
  toolchain::Constant *
  EmitProtocolMethodTypes(Twine Name, ArrayRef<toolchain::Constant *> MethodTypes,
                          const ObjCCommonTypesHelper &ObjCTypes);

  /// GetProtocolRef - Return a reference to the internal protocol
  /// description, creating an empty one if it has not been
  /// defined. The return value has type ProtocolPtrTy.
  toolchain::Constant *GetProtocolRef(const ObjCProtocolDecl *PD);

  /// Return a reference to the given Class using runtime calls rather than
  /// by a symbol reference.
  toolchain::Value *EmitClassRefViaRuntime(CodeGenFunction &CGF,
...
public:
  ...
  /// global to the "toolchain.used" list.
  ///
  ...
  ///   "toolchain.used".
  toolchain::GlobalVariable *CreateMetadataVar(Twine Name,
                                          ConstantStructBuilder &Init,
                                          StringRef Section, CharUnits Align,
                                          bool AddToUsed);
  toolchain::GlobalVariable *CreateMetadataVar(Twine Name, toolchain::Constant *Init,
                                          StringRef Section, CharUnits Align,
                                          bool AddToUsed);

  toolchain::GlobalVariable *CreateCStringLiteral(StringRef Name,
...
protected:
  CodeGen::RValue EmitMessageSend(CodeGen::CodeGenFunction &CGF,
                                  ...
                                  Selector Sel, toolchain::Value *Arg0,
...
public:
  ...
  toolchain::Function *GenerateDirectMethod(const ObjCMethodDecl *OMD,
                                       const ObjCContainerDecl *CD);

  void GenerateDirectMethodPrologue(CodeGenFunction &CGF, toolchain::Function *Fn,
                                    const ObjCMethodDecl *OMD,
  ...
  virtual toolchain::Constant *GetOrEmitProtocolRef(const ObjCProtocolDecl *PD) = 0;

  virtual toolchain::Constant *getNSConstantStringClassRef() = 0;

  toolchain::Constant *BuildGCBlockLayout(CodeGen::CodeGenModule &CGM,
                                     const CGBlockInfo &blockInfo) override;
  toolchain::Constant *BuildRCBlockLayout(CodeGen::CodeGenModule &CGM,
                                     const CGBlockInfo &blockInfo) override;
  std::string getRCBlockLayoutStr(CodeGen::CodeGenModule &CGM,
                                  const CGBlockInfo &blockInfo) override;

  toolchain::Constant *BuildByrefLayout(CodeGen::CodeGenModule &CGM,
                                   QualType T) override;
...
public:
  ...
  template <class Self>
  SmallVector<toolchain::Constant *, 8> emitExtendedTypesArray(Self *self) const {
    ...
    SmallVector<toolchain::Constant *, 8> result;
  ...
  template <class Self>
  toolchain::Constant *emitMethodList(Self *self, const ObjCProtocolDecl *PD,
                                 Kind kind) const {
...
private:
  ...
  toolchain::Constant *EmitModuleSymbols();
  ...
  toolchain::Constant *EmitClassExtension(const ObjCImplementationDecl *ID,
                                     CharUnits instanceSize,
                                     bool hasMRCWeakIvars, bool isMetaclass);

  /// EmitClassRef - Return a Value*, of type ObjCTypes.ClassPtrTy,
  /// for the given class.
  toolchain::Value *EmitClassRef(CodeGenFunction &CGF, const ObjCInterfaceDecl *ID);

  toolchain::Value *EmitClassRefFromId(CodeGenFunction &CGF, IdentifierInfo *II);

  toolchain::Value *EmitNSAutoreleasePoolClassRef(CodeGenFunction &CGF) override;

  /// EmitSuperClassRef - Emits reference to class's main metadata class.
  toolchain::Value *EmitSuperClassRef(const ObjCInterfaceDecl *ID);
  ...
  /// IvarListPtrTy.
  toolchain::Constant *EmitIvarList(const ObjCImplementationDecl *ID, bool ForClass);

  /// EmitMetaClass - Emit a forward reference to the class structure
  /// for the metaclass of the given interface. The return value has
  /// type ClassPtrTy.
  toolchain::Constant *EmitMetaClassRef(const ObjCInterfaceDecl *ID);

  /// EmitMetaClass - Emit a class structure for the metaclass of the
  /// given implementation. The return value has type ClassPtrTy.
  toolchain::Constant *EmitMetaClass(const ObjCImplementationDecl *ID,
                                toolchain::Constant *Protocols,
  ...
  toolchain::Constant *emitMethodList(Twine Name, MethodListType MLT,
                                 ArrayRef<const ObjCMethodDecl *> Methods);

  /// GetOrEmitProtocol - Get the protocol object for the given
  /// declaration, emitting it if necessary. The return value has type
  /// ProtocolPtrTy.
  toolchain::Constant *GetOrEmitProtocol(const ObjCProtocolDecl *PD) override;

  /// GetOrEmitProtocolRef - Get a forward reference to the protocol
  /// object for the given declaration, emitting it if needed. These
  /// forward references will be filled in with empty bodies if no
  /// definition is seen. The return value has type ProtocolPtrTy.
  toolchain::Constant *GetOrEmitProtocolRef(const ObjCProtocolDecl *PD) override;

  /// EmitProtocolExtension - Generate the protocol extension
  /// structure used to store optional instance and class methods, and
  /// protocol properties. The return value has type
  /// ProtocolExtensionPtrTy.
  toolchain::Constant *EmitProtocolExtension(const ObjCProtocolDecl *PD,
                                        const ProtocolMethodLists &methodLists);

  /// EmitProtocolList - Generate the list of referenced
  /// protocols. The return value has type ProtocolListPtrTy.
  toolchain::Constant *EmitProtocolList(Twine Name,
                                   ObjCProtocolDecl::protocol_iterator begin,
                                   ObjCProtocolDecl::protocol_iterator end);

  /// EmitSelector - Return a Value*, of type ObjCTypes.SelectorPtrTy,
  /// for the given selector.
  toolchain::Value *EmitSelector(CodeGenFunction &CGF, Selector Sel);
  ConstantAddress EmitSelectorAddr(Selector Sel);

public:
  CGObjCMac(CodeGen::CodeGenModule &cgm);

  toolchain::Constant *getNSConstantStringClassRef() override;

  toolchain::Function *ModuleInitFunction() override;
  ...
  CodeGen::RValue GenerateMessageSendSuper(
      ...
      bool isCategoryImpl, toolchain::Value *Receiver, bool IsClassMessage,
      const CallArgList &CallArgs, const ObjCMethodDecl *Method) override;

  toolchain::Value *GetClass(CodeGenFunction &CGF,
                        const ObjCInterfaceDecl *ID) override;

  toolchain::Value *GetSelector(CodeGenFunction &CGF, Selector Sel) override;
  Address GetAddrOfSelector(CodeGenFunction &CGF, Selector Sel) override;

  /// The NeXT/Apple runtimes do not support typed selectors; just emit an
  /// untyped one.
  toolchain::Value *GetSelector(CodeGenFunction &CGF,
                           const ObjCMethodDecl *Method) override;

  toolchain::Constant *GetEHType(QualType T) override;
  ...
  toolchain::Value *GenerateProtocolRef(CodeGenFunction &CGF,
                                   const ObjCProtocolDecl *PD) override;

  toolchain::FunctionCallee GetPropertyGetFunction() override;
  toolchain::FunctionCallee GetPropertySetFunction() override;
  toolchain::FunctionCallee GetOptimizedPropertySetFunction(bool atomic,
                                                       bool copy) override;
  toolchain::FunctionCallee GetGetStructFunction() override;
  toolchain::FunctionCallee GetSetStructFunction() override;
  toolchain::FunctionCallee GetCppAtomicObjectGetFunction() override;
  toolchain::FunctionCallee GetCppAtomicObjectSetFunction() override;
  toolchain::FunctionCallee EnumerationMutationFunction() override;
  ...
  toolchain::Value *EmitObjCWeakRead(CodeGen::CodeGenFunction &CGF,
                                Address AddrWeakObj) override;
  void EmitObjCWeakAssign(CodeGen::CodeGenFunction &CGF, toolchain::Value *src,
                          Address dst) override;
  void EmitObjCGlobalAssign(CodeGen::CodeGenFunction &CGF, toolchain::Value *src,
                            Address dest, bool threadlocal = false) override;
  void EmitObjCIvarAssign(CodeGen::CodeGenFunction &CGF, toolchain::Value *src,
                          Address dest, toolchain::Value *ivarOffset) override;
  void EmitObjCStrongCastAssign(CodeGen::CodeGenFunction &CGF, toolchain::Value *src,
                                Address dest) override;
  void EmitGCMemmoveCollectable(CodeGen::CodeGenFunction &CGF, Address dest,
                                Address src, toolchain::Value *size) override;

  LValue EmitObjCValueForIvar(CodeGen::CodeGenFunction &CGF, QualType ObjectTy,
                              toolchain::Value *BaseValue, const ObjCIvarDecl *Ivar,
                              unsigned CVRQualifiers) override;
  toolchain::Value *EmitIvarOffset(CodeGen::CodeGenFunction &CGF,
...
private:
  ...
  toolchain::GlobalVariable *ObjCEmptyCacheVar;
  toolchain::Constant *ObjCEmptyVtableVar;

  /// SuperClassReferences - uniqued super class references.
  toolchain::DenseMap<IdentifierInfo *, toolchain::GlobalVariable *> SuperClassReferences;

  /// MetaClassReferences - uniqued meta class references.
  toolchain::DenseMap<IdentifierInfo *, toolchain::GlobalVariable *> MetaClassReferences;

  /// EHTypeReferences - uniqued class ehtype references.
  toolchain::DenseMap<IdentifierInfo *, toolchain::GlobalVariable *> EHTypeReferences;

  /// VTableDispatchMethods - List of methods for which we generate
  /// vtable-based message dispatch.
  toolchain::DenseSet<Selector> VTableDispatchMethods;

  /// DefinedMetaClasses - List of defined meta-classes.
  std::vector<toolchain::GlobalValue *> DefinedMetaClasses;
  ...
  void AddModuleClassList(ArrayRef<toolchain::GlobalValue *> Container,
  ...
  BuildClassObject(const ObjCInterfaceDecl *CI, bool isMetaclass,
                   toolchain::Constant *IsAGV, toolchain::Constant *SuperClassGV,
                   toolchain::Constant *ClassRoGV, bool HiddenVisibility);
  ...
  /// interface ivars will be emitted. The return value has type
  /// IvarListnfABIPtrTy.
  toolchain::Constant *EmitIvarList(const ObjCImplementationDecl *ID);

  toolchain::Constant *EmitIvarOffsetVar(const ObjCInterfaceDecl *ID,
  ...
  CodeGen::RValue EmitVTableMessageSend(
      CodeGen::CodeGenFunction &CGF, ReturnValueSlot Return,
      QualType ResultType, Selector Sel, toolchain::Value *Receiver, QualType Arg0Ty,
      bool IsSuper, const CallArgList &CallArgs, const ObjCMethodDecl *Method);

  /// GetClassGlobal - Return the global variable for the Objective-C
  /// class of the given name.
  toolchain::Constant *GetClassGlobal(StringRef Name,
                                 ForDefinition_t IsForDefinition,
                                 bool Weak = false, bool DLLImport = false);
  toolchain::Constant *GetClassGlobal(const ObjCInterfaceDecl *ID, bool isMetaclass,
                                 ForDefinition_t isForDefinition);

  toolchain::Constant *GetClassGlobalForClassRef(const ObjCInterfaceDecl *ID);

  toolchain::Value *EmitLoadOfClassRef(CodeGenFunction &CGF,
                                  const ObjCInterfaceDecl *ID,
                                  toolchain::GlobalVariable *Entry);
  ...
  toolchain::Value *EmitSuperClassRef(CodeGenFunction &CGF,
                                 const ObjCInterfaceDecl *ID);

  /// EmitMetaClassRef - Return a Value * of the address of _class_t
  /// meta-data
  toolchain::Value *EmitMetaClassRef(CodeGenFunction &CGF,
                                const ObjCInterfaceDecl *ID, bool Weak);

  /// ObjCIvarOffsetVariable - Returns the ivar offset variable for
  /// the given ivar.
  ///
  toolchain::GlobalVariable *ObjCIvarOffsetVariable(const ObjCInterfaceDecl *ID,
                                               const ObjCIvarDecl *Ivar);
  ...
  toolchain::Constant *GetInterfaceEHType(const ObjCInterfaceDecl *ID,
                                     ForDefinition_t IsForDefinition);
...
struct NullReturnState {
  ...
  void init(CodeGenFunction &CGF, toolchain::Value *receiver) {
    ...
    toolchain::Value *isNull = CGF.Builder.CreateIsNull(receiver);
  ...
  RValue complete(CodeGenFunction &CGF, ReturnValueSlot returnSlot,
    ...
    toolchain::BasicBlock *contBB = nullptr;

    // Finish the call path.
    toolchain::BasicBlock *callBB = CGF.Builder.GetInsertBlock();
    if (callBB) {
    ...
    if (result.isScalar()) {
      ...
      CGF.EmitBlock(contBB);
      toolchain::PHINode *phi = CGF.Builder.CreatePHI(null->getType(), 2);
    ...
    toolchain::Type *scalarTy = callResult.first->getType();
    toolchain::Constant *scalarZero = toolchain::Constant::getNullValue(scalarTy);

    // Build phis for both coordinates.
    toolchain::PHINode *real = CGF.Builder.CreatePHI(scalarTy, 2);
    real->addIncoming(callResult.first, callBB);
    real->addIncoming(scalarZero, NullBB);
    toolchain::PHINode *imag = CGF.Builder.CreatePHI(scalarTy, 2);
...
static toolchain::Constant *getConstantGEP(toolchain::LLVMContext &VMContext,
                                      toolchain::GlobalVariable *C, unsigned idx0,
                                      unsigned idx1) {
  toolchain::Value *Idxs[] = {
      toolchain::ConstantInt::get(toolchain::Type::getInt32Ty(VMContext), idx0),
      toolchain::ConstantInt::get(toolchain::Type::getInt32Ty(VMContext), idx1)};
  return toolchain::ConstantExpr::getGetElementPtr(C->getValueType(), C, Idxs);
}
...
finishAndCreateGlobal(ConstantInitBuilder::StructBuilder &Builder,
                      const toolchain::Twine &Name, CodeGenModule &CGM) {
...
/// decl.
toolchain::Value *CGObjCMac::GetClass(CodeGenFunction &CGF,
                                 const ObjCInterfaceDecl *ID) {
  return EmitClassRef(CGF, ID);
}

/// GetSelector - Return the pointer to the unique'd string for this selector.
toolchain::Value *CGObjCMac::GetSelector(CodeGenFunction &CGF, Selector Sel) {
  return EmitSelector(CGF, Sel);
}
Address CGObjCMac::GetAddrOfSelector(CodeGenFunction &CGF, Selector Sel) {
  return EmitSelectorAddr(Sel);
}
toolchain::Value *CGObjCMac::GetSelector(CodeGenFunction &CGF,
                                    const ObjCMethodDecl *Method) {
  return EmitSelector(CGF, Method->getSelector());
}

toolchain::Constant *CGObjCMac::GetEHType(QualType T) {
  ...
  toolchain_unreachable("asking for catch type for ObjC type in fragile runtime");
}
...
GetConstantStringEntry(toolchain::StringMap<toolchain::GlobalVariable *> &Map,
...
toolchain::Constant *CGObjCMac::getNSConstantStringClassRef() {
  if (toolchain::Value *V = ConstantStringClassRef)
    return cast<toolchain::Constant>(V);
  ...
  toolchain::Type *PTy = toolchain::ArrayType::get(CGM.IntTy, 0);
  auto GV = CGM.CreateRuntimeVariable(PTy, str);
  ConstantStringClassRef = GV;
  return GV;
}

toolchain::Constant *CGObjCNonFragileABIMac::getNSConstantStringClassRef() {
  if (toolchain::Value *V = ConstantStringClassRef)
    return cast<toolchain::Constant>(V);
  ...
  toolchain::Constant *GV = GetClassGlobal(str, NotForDefinition);
  ConstantStringClassRef = GV;
  return GV;
}
...
CGObjCCommonMac::GenerateConstantNSString(const StringLiteral *Literal) {
  ...
  toolchain::Constant *Class = getNSConstantStringClassRef();

  // If we don't already have it, construct the type for a constant NSString.
  if (!NSConstantStringType) {
    NSConstantStringType =
        toolchain::StructType::create({CGM.UnqualPtrTy, CGM.Int8PtrTy, CGM.IntTy},
                                 "struct.__builtin_NSString");
  }
  ...
  toolchain::Constant *C =
      toolchain::ConstantDataArray::getString(VMContext, Entry.first());

  toolchain::GlobalValue::LinkageTypes Linkage = toolchain::GlobalValue::PrivateLinkage;
  bool isConstant = !CGM.getLangOpts().WritableStrings;

  auto *GV = new toolchain::GlobalVariable(CGM.getModule(), C->getType(), isConstant,
                                      Linkage, C, ".str");
  GV->setUnnamedAddr(toolchain::GlobalValue::UnnamedAddr::Global);
  // Don't enforce the target's minimum global alignment, since the only use
  // of the string is via this class initializer.
  GV->setAlignment(toolchain::Align(1));
  Fields.add(GV);
...
CodeGen::RValue CGObjCMac::GenerateMessageSendSuper(
    ...
    toolchain::Value *Receiver, bool IsClassMessage,
  ...
  toolchain::Value *ReceiverAsObject =
      CGF.Builder.CreateBitCast(Receiver, ObjCTypes.ObjectPtrTy);
  CGF.Builder.CreateStore(ReceiverAsObject,
                          CGF.Builder.CreateStructGEP(ObjCSuper, 0));

  // If this is a class message the metaclass is passed as the target.
  toolchain::Type *ClassTyPtr = toolchain::PointerType::getUnqual(VMContext);
  toolchain::Value *Target;
  if (IsClassMessage) {
    if (isCategoryImpl) {
      ...
      toolchain::Constant *MetaClassPtr = EmitMetaClassRef(Class);
      toolchain::Value *SuperPtr =
          CGF.Builder.CreateStructGEP(ObjCTypes.ClassTy, MetaClassPtr, 1);
      toolchain::Value *Super = CGF.Builder.CreateAlignedLoad(ClassTyPtr, SuperPtr,
                                                         CGF.getPointerAlign());
      Target = Super;
    }
    ...
    toolchain::Value *ClassPtr = EmitSuperClassRef(Class);
...
CodeGen::RValue CGObjCMac::GenerateMessageSend(
    CodeGen::CodeGenFunction &CGF, ReturnValueSlot Return, QualType ResultType,
    Selector Sel, toolchain::Value *Receiver, const CallArgList &CallArgs,
...
CodeGen::RValue CGObjCCommonMac::EmitMessageSend(
    CodeGen::CodeGenFunction &CGF, ReturnValueSlot Return, QualType ResultType,
    Selector Sel, toolchain::Value *Arg0, QualType Arg0Ty, bool IsSuper,
    const CallArgList &CallArgs, const ObjCMethodDecl *Method,
    const ObjCInterfaceDecl *ClassReceiver,
    const ObjCCommonTypesHelper &ObjCTypes) {
  CodeGenTypes &Types = CGM.getTypes();
  auto selTy = CGF.getContext().getObjCSelType();
  toolchain::Value *SelValue = toolchain::UndefValue::get(Types.ConvertType(selTy));
  ...
  toolchain::FunctionCallee Fn = nullptr;
  if (Method && Method->isDirectMethod()) {
    assert(!IsSuper);
  ...
  toolchain::Constant *BitcastFn = cast<toolchain::Constant>(
...
static Qualifiers::GC GetGCAttrTypeForType(ASTContext &Ctx, QualType FQT,
  ...
  if (auto ownership = FQT.getObjCLifetime()) {
    ...
    case Qualifiers::OCL_Autoreleasing:
      toolchain_unreachable("autoreleasing ivar?");
    case Qualifiers::OCL_None:
      toolchain_unreachable("known nonzero");
    }
    toolchain_unreachable("bad objc ownership");
  }
...
class IvarLayoutBuilder {
  ...
  toolchain::SmallVector<IvarInfo, 8> IvarsInfo;
...
public:
  ...
  toolchain::Constant *buildBitmap(CGObjCCommonMac &CGObjC,
                              toolchain::SmallVectorImpl<unsigned char> &buffer);
...
CGObjCCommonMac::BuildGCBlockLayout(CodeGenModule &CGM,
  ...
  toolchain::Constant *nullPtr = toolchain::Constant::getNullValue(CGM.Int8PtrTy);
  ...
  toolchain::SmallVector<unsigned char, 32> buffer;
  toolchain::Constant *C = builder.buildBitmap(*this, buffer);
...
void CGObjCCommonMac::BuildRCRecordLayout(const toolchain::StructLayout *RecLayout,
                                          const RecordDecl *RD,
                                          ArrayRef<const FieldDecl *> RecFields,
...
void CGObjCCommonMac::BuildRCBlockVarRecordLayout(const RecordType *RT,
  ...
  toolchain::Type *Ty = CGM.getTypes().ConvertType(QualType(RT, 0));
  const toolchain::StructLayout *RecLayout =
      CGM.getDataLayout().getStructLayout(cast<toolchain::StructType>(Ty));
...
toolchain::Constant *CGObjCCommonMac::getBitmapBlockLayout(bool ComputeByrefLayout) {
  toolchain::Constant *nullPtr = toolchain::Constant::getNullValue(CGM.Int8PtrTy);
  ...
  toolchain::array_pod_sort(RunSkipBlockVars.begin(), RunSkipBlockVars.end());
  ...
  if (Result != 0) {
    ...
    return toolchain::ConstantInt::get(CGM.IntPtrTy, Result);
  }
...
static std::string getBlockLayoutInfoString(
  ...
  for (const CGObjCCommonMac::RUN_SKIP &R : RunSkipBlockVars) {
    ...
    Str += toolchain::to_string(R.block_var_bytepos.getQuantity());
    Str += "l" + toolchain::to_string(R.block_var_size.getQuantity());
  }
  return Str;
}
...
toolchain::Constant *CGObjCCommonMac::BuildByrefLayout(CodeGen::CodeGenModule &CGM,
                                                  QualType T) {
  assert(CGM.getLangOpts().getGC() == LangOptions::NonGC);
  ...
  if (const RecordType *record = T->getAs<RecordType>()) {
    BuildRCBlockVarRecordLayout(record, fieldOffset, hasUnion,
                                true /*ByrefLayout */);
    toolchain::Constant *Result = getBitmapBlockLayout(true);
    if (isa<toolchain::ConstantInt>(Result))
      Result = toolchain::ConstantExpr::getIntToPtr(Result, CGM.Int8PtrTy);
    return Result;
  }
  toolchain::Constant *nullPtr = toolchain::Constant::getNullValue(CGM.Int8PtrTy);
  return nullPtr;
...
toolchain::Value *CGObjCMac::GenerateProtocolRef(CodeGenFunction &CGF,
...
toolchain::Constant *CGObjCCommonMac::GetProtocolRef(const ObjCProtocolDecl *PD) {
...
CGObjCCommonMac::EmitClassRefViaRuntime(CodeGenFunction &CGF,
                                        const ObjCInterfaceDecl *ID,
                                        ObjCCommonTypesHelper &ObjCTypes) {
  toolchain::FunctionCallee lookUpClassFn = ObjCTypes.getLookUpClassFn();

  toolchain::Value *className = CGF.CGM
  ...
  toolchain::CallInst *call = CGF.Builder.CreateCall(lookUpClassFn, className);
...
*/
toolchain::Constant *CGObjCMac::GetOrEmitProtocol(const ObjCProtocolDecl *PD) {
  toolchain::GlobalVariable *Entry = Protocols[PD->getIdentifier()];
  ...
  if (Entry) {
    ...
    Entry = values.finishAndCreateGlobal(
        ...
        /*constant*/ false, toolchain::GlobalValue::PrivateLinkage);
...
toolchain::Constant *CGObjCMac::GetOrEmitProtocolRef(const ObjCProtocolDecl *PD) {
  toolchain::GlobalVariable *&Entry = Protocols[PD->getIdentifier()];
  ...
  if (!Entry) {
    ...
    Entry = new toolchain::GlobalVariable(CGM.getModule(), ObjCTypes.ProtocolTy,
                                     false, toolchain::GlobalValue::PrivateLinkage,
                                     nullptr, "OBJC_PROTOCOL_" + PD->getName());
    Entry->setSection("__OBJC,__protocol,regular,no_dead_strip");
    // FIXME: Is this necessary? Why only for protocol?
    Entry->setAlignment(toolchain::Align(4));
  }
...
CGObjCMac::EmitProtocolExtension(const ObjCProtocolDecl *PD,
  ...
  if (optInstanceMethods->isNullValue() && optClassMethods->isNullValue() &&
    ...
    return toolchain::Constant::getNullValue(ObjCTypes.ProtocolExtensionPtrTy);
  }
  ...
  // No special section, but goes in toolchain.used
...
CGObjCMac::EmitProtocolList(Twine name,
  ...
  if (PDs.empty())
    return toolchain::Constant::getNullValue(ObjCTypes.ProtocolListPtrTy);
...
static void PushProtocolProperties(
    toolchain::SmallPtrSet<const IdentifierInfo *, 16> &PropertySet,
...
*/
toolchain::Constant *CGObjCCommonMac::EmitPropertyList(
  ...
  if (IsClassProperty) {
    ...
    const toolchain::Triple &Triple = CGM.getTarget().getTriple();
    if ((Triple.isMacOSX() && Triple.isMacOSXVersionLT(10, 11)) ||
        (Triple.isiOS() && Triple.isOSVersionLT(9)))
      return toolchain::Constant::getNullValue(ObjCTypes.PropertyListPtrTy);
  }
...
toolchain::Constant *CGObjCCommonMac::EmitProtocolMethodTypes(
    Twine Name, ArrayRef<toolchain::Constant *> MethodTypes,
    const ObjCCommonTypesHelper &ObjCTypes) {
  // Return null for empty list.
  if (MethodTypes.empty())
    return toolchain::Constant::getNullValue(ObjCTypes.Int8PtrPtrTy);

  toolchain::ArrayType *AT =
      toolchain::ArrayType::get(ObjCTypes.Int8PtrTy, MethodTypes.size());
  toolchain::Constant *Init = toolchain::ConstantArray::get(AT, MethodTypes);
...
void CGObjCMac::GenerateCategory(const ObjCCategoryImplDecl *OCD) {
  ...
  toolchain::raw_svector_ostream(ExtName)
  ...
  toolchain::GlobalVariable *GV = CreateMetadataVar(
      "OBJC_CATEGORY_" + ExtName.str(), Values,
      "__OBJC,__category,regular,no_dead_strip", CGM.getPointerAlign(), true);
  DefinedCategories.push_back(GV);
  DefinedCategoryNames.insert(toolchain::CachedHashString(ExtName));
...
void CGObjCMac::GenerateClass(const ObjCImplementationDecl *ID) {
  ...
  toolchain::GlobalVariable *GV = CGM.getModule().getGlobalVariable(Name, true);
  if (GV) {
...
toolchain::Constant *CGObjCMac::EmitMetaClassRef(const ObjCInterfaceDecl *ID) {
  ...
  toolchain::GlobalVariable *GV = CGM.getModule().getGlobalVariable(Name, true);
  if (!GV)
    GV = new toolchain::GlobalVariable(CGM.getModule(), ObjCTypes.ClassTy, false,
...
toolchain::Value *CGObjCMac::EmitSuperClassRef(const ObjCInterfaceDecl *ID) {
...
*/
toolchain::Constant *CGObjCMac::EmitClassExtension(const ObjCImplementationDecl *ID,
                                              CharUnits InstanceSize,
                                              bool hasMRCWeakIvars,
                                              bool isMetaclass) {
  // Weak ivar layout.
  toolchain::Constant *layout;
  if (isMetaclass) {
    layout = toolchain::ConstantPointerNull::get(CGM.Int8PtrTy);
  } else {
  ...
  // Properties.
  toolchain::Constant *propertyList =
  ...
  if (layout->isNullValue() && propertyList->isNullValue()) {
    return toolchain::Constant::getNullValue(ObjCTypes.ClassExtensionPtrTy);
  }
...
*/
toolchain::Constant *CGObjCMac::EmitIvarList(const ObjCImplementationDecl *ID,
                                        bool ForClass) {
  ...
  // for the class.
  if (ForClass)
    return toolchain::Constant::getNullValue(ObjCTypes.IvarListPtrTy);
...
void CGObjCMac::emitMethodConstant(ConstantArrayBuilder &builder,
                                   const ObjCMethodDecl *MD) {
  toolchain::Function *fn = GetMethodDefinition(MD);
...
CGObjCMac::emitMethodList(Twine name, MethodListType MLT,
  ...
  // Return null for empty list.
  if (methods.empty())
    return toolchain::Constant::getNullValue(
  ...
  if (forProtocol) {
    ...
    toolchain::GlobalVariable *GV = CreateMetadataVar(prefix + name, values, section,
                                                 CGM.getPointerAlign(), true);
    return GV;
  }
...
toolchain::Function *CGObjCCommonMac::GenerateMethod(const ObjCMethodDecl *OMD,
                                                const ObjCContainerDecl *CD) {
  toolchain::Function *Method;
  ...
  if (OMD->isDirectMethod()) {
    ...
    CodeGenTypes &Types = CGM.getTypes();
    toolchain::FunctionType *MethodTy =
        Types.GetFunctionType(Types.arrangeObjCMethodDeclaration(OMD));
    Method = toolchain::Function::Create(
        MethodTy, toolchain::GlobalValue::InternalLinkage, Name, &CGM.getModule());
  }
...
CGObjCCommonMac::GenerateDirectMethod(const ObjCMethodDecl *OMD,
  ...
  toolchain::Function *OldFn = nullptr, *Fn = nullptr;
  ...
  if (OldFn) {
    Fn = toolchain::Function::Create(MethodTy, toolchain::GlobalValue::ExternalLinkage,
                                "", &CGM.getModule());
    Fn->takeName(OldFn);
...
void CGObjCCommonMac::GenerateDirectMethodPrologue(
    CodeGenFunction &CGF, toolchain::Function *Fn, const ObjCMethodDecl *OMD,
    const ObjCContainerDecl *CD) {
  ...
  if (ReceiverCanBeNull) {
    toolchain::BasicBlock *SelfIsNilBlock =
        CGF.createBasicBlock("objc_direct_method.self_is_nil");
    toolchain::BasicBlock *ContBlock =
        CGF.createBasicBlock("objc_direct_method.cont");

    // if (self == nil) {
    auto selfTy = cast<toolchain::PointerType>(selfValue->getType());
    auto Zero = toolchain::ConstantPointerNull::get(selfTy);

    toolchain::MDBuilder MDHelper(CGM.getLLVMContext());
...
toolchain::GlobalVariable *CGObjCCommonMac::CreateMetadataVar(Twine Name,
                                                         toolchain::Constant *Init,
                                                         StringRef Section,
                                                         CharUnits Align,
                                                         bool AddToUsed) {
  toolchain::Type *Ty = Init->getType();
  toolchain::GlobalValue::LinkageTypes LT =
      getLinkageTypeForObjCMetadata(CGM, Section);
  toolchain::GlobalVariable *GV =
      new toolchain::GlobalVariable(CGM.getModule(), Ty, false, LT, Init, Name);
  if (!Section.empty())
    GV->setSection(Section);
...
CGObjCCommonMac::CreateCStringLiteral(StringRef Name, ObjCLabelType Type,
  ...
  toolchain::Constant *Value =
      toolchain::ConstantDataArray::getString(VMContext, Name, NullTerminate);
  toolchain::GlobalVariable *GV = new toolchain::GlobalVariable(
      CGM.getModule(), Value->getType(),
      /*isConstant=*/true, toolchain::GlobalValue::PrivateLinkage, Value, Label);
  if (CGM.getTriple().isOSBinFormatMachO())
    GV->setSection(Section);
  GV->setUnnamedAddr(toolchain::GlobalValue::UnnamedAddr::Global);
...
toolchain::Function *CGObjCMac::ModuleInitFunction() {
  // Abuse this interface function as a place to finalize.
  FinishModule();
  return nullptr;
}

toolchain::FunctionCallee CGObjCMac::GetPropertyGetFunction() {
  return ObjCTypes.getGetPropertyFn();
}

toolchain::FunctionCallee CGObjCMac::GetPropertySetFunction() {
  return ObjCTypes.getSetPropertyFn();
}

toolchain::FunctionCallee CGObjCMac::GetOptimizedPropertySetFunction(bool atomic,
                                                                bool copy) {
  return ObjCTypes.getOptimizedSetPropertyFn(atomic, copy);
}

toolchain::FunctionCallee CGObjCMac::GetGetStructFunction() {
  return ObjCTypes.getCopyStructFn();
}

toolchain::FunctionCallee CGObjCMac::GetSetStructFunction() {
  return ObjCTypes.getCopyStructFn();
}

toolchain::FunctionCallee CGObjCMac::GetCppAtomicObjectGetFunction() {
  return ObjCTypes.getCppAtomicObjectFunction();
}

toolchain::FunctionCallee CGObjCMac::GetCppAtomicObjectSetFunction() {
  return ObjCTypes.getCppAtomicObjectFunction();
}

toolchain::FunctionCallee CGObjCMac::EnumerationMutationFunction() {
  return ObjCTypes.getEnumerationMutationFn();
}
...
struct PerformFragileFinally final : EHScopeStack::Cleanup {
  ...
  void Emit(CodeGenFunction &CGF, Flags flags) override {
    ...
    toolchain::BasicBlock *FinallyCallExit =
        CGF.createBasicBlock("finally.call_exit");
    toolchain::BasicBlock *FinallyNoCallExit =
    ...
    if (isa<ObjCAtTryStmt>(S)) {
      if (const ObjCAtFinallyStmt *FinallyStmt =
        ...
        toolchain::Value *CurCleanupDest =
      ...
      // @synchronized.
      toolchain::Value *SyncArg = CGF.Builder.CreateLoad(SyncArgSlot);
...
class FragileHazards {
  CodeGenFunction &CGF;
  SmallVector<toolchain::Value *, 20> Locals;
  toolchain::DenseSet<toolchain::BasicBlock *> BlocksBeforeTry;

  toolchain::InlineAsm *ReadHazard;
  toolchain::InlineAsm *WriteHazard;

  toolchain::FunctionType *GetAsmFnType();
...
FragileHazards::FragileHazards(CodeGenFunction &CGF) : CGF(CGF) {
  ...
  for (toolchain::BasicBlock &BB : *CGF.CurFn)
    BlocksBeforeTry.insert(&BB);

  toolchain::FunctionType *AsmFnTy = GetAsmFnType();
  ...
  // catch block if the call throws.
  {
    ...
    ReadHazard = toolchain::InlineAsm::get(AsmFnTy, "", Constraint, true, false);
  }
  ...
  // variables might have been written within the protected scope.
  {
    ...
    WriteHazard = toolchain::InlineAsm::get(AsmFnTy, "", Constraint, true, false);
  }
}
...
void FragileHazards::emitWriteHazard() {
  ...
  toolchain::CallInst *Call = CGF.EmitNounwindRuntimeCall(WriteHazard, Locals);
  for (auto Pair : toolchain::enumerate(Locals))
    Call->addParamAttr(
        Pair.index(),
        toolchain::Attribute::get(
            CGF.getLLVMContext(), toolchain::Attribute::ElementType,
            cast<toolchain::AllocaInst>(Pair.value())->getAllocatedType()));
}

void FragileHazards::emitReadHazard(CGBuilderTy &Builder) {
  assert(!Locals.empty());
  toolchain::CallInst *call = Builder.CreateCall(ReadHazard, Locals);
  call->setDoesNotThrow();
  ...
  for (auto Pair : toolchain::enumerate(Locals))
    call->addParamAttr(
        Pair.index(),
        toolchain::Attribute::get(
            Builder.getContext(), toolchain::Attribute::ElementType,
            cast<toolchain::AllocaInst>(Pair.value())->getAllocatedType()));
}
...
void FragileHazards::emitHazardsInNewBlocks() {
  ...
  for (toolchain::BasicBlock &BB : *CGF.CurFn) {
    ...
    for (toolchain::BasicBlock::iterator BI = BB.begin(), BE = BB.end(); BI != BE;
         ++BI) {
      toolchain::Instruction &I = *BI;

      // Ignore instructions that aren't non-intrinsic calls.
      // These are the only calls that can possibly call longjmp.
      if (!isa<toolchain::CallInst>(I) && !isa<toolchain::InvokeInst>(I))
        continue;
      if (isa<toolchain::IntrinsicInst>(I))
        continue;

      // Ignore call sites marked nounwind.  This may be questionable,
      // since 'nounwind' doesn't necessarily mean 'does not call longjmp'.
      if (cast<toolchain::CallBase>(I).doesNotThrow())
        continue;
...
static void addIfPresent(toolchain::DenseSet<toolchain::Value *> &S, Address V) {
  if (V.isValid())
    if (toolchain::Value *Ptr = V.getBasePointer())
      S.insert(Ptr);
}

void FragileHazards::collectLocals() {
  // Compute a set of allocas to ignore.
  toolchain::DenseSet<toolchain::Value *> AllocasToIgnore;
  addIfPresent(AllocasToIgnore, CGF.ReturnValue);
  addIfPresent(AllocasToIgnore, CGF.NormalCleanupDest);

  // Collect all the allocas currently in the function.  This is
  // probably way too aggressive.
  toolchain::BasicBlock &Entry = CGF.CurFn->getEntryBlock();
  for (toolchain::Instruction &I : Entry)
    if (isa<toolchain::AllocaInst>(I) && !AllocasToIgnore.count(&I))
      Locals.push_back(&I);
}

toolchain::FunctionType *FragileHazards::GetAsmFnType() {
  SmallVector<toolchain::Type *, 16> tys(Locals.size());
  for (unsigned i = 0, e = Locals.size(); i != e; ++i)
    tys[i] = Locals[i]->getType();
  return toolchain::FunctionType::get(CGF.VoidTy, tys, false);
}
...
void CGObjCMac::EmitTryOrSynchronizedStmt(CodeGen::CodeGenFunction &CGF,
  ...
  toolchain::Constant *Zero = toolchain::ConstantInt::get(CGF.Builder.getInt32Ty(), 0);
  toolchain::Value *GEPIndexes[] = {Zero, Zero, Zero};
  toolchain::Value *SetJmpBuffer = CGF.Builder.CreateGEP(
      ObjCTypes.ExceptionDataTy, ExceptionData.emitRawPointer(CGF), GEPIndexes,
      "setjmp_buffer");
  toolchain::CallInst *SetJmpResult = CGF.EmitNounwindRuntimeCall(
      ObjCTypes.getSetJmpFn(), SetJmpBuffer, "setjmp_result");
  SetJmpResult->setCanReturnTwice();

  // If setjmp returned 0, enter the protected block; otherwise,
  // branch to the handler.
  toolchain::BasicBlock *TryBlock = CGF.createBasicBlock("try");
  toolchain::BasicBlock *TryHandler = CGF.createBasicBlock("try.handler");
  toolchain::Value *DidCatch =
  ...
  // Otherwise, we have to match against the caught exceptions.
    ...
    toolchain::CallInst *Caught = CGF.EmitNounwindRuntimeCall(
    ...
    toolchain::BasicBlock *CatchBlock = nullptr;
    toolchain::BasicBlock *CatchHandler = nullptr;
    if (HasFinally) {
    ...
    for (const ObjCAtCatchStmt *CatchStmt : AtTryStmt->catch_stmts()) {
      ...
      toolchain::Value *Class = EmitClassRef(CGF, IDecl);

      toolchain::Value *matchArgs[] = {Class, Caught};
      toolchain::CallInst *Match = CGF.EmitNounwindRuntimeCall(
          ObjCTypes.getExceptionMatchFn(), matchArgs, "match");

      toolchain::BasicBlock *MatchedBlock = CGF.createBasicBlock("match");
      toolchain::BasicBlock *NextCatchBlock = CGF.createBasicBlock("catch.next");
      ...
      toolchain::Value *Tmp = CGF.Builder.CreateBitCast(
    ...
    if (HasFinally) {
      ...
      toolchain::CallInst *NewCaught = CGF.EmitNounwindRuntimeCall(
          ObjCTypes.getExceptionExtractFn(), ExceptionData.emitRawPointer(CGF),
          "caught");
  ...
  if (CGF.HaveInsertPoint()) {
    ...
    toolchain::Value *PropagatingExn;
...
void CGObjCMac::EmitThrowStmt(CodeGen::CodeGenFunction &CGF,
  ...
  toolchain::Value *ExceptionAsObject;

  if (const Expr *ThrowExpr = S.getThrowExpr()) {
    toolchain::Value *Exception = CGF.EmitObjCThrowOperand(ThrowExpr);
    ExceptionAsObject =
...
///
toolchain::Value *CGObjCMac::EmitObjCWeakRead(CodeGen::CodeGenFunction &CGF,
                                         Address AddrWeakObj) {
  toolchain::Type *DestTy = AddrWeakObj.getElementType();
  toolchain::Value *AddrWeakObjVal = CGF.Builder.CreateBitCast(
      AddrWeakObj.emitRawPointer(CGF), ObjCTypes.PtrObjectPtrTy);
  toolchain::Value *read_weak = CGF.EmitNounwindRuntimeCall(
...
void CGObjCMac::EmitObjCWeakAssign(CodeGen::CodeGenFunction &CGF,
                                   toolchain::Value *src, Address dst) {
  toolchain::Type *SrcTy = src->getType();
  if (!isa<toolchain::PointerType>(SrcTy)) {
  ...
  toolchain::Value *dstVal = CGF.Builder.CreateBitCast(dst.emitRawPointer(CGF),
                                                  ObjCTypes.PtrObjectPtrTy);
  toolchain::Value *args[] = {src, dstVal};
...
void CGObjCMac::EmitObjCIvarAssign(CodeGen::CodeGenFunction &CGF,
  ...
  toolchain::Value *dstVal = CGF.Builder.CreateBitCast(dst.emitRawPointer(CGF),
                                                  ObjCTypes.PtrObjectPtrTy);
  toolchain::Value *args[] = {src, dstVal, ivarOffset};
...
void CGObjCMac::EmitGCMemmoveCollectable(CodeGen::CodeGenFunction &CGF,
  ...
  toolchain::Value *args[] = {DestPtr.emitRawPointer(CGF),
...
toolchain::Value *CGObjCMac::EmitIvarOffset(CodeGen::CodeGenFunction &CGF,
                                       const ObjCInterfaceDecl *Interface,
                                       const ObjCIvarDecl *Ivar) {
...
std::string CGObjCCommonMac::GetSectionName(StringRef Section,
  ...
  case toolchain::Triple::UnknownObjectFormat:
    toolchain_unreachable("unexpected object file format");
  ...
  toolchain_unreachable("Unhandled toolchain::Triple::ObjectFormatType enum");
}
...
void CGObjCCommonMac::EmitImageInfo() {
  ...
  // linker and code-gen.
  toolchain::Module &Mod = CGM.getModule();

  // Add the ObjC ABI version to the module flags.
  Mod.addModuleFlag(toolchain::Module::Error, "Objective-C Version", ObjCABI);
  Mod.addModuleFlag(toolchain::Module::Error, "Objective-C Image Info Version",
                    version);
  Mod.addModuleFlag(toolchain::Module::Error, "Objective-C Image Info Section",
                    toolchain::MDString::get(VMContext, Section));

  auto Int8Ty = toolchain::Type::getInt8Ty(VMContext);
  if (CGM.getLangOpts().getGC() == LangOptions::NonGC) {
    // Non-GC overrides those files which specify GC.
    Mod.addModuleFlag(toolchain::Module::Error, "Objective-C Garbage Collection",
                      toolchain::ConstantInt::get(Int8Ty, 0));
  } else {
    // Add the ObjC garbage collection value.
    Mod.addModuleFlag(
        toolchain::Module::Error, "Objective-C Garbage Collection",
        toolchain::ConstantInt::get(Int8Ty, (uint8_t)eImageInfo_GarbageCollected));

    if (CGM.getLangOpts().getGC() == LangOptions::GCOnly) {
      // Add the ObjC GC Only value.
      Mod.addModuleFlag(toolchain::Module::Error, "Objective-C GC Only",
                        eImageInfo_GCOnly);

      // Require that GC be specified and set to eImageInfo_GarbageCollected.
      toolchain::Metadata *Ops[2] = {
          toolchain::MDString::get(VMContext, "Objective-C Garbage Collection"),
          toolchain::ConstantAsMetadata::get(
              toolchain::ConstantInt::get(Int8Ty, eImageInfo_GarbageCollected))};
      Mod.addModuleFlag(toolchain::Module::Require, "Objective-C GC Only",
  ...
  if (CGM.getTarget().getTriple().isSimulatorEnvironment())
    Mod.addModuleFlag(toolchain::Module::Error, "Objective-C Is Simulated",
                      eImageInfo_ImageIsSimulated);

  // Indicate whether we are generating class properties.
  Mod.addModuleFlag(toolchain::Module::Error, "Objective-C Class Properties",
  ...
  if (CGM.getLangOpts().PointerAuthObjcClassROPointers)
    Mod.addModuleFlag(toolchain::Module::Error,
...
toolchain::Constant *CGObjCMac::EmitModuleSymbols() {
  unsigned NumClasses = DefinedClasses.size();
  unsigned NumCategories = DefinedCategories.size();

  // Return null if no symbols were defined.
  if (!NumClasses && !NumCategories)
    return toolchain::Constant::getNullValue(ObjCTypes.SymtabPtrTy);
  ...
  for (unsigned i = 0; i < NumClasses; i++) {
    ...
    if (ObjCImplementationDecl *IMP = ID->getImplementation())
      ...
      if (ID->isWeakImported() && !IMP->isWeakImported())
        DefinedClasses[i]->setLinkage(toolchain::GlobalVariable::ExternalLinkage);
...
toolchain::Value *CGObjCMac::EmitClassRefFromId(CodeGenFunction &CGF,
                                           IdentifierInfo *II) {
  LazySymbols.insert(II);

  toolchain::GlobalVariable *&Entry = ClassReferences[II];
...
toolchain::Value *CGObjCMac::EmitClassRef(CodeGenFunction &CGF,
                                     const ObjCInterfaceDecl *ID) {
...
toolchain::Value *CGObjCMac::EmitNSAutoreleasePoolClassRef(CodeGenFunction &CGF) {
  IdentifierInfo *II = &CGM.getContext().Idents.get("NSAutoreleasePool");
  return EmitClassRefFromId(CGF, II);
}

toolchain::Value *CGObjCMac::EmitSelector(CodeGenFunction &CGF, Selector Sel) {
...
ConstantAddress CGObjCMac::EmitSelectorAddr(Selector Sel) {
  ...
  toolchain::GlobalVariable *&Entry = SelectorReferences[Sel];
  if (!Entry) {
...
toolchain::Constant *CGObjCCommonMac::GetClassName(StringRef RuntimeName) {
  toolchain::GlobalVariable *&Entry = ClassNames[RuntimeName];
  if (!Entry)
    Entry = CreateCStringLiteral(RuntimeName, ObjCLabelType::ClassName);
  return getConstantGEP(VMContext, Entry, 0, 0);
}

toolchain::Function *CGObjCCommonMac::GetMethodDefinition(const ObjCMethodDecl *MD) {
...
CGObjCCommonMac::GetIvarLayoutName(IdentifierInfo *Ident,
                                   const ObjCCommonTypesHelper &ObjCTypes) {
  return toolchain::Constant::getNullValue(ObjCTypes.Int8PtrTy);
}
...
IvarLayoutBuilder::buildBitmap(CGObjCCommonMac &CGObjC,
  ...
  if (IsDisordered) {
    ...
    toolchain::array_pod_sort(IvarsInfo.begin(), IvarsInfo.end());
  } else {
    assert(toolchain::is_sorted(IvarsInfo));
  }
  ...
  if (buffer.empty())
    return toolchain::ConstantPointerNull::get(CGM.Int8PtrTy);
...
CGObjCCommonMac::BuildIvarLayout(const ObjCImplementationDecl *OMD,
  ...
  toolchain::Type *PtrTy = CGM.Int8PtrTy;
  if (CGM.getLangOpts().getGC() == LangOptions::NonGC &&
      !CGM.getLangOpts().ObjCAutoRefCount &&
      (ForStrongLayout || !HasMRCWeakIvars))
    return toolchain::Constant::getNullValue(PtrTy);
  ...
  toolchain::SmallVector<unsigned char, 4> buffer;
  toolchain::Constant *C = builder.buildBitmap(*this, buffer);
...
toolchain::Constant *CGObjCCommonMac::GetMethodVarName(Selector Sel) {
  toolchain::GlobalVariable *&Entry = MethodVarNames[Sel];
...
toolchain::Constant *CGObjCCommonMac::GetMethodVarName(IdentifierInfo *ID) {
  return GetMethodVarName(CGM.getContext().Selectors.getNullarySelector(ID));
}

toolchain::Constant *CGObjCCommonMac::GetMethodVarType(const FieldDecl *Field) {
  std::string TypeStr;
  CGM.getContext().getObjCEncodingForType(Field->getType(), TypeStr, Field);

  toolchain::GlobalVariable *&Entry = MethodVarTypes[TypeStr];
  if (!Entry)
    Entry = CreateCStringLiteral(TypeStr, ObjCLabelType::MethodVarType);
  return getConstantGEP(VMContext, Entry, 0, 0);
}

toolchain::Constant *CGObjCCommonMac::GetMethodVarType(const ObjCMethodDecl *D,
                                                  bool Extended) {
  std::string TypeStr =
...
// FIXME: Merge into a single cstring creation function.
toolchain::Constant *CGObjCCommonMac::GetPropertyName(IdentifierInfo *Ident) {
  toolchain::GlobalVariable *&Entry = PropertyNames[Ident];
  if (!Entry)
...
void CGObjCMac::FinishModule() {
  ...
  for (auto &entry : Protocols) {
    toolchain::GlobalVariable *global = entry.second;
  ...
  if ((!LazySymbols.empty() || !DefinedSymbols.empty()) &&
    ...
    toolchain::raw_svector_ostream OS(Asm);
...
ObjCCommonTypesHelper::ObjCCommonTypesHelper(CodeGen::CodeGenModule &cgm)
  ...
  ShortTy = cast<toolchain::IntegerType>(Types.ConvertType(Ctx.ShortTy));
  IntTy = CGM.IntTy;
  LongTy = cast<toolchain::IntegerType>(Types.ConvertType(Ctx.LongTy));
  Int8PtrTy = CGM.Int8PtrTy;
  Int8PtrProgramASTy = toolchain::PointerType::get(CGM.getLLVMContext(), ProgramAS);
  Int8PtrPtrTy = CGM.Int8PtrPtrTy;

  // arm64 targets use "int" ivar offset variables. All others,
  // including OS X x86_64 and Windows x86_64, use "long" ivar offsets.
  if (CGM.getTarget().getTriple().getArch() == toolchain::Triple::aarch64)
    IvarOffsetVarTy = IntTy;
  else
    IvarOffsetVarTy = LongTy;

  ObjectPtrTy = cast<toolchain::PointerType>(Types.ConvertType(Ctx.getObjCIdType()));
  PtrObjectPtrTy = toolchain::PointerType::getUnqual(VMContext);
  SelectorPtrTy =
      cast<toolchain::PointerType>(Types.ConvertType(Ctx.getObjCSelType()));
  ...
  SuperTy = cast<toolchain::StructType>(Types.ConvertType(SuperCTy));
  SuperPtrTy = toolchain::PointerType::getUnqual(VMContext);

  // struct _prop_t {
  //   char *name;
  //   char *attributes;
  // }
  PropertyTy = toolchain::StructType::create("struct._prop_t", Int8PtrTy, Int8PtrTy);
  ...
  // }
  PropertyListTy = toolchain::StructType::create(
      "struct._prop_list_t", IntTy, IntTy, toolchain::ArrayType::get(PropertyTy, 0));
  // struct _prop_list_t *
  PropertyListPtrTy = toolchain::PointerType::getUnqual(VMContext);
  ...
  //   char *_imp;
  // }
  MethodTy = toolchain::StructType::create("struct._objc_method", SelectorPtrTy,
                                      Int8PtrTy, Int8PtrProgramASTy);

  // struct _objc_cache *
  CacheTy = toolchain::StructType::create(VMContext, "struct._objc_cache");
  CachePtrTy = toolchain::PointerType::getUnqual(VMContext);
}
...
ObjCTypesHelper::ObjCTypesHelper(CodeGen::CodeGenModule &cgm)
  ...
  //   char *types;
  // }
  MethodDescriptionTy = toolchain::StructType::create(
  ...
  MethodDescriptionListTy =
      toolchain::StructType::create("struct._objc_method_description_list", IntTy,
                               toolchain::ArrayType::get(MethodDescriptionTy, 0));

  // struct _objc_method_description_list *
  MethodDescriptionListPtrTy = toolchain::PointerType::getUnqual(VMContext);
  ...
  //   struct _objc_property_list *class_properties;
  // }
  ProtocolExtensionTy = toolchain::StructType::create(
  ...
  // struct _objc_protocol_extension *
  ProtocolExtensionPtrTy = toolchain::PointerType::getUnqual(VMContext);
  ...
  // }
  ProtocolTy = toolchain::StructType::create(
      {ProtocolExtensionPtrTy, Int8PtrTy,
       toolchain::PointerType::getUnqual(VMContext), MethodDescriptionListPtrTy,
       MethodDescriptionListPtrTy},
      "struct._objc_protocol");

  ProtocolListTy =
      toolchain::StructType::create({toolchain::PointerType::getUnqual(VMContext), LongTy,
                                toolchain::ArrayType::get(ProtocolTy, 0)},
                               "struct._objc_protocol_list");

  // struct _objc_protocol_list *
  ProtocolListPtrTy = toolchain::PointerType::getUnqual(VMContext);

  ProtocolPtrTy = toolchain::PointerType::getUnqual(VMContext);
  ...
  //   int  ivar_offset;
  // }
  IvarTy = toolchain::StructType::create("struct._objc_ivar", Int8PtrTy, Int8PtrTy,
                                    IntTy);

  // struct _objc_ivar_list *
  IvarListTy = toolchain::StructType::create(VMContext, "struct._objc_ivar_list");
  IvarListPtrTy = toolchain::PointerType::getUnqual(VMContext);

  // struct _objc_method_list *
  MethodListTy =
      toolchain::StructType::create(VMContext, "struct._objc_method_list");
  MethodListPtrTy = toolchain::PointerType::getUnqual(VMContext);

  // struct _objc_class_extension *
  ClassExtensionTy = toolchain::StructType::create(
      "struct._objc_class_extension", IntTy, Int8PtrTy, PropertyListPtrTy);
  ClassExtensionPtrTy = toolchain::PointerType::getUnqual(VMContext);
  ...
  //   struct _objc_class_ext *ext;
  // };
  ClassTy = toolchain::StructType::create(
      {toolchain::PointerType::getUnqual(VMContext),
       toolchain::PointerType::getUnqual(VMContext), Int8PtrTy, LongTy, LongTy,
       LongTy, IvarListPtrTy, MethodListPtrTy, CachePtrTy, ProtocolListPtrTy,
       Int8PtrTy, ClassExtensionPtrTy},
      "struct._objc_class");

  ClassPtrTy = toolchain::PointerType::getUnqual(VMContext);
  ...
  //   struct _objc_property_list *class_properties;
  // }
  CategoryTy = toolchain::StructType::create(
  ...
  // }
  SymtabTy = toolchain::StructType::create("struct._objc_symtab", LongTy,
                                      SelectorPtrTy, ShortTy, ShortTy,
                                      toolchain::ArrayType::get(Int8PtrTy, 0));
  SymtabPtrTy = toolchain::PointerType::getUnqual(VMContext);
  ...
  //  }
  ModuleTy = toolchain::StructType::create("struct._objc_module", LongTy, LongTy,
  ...
  // Exceptions
  toolchain::Type *StackPtrTy = toolchain::ArrayType::get(CGM.Int8PtrTy, 4);

  ExceptionDataTy = toolchain::StructType::create(
      "struct._objc_exception_data",
      toolchain::ArrayType::get(CGM.Int32Ty, SetJmpBufferSize), StackPtrTy);
}
...
ObjCNonFragileABITypesHelper::ObjCNonFragileABITypesHelper(
  ...
  // }
  MethodListnfABITy =
      toolchain::StructType::create("struct.__method_list_t", IntTy, IntTy,
                               toolchain::ArrayType::get(MethodTy, 0));
  // struct method_list_t *
  MethodListnfABIPtrTy = toolchain::PointerType::getUnqual(VMContext);
  ...
  ProtocolnfABITy = toolchain::StructType::create(
      "struct._protocol_t", ObjectPtrTy, Int8PtrTy,
      toolchain::PointerType::getUnqual(VMContext), MethodListnfABIPtrTy,
      MethodListnfABIPtrTy, MethodListnfABIPtrTy, MethodListnfABIPtrTy,
      PropertyListPtrTy, IntTy, IntTy, Int8PtrPtrTy, Int8PtrTy,
      PropertyListPtrTy);

  // struct _protocol_t*
  ProtocolnfABIPtrTy = toolchain::PointerType::getUnqual(VMContext);

  // struct _protocol_list_t {
  //   long protocol_count;   // Note, this is 32/64 bit
  //   struct _protocol_t *[protocol_count];
  // }
  ProtocolListnfABITy = toolchain::StructType::create(
      {LongTy, toolchain::ArrayType::get(ProtocolnfABIPtrTy, 0)},
      "struct._objc_protocol_list");

  // struct _objc_protocol_list*
  ProtocolListnfABIPtrTy = toolchain::PointerType::getUnqual(VMContext);
  ...
  //   uint32_t size;
  // }
  IvarnfABITy = toolchain::StructType::create(
      "struct._ivar_t", toolchain::PointerType::getUnqual(VMContext), Int8PtrTy,
  ...
  // }
  IvarListnfABITy =
      toolchain::StructType::create("struct._ivar_list_t", IntTy, IntTy,
                               toolchain::ArrayType::get(IvarnfABITy, 0));

  IvarListnfABIPtrTy = toolchain::PointerType::getUnqual(VMContext);
  ...
  ClassRonfABITy = toolchain::StructType::create(
  ...
  ClassnfABITy = toolchain::StructType::create(
      {toolchain::PointerType::getUnqual(VMContext),
       toolchain::PointerType::getUnqual(VMContext), CachePtrTy,
       toolchain::PointerType::getUnqual(VMContext),
       toolchain::PointerType::getUnqual(VMContext)},
      "struct._class_t");

  // LLVM for struct _class_t *
  ClassnfABIPtrTy = toolchain::PointerType::getUnqual(VMContext);
  ...
  //   const uint32_t size;
  // }
  CategorynfABITy = toolchain::StructType::create(
  ...
  MessageRefTy = cast<toolchain::StructType>(Types.ConvertType(MessageRefCTy));

  // MessageRefPtrTy - LLVM for struct _message_ref_t*
  MessageRefPtrTy = toolchain::PointerType::getUnqual(VMContext);
  ...
  //   SEL name;
  // };
  SuperMessageRefTy = toolchain::StructType::create("struct._super_message_ref_t",
                                               ImpnfABITy, SelectorPtrTy);

  // SuperMessageRefPtrTy - LLVM for struct _super_message_ref_t*
  SuperMessageRefPtrTy = toolchain::PointerType::getUnqual(VMContext);
  ...
  //   Class        cls;
  // };
  EHTypeTy = toolchain::StructType::create("struct._objc_typeinfo",
                                      toolchain::PointerType::getUnqual(VMContext),
                                      Int8PtrTy, ClassnfABIPtrTy);
  EHTypePtrTy = toolchain::PointerType::getUnqual(VMContext);
}

toolchain::Function *CGObjCNonFragileABIMac::ModuleInitFunction() {
...
void CGObjCNonFragileABIMac::AddModuleClassList(
    ArrayRef<toolchain::GlobalValue *> Container, StringRef SymbolName,
  ...
  SmallVector<toolchain::Constant *, 8> Symbols(NumClasses);
  for (unsigned i = 0; i < NumClasses; i++)
    Symbols[i] = Container[i];

  toolchain::Constant *Init = toolchain::ConstantArray::get(
      toolchain::ArrayType::get(ObjCTypes.Int8PtrTy, Symbols.size()), Symbols);
  ...
  toolchain::GlobalVariable *GV = new toolchain::GlobalVariable(
      ...
      toolchain::GlobalValue::PrivateLinkage, Init, SymbolName);
...
/// }
///
toolchain::GlobalVariable *CGObjCNonFragileABIMac::BuildClassRoTInitializer(
  ...
  toolchain::Constant *MethListPtr = emitMethodList(
      ID->getObjCRuntimeNameAsString(),
  ...
  toolchain::SmallString<64> roLabel;
  toolchain::raw_svector_ostream(roLabel)
...
/// }
///
toolchain::GlobalVariable *CGObjCNonFragileABIMac::BuildClassObject(
    const ObjCInterfaceDecl *CI, bool isMetaclass, toolchain::Constant *IsAGV,
    toolchain::Constant *SuperClassGV, toolchain::Constant *ClassRoGV,
...
static toolchain::GlobalValue::DLLStorageClassTypes getStorage(CodeGenModule &CGM,
                                                          StringRef Name) {
  ...
  if (!VD)
    return toolchain::GlobalValue::DLLImportStorageClass;
  if (VD->hasAttr<DLLExportAttr>())
    return toolchain::GlobalValue::DLLExportStorageClass;
  if (VD->hasAttr<DLLImportAttr>())
    return toolchain::GlobalValue::DLLImportStorageClass;
  return toolchain::GlobalValue::DefaultStorageClass;
}

void CGObjCNonFragileABIMac::GenerateClass(const ObjCImplementationDecl *ID) {
  if (!ObjCEmptyCacheVar) {
    ObjCEmptyCacheVar = new toolchain::GlobalVariable(
        CGM.getModule(), ObjCTypes.CacheTy, false,
        toolchain::GlobalValue::ExternalLinkage, nullptr, "_objc_empty_cache");
    if (CGM.getTriple().isOSBinFormatCOFF())
    ...
    if (Triple.isMacOSX() && Triple.isMacOSXVersionLT(10, 9))
      ObjCEmptyVtableVar = new toolchain::GlobalVariable(
          CGM.getModule(), ObjCTypes.ImpnfABITy, false,
          toolchain::GlobalValue::ExternalLinkage, nullptr, "_objc_empty_vtable");
    else
      ObjCEmptyVtableVar = toolchain::ConstantPointerNull::get(CGM.UnqualPtrTy);
  }
  ...
  toolchain::Constant *SuperClassGV, *IsAGV;
  ...
  toolchain::GlobalVariable *CLASS_RO_GV =
      BuildClassRoTInitializer(flags, InstanceStart, InstanceSize, ID);

  toolchain::GlobalVariable *MetaTClass = BuildClassObject(
  ...
  toolchain::GlobalVariable *ClassMD =
...
CGObjCNonFragileABIMac::GenerateProtocolRef(CodeGenFunction &CGF,
  ...
  toolchain::Constant *Init = GetOrEmitProtocol(PD);
  ...
  toolchain::GlobalVariable *PTGV = CGM.getModule().getGlobalVariable(ProtocolName);
  if (PTGV)
    return CGF.Builder.CreateAlignedLoad(PTGV->getValueType(), PTGV, Align);
  PTGV = new toolchain::GlobalVariable(CGM.getModule(), Init->getType(), false,
                                  toolchain::GlobalValue::WeakAnyLinkage, Init,
                                  ProtocolName);
  PTGV->setSection(
      GetSectionName("__objc_protorefs", "coalesced,no_dead_strip"));
  PTGV->setVisibility(toolchain::GlobalValue::HiddenVisibility);
...
void CGObjCNonFragileABIMac::GenerateCategory(const ObjCCategoryImplDecl *OCD) {
  ...
  toolchain::SmallString<64> ExtCatName(Prefix);
  ...
  toolchain::Constant *InstanceMethodList = emitMethodList(
  ...
  toolchain::Constant *ClassMethodList = emitMethodList(
  ...
  toolchain::GlobalVariable *GCATV =
...
void CGObjCNonFragileABIMac::emitMethodConstant(ConstantArrayBuilder &builder,
  ...
  if (forProtocol) {
    ...
    if (const PointerAuthSchema &Schema =
      ...
      toolchain::Constant *Bitcast =
          toolchain::ConstantExpr::getBitCast(fn, ObjCTypes.Int8PtrProgramASTy);
...
/// }
///
toolchain::Constant *CGObjCNonFragileABIMac::emitMethodList(
    Twine name, MethodListType kind, ArrayRef<const ObjCMethodDecl *> methods) {
  // Return null for empty list.
  if (methods.empty())
    return toolchain::Constant::getNullValue(ObjCTypes.MethodListnfABIPtrTy);
  ...
  toolchain::GlobalVariable *GV = finishAndCreateGlobal(values, prefix + name, CGM);
  CGM.addCompilerUsedGlobal(GV);
  return GV;
}
...
CGObjCNonFragileABIMac::ObjCIvarOffsetVariable(const ObjCInterfaceDecl *ID,
  ...
  toolchain::SmallString<64> Name("OBJC_IVAR_$_");
  Name += Container->getObjCRuntimeNameAsString();
  Name += ".";
  Name += Ivar->getName();
  toolchain::GlobalVariable *IvarOffsetGV = CGM.getModule().getGlobalVariable(Name);
  if (!IvarOffsetGV) {
    IvarOffsetGV = new toolchain::GlobalVariable(
        CGM.getModule(), ObjCTypes.IvarOffsetVarTy, false,
        toolchain::GlobalValue::ExternalLinkage, nullptr, Name.str());
    if (CGM.getTriple().isOSBinFormatCOFF()) {
...
CGObjCNonFragileABIMac::EmitIvarOffsetVar(const ObjCInterfaceDecl *ID,
                                          const ObjCIvarDecl *Ivar,
                                          unsigned long int Offset) {
  toolchain::GlobalVariable *IvarOffsetGV = ObjCIvarOffsetVariable(ID, Ivar);
  IvarOffsetGV->setInitializer(
      toolchain::ConstantInt::get(ObjCTypes.IvarOffsetVarTy, Offset));
  ...
  if (!CGM.getTriple().isOSBinFormatCOFF()) {
    ...
    if (Ivar->getAccessControl() == ObjCIvarDecl::Private ||
      ...
      IvarOffsetGV->setVisibility(toolchain::GlobalValue::HiddenVisibility);
    else
      IvarOffsetGV->setVisibility(toolchain::GlobalValue::DefaultVisibility);
  }
...
CGObjCNonFragileABIMac::EmitIvarList(const ObjCImplementationDecl *ID) {
  ...
  if (ivars.empty()) {
    ivars.abandon();
    ivarList.abandon();
    return toolchain::Constant::getNullValue(ObjCTypes.IvarListnfABIPtrTy);
  }
  ...
  toolchain::GlobalVariable *GV = finishAndCreateGlobal(
...
CGObjCNonFragileABIMac::GetOrEmitProtocolRef(const ObjCProtocolDecl *PD) {
  ...
  if (!Entry) {
    ...
    // reference or not. At module finalization we add the empty
    // contents for protocols which were referenced but never defined.
    toolchain::SmallString<64> Protocol;
    toolchain::raw_svector_ostream(Protocol)
        << "_OBJC_PROTOCOL_$_" << PD->getObjCRuntimeNameAsString();

    Entry = new toolchain::GlobalVariable(CGM.getModule(), ObjCTypes.ProtocolnfABITy,
                                     false, toolchain::GlobalValue::ExternalLinkage,
                                     nullptr, Protocol);
    if (!CGM.getTriple().isOSBinFormatMachO())
...
CGObjCNonFragileABIMac::GetOrEmitProtocol(const ObjCProtocolDecl *PD) {
  ...
  if (Entry) {
    ...
    Entry->setLinkage(toolchain::GlobalValue::WeakAnyLinkage);
    values.finishAndSetAsInitializer(Entry);
  } else {
    toolchain::SmallString<64> symbolName;
    toolchain::raw_svector_ostream(symbolName)
        << "_OBJC_PROTOCOL_$_" << PD->getObjCRuntimeNameAsString();
  ...
  Entry->setVisibility(toolchain::GlobalValue::HiddenVisibility);
  CGM.addUsedGlobal(Entry);

  // Use this protocol meta-data to build protocol list table in section
  // __DATA, __objc_protolist
  toolchain::SmallString<64> ProtocolRef;
  toolchain::raw_svector_ostream(ProtocolRef)
      << "_OBJC_LABEL_PROTOCOL_$_" << PD->getObjCRuntimeNameAsString();

  toolchain::GlobalVariable *PTGV = new toolchain::GlobalVariable(
      CGM.getModule(), ObjCTypes.ProtocolnfABIPtrTy, false,
      toolchain::GlobalValue::WeakAnyLinkage, Entry, ProtocolRef);
  if (!CGM.getTriple().isOSBinFormatMachO())
...
/// @endcode
///
toolchain::Constant *CGObjCNonFragileABIMac::EmitProtocolList(
    Twine Name, ObjCProtocolDecl::protocol_iterator begin,
    ObjCProtocolDecl::protocol_iterator end) {
  // Just return null for empty protocol lists
  auto Protocols = GetRuntimeProtocolList(begin, end);
  if (Protocols.empty())
    return toolchain::Constant::getNullValue(ObjCTypes.ProtocolListnfABIPtrTy);

  SmallVector<toolchain::Constant *, 16> ProtocolRefs;
...
LValue CGObjCNonFragileABIMac::EmitObjCValueForIvar(
    CodeGen::CodeGenFunction &CGF, QualType ObjectTy, toolchain::Value *BaseValue,
    const ObjCIvarDecl *Ivar, unsigned CVRQualifiers) {
  ObjCInterfaceDecl *ID = ObjectTy->castAs<ObjCObjectType>()->getInterface();
  toolchain::Value *Offset = EmitIvarOffset(CGF, ID, Ivar);
  return EmitValueForIvarAtOffset(CGF, ID, BaseValue, Ivar, CVRQualifiers,
                                  Offset);
}
...
CGObjCNonFragileABIMac::EmitIvarOffset(CodeGen::CodeGenFunction &CGF,
                                       const ObjCInterfaceDecl *Interface,
                                       const ObjCIvarDecl *Ivar) {
  toolchain::Value *IvarOffsetValue;
  if (isClassLayoutKnownStatically(Interface)) {
    IvarOffsetValue = toolchain::ConstantInt::get(
        ObjCTypes.IvarOffsetVarTy,
        ComputeIvarBaseOffset(CGM, Interface->getImplementation(), Ivar));
  } else {
    toolchain::GlobalVariable *GV = ObjCIvarOffsetVariable(Interface, Ivar);
    IvarOffsetValue = CGF.Builder.CreateAlignedLoad(GV->getValueType(), GV,
                                                    CGF.getSizeAlign(), "ivar");
    if (IsIvarOffsetKnownIdempotent(CGF, Ivar))
      cast<toolchain::LoadInst>(IvarOffsetValue)
          ->setMetadata(toolchain::LLVMContext::MD_invariant_load,
                        toolchain::MDNode::get(VMContext, {}));
  }
...
RValue CGObjCNonFragileABIMac::EmitVTableMessageSend(
    ...
    Selector selector, toolchain::Value *arg0, QualType arg0Type, bool isSuper,
  ...
  toolchain::append_range(args, formalArgs);
  ...
  toolchain::GlobalVariable *messageRef =
      CGM.getModule().getGlobalVariable(messageRefName);
  if (!messageRef) {
    // Build the message ref structure.
    ConstantInitBuilder builder(CGM);
    auto values = builder.beginStruct();
    values.add(cast<toolchain::Constant>(fn.getCallee()));
    values.add(GetMethodVarName(selector));
    messageRef = values.finishAndCreateGlobal(
        messageRefName, CharUnits::fromQuantity(16),
        /*constant*/ false, toolchain::GlobalValue::WeakAnyLinkage);
    messageRef->setVisibility(toolchain::GlobalValue::HiddenVisibility);
  ...
  toolchain::Value *calleePtr = CGF.Builder.CreateLoad(calleeAddr, "msgSend_fn");
...
CGObjCNonFragileABIMac::GetClassGlobal(StringRef Name,
  ...
  toolchain::GlobalValue::LinkageTypes L =
      Weak ? toolchain::GlobalValue::ExternalWeakLinkage
           : toolchain::GlobalValue::ExternalLinkage;

  toolchain::GlobalVariable *GV = CGM.getModule().getGlobalVariable(Name);
  if (!GV || GV->getValueType() != ObjCTypes.ClassnfABITy) {
    auto *NewGV = new toolchain::GlobalVariable(ObjCTypes.ClassnfABITy, false, L,
                                           nullptr, Name);

    if (DLLImport)
      NewGV->setDLLStorageClass(toolchain::GlobalValue::DLLImportStorageClass);
...
CGObjCNonFragileABIMac::GetClassGlobalForClassRef(const ObjCInterfaceDecl *ID) {
  toolchain::Constant *ClassGV =
      GetClassGlobal(ID, /*metaclass*/ false, NotForDefinition);

  if (!ID->hasAttr<ObjCClassStubAttr>())
    return ClassGV;

  ClassGV = toolchain::ConstantExpr::getPointerCast(ClassGV, ObjCTypes.Int8PtrTy);

  // Stub classes are pointer-aligned. Classrefs pointing at stub classes
  // must set the least significant bit set to 1.
  auto *Idx = toolchain::ConstantInt::get(CGM.Int32Ty, 1);
  return toolchain::ConstantExpr::getGetElementPtr(CGM.Int8Ty, ClassGV, Idx);
}
...
toolchain::Value *CGObjCNonFragileABIMac::EmitClassRefFromId(
  ...
  if (!Entry) {
    ...
    Entry = new toolchain::GlobalVariable(
...
toolchain::Value *CGObjCNonFragileABIMac::EmitClassRef(CodeGenFunction &CGF,
                                                  const ObjCInterfaceDecl *ID) {
  // If the class has the objc_runtime_visible attribute, we need to
  // use the Objective-C runtime to get the class.
  if (ID->hasAttr<ObjCRuntimeVisibleAttr>())
...
CGObjCNonFragileABIMac::EmitSuperClassRef(CodeGenFunction &CGF,
                                          const ObjCInterfaceDecl *ID) {
  toolchain::GlobalVariable *&Entry = SuperClassReferences[ID->getIdentifier()];

  if (!Entry) {
    toolchain::Constant *ClassGV = GetClassGlobalForClassRef(ID);
    std::string SectionName =
        GetSectionName("__objc_superrefs", "regular,no_dead_strip");
    Entry = new toolchain::GlobalVariable(CGM.getModule(), ClassGV->getType(), false,
                                     toolchain::GlobalValue::PrivateLinkage, ClassGV,
...
/// meta-data
///
toolchain::Value *CGObjCNonFragileABIMac::EmitMetaClassRef(
    CodeGenFunction &CGF, const ObjCInterfaceDecl *ID, bool Weak) {
  CharUnits Align = CGF.getPointerAlign();
  toolchain::GlobalVariable *&Entry = MetaClassReferences[ID->getIdentifier()];
  if (!Entry) {
    auto MetaClassGV = GetClassGlobal(ID, /*metaclass*/ true, NotForDefinition);
    std::string SectionName =
        GetSectionName("__objc_superrefs", "regular,no_dead_strip");
    Entry = new toolchain::GlobalVariable(CGM.getModule(), ObjCTypes.ClassnfABIPtrTy,
                                     false, toolchain::GlobalValue::PrivateLinkage,
...
/// GetClass - Return a reference to the class for the given interface
/// decl.
toolchain::Value *CGObjCNonFragileABIMac::GetClass(CodeGenFunction &CGF,
                                              const ObjCInterfaceDecl *ID) {
  if (ID->isWeakImported()) {
    auto ClassGV = GetClassGlobal(ID, /*metaclass*/ false, NotForDefinition);
    (void)ClassGV;
    assert(!isa<toolchain::GlobalVariable>(ClassGV) ||
           cast<toolchain::GlobalVariable>(ClassGV)->hasExternalWeakLinkage());
  }
...
toolchain::Value *CGObjCNonFragileABIMac::EmitSelector(CodeGenFunction &CGF,
                                                  Selector Sel) {
  Address Addr = EmitSelectorAddr(Sel);

  toolchain::LoadInst *LI = CGF.Builder.CreateLoad(Addr);
  LI->setMetadata(toolchain::LLVMContext::MD_invariant_load,
                  toolchain::MDNode::get(VMContext, {}));
  return LI;
}
...
void CGObjCNonFragileABIMac::EmitObjCStrongCastAssign(
    CodeGen::CodeGenFunction &CGF, toolchain::Value *src, Address dst) {
  toolchain::Type *SrcTy = src->getType();
  if (!isa<toolchain::PointerType>(SrcTy)) {
    unsigned Size = CGM.getDataLayout().getTypeAllocSize(SrcTy);
    assert(Size <= 8 && "does not support size > 8");
...
toolchain::Constant *CGObjCNonFragileABIMac::GetEHType(QualType T) {
  // There's a particular fixed type info for 'id'.
  if (T->isObjCIdType() || T->isObjCQualifiedIdType()) {
    auto *IDEHType = CGM.getModule().getGlobalVariable("OBJC_EHTYPE_id");
    if (!IDEHType) {
      IDEHType = new toolchain::GlobalVariable(
          CGM.getModule(), ObjCTypes.EHTypeTy, false,
          toolchain::GlobalValue::ExternalLinkage, nullptr, "OBJC_EHTYPE_id");
      if (CGM.getTriple().isOSBinFormatCOFF())
...
CGObjCNonFragileABIMac::GetInterfaceEHType(const ObjCInterfaceDecl *ID,
                                           ForDefinition_t IsForDefinition) {
  toolchain::GlobalVariable *&Entry = EHTypeReferences[ID->getIdentifier()];
  ...
  if (!IsForDefinition) {
    ...
    if (hasObjCExceptionAttribute(CGM.getContext(), ID)) {
      ...
      Entry = new toolchain::GlobalVariable(
          CGM.getModule(), ObjCTypes.EHTypeTy, false,
          toolchain::GlobalValue::ExternalLinkage, nullptr, EHTypeName);
  ...
  if (!VTableGV) {
    VTableGV = new toolchain::GlobalVariable(
        CGM.getModule(), ObjCTypes.Int8PtrTy, false,
        toolchain::GlobalValue::ExternalLinkage, nullptr, VTableName);
    if (CGM.getTriple().isOSBinFormatCOFF())
      VTableGV->setDLLStorageClass(getStorage(CGM, VTableName));
  }

  toolchain::Value *VTableIdx = toolchain::ConstantInt::get(CGM.Int32Ty, 2);
  toolchain::Constant *VTablePtr = toolchain::ConstantExpr::getInBoundsGetElementPtr(
  ...
  toolchain::GlobalValue::LinkageTypes L = IsForDefinition
                                          ? toolchain::GlobalValue::ExternalLinkage
                                          : toolchain::GlobalValue::WeakAnyLinkage;
  if (Entry) {
    values.finishAndSetAsInitializer(Entry);
...
CodeGen::CreateMacObjCRuntime(CodeGen::CodeGenModule &CGM) {
  ...
  case ObjCRuntime::ObjFW:
    toolchain_unreachable("these runtimes are not Mac runtimes");
  }
  toolchain_unreachable("bad runtime");
}
