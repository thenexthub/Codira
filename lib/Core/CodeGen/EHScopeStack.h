...
#ifndef LANGUAGE_CORE_LIB_CODEGEN_EHSCOPESTACK_H
#define LANGUAGE_CORE_LIB_CODEGEN_EHSCOPESTACK_H
...
struct BranchFixup {
  ...
  toolchain::BasicBlock *OptimisticBranchBlock;

  /// The ultimate destination of the branch.
  ///
  /// This can be set to null to indicate that this fixup was
  /// successfully resolved.
  toolchain::BasicBlock *Destination;

  /// The destination index value.
  unsigned DestinationIndex;

  /// The initial branch of the fixup.
  toolchain::BranchInst *InitialBranch;
};
...
template <class T, bool mightBeInstruction =
            std::is_base_of<toolchain::Value, T>::value &&
            !std::is_base_of<toolchain::Constant, T>::value &&
            !std::is_base_of<toolchain::BasicBlock, T>::value>
