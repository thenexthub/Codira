...
#ifndef LANGUAGE_CORE_LIB_CODEGEN_CGOPENMPRUNTIME_H
#define LANGUAGE_CORE_LIB_CODEGEN_CGOPENMPRUNTIME_H
...
struct OMPTaskDataTy final {
  ...
  toolchain::PointerIntPair<toolchain::Value *, 1, bool> Final;
  toolchain::PointerIntPair<toolchain::Value *, 1, bool> Schedule;
  toolchain::PointerIntPair<toolchain::Value *, 1, bool> Priority;
  toolchain::Value *Reductions = nullptr;
...
private:
  ...
  SmallVector<std::pair<toolchain::Value *, toolchain::Value *>, 4> Sizes;
...
public:
  ...
  void emitAggregateType(CodeGenFunction &CGF, unsigned N, toolchain::Value *Size);
  ...
  std::pair<toolchain::Value *, toolchain::Value *> getSizes(unsigned N) const {
    return Sizes[N];
  }
...
public:
  ...
  struct LastprivateConditionalData {
    toolchain::MapVector<CanonicalDeclPtr<const Decl>, SmallString<16>>
        DeclToUniqueName;
    LValue IVLVal;
  ...
  toolchain::OpenMPIRBuilder &getOMPBuilder() { return OMPBuilder; }
...
protected:
  ...
  toolchain::Type *getIdentTyPointerTy();

  /// Gets thread id value for the current thread.
  ///
  toolchain::Value *getThreadID(CodeGenFunction &CGF, SourceLocation Loc);
  ...
  toolchain::ArrayType *getKmpCriticalNameTy() const {return KmpCriticalNameTy;}
  ...
  ///
  toolchain::Value *getCriticalRegionLock(StringRef CriticalName);

protected:
  /// Map for SourceLocation and OpenMP runtime library debug locations.
  typedef toolchain::DenseMap<SourceLocation, toolchain::Value *> OpenMPDebugLocMapTy;
  OpenMPDebugLocMapTy OpenMPDebugLocMap;
  /// Stores debug location and ThreadID for the function.
  struct DebugLocThreadIdTy {
    toolchain::Value *DebugLoc;
    toolchain::Value *ThreadID;
    /// Insert point for the service instructions.
    toolchain::AssertingVH<toolchain::Instruction> ServiceInsertPt = nullptr;
  };
  /// Map of local debug location, ThreadId and functions.
  typedef toolchain::DenseMap<toolchain::Function *, DebugLocThreadIdTy>
      OpenMPLocThreadIDMapTy;
  OpenMPLocThreadIDMapTy OpenMPLocThreadIDMap;
  /// Map of UDRs and corresponding combiner/initializer.
  typedef toolchain::DenseMap<const OMPDeclareReductionDecl *,
                         std::pair<toolchain::Function *, toolchain::Function *>>
      UDRMapTy;
  UDRMapTy UDRMap;
  /// Map of functions and locally defined UDRs.
  typedef toolchain::DenseMap<toolchain::Function *,
                         SmallVector<const OMPDeclareReductionDecl *, 4>>
      FunctionUDRMapTy;
  FunctionUDRMapTy FunctionUDRMap;
  /// Map from the user-defined mapper declaration to its corresponding
  /// functions.
  toolchain::DenseMap<const OMPDeclareMapperDecl *, toolchain::Function *> UDMMap;
  /// Map of functions and their local user-defined mappers.
  using FunctionUDMMapTy =
      toolchain::DenseMap<toolchain::Function *,
                     SmallVector<const OMPDeclareMapperDecl *, 4>>;
  FunctionUDMMapTy FunctionUDMMap;
  /// Maps local variables marked as lastprivate conditional to their internal
  /// types.
  toolchain::DenseMap<toolchain::Function *,
                 toolchain::DenseMap<CanonicalDeclPtr<const Decl>,
                                std::tuple<QualType, const FieldDecl *,
                                           const FieldDecl *, LValue>>>
      LastprivateConditionalToTypes;
  /// Maps function to the position of the untied task locals stack.
  toolchain::DenseMap<toolchain::Function *, unsigned> FunctionToUntiedTaskStackMap;
  /// Type kmp_critical_name, originally defined as typedef kmp_int32
  /// kmp_critical_name[8];
  toolchain::ArrayType *KmpCriticalNameTy;
  /// An ordered map of auto-generated variables to their unique names.
  /// It stores variables with the following names: 1) ".gomp_critical_user_" +
  /// <critical_section_name> + ".var" for "omp critical" directives; 2)
  /// <mangled_name_for_global_var> + ".cache." for cache for threadprivate
  /// variables.
  toolchain::StringMap<toolchain::AssertingVH<toolchain::GlobalVariable>,
                  toolchain::BumpPtrAllocator> InternalVars;
  /// Type typedef kmp_int32 (* kmp_routine_entry_t)(kmp_int32, void *);
  toolchain::Type *KmpRoutineEntryPtrTy = nullptr;
  ...
  toolchain::DenseSet<CanonicalDeclPtr<const Decl>> AlreadyEmittedTargetDecls;
  /// List of the global variables with their addresses that should not be
  /// emitted for the target.
  toolchain::StringMap<toolchain::WeakTrackingVH> EmittedNonTargetVariables;

  /// List of variables that can become declare target implicitly and, thus,
  /// must be emitted.
  toolchain::SmallDenseSet<const VarDecl *> DeferredGlobalVariables;

  using NontemporalDeclsSet = toolchain::SmallDenseSet<CanonicalDeclPtr<const Decl>>;
  /// Stack for list of declarations in current context marked as nontemporal.
  /// The set is the union of all current stack elements.
  toolchain::SmallVector<NontemporalDeclsSet, 4> NontemporalDeclsStack;

  using UntiedLocalVarsAddressesMap =
      toolchain::MapVector<CanonicalDeclPtr<const VarDecl>,
                      std::pair<Address, Address>>;
  toolchain::SmallVector<UntiedLocalVarsAddressesMap, 4> UntiedLocalVarsStack;

  /// Stack for list of addresses of declarations in current context marked as
  /// lastprivate conditional. The set is the union of all current stack
  /// elements.
  toolchain::SmallVector<LastprivateConditionalData, 4> LastprivateConditionalStack;
  ...
  toolchain::AtomicOrdering RequiresAtomicOrdering = toolchain::AtomicOrdering::Monotonic;
  ...
  toolchain::Constant *getOrCreateThreadPrivateCache(const VarDecl *VD);

  /// Set of threadprivate variables with the generated initializer.
  toolchain::StringSet<> ThreadPrivateWithDefinition;

  /// Set of declare target variables with the generated initializer.
  toolchain::StringSet<> DeclareTargetWithDefinition;
  ...
  void emitThreadPrivateVarInit(CodeGenFunction &CGF, Address VDAddr,
                                toolchain::Value *Ctor, toolchain::Value *CopyCtor,
                                toolchain::Value *Dtor, SourceLocation Loc);

  struct TaskResultTy {
    toolchain::Value *NewTask = nullptr;
    toolchain::Function *TaskEntry = nullptr;
    toolchain::Value *NewTaskNewTaskTTy = nullptr;
    LValue TDBase;
    const RecordDecl *KmpTaskTQTyRD = nullptr;
    toolchain::Value *TaskDupFn = nullptr;
  };
  ...
  /// dependencies.
  std::pair<toolchain::Value *, LValue> getDepobjElements(CodeGenFunction &CGF,
                                                     LValue DepobjLVal,
                                                     SourceLocation Loc);

  SmallVector<toolchain::Value *, 4>
...
public:
  ...
  ///
  toolchain::Value *emitUpdateLocation(CodeGenFunction &CGF, SourceLocation Loc,
  ...
  const Expr *getNumTeamsExprForTargetDirective(CodeGenFunction &CGF,
                                                ...
                                                int32_t &MinTeamsVal,
                                                int32_t &MaxTeamsVal);
  toolchain::Value *emitNumTeamsForTargetDirective(CodeGenFunction &CGF,
                                              const OMPExecutableDirective &D);
  ...
  const Expr *getNumThreadsExprForTargetDirective(
      ...
      toolchain::Value **CondExpr = nullptr, const Expr **ThreadLimitExpr = nullptr);
  ...
  toolchain::Value *emitTargetNumIterationsCall(
      CodeGenFunction &CGF, const OMPExecutableDirective &D,
  ...
  virtual std::pair<toolchain::Value *, toolchain::Value *>
  ...
  virtual std::pair<toolchain::Function *, toolchain::Function *>
  ...
  virtual toolchain::Function *emitParallelOutlinedFunction(
      CodeGenFunction &CGF, const OMPExecutableDirective &D,
  ...
  /// is a directive itself, for combined - its innermost directive).
  /// \param CodeGen Code generation sequence for the \a D directive.
  virtual toolchain::Function *emitTeamsOutlinedFunction(
      CodeGenFunction &CGF, const OMPExecutableDirective &D,
      const VarDecl *ThreadIDVar, OpenMPDirectiveKind InnermostKind,
      const RegionCodeGenTy &CodeGen);
  ...
  /// tasks.
  ///
  virtual toolchain::Function *emitTaskOutlinedFunction(
  ...
  virtual void emitParallelCall(CodeGenFunction &CGF, SourceLocation Loc,
                                ...
                                const Expr *IfCond, toolchain::Value *NumThreads);
  ...
  struct DispatchRTInput {
    /// Loop lower bound
    toolchain::Value *LB = nullptr;
    /// Loop upper bound
    toolchain::Value *UB = nullptr;
    /// Chunk size specified using 'schedule' clause (nullptr if chunk
    /// was not specified)
    toolchain::Value *Chunk = nullptr;
    DispatchRTInput() = default;
    DispatchRTInput(toolchain::Value *LB, toolchain::Value *UB, toolchain::Value *Chunk)
  ...
  /// \param DispatchValues struct containing toolchain values for lower bound, upper
  ...
  /// returned.
  virtual toolchain::Value *emitForNext(CodeGenFunction &CGF, SourceLocation Loc,
  ...
  virtual void emitProcBindClause(CodeGenFunction &CGF,
                                  toolchain::omp::ProcBindKind ProcBind,
                                  SourceLocation Loc);
  ...
  toolchain::Function *emitReductionFunction(
  ...
  virtual toolchain::Value *emitTaskReductionInit(CodeGenFunction &CGF,
                                             SourceLocation Loc,
                                             ArrayRef<const Expr *> LHSExprs,
                                             ArrayRef<const Expr *> RHSExprs,
                                             const OMPTaskDataTy &Data);
  ...
  virtual void emitTeamsCall(CodeGenFunction &CGF,
                             const OMPExecutableDirective &D,
                             SourceLocation Loc, toolchain::Function *OutlinedFn,
                             ArrayRef<toolchain::Value *> CapturedVars);
  ...
  class TargetDataInfo : public toolchain::OpenMPIRBuilder::TargetDataInfo {
  public:
    explicit TargetDataInfo() : toolchain::OpenMPIRBuilder::TargetDataInfo() {}
    explicit TargetDataInfo(bool RequiresDevicePointerInfo,
                            bool SeparateBeginEndCalls)
        : toolchain::OpenMPIRBuilder::TargetDataInfo(RequiresDevicePointerInfo,
                                                SeparateBeginEndCalls) {}
    /// Map between the a declaration of a capture and the corresponding new
    /// toolchain address where the runtime returns the device pointers.
    toolchain::DenseMap<const ValueDecl *, toolchain::Value *> CaptureDeviceAddrMap;
  };
  ...
  emitOutlinedFunctionCall(CodeGenFunction &CGF, SourceLocation Loc,
                           toolchain::FunctionCallee OutlinedFn,
                           ArrayRef<toolchain::Value *> Args = {}) const;
  ...
  toolchain::AtomicOrdering getDefaultMemoryOrdering() const;
  ...
  std::pair<toolchain::Value *, Address>
...
public:
  ...
  /// is a directive itself, for combined - its innermost directive).
  /// \param CodeGen Code generation sequence for the \a D directive.
  toolchain::Function *emitParallelOutlinedFunction(
      CodeGenFunction &CGF, const OMPExecutableDirective &D,
      const VarDecl *ThreadIDVar, OpenMPDirectiveKind InnermostKind,
  ...
  /// is a directive itself, for combined - its innermost directive).
  /// \param CodeGen Code generation sequence for the \a D directive.
  toolchain::Function *emitTeamsOutlinedFunction(
      CodeGenFunction &CGF, const OMPExecutableDirective &D,
      const VarDecl *ThreadIDVar, OpenMPDirectiveKind InnermostKind,
      const RegionCodeGenTy &CodeGen) override;
  ...
  /// tasks.
  ///
  toolchain::Function *emitTaskOutlinedFunction(
      const OMPExecutableDirective &D, const VarDecl *ThreadIDVar,
      const VarDecl *PartIDVar, const VarDecl *TaskTVar,
      OpenMPDirectiveKind InnermostKind, const RegionCodeGenTy &CodeGen,
  ...
  void emitParallelCall(CodeGenFunction &CGF, SourceLocation Loc,
                        toolchain::Function *OutlinedFn,
                        ArrayRef<toolchain::Value *> CapturedVars,
                        const Expr *IfCond, toolchain::Value *NumThreads) override;
  ...
  /// \param ST Address of the output variable in which the stride value is
  /// returned.
  toolchain::Value *emitForNext(CodeGenFunction &CGF, SourceLocation Loc,
  ...
  /// clause.
  /// \param NumThreads An integer value of threads.
  void emitNumThreadsClause(CodeGenFunction &CGF, toolchain::Value *NumThreads,
                            SourceLocation Loc) override;
  ...
  void emitFlush(CodeGenFunction &CGF, ArrayRef<const Expr *> Vars,
                 SourceLocation Loc, toolchain::AtomicOrdering AO) override;
  ...
  void emitTaskLoopCall(CodeGenFunction &CGF, SourceLocation Loc,
                        const OMPLoopDirective &D, toolchain::Function *TaskFunction,
  ...
  /// \param Data Additional data for task generation like tiedness, final
  /// state, list of privates, reductions etc.
  toolchain::Value *emitTaskReductionInit(CodeGenFunction &CGF, SourceLocation Loc,
                                     ArrayRef<const Expr *> LHSExprs,
                                     ArrayRef<const Expr *> RHSExprs,
                                     const OMPTaskDataTy &Data) override;
  ...
  void emitTeamsCall(CodeGenFunction &CGF, const OMPExecutableDirective &D,
                     SourceLocation Loc, toolchain::Function *OutlinedFn,
                     ArrayRef<toolchain::Value *> CapturedVars) override;
