...
#ifndef LANGUAGE_CORE_LIB_FORMAT_TOKENANNOTATOR_H
#define LANGUAGE_CORE_LIB_FORMAT_TOKENANNOTATOR_H
...
public:
  AnnotatedLine(const UnwrappedLine &Line)
    ...
    for (const UnwrappedLineNode &Node : toolchain::drop_begin(Line.Tokens)) {
