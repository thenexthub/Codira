...
#ifndef LANGUAGE_CORE_LIB_FORMAT_CONTINUATIONINDENTER_H
#define LANGUAGE_CORE_LIB_FORMAT_CONTINUATIONINDENTER_H
...
struct RawStringFormatStyleManager {
  toolchain::StringMap<FormatStyle> DelimiterStyle;
  toolchain::StringMap<FormatStyle> EnclosingFunctionStyle;
