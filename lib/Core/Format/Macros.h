...
private:
  ...
  toolchain::StringMap<toolchain::DenseMap<int, Definition>> FunctionLike;
  toolchain::StringMap<Definition> ObjectLike;
};
...
public:
  ...
  MacroCallReconstructor(
      unsigned Level,
      const toolchain::DenseMap<FormatToken *, std::unique_ptr<UnwrappedLine>>
          &ActiveExpansions);
...
private:
  ...
  toolchain::DenseMap<FormatToken *, FormatToken *>
