...
#ifndef LANGUAGE_CORE_LIB_FORMAT_BREAKABLETOKEN_H
#define LANGUAGE_CORE_LIB_FORMAT_BREAKABLETOKEN_H
...
public:
  ...
  virtual Split getSplit(unsigned LineIndex, unsigned TailOffset,
                         ...
                         const toolchain::Regex &CommentPragmasRegex) const = 0;
...
public:
  ...
  Split getSplit(unsigned LineIndex, unsigned TailOffset, unsigned ColumnLimit,
                 ...
                 const toolchain::Regex &CommentPragmasRegex) const override;
...
public:
  ...
  // on multiple lines.
  static const toolchain::StringSet<> ContentIndentingJavadocAnnotations;
