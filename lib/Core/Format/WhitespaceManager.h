...
#ifndef LANGUAGE_CORE_LIB_FORMAT_WHITESPACEMANAGER_H
#define LANGUAGE_CORE_LIB_FORMAT_WHITESPACEMANAGER_H
...
public:
  ...
  toolchain::Error addReplacement(const tooling::Replacement &Replacement);
