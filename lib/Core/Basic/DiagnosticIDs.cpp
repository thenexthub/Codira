...
#include "language/Core/Basic/AllDiagnostics.h"
...
#include "language/Core/Basic/AllDiagnosticKinds.inc"
#undef DIAG
};
...
#include "language/Core/Basic/DiagnosticCommonKinds.inc"
#include "language/Core/Basic/DiagnosticDriverKinds.inc"
#include "language/Core/Basic/DiagnosticFrontendKinds.inc"
#include "language/Core/Basic/DiagnosticSerializationKinds.inc"
#include "language/Core/Basic/DiagnosticLexKinds.inc"
#include "language/Core/Basic/DiagnosticParseKinds.inc"
#include "language/Core/Basic/DiagnosticASTKinds.inc"
#include "language/Core/Basic/DiagnosticCommentKinds.inc"
#include "language/Core/Basic/DiagnosticCrossTUKinds.inc"
#include "language/Core/Basic/DiagnosticSemaKinds.inc"
#include "language/Core/Basic/DiagnosticAnalysisKinds.inc"
#include "language/Core/Basic/DiagnosticRefactoringKinds.inc"
#include "language/Core/Basic/DiagnosticInstallAPIKinds.inc"
// clang-format on
#undef DIAG
};
...
static DiagnosticIDs::Level toLevel(diag::Severity SV) {
  ...
  toolchain_unreachable("unexpected severity");
}
...
DiagnosticIDs::getGroupForWarningOption(StringRef Name) {
  const auto *Found = toolchain::partition_point(
...
DiagnosticIDs::getDiagnosticsInGroup(diag::Flavor Flavor, StringRef Group,
  ...
  if (std::optional<diag::Group> G = getGroupForWarningOption(Group)) {
    if (CustomDiagInfo)
      toolchain::copy(CustomDiagInfo->getDiagsInGroup(*G),
                 std::back_inserter(Diags));
...
StringRef DiagnosticIDs::getNearestOption(diag::Flavor Flavor,
  ...
  for (const WarningOption &O : OptionTable) {
    ...
    toolchain::SmallVector<diag::kind, 8> Diags;
...
#include "language/Core/Basic/DiagnosticAllCompatIDs.inc"
  };
