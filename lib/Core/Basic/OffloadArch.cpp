...
const char *OffloadArchToString(OffloadArch A) {
  auto Result =
      toolchain::find_if(ArchNames, [A](const OffloadArchToStringMap &Map) {
        return A == Map.Arch;
      });
...
OffloadArch StringToOffloadArch(toolchain::StringRef S) {
  auto Result =
      toolchain::find_if(ArchNames, [S](const OffloadArchToStringMap &Map) {
