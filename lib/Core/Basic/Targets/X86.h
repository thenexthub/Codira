...
#ifndef LANGUAGE_CORE_LIB_BASIC_TARGETS_X86_H
#define LANGUAGE_CORE_LIB_BASIC_TARGETS_X86_H
...
protected:
  toolchain::X86::CPUKind CPU = toolchain::X86::CK_None;

  enum FPMathKind { FP_Default, FP_SSE, FP_387 } FPMath = FP_Default;

public:
  X86TargetInfo(const toolchain::Triple &Triple, const TargetOptions &)
      : TargetInfo(Triple) {
    BFloat16Width = BFloat16Align = 16;
    BFloat16Format = &toolchain::APFloat::BFloat();
    LongDoubleFormat = &toolchain::APFloat::x87DoubleExtended();
  ...
  const char *getLongDoubleMangling() const override {
    return LongDoubleFormat == &toolchain::APFloat::IEEEquad() ? "g" : "e";
  }
  ...
  void getCPUSpecificCPUDispatchFeatures(
      StringRef Name,
      toolchain::SmallVectorImpl<StringRef> &Features) const override;
  ...
  bool validateOutputSize(const toolchain::StringMap<bool> &FeatureMap,
                          StringRef Constraint, unsigned Size) const override;

  bool validateInputSize(const toolchain::StringMap<bool> &FeatureMap,
                         StringRef Constraint, unsigned Size) const override;

  bool
  checkCFProtectionReturnSupported(DiagnosticsEngine &Diags) const override {
    if (CPU == toolchain::X86::CK_None || CPU >= toolchain::X86::CK_PentiumPro)
      return true;
  ...
  virtual bool validateOperandSize(const toolchain::StringMap<bool> &FeatureMap,
  ...
  StringRef getABI() const override {
    if (getTriple().getArch() == toolchain::Triple::x86_64 && SSELevel >= AVX512F)
      return "avx512";
    if (getTriple().getArch() == toolchain::Triple::x86_64 && SSELevel >= AVX)
      return "avx";
    if (getTriple().getArch() == toolchain::Triple::x86 && !HasMMX)
      return "no-mmx";
    return "";
  }
  ...
  bool isValidCPUName(StringRef Name) const override {
    bool Only64Bit = getTriple().getArch() != toolchain::Triple::x86;
    return toolchain::X86::parseArchX86(Name, Only64Bit) != toolchain::X86::CK_None;
  }
  ...
  bool isValidTuneCPUName(StringRef Name) const override {
    ...
    return toolchain::X86::parseTuneCPU(Name) != toolchain::X86::CK_None;
  }
  ...
  bool setCPU(const std::string &Name) override {
    bool Only64Bit = getTriple().getArch() != toolchain::Triple::x86;
    CPU = toolchain::X86::parseArchX86(Name, Only64Bit);
    return CPU != toolchain::X86::CK_None;
  }
  ...
  bool supportsExtendIntArgs() const override {
    return getTriple().getArch() != toolchain::Triple::x86;
  }
...
public:
  X86_32TargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
  ...
  bool validateOperandSize(const toolchain::StringMap<bool> &FeatureMap,
                           StringRef Constraint, unsigned Size) const override {
    switch (Constraint[0]) {
    default:
      break;
  ...
  size_t getMaxBitIntWidth() const override {
    return toolchain::IntegerType::MAX_INT_BITS;
  }
};
...
public:
  NetBSDI386TargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
...
public:
  OpenBSDI386TargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
...
public:
  AppleMachOI386TargetInfo(const toolchain::Triple &Triple,
...
public:
  DarwinI386TargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
    ...
    toolchain::Triple T = toolchain::Triple(Triple);
    if (T.isWatchOS())
...
public:
  WindowsX86_32TargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
...
public:
  MicrosoftX86_32TargetInfo(const toolchain::Triple &Triple,
                            const TargetOptions &Opts)
...
class LLVM_LIBRARY_VISIBILITY MinGWX86_32TargetInfo
    : public WindowsX86_32TargetInfo {
public:
  MinGWX86_32TargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : WindowsX86_32TargetInfo(Triple, Opts) {
    HasFloat128 = true;
  }
...
public:
  CygwinX86_32TargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
...
public:
  HaikuX86_32TargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
...
public:
  MCUX86_32TargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : X86_32TargetInfo(Triple, Opts) {
    LongDoubleWidth = 64;
...
public:
  RTEMSX86_32TargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : X86_32TargetInfo(Triple, Opts) {
    SizeType = UnsignedLong;
    IntPtrType = SignedLong;
    PtrDiffType = SignedLong;
...
public:
  X86_64TargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : X86TargetInfo(Triple, Opts) {
...
public:
  UEFIX86_64TargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
...
public:
  WindowsX86_64TargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
...
public:
  MicrosoftX86_64TargetInfo(const toolchain::Triple &Triple,
                            const TargetOptions &Opts)
...
class LLVM_LIBRARY_VISIBILITY MinGWX86_64TargetInfo
    : public WindowsX86_64TargetInfo {
public:
  MinGWX86_64TargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : WindowsX86_64TargetInfo(Triple, Opts) {
...
public:
  CygwinX86_64TargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
...
public:
  DarwinX86_64TargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
...
public:
  OpenBSDX86_64TargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
...
public:
  AndroidX86_32TargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
...
public:
  AndroidX86_64TargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
...
public:
  OHOSX86_32TargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
...
public:
  OHOSX86_64TargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
...
#endif // LANGUAGE_CORE_LIB_BASIC_TARGETS_X86_H
