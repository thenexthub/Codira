...
#ifndef LANGUAGE_CORE_LIB_BASIC_TARGETS_OSTARGETS_H
#define LANGUAGE_CORE_LIB_BASIC_TARGETS_OSTARGETS_H
...
protected:
  virtual void getOSDefines(const LangOptions &Opts, const toolchain::Triple &Triple,
                            MacroBuilder &Builder) const = 0;

public:
  OSTargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : TgtInfo(Triple, Opts) {}
...
void getDarwinDefines(MacroBuilder &Builder, const LangOptions &Opts,
                      const toolchain::Triple &Triple, StringRef &PlatformName,
...
public:
  AppleMachOTargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
...
public:
  DarwinTargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
  ...
  unsigned getExnObjectAlignment() const override {
    ...
    toolchain::VersionTuple MinVersion;
    const toolchain::Triple &T = this->getTriple();

    // Compute the earliest OS versions that have the fix to libc++abi.
    switch (T.getOS()) {
    case toolchain::Triple::Darwin:
    case toolchain::Triple::MacOSX: // Earliest supporting version is 10.14.
      MinVersion = toolchain::VersionTuple(10U, 14U);
      break;
    case toolchain::Triple::IOS:
    case toolchain::Triple::TvOS: // Earliest supporting version is 12.0.0.
      MinVersion = toolchain::VersionTuple(12U);
      break;
    case toolchain::Triple::WatchOS: // Earliest supporting version is 5.0.0.
      MinVersion = toolchain::VersionTuple(5U);
      break;
    case toolchain::Triple::XROS:
      MinVersion = toolchain::VersionTuple(0);
      break;
    default:
...
public:
  DragonFlyBSDTargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : OSTargetInfo<Target>(Triple, Opts) {
...
public:
  FreeBSDTargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : OSTargetInfo<Target>(Triple, Opts) {
    switch (Triple.getArch()) {
    case toolchain::Triple::x86:
    case toolchain::Triple::x86_64:
...
public:
  HaikuTargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : OSTargetInfo<Target>(Triple, Opts) {
...
public:
  LinuxTargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : OSTargetInfo<Target>(Triple, Opts) {
...
public:
  ManagarmTargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : OSTargetInfo<Target>(Triple, Opts) {
    switch (Triple.getArch()) {
    default:
      break;
...
public:
  NetBSDTargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : OSTargetInfo<Target>(Triple, Opts) {
    this->MCountName = "__mcount";
    switch (Triple.getArch()) {
    default:
...
public:
  OpenBSDTargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : OSTargetInfo<Target>(Triple, Opts) {
...
public:
  PS3PPUTargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : OSTargetInfo<Target>(Triple, Opts) {
...
public:
  PSOSTargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : OSTargetInfo<Target>(Triple, Opts) {
...
public:
  RTEMSTargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : OSTargetInfo<Target>(Triple, Opts) {
    switch (Triple.getArch()) {
    default:
    case toolchain::Triple::x86:
...
public:
  SolarisTargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : OSTargetInfo<Target>(Triple, Opts) {
...
public:
  AIXTargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : OSTargetInfo<Target>(Triple, Opts) {
    this->MCountName = "__mcount";
...
protected:
  void getOSDefines(const LangOptions &Opts, const toolchain::Triple &Triple,
    ...
    this->PlatformName = toolchain::Triple::getOSTypeName(Triple.getOS());
  }

public:
  ZOSTargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : OSTargetInfo<Target>(Triple, Opts) {
...
public:
  UEFITargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : OSTargetInfo<Target>(Triple, Opts) {
    this->WCharType = TargetInfo::UnsignedShort;
...
void addWindowsDefines(const toolchain::Triple &Triple, const LangOptions &Opts,
...
public:
  WindowsTargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : OSTargetInfo<Target>(Triple, Opts) {
    this->WCharType = TargetInfo::UnsignedShort;
    this->WIntType = TargetInfo::UnsignedShort;
    this->UseMicrosoftManglingForC = true;
...
public:
  FuchsiaTargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : OSTargetInfo<Target>(Triple, Opts) {
    this->WIntType = TargetInfo::UnsignedInt;
    this->MCountName = "__mcount";
...
public:
  explicit WebAssemblyOSTargetInfo(const toolchain::Triple &Triple,
...
public:
  explicit EmscriptenTargetInfo(const toolchain::Triple &Triple,
                                const TargetOptions &Opts)
...
public:
  OHOSTargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts)
      : OSTargetInfo<Target>(Triple, Opts) {
    this->WIntType = TargetInfo::UnsignedInt;
...
#endif // LANGUAGE_CORE_LIB_BASIC_TARGETS_OSTARGETS_H
