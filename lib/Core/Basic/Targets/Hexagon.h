...
#ifndef LANGUAGE_CORE_LIB_BASIC_TARGETS_HEXAGON_H
#define LANGUAGE_CORE_LIB_BASIC_TARGETS_HEXAGON_H
...
public:
  HexagonTargetInfo(const toolchain::Triple &Triple, const TargetOptions &)
      : TargetInfo(Triple) {
...
#endif // LANGUAGE_CORE_LIB_BASIC_TARGETS_HEXAGON_H
