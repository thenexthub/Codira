...
#ifndef LANGUAGE_CORE_LIB_BASIC_TARGETS_MIPS_H
#define LANGUAGE_CORE_LIB_BASIC_TARGETS_MIPS_H
...
class LLVM_LIBRARY_VISIBILITY MipsTargetInfo : public TargetInfo {
  void setDataLayout() {
    ...
    if (ABI == "o32")
      ...
      toolchain_unreachable("Invalid ABI");
...
public:
  MipsTargetInfo(const toolchain::Triple &Triple, const TargetOptions &)
  ...
  ArrayRef<TargetInfo::GCCRegAlias> getGCCRegAliases() const override {
    ...
    if (ABI == "o32")
      return toolchain::ArrayRef(O32RegAliases);
    return toolchain::ArrayRef(NewABIRegAliases);
  }
...
public:
  WindowsMipsTargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts);
...
public:
  MicrosoftMipsTargetInfo(const toolchain::Triple &Triple,
...
class LLVM_LIBRARY_VISIBILITY MinGWMipsTargetInfo
    : public WindowsMipsTargetInfo {
public:
  MinGWMipsTargetInfo(const toolchain::Triple &Triple, const TargetOptions &Opts);
...
#endif // LANGUAGE_CORE_LIB_BASIC_TARGETS_MIPS_H
