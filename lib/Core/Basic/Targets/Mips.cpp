...
static constexpr int NumBuiltins =
    language::Core::Mips::LastTSBuiltin - Builtin::FirstTSBuiltin;
...
unsigned MipsTargetInfo::getISARev() const {
  return toolchain::StringSwitch<unsigned>(getCPU())
...
unsigned MipsTargetInfo::getUnwindWordWidth() const {
  return toolchain::StringSwitch<unsigned>(ABI)
      .Case("o32", 32)
      .Case("n32", 64)
      .Case("n64", 64)
...
WindowsMipsTargetInfo::WindowsMipsTargetInfo(const toolchain::Triple &Triple,
...
MicrosoftMipsTargetInfo::MicrosoftMipsTargetInfo(const toolchain::Triple &Triple,
                                                 const TargetOptions &Opts)
...
MinGWMipsTargetInfo::MinGWMipsTargetInfo(const toolchain::Triple &Triple,
                                         const TargetOptions &Opts)
    : WindowsMipsTargetInfo(Triple, Opts) {
