...
using namespace language::Core::driver::types;
...
#include "language/Core/Driver/Types.def"
#undef TYPE
};
...
bool types::canTypeBeUserSpecified(ID Id) {
  static const language::Core::driver::types::ID kStaticLangageTypes[] = {
  ...
  return !toolchain::is_contained(kStaticLangageTypes, Id);
}
...
types::ID types::lookupTypeForExtension(toolchain::StringRef Ext) {
  return toolchain::StringSwitch<types::ID>(Ext)
      .Case("c", TY_C)
      .Case("C", TY_CXX)
      .Case("F", TY_Fortran)
...
toolchain::SmallVector<phases::ID, phases::MaxNumberOfPhases>
types::getCompilationPhases(ID Id, phases::ID LastPhase) {
  toolchain::SmallVector<phases::ID, phases::MaxNumberOfPhases> P;
...
toolchain::SmallVector<phases::ID, phases::MaxNumberOfPhases>
types::getCompilationPhases(const language::Core::driver::Driver &Driver,
                            toolchain::opt::DerivedArgList &DAL, ID Id) {
