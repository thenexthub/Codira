...
#ifndef LANGUAGE_CORE_LIB_DRIVER_TOOLCHAINS_PPC_LINUX_H
#define LANGUAGE_CORE_LIB_DRIVER_TOOLCHAINS_PPC_LINUX_H
...
public:
  PPCLinuxToolChain(const Driver &D, const toolchain::Triple &Triple,
...
private:
  bool SupportIEEEFloat128(const Driver &D, const toolchain::Triple &Triple,
...
#endif // LANGUAGE_CORE_LIB_DRIVER_TOOLCHAINS_PPC_LINUX_H
