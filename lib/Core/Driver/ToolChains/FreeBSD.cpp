...
void freebsd::Linker::ConstructJob(Compilation &C, const JobAction &JA,
  ...
  if (Args.hasArg(options::OPT_static)) {
    ...
    if (Arch == toolchain::Triple::arm || Triple.isX86())
...
FreeBSD::FreeBSD(const Driver &D, const toolchain::Triple &Triple,
                 const ArgList &Args)
...
void FreeBSD::addLibCxxIncludePaths(const toolchain::opt::ArgList &DriverArgs,
                                    toolchain::opt::ArgStringList &CC1Args) const {
...
bool FreeBSD::isPIEDefault(const toolchain::opt::ArgList &Args) const {
