...
Hurd::Hurd(const Driver &D, const toolchain::Triple &Triple, const ArgList &Args)
...
void Hurd::addLibStdCxxIncludePaths(const toolchain::opt::ArgList &DriverArgs,
  ...
  StringRef DebianMultiarch =
      GCCInstallation.getTriple().getArch() == toolchain::Triple::x86 ? "i386-gnu"
                                                                 : TripleStr;

  addGCCLibStdCxxIncludePaths(DriverArgs, CC1Args, DebianMultiarch);
}

void Hurd::addExtraOpts(toolchain::opt::ArgStringList &CmdArgs) const {
