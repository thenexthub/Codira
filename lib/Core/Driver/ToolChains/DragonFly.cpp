...
void dragonfly::Assembler::ConstructJob(Compilation &C, const JobAction &JA,
  ...
  if (ToolChain.getArch() == toolchain::Triple::x86)
...
DragonFly::DragonFly(const Driver &D, const toolchain::Triple &Triple,
                     const ArgList &Args)
...
void DragonFly::addLibStdCxxIncludePaths(const toolchain::opt::ArgList &DriverArgs,
                                         toolchain::opt::ArgStringList &CC1Args) const {
