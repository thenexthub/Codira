...
#ifndef LANGUAGE_CORE_LIB_DRIVER_TOOLCHAINS_SPIRV_OPENMP_H
#define LANGUAGE_CORE_LIB_DRIVER_TOOLCHAINS_SPIRV_OPENMP_H
...
public:
  SPIRVOpenMPToolChain(const Driver &D, const toolchain::Triple &Triple,
