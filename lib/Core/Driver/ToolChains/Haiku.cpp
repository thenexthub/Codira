...
Haiku::Haiku(const Driver &D, const toolchain::Triple& Triple, const ArgList &Args)
...
void Haiku::AddClangSystemIncludeArgs(const toolchain::opt::ArgList &DriverArgs,
...
void Haiku::addLibCxxIncludePaths(const toolchain::opt::ArgList &DriverArgs,
                                  toolchain::opt::ArgStringList &CC1Args) const {
