...
#ifndef LANGUAGE_CORE_LIB_DRIVER_TOOLCHAINS_DARWIN_H
#define LANGUAGE_CORE_LIB_DRIVER_TOOLCHAINS_DARWIN_H
...
namespace darwin {
toolchain::Triple::ArchType getArchTypeForMachOArchName(StringRef Str);
void setTripleTypeForMachOArchName(toolchain::Triple &T, StringRef Str,
...
protected:
  void AddMachOArch(const toolchain::opt::ArgList &Args,
...
class LLVM_LIBRARY_VISIBILITY Linker : public MachOTool {
  ...
  void AddLinkArgs(Compilation &C, const toolchain::opt::ArgList &Args,
...
public:
  MachO(const Driver &D, const toolchain::Triple &Triple,
        const toolchain::opt::ArgList &Args);
  ~MachO() override;
  ...
  StringRef getMachOArchName(const toolchain::opt::ArgList &Args) const;

  /// Get the version of the linker known to be available for a particular
  /// compiler invocation (via the `-mlinker-version=` arg).
  VersionTuple getLinkerVersion(const toolchain::opt::ArgList &Args) const;

  /// Add the linker arguments to link the ARC runtime library.
  virtual void AddLinkARCArgs(const toolchain::opt::ArgList &Args,
                              toolchain::opt::ArgStringList &CmdArgs) const {}
  ...
  /// misleadingly named.
  virtual void AddLinkRuntimeLibArgs(const toolchain::opt::ArgList &Args,
                                     toolchain::opt::ArgStringList &CmdArgs,
                                     bool ForceLinkBuiltinRT = false) const;

  virtual void addStartObjectFileArgs(const toolchain::opt::ArgList &Args,
                                      toolchain::opt::ArgStringList &CmdArgs) const {
  }

  virtual void addMinVersionArgs(const toolchain::opt::ArgList &Args,
                                 toolchain::opt::ArgStringList &CmdArgs) const {}

  virtual void addPlatformVersionArgs(const toolchain::opt::ArgList &Args,
                                      toolchain::opt::ArgStringList &CmdArgs) const {
  }
  ...
  void AddLinkRuntimeLib(const toolchain::opt::ArgList &Args,
                         toolchain::opt::ArgStringList &CmdArgs, StringRef Component,
...
public:
  AppleMachO(const Driver &D, const toolchain::Triple &Triple,
             const toolchain::opt::ArgList &Args);
  ~AppleMachO() override;
...
protected:
  ...
  GetEffectiveSysroot(const toolchain::opt::ArgList &DriverArgs) const;

private:
  virtual void
  AddGnuCPlusPlusIncludePaths(const toolchain::opt::ArgList &DriverArgs,
...
public:
  ...
  mutable std::optional<toolchain::Triple> TargetVariantTriple;

private:
  void AddDeploymentTarget(toolchain::opt::DerivedArgList &Args) const;
...
public:
  ...
  void addMinVersionArgs(const toolchain::opt::ArgList &Args,
                         toolchain::opt::ArgStringList &CmdArgs) const override;

  void addPlatformVersionArgs(const toolchain::opt::ArgList &Args,
                              toolchain::opt::ArgStringList &CmdArgs) const override;

  void addStartObjectFileArgs(const toolchain::opt::ArgList &Args,
                              toolchain::opt::ArgStringList &CmdArgs) const override;
...
protected:
  ...
  void setTarget(DarwinPlatformKind Platform, DarwinEnvironmentKind Environment,
    ...
    if (Environment == Simulator)
      const_cast<Darwin *>(this)->setTripleEnvironment(toolchain::Triple::Simulator);
    else if (Environment == MacCatalyst) {
      const_cast<Darwin *>(this)->setTripleEnvironment(toolchain::Triple::MacABI);
...
public:
  ...
  bool isTargetAppleSiliconMac() const {
    assert(TargetInitialized && "Target not initialized!");
    return isTargetMacOSBased() && getArch() == toolchain::Triple::aarch64;
  }
  ...
  bool isMacosxVersionLT(unsigned V0, unsigned V1 = 0, unsigned V2 = 0) const {
    ...
    VersionTuple MinVers =
        toolchain::Triple(getTriple().getArchName(), "apple", "macos")
...
protected:
  ...
  void addClangCC1ASTargetOptions(
      const toolchain::opt::ArgList &Args,
      toolchain::opt::ArgStringList &CC1ASArgs) const override;
...
public:
  DarwinClang(const Driver &D, const toolchain::Triple &Triple,
              const toolchain::opt::ArgList &Args);
  ...
  RuntimeLibType GetRuntimeLibType(const toolchain::opt::ArgList &Args) const override;

  void AddLinkRuntimeLibArgs(const toolchain::opt::ArgList &Args,
                             toolchain::opt::ArgStringList &CmdArgs,
                             bool ForceLinkBuiltinRT = false) const override;

  void AddCCKextLibArgs(const toolchain::opt::ArgList &Args,
                        toolchain::opt::ArgStringList &CmdArgs) const override;
  ...
  void AddLinkARCArgs(const toolchain::opt::ArgList &Args,
                      toolchain::opt::ArgStringList &CmdArgs) const override;
  ...
  toolchain::DebuggerKind getDefaultDebuggerTuning() const override {
    return toolchain::DebuggerKind::LLDB;
  }

  /// }

private:
  void AddLinkSanitizerLibArgs(const toolchain::opt::ArgList &Args,
                               toolchain::opt::ArgStringList &CmdArgs,
                               StringRef Sanitizer,
  ...
  bool AddGnuCPlusPlusIncludePaths(const toolchain::opt::ArgList &DriverArgs,
                                   toolchain::opt::ArgStringList &CC1Args,
...
#endif // LANGUAGE_CORE_LIB_DRIVER_TOOLCHAINS_DARWIN_H
