...
#ifndef LANGUAGE_CORE_LIB_DRIVER_TOOLCHAINS_HIPSPV_H
#define LANGUAGE_CORE_LIB_DRIVER_TOOLCHAINS_HIPSPV_H
...
public:
  HIPSPVToolChain(const Driver &D, const toolchain::Triple &Triple,
...
#endif // LANGUAGE_CORE_LIB_DRIVER_TOOLCHAINS_HIPSPV_H
