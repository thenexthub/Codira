...
#ifndef LANGUAGE_CORE_LIB_DRIVER_TOOLCHAINS_CYGWIN_H
#define LANGUAGE_CORE_LIB_DRIVER_TOOLCHAINS_CYGWIN_H
...
#endif // LANGUAGE_CORE_LIB_DRIVER_TOOLCHAINS_CYGWIN_H
