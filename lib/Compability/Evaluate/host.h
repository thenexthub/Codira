...
#ifndef LANGUAGE_COMPABILITY_EVALUATE_HOST_H_
#define LANGUAGE_COMPABILITY_EVALUATE_HOST_H_
...
template <int KIND> struct HostTypeHelper<Type<TypeCategory::Complex, KIND>> {
  using RealT = language::Compability::evaluate::Type<TypeCategory::Real, KIND>;
...
template <> struct HostTypeHelper<Type<TypeCategory::Complex, 16>> {
  using RealT = language::Compability::evaluate::Type<TypeCategory::Real, 16>;
...
template <int KIND> struct HostTypeHelper<Type<TypeCategory::Character, KIND>> {
  using Type =
      Scalar<typename language::Compability::evaluate::Type<TypeCategory::Character, KIND>>;
};
