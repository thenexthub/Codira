...
#include "language/Compability/Evaluate/pgmath.h.inc"
...
// TODO: double _Complex/float _Complex have been removed from toolchain flang
...
const ArgumentVerifierFunc *findVerifier(const std::string &intrinsicName) {
  static constexpr language::Compability::common::StaticMultimapView<ArgumentVerifier>
