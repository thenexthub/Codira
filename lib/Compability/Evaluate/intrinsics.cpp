...
bool IntrinsicProcTable::Implementation::IsDualIntrinsic(
  ...
  static const std::string dualIntrinsic[]{{"chdir"}, {"etime"}, {"fseek"},
      ...
      {"system"}, {"unlink"}};
  return toolchain::is_contained(dualIntrinsic, name);
}
...
toolchain::raw_ostream &TypePattern::Dump(toolchain::raw_ostream &o) const {
...
toolchain::raw_ostream &IntrinsicDummyArgument::Dump(toolchain::raw_ostream &o) const {
  if (keyword) {
    o << keyword << '=';
  }
...
toolchain::raw_ostream &IntrinsicInterface::Dump(toolchain::raw_ostream &o) const {
  o << name;
  char sep{'('};
...
toolchain::raw_ostream &IntrinsicProcTable::Implementation::Dump(
...
toolchain::raw_ostream &IntrinsicProcTable::Dump(toolchain::raw_ostream &o) const {
