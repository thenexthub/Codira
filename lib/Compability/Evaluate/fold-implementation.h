...
#ifndef LANGUAGE_COMPABILITY_EVALUATE_FOLD_IMPLEMENTATION_H_
#define LANGUAGE_COMPABILITY_EVALUATE_FOLD_IMPLEMENTATION_H_
...
#include "language/Compability/Evaluate/intrinsics-library.h"
