...
#include "language/Compability/Evaluate/formatting.h"
...
static void ShapeAsFortran(toolchain::raw_ostream &o,
...
toolchain::raw_ostream &ConstantBase<RESULT, VALUE>::AsFortran(
    toolchain::raw_ostream &o) const {
...
template <int KIND>
toolchain::raw_ostream &Constant<Type<TypeCategory::Character, KIND>>::AsFortran(
    toolchain::raw_ostream &o) const {
  bool hasNonDefaultLowerBound{printLbounds && HasNonDefaultLowerBound()};
  if (Rank() > 1 || hasNonDefaultLowerBound) {
    o << "reshape(";
...
toolchain::raw_ostream &EmitVar(toolchain::raw_ostream &o, const Symbol &symbol,
...
toolchain::raw_ostream &EmitVar(toolchain::raw_ostream &o, const std::string &lit) {
  return o << parser::QuoteCharacterLiteral(lit);
}

toolchain::raw_ostream &EmitVar(toolchain::raw_ostream &o, const std::u16string &lit) {
  return o << parser::QuoteCharacterLiteral(lit);
}

toolchain::raw_ostream &EmitVar(toolchain::raw_ostream &o, const std::u32string &lit) {
  return o << parser::QuoteCharacterLiteral(lit);
}

template <typename A>
toolchain::raw_ostream &EmitVar(toolchain::raw_ostream &o, const A &x) {
  return x.AsFortran(o);
}

template <typename A>
toolchain::raw_ostream &EmitVar(toolchain::raw_ostream &o, common::Reference<A> x) {
  return EmitVar(o, *x);
}

template <typename A>
toolchain::raw_ostream &EmitVar(
    toolchain::raw_ostream &o, const A *p, const char *kw = nullptr) {
  if (p) {
    if (kw) {
      o << kw;
    }
...
template <typename A>
toolchain::raw_ostream &EmitVar(
    toolchain::raw_ostream &o, const std::optional<A> &x, const char *kw = nullptr) {
  if (x) {
    if (kw) {
      o << kw;
    }
...
toolchain::raw_ostream &EmitVar(toolchain::raw_ostream &o,
...
template <typename A>
toolchain::raw_ostream &EmitVar(toolchain::raw_ostream &o, const std::shared_ptr<A> &p) {
  CHECK(p);
  return EmitVar(o, *p);
}

template <typename... A>
toolchain::raw_ostream &EmitVar(toolchain::raw_ostream &o, const std::variant<A...> &u) {
  common::visit([&](const auto &x) { EmitVar(o, x); }, u);
  return o;
}

toolchain::raw_ostream &ActualArgument::AssumedType::AsFortran(
    toolchain::raw_ostream &o) const {
  return EmitVar(o, *symbol_);
}

toolchain::raw_ostream &ActualArgument::AsFortran(toolchain::raw_ostream &o) const {
  if (keyword_) {
    o << keyword_->ToString() << '=';
  }
  if (isPercentVal()) {
...
toolchain::raw_ostream &SpecificIntrinsic::AsFortran(toolchain::raw_ostream &o) const {
  return o << name;
}

toolchain::raw_ostream &ProcedureRef::AsFortran(toolchain::raw_ostream &o) const {
...
toolchain::raw_ostream &Operation<D, R, O...>::AsFortran(
    toolchain::raw_ostream &o) const {
...
toolchain::raw_ostream &Convert<TO, FROMCAT>::AsFortran(toolchain::raw_ostream &o) const {
...
toolchain::raw_ostream &Relational<SomeType>::AsFortran(toolchain::raw_ostream &o) const {
  common::visit([&](const auto &rel) { rel.AsFortran(o); }, u);
  return o;
}

template <typename T>
toolchain::raw_ostream &EmitArray(toolchain::raw_ostream &o, const Expr<T> &expr) {
  return expr.AsFortran(o);
}

template <typename T>
toolchain::raw_ostream &EmitArray(
    toolchain::raw_ostream &, const ArrayConstructorValues<T> &);

template <typename T>
toolchain::raw_ostream &EmitArray(toolchain::raw_ostream &o, const ImpliedDo<T> &implDo) {
  o << '(';
...
template <typename T>
toolchain::raw_ostream &EmitArray(
    toolchain::raw_ostream &o, const ArrayConstructorValues<T> &values) {
  const char *sep{""};
...
template <typename T>
toolchain::raw_ostream &ArrayConstructor<T>::AsFortran(toolchain::raw_ostream &o) const {
  o << '[' << GetType().AsFortran() << "::";
  EmitArray(o, *this);
  return o << ']';
}
...
toolchain::raw_ostream &ArrayConstructor<SomeDerived>::AsFortran(
    toolchain::raw_ostream &o) const {
  o << '[' << GetType().AsFortran() << "::";
  EmitArray(o, *this);
  return o << ']';
...
std::string ExpressionBase<RESULT>::AsFortran() const {
  std::string buf;
  toolchain::raw_string_ostream ss{buf};
  AsFortran(ss);
  return buf;
}

template <typename RESULT>
toolchain::raw_ostream &ExpressionBase<RESULT>::AsFortran(
    toolchain::raw_ostream &o) const {
...
toolchain::raw_ostream &StructureConstructor::AsFortran(toolchain::raw_ostream &o) const {
...
toolchain::raw_ostream &BaseObject::AsFortran(toolchain::raw_ostream &o) const {
  return EmitVar(o, u);
}

toolchain::raw_ostream &TypeParamInquiry::AsFortran(toolchain::raw_ostream &o) const {
  if (base_) {
...
toolchain::raw_ostream &Component::AsFortran(toolchain::raw_ostream &o) const {
  base_.value().AsFortran(o);
  return EmitVar(o << '%', symbol_);
}

toolchain::raw_ostream &NamedEntity::AsFortran(toolchain::raw_ostream &o) const {
  common::visit(common::visitors{
...
toolchain::raw_ostream &Triplet::AsFortran(toolchain::raw_ostream &o) const {
  EmitVar(o, lower_) << ':';
  EmitVar(o, upper_);
...
toolchain::raw_ostream &Subscript::AsFortran(toolchain::raw_ostream &o) const {
  return EmitVar(o, u);
}

toolchain::raw_ostream &ArrayRef::AsFortran(toolchain::raw_ostream &o) const {
  base_.AsFortran(o);
  char separator{'('};
...
toolchain::raw_ostream &CoarrayRef::AsFortran(toolchain::raw_ostream &o) const {
  base().AsFortran(o);
  char separator{'['};
...
toolchain::raw_ostream &DataRef::AsFortran(toolchain::raw_ostream &o) const {
  return EmitVar(o, u);
}

toolchain::raw_ostream &Substring::AsFortran(toolchain::raw_ostream &o) const {
  EmitVar(o, parent_) << '(';
  EmitVar(o, lower_) << ':';
  return EmitVar(o, upper_) << ')';
}

toolchain::raw_ostream &ComplexPart::AsFortran(toolchain::raw_ostream &o) const {
  return complex_.AsFortran(o) << '%' << EnumToString(part_);
}

toolchain::raw_ostream &ProcedureDesignator::AsFortran(toolchain::raw_ostream &o) const {
  return EmitVar(o, u);
}

template <typename T>
toolchain::raw_ostream &Designator<T>::AsFortran(toolchain::raw_ostream &o) const {
  common::visit(common::visitors{
...
toolchain::raw_ostream &DescriptorInquiry::AsFortran(toolchain::raw_ostream &o) const {
  switch (field_) {
...
toolchain::raw_ostream &Assignment::AsFortran(toolchain::raw_ostream &o) const {
  common::visit(
      common::visitors{
