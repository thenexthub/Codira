  ...
  void RewriteOpenMPLoopConstruct(parser::OpenMPLoopConstruct &x,
    ...
    while (++nextIt != block.end()) {
      ...
      if (auto *doCons{GetConstructIf<parser::DoConstruct>(*nextIt)}) {
        ...
        if ((nestedBeginLoopDirective.v == toolchain::omp::Directive::OMPD_unroll ||
                nestedBeginLoopDirective.v ==
                    toolchain::omp::Directive::OMPD_tile) &&
            !(nestedBeginLoopDirective.v == toolchain::omp::Directive::OMPD_unroll &&
                dir.v == toolchain::omp::Directive::OMPD_tile)) {
          ...
          nextIt = block.erase(nextIt);
                ...
                toolchain::omp::Directive::OMPD_unroll &&
            dir.v == toolchain::omp::Directive::OMPD_tile) {
          ...
          if (unrollClauseList.v.empty()) {
            ...
            for (auto clause{unrollClauseList.v.begin()};
              ...
              if (clause->Id() == toolchain::omp::OMPC_full) {
                tileUnrollError(dir, messages_);
              }
            }
          }
