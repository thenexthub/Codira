...
private:
  using NameWithId = std::pair<std::string, toolchain::omp::Directive>;
  using ConstIterator = std::vector<NameWithId>::const_iterator;

  toolchain::iterator_range<ConstIterator> directives_starting_with(
      char initial) const;
  void initTokens(std::vector<NameWithId>[]) const;
};

toolchain::iterator_range<OmpDirectiveNameParser::ConstIterator>
OmpDirectiveNameParser::directives_starting_with(char initial) const {
  static const std::vector<NameWithId> empty{};
  if (initial < 'a' || initial > 'z') {
    return toolchain::make_range(std::cbegin(empty), std::cend(empty));
  }
  ...
  int index = initial - 'a';
  return toolchain::make_range(std::cbegin(table[index]), std::cend(table[index]));
}

void OmpDirectiveNameParser::initTokens(std::vector<NameWithId> table[]) const {
  for (size_t i{0}, e{toolchain::omp::Directive_enumSize}; i != e; ++i) {
    toolchain::StringSet spellings;
    auto id{static_cast<toolchain::omp::Directive>(i)};
    for (unsigned version : toolchain::omp::getOpenMPVersions()) {
      spellings.insert(toolchain::omp::getOpenMPDirectiveName(id, version));
    }
  ...
  for (int initial{'a'}; initial != 'z' + 1; ++initial) {
    toolchain::stable_sort(table[initial - 'a'],
...
struct TraitSelectorParser {
  ...
  std::optional<resultType> Parse(ParseState &state) const {
    ...
    if (auto *v{std::get_if<OmpTraitSelectorName::Value>(&name->u)}) {
      ...
      // The other alternatives are `toolchain::omp::Directive`, and `std::string`.
    ...
    toolchain_unreachable("Unhandled trait name?");
  }
...
TYPE_PARSER(construct<OmpAbsentClause>(many(maybe(","_tok) >>
    construct<toolchain::omp::Directive>(unwrap(OmpDirectiveNameParser{})))))
...
TYPE_PARSER(sourced(construct<OmpLoopDirective>(first(
    "DISTRIBUTE PARALLEL DO SIMD" >>
        pure(toolchain::omp::Directive::OMPD_distribute_parallel_do_simd),
    "DISTRIBUTE PARALLEL DO" >>
        pure(toolchain::omp::Directive::OMPD_distribute_parallel_do),
    "DISTRIBUTE SIMD" >> pure(toolchain::omp::Directive::OMPD_distribute_simd),
    "DISTRIBUTE" >> pure(toolchain::omp::Directive::OMPD_distribute),
    "DO SIMD" >> pure(toolchain::omp::Directive::OMPD_do_simd),
    "DO" >> pure(toolchain::omp::Directive::OMPD_do),
    "LOOP" >> pure(toolchain::omp::Directive::OMPD_loop),
    "MASKED TASKLOOP SIMD" >>
        pure(toolchain::omp::Directive::OMPD_masked_taskloop_simd),
    "MASKED TASKLOOP" >> pure(toolchain::omp::Directive::OMPD_masked_taskloop),
    "MASTER TASKLOOP SIMD" >>
        pure(toolchain::omp::Directive::OMPD_master_taskloop_simd),
    "MASTER TASKLOOP" >> pure(toolchain::omp::Directive::OMPD_master_taskloop),
    "PARALLEL DO SIMD" >> pure(toolchain::omp::Directive::OMPD_parallel_do_simd),
    "PARALLEL DO" >> pure(toolchain::omp::Directive::OMPD_parallel_do),
    "PARALLEL MASKED TASKLOOP SIMD" >>
        pure(toolchain::omp::Directive::OMPD_parallel_masked_taskloop_simd),
    "PARALLEL MASKED TASKLOOP" >>
        pure(toolchain::omp::Directive::OMPD_parallel_masked_taskloop),
    "PARALLEL MASTER TASKLOOP SIMD" >>
        pure(toolchain::omp::Directive::OMPD_parallel_master_taskloop_simd),
    "PARALLEL MASTER TASKLOOP" >>
        pure(toolchain::omp::Directive::OMPD_parallel_master_taskloop),
    "SIMD" >> pure(toolchain::omp::Directive::OMPD_simd),
    "TARGET LOOP" >> pure(toolchain::omp::Directive::OMPD_target_loop),
    "TARGET PARALLEL DO SIMD" >>
        pure(toolchain::omp::Directive::OMPD_target_parallel_do_simd),
    "TARGET PARALLEL DO" >> pure(toolchain::omp::Directive::OMPD_target_parallel_do),
    "TARGET PARALLEL LOOP" >>
        pure(toolchain::omp::Directive::OMPD_target_parallel_loop),
    "TARGET SIMD" >> pure(toolchain::omp::Directive::OMPD_target_simd),
    "TARGET TEAMS DISTRIBUTE PARALLEL DO SIMD" >>
        pure(toolchain::omp::Directive::
                OMPD_target_teams_distribute_parallel_do_simd),
    "TARGET TEAMS DISTRIBUTE PARALLEL DO" >>
        pure(toolchain::omp::Directive::OMPD_target_teams_distribute_parallel_do),
    "TARGET TEAMS DISTRIBUTE SIMD" >>
        pure(toolchain::omp::Directive::OMPD_target_teams_distribute_simd),
    "TARGET TEAMS DISTRIBUTE" >>
        pure(toolchain::omp::Directive::OMPD_target_teams_distribute),
    "TARGET TEAMS LOOP" >> pure(toolchain::omp::Directive::OMPD_target_teams_loop),
    "TASKLOOP SIMD" >> pure(toolchain::omp::Directive::OMPD_taskloop_simd),
    "TASKLOOP" >> pure(toolchain::omp::Directive::OMPD_taskloop),
    "TEAMS DISTRIBUTE PARALLEL DO SIMD" >>
        pure(toolchain::omp::Directive::OMPD_teams_distribute_parallel_do_simd),
    "TEAMS DISTRIBUTE PARALLEL DO" >>
        pure(toolchain::omp::Directive::OMPD_teams_distribute_parallel_do),
    "TEAMS DISTRIBUTE SIMD" >>
        pure(toolchain::omp::Directive::OMPD_teams_distribute_simd),
    "TEAMS DISTRIBUTE" >> pure(toolchain::omp::Directive::OMPD_teams_distribute),
    "TEAMS LOOP" >> pure(toolchain::omp::Directive::OMPD_teams_loop),
    "TILE" >> pure(toolchain::omp::Directive::OMPD_tile),
    "UNROLL" >> pure(toolchain::omp::Directive::OMPD_unroll)))))

TYPE_PARSER(sourced(construct<OmpBeginLoopDirective>(
    sourced(Parser<OmpLoopDirective>{}), Parser<OmpClauseList>{})))

static inline constexpr auto IsDirective(toolchain::omp::Directive dir) {
...
struct OmpBeginDirectiveParser {
  ...
  constexpr OmpBeginDirectiveParser(toolchain::omp::Directive dir) : dir_(dir) {}
...
private:
  toolchain::omp::Directive dir_;
};

struct OmpEndDirectiveParser {
  using resultType = OmpDirectiveSpecification;

  constexpr OmpEndDirectiveParser(toolchain::omp::Directive dir) : dir_(dir) {}
...
struct OmpStatementConstructParser {
  ...
  constexpr OmpStatementConstructParser(toolchain::omp::Directive dir) : dir_(dir) {}
  ...
  std::optional<resultType> Parse(ParseState &state) const {
    if (auto begin{OmpBeginDirectiveParser(dir_).Parse(state)}) {
      ...
      return OmpBlockConstruct{OmpBeginDirective(std::move(*begin)),
          std::move(body),
          toolchain::transformOptional(std::move(*end),
...
struct OmpBlockConstructParser {
  ...
  constexpr OmpBlockConstructParser(toolchain::omp::Directive dir) : dir_(dir) {}
...
TYPE_PARSER(sourced(construct<OpenMPAllocatorsConstruct>(
    OmpStatementConstructParser{toolchain::omp::Directive::OMPD_allocators})))

TYPE_PARSER(sourced(construct<OpenMPDispatchConstruct>(
    OmpStatementConstructParser{toolchain::omp::Directive::OMPD_dispatch})))
...
struct OmpAtomicConstructParser {
  ...
  std::optional<resultType> Parse(ParseState &state) const {
    ...
    if (!dirSpec || dirSpec->DirId() != toolchain::omp::Directive::OMPD_atomic) {
      recursing_ = false;
      return std::nullopt;
    }

    auto exec{Parser<ExecutionPartConstruct>{}};
    auto end{OmpEndDirectiveParser{toolchain::omp::Directive::OMPD_atomic}};
    TailType tail;
    ...
    if (ParseOne(exec, end, tail, state)) {
      ...
      return OpenMPAtomicConstruct{OmpBeginDirective(std::move(*dirSpec)),
          std::move(tail.first),
          toolchain::transformOptional(std::move(tail.second),
              [](auto &&s) { return OmpEndDirective(std::move(s)); })};
    }
...
TYPE_PARSER(sourced( //
    construct<OpenMPFlushConstruct>(
        predicated(OmpDirectiveNameParser{},
            IsDirective(toolchain::omp::Directive::OMPD_flush)) >=
        Parser<OmpDirectiveSpecification>{})))
...
TYPE_PARSER(sourced( //
    construct<OpenMPCancellationPointConstruct>(
        predicated(OmpDirectiveNameParser{},
            IsDirective(toolchain::omp::Directive::OMPD_cancellation_point)) >=
        Parser<OmpDirectiveSpecification>{})))
...
TYPE_PARSER(sourced( //
    construct<OpenMPCancelConstruct>(
        predicated(OmpDirectiveNameParser{},
            IsDirective(toolchain::omp::Directive::OMPD_cancel)) >=
        Parser<OmpDirectiveSpecification>{})))

TYPE_PARSER(sourced( //
    construct<OpenMPDepobjConstruct>(
        predicated(OmpDirectiveNameParser{},
            IsDirective(toolchain::omp::Directive::OMPD_depobj)) >=
        Parser<OmpDirectiveSpecification>{})))
...
TYPE_PARSER(sourced( //
    construct<OpenMPInteropConstruct>(
        predicated(OmpDirectiveNameParser{},
            IsDirective(toolchain::omp::Directive::OMPD_interop)) >=
        Parser<OmpDirectiveSpecification>{})))
...
static OmpMapperSpecifier ConstructOmpMapperSpecifier(
  ...
  if (DerivedTypeSpec * derived{std::get_if<DerivedTypeSpec>(&typeSpec.u)}) {
    return OmpMapperSpecifier{
        std::get<Name>(derived->t).ToString() + toolchain::omp::OmpDefaultMapperName,
        std::move(typeSpec), std::move(varName)};
  }
  return OmpMapperSpecifier{std::string(toolchain::omp::OmpDefaultMapperName),
      std::move(typeSpec), std::move(varName)};
}
...
TYPE_PARSER(construct<OpenMPCriticalConstruct>(
    OmpBlockConstructParser{toolchain::omp::Directive::OMPD_critical}))
...
TYPE_PARSER( //
    MakeBlockConstruct(toolchain::omp::Directive::OMPD_masked) ||
    MakeBlockConstruct(toolchain::omp::Directive::OMPD_master) ||
    MakeBlockConstruct(toolchain::omp::Directive::OMPD_ordered) ||
    MakeBlockConstruct(toolchain::omp::Directive::OMPD_parallel_masked) ||
    MakeBlockConstruct(toolchain::omp::Directive::OMPD_parallel_master) ||
    MakeBlockConstruct(toolchain::omp::Directive::OMPD_parallel_workshare) ||
    MakeBlockConstruct(toolchain::omp::Directive::OMPD_parallel) ||
    MakeBlockConstruct(toolchain::omp::Directive::OMPD_scope) ||
    MakeBlockConstruct(toolchain::omp::Directive::OMPD_single) ||
    MakeBlockConstruct(toolchain::omp::Directive::OMPD_target_data) ||
    MakeBlockConstruct(toolchain::omp::Directive::OMPD_target_parallel) ||
    MakeBlockConstruct(toolchain::omp::Directive::OMPD_target_teams) ||
    MakeBlockConstruct(toolchain::omp::Directive::OMPD_target) ||
    MakeBlockConstruct(toolchain::omp::Directive::OMPD_task) ||
    MakeBlockConstruct(toolchain::omp::Directive::OMPD_taskgroup) ||
    MakeBlockConstruct(toolchain::omp::Directive::OMPD_teams) ||
    MakeBlockConstruct(toolchain::omp::Directive::OMPD_workshare))
#undef MakeBlockConstruct

// OMP SECTIONS Directive
TYPE_PARSER(construct<OmpSectionsDirective>(first(
    "SECTIONS" >> pure(toolchain::omp::Directive::OMPD_sections),
    "PARALLEL SECTIONS" >> pure(toolchain::omp::Directive::OMPD_parallel_sections))))
...
static constexpr auto sectionDir{
    startOmpLine >> (predicated(OmpDirectiveNameParser{},
                         IsDirective(toolchain::omp::Directive::OMPD_section)) >=
                        Parser<OmpDirectiveSpecification>{})};
