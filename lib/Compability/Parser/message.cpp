...
#include "language/Compability/Parser/char-set.h"
...
toolchain::raw_ostream &operator<<(toolchain::raw_ostream &o, const MessageFixedText &t) {
...
static toolchain::raw_ostream::Colors PrefixColor(Severity severity) {
  switch (severity) {
  case Severity::Error:
  case Severity::Todo:
    return toolchain::raw_ostream::RED;
  case Severity::Warning:
  case Severity::Portability:
    return toolchain::raw_ostream::MAGENTA;
  default:
    // TODO: Set the color.
    break;
  }
  return toolchain::raw_ostream::SAVEDCOLOR;
}
...
void Message::Emit(toolchain::raw_ostream &o, const AllCookedSources &allCooked,
    bool echoSourceLine,
...
void Messages::Emit(toolchain::raw_ostream &o, const AllCookedSources &allCooked,
