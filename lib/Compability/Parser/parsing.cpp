...
const SourceFile *Parsing::Prescan(const std::string &path, Options options) {
  ...
  std::string buf;
  toolchain::raw_string_ostream fileError{buf};
...
void Parsing::EmitPreprocessorMacros(toolchain::raw_ostream &out) const {
  preprocessor_.PrintMacros(out);
}

void Parsing::EmitPreprocessedSource(
    toolchain::raw_ostream &out, bool lineDirectives) const {
...
void Parsing::DumpCookedChars(toolchain::raw_ostream &out) const {
...
void Parsing::DumpProvenance(toolchain::raw_ostream &out) const {
  allCooked_.Dump(out);
}

void Parsing::DumpParsingLog(toolchain::raw_ostream &out) const {
  log_.Dump(out, allCooked_);
}

void Parsing::Parse(toolchain::raw_ostream &out) {
