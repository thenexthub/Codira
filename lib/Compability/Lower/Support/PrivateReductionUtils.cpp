...
static void createCleanupRegion(language::Compability::lower::AbstractConverter &converter,
  ...
  if (auto boxTy = mlir::dyn_cast_or_null<fir::BaseBoxType>(valTy)) {
    ...
    // language::Compability::lower::genDeallocateIfAllocated (not done now to avoid test
    // churn)
...
fir::ShapeShiftOp language::Compability::lower::getShapeShift(
...
static void getLengthParameters(fir::FirOpBuilder &builder, mlir::Location loc,
                                mlir::Value moldArg,
                                toolchain::SmallVectorImpl<mlir::Value> &lenParams) {
...
static bool
isDerivedTypeNeedingInitialization(const language::Compability::semantics::Symbol &sym) {
  // language::Compability::lower::hasDefaultInitialization returns false for ALLOCATABLE, so
  // re-implement here.
...
namespace {
using namespace language::Compability::lower;
...
public:
  PopulateInitAndCleanupRegionsHelper(
      ...
      DeclOperationKind kind, const language::Compability::semantics::Symbol *sym,
...
void PopulateInitAndCleanupRegionsHelper::initBoxedPrivatePointer(
  ...
  // to an toolchain struct of the right type. This returns nullptr if the types
  // aren't right.
...
void PopulateInitAndCleanupRegionsHelper::initAndCleanupBoxedArray(
  ...
  if (mlir::isa<fir::BaseBoxType>(temp.getType()))
    ...
    box = fir::EmboxOp::create(builder, loc, boxType, temp, shapeShift,
                               /*slice=*/mlir::Value{},
                               /*typeParams=*/toolchain::ArrayRef<mlir::Value>{});
...
void language::Compability::lower::populateByRefInitAndCleanupRegions(
    language::Compability::lower::AbstractConverter &converter, mlir::Location loc,
    mlir::Type argType, mlir::Value scalarInitValue, mlir::Block *initBlock,
    mlir::Value allocatedPrivVarArg, mlir::Value moldArg,
    mlir::Region &cleanupRegion, DeclOperationKind kind,
    const language::Compability::semantics::Symbol *sym, bool cannotHaveLowerBounds,
    bool isDoConcurrent) {
