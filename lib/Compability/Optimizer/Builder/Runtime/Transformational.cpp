...
#include "language/Compability/Runtime/matmul-transpose.h"
#include "language/Compability/Runtime/matmul.h"
#include "language/Compability/Runtime/transformational.h"
...
struct ForcedBesselJn_10 {
  ...
  static constexpr fir::runtime::FuncTypeBuilderFunc getTypeModel() {
    return [](mlir::MLIRContext *ctx) {
      ...
      auto boxTy =
          fir::runtime::getModel<language::Compability::runtime::Descriptor &>()(ctx);
  ...
  static constexpr fir::runtime::FuncTypeBuilderFunc getTypeModel() {
    return [](mlir::MLIRContext *ctx) {
      auto boxRefTy =
          fir::runtime::getModel<language::Compability::runtime::Descriptor &>()(ctx);
      auto boxTy =
          fir::runtime::getModel<const language::Compability::runtime::Descriptor &>()(ctx);
...
#include "language/Compability/Runtime/matmul-instances.inc"
