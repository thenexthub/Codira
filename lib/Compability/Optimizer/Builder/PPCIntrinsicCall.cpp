...
// (https://mlir.toolchain.org/getting_started/DeveloperGuide/) is used in this
// module.
//
//===----------------------------------------------------------------------===//
...
static constexpr MathOperation ppcMathOperations[] = {
    // fcfi is just another name for fcfid, there is no toolchain.ppc.fcfi.
    {"__ppc_fcfi", "toolchain.ppc.fcfid", genFuncType<Ty::Real<8>, Ty::Real<8>>,
     genLibCall},
    {"__ppc_fcfid", "toolchain.ppc.fcfid", genFuncType<Ty::Real<8>, Ty::Real<8>>,
     genLibCall},
    {"__ppc_fcfud", "toolchain.ppc.fcfud", genFuncType<Ty::Real<8>, Ty::Real<8>>,
     genLibCall},
    {"__ppc_fctid", "toolchain.ppc.fctid", genFuncType<Ty::Real<8>, Ty::Real<8>>,
     genLibCall},
    {"__ppc_fctidz", "toolchain.ppc.fctidz", genFuncType<Ty::Real<8>, Ty::Real<8>>,
     genLibCall},
    {"__ppc_fctiw", "toolchain.ppc.fctiw", genFuncType<Ty::Real<8>, Ty::Real<8>>,
     genLibCall},
    {"__ppc_fctiwz", "toolchain.ppc.fctiwz", genFuncType<Ty::Real<8>, Ty::Real<8>>,
     genLibCall},
    {"__ppc_fctudz", "toolchain.ppc.fctudz", genFuncType<Ty::Real<8>, Ty::Real<8>>,
     genLibCall},
    {"__ppc_fctuwz", "toolchain.ppc.fctuwz", genFuncType<Ty::Real<8>, Ty::Real<8>>,
     genLibCall},
    {"__ppc_fmadd", "toolchain.fma.f32",
     genFuncType<Ty::Real<4>, Ty::Real<4>, Ty::Real<4>, Ty::Real<4>>,
     genMathOp<mlir::math::FmaOp>},
    {"__ppc_fmadd", "toolchain.fma.f64",
     genFuncType<Ty::Real<8>, Ty::Real<8>, Ty::Real<8>, Ty::Real<8>>,
     genMathOp<mlir::math::FmaOp>},
    {"__ppc_fmsub", "toolchain.ppc.fmsubs",
     genFuncType<Ty::Real<4>, Ty::Real<4>, Ty::Real<4>, Ty::Real<4>>,
     genLibCall},
    {"__ppc_fmsub", "toolchain.ppc.fmsub",
     genFuncType<Ty::Real<8>, Ty::Real<8>, Ty::Real<8>, Ty::Real<8>>,
     genLibCall},
    {"__ppc_fnabs", "toolchain.ppc.fnabss", genFuncType<Ty::Real<4>, Ty::Real<4>>,
     genLibCall},
    {"__ppc_fnabs", "toolchain.ppc.fnabs", genFuncType<Ty::Real<8>, Ty::Real<8>>,
     genLibCall},
    {"__ppc_fnmadd", "toolchain.ppc.fnmadds",
     genFuncType<Ty::Real<4>, Ty::Real<4>, Ty::Real<4>, Ty::Real<4>>,
     genLibCall},
    {"__ppc_fnmadd", "toolchain.ppc.fnmadd",
     genFuncType<Ty::Real<8>, Ty::Real<8>, Ty::Real<8>, Ty::Real<8>>,
     genLibCall},
    {"__ppc_fnmsub", "toolchain.ppc.fnmsub.f32",
     genFuncType<Ty::Real<4>, Ty::Real<4>, Ty::Real<4>, Ty::Real<4>>,
     genLibCall},
    {"__ppc_fnmsub", "toolchain.ppc.fnmsub.f64",
     genFuncType<Ty::Real<8>, Ty::Real<8>, Ty::Real<8>, Ty::Real<8>>,
     genLibCall},
    {"__ppc_fre", "toolchain.ppc.fre", genFuncType<Ty::Real<8>, Ty::Real<8>>,
     genLibCall},
    {"__ppc_fres", "toolchain.ppc.fres", genFuncType<Ty::Real<4>, Ty::Real<4>>,
     genLibCall},
    {"__ppc_frsqrte", "toolchain.ppc.frsqrte", genFuncType<Ty::Real<8>, Ty::Real<8>>,
     genLibCall},
    {"__ppc_frsqrtes", "toolchain.ppc.frsqrtes",
     genFuncType<Ty::Real<4>, Ty::Real<4>>, genLibCall},
    {"__ppc_vec_cvbf16spn", "toolchain.ppc.vsx.xvcvbf16spn",
     genFuncType<Ty::UnsignedVector<1>, Ty::UnsignedVector<1>>, genLibCall},
    {"__ppc_vec_cvspbf16_", "toolchain.ppc.vsx.xvcvspbf16",
     genFuncType<Ty::UnsignedVector<1>, Ty::UnsignedVector<1>>, genLibCall},
    {"__ppc_vec_madd", "toolchain.fma.v4f32",
     genFuncType<Ty::RealVector<4>, Ty::RealVector<4>, Ty::RealVector<4>,
                 Ty::RealVector<4>>,
     genLibCall},
    {"__ppc_vec_madd", "toolchain.fma.v2f64",
     genFuncType<Ty::RealVector<8>, Ty::RealVector<8>, Ty::RealVector<8>,
                 Ty::RealVector<8>>,
     genLibCall},
    {"__ppc_vec_max", "toolchain.ppc.altivec.vmaxsb",
     genFuncType<Ty::IntegerVector<1>, Ty::IntegerVector<1>,
                 Ty::IntegerVector<1>>,
     genLibCall},
    {"__ppc_vec_max", "toolchain.ppc.altivec.vmaxsh",
     genFuncType<Ty::IntegerVector<2>, Ty::IntegerVector<2>,
                 Ty::IntegerVector<2>>,
     genLibCall},
    {"__ppc_vec_max", "toolchain.ppc.altivec.vmaxsw",
     genFuncType<Ty::IntegerVector<4>, Ty::IntegerVector<4>,
                 Ty::IntegerVector<4>>,
     genLibCall},
    {"__ppc_vec_max", "toolchain.ppc.altivec.vmaxsd",
     genFuncType<Ty::IntegerVector<8>, Ty::IntegerVector<8>,
                 Ty::IntegerVector<8>>,
     genLibCall},
    {"__ppc_vec_max", "toolchain.ppc.altivec.vmaxub",
     genFuncType<Ty::UnsignedVector<1>, Ty::UnsignedVector<1>,
                 Ty::UnsignedVector<1>>,
     genLibCall},
    {"__ppc_vec_max", "toolchain.ppc.altivec.vmaxuh",
     genFuncType<Ty::UnsignedVector<2>, Ty::UnsignedVector<2>,
                 Ty::UnsignedVector<2>>,
     genLibCall},
    {"__ppc_vec_max", "toolchain.ppc.altivec.vmaxuw",
     genFuncType<Ty::UnsignedVector<4>, Ty::UnsignedVector<4>,
                 Ty::UnsignedVector<4>>,
     genLibCall},
    {"__ppc_vec_max", "toolchain.ppc.altivec.vmaxud",
     genFuncType<Ty::UnsignedVector<8>, Ty::UnsignedVector<8>,
                 Ty::UnsignedVector<8>>,
     genLibCall},
    {"__ppc_vec_max", "toolchain.ppc.vsx.xvmaxsp",
     genFuncType<Ty::RealVector<4>, Ty::RealVector<4>, Ty::RealVector<4>>,
     genLibCall},
    {"__ppc_vec_max", "toolchain.ppc.vsx.xvmaxdp",
     genFuncType<Ty::RealVector<8>, Ty::RealVector<8>, Ty::RealVector<8>>,
     genLibCall},
    {"__ppc_vec_min", "toolchain.ppc.altivec.vminsb",
     genFuncType<Ty::IntegerVector<1>, Ty::IntegerVector<1>,
                 Ty::IntegerVector<1>>,
     genLibCall},
    {"__ppc_vec_min", "toolchain.ppc.altivec.vminsh",
     genFuncType<Ty::IntegerVector<2>, Ty::IntegerVector<2>,
                 Ty::IntegerVector<2>>,
     genLibCall},
    {"__ppc_vec_min", "toolchain.ppc.altivec.vminsw",
     genFuncType<Ty::IntegerVector<4>, Ty::IntegerVector<4>,
                 Ty::IntegerVector<4>>,
     genLibCall},
    {"__ppc_vec_min", "toolchain.ppc.altivec.vminsd",
     genFuncType<Ty::IntegerVector<8>, Ty::IntegerVector<8>,
                 Ty::IntegerVector<8>>,
     genLibCall},
    {"__ppc_vec_min", "toolchain.ppc.altivec.vminub",
     genFuncType<Ty::UnsignedVector<1>, Ty::UnsignedVector<1>,
                 Ty::UnsignedVector<1>>,
     genLibCall},
    {"__ppc_vec_min", "toolchain.ppc.altivec.vminuh",
     genFuncType<Ty::UnsignedVector<2>, Ty::UnsignedVector<2>,
                 Ty::UnsignedVector<2>>,
     genLibCall},
    {"__ppc_vec_min", "toolchain.ppc.altivec.vminuw",
     genFuncType<Ty::UnsignedVector<4>, Ty::UnsignedVector<4>,
                 Ty::UnsignedVector<4>>,
     genLibCall},
    {"__ppc_vec_min", "toolchain.ppc.altivec.vminud",
     genFuncType<Ty::UnsignedVector<8>, Ty::UnsignedVector<8>,
                 Ty::UnsignedVector<8>>,
     genLibCall},
    {"__ppc_vec_min", "toolchain.ppc.vsx.xvminsp",
     genFuncType<Ty::RealVector<4>, Ty::RealVector<4>, Ty::RealVector<4>>,
     genLibCall},
    {"__ppc_vec_min", "toolchain.ppc.vsx.xvmindp",
     genFuncType<Ty::RealVector<8>, Ty::RealVector<8>, Ty::RealVector<8>>,
     genLibCall},
    {"__ppc_vec_nmsub", "toolchain.ppc.fnmsub.v4f32",
     genFuncType<Ty::RealVector<4>, Ty::RealVector<4>, Ty::RealVector<4>,
                 Ty::RealVector<4>>,
     genLibCall},
    {"__ppc_vec_nmsub", "toolchain.ppc.fnmsub.v2f64",
     genFuncType<Ty::RealVector<8>, Ty::RealVector<8>, Ty::RealVector<8>,
                 Ty::RealVector<8>>,
     genLibCall},
};
...
const IntrinsicHandler *findPPCIntrinsicHandler(toolchain::StringRef name) {
  auto compare = [](const IntrinsicHandler &ppcHandler, toolchain::StringRef name) {
    return name.compare(ppcHandler.name) > 0;
  };
  auto result = toolchain::lower_bound(ppcHandlers, name, compare);
...
// MTFSF, MTFSFI
template <bool isImm>
void PPCIntrinsicLibrary::genMtfsf(toolchain::ArrayRef<fir::ExtendedValue> args) {
  assert(args.size() == 2);
  ...
  if (isImm) {
    ...
    funcOp = builder.createFunction(loc, "toolchain.ppc.mtfsfi", libFuncType);
  } else {
    libFuncType = genFuncType<Ty::Void, Ty::Integer<4>, Ty::Real<8>>(
        builder.getContext(), builder);
    funcOp = builder.createFunction(loc, "toolchain.ppc.mtfsf", libFuncType);
  }
...
PPCIntrinsicLibrary::genVecAbs(mlir::Type resultType,
  ...
  toolchain_unreachable("unknown vector type");
}
...
PPCIntrinsicLibrary::genVecAnyCompare(mlir::Type resultType,
  ...
  toolchain::SmallVector<mlir::Value> cmpArgs;
  ...
  if (auto elementTy = mlir::dyn_cast<mlir::IntegerType>(vTypeInfo.eleTy)) {
    std::pair<toolchain::StringRef, mlir::FunctionType> bi;
...
static std::pair<toolchain::StringRef, mlir::FunctionType>
getVecCmpFuncTypeAndName(VecTypeInfo &vTypeInfo, VecOp vop,
  ...
  static std::map<std::pair<Cmp, int>,
      ...
      rGBI{{std::make_pair(Cmp::geOrLe, 32),
            std::make_pair("toolchain.ppc.vsx.xvcmpgesp",
                           genFuncType<Ty::UnsignedVector<4>, Ty::RealVector<4>,
                                       Ty::RealVector<4>>(context, builder))},
           {std::make_pair(Cmp::geOrLe, 64),
            std::make_pair("toolchain.ppc.vsx.xvcmpgedp",
                           genFuncType<Ty::UnsignedVector<8>, Ty::RealVector<8>,
                                       Ty::RealVector<8>>(context, builder))},
           {std::make_pair(Cmp::gtOrLt, 32),
            std::make_pair("toolchain.ppc.vsx.xvcmpgtsp",
                           genFuncType<Ty::UnsignedVector<4>, Ty::RealVector<4>,
                                       Ty::RealVector<4>>(context, builder))},
           {std::make_pair(Cmp::gtOrLt, 64),
            std::make_pair("toolchain.ppc.vsx.xvcmpgtdp",
                           genFuncType<Ty::UnsignedVector<8>, Ty::RealVector<8>,
                                       Ty::RealVector<8>>(context, builder))}};

  const auto width{vTypeInfo.eleTy.getIntOrFloatBitWidth()};
  std::pair<toolchain::StringRef, mlir::FunctionType> specFunc;
  if (auto elementTy = mlir::dyn_cast<mlir::IntegerType>(vTypeInfo.eleTy))
    specFunc =
...
PPCIntrinsicLibrary::genVecCmp(mlir::Type resultType,
  ...
  std::pair<toolchain::StringRef, mlir::FunctionType> funcTyNam{
  ...
  if (auto eTy = mlir::dyn_cast<mlir::IntegerType>(vecTyInfo.eleTy)) {
    ...
    default:
      toolchain_unreachable("Invalid vector operation for generator");
    }
    ...
    toolchain_unreachable("invalid vector type");
...
static inline mlir::Value swapVectorWordPairs(fir::FirOpBuilder &builder,
  ...
  toolchain::SmallVector<int64_t, 16> mask{4,  5,  6,  7,  0, 1, 2,  3,
...
PPCIntrinsicLibrary::genVecConvert(mlir::Type resultType,
  ...
  case VecOp::Ctf: {
    ...
    if (width == 32) {
      auto ftype{(isUnsigned)
                     ...
                     : genFuncType<Ty::RealVector<4>, Ty::IntegerVector<4>,
                                   Ty::Integer<4>>(context, builder)};
      const toolchain::StringRef fname{(isUnsigned) ? "toolchain.ppc.altivec.vcfux"
                                               : "toolchain.ppc.altivec.vcfsx"};
      ...
      // vec_vtf(arg1, arg2) = fmul(1.0 / (1 << arg2), toolchain.sitofp(arg1))
      ...
      toolchain::SmallVector<double> vals{f, f};
    ...
    toolchain_unreachable("invalid element integer kind");
  }
  case VecOp::Convert: {
    assert(args.size() == 2);
  ...
  case VecOp::Cvf: {
    ...
    if (vecTyInfo.isFloat32()) {
      ...
      const toolchain::StringRef fname{"toolchain.ppc.vsx.xvcvspdp"};
      auto ftype{
      ...
      const toolchain::StringRef fname{"toolchain.ppc.vsx.xvcvdpsp"};
      auto ftype{
...
PPCIntrinsicLibrary::genVecMerge(mlir::Type resultType,
  ...
  auto argBases{getBasesForArgs(args)};
  auto vecTyInfo{getVecTypeFromFir(argBases[0])};
  toolchain::SmallVector<int64_t, 16> mMask; // native vector element order mask
  toolchain::SmallVector<int64_t, 16> rMask; // non-native vector element order mask
  ...
  case VecOp::Mergeh: {
    ...
    case 16:
      ...
      break;
    default:
      toolchain_unreachable("unexpected vector length");
    }
    break;
  }
  case VecOp::Mergel: {
  ...
  toolchain::SmallVector<int64_t, 16> &mergeMask =
...
static mlir::Value reverseVectorElements(fir::FirOpBuilder &builder,
  ...
  assert(len > 0);
  toolchain::SmallVector<int64_t, 16> mask;
...
PPCIntrinsicLibrary::genVecLdCallGrp(mlir::Type resultType,
  ...
  // toolchain.ppc.altivec.lvx* returns <4xi32>
  // Others, like "toolchain.ppc.altivec.lvebx" too if arg2 is not of Integer type
  ...
  // Add the %val of arg0 to %addr of arg1
  auto addr{addOffsetToAddress(builder, loc, arg1, arg0)};
  toolchain::SmallVector<mlir::Value, 4> parsedArgs{addr};

  mlir::Type intrinResTy{nullptr};
  toolchain::StringRef fname{};
  switch (vop) {
  case VecOp::Ld:
    fname = "toolchain.ppc.altivec.lvx";
    intrinResTy = mVecI32Ty;
    break;
  case VecOp::Lde:
    switch (vecResTyInfo.eleTy.getIntOrFloatBitWidth()) {
    case 8:
      fname = "toolchain.ppc.altivec.lvebx";
      intrinResTy = mlirTy;
      break;
    case 16:
      fname = "toolchain.ppc.altivec.lvehx";
      intrinResTy = mlirTy;
      break;
    case 32:
      fname = "toolchain.ppc.altivec.lvewx";
      ...
      break;
    default:
      toolchain_unreachable("invalid vector for vec_lde");
    }
    break;
  case VecOp::Ldl:
    fname = "toolchain.ppc.altivec.lvxl";
    intrinResTy = mVecI32Ty;
    break;
  case VecOp::Lxvp:
    fname = "toolchain.ppc.vsx.lxvp";
    intrinResTy = fir::VectorType::get(256, mlir::IntegerType::get(context, 1));
    break;
  case VecOp::Xld2: {
    fname = isBEVecElemOrderOnLE() ? "toolchain.ppc.vsx.lxvd2x.be"
                                   : "toolchain.ppc.vsx.lxvd2x";
    // toolchain.ppc.altivec.lxvd2x* returns <2 x double>
    intrinResTy = mlir::VectorType::get(2, mlir::Float64Type::get(context));
  } break;
  case VecOp::Xlw4:
    fname = isBEVecElemOrderOnLE() ? "toolchain.ppc.vsx.lxvw4x.be"
                                   : "toolchain.ppc.vsx.lxvw4x";
    // toolchain.ppc.altivec.lxvw4x* returns <4xi32>
    intrinResTy = mVecI32Ty;
    break;
  default:
    toolchain_unreachable("invalid vector operation for generator");
...
PPCIntrinsicLibrary::genVecLvsGrp(mlir::Type resultType,
  ...
  switch (vop) {
  case VecOp::Lvsl:
    fname = "toolchain.ppc.altivec.lvsl";
    break;
  case VecOp::Lvsr:
    fname = "toolchain.ppc.altivec.lvsr";
    break;
  default:
    toolchain_unreachable("invalid vector operation for generator");
  }
...
PPCIntrinsicLibrary::genVecNmaddMsub(mlir::Type resultType,
  ...
  static std::map<int, std::pair<toolchain::StringRef, mlir::FunctionType>> fmaMap{
      {32,
       std::make_pair(
           "toolchain.fma.v4f32",
           genFuncType<Ty::RealVector<4>, Ty::RealVector<4>, Ty::RealVector<4>>(
...
PPCIntrinsicLibrary::genVecPerm(mlir::Type resultType,
  ...
  case VecOp::Perm: {
    ...
    auto funcOp{builder.createFunction(
        loc, "toolchain.ppc.altivec.vperm",
        genFuncType<Ty::IntegerVector<4>, Ty::IntegerVector<4>,
                    Ty::IntegerVector<4>, Ty::IntegerVector<1>>(context,
                                                                builder))};

    toolchain::SmallVector<mlir::Value> newArgs;
    if (isNativeVecElemOrderOnLE()) {
    ...
    if (res.getType() != argTypes[0]) {
      // fir.call toolchain.ppc.altivec.vperm returns !fir.vector<i4:32>
  ...
  case VecOp::Permi: {
    ...
    toolchain::SmallVector<int64_t, 2> nMask; // native vector element order mask
    toolchain::SmallVector<int64_t, 2> rMask; // non-native vector element order mask
    enum { V1 = 0, V2 = 2 };
    switch (constInt) {
    case 0:
      nMask = {V1 + 0, V2 + 0};
    ...
    case 3:
      ...
      break;
    default:
      toolchain_unreachable("unexpected arg3 value for vec_permi");
    }

    toolchain::SmallVector<int64_t, 2> mask =
...
PPCIntrinsicLibrary::genVecSel(mlir::Type resultType,
  ...
  assert(args.size() == 3);
  auto argBases{getBasesForArgs(args)};
  toolchain::SmallVector<VecTypeInfo, 4> vecTyInfos;
...
PPCIntrinsicLibrary::genVecShift(mlir::Type resultType,
  ...
  toolchain::SmallVector<VecTypeInfo, 2> vecTyInfoArgs;
  ...
  toolchain::SmallVector<mlir::Type, 2> mlirTyArgs;
  ...
  toolchain::SmallVector<mlir::Value, 2> mlirVecArgs;
  ...
  if (vop == VecOp::Sl || vop == VecOp::Sr) {
    ...
    toolchain::StringRef funcName;
    switch (vop) {
    case VecOp::Srl:
      funcName = "toolchain.ppc.altivec.vsr";
      break;
    case VecOp::Sro:
      funcName = "toolchain.ppc.altivec.vsro";
      break;
    case VecOp::Sll:
      funcName = "toolchain.ppc.altivec.vsl";
      break;
    case VecOp::Slo:
      funcName = "toolchain.ppc.altivec.vslo";
      break;
    default:
      toolchain_unreachable("unknown vector shift operation");
    }
...
const char *getMmaIrIntrName(MMAOp mmaOp) {
  ...
  case MMAOp::AssembleAcc:
    return "toolchain.ppc.mma.assemble.acc";
  case MMAOp::AssemblePair:
    return "toolchain.ppc.vsx.assemble.pair";
  case MMAOp::DisassembleAcc:
    return "toolchain.ppc.mma.disassemble.acc";
  case MMAOp::DisassemblePair:
    return "toolchain.ppc.vsx.disassemble.pair";
  case MMAOp::Xxmfacc:
    return "toolchain.ppc.mma.xxmfacc";
  case MMAOp::Xxmtacc:
    return "toolchain.ppc.mma.xxmtacc";
  case MMAOp::Xxsetaccz:
    return "toolchain.ppc.mma.xxsetaccz";
  case MMAOp::Pmxvbf16ger2:
    return "toolchain.ppc.mma.pmxvbf16ger2";
  case MMAOp::Pmxvbf16ger2nn:
    return "toolchain.ppc.mma.pmxvbf16ger2nn";
  case MMAOp::Pmxvbf16ger2np:
    return "toolchain.ppc.mma.pmxvbf16ger2np";
  case MMAOp::Pmxvbf16ger2pn:
    return "toolchain.ppc.mma.pmxvbf16ger2pn";
  case MMAOp::Pmxvbf16ger2pp:
    return "toolchain.ppc.mma.pmxvbf16ger2pp";
  case MMAOp::Pmxvf16ger2:
    return "toolchain.ppc.mma.pmxvf16ger2";
  case MMAOp::Pmxvf16ger2nn:
    return "toolchain.ppc.mma.pmxvf16ger2nn";
  case MMAOp::Pmxvf16ger2np:
    return "toolchain.ppc.mma.pmxvf16ger2np";
  case MMAOp::Pmxvf16ger2pn:
    return "toolchain.ppc.mma.pmxvf16ger2pn";
  case MMAOp::Pmxvf16ger2pp:
    return "toolchain.ppc.mma.pmxvf16ger2pp";
  case MMAOp::Pmxvf32ger:
    return "toolchain.ppc.mma.pmxvf32ger";
  case MMAOp::Pmxvf32gernn:
    return "toolchain.ppc.mma.pmxvf32gernn";
  case MMAOp::Pmxvf32gernp:
    return "toolchain.ppc.mma.pmxvf32gernp";
  case MMAOp::Pmxvf32gerpn:
    return "toolchain.ppc.mma.pmxvf32gerpn";
  case MMAOp::Pmxvf32gerpp:
    return "toolchain.ppc.mma.pmxvf32gerpp";
  case MMAOp::Pmxvf64ger:
    return "toolchain.ppc.mma.pmxvf64ger";
  case MMAOp::Pmxvf64gernn:
    return "toolchain.ppc.mma.pmxvf64gernn";
  case MMAOp::Pmxvf64gernp:
    return "toolchain.ppc.mma.pmxvf64gernp";
  case MMAOp::Pmxvf64gerpn:
    return "toolchain.ppc.mma.pmxvf64gerpn";
  case MMAOp::Pmxvf64gerpp:
    return "toolchain.ppc.mma.pmxvf64gerpp";
  case MMAOp::Pmxvi16ger2:
    return "toolchain.ppc.mma.pmxvi16ger2";
  case MMAOp::Pmxvi16ger2pp:
    return "toolchain.ppc.mma.pmxvi16ger2pp";
  case MMAOp::Pmxvi16ger2s:
    return "toolchain.ppc.mma.pmxvi16ger2s";
  case MMAOp::Pmxvi16ger2spp:
    return "toolchain.ppc.mma.pmxvi16ger2spp";
  case MMAOp::Pmxvi4ger8:
    return "toolchain.ppc.mma.pmxvi4ger8";
  case MMAOp::Pmxvi4ger8pp:
    return "toolchain.ppc.mma.pmxvi4ger8pp";
  case MMAOp::Pmxvi8ger4:
    return "toolchain.ppc.mma.pmxvi8ger4";
  case MMAOp::Pmxvi8ger4pp:
    return "toolchain.ppc.mma.pmxvi8ger4pp";
  case MMAOp::Pmxvi8ger4spp:
    return "toolchain.ppc.mma.pmxvi8ger4spp";
  case MMAOp::Xvbf16ger2:
    return "toolchain.ppc.mma.xvbf16ger2";
  case MMAOp::Xvbf16ger2nn:
    return "toolchain.ppc.mma.xvbf16ger2nn";
  case MMAOp::Xvbf16ger2np:
    return "toolchain.ppc.mma.xvbf16ger2np";
  case MMAOp::Xvbf16ger2pn:
    return "toolchain.ppc.mma.xvbf16ger2pn";
  case MMAOp::Xvbf16ger2pp:
    return "toolchain.ppc.mma.xvbf16ger2pp";
  case MMAOp::Xvf16ger2:
    return "toolchain.ppc.mma.xvf16ger2";
  case MMAOp::Xvf16ger2nn:
    return "toolchain.ppc.mma.xvf16ger2nn";
  case MMAOp::Xvf16ger2np:
    return "toolchain.ppc.mma.xvf16ger2np";
  case MMAOp::Xvf16ger2pn:
    return "toolchain.ppc.mma.xvf16ger2pn";
  case MMAOp::Xvf16ger2pp:
    return "toolchain.ppc.mma.xvf16ger2pp";
  case MMAOp::Xvf32ger:
    return "toolchain.ppc.mma.xvf32ger";
  case MMAOp::Xvf32gernn:
    return "toolchain.ppc.mma.xvf32gernn";
  case MMAOp::Xvf32gernp:
    return "toolchain.ppc.mma.xvf32gernp";
  case MMAOp::Xvf32gerpn:
    return "toolchain.ppc.mma.xvf32gerpn";
  case MMAOp::Xvf32gerpp:
    return "toolchain.ppc.mma.xvf32gerpp";
  case MMAOp::Xvf64ger:
    return "toolchain.ppc.mma.xvf64ger";
  case MMAOp::Xvf64gernn:
    return "toolchain.ppc.mma.xvf64gernn";
  case MMAOp::Xvf64gernp:
    return "toolchain.ppc.mma.xvf64gernp";
  case MMAOp::Xvf64gerpn:
    return "toolchain.ppc.mma.xvf64gerpn";
  case MMAOp::Xvf64gerpp:
    return "toolchain.ppc.mma.xvf64gerpp";
  case MMAOp::Xvi16ger2:
    return "toolchain.ppc.mma.xvi16ger2";
  case MMAOp::Xvi16ger2pp:
    return "toolchain.ppc.mma.xvi16ger2pp";
  case MMAOp::Xvi16ger2s:
    return "toolchain.ppc.mma.xvi16ger2s";
  case MMAOp::Xvi16ger2spp:
    return "toolchain.ppc.mma.xvi16ger2spp";
  case MMAOp::Xvi4ger8:
    return "toolchain.ppc.mma.xvi4ger8";
  case MMAOp::Xvi4ger8pp:
    return "toolchain.ppc.mma.xvi4ger8pp";
  case MMAOp::Xvi8ger4:
    return "toolchain.ppc.mma.xvi8ger4";
  case MMAOp::Xvi8ger4pp:
    return "toolchain.ppc.mma.xvi8ger4pp";
  case MMAOp::Xvi8ger4spp:
    return "toolchain.ppc.mma.xvi8ger4spp";
  }
  toolchain_unreachable("getMmaIrIntrName");
}
...
mlir::FunctionType getMmaIrFuncType(mlir::MLIRContext *context, MMAOp mmaOp) {
  ...
  toolchain_unreachable("getMmaIrFuncType");
}

template <MMAOp IntrId, MMAHandlerOp HandlerOp>
void PPCIntrinsicLibrary::genMmaIntr(toolchain::ArrayRef<fir::ExtendedValue> args) {
  auto context{builder.getContext()};
  ...
  toolchain::SmallVector<mlir::Value> intrArgs;
  ...
  for (size_t i = argStart, j = 0; i != e; i += argStep, ++j) {
    ...
    if (vType != targetType) {
      if (mlir::isa<mlir::VectorType>(targetType)) {
        ...
        toolchain_unreachable("Unsupported type conversion for argument to PowerPC "
                         "MMA intrinsic");
      }
    } else {
...
// VEC_ST, VEC_STE
template <VecOp vop>
void PPCIntrinsicLibrary::genVecStore(toolchain::ArrayRef<fir::ExtendedValue> args) {
  assert(args.size() == 3);
  ...
  case VecOp::St:
    ...
    fname = "toolchain.ppc.altivec.stvx";
    break;
  case VecOp::Ste: {
  ...
  toolchain::SmallVector<mlir::Value, 4> biArgs;
