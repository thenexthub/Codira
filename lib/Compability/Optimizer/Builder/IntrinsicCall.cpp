...
#include "language/Compability/Optimizer/Builder/PPCIntrinsicCall.h"
...
#include "language/Compability/Optimizer/Builder/Runtime/Intrinsics.h"
...
#include "language/Compability/Optimizer/Builder/Runtime/Reduction.h"
#include "language/Compability/Optimizer/Builder/Runtime/Stop.h"
#include "language/Compability/Optimizer/Builder/Runtime/Transformational.h"
...
static bool isStaticallyAbsent(toolchain::ArrayRef<fir::ExtendedValue> args,
                               size_t argIndex) {
  return args.size() <= argIndex || isStaticallyAbsent(args[argIndex]);
}
static bool isStaticallyAbsent(toolchain::ArrayRef<mlir::Value> args,
                               size_t argIndex) {
...
static constexpr IntrinsicHandler handlers[]{
    ...
    {"is_contiguous",
     ...
     {{{"array", asBox}}},
     /*isElemental=*/false},
    {"is_iostat_end", &I::genIsIostatValue<language::Compability::runtime::io::IostatEnd>},
    {"is_iostat_eor", &I::genIsIostatValue<language::Compability::runtime::io::IostatEor>},
    {"ishft", &I::genIshft},
    {"ishftc", &I::genIshftc},
...
static const IntrinsicHandler *findIntrinsicHandler(toolchain::StringRef name) {
  auto compare = [](const IntrinsicHandler &handler, toolchain::StringRef name) {
    return name.compare(handler.name) > 0;
  };
  auto result = toolchain::lower_bound(handlers, name, compare);
...
static toolchain::cl::opt<bool> outlineAllIntrinsics(
    "outline-intrinsics",
    toolchain::cl::desc(
...
toolchain::cl::opt<MathRuntimeVersion> mathRuntimeVersion(
    "math-runtime", toolchain::cl::desc("Select math operations' runtime behavior:"),
    toolchain::cl::values(
    ...
    toolchain::cl::init(fastVersion));

static toolchain::cl::opt<bool>
    forceMlirComplex("force-mlir-complex",
                     toolchain::cl::desc("Force using MLIR complex operations "
...
prettyPrintIntrinsicName(fir::FirOpBuilder &builder, mlir::Location loc,
                         toolchain::StringRef prefix, toolchain::StringRef name,
                         toolchain::StringRef suffix, mlir::FunctionType funcType) {
  std::string output = prefix.str();
  toolchain::raw_string_ostream sstream(output);
  if (name == "pow") {
...
mlir::Value genLibCall(fir::FirOpBuilder &builder, mlir::Location loc,
                       ...
                       mlir::FunctionType libFuncType,
                       toolchain::ArrayRef<mlir::Value> args) {
  toolchain::StringRef libFuncName = mathOp.runtimeFunc;
  ...
  LLVM_DEBUG(toolchain::dbgs() << "Generating '" << libFuncName
                          << "' call with type ";
             libFuncType.dump(); toolchain::dbgs() << "\n");
  ...
  if (!funcOp) {
    ...
    LLVM_DEBUG(libCall.dump(); toolchain::dbgs() << "\n");
  ...
  if (soughtFuncType == libFuncType) {
    ...
    LLVM_DEBUG(mlir::emitWarning(
        loc, toolchain::Twine("function signature mismatch for '") +
                 toolchain::Twine(libFuncName) +
                 toolchain::Twine("' may lead to undefined behavior.")));
    ...
    toolchain::SmallVector<mlir::Value, 3> operands{funcPointer};
...
mlir::Value genLibSplitComplexArgsCall(fir::FirOpBuilder &builder,
  ...
  toolchain::SmallVector<mlir::Value, 4> splitArgs;
...
mlir::Value genMathOp(fir::FirOpBuilder &builder, mlir::Location loc,
  ...
  //           topic at discourse.toolchain.org).
  ...
  //           modes.
  mlir::Value result;
  toolchain::StringRef mathLibFuncName = mathOp.runtimeFunc;
  if (mathRuntimeVersion == preciseVersion &&
    ...
    LLVM_DEBUG(toolchain::dbgs() << "Generating '" << mathLibFuncName
                            << "' operation with type ";
               mathLibFuncType.dump(); toolchain::dbgs() << "\n");
    result = T::create(builder, loc, args);
  }
  LLVM_DEBUG(result.dump(); toolchain::dbgs() << "\n");
  return result;
}
...
static constexpr MathOperation mathOperations[] = {
    ...
    {"abs", "fabs", genFuncType<Ty::Real<8>, Ty::Real<8>>,
     genMathOp<mlir::math::AbsFOp>},
    {"abs", "toolchain.fabs.f128", genFuncType<Ty::Real<16>, Ty::Real<16>>,
     genMathOp<mlir::math::AbsFOp>},
    ...
    {"acosh", RTNAME_STRING(CAcoshF128), FuncTypeComplex16Complex16,
     genLibF128Call},
    // toolchain.trunc behaves the same way as libm's trunc.
    {"aint", "toolchain.trunc.f32", genFuncType<Ty::Real<4>, Ty::Real<4>>,
     genLibCall},
    {"aint", "toolchain.trunc.f64", genFuncType<Ty::Real<8>, Ty::Real<8>>,
     genLibCall},
    {"aint", "toolchain.trunc.f80", genFuncType<Ty::Real<10>, Ty::Real<10>>,
     genLibCall},
    {"aint", RTNAME_STRING(TruncF128), FuncTypeReal16Real16, genLibF128Call},
    // toolchain.round behaves the same way as libm's round.
    {"anint", "toolchain.round.f32", genFuncType<Ty::Real<4>, Ty::Real<4>>,
     genMathOp<mlir::LLVM::RoundOp>},
    {"anint", "toolchain.round.f64", genFuncType<Ty::Real<8>, Ty::Real<8>>,
     genMathOp<mlir::LLVM::RoundOp>},
    {"anint", "toolchain.round.f80", genFuncType<Ty::Real<10>, Ty::Real<10>>,
     genMathOp<mlir::LLVM::RoundOp>},
    ...
    {"log_gamma", RTNAME_STRING(LgammaF128), FuncTypeReal16Real16,
     genLibF128Call},
    {"nearbyint", "toolchain.nearbyint.f32", genFuncType<Ty::Real<4>, Ty::Real<4>>,
     genLibCall},
    {"nearbyint", "toolchain.nearbyint.f64", genFuncType<Ty::Real<8>, Ty::Real<8>>,
     genLibCall},
    {"nearbyint", "toolchain.nearbyint.f80", genFuncType<Ty::Real<10>, Ty::Real<10>>,
     genLibCall},
    {"nearbyint", RTNAME_STRING(NearbyintF128), FuncTypeReal16Real16,
     genLibF128Call},
    // toolchain.lround behaves the same way as libm's lround.
    {"nint", "toolchain.lround.i64.f64", genFuncType<Ty::Integer<8>, Ty::Real<8>>,
     genLibCall},
    {"nint", "toolchain.lround.i64.f32", genFuncType<Ty::Integer<8>, Ty::Real<4>>,
     genLibCall},
    {"nint", RTNAME_STRING(LlroundF128), FuncTypeInteger8Real16,
     genLibF128Call},
    {"nint", "toolchain.lround.i32.f64", genFuncType<Ty::Integer<4>, Ty::Real<8>>,
     genLibCall},
    {"nint", "toolchain.lround.i32.f32", genFuncType<Ty::Integer<4>, Ty::Real<4>>,
     genLibCall},
...
using RtMap = language::Compability::common::StaticMultimapView<MathOperation>;
...
static void checkPrecisionLoss(toolchain::StringRef name,
                               mlir::FunctionType funcType,
...
static mlir::FunctionType getFunctionType(std::optional<mlir::Type> resultType,
                                          toolchain::ArrayRef<mlir::Value> arguments,
...
static bool isIntrinsicModuleProcedure(toolchain::StringRef name) {
  return name.starts_with("c_") || name.starts_with("compiler_") ||
         name.starts_with("ieee_") || name.starts_with("__ppc_");
}

static bool isCoarrayIntrinsic(toolchain::StringRef name) {
...
toolchain::StringRef genericName(toolchain::StringRef specificName) {
  const std::string builtin = "__builtin_";
  toolchain::StringRef name = specificName.starts_with(builtin)
...
lookupRuntimeGenerator(toolchain::StringRef name, bool isPPCTarget) {
...
lookupIntrinsicHandler(fir::FirOpBuilder &builder,
                       toolchain::StringRef intrinsicName,
                       std::optional<mlir::Type> resultType) {
  toolchain::StringRef name = genericName(intrinsicName);
...
void crashOnMissingIntrinsic(mlir::Location loc,
  ...
  toolchain::StringRef name = genericName(intrinsicName);
  if (isIntrinsicModuleProcedure(name))
    TODO(loc, "intrinsic module procedure: " + toolchain::Twine(name));
  else if (isCoarrayIntrinsic(name))
    TODO(loc, "coarray: intrinsic " + toolchain::Twine(name));
  else
    TODO(loc, "intrinsic: " + toolchain::Twine(name.upper()));
}

template <typename GeneratorType>
fir::ExtendedValue IntrinsicLibrary::genElementalCall(
    GeneratorType generator, toolchain::StringRef name, mlir::Type resultType,
    toolchain::ArrayRef<fir::ExtendedValue> args, bool outline) {
  toolchain::SmallVector<mlir::Value> scalarArgs;
...
IntrinsicLibrary::genElementalCall<IntrinsicLibrary::ExtendedGenerator>(
    ExtendedGenerator generator, toolchain::StringRef name, mlir::Type resultType,
    toolchain::ArrayRef<fir::ExtendedValue> args, bool outline) {
  for (const fir::ExtendedValue &arg : args) {
...
IntrinsicLibrary::genElementalCall<IntrinsicLibrary::SubroutineGenerator>(
    SubroutineGenerator generator, toolchain::StringRef name, mlir::Type resultType,
    toolchain::ArrayRef<fir::ExtendedValue> args, bool outline) {
  for (const fir::ExtendedValue &arg : args)
    if (!arg.getUnboxed() && !arg.getCharBox())
      // fir::emitFatalError(loc, "nonscalar intrinsic argument");
...
IntrinsicLibrary::genElementalCall<IntrinsicLibrary::DualGenerator>(
    DualGenerator generator, toolchain::StringRef name, mlir::Type resultType,
    toolchain::ArrayRef<fir::ExtendedValue> args, bool outline) {
...
static std::pair<fir::ExtendedValue, bool> genIntrinsicCallHelper(
    ...
    toolchain::ArrayRef<fir::ExtendedValue> args, IntrinsicLibrary &lib) {
...
static std::pair<fir::ExtendedValue, bool> genIntrinsicCallHelper(
  ...
  toolchain::StringRef name = range.first->key;
  // FIXME: using toValue to get the type won't work with array arguments.
  toolchain::SmallVector<mlir::Value> mlirArgs;
...
std::pair<fir::ExtendedValue, bool>
IntrinsicLibrary::genIntrinsicCall(toolchain::StringRef specificName,
                                   std::optional<mlir::Type> resultType,
                                   toolchain::ArrayRef<fir::ExtendedValue> args) {
...
IntrinsicLibrary::invokeGenerator(ExtendedGenerator generator,
                                  mlir::Type resultType,
                                  toolchain::ArrayRef<mlir::Value> args) {
  toolchain::SmallVector<fir::ExtendedValue> extendedArgs;
...
static std::string typeToString(mlir::Type t) {
  ...
  toolchain_unreachable("no mangling for type");
}
...
static std::string mangleIntrinsicProcedure(toolchain::StringRef intrinsic,
  ...
  if (funTy.getNumResults() == 1)
    ...
    toolchain_unreachable("more than one result value for function");
...
mlir::func::FuncOp IntrinsicLibrary::getWrapper(GeneratorType generator,
  ...
  if (!function) {
    ...
    toolchain::SmallVector<mlir::Value> localArguments;
...
bool static hasAbsentOptional(toolchain::ArrayRef<mlir::Value> args) {
  for (const mlir::Value &arg : args)
    if (!arg)
      return true;
  return false;
}
bool static hasAbsentOptional(toolchain::ArrayRef<fir::ExtendedValue> args) {
  for (const fir::ExtendedValue &arg : args)
    if (!fir::getBase(arg))
      return true;
  return false;
...
IntrinsicLibrary::outlineInWrapper(GeneratorType generator,
                                   toolchain::StringRef name, mlir::Type resultType,
                                   toolchain::ArrayRef<mlir::Value> args) {
  if (hasAbsentOptional(args)) {
    ...
    TODO(loc, "cannot outline call to intrinsic " + toolchain::Twine(name) +
                  " with absent optional argument");
  }

  mlir::FunctionType funcType = getFunctionType(resultType, args, builder);
  std::string funcName{name};
  toolchain::raw_string_ostream nameOS{funcName};
...
fir::ExtendedValue IntrinsicLibrary::outlineInExtendedWrapper(
    GeneratorType generator, toolchain::StringRef name,
    std::optional<mlir::Type> resultType,
    toolchain::ArrayRef<fir::ExtendedValue> args) {
  if (hasAbsentOptional(args))
    TODO(loc, "cannot outline call to intrinsic " + toolchain::Twine(name) +
...
static IntrinsicLibrary::RuntimeCallGenerator getRuntimeCallGeneratorHelper(
  ...
  if (!mathOp) {
    ...
    toolchain::raw_string_ostream sstream(nameAndType);
  ...
  return [actualFuncType, mathOp,
          soughtFuncType](fir::FirOpBuilder &builder, mlir::Location loc,
                          toolchain::ArrayRef<mlir::Value> args) {
    toolchain::SmallVector<mlir::Value> convertedArguments;
    for (auto [fst, snd] : toolchain::zip(actualFuncType.getInputs(), args))
...
IntrinsicLibrary::getRuntimeCallGenerator(toolchain::StringRef name,
                                          mlir::FunctionType soughtFuncType) {
  bool isPPCTarget = fir::getTargetTriple(builder.getModule()).isPPC();
...
mlir::SymbolRefAttr IntrinsicLibrary::getUnrestrictedIntrinsicSymbolRefAttr(
    toolchain::StringRef name, mlir::FunctionType signature) {
  ...
  if (const IntrinsicHandler *handler = findIntrinsicHandler(name))
    funcOp = language::Compability::common::visit(
        [&](auto generator) {
...
mlir::Value IntrinsicLibrary::genRuntimeCall(toolchain::StringRef name,
                                             mlir::Type resultType,
                                             toolchain::ArrayRef<mlir::Value> args) {
  mlir::FunctionType soughtFuncType =
...
// ABORT
void IntrinsicLibrary::genAbort(toolchain::ArrayRef<fir::ExtendedValue> args) {
  assert(args.size() == 0);
...
mlir::Value IntrinsicLibrary::genAbs(mlir::Type resultType,
  ...
  toolchain_unreachable("unexpected type in ABS argument");
}
...
mlir::Value IntrinsicLibrary::genAcosd(mlir::Type resultType,
  ...
  toolchain::APFloat pi = toolchain::APFloat(toolchain::numbers::pi);
  mlir::Value dfactor = builder.createRealConstant(
      loc, mlir::Float64Type::get(context), toolchain::APFloat(180.0) / pi);
...
mlir::Value IntrinsicLibrary::genAcospi(mlir::Type resultType,
  ...
  toolchain::APFloat inv_pi =
      toolchain::APFloat(toolchain::cast<mlir::FloatType>(resultType).getFloatSemantics(),
                    toolchain::numbers::inv_pis);
...
static mlir::Value genAtomBinOp(fir::FirOpBuilder &builder, mlir::Location &loc,
                                ...
                                mlir::Value arg1) {
  auto toolchainPointerType = mlir::LLVM::LLVMPointerType::get(builder.getContext());
  arg0 = builder.createConvert(loc, toolchainPointerType, arg0);
...
IntrinsicLibrary::genAtomicCas(mlir::Type resultType,
  ...
  auto toolchainPtrTy = mlir::LLVM::LLVMPointerType::get(resultType.getContext());
  ...
  auto address =
      mlir::UnrealizedConversionCastOp::create(builder, loc, toolchainPtrTy, arg0)
          .getResult(0);
...
genCLocOrCFunLoc(fir::FirOpBuilder &builder, mlir::Location loc,
                 mlir::Type resultType, toolchain::ArrayRef<fir::ExtendedValue> args,
...
// C_F_POINTER
void IntrinsicLibrary::genCFPointer(toolchain::ArrayRef<fir::ExtendedValue> args) {
  assert(args.size() == 4);
...
mlir::Value IntrinsicLibrary::genCeiling(mlir::Type resultType,
  ...
  // an toolchain intrinsic that does the same, but return a floating
  // point.
...
mlir::Value IntrinsicLibrary::genConjg(mlir::Type resultType,
  ...
  if (resultType != args[0].getType())
    toolchain_unreachable("argument type mismatch");
...
mlir::Value IntrinsicLibrary::genCosd(mlir::Type resultType,
  ...
  toolchain::APFloat pi = toolchain::APFloat(toolchain::numbers::pi);
  mlir::Value dfactor = builder.createRealConstant(
      loc, mlir::Float64Type::get(context), pi / toolchain::APFloat(180.0));
  mlir::Value factor = builder.createConvert(loc, args[0].getType(), dfactor);
...
mlir::Value IntrinsicLibrary::genCospi(mlir::Type resultType,
  ...
  mlir::FunctionType ftype =
      mlir::FunctionType::get(context, {resultType}, {args[0].getType()});
  toolchain::APFloat pi =
      toolchain::APFloat(toolchain::cast<mlir::FloatType>(resultType).getFloatSemantics(),
                    toolchain::numbers::pis);
...
// CPU_TIME
void IntrinsicLibrary::genCpuTime(toolchain::ArrayRef<fir::ExtendedValue> args) {
  assert(args.size() == 1);
  const mlir::Value *arg = args[0].getUnboxed();
...
IntrinsicLibrary::genCUDALDXXFunc(mlir::Type resultType,
  ...
  toolchain::SmallVector<mlir::Value> funcArgs;
...
// DATE_AND_TIME
void IntrinsicLibrary::genDateAndTime(toolchain::ArrayRef<fir::ExtendedValue> args) {
  assert(args.size() == 4 && "date_and_time has 4 args");
  toolchain::SmallVector<std::optional<fir::CharBoxValue>> charArgs(3);
...
// EXIT
void IntrinsicLibrary::genExit(toolchain::ArrayRef<fir::ExtendedValue> args) {
  assert(args.size() == 1);
...
void IntrinsicLibrary::genFree(toolchain::ArrayRef<fir::ExtendedValue> args) {
  assert(args.size() == 1);
...
// GET_COMMAND
void IntrinsicLibrary::genGetCommand(toolchain::ArrayRef<fir::ExtendedValue> args) {
  assert(args.size() == 4);
...
fir::ExtendedValue
IntrinsicLibrary::genReduction(FN func, FD funcDim, toolchain::StringRef errMsg,
                               mlir::Type resultType,
                               toolchain::ArrayRef<fir::ExtendedValue> args) {
...
IntrinsicLibrary::genIchar(mlir::Type resultType,
  ...
  if (!charBox)
    toolchain::report_fatal_error("expected character scalar");
  ...
  if (auto charTy = mlir::dyn_cast<fir::CharacterType>(bufferTy)) {
    ...
    if (!ty)
      toolchain::report_fatal_error("expected memory type");
  ...
  LLVM_DEBUG(toolchain::dbgs() << "ichar(" << charVal << ")\n");
...
// toolchain floating point class intrinsic test values
//   0   Signaling NaN
//   1   Quiet NaN
//   2   Negative infinity
//   3   Negative normal
...
mlir::Value IntrinsicLibrary::genIeeeClass(mlir::Type resultType,
  ...
  toolchain::StringRef tableName = RTNAME_STRING(IeeeClassTable);
  ...
  auto createIntegerConstantAPI = [&](const toolchain::APInt &apInt) {
  ...
  auto getMasksAndShifts = [&](uint64_t totalSize, uint64_t exponentSize,
    ...
    toolchain::APInt exponentMaskAPI =
        toolchain::APInt::getBitsSet(intWidth, /*lo=*/significandSize,
                                /*hi=*/significandSize + exponentSize);
    exponentMask = createIntegerConstantAPI(exponentMaskAPI);
    toolchain::APInt lowSignificandMaskAPI =
        toolchain::APInt::getLowBitsSet(intWidth, lowSignificandSize);
  ...
  case 128: // kind=16: 1 sign bit, 15 exponent bits, 112 significand bits
    ...
    break;
  default:
    toolchain_unreachable("unknown real type");
  }
  ...
  if (!builder.getNamedGlobal(tableName)) {
    toolchain::SmallVector<mlir::Attribute, 64> values;
...
// IEEE_GET_FLAG
void IntrinsicLibrary::genIeeeGetFlag(toolchain::ArrayRef<fir::ExtendedValue> args) {
  assert(args.size() == 2);
...
void IntrinsicLibrary::genIeeeGetOrSetModesOrStatus(
  ...
  toolchain::StringRef func = isModes
  ...
  toolchain::StringRef func = isModes ? (isGet ? "fegetmode" : "fesetmode")
...
void IntrinsicLibrary::genIeeeGetRoundingMode(
  ...
  // Values are chosen to match the toolchain.get.rounding encoding.
...
mlir::Value IntrinsicLibrary::genIeeeInt(mlir::Type resultType,
  ...
  mlir::Value intLBound = mlir::arith::ConstantOp::create(
      ...
      builder.getIntegerAttr(resultType,
                             toolchain::APInt::getBitsSet(intWidth,
                                                     /*lo=*/intWidth - 1,
                                                     /*hi=*/intWidth)));
  mlir::Value intUBound = mlir::arith::ConstantOp::create(
      builder, loc, resultType,
      builder.getIntegerAttr(resultType,
                             toolchain::APInt::getBitsSet(intWidth, /*lo=*/0,
                                                     /*hi=*/intWidth - 1)));
...
void IntrinsicLibrary::genIeeeSetRoundingMode(
  ...
  // ROUNDING_VALUE. Values are toolchain.get.rounding encoding values.
...
mlir::Value IntrinsicLibrary::genIeeeValue(mlir::Type resultType,
  ...
  if (!builder.getNamedGlobal(tableName)) {
    toolchain::SmallVector<mlir::Attribute, tableSize> values;
...
void IntrinsicLibrary::genMoveAlloc(toolchain::ArrayRef<fir::ExtendedValue> args) {
  assert(args.size() == 4);
...
// MVBITS
void IntrinsicLibrary::genMvbits(toolchain::ArrayRef<fir::ExtendedValue> args) {
  ...
  mlir::Value minNegativeSubnormal = mlir::arith::BitcastOp::create(
      ...
      mlir::arith::ConstantOp::create(
          ...
          builder.getIntegerAttr(
              intType, toolchain::APInt::getBitsSetWithWrap(
...
// NULL
fir::ExtendedValue
IntrinsicLibrary::genNull(mlir::Type, toolchain::ArrayRef<fir::ExtendedValue> args) {
...
// PERROR
void IntrinsicLibrary::genPerror(toolchain::ArrayRef<fir::ExtendedValue> args) {
  assert(args.size() == 1);
...
// RANDOM_INIT
void IntrinsicLibrary::genRandomInit(toolchain::ArrayRef<fir::ExtendedValue> args) {
  assert(args.size() == 2);
...
// RANDOM_SEED
void IntrinsicLibrary::genRandomSeed(toolchain::ArrayRef<fir::ExtendedValue> args) {
  assert(args.size() == 3);
  mlir::Type boxNoneTy = fir::BoxType::get(builder.getNoneType());
  auto getDesc = [&](int i) {
...
IntrinsicLibrary::genSecond(std::optional<mlir::Type> resultType,
  ...
  toolchain::SmallVector<fir::ExtendedValue, 1> subroutineArgs(1, result);
...
genBoundInquiry(fir::FirOpBuilder &builder, mlir::Location loc,
  ...
  int rank = hasAssumedRank ? language::Compability::common::maxRank : array.rank();
...
IntrinsicLibrary::genShape(mlir::Type resultType,
  ...
  toolchain::SmallVector<mlir::Value> extents{shapeArrayExtent};
...
IntrinsicLibrary::genLbound(mlir::Type resultType,
  ...
  if (dimIsAbsent) {
    ...
    mlir::Value lbArrayExtent =
        builder.createIntegerConstant(loc, indexType, rank);
    toolchain::SmallVector<mlir::Value> extents{lbArrayExtent};
...
// SYNCTHREADS
void IntrinsicLibrary::genSyncThreads(toolchain::ArrayRef<fir::ExtendedValue> args) {
...
IntrinsicLibrary::genSyncThreadsAnd(mlir::Type resultType,
                                    toolchain::ArrayRef<mlir::Value> args) {
  constexpr toolchain::StringLiteral funcName = "toolchain.nvvm.barrier0.and";
  mlir::MLIRContext *context = builder.getContext();
  mlir::FunctionType ftype =
      mlir::FunctionType::get(context, {resultType}, {args[0].getType()});
...
IntrinsicLibrary::genSyncThreadsCount(mlir::Type resultType,
                                      toolchain::ArrayRef<mlir::Value> args) {
  constexpr toolchain::StringLiteral funcName = "toolchain.nvvm.barrier0.popc";
  mlir::MLIRContext *context = builder.getContext();
  mlir::FunctionType ftype =
      mlir::FunctionType::get(context, {resultType}, {args[0].getType()});
  auto funcOp = builder.createFunction(loc, funcName, ftype);
...
IntrinsicLibrary::genSyncThreadsOr(mlir::Type resultType,
                                   toolchain::ArrayRef<mlir::Value> args) {
  constexpr toolchain::StringLiteral funcName = "toolchain.nvvm.barrier0.or";
  mlir::MLIRContext *context = builder.getContext();
  mlir::FunctionType ftype =
      mlir::FunctionType::get(context, {resultType}, {args[0].getType()});
  auto funcOp = builder.createFunction(loc, funcName, ftype);
...
// SYNCWARP
void IntrinsicLibrary::genSyncWarp(toolchain::ArrayRef<fir::ExtendedValue> args) {
  assert(args.size() == 1);
  constexpr toolchain::StringLiteral funcName = "toolchain.nvvm.bar.warp.sync";
  ...
  toolchain::SmallVector<mlir::Value> argsList{mask};
...
// SYSTEM_CLOCK
void IntrinsicLibrary::genSystemClock(toolchain::ArrayRef<fir::ExtendedValue> args) {
  assert(args.size() == 3);
...
// SLEEP
void IntrinsicLibrary::genSleep(toolchain::ArrayRef<fir::ExtendedValue> args) {
...
// THREADFENCE
void IntrinsicLibrary::genThreadFence(toolchain::ArrayRef<fir::ExtendedValue> args) {
  constexpr toolchain::StringLiteral funcName = "toolchain.nvvm.membar.gl";
  mlir::FunctionType funcType =
      mlir::FunctionType::get(builder.getContext(), {}, {});
  auto funcOp = builder.createFunction(loc, funcName, funcType);
  toolchain::SmallVector<mlir::Value> noArgs;
...
void IntrinsicLibrary::genThreadFenceBlock(
    toolchain::ArrayRef<fir::ExtendedValue> args) {
  constexpr toolchain::StringLiteral funcName = "toolchain.nvvm.membar.cta";
  mlir::FunctionType funcType =
      mlir::FunctionType::get(builder.getContext(), {}, {});
  auto funcOp = builder.createFunction(loc, funcName, funcType);
  toolchain::SmallVector<mlir::Value> noArgs;
...
void IntrinsicLibrary::genThreadFenceSystem(
    toolchain::ArrayRef<fir::ExtendedValue> args) {
  constexpr toolchain::StringLiteral funcName = "toolchain.nvvm.membar.sys";
  mlir::FunctionType funcType =
      mlir::FunctionType::get(builder.getContext(), {}, {});
  auto funcOp = builder.createFunction(loc, funcName, funcType);
  toolchain::SmallVector<mlir::Value> noArgs;
...
template <typename FN, typename FD>
fir::ExtendedValue
IntrinsicLibrary::genExtremumloc(FN func, FD funcDim, toolchain::StringRef errMsg,
                                 mlir::Type resultType,
                                 toolchain::ArrayRef<fir::ExtendedValue> args) {
...
IntrinsicLibrary::genExtremumVal(FN func, FD funcDim, FC funcChar,
                                 toolchain::StringRef errMsg, mlir::Type resultType,
                                 toolchain::ArrayRef<fir::ExtendedValue> args) {
...
getIntrinsicArgumentLowering(toolchain::StringRef specificName) {
  toolchain::StringRef name = genericName(specificName);
  if (const IntrinsicHandler *handler = findIntrinsicHandler(name))
...
getUnrestrictedIntrinsicSymbolRefAttr(fir::FirOpBuilder &builder,
                                      mlir::Location loc, toolchain::StringRef name,
