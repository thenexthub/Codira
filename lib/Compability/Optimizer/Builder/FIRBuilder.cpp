...
#include "language/CompabilityOptimizer/Builder/FIRBuilder.h"
#include "language/CompabilityOptimizer/Builder/BoxValue.h"
#include "language/CompabilityOptimizer/Builder/Character.h"
#include "language/CompabilityOptimizer/Builder/Complex.h"
#include "language/CompabilityOptimizer/Builder/MutableBox.h"
#include "language/CompabilityOptimizer/Builder/Runtime/Allocatable.h"
#include "language/CompabilityOptimizer/Builder/Runtime/Assign.h"
#include "language/CompabilityOptimizer/Builder/Runtime/Derived.h"
#include "language/CompabilityOptimizer/Builder/Todo.h"
#include "language/CompabilityOptimizer/Dialect/CUF/CUFOps.h"
#include "language/CompabilityOptimizer/Dialect/FIRAttr.h"
#include "language/CompabilityOptimizer/Dialect/FIRDialect.h"
#include "language/CompabilityOptimizer/Dialect/FIROpsSupport.h"
#include "language/CompabilityOptimizer/Dialect/FIRType.h"
#include "language/CompabilityOptimizer/Support/DataLayout.h"
#include "language/CompabilityOptimizer/Support/FatalError.h"
#include "language/CompabilityOptimizer/Support/InternalNames.h"
#include "language/CompabilityOptimizer/Support/Utils.h"
...
static toolchain::cl::opt<std::size_t>
    nameLengthHashSize("length-to-hash-string-literal",
                       toolchain::cl::desc("string literals that exceed this length"
                                      " will use a hash value as their symbol "
                                      "name"),
                       toolchain::cl::init(32));

mlir::func::FuncOp
fir::FirOpBuilder::createFunction(mlir::Location loc, mlir::ModuleOp module,
                                  toolchain::StringRef name, mlir::FunctionType ty,
...
mlir::Type fir::FirOpBuilder::getRealType(int kind) {
  ...
  case toolchain::Type::TypeID::HalfTyID:
    return mlir::Float16Type::get(getContext());
  case toolchain::Type::TypeID::BFloatTyID:
    return mlir::BFloat16Type::get(getContext());
  case toolchain::Type::TypeID::FloatTyID:
    return mlir::Float32Type::get(getContext());
  case toolchain::Type::TypeID::DoubleTyID:
    return mlir::Float64Type::get(getContext());
  case toolchain::Type::TypeID::X86_FP80TyID:
    return mlir::Float80Type::get(getContext());
  case toolchain::Type::TypeID::FP128TyID:
...
mlir::Value fir::FirOpBuilder::createAllOnesInteger(mlir::Location loc,
  ...
  toolchain::APInt allOnes =
      toolchain::APInt::getAllOnes(mlir::cast<mlir::IntegerType>(ty).getWidth());
  return mlir::arith::ConstantOp::create(*this, loc, ty,
...
fir::FirOpBuilder::createRealConstant(mlir::Location loc, mlir::Type fltTy,
                                      toolchain::APFloat::integerPart val) {
  auto apf = [&]() -> toolchain::APFloat {
    if (fltTy.isF16())
      return toolchain::APFloat(toolchain::APFloat::IEEEhalf(), val);
    if (fltTy.isBF16())
      return toolchain::APFloat(toolchain::APFloat::BFloat(), val);
    if (fltTy.isF32())
      return toolchain::APFloat(toolchain::APFloat::IEEEsingle(), val);
    if (fltTy.isF64())
      return toolchain::APFloat(toolchain::APFloat::IEEEdouble(), val);
    if (fltTy.isF80())
      return toolchain::APFloat(toolchain::APFloat::x87DoubleExtended(), val);
    if (fltTy.isF128())
      return toolchain::APFloat(toolchain::APFloat::IEEEquad(), val);
    toolchain_unreachable("unhandled MLIR floating-point type");
  };
...
mlir::Value fir::FirOpBuilder::createRealConstant(mlir::Location loc,
  ...
  toolchain_unreachable("should use builtin floating-point type");
}
...
fir::factory::elideExtentsAlreadyInType(mlir::Type type,
  ...
  toolchain::SmallVector<mlir::Value> dynamicShape;
...
mlir::Value fir::FirOpBuilder::allocateLocal(
    mlir::Location loc, mlir::Type ty, toolchain::StringRef uniqName,
    toolchain::StringRef name, bool pinned, toolchain::ArrayRef<mlir::Value> shape,
    toolchain::ArrayRef<mlir::Value> lenParams, bool asTarget) {
...
mlir::Value fir::FirOpBuilder::allocateLocal(
    mlir::Location loc, mlir::Type ty, toolchain::StringRef uniqName,
    toolchain::StringRef name, toolchain::ArrayRef<mlir::Value> shape,
    toolchain::ArrayRef<mlir::Value> lenParams, bool asTarget) {
...
static mlir::ArrayAttr makeI64ArrayAttr(toolchain::ArrayRef<int64_t> values,
                                        mlir::MLIRContext *context) {
  toolchain::SmallVector<mlir::Attribute, 4> attrs;
...
mlir::ArrayAttr fir::FirOpBuilder::create2DI64ArrayAttr(
    toolchain::SmallVectorImpl<toolchain::SmallVector<int64_t>> &intData) {
  toolchain::SmallVector<mlir::Attribute> arrayAttr;
...
mlir::Value fir::FirOpBuilder::createTemporaryAlloc(
    mlir::Location loc, mlir::Type type, toolchain::StringRef name,
  ...
  if (cudaAttr) {
    ...
    return cuf::AllocOp::create(*this, loc, type,
                                /*unique_name=*/toolchain::StringRef{}, name, attr,
                                lenParams, shape, attrs);
  } else {
    return fir::AllocaOp::create(*this, loc, type,
                                 /*unique_name=*/toolchain::StringRef{}, name,
...
mlir::Value fir::FirOpBuilder::createTemporary(
  ...
  toolchain::SmallVector<mlir::Value> dynamicLength =
...
std::pair<mlir::Value, bool> fir::FirOpBuilder::createAndDeclareTemp(
    ...
    toolchain::ArrayRef<mlir::Value> extents, toolchain::ArrayRef<mlir::Value> typeParams,
    const std::function<decltype(FirOpBuilder::genTempDeclareOp)> &genDeclare,
    mlir::Value polymorphicMold, bool useStack, toolchain::StringRef tmpName) {
  if (polymorphicMold) {
...
mlir::Value fir::FirOpBuilder::genTempDeclareOp(
    ...
    toolchain::StringRef name, mlir::Value shape,
    toolchain::ArrayRef<mlir::Value> typeParams,
...
fir::GlobalOp fir::FirOpBuilder::createGlobal(
    mlir::Location loc, mlir::Type type, toolchain::StringRef name, bool isConst,
...
mlir::Value fir::FirOpBuilder::convertWithSemantics(
  ...
  if (allowCharacterConversion) {
    ...
    if (auto boxType = mlir::dyn_cast<fir::BoxCharType>(toTy)) {
      ...
      // Do not use fir.undef since toolchain optimizer is too harsh when it
...
fir::StringLitOp fir::FirOpBuilder::createStringLitOp(mlir::Location loc,
  ...
  return fir::StringLitOp::create(*this, loc, toolchain::ArrayRef<mlir::Type>{type},
                                  mlir::ValueRange{}, attrs);
}

mlir::Value fir::FirOpBuilder::genShape(mlir::Location loc,
                                        toolchain::ArrayRef<mlir::Value> exts) {
  return fir::ShapeOp::create(*this, loc, exts);
}

mlir::Value fir::FirOpBuilder::genShape(mlir::Location loc,
                                        toolchain::ArrayRef<mlir::Value> shift,
                                        toolchain::ArrayRef<mlir::Value> exts) {
  auto shapeType = fir::ShapeShiftType::get(getContext(), exts.size());
  toolchain::SmallVector<mlir::Value> shapeArgs;
  auto idxTy = getIndexType();
  for (auto [lbnd, ext] : toolchain::zip(shift, exts)) {
...
mlir::Value fir::FirOpBuilder::createSlice(mlir::Location loc,
  ...
  if (triples.empty()) {
    ...
    auto fullShape = [&](const toolchain::ArrayRef<mlir::Value> lbounds,
                         toolchain::ArrayRef<mlir::Value> extents) -> mlir::Value {
      ...
      for (auto [lbnd, extent] : toolchain::zip(lbounds, extents)) {
        auto lb = createConvert(loc, idxTy, lbnd);
...
mlir::Value fir::FirOpBuilder::createBox(mlir::Location loc,
  ...
  if (!elementType) {
    mlir::emitError(loc, "internal: expected a memory reference type ")
        << itemAddr.getType();
    toolchain_unreachable("not a memory reference type");
  }
  ...
  return exv.match(
      ...
      [&](const fir::CharArrayBoxValue &box) -> mlir::Value {
        ...
        toolchain::SmallVector<mlir::Value> lenParams{box.getLen()};
...
void fir::FirOpBuilder::setCommonAttributes(mlir::Operation *op) const {
  ...
  if (fmi) {
    ...
    toolchain::StringRef arithFMFAttrName = fmi.getFastMathAttrName();
  ...
  if (iofi) {
    toolchain::StringRef arithIOFAttrName = iofi.getIntegerOverflowAttrName();
...
void fir::FirOpBuilder::setFastMathFlags(
    language::Compability::common::MathOptionsBase options) {
...
fir::factory::getExtents(mlir::Location loc, fir::FirOpBuilder &builder,
                         const fir::ExtendedValue &box) {
  return box.match(
      [&](const fir::ArrayBoxValue &x) -> toolchain::SmallVector<mlir::Value> {
        return {x.getExtents().begin(), x.getExtents().end()};
      },
      [&](const fir::CharArrayBoxValue &x) -> toolchain::SmallVector<mlir::Value> {
        return {x.getExtents().begin(), x.getExtents().end()};
      },
      [&](const fir::BoxValue &x) -> toolchain::SmallVector<mlir::Value> {
        return fir::factory::readExtents(builder, loc, x);
      },
      [&](const fir::MutableBoxValue &x) -> toolchain::SmallVector<mlir::Value> {
        auto load = fir::factory::genMutableBoxRead(builder, loc, x);
        return fir::factory::getExtents(loc, builder, load);
      },
      [&](const auto &) -> toolchain::SmallVector<mlir::Value> { return {}; });
}
...
fir::factory::getNonDefaultLowerBounds(fir::FirOpBuilder &builder,
                                       ...
                                       const fir::ExtendedValue &exv) {
  return exv.match(
      [&](const fir::ArrayBoxValue &array) -> toolchain::SmallVector<mlir::Value> {
      ...
      [&](const fir::BoxValue &box) -> toolchain::SmallVector<mlir::Value> {
        return {box.getLBounds().begin(), box.getLBounds().end()};
      },
      [&](const fir::MutableBoxValue &box) -> toolchain::SmallVector<mlir::Value> {
...
fir::factory::getNonDeferredLenParams(const fir::ExtendedValue &exv) {
  return exv.match(
      [&](const fir::CharArrayBoxValue &character)
          -> toolchain::SmallVector<mlir::Value> { return {character.getLen()}; },
...
// the box value.
static toolchain::SmallVector<mlir::Value> getFromBox(mlir::Location loc,
...
fir::factory::getTypeParams(mlir::Location loc, fir::FirOpBuilder &builder,
                            const fir::ExtendedValue &exv) {
  auto handleBoxed = [&](const auto &box) -> toolchain::SmallVector<mlir::Value> {
    if (box.isCharacter())
...
std::string fir::factory::uniqueCGIdent(toolchain::StringRef prefix,
                                        toolchain::StringRef name) {
  ...
  if (name.size() > nameLengthHashSize) {
    ...
    hash.final(result);
    toolchain::SmallString<32> str;
    toolchain::MD5::stringifyResult(result, str);
  ...
  return fir::NameUniquer::doGenerated(
      nm.append("X").append(toolchain::toHex(name)));
}
...
fir::ExtendedValue fir::factory::componentToExtendedValue(
  ...
  if (mlir::isa<fir::BaseBoxType>(fieldTy)) {
    toolchain::SmallVector<mlir::Value> nonDeferredTypeParams;
...
static void genComponentByComponentAssignment(fir::FirOpBuilder &builder,
  ...
  for (auto [lhsPair, rhsPair] :
       toolchain::zip(lhsType.getTypeList(), rhsType.getTypeList())) {
    ...
    if (auto sequenceType = mlir::dyn_cast<fir::SequenceType>(lFieldTy)) {
      ...
      for (auto extent : toolchain::reverse(sequenceType.getShape())) {
...
mlir::Value fir::factory::genLenOfCharacter(
    ...
    toolchain::ArrayRef<mlir::Value> path, toolchain::ArrayRef<mlir::Value> substring) {
  toolchain::SmallVector<mlir::Value> typeParams(arrLoad.getTypeparams());
...
mlir::Value fir::factory::genLenOfCharacter(
    ...
    mlir::Value memref, toolchain::ArrayRef<mlir::Value> typeParams,
    toolchain::ArrayRef<mlir::Value> path, toolchain::ArrayRef<mlir::Value> substring) {
  auto idxTy = builder.getIndexType();
...
fir::BoxValue fir::factory::createBoxValue(fir::FirOpBuilder &builder,
  ...
  toolchain::SmallVector<mlir::Value> explicitTypeParams;
  exv.match(
      [&](const fir::ArrayBoxValue &box) {
...
void fir::factory::setInternalLinkage(mlir::func::FuncOp func) {
  ...
  func->setAttr("toolchain.linkage", linkage);
}
...
fir::factory::deduceOptimalExtents(mlir::ValueRange extents1,
  ...
  for (auto [extent1, extent2] : toolchain::zip(extents1, extents2)) {
...
toolchain::SmallVector<mlir::Value> fir::factory::updateRuntimeExtentsForEmptyArrays(
  ...
  toolchain::SmallVector<mlir::Value, language::Compability::common::maxRank> zeroes;
  ...
  for (auto [zero, extent] : toolchain::zip_equal(zeroes, extents)) {
...
void fir::factory::genDimInfoFromBox(
    ...
    toolchain::SmallVectorImpl<mlir::Value> *lbounds,
    toolchain::SmallVectorImpl<mlir::Value> *extents,
    toolchain::SmallVectorImpl<mlir::Value> *strides) {
