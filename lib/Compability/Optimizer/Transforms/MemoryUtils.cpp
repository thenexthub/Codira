...
public:
  bool allocaIsInCycle(fir::AllocaOp alloca,
                       toolchain::ArrayRef<mlir::Operation *> deallocationPoints);
...
private:
  ...
  toolchain::DenseMap<mlir::Block *, /*isInCycle*/ bool> analyzed;
};
} // namespace
...
private:
  mlir::Region *findDeallocationPointsAndOwner(
      fir::AllocaOp alloca,
      toolchain::SmallVectorImpl<mlir::Operation *> &deallocationPoints);
  bool
  allocDominatesDealloc(fir::AllocaOp alloca,
                        toolchain::ArrayRef<mlir::Operation *> deallocationPoints) {
    return toolchain::all_of(deallocationPoints, [&](mlir::Operation *deallocPoint) {
...
allocaIsInCycleImpl(mlir::Block *allocaBlock,
                    toolchain::ArrayRef<mlir::Operation *> deallocationPoints) {
  toolchain::DenseSet<mlir::Block *> seen;
  ...
  toolchain::SmallVector<mlir::Block *> successors{allocaBlock};
...
static bool terminatorYieldsMemory(mlir::Operation &terminator) {
  return toolchain::any_of(terminator.getResults(), [](mlir::OpResult res) {
...
bool AllocaReplaceImpl::replace(mlir::RewriterBase &rewriter,
                                fir::AllocaOp alloca) {
  toolchain::SmallVector<mlir::Operation *> deallocationPoints;
