...
#ifndef LANGUAGE_COMPABILITY_OPTIMIZER_TRANSFORMS_DEBUGTYPEGENERATOR_H
#define LANGUAGE_COMPABILITY_OPTIMIZER_TRANSFORMS_DEBUGTYPEGENERATOR_H
...
public:
  ...
  // PR.
  // https://github.com/toolchain/toolchain-project/pull/106571
  //
  ...
  // recursive types.
  using ActiveLevels = toolchain::SmallVector<int32_t, 1>;
...
private:
  ...
  // smaller than "i".
  toolchain::DenseMap<mlir::Type, std::pair<mlir::LLVM::DITypeAttr, ActiveLevels>>
      typeCache;
  ...
  toolchain::SmallVector<std::pair<toolchain::SmallVector<mlir::Type>, int32_t>>
      cacheCleanupList;
};
...
private:
  ...
  fir::LLVMTypeConverter toolchainTypeConverter;
