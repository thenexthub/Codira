...
#include "language/Compability/Common/leading-zero-bit-count.h"
#include "language/Compability/Decimal/binary-floating-point.h"
...
enum ConversionResultFlags ConvertDecimalToFloat(
  ...
  auto result{language::Compability::decimal::ConvertToBinary<24>(*p, rounding)};
...
enum ConversionResultFlags ConvertDecimalToDouble(
  ...
  auto result{language::Compability::decimal::ConvertToBinary<53>(*p, rounding)};
...
enum ConversionResultFlags ConvertDecimalToLongDouble(
  ...
  auto result{language::Compability::decimal::ConvertToBinary<64>(*p, rounding)};
