...
ConversionToDecimalResult ConvertFloatToDecimal(char *buffer, std::size_t size,
  ...
  return language::Compability::decimal::ConvertToDecimal(buffer, size, flags, digits,
      rounding, language::Compability::decimal::BinaryFloatingPointNumber<24>(x));
}
...
ConversionToDecimalResult ConvertDoubleToDecimal(char *buffer, std::size_t size,
  ...
  return language::Compability::decimal::ConvertToDecimal(buffer, size, flags, digits,
      rounding, language::Compability::decimal::BinaryFloatingPointNumber<53>(x));
}
...
ConversionToDecimalResult ConvertLongDoubleToDecimal(char *buffer,
  ...
  return language::Compability::decimal::ConvertToDecimal(buffer, size, flags, digits,
      rounding, language::Compability::decimal::BinaryFloatingPointNumber<64>(x));
}
...
ConversionToDecimalResult ConvertLongDoubleToDecimal(char *buffer,
    ...
    enum FortranRounding rounding, long double x) {
  return language::Compability::decimal::ConvertToDecimal(buffer, size, flags, digits,
      rounding, language::Compability::decimal::BinaryFloatingPointNumber<113>(x));
}
#endif
