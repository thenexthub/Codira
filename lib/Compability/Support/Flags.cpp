...
toolchain::cl::opt<bool> enableDelayedPrivatization("enable-delayed-privatization",
    toolchain::cl::desc(
        "Emit private/local variables as clauses/specifiers on MLIR ops."),
    toolchain::cl::init(true));

toolchain::cl::opt<bool> enableDelayedPrivatizationStaging(
    "enable-delayed-privatization-staging",
    toolchain::cl::desc("For partially supported constructs, emit private/local "
