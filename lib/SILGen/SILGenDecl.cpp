...
#include "language/SIL/SILDebuggerClient.h"
...
#ifndef NDEBUG
      toolchain::errs() << "CleanupClosureConstant\n"
                   << "State:" << getState() << "\n"
                   << "closure:" << closure << "\n";
#endif
    }
...
public:
  ...
  void dump(SILGenFunction &) const override {
#ifndef NDEBUG
    toolchain::errs() << "ReleaseValueCleanup\n"
                 << "State:" << getState() << "\n"
                 << "Value:" << v << "\n";
#endif
  }
...
public:
  ...
  void dump(SILGenFunction &) const override {
#ifndef NDEBUG
    toolchain::errs() << "DeallocStackCleanup\n"
                 << "State:" << getState() << "\n"
                 << "Addr:" << Addr << "\n";
#endif
  }
...
#ifndef NDEBUG
    toolchain::errs() << "DestroyLocalVariable\n"
                 << "State:" << getState() << "\n"
                 << "Decl: ";
    Var->print(toolchain::errs());
    toolchain::errs() << "\n";
    if (isActive()) {
      auto &loc = SGF.VarLocs[Var];
      assert((loc.box || loc.value) && "One of box or value should be set");
      if (loc.box) {
        toolchain::errs() << "Box: " << loc.box << "\n";
      } else {
        toolchain::errs() << "Value: " << loc.value << "\n";
      }
    }
    toolchain::errs() << "\n";
#endif
...
public:
  ...
  void dump(SILGenFunction &) const override {
#ifndef NDEBUG
    toolchain::errs() << "DeallocateUninitializedLocalVariable\n"
                 << "State:" << getState() << "\n";
...
public:
  ...
  void dump(SILGenFunction &SGF) const override {
#ifndef NDEBUG
    toolchain::errs() << "DeallocateLocalVariableAddressableBuffer\n"
                 << "State:" << getState() << "\n"
                 << "Decl: ";
    vd->print(toolchain::errs());
    toolchain::errs() << "\n";
#endif
  }
};
...
public:
  ...
  SILValue getValueForLexicalLifetimeBinding(SILGenFunction &SGF,
    ...
    case OwnershipKind::Any:
      toolchain_unreachable("unexpected ownership");
    }
    if (vd->isNoImplicitCopy()) {
      value =
...
static EnumElementDecl *getOppositeBinaryDecl(const SILGenFunction &SGF,
  ...
  if (!enumDecl->isEffectivelyExhaustive(SGF.SGM.CodiraModule,
...
SILGenFunction::emitInitializationForVarDecl(VarDecl *vd, bool forceImmutable,
  ...
  if (vd->isDebuggerVar()) {
    DebuggerClient *DebugClient = SGM.CodiraModule->getDebugClient();
...
public:
  ...
  void dump(SILGenFunction &) const override {
#ifndef NDEBUG
    toolchain::errs() << "EndLifetimeCleanup\n"
                 << "State:" << getState() << "\n"
                 << "Value:" << v << "\n";
#endif
  }
  ...
  public:
    ...
    void emit(SILGenFunction &SGF, CleanupLocation l,
      ...
      case ExistentialRepresentation::Metatype:
        toolchain_unreachable("cannot cleanup existential");
    ...
    void dump(SILGenFunction &) const override {
#ifndef NDEBUG
      toolchain::errs() << "DeinitExistentialCleanup\n"
                   << "State:" << getState() << "\n"
...
namespace {
  ...
  public:
    ...
    void dump(SILGenFunction &) const override {
#ifndef NDEBUG
      toolchain::errs() << "CancelAsyncTaskCleanup\n"
                   << "Task:" << task << "\n";
#endif
    }
  };
...
public:
  ...
  void dump(SILGenFunction &) const override {
#ifndef NDEBUG
    toolchain::errs() << "AsyncLetCleanup\n"
                 << "AsyncLet:" << alet << "\n"
...
struct FormalAccessReleaseValueCleanup final : Cleanup {
  ...
  void dump(SILGenFunction &SGF) const override {
#ifndef NDEBUG
    toolchain::errs() << "FormalAccessReleaseValueCleanup "
                 << "State:" << getState() << "\n"
                 << "Value:" << getValue(SGF) << "\n";
#endif
  }
...
SILGenFunction::getLocalVariableAddressableBuffer(VarDecl *decl,
  ...
  }
  {
    ...
    if (isa<ParamDecl>(decl)) {
      ...
      toolchain_unreachable("unexpected value source!");
    }
