...
UID_KEYS = [
    ...
    KEY('SwiftVersion', 'key.language_version'),
    KEY('Value', 'key.value'),
    ...
    KEY('UsingSwiftArgs', 'key.usinglanguageargs'),
    KEY('Names', 'key.names'),
    KEY('UIDs', 'key.uids'),
...
UID_REQUESTS = [
    ...
    REQUEST('EditorOpenSwiftSourceInterface',
            'source.request.editor.open.interface.languagesource'),
    REQUEST('EditorOpenSwiftTypeInterface',
            'source.request.editor.open.interface.languagetype'),
...
UID_KINDS = [
    KIND('DeclFunctionFree', 'source.lang.language.decl.function.free'),
    KIND('RefFunctionFree', 'source.lang.language.ref.function.free'),
    KIND('DeclMethodInstance',
         'source.lang.language.decl.function.method.instance'),
    KIND('RefMethodInstance',
         'source.lang.language.ref.function.method.instance'),
    KIND('DeclMethodStatic', 'source.lang.language.decl.function.method.static'),
    KIND('RefMethodStatic', 'source.lang.language.ref.function.method.static'),
    KIND('DeclMethodClass', 'source.lang.language.decl.function.method.class'),
    KIND('RefMethodClass', 'source.lang.language.ref.function.method.class'),
    KIND('DeclAccessorGetter',
         'source.lang.language.decl.function.accessor.getter'),
    KIND('RefAccessorGetter',
         'source.lang.language.ref.function.accessor.getter'),
    KIND('DeclAccessorSetter',
         'source.lang.language.decl.function.accessor.setter'),
    KIND('RefAccessorSetter',
         'source.lang.language.ref.function.accessor.setter'),
    KIND('DeclAccessorWillSet',
         'source.lang.language.decl.function.accessor.willset'),
    KIND('RefAccessorWillSet',
         'source.lang.language.ref.function.accessor.willset'),
    KIND('DeclAccessorDidSet',
         'source.lang.language.decl.function.accessor.didset'),
    KIND('RefAccessorDidSet',
         'source.lang.language.ref.function.accessor.didset'),
    KIND('DeclAccessorAddress',
         'source.lang.language.decl.function.accessor.address'),
    KIND('RefAccessorAddress',
         'source.lang.language.ref.function.accessor.address'),
    KIND('DeclAccessorMutableAddress',
         'source.lang.language.decl.function.accessor.mutableaddress'),
    KIND('RefAccessorMutableAddress',
         'source.lang.language.ref.function.accessor.mutableaddress'),
    KIND('DeclAccessorRead',
         'source.lang.language.decl.function.accessor.read'),
    KIND('RefAccessorRead',
         'source.lang.language.ref.function.accessor.read'),
    KIND('DeclAccessorModify',
         'source.lang.language.decl.function.accessor.modify'),
    KIND('RefAccessorModify',
         'source.lang.language.ref.function.accessor.modify'),
    KIND('DeclAccessorInit',
         'source.lang.language.decl.function.accessor.init'),
    KIND('RefAccessorInit',
         'source.lang.language.ref.function.accessor.init'),
    KIND('DeclConstructor', 'source.lang.language.decl.function.constructor'),
    KIND('RefConstructor', 'source.lang.language.ref.function.constructor'),
    KIND('DeclDestructor', 'source.lang.language.decl.function.destructor'),
    KIND('RefDestructor', 'source.lang.language.ref.function.destructor'),
    KIND('DeclFunctionPrefixOperator',
         'source.lang.language.decl.function.operator.prefix'),
    KIND('DeclFunctionPostfixOperator',
         'source.lang.language.decl.function.operator.postfix'),
    KIND('DeclFunctionInfixOperator',
         'source.lang.language.decl.function.operator.infix'),
    KIND('RefFunctionPrefixOperator',
         'source.lang.language.ref.function.operator.prefix'),
    KIND('RefFunctionPostfixOperator',
         'source.lang.language.ref.function.operator.postfix'),
    KIND('RefFunctionInfixOperator',
         'source.lang.language.ref.function.operator.infix'),
    KIND('DeclPrecedenceGroup', 'source.lang.language.decl.precedencegroup'),
    KIND('RefPrecedenceGroup', 'source.lang.language.ref.precedencegroup'),
    KIND('DeclSubscript', 'source.lang.language.decl.function.subscript'),
    KIND('RefSubscript', 'source.lang.language.ref.function.subscript'),
    KIND('DeclVarGlobal', 'source.lang.language.decl.var.global'),
    KIND('RefVarGlobal', 'source.lang.language.ref.var.global'),
    KIND('DeclVarInstance', 'source.lang.language.decl.var.instance'),
    KIND('RefVarInstance', 'source.lang.language.ref.var.instance'),
    KIND('DeclVarStatic', 'source.lang.language.decl.var.static'),
    KIND('RefVarStatic', 'source.lang.language.ref.var.static'),
    KIND('DeclVarClass', 'source.lang.language.decl.var.class'),
    KIND('RefVarClass', 'source.lang.language.ref.var.class'),
    KIND('DeclVarLocal', 'source.lang.language.decl.var.local'),
    KIND('RefVarLocal', 'source.lang.language.ref.var.local'),
    KIND('DeclVarParam', 'source.lang.language.decl.var.parameter'),
    KIND('DeclModule', 'source.lang.language.decl.module'),
    KIND('DeclClass', 'source.lang.language.decl.class'),
    KIND('RefClass', 'source.lang.language.ref.class'),
    KIND('DeclActor', 'source.lang.language.decl.actor'),
    KIND('RefActor', 'source.lang.language.ref.actor'),
    KIND('DeclStruct', 'source.lang.language.decl.struct'),
    KIND('RefStruct', 'source.lang.language.ref.struct'),
    KIND('DeclEnum', 'source.lang.language.decl.enum'),
    KIND('RefEnum', 'source.lang.language.ref.enum'),
    KIND('DeclEnumCase', 'source.lang.language.decl.enumcase'),
    KIND('DeclEnumElement', 'source.lang.language.decl.enumelement'),
    KIND('RefEnumElement', 'source.lang.language.ref.enumelement'),
    KIND('DeclProtocol', 'source.lang.language.decl.protocol'),
    KIND('RefProtocol', 'source.lang.language.ref.protocol'),
    KIND('DeclExtension', 'source.lang.language.decl.extension'),
    KIND('DeclExtensionStruct', 'source.lang.language.decl.extension.struct'),
    KIND('DeclExtensionClass', 'source.lang.language.decl.extension.class'),
    KIND('DeclExtensionEnum', 'source.lang.language.decl.extension.enum'),
    KIND('DeclExtensionProtocol', 'source.lang.language.decl.extension.protocol'),
    KIND('DeclAssociatedType', 'source.lang.language.decl.associatedtype'),
    KIND('RefAssociatedType', 'source.lang.language.ref.associatedtype'),
    KIND('DeclOpaqueType', 'source.lang.language.decl.opaquetype'),
    KIND('RefOpaqueType', 'source.lang.language.ref.opaquetype'),
    KIND('DeclTypeAlias', 'source.lang.language.decl.typealias'),
    KIND('RefTypeAlias', 'source.lang.language.ref.typealias'),
    KIND('DeclGenericTypeParam', 'source.lang.language.decl.generic_type_param'),
    KIND('RefGenericTypeParam', 'source.lang.language.ref.generic_type_param'),
    KIND('DeclMacro', 'source.lang.language.decl.macro'),
    KIND('RefMacro', 'source.lang.language.ref.macro'),
    KIND('RefModule', 'source.lang.language.ref.module'),
    KIND('CommentTag', 'source.lang.language.commenttag'),
    KIND('StmtForEach', 'source.lang.language.stmt.foreach'),
    KIND('StmtFor', 'source.lang.language.stmt.for'),
    KIND('StmtWhile', 'source.lang.language.stmt.while'),
    KIND('StmtRepeatWhile', 'source.lang.language.stmt.repeatwhile'),
    KIND('StmtIf', 'source.lang.language.stmt.if'),
    KIND('StmtGuard', 'source.lang.language.stmt.guard'),
    KIND('StmtSwitch', 'source.lang.language.stmt.switch'),
    KIND('StmtCase', 'source.lang.language.stmt.case'),
    KIND('StmtBrace', 'source.lang.language.stmt.brace'),
    KIND('ExprCall', 'source.lang.language.expr.call'),
    KIND('ExprArg', 'source.lang.language.expr.argument'),
    KIND('ExprArray', 'source.lang.language.expr.array'),
    KIND('ExprDictionary', 'source.lang.language.expr.dictionary'),
    KIND('ExprObjectLiteral', 'source.lang.language.expr.object_literal'),
    KIND('ExprTuple', 'source.lang.language.expr.tuple'),
    KIND('ExprClosure', 'source.lang.language.expr.closure'),
    KIND('StructureElemId', 'source.lang.language.structure.elem.id'),
    KIND('StructureElemExpr', 'source.lang.language.structure.elem.expr'),
    KIND('StructureElemInitExpr',
         'source.lang.language.structure.elem.init_expr'),
    KIND('StructureElemCondExpr',
         'source.lang.language.structure.elem.condition_expr'),
    KIND('StructureElemPattern', 'source.lang.language.structure.elem.pattern'),
    KIND('StructureElemTypeRef', 'source.lang.language.structure.elem.typeref'),
    KIND('RangeSingleStatement', 'source.lang.language.range.singlestatement'),
    KIND('RangeSingleExpression', 'source.lang.language.range.singleexpression'),
    KIND('RangeSingleDeclaration',
         'source.lang.language.range.singledeclaration'),
    KIND('RangeMultiStatement', 'source.lang.language.range.multistatement'),
    KIND('RangeMultiTypeMemberDeclaration',
         'source.lang.language.range.multitypememberdeclaration'),
    KIND('RangeInvalid', 'source.lang.language.range.invalid'),
    KIND('NameObjc', 'source.lang.name.kind.objc'),
    KIND('NameSwift', 'source.lang.name.kind.language'),
    KIND('Keyword', 'source.lang.language.syntaxtype.keyword'),
    KIND('Identifier', 'source.lang.language.syntaxtype.identifier'),
    KIND('Operator', 'source.lang.language.syntaxtype.operator'),
    KIND('TypeIdentifier', 'source.lang.language.syntaxtype.typeidentifier'),
    KIND('BuildConfigKeyword',
         'source.lang.language.syntaxtype.buildconfig.keyword'),
    KIND('BuildConfigId', 'source.lang.language.syntaxtype.buildconfig.id'),
    KIND('PoundDirectiveKeyword',
         'source.lang.language.syntaxtype.pounddirective.keyword'),
    KIND('AttributeId', 'source.lang.language.syntaxtype.attribute.id'),
    KIND('AttributeBuiltin', 'source.lang.language.syntaxtype.attribute.builtin'),
    KIND('Number', 'source.lang.language.syntaxtype.number'),
    KIND('String', 'source.lang.language.syntaxtype.string'),
    KIND('StringInterpolation',
         'source.lang.language.syntaxtype.string_interpolation_anchor'),
    KIND('Comment', 'source.lang.language.syntaxtype.comment'),
    KIND('DocComment', 'source.lang.language.syntaxtype.doccomment'),
    KIND('DocCommentField', 'source.lang.language.syntaxtype.doccomment.field'),
    KIND('CommentMarker', 'source.lang.language.syntaxtype.comment.mark'),
    KIND('CommentURL', 'source.lang.language.syntaxtype.comment.url'),
    KIND('Placeholder', 'source.lang.language.syntaxtype.placeholder'),
    KIND('ObjectLiteral', 'source.lang.language.syntaxtype.objectliteral'),
    KIND('Expr', 'source.lang.language.expr'),
    KIND('Stmt', 'source.lang.language.stmt'),
    KIND('Type', 'source.lang.language.type'),
    KIND('ForEachSequence', 'source.lang.language.foreach.sequence'),
    ...
    KIND('Swift', 'source.lang.language'),
    KIND('ObjC', 'source.lang.objc'),
    KIND('MacroRoleExpression', 'source.lang.language.macro_role.expression'),
    KIND('MacroRoleDeclaration', 'source.lang.language.macro_role.declaration'),
    KIND('MacroRoleCodeItem', 'source.lang.language.macro_role.codeitem'),
    KIND('MacroRoleAccessor', 'source.lang.language.macro_role.accessor'),
    KIND('MacroRoleMemberAttribute', 'source.lang.language.macro_role.member_attribute'),
    KIND('MacroRoleMember', 'source.lang.language.macro_role.member'),
    KIND('MacroRolePeer', 'source.lang.language.macro_role.peer'),
    KIND('MacroRoleConformance', 'source.lang.language.macro_role.conformance'),
    KIND('MacroRoleExtension', 'source.lang.language.macro_role.extension'),
    KIND('MacroRolePreamble', 'source.lang.language.macro_role.preamble'),
    KIND('MacroRoleBody', 'source.lang.language.macro_role.body'),
]
