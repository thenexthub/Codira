#!/usr/bin/env python3
#
# ==-- process-stats-dir - summarize one or more Codira -stats-output-dirs --==#
#
...
# `languagec -stats-output-dir` and emits summary data, traces etc. for analysis.
...
def main():
    ...
    parser.add_argument("--lnt-tag", type=str, default="language-compile",
