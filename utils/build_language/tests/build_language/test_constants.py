...
class TestConstants(unittest.TestCase):
    ...
    def test_get_language_source_root_standalone_build(self):
        self.assertEqual(
            constants._get_language_source_root(_TEST_STANDALONE_SWIFT_PATH),
    ...
    def test_get_language_source_root_unified_build(self):
        self.assertEqual(
            constants._get_language_source_root(_TEST_UNIFIED_SWIFT_PATH),
    ...
    def test_get_language_repo_name(self):
        self.assertEqual(
            constants._get_language_repo_name(_TEST_SWIFT_PATH), _TEST_REPO_NAME
        )
