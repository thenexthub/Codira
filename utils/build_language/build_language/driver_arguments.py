...
from language_build_support.language_build_support.targets import \
...
def _apply_default_arguments(args):
    ...
    if args.language_stdlib_build_variant is None:
        args.language_stdlib_build_variant = args.build_variant

    if args.cmark_build_variant is None:
        args.cmark_build_variant = args.language_build_variant
    ...
    if args.language_stdlib_assertions is None:
        args.language_stdlib_assertions = args.assertions
    ...
    if args.language_stdlib_strict_availability is None:
        args.language_stdlib_strict_availability = False
...
def create_argument_parser():
    ...
    option(['--toolchain-benchmarks'],
           ...
           help='build Swift Benchmarks using languagepm against the just built '
                'toolchain')
    option(['--language-inspect'],
           toggle_true('build_language_inspect'),
           help='build SwiftInspect using languagepm against the just built '
                'toolchain')
