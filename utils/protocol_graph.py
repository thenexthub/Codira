...
#   python protocol_graph.py stdlib.language > /tmp/p0.dot && \
...
# Open 'stdlib.language' in this directory if no path specified.
args = list(sys.argv) + \
    [os.path.join(os.path.dirname(__file__), 'stdlib.language')]
