...
atomicTypes = [
    # Name, Size, Alignment, Builtin, Codira Type
...
loadOrderings = [
    # Codira, API name, doc name, LLVM name
...
storeOrderings = [
    # Codira enum case, API name, doc name, LLVM name
    ("relaxed", "Relaxed", "relaxed", "monotonic"),
...
updateOrderings = [
    # Codira enum case, API name, doc name, LLVM name, failure name
...
integerOperations = [
    # Codira name, toolchain name, operator, doc name
...
boolOperations = [
    # Codira name, toolchain name, operator, doc
