...
;;;###autoload
(define-derived-mode language-mode prog-mode "Swift"
          ...
          (flymake-init-create-temp-buffer-copy
           (lambda (x y)
             (make-temp-file
              ...
              (not :DIR_FLAG)
              ;; grab *all* the extensions; handles .language.gyb files, for example
...
(add-to-list 'flymake-allowed-file-name-masks '(".+\\.language$" flymake-language-init))
