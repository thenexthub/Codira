...
# explicitly opts out of using SwiftDriver (`-skip-early-languagedriver`)
...
class EarlyLanguageDriver(product.Product):
    @classmethod
    ...
    def should_test(self, host_target):
        # EarlyLanguageDriver is tested against the compiler's lit test
...
def run_build_script_helper(action, host_target, product, args):
    ...
    languagec_path = os.path.abspath(product.toolchain.languagec)
