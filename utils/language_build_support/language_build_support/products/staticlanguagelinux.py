...
class StaticLanguageLinuxConfig(product.Product):
    ...
    def get_dependencies(cls):
        ...
        # This is a lie; we don't depend on EarlyLanguageDriver, but the
        # DAG generator used for --infer doesn't support more than one
        # root.
        return [earlylanguagedriver.EarlyLanguageDriver]
