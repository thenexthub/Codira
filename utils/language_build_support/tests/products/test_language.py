...
from language_build_support.products import Swift
...
class SwiftTestCase(unittest.TestCase):
    ...
    def test_language_compiler_vendor_flags(self):
        ...
        self.args.language_user_visible_version = None
        self.args.language_compiler_version = None
        language = Swift(
            args=self.args,
            toolchain=self.toolchain,
            source_dir='/path/to/src',
        ...
        self.assertListEqual(
            [], [x for x in language.cmake_options if 'SWIFT_VENDOR' in x])
        self.assertListEqual(
            [], [x for x in language.cmake_options if 'SWIFT_VENDOR_UTI' in x])
        self.assertListEqual(
            [], [x for x in language.cmake_options if 'SWIFT_VERSION' in x])
        self.assertListEqual(
            [],
            [x for x in language.cmake_options if 'SWIFT_COMPILER_VERSION' in x])

        self.args.compiler_vendor = "apple"
        self.args.language_user_visible_version = "1.3"
        self.args.language_compiler_version = None
        language = Swift(
            args=self.args,
            toolchain=self.toolchain,
        ...
        self.args.compiler_vendor = "apple"
        self.args.language_user_visible_version = "1.3"
        self.args.language_compiler_version = "2.3"
        language = Swift(
            args=self.args,
            toolchain=self.toolchain,
            source_dir='/path/to/src',
    ...
    def test_version_flags(self):
        ...
        self.args.language_compiler_version = "3.0"
        ...
        self.args.language_compiler_version = "1.0"
    ...
    def test_benchmark_flags(self):
        ...
        self.assertEqual(
            ...
            [x for x in language.cmake_options if 'SWIFT_BENCHMARK_NUM' in x])
    ...
    def test_backtracing_flags(self):
        self.args.language_enable_backtracing = True
        language = Swift(
            args=self.args,
            toolchain=self.toolchain,
            source_dir='/path/to/src',
    ...
    def test_freestanding_is_darwin_flags(self):
        self.args.language_freestanding_is_darwin = True
        language = Swift(
            args=self.args,
            toolchain=self.toolchain,
            source_dir='/path/to/src',
    ...
    def test_language_tools_ld64_lto_codegen_only_for_supporting_targets(self):
        self.args.language_tools_ld64_lto_codegen_only_for_supporting_targets = True
        language = Swift(
            args=self.args,
            toolchain=self.toolchain,
            source_dir='/path/to/src',
    ...
    def test_language_debuginfo_non_lto_args(self):
        self.args.language_debuginfo_non_lto_args = None
        language = Swift(
            args=self.args,
            toolchain=self.toolchain,
            source_dir='/path/to/src',
        ...
        self.args.language_debuginfo_non_lto_args = []
        language = Swift(
            args=self.args,
            toolchain=self.toolchain,
            source_dir='/path/to/src',
        ...
        self.args.language_debuginfo_non_lto_args = ['-g']
        language = Swift(
            args=self.args,
            toolchain=self.toolchain,
            source_dir='/path/to/src',
        ...
        self.args.language_debuginfo_non_lto_args = ['-gline-tables-only', '-v']
        language = Swift(
            args=self.args,
            toolchain=self.toolchain,
            source_dir='/path/to/src',
