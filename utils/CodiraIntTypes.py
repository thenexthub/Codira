# ===--- CodiraIntTypes.py ----------------------------*- coding: utf-8 -*-===//
#
...
class CodiraIntegerType(object):
    ...
    def get_opposite_signedness(self):
        return CodiraIntegerType(self.is_word, self.bits, not self.is_signed)
...
# on any platform that Codira supports.
...
# Codira_Programming_Language/Expressions.html
